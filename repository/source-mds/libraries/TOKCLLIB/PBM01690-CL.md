...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PBM01690.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PBM01690'
    VAR       ?STEP     ,STRING*8
...
SBM0169B:
    ...
    OVRF     FILE-BMSHE6W,TOFILE-BMSHE6W.BMSFLIB
    CALL     PGM-SBM0169B.TOKSOLIB,PARA-(?TORICD,?DTPTN,
                                         ?DATEF,?DATET)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 := '流通ＢＭＳ返品データ抽出'
              GOTO ABEND
...
SBM0175L:
    ...
    OVRF      FILE-BMSHE6W1,TOFILE-BMSHE6W1.BMSFLIB
    CALL      PGM-SBM0175L.TOKSOLIB,PARA-(?TORICD,?DTPTN,
                                         ?DATEF,?DATET)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 := '流通ＢＭＳ返品リスト出力'
              GOTO ABEND
...
SBM0184V:
    ...
    SNDMSG    ?MSGX,TO-XCTL
    OVRF      FILE-BMSHE6W1,TOFILE-BMSHE6W1.BMSFLIB
    OVRF      FILE-BMSHE6C,TOFILE-BMSHE6C.BMSFLIB
    CALL      PGM-SBM0184V.TOKSOLIB
    IF        @PGMEC    ^=   0    THEN
...
CNVDF000:
    ...
    CNVDF FILE-BMSHE6C.BMSFLIB,
    PATH-'/HGNAS/BMSHE6C.CSV',MODE-@EXP,ADD-@NO,
    ACTCHK-@NO,HEADLINE-@YES,EXTCNV-@YES
/.  CNVDF FILE-BMSHE6C.BMSFLIB,PATH-'/NAVPC/BMSHE6C.CSV',
