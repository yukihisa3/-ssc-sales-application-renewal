...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PSY94710.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY94710'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SSY9472B:
    ...
    CALL      PGM-SSY9472B.TOKSOLIB,PARA-(?JDATE,?JTIME,?JTORI,?SOKCD,
