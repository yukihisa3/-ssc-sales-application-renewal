...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PSY12230.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY12230'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SSY1223I:
    ...
    OVRF      FILE-KNBULKL1,TOFILE-KNBULKL1.TOKDTLIB
    CALL      PGM-SSY1223I.TOKSOLIB
...
SSY1225B:
    ...
    OVRF      FILE-KNBULKL5,TOFILE-KNBULKL5.TOKDTLIB
