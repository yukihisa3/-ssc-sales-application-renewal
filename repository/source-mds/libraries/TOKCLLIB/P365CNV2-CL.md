...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/P365CNV2.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'P365CNV2'
    VAR       ?STEP     ,STRING*8
...
FLMCNV03:
    ...
    OVRF      MEIMS1,MEIMS1.TOKFLIB
    OVRF      CRTMEIF,CRTMEIF.TOKWLIB
    OVRF      CRTSMEIF,CRTSMEIF.TOKWLIB
    OVRF      NOMEIF,NOMEIF.TOKWLIB
    CALL      PGM-D365CNV2.TOKSOLIB
    IF        @PGMEC    ^=   0  THEN
              ?KEKA4 := '商品名称マスタコンバート'
              GOTO  ABEND
    END
