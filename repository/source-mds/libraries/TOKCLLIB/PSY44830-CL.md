...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PSY44830.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?FILNMH   ,STRING*8,VALUE-'BMSTE6F'     /.ﾌｧｲﾙ名ﾃﾞﾌｫﾙﾄ./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PSY44830'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,NAME!MOD
...
/.##ﾌﾟﾛｸﾞﾗﾑ名称ｾｯﾄ##./
    ?PGNM :=  '流通ＢＭＳ出荷ＤＴ作成（山新）手書き'
    ?SYORINM1 :=  '流通ＢＭＳ出荷ＤＴ作成（山新）手書き'
...
STEP060:
    ...
    OVRF FILE-BMSTE6F,TOFILE-?JHTTEGF
    OVRF FILE-TENMS1,TOFILE-TENMS1.TOKFLIB
    OVRF FILE-MEIMS1,TOFILE-MEIMS1.TOKFLIB
    OVRF FILE-SYOMEIL1,TOFILE-SYOMEIL1.TOKKLIB
    OVRF FILE-JYOKEN1,TOFILE-JYOKEN1.TOKFLIB
    OVRF FILE-BMSSYKL3,TOFILE-BMSSYKL3.BMSFLIB
    CALL SSY4487B.TOKSOLIB,PARA-(?JDATE,?JTIME,?TORICD,?SYORIKN1)
    IF      @PGMEC    ^=   0    THEN
       IF      @PGMEC    =  4010    THEN
               GOTO RTN
       ELSE
               ?KEKA4 := '【出荷データ作成（山新）手書き】'
               GOTO ABEND
       END
    END
