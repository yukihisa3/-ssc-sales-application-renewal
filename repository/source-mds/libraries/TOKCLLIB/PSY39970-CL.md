...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PSY39970.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY39970'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SSY3995B:
    ...
    CALL      PGM-SSY3995B.TOKSOLIB,PARA-(?STDATE,?EDDATE)
