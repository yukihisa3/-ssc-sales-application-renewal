...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PSSY0018.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
  ...
  /.VAR ?JHTTEGFN ,STRING*17                 ./ /.ﾌｧｲﾙ名表示用./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PSSY0018'
    VAR       ?STEP     ,STRING*8
...
SSY0016B:
  ...
  /.SETPF FILE-?JHTDENF,TOFILE-?JHTTEGF,ADD-@NO,ACTCHK-@NO ./
    SETPF FILE-JHTTEGWF.BMSFLIB,TOFILE-BMSTE6F.BMSFLIB,
          ADD-@NO,ACTCHK-@NO
