...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PBM03100.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PBM03100'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
PSORT:
    ...
    SORTF  INFILE-WKDENAR.BMSFLIB,
           OUTFILE-WKDENAR.BMSFLIB,
           RCD-50,
           KEY-'F323!A',
           KEY1-'F304!A',
           KEY2-'F342!A',
...
SSY4476V:
    ...
    OVRF FILE-ARNOMEI1,TOFILE-ARNOMTE1.BMSFLIB
    CALL      PGM-SSY4476V.TOKSOLIB
    IF        @PGMEC    ^=   0   THEN
              ?KEKA4    :=   '納品明細書発行データ作成'
              GOTO ABEND
    END
...
PCNVFILE:
    ...
    CNVFILE FILE-ARNOMTEF.BMSFLIB,TOFILE-ARNOMTSF.BMSFLIB,
            ADD-@NO,BF-1
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4    :=   '納品明細書データセット'
              GOTO ABEND
...
PFIMPIRT:
    ...
    FIMPORT FILE-ARNOMTSF.BMSFLIB,PARA-ARNOMEIF,UNIT-1
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4    :=   '納品明細書データ転送'
              GOTO ABEND
    END
