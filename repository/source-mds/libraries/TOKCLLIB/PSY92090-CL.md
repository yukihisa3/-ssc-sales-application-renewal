...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PSY92090.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY92090'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
/.##実行PG名称ｾｯﾄ##./
    ?PGNM := 'センター納入データ抽出'
/.##ﾗｲﾌﾞﾗﾘﾘｽﾄ登録##./
    DEFLIBL TOKELIB/TOKELIBO/TOKSOLIB/ZAIEXCEL/TOKFLIB/TOKKLIB/
            TOKMDLIB
/.##ﾌﾟﾛｸﾞﾗﾑ開始ﾒｯｾｰｼﾞ##./
    ?MSGX :=  '***   '  && ?PGMID  &&   ' START  ***'
    SNDMSG    ?MSGX,TO-XCTL
...
SSY9209I:
    ...
    CALL      PGM-SSY9209I.TOKSOLIB,PARA-(?P3,?P4,?P5,?P6)
    IF        @PGMEC    ^=   0    THEN
         IF   @PGMEC     =   4010 THEN
...
SSY9210L:
    ...
    CALL      PGM-SSY9210L.TOKSOLIB,PARA-(?P3,?P4,?P5,?P6)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '納品ラベル'
              GOTO ABEND END
