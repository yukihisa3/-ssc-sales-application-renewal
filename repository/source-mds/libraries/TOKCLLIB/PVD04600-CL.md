...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PVD04600.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PVD04600'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,NAME!MOD
...
NVD0460I:
    ...
    OVRF     FILE-DNSFILL1,TOFILE-DNSFILL1.D365DLIB
    OVRF     FILE-ZSOKMS1,TOFILE-ZSOKMS1.TOKFLIB
    OVRF     FILE-MEIMS1,TOFILE-MEIMS1.TOKFLIB
    OVRF     FILE-JYOKEN1,TOFILE-JYOKEN1.TOKFLIB
    OVRF     FILE-ZAMZAIL1,TOFILE-ZAMZAIL1.TOKFLIB
    CALL  NVD0460I.TOKSOLIB,PARA-(?BUMON,?TANCD)
    IF      @PGMEC    ^=   0    THEN
       IF      @PGMEC    =  4010    THEN
