...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PNSY0910.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PNSY0910'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
/.##ﾗｲﾌﾞﾗﾘﾘｽﾄ登録##./
    DEFLIBL TOKELIB/TOKFLIB/TOKELIBO/TOKKLIB/TOKDTLIB/TOKDLIB
...
NSY0910L:
    ...
    OVRF FILE-DCMTOKL1,TOFILE-DCMTOKL1.TOKDTLIB
    OVRF FILE-JYOKEN1,TOFILE-JYOKEN1.TOKFLIB
    OVRF FILE-TOKMS2,TOFILE-TOKMS2.TOKFLIB
  /.OVRDSPF FILE-DSPF,TOFILE-DSPF.XUCL,MEDLIB-TOKMDLIB./
    CALL PGM-NSY0910L.TOKSOLIB,PARA-(?BUMON,?TANCD)
    ?PGMEC    :=   @PGMEC
    ?PGMEM    :=   @PGMEM
    IF        ?PGMEC    ^=   0    THEN
              ?KEKA4 :=  'ＤＣＭ取引先設定マスタリスト'
              GOTO ABEND
    END
