...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PSY52200.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY52200'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SSY5200I:
    ...
    CALL PGM-SSY5220I.TOKSOLIB,PARA-(?KANRNO,?KBN)
...
SSY5210V:
    ...
    CALL      PGM-SSY5230V.TOKSOLIB,PARA-(?KANRNO)
