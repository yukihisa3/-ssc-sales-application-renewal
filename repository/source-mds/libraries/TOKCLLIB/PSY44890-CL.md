...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PSY44890.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?FILNMH   ,STRING*8,VALUE-'BMSTE5F'     /.ﾌｧｲﾙ名ﾃﾞﾌｫﾙﾄ./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PSY44890'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,NAME!MOD
...
STEP070:
    ...
    OVRF FILE-WKSTKAR1,TOFILE-WKSTKAR1.BMSFLIB
    OVRF FILE-SYKSNDF,TOFILE-SYKSNDF.BMSFLIB
/.  CALL  SBM0085B.TOKSOLIB,PARA-(?SYORIKN1)
./  CALL  SBM0086B.TOKSOLIB,PARA-(?SYORIKN1)
    ?PGMEC    :=    @PGMEC
    ?PGMEM    :=    @PGMEM
    IF      ?PGMEC    ^=   0    THEN
...
STEP090:
    ...
    SETPF FILE-WKSYKAR.BMSFLIB,TOFILE-BMSSYKF.BMSFLIB,
          ACTCHK-@NO
    ?PGMEC    :=    @PGMEC
    ?PGMEM    :=    @PGMEM
    IF    ?PGMEC    ^=   0    THEN
