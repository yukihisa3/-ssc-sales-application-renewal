...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PSY44807.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PSY44807'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,NAME!MOD
...
/.##ﾌﾟﾛｸﾞﾗﾑ名称ｾｯﾄ##./
    ?PGNM :=  'ＢＭＳ出荷ＤＴ作成（ジュンテンドー）'
    ?SYORINM1 :=  'ＢＭＳ出荷ＤＴ作成（ジュンテンドー）'
...
STEP060:
    ...
    OVRF FILE-BMSSYKL3,TOFILE-BMSSYKL3.BMSFLIB
    CALL SSY4490B.TOKSOLIB,PARA-(?JDATE,?JTIME,?TORICD,?SOKO,
