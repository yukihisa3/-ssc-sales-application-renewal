...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PSY13201.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY13201'    /.ﾌﾟﾛｸﾞﾗﾑID./
    ...
    VAR ?JTORI    ,STRING*8,VALUE-'00023631'    /.受信取引先./
