...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PTB00300.CL`
...
/. *  （株）サカタのタネ                                     *  ./
/. *   SYSTEM-NAME :    ＨＧ基幹　　　　　　　　　　　       *  ./
/. *   JOB-NAME    :    商品変換テーブル取込チェックリスト　 *  ./
/. *   JOB-ID      :    PTB00300  2017/12/07                 *  ./
/. *   UPDATE      :                                         *  ./
/. *                                                         *  ./
/. ***********************************************************  ./
    PGM  (P1-?OUTSYU)
...
/.--------------------------------------------------------------./
    ...
    VAR  ?MSG     ,STRING*99(6)
    VAR  ?MSGX    ,STRING*99
    VAR  ?PGMID   ,STRING*8,VALUE-'PTB00300'
    VAR  ?STEP    ,STRING*8
/.--------------------------------------------------------------./
