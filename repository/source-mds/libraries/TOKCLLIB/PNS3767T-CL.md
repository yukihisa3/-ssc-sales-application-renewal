...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PNS3767T.CL`
...
/.### ﾜｰｸｴﾘｱ定義 ###./
    ...
    VAR ?BTHZK    ,STRING*8,VALUE-'20221215' /. バッチＮＯ・日付 ./
    VAR ?BTTIM    ,STRING*4,VALUE-'1559'     /. バッチＮＯ・時間 ./
    VAR ?BTTOR    ,STRING*8,VALUE-'00284202' /. バッチＮＯ・取引先 ./
