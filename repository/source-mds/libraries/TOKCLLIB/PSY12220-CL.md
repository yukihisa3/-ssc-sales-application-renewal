...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PSY12220.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY12220'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SSY1222I:
    ...
    OVRF      FILE-JYOKEN1,TOFILE-JYOKEN1.TOKFLIB
    OVRF      FILE-KNHAKOL2,TOFILE-KNHAKOL2.TOKDTLIB
    CALL      PGM-SSY1222I.TOKSOLIB
