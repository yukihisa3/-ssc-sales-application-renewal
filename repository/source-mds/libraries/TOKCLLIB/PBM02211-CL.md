...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PBM02211.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PBM02211'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SBM0223V:
    ...
    OVRF      FILE-BMSSH8C,TOFILE-BMSSH8C.BMSFLIB
    CALL      PGM-SBM0223V.TOKSOLIB
    IF        @PGMEC    ^=   0    THEN
...
CNVDF000:
    ...
    CNVDF FILE-BMSSH8C.BMSFLIB,
  /.社内./
  /.PATH-'/NAVPC/BMSSHHIH.CSV',MODE-@EXP,ADD-@NO,HEADLINE-@YES,
    ACTCHK-@NO,EXTCNV-@YES ./
  /.実機./
    PATH-'/HGNAS/BMSSHHIH.CSV',MODE-@EXP,ADD-@NO,HEADLINE-@YES,
    ACTCHK-@NO,EXTCNV-@YES
    IF        @PGMEC    ^=   0    THEN
