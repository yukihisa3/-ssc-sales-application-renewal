...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PBM0208A.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PBM0208A'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SBM0208B:
    ...
    OVRF      FILE-BMSSH5W,TOFILE-BMSSH5W.BMSFLIB
    CALL      PGM-SBM0208B.TOKSOLIB,PARA-(?TORICD,?SIMEBI)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '支払明細ワーク作成'
              GOTO ABEND
    END
...
SBM0213C:
    ...
    OVRF      FILE-BMSSH5W1,TOFILE-BMSSH5W1.BMSFLIB
    OVRF      FILE-TOKMS2,TOFILE-TOKMS2.TOKFLIB
    OVRF      FILE-TENMS1,TOFILE-TENMS1.TOKFLIB
    CALL      PGM-SBM0213C.TOKSOLIB
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '支払明細書発行'
              GOTO ABEND
    END
