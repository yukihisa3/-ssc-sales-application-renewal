...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PNSY0900.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PNSY0900'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
NSY0900I:
    ...
    CALL PGM-NSY0900I.TOKSOLIB,PARA-(?BUMON,?TANCD)
    ?PGMEC    :=   @PGMEC
    ?PGMEM    :=   @PGMEM
    IF        ?PGMEC    ^=   0    THEN
              ?KEKA4 :=  'ＤＣＭ取引先設定マスタ保守'
