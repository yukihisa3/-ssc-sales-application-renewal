...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PKE10802.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PKE10802'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,NAME!MOD
...
ASSIGN:
    ...
    ASSIGN    FILE-CZSYKTNF.BMSFLIB!@XCL
    ?PGMEC    :=    @PGMEC
    ?PGMEM    :=    @PGMEM
    IF        ?PGMEC    ^=   0    THEN
...
STEP060:
    ...
    OVRF FILE-BMSHACL4,TOFILE-BMSHACL4.BMSFLIB
    OVRF FILE-SHTDENLA,TOFILE-SHTDENLA.TOKFLIB
    OVRF FILE-JYOKEN1,TOFILE-JYOKEN1.TOKFLIB
    OVRF FILE-CZSOKMS1,TOFILE-CZSOKMS1.TOKKPLIB
    OVRF FILE-MSTKMEL1,TOFILE-MSTKMEL1.TOKKLIB
    OVRF FILE-CZSYKTN3,TOFILE-CZSYKTN3.BMSFLIB
    CALL NKE1092B.TOKSOLIB,PARA-(?JDATE,?JTIME,?TORICD,?SOKO,
