...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PBM01605.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PBM01605'
    VAR       ?STEP     ,STRING*8
...
SBM0168B:
    ...
    OVRF     FILE-BMSHE5W,TOFILE-BMSHE5W.BMSFLIB
    CALL     PGM-SBM0168B.TOKSOLIB,PARA-(?TORICD,?DTPTN,
                                         ?DATEF,?DATET)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 := '流通ＢＭＳ返品データ抽出'
              GOTO ABEND
...
SBM0174L:
    ...
    OVRF      FILE-BMSHE5W1,TOFILE-BMSHE5W1.BMSFLIB
    CALL      PGM-SBM0174L.TOKSOLIB,PARA-(?TORICD,?DTPTN,
                                         ?DATEF,?DATET)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 := '流通ＢＭＳ返品リスト出力'
              GOTO ABEND
...
SBM0183V:
    ...
    SNDMSG    ?MSGX,TO-XCTL
    OVRF      FILE-BMSHE5W1,TOFILE-BMSHE5W1.BMSFLIB
    OVRF      FILE-BMSHE5C,TOFILE-BMSHE5C.BMSFLIB
    CALL      PGM-SBM0183V.TOKSOLIB
    IF        @PGMEC    ^=   0    THEN
...
CNVDF000:
  ...
  /.社内./
 /. CNVDF FILE-BMSHE5C.BMSFLIB,PATH-'/NAVPC/BMSHEJT.CSV',
          MODE-@EXP,ADD-@NO,ACTCHK-@NO,HEADLINE-@YES,EXTCNV-@YES./
  /.実機./
    CNVDF FILE-BMSHE5C.BMSFLIB,PATH-'/HGNAS/BMSHEJT.CSV',
          MODE-@EXP,ADD-@NO,ACTCHK-@NO,HEADLINE-@YES,EXTCNV-@YES
