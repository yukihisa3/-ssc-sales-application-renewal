...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PBM02003.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PBM02003'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SBM0205B:
    ...
    CALL      PGM-SBM0205B.TOKELIBO,PARA-(?TORICD,?SIMEBI)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '支払明細書発行'
              GOTO ABEND
    END
...
SBM0215V:
    ...
    CALL      PGM-SBM0215V.TOKELIBO
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 := '流通ＢＭＳ支払明細ＣＳＶ出力'
              GOTO ABEND
    END
...
CNVDF000:
    ...
    PATH-'/HGNAS/BMSSIHC.CSV',MODE-@EXP,ADD-@NO,HEADLINE-@YES,
    ACTCHK-@NO
    IF        @PGMEC    ^=   0    THEN
