...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PNS3719V.CL`
...
/.## ﾗｲﾌﾞﾗﾘﾘｽﾄ登録 ##./
    DEFLIBL TOKELIB/TOKFLIB/TOKELIBO/TOKDTLIB/TOKKLIB
...
SSY3710B:
  ...
  /.OVRF FILE-SHTDENLK,TOFILE-SHTDENLK.TOKKLIB./
    OVRF FILE-SHTDENLK,TOFILE-SHTDENLT.TOKKLIB
  /.↑20120530./
    OVRF FILE-NFJISKL1,TOFILE-NSJISKL1.TOKDTLIB
...
SSY3716B:
    ...
    OVRF FILE-NFJYURL6,TOFILE-NSJYURL6.TOKDTLIB
    OVRF FILE-NFJUJKL1,TOFILE-NSJUJKL1.TOKDTLIB
 /.↓20120530./
...
SSY3717B:
    ...
    OVRF FILE-NFJISKL2,TOFILE-NSJISKL2.TOKDTLIB
    OVRF FILE-NFJUJKL2,TOFILE-NSJUJKL2.TOKDTLIB
...
SSY3714V:
    ...
    OVRF FILE-NFNUNML1,TOFILE-NSNUNML1.TOKDTLIB
...
/.  OVRF FILE-NFSHOMS1,TOFILE-NFSHOMS1.TOKKLIB./
    ...
    OVRF FILE-NFNUNMWK,TOFILE-NSNUNMWK.TOKDTLIB
...
PFIMPORT:
    ...
    FIMPORT FILE-NSNUNMWK.TOKDTLIB,PARA-NFNUNMWK,UNIT-2
