...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/P365CNV5.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'P365CNV5'
    VAR       ?STEP     ,STRING*8
...
D365CNV5:
    ...
    CALL      PGM-D365CNV5.TOKSOLIB
    IF        @PGMEC    ^=   0  THEN
              ?KEKA4 := 'ＳＵＢ商品名称マスタ作成・更新'
              GOTO  ABEND
    END
