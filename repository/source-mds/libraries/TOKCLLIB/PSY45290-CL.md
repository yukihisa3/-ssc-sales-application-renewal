...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PSY45290.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PSY45290'
    VAR       ?STEP     ,STRING*8
...
SSY4529B:
    ...
    OVRF     FILE-BMSHE7W,TOFILE-BMSHE7W.BMSFLIB
    CALL     PGM-SSY4529B.TOKSOLIB,PARA-(?TORICD,?DTPTN,
                                         ?DATEF,?DATET)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 := '流通ＢＭＳ返品データ抽出'
              GOTO ABEND
...
SSY4530L:
    ...
    OVRF      FILE-BMSHE7W1,TOFILE-BMSHE7W1.BMSFLIB
    CALL      PGM-SSY4530L.TOKSOLIB,PARA-(?TORICD,?DTPTN,
                                         ?DATEF,?DATET)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 := '流通ＢＭＳ返品リスト出力'
              GOTO ABEND
...
SSY4531V:
    ...
    SNDMSG    ?MSGX,TO-XCTL
    OVRF      FILE-BMSHE7W1,TOFILE-BMSHE7W1.BMSFLIB
    OVRF      FILE-BMSHE7C,TOFILE-BMSHE7C.BMSFLIB
    CALL      PGM-SSY4531V.TOKSOLIB
    IF        @PGMEC    ^=   0    THEN
...
/.  CNVDF FILE-BMSHE7C.BMSFLIB,
    PATH-'/HGNAS/BMSHE7C.CSV',MODE-@EXP,ADD-@NO,
    ACTCHK-@NO,HEADLINE-@YES,EXTCNV-@YES
./  CNVDF FILE-BMSHE7C.BMSFLIB,PATH-'/HGNAS/616_HENPIN_HANSMAN.CSV',
