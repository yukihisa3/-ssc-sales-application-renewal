...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PFU39980.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PFU39980'
    VAR       ?STEP     ,STRING*8
...
/.##ﾌﾟﾛｸﾞﾗﾑ名称ｾｯﾄ##./
    ...
    DEFLIBL TOKELIB/TOKFLIB/TOKDTLIB/TOKKLIB/TOKDLIB
...
SFU3998I:
    ...
    CALL      PGM-SFU3998I.TOKSOLIB,PARA-(?BUMON,?TANTO)
    ?PGMEC := @PGMEC
    ?PGMES := @PGMES
    IF        ?PGMEC    ^=   0    THEN
              ?KEKA4 := '部門マスタ保守'
