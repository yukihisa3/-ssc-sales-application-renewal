...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PSY53200.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PSY53200'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,NAME!MOD
...
/.##ﾌﾟﾛｸﾞﾗﾑ名称ｾｯﾄ##./
    ?PGNM :=  'ＢＭＳ出荷ＤＴ作成（ジョイフルエーケー）'
    ?SYORINM1 :=  'ＢＭＳ出荷ＤＴ作成（ジョイフルエーケー）'
...
STEP051:
    ...
    CALL SBM9100B.TOKSOLIB,PARA-(?SITEI,?SYURUI,
                                 ?JDATE,?JTIME,?TORICD,?SOKO,
                                 ?NOUDT)
    ?PGMEC    :=    @PGMEC
    ?PGMEM    :=    @PGMEM
...
STEP060:
    ...
    OVRF FILE-BMSSYKL3,TOFILE-BMSSYKL3.BMSFLIB
    CALL SSY5320B.TOKSOLIB,PARA-(?JDATE,?JTIME,?TORICD,?SOKO,
