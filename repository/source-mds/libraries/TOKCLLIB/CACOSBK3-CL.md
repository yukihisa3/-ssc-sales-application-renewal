...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/CACOSBK3.CL`
...
/. *   JOB-ID      :    CACOSBK3                             *  ./
/. *   JOB-NAME    :    日次計上エラーデータバックアップ　　 *  ./
/. *   UPDATE      :    2018/02/01 NAV TAKAHASHI             *  ./
/. ***********************************************************  ./
    PGM  (P1-?ERRCHK)
/.  PGM    ./
/.##ﾊﾟﾗﾒﾀ##./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'CACOSBK3'
    VAR       ?STEP   ,STRING*8
...
/.##ＭＳＧ出力##./
    ...
    SAVFILE FILE-TOKUERR.TOKFLIB,TODEV-@NONE,
