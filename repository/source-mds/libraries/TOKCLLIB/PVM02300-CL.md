...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PVM02300.CL`
...
/.--------------------------------------------------------------./
    ...
    VAR  ?MSG     ,STRING*99(6)
    VAR  ?MSGX    ,STRING*99
    VAR  ?PGMID   ,STRING*8,VALUE-'PVM02300'
    VAR  ?STEP    ,STRING*8
/.--------------------------------------------------------------./
...
/.##ﾌﾟﾛｸﾞﾗﾑ名称ｾｯﾄ##./
    ?PGNM := '商品名称マスタ取込チェックリスト'
    CASE  ?OUTSYU     OF
          #'1'# ?PGNM := '商品名称マスタ　取込チェックリスト'
          #'2'# ?PGNM := '商品名称マスタ　取込エラーリスト　'
          ELSE  SNDMSG   '！！！！！！！！！！！！！！！！！！',
