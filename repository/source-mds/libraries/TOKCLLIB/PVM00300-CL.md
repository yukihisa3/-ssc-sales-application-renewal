...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PVM00300.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PVM00300'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
NVM0010I:
    ...
    OVRDSPF FILE-DSPFILE,TOFILE-DSPF.XUCL,MEDLIB-TOKMDLIB
    CALL PGM-NVM0030I.TOKSOLIB,PARA-(?BUMON,?TANCD)
    ?PGMEC    :=    @PGMEC
    ?PGMEM    :=    @PGMEM
    IF        ?PGMEC    ^=   0    THEN
              ?KEKA4 :=  'Ｄ３６５定例ＪＯＢ設定マスタ保守'
              GOTO ABEND
    END
