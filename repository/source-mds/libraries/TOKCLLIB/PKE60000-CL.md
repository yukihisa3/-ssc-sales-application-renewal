...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PKE60000.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PKE60000'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
NKE6000B:
    ...
    OVRF      FILE-CZSUMTK1,TOFILE-CZSUMTK1.TOKKPLIB
    OVRF      FILE-CZSUMWWF,TOFILE-CZSUMWWF.TOKKPLIB
    CALL      PGM-NKE6000B.TOKSOLIB
...
NKE6010B:
    ...
    OVRF      FILE-CZSUMWW1,TOFILE-CZSUMWW1.TOKKPLIB
    OVRF      FILE-CZKONTK3,TOFILE-CZKONTK3.TOKKPLIB
    OVRF      FILE-CZKONWWF,TOFILE-CZKONWWF.TOKKPLIB
    CALL      PGM-NKE6010B.TOKSOLIB
