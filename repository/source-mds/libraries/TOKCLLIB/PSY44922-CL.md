...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PSY44922.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PSY44922'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,NAME!MOD
...
/.-----------------------------------------------------------./
    ...
    VAR       ?NOUDS  ,STRING*8,VALUE-'00000000'   /.納品日開始./
    VAR       ?NOUDE  ,STRING*8,VALUE-'00000000'   /.納品日終了./
    VAR       ?BMNCD  ,STRING*4,VALUE-'0000'       /.部門./
    VAR       ?TNCD   ,STRING*2,VALUE-'00'         /.担当者　./
    DEFLIBL BMSFLIB/TOKELIB/TOKFLIB/TOKKLIB

/.##ﾌﾟﾛｸﾞﾗﾑ名称ｾｯﾄ##./
    ?PGNM :=  'ＢＭＳ送信ＤＴ作成（ビバホーム）'
    ?SYORINM1 :=  'ＢＭＳ送信ＤＴ作成（ビバホーム）'
...
STEP070:
    ...
    OVRF FILE-SYKSNDVH,TOFILE-SYKSNDVI.ONLBLIB
    CALL  SBM0088C.TOKSOLIB,PARA-(?JDATE,?JTIME,?TORICD,?SOKO,?NOUDS,
                                  ?NOUDE,?SYORIKN1)
    IF      @PGMEC    ^=   0    THEN
