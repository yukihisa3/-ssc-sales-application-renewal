...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PVD05400.CL`
...
/. ***********************************************************  ./
/. *   サカタのタネ　ホームガーデン部　　　　　　　  　      *  ./
/. *   SYSTEM-NAME :    基幹＿移動＿Ｄ３６５連携　　　　　   *  ./
/. *   JOB-ID      :    PVD05400                             *  ./
/. *   JOB-NAME    :    倉庫間在庫移動実績照会　　　　　　   *  ./
/. *   UPDATE      :                                         *  ./
/. ***********************************************************  ./
    PGM
    VAR       ?PGMEC  ,INTEGER
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PVD05400'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,NAME!MOD
...
NVD0540I:
    ...
    OVRF     FILE-DNSFILL4,TOFILE-DNSFILL4.D365DLIB
    OVRF     FILE-DNSFILL5,TOFILE-DNSFILL5.D365DLIB
    OVRF     FILE-DNSFILL7,TOFILE-DNSFILL7.D365DLIB
    OVRF     FILE-ZSOKMS1,TOFILE-ZSOKMS1.TOKFLIB
    OVRF     FILE-MEIMS1,TOFILE-MEIMS1.TOKFLIB
    CALL  NVD0540I.TOKSOLIB
    IF      @PGMEC    ^=   0    THEN
       IF      @PGMEC    =  4010    THEN
