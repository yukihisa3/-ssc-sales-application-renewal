...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PJR04800.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PJR04800'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SJR0480I:
    ...
    CALL      SJR0480I.TOKSOLIB,PARA-(?JIKKBN,?BUMON,?TANCD,?JIKKBN)
