...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PIT02000.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PIT02000'
    VAR       ?STEP     ,STRING*8
...
SIT0030I:
    ...
    CALL      PGM-SIT0200I.TOKSOLIB,PARA-(?BUMON,?TANTO,?UPDT,?UPTM)
    IF        @PGMEC    ^=   0  THEN
              IF  @PGMEC = 4010  THEN
