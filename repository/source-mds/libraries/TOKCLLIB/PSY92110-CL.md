...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PSY92110.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY92110'    /.ﾌﾟﾛｸﾞﾗﾑID./
    ...
    VAR ?P13      ,STRING*3,VALUE-'000'         /.部門開始./
    VAR ?P14      ,STRING*3,VALUE-'000'         /.部門終了./
...
/.##ﾗｲﾌﾞﾗﾘﾘｽﾄ登録##./
    DEFLIBL TOKELIB/TOKFLIB/TOKELIBO/TOKKLIB/TOKMDLIB/TOKDTLIB
/.##ﾌﾟﾛｸﾞﾗﾑ開始ﾒｯｾｰｼﾞ##./
    ?MSGX :=  '***   '  && ?PGMID  &&   ' START  ***'
    SNDMSG    ?MSGX,TO-XCTL
/.## ﾜｰｸｽﾃｰｼｮﾝ名取得##./
...
SSY9211I:
    ...
    CALL      PGM-SSY9211I.TOKSOLIB,PARA-(?P1,?P2,?P3,?P4,?P5,?P6,?P7
                          ,?P8,?P9,?P10,?P11,?P13,?P14,?P12)
    IF        @PGMEC    ^=   0    THEN
         IF   @PGMEC     =   4010 THEN
...
SSY9213L:
    ...
    CALL      PGM-SSY9213L.TOKSOLIB,PARA-(?P1,?P2,?P3,?P4,?P6,?P7
...
SSY9212L:
    ...
    CALL      PGM-SSY9212L.TOKSOLIB,PARA-(?P1,?P2,?P3,?P4,?P6,?P7
                                   ,?P8,?P9,?P10,?P11,?P13,?P14)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '出荷リスト発行（原価無し）'
              GOTO ABEND END
