...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PVM00100.CL`
...
NVM0010I:
    ...
    CALL PGM-NVM0010I.TOKSOLIB,PARA-(?BUMON,?TANCD)
    ?PGMEC    :=    @PGMEC
    ?PGMEM    :=    @PGMEM
    IF        ?PGMEC    ^=   0    THEN
              ?KEKA4 :=  'Ｄ３６５送受信ＤＴ種別マスタ保守'
              GOTO ABEND
    END
