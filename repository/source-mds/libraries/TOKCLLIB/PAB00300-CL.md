...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PAB00300.CL`
...
/.--------------------------------------------------------------./
    ...
    VAR  ?MSG     ,STRING*99(6)
    VAR  ?MSGX    ,STRING*99
    VAR  ?PGMID   ,STRING*8,VALUE-'PAB00300'
    VAR  ?STEP    ,STRING*8
/.--------------------------------------------------------------./
...
/.---------------------------------------------------------------./
  ...
  /.##端末別ファイルＩＤ編集用##./      /.当機能では非使用./
    ...
    /.データ_OVRF_ファイルＩＤ./
    VAR  ?SYOXXXCS ,NAME!MOD
    VAR  ?SYOXXXWK ,NAME!MOD
    VAR  ?SYOXXXW1 ,NAME!MOD
    VAR  ?SYOXXXW2 ,NAME!MOD
    VAR  ?SYOXXXW3 ,NAME!MOD
...
/.##ﾌﾟﾛｸﾞﾗﾑ名称ｾｯﾄ##./
    ?PGNM := '倉庫商品別_番設定　取込チェックリスト'
    CASE  ?OUTSYU     OF
          #'1'# ?PGNM := '倉庫商品別_番設定　取込チェックリスト'
          #'2'# ?PGNM := '倉庫商品別_番設定　取込エラーリスト'
          ELSE  SNDMSG   '！！！！！！！！！！！！！！！！！！',
