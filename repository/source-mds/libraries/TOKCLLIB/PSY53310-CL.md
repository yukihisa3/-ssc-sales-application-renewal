...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PSY53310.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PSY53310'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,NAME!MOD
...
/.-----------------------------------------------------------./
    ...
    VAR       ?NOUDTS ,STRING*8,VALUE-'00000000'   /.納品日./
...
/.##ﾌﾟﾛｸﾞﾗﾑ名称ｾｯﾄ##./
    ?PGNM :=  'ＢＭＳ送信ＤＴ作成（ジョイフルエーケー）'
    ?SYORINM1 :=  'ＢＭＳ送信ＤＴ作成（ジョイフルエーケー）'
...
STEP070:
    ...
    CALL  SSY5351B.TOKSOLIB,PARA-(?JDATE,?JTIME,?TORICD,?SOKO,?NOUDTS,
                                  ?NOUDTE,?SYORIKN1)
    IF      @PGMEC    ^=   0    THEN
