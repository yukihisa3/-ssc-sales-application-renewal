...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PSY08070.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY08070'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
PFIMPORT:
    ...
    FIMPORT FILE-ONLKPCSV.TOKDTLIB,PARA-DCMKEP,UNIT-1
    ?PGMEC := @PGMEC
    ?PGMEM := @PGMEM
    IF  ?PGMEC ^= 0  THEN
              ?KEKA4 :=  '欠品データＣＳＶ出力'
