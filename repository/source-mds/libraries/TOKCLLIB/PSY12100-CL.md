...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PSY12100.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY12100'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SSY1211B:
    ...
    OVRF      FILE-KNPKLBWK,TOFILE-KNPKLBWK.TOKDTLIB
    CALL      PGM-SSY1211B.TOKSOLIB,
...
SSY1212L:
    ...
    OVRF      FILE-KNPKLBW1,TOFILE-KNPKLBW1.TOKDTLIB
    OVRF      FILE-TOKMS2,TOFILE-TOKMS2.TOKFLIB
    OVRF      FILE-ZSOKMS1,TOFILE-ZSOKMS1.TOKFLIB
    OVRF      FILE-TENMS1,TOFILE-TENMS1.TOKFLIB
    OVRF      FILE-MEIMS1,TOFILE-MEIMS1.TOKFLIB
    CALL      PGM-SSY1212L.TOKSOLIB
