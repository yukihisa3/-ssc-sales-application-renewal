...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PNSY0515.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PNSY0515'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
NSY0515L:
    ...
    OVRF      FILE-DDCENTL3,TOFILE-DDCENTL3.TOKDTLIB
...
/.  CASE  ?P7  OF
       ...
       # '6A' #
          ?MSGX :=  '##　片岡配送センター　　出力　##'
          SNDMSG    ?MSGX,TO-XCTL
          OVRPRTF FILE-PRTF,TOFILE-PRTF.XUCL,DEV-PRINTX6A,
    ...
    END
./  CALL      PGM-NSY0515L.TOKSOLIB,PARA-(?P1,?P2,?P3,?P4,?P6,?P8,
                                          ?P9,?P10)
    ?PGMEC    :=    @PGMEC
    ?PGMEM    :=    @PGMEM
    IF        ?PGMEC    ^=   0    THEN
