...
**種別**: JCL  
**ライブラリ**: TOKCLLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLLIB/PSY44802.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PSY44802'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,NAME!MOD
...
STEP050:
    ...
    CALL  SBM0061I.TOKSOLIB,PARA-(?BUMON,?TANCD,?SOKCD,?DSOKCD,
                                  ?JDATE,?JTIME,?TORICD,?SOKO,
                                  ?NOUDT,?NOUDTE,?BMNCD,?TNCD)
    IF      @PGMEC    ^=   0    THEN
       IF      @PGMEC    =  4010    THEN
...
STEP070:
    ...
    CALL  SBM0089B.TOKSOLIB,PARA-(?JDATE,?JTIME,?TORICD,?SOKO,?NOUDT,
                                  ?NOUDTE,?SYORIKN2)
    IF      @PGMEC    ^=   0    THEN
