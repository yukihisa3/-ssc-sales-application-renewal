...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SJU2020B.COB`
...
*
 ...
 FILE-CONTROL.
*受信ファイル
     SELECT  CVCSGF    ASSIGN    TO        DA-01-S-CVCSG002
                       ACCESS    MODE      SEQUENTIAL
                       FILE      STATUS    CVC-ST.
*バックアップファイル
     SELECT  BKCVCF    ASSIGN    TO        DA-01-S-BKCVCS02
                       ACCESS    MODE      SEQUENTIAL
                       FILE      STATUS    BKC-ST.
*
****************************************************************
