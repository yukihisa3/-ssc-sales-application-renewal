...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SLST040.COB`
...
*プリンター
 FD  PRTF
     ...
     COPY        FL040L    OF        XMDLIB.
*表示ファイル
 FD  DSPF
     LABEL       RECORD    IS        OMITTED.
     COPY        FL040     OF        XMDLIB.
******************************************************************
...
**********************
 MAIN-010.
     READ   HSHOTBL   NEXT  AT        END
          ...
          GO                TO        MAIN-EXIT.
*量販店チェック
     IF  (STB-F02  <  KAIRYO) OR (STB-F02  >  ENDRYO)
         GO                TO        MAIN-010.
*終了取引先チェック
     IF  (STB-F01  >  ENDTOK)
          MOVE  "FL040L"    TO        PRT-FORM
...
*
     IF  (KAIRYO > ENDRYO)
         MOVE    1         TO        ERR-SW
         MOVE   "R"        TO        EDIT-OPTION  OF    KAIRYO
         MOVE   "R"        TO        EDIT-OPTION  OF    ENDRYO
         MOVE   "C"        TO        EDIT-CURSOR  OF    KAIRYO
         MOVE    WK-ERR1   TO        ERRMSG
       ELSE
         MOVE   "M"        TO        EDIT-OPTION  OF    KAIRYO
         MOVE   "M"        TO        EDIT-OPTION  OF    ENDRYO
         MOVE    SPACE     TO        EDIT-CURSOR  OF    KAIRYO.
*項目表示
     MOVE       "GRP001"   TO        DSP-GRP.
     PERFORM     DSP-WRT-SEC.
*エラー存在？
