...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/STE1701B.COB`

## ソースコード

```cobol
****************************************************************
*   SYSTEM ･･･富士シティオオンラインシステム
*   PG-NAME･･･手書き伝票発行
*   PG-ID  ･･･STE1701B
*                                            DATE. 99.01.25
*                                            BY. T.TAKAHASHI
...
*    ﾐﾀﾞｼ
 01  HEAD-00.
     ...
     03  HD001                    PIC  N(06)     VALUE
         NC"富士シティオ"         CHARACTER  TYPE IS YA.
...
*    伝票データ読込み
 READ-000.
     ...
     IF       KYO-F03 >    20
              IF   KYO-F03  =  80
                   MOVE     KYO-F1421  TO  WK-BIKO-1
                   MOVE     KYO-F1422  TO  WK-BIKO-2
              END-IF
              GO                  TO   READ-000
     END-IF.
*    全プリント時判定
...
*    備考欄セット
     MOVE   WK-BIKO-1            TO   TL02-1.
     MOVE   WK-BIKO-2            TO   TL03-1.
*    テイル印字制御
