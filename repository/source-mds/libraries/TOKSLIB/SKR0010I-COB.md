...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKR0010I.COB`
...
****  画面ファイル  ****
 COPY   FKR00101         OF        XMDLIB.
 COPY   FKR00102         OF        XMDLIB.
****  画面制御項目  ****
 01  DSP-CONTROL.
...
****  メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SKR0010I".
...
*----------------------------------------------------------*
 INIT1-DSP-SEC        SECTION.
     MOVE     SPACE          TO   FKR00101.
     MOVE     SPACE          TO   FKR00102.
     MOVE    "FKR00101"      TO   DSP-FORMAT.
...
*----------------------------------------------------------*
 DSP-READ-SEC           SECTION.
     MOVE  "NE"    TO   DSP-PROC.
     READ   DSPF.
     IF  DSP-FORMAT  = "FKR00101"
         MOVE    DSP-AREA    TO   FKR00101
     ELSE
         MOVE    DSP-AREA    TO   FKR00102
     END-IF.
 DSP-READ-EXIT.
     EXIT.
*----------------------------------------------------------*
