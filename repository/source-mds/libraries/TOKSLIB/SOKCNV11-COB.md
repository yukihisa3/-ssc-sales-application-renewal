...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SOKCNV11.COB`
...
*
 ...
 FILE-CONTROL.
*実績集計Ｆ
     SELECT   JISSYUF   ASSIGN    TO        DA-01-S-JISSYUF
...
*　　実績集計Ｆ
******************************************************************
 FD  JISSYUF            LABEL RECORD   IS   STANDARD.
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SOKCNV11".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SOKCNV11".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
