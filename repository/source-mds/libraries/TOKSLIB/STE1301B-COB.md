...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/STE1301B.COB`
...
*   システム名    ：   販売管理システム
*   サブシステム名：   手書伝票発行　
*   プログラム名　：   トークホームセンター手書伝票発行
*   プログラムID  ：   STE1301B（備考欄印字機能有り）
*   使用伝票      ：   ＜ターンアラウンド用Ｉ_型＞
*   作成者        ：   ナブ・アシスト
*   作成日        ：   1997.04.07
*   更新履歴      ：
...
*プリンター
 FD  PRTF
     ...
     COPY        FTE13011  OF        XMDLIB.
*表示ファイル
 FD  DSPF
     LABEL       RECORD    IS        OMITTED.
     COPY        FTE13012  OF        XMDLIB.
******************************************************************
...
*****各ファイルオープン
     OPEN        I-O       DSPF
                 ...
                 OUTPUT    PRTF.
*****画面初期化
     MOVE     SPACE              TO   FTE13012.
     MOVE     ZERO               TO   WK-DEN.
     MOVE     ZERO               TO   CNT-DENPYO.
*////PERFORM  DSP-WRT-SEC.
*****帳票初期化
     MOVE        SPACE     TO        FTE13011.
*****伝票枚数カウント
     MOVE     ZERO         TO    WK-MAI.
*  2011/10/05,S  S.I/NAV
...
*****社名
     MOVE     "NTTﾌﾞﾂﾘｭｳｻｰﾋﾞｽ(ｶﾌﾞ)" TO   HD01.
*****店舗名称
...
*****明細エリア転送
     PERFORM   VARYING   I   FROM  1  BY  1   UNTIL   I  >  6
          ...
          MOVE   ALL "9"         TO   DM04(I) DM05(I) DM06(I)
