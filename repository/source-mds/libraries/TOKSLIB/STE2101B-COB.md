...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/STE2101B.COB`
...
*プリンター
 FD  PRTF
     ...
     COPY        FTE21011  OF        XMDLIB.
*表示ファイル
 FD  DSPF
     LABEL       RECORD    IS        OMITTED.
     COPY        FTE21012   OF        XMDLIB.
******************************************************************
