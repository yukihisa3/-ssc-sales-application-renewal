...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY6002L.COB`
...
***** 合計計算ワーク
 ...
 01  WTAKUHAI                     PIC       9(07)  VALUE  ZERO.
 01  WDERIBA                      PIC       9(07)  VALUE  ZERO.
 01  WD2                          PIC       9(07)  VALUE  ZERO.
 01  WSONOTA                      PIC       9(07)  VALUE  ZERO.
 01  WK-DELKBN                    PIC       9(02)  VALUE  ZERO.
*
***** 合計見出し領域
...
***** メッセージエリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY6002L".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY6002L".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND1.
...
***** 見出し行１
 01  MIDASHI1.
     ...
     03  FILLER                   PIC  X(08)  VALUE "SSY6002L".
...
***** 明細行１
 01  MEISAI1.
     03  FILLER                   PIC       X(02)  VALUE  SPACE.
     03  TAKUHAI                  PIC       ZZZZZZ.
     03  FILLER                   PIC       X(02)  VALUE  SPACE.
     03  DERIBA                   PIC       ZZZZZZ.
     03  FILLER                   PIC       X(02)  VALUE  SPACE.
     03  D2                       PIC       ZZZZZZ.
     03  FILLER                   PIC       X(02)  VALUE  SPACE.
     03  SONOTA                   PIC       ZZZZZZ.
     03  FILLER                   PIC       X(03)  VALUE  SPACE.
...
*
     MOVE     1         TO        IDX-CNT.
     PERFORM  CLR-SEC   UNTIL     IDX-CNT   >    5.
*
...
*    発注数量又は、訂正数量か判定
     IF       PARA-TKBN      =    1
              ...
              EVALUATE  WK-DELKBN
                  WHEN  1
                        ADD  HAC-F13   TO   WTAKUHAI
                  WHEN  2
                        ADD  HAC-F13   TO   WDERIBA
                  WHEN  3
                        ADD  HAC-F13   TO   WD2
                  WHEN  OTHER
                        ADD  HAC-F13   TO   WSONOTA
              END-EVALUATE
     END-IF.
     IF       PARA-TKBN      =    2
              ...
              EVALUATE  WK-DELKBN
                  WHEN  1
                        ADD  HAC-F14   TO   WTAKUHAI
                  WHEN  2
                        ADD  HAC-F14   TO   WDERIBA
                  WHEN  3
                        ADD  HAC-F14   TO   WD2
                  WHEN  OTHER
                        ADD  HAC-F14   TO   WSONOTA
              END-EVALUATE
     END-IF.
*
...
****************************************************************
 TEN-READ-SUB           SECTION.
     MOVE    HAC-F013        TO   TEN-F52.
     MOVE    HAC-F02         TO   TEN-F011.
     READ    HTENMS
       INVALID      KEY
          MOVE     ZERO      TO   WK-DELKBN
       NOT INVALID  KEY
          MOVE     TEN-F82   TO   WK-DELKBN
     END-READ.
 TEN-READ-END.
     EXIT.
****************************************************************
...
*
     MOVE      WTAKUHAI       TO        TAKUHAI.
     MOVE      WDERIBA        TO        DERIBA.
*****MOVE      WD2            TO        D2.
*****MOVE      WSONOTA        TO        SONOTA.
     MOVE      ZERO           TO        D2.
     MOVE      ZERO           TO        SONOTA.
*
     MOVE   ZERO              TO        WK-IXM.
...
*
     ...
     MOVE      HAC-F08        TO        WJISHOCD.
     MOVE      ZERO           TO        WSURYO.
     MOVE      ZERO           TO        WTAKUHAI.
     MOVE      ZERO           TO        WDERIBA.
     MOVE      ZERO           TO        WD2.
     MOVE      ZERO           TO        WSONOTA.
*
     MOVE      1              TO        IDX-CNT.
     PERFORM   CLR-SEC   UNTIL          IDX-CNT   >   5.
*
