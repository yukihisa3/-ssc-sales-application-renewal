...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SMG0020L.COB`
...
*
***  PG-ID
 01  WK-PGID                 PIC X(08)  VALUE  "SMG0020L".
***  ｽﾃｰﾀｽｴﾘｱ
 01  FILE-STATUS.
     03  PRT-ST              PIC X(02).
*帳票制御用領域
...
*             PROCEDURE           DIVISION                     *
****************************************************************
 PROCEDURE    DIVISION     USING  LINK-PGNM
                                  LINK-KEKA1
                                  LINK-KEKA2
                                  LINK-KEKA3
                                  LINK-KEKA4.
