...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKY3401B.COB`
...
*    サブシステム　　　　：　受配信                            *
*    モジュール名　　　　：　ＰＧ実行結果リスト                *
*    作成日／作成者　　　：　2000/08/16 T.TAKAHASHI            *
*    更新日／更新者　　　：　　　　　　                        *
*    処理概要　　　　　　：　　　　　　　　　　　　　　　　　　*
*                                                              *
****************************************************************
...
*             PROCEDURE           DIVISION                     *
****************************************************************
 PROCEDURE    DIVISION     USING  LINK-KEKKACD.
 DECLARATIVES.
 PRT-ERR                   SECTION.
...
***  受信結果／エラー内容
     EVALUATE LINK-KEKKACD
         WHEN 1
         MOVE  NC"正常終了"  TO        PRT-JKEKKA
         MOVE  NC"ＡＣＯＳ計上データ編集処理が正常終了しま"
                             TO        PRT-ERRNM1
         MOVE  NC"した。計上件数を確認して下さい。　　　　"
                             TO        PRT-ERRNM2
         WHEN 2
         MOVE  NC"異常終了"  TO        PRT-JKEKKA
         MOVE  NC"ＡＣＯＳ計上データ編集処理が異常終了しま"
                             TO        PRT-ERRNM1
         MOVE  NC"した。ログ採取後ナブまで連絡して下さい。"
                             TO        PRT-ERRNM2
         WHEN OTHER
         MOVE  NC"＊＊＊＊"  TO        PRT-JKEKKA
         MOVE  ALL NC"＊"    TO        PRT-ERRNM1
         MOVE  ALL NC"＊"    TO        PRT-ERRNM2
     END-EVALUATE.
*プリント出力
     MOVE        SPACE       TO   PRT-CONTROL.
     MOVE        "FKY34011"  TO   PRT-FORMAT.
