...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY0021L.COB`
...
***** メッセージエリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY0021L".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY0021L".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND1.
...
***** 見出し行１
 01  MIDASHI1.
     ...
     03  FILLER                   PIC  X(08)  VALUE "SSY0021L".
...
*********WHEN  "3" MOVE  NC"セット組出荷"   TO   MEI2-KOURI-KBN
         WHEN  "1" MOVE  NC"小売出荷"       TO   MEI2-KOURI-KBN
         WHEN  "2" MOVE  NC"直送出荷"       TO   MEI2-KOURI-KBN
         WHEN  "3" MOVE  NC"セット出"       TO   MEI2-KOURI-KBN
*# 2020/07/17 NAV ED ストックＮＯ管理区分追加
