...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/STE2601B.COB`
...
*プリンター
 FD  PRTF
     ...
     COPY        FTE26011  OF        XMDLIB.
*表示ファイル
 FD  DSPF
     LABEL       RECORD    IS        OMITTED.
     COPY        FTE26012   OF        XMDLIB.
******************************************************************
