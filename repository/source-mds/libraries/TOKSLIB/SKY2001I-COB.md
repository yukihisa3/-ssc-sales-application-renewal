...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKY2001I.COB`
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SKY2001I DSPFILE ERROR " DSP-ST " "
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FKY20011.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-BODY-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "SKY2001I"      TO   PGID.
     MOVE    "FKY20011"      TO   FORM.
*    パラメタ倉庫コードセット
     MOVE    PARA-SOKCD      TO   SOKCD.
*
     MOVE     SPACE          TO   DSP-CNTL.
     MOVE     "FKY20011"     TO   DSP-FMT.
