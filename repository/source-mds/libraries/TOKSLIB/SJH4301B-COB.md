...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SJH4301B.COB`
...
*ファイルヘッダー退避ワーク
 01  WK-DEPA-REC.
     ...
     03  WK-DEPA05          PIC  X(04).
     03  WK-DEPA06          PIC  X(20).
     03  WK-DEPA07          PIC  9(07).
     03  WK-DEPA08          PIC  X(20).
     03  WK-DEPA09          PIC  X(60).
*
*伝票ヘッダー退避ワーク
 01  WK-DEPB-REC.
     03  WK-DEPB01          PIC  X(02).
     03  WK-DEPB02          PIC  X.
     03  WK-DEPB03          PIC  9(08).
     03  WK-DEPB04          PIC  9(08).
     03  WK-DEPB05          PIC  9(02).
     03  WK-DEPB06          PIC  9(04).
     03  WK-DEPB07          PIC  9.
     03  WK-DEPB08          PIC  9.
     03  WK-DEPB09          PIC  9(04).
     03  WK-DEPB10          PIC  9(04).
     03  WK-DEPB11          PIC  9(08).
     03  WK-DEPB12          PIC  9(08).
     03  WK-DEPB13          PIC  9(04).
     03  WK-DEPB14          PIC  9.
     03  WK-DEPB15          PIC  9.
     03  WK-DEPB16          PIC  9.
     03  WK-DEPB17          PIC  9.
     03  WK-DEPB18          PIC  9(05).
     03  WK-DEPB19          PIC  X.
     03  WK-DEPB20          PIC  X(10).
     03  WK-DEPB21          PIC  X(10).
     03  WK-DEPB22          PIC  X(15).
     03  WK-DEPB23          PIC  X(28).
*
*    明細レコード退避ワーク
 01  WK-DEPD-REC.
     03  WK-DEPD01          PIC  X(02).
     03  WK-DEPD02          PIC  X.
     03  WK-DEPD03          PIC  9(04).
     03  WK-DEPD04          PIC  9(02).
     03  WK-DEPD05          PIC  9(10).
     03  WK-DEPD06          PIC  9(13).
     03  WK-DEPD07          PIC  X(03).
     03  WK-DEPD08          PIC  9(04).
     03  WK-DEPD09          PIC  9(04).
     03  WK-DEPD10          PIC  9(06)V9(01).
     03  WK-DEPD11          PIC  9(06)V9(02).
     03  WK-DEPD12          PIC  9(06).
     03  WK-DEPD13          PIC  9(09).
     03  WK-DEPD14          PIC  X(20).
     03  WK-DEPD15          PIC  X(20).
     03  WK-DEPD16          PIC  X(09).
     03  WK-DEPD17          PIC  X(06).
*
 01  WRK-SNAME.
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJH4301B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJH4301B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*
*    データ種別
     MOVE     WK-DEPB01     TO        HEN-A10.
*    レコード区分
     MOVE     WK-DEPB02     TO        HEN-A11.
*    発注_
     MOVE     WK-DEPB03     TO        HEN-A12.
*    伝票番号
     MOVE     WK-DEPB04     TO        HEN-A13.
*    伝票区分
     MOVE     WK-DEPB05     TO        HEN-A14.
*    部門コード
     MOVE     WK-DEPB06     TO        HEN-A15.
*    納品区分
     MOVE     WK-DEPB07     TO        HEN-A16.
*    検品区分
     MOVE     WK-DEPB08     TO        HEN-A17.
*    納品店舗コード
     MOVE     WK-DEPB09     TO        HEN-A18.
*    梱包店舗コード
     MOVE     WK-DEPB10     TO        HEN-A19.
*    発注日
     MOVE     WK-DEPB11     TO        HEN-A20.
*    納品指定日
     MOVE     WK-DEPB12     TO        HEN-A21.
*    納品指定時刻
     MOVE     WK-DEPB13     TO        HEN-A22.
*    便区分
     MOVE     WK-DEPB14     TO        HEN-A23.
*    値付区分
     MOVE     WK-DEPB15     TO        HEN-A24.
*    特売区分
     MOVE     WK-DEPB16     TO        HEN-A25.
*    発注区分
     MOVE     WK-DEPB17     TO        HEN-A26.
*    部門区分
     MOVE     WK-DEPB18     TO        HEN-A27.
*    伝票仕分区分
     MOVE     WK-DEPB19     TO        HEN-A28.
*    納品店舗名
     MOVE     WK-DEPB20     TO        HEN-A29.
*    梱包店舗名
     MOVE     WK-DEPB21     TO        HEN-A30.
*    摘要
     MOVE     WK-DEPB22     TO        HEN-A31.
*    予備
     MOVE     WK-DEPB23     TO        HEN-A32.
*
*    データ種別
     MOVE     WK-DEPD01     TO        HEN-A33.
*    レコード区分
     MOVE     WK-DEPD02     TO        HEN-A34.
*    発注ＳＥＱ
     MOVE     WK-DEPD03     TO        HEN-A35.
*    伝票行番号
     MOVE     WK-DEPD04     TO        HEN-A36.
*    商品コード
     MOVE     WK-DEPD05     TO        HEN-A37.
*    ＪＡＮコード
     MOVE     WK-DEPD06     TO        HEN-A38.
*    予備
     MOVE     WK-DEPD07     TO        HEN-A39.
*    入数
     MOVE     WK-DEPD08     TO        HEN-A40.
*    ケース数
     MOVE     WK-DEPD09     TO        HEN-A41.
*    発注数量
     MOVE     WK-DEPD10     TO        HEN-A42.
*    原単価
     MOVE     WK-DEPD11     TO        HEN-A43.
*    売単価
     MOVE     WK-DEPD12     TO        HEN-A44.
*    原価金額
     MOVE     WK-DEPD13     TO        HEN-A45.
*    商品名カナ（上段）
     MOVE     WK-DEPD14     TO        HEN-A46.
*    商品名カナ（下段）
     MOVE     WK-DEPD15     TO        HEN-A47.
*    ロケーション
     MOVE     WK-DEPD16     TO        HEN-A48.
*    予備
     MOVE     WK-DEPD17     TO        HEN-A49.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
...
*取引先コード
     MOVE        HEN-A07   TO        HEN-F01.
     MOVE        HEN-A07   TO        WK-TOKCD.
*伝票ナンバー
     MOVE        HEN-A13   TO        HEN-F02.
...
*出荷場所／伝発場所
     MOVE        TBL-F04   TO        HEN-F08
                                     HEN-F09.
*発注日
     MOVE        HEN-A20   TO        HEN-F111.
*納品日
     MOVE        HEN-A21   TO        HEN-F112.
*出荷日はセットしない
*
*分類（部門）
     MOVE        HEN-A15   TO        HEN-F12.
*商品区分　　
     MOVE        SPACE     TO        HEN-F131.
*伝票区分　　
     MOVE        HEN-A14   TO        HEN-F132.
*伝発区分
     MOVE        9         TO        HEN-F134.
*自社商品コード
...
*商品名　　　
     MOVE        SPACE     TO        WRK-SNAME.
     MOVE        HEN-A46   TO        WRK-SNAME1.
     MOVE        HEN-A47   TO        WRK-SNAME2.
     MOVE        WRK-SNAME(1:15)     TO   HEN-F1421.
     MOVE        WRK-SNAME(16:15)    TO   HEN-F1422.
*数量
...
*
*店舗名（カナ）
     MOVE        HEN-A29   TO        HEN-F30.
*システム日付
     MOVE        SYS-DATEW TO        HEN-F99.
*ルート（納品時間）
     MOVE        HEN-A22   TO        HEN-F42.
*受信日付
...
*取引先ＣＤは取引先エリアの取引先ＣＤを使用すること
     MOVE     HEN-A07      TO        RUT-F01.
     MOVE     SPACE        TO        RUT-F02.
     MOVE     HEN-A28      TO        RUT-F03.
     READ     JHMRUTL1
         INVALID
           MOVE  1         TO        INV-RUT
