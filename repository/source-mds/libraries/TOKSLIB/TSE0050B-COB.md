...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/TSE0050B.COB`
...
***≪請求合計ファイル≫*****************************************
     SELECT  OUTF       ASSIGN    TO  DA-01-S-OUTF
                        FILE  STATUS  IS   OUT-ST1.
****************************************************************
 DATA                   DIVISION.
****************************************************************
 FILE                   SECTION.
...
*----≪請求合計ファイル≫--------------------------------------*
 FD  OUTF.
     COPY    NYKFILF    OF   XFDLIB    JOINING   OUT  PREFIX.
****  作業領域  ************************************************
 WORKING-STORAGE        SECTION.
****************************************************************
 01  PGM-ID             PIC   X(08)    VALUE     "TSE0050B".
*----≪フラグ≫------------------------------------------------*
 01  FLG.
...
*----≪ステータスエリア≫--------------------------------------*
 01  ST-AREA.
     ...
     03  OUT-ST1        PIC   X(02)    VALUE     SPACE.
*----≪システム日付　時間エリア≫------------------------------*
