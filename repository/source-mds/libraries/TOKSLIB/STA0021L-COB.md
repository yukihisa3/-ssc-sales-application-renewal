...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/STA0021L.COB`
...
****  メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "STA0021L".
...
*条件Ｆ索引（部門コード取得）
     ...
     READ    HJYOKEN
           INVALID
             ...
             STOP RUN
     END-READ.
*****MOVE    JYO-F04             TO   WK-BUMON-CD.
*2003/11/21 NAV START* 在庫部門ＣＤのセット
     MOVE    JYO-F05             TO   WK-BUMON-CD.
*2003/11/21 NAV END  *
     MOVE    JYO-F03             TO   WK-BUMON-NAME.
**** DISPLAY "WK-BUMON-CD1 = " WK-BUMON-CD1 UPON CONS.
**** DISPLAY "WK-BUMON-CD2 = " WK-BUMON-CD2 UPON CONS.
*******
...
*---- 部門ＣＤ／名称編集   ----*
*****MOVE    WK-BUMON-CD2        TO   WK-INDT.
*****MOVE    TAN-F02             TO   WK-INDT.
     MOVE    TAN-F02X            TO   WK-INDT.
     PERFORM   ZENKAKU-HENKAN-SEC.
     MOVE    WK-OTDT             TO   HEAD03-BUMONCD.
     MOVE    WK-BUMON-NAME       TO   HEAD03-BUMONMEI.
*****IF      TAN-F02  =  312
*            MOVE NC"北海道支店" TO   HEAD03-BUMONMEI
*****END-IF.
*2013/05/17 NAV ST 部門名称をセット
     EVALUATE TAN-F02
         WHEN 291     MOVE NC"ＨＧ部北海道" TO HEAD03-BUMONMEI
         WHEN 292     MOVE NC"ＨＧ部東日本" TO HEAD03-BUMONMEI
         WHEN 293     MOVE NC"ＨＧ部西日本" TO HEAD03-BUMONMEI
         WHEN 294     MOVE NC"ＨＧ部九州　" TO HEAD03-BUMONMEI
         WHEN OTHER   MOVE NC"ＨＧ部東日本" TO HEAD03-BUMONMEI
     END-EVALUATE.
*2013/05/17 NAV ED 部門名称をセット
*
     ADD    1                    TO   PAGE-CNT.
