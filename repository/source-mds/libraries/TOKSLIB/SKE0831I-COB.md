...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKE0831I.COB`
...
*パラメタ
 01  WK-PARA.
     03  PARA-SOKCD     PIC  X(02)   VALUE  SPACE.
     03  PARA-JOHO-CNT  PIC  9(06)   VALUE  ZERO.
     03  PARA-LABH-CNT  PIC  9(06)   VALUE  ZERO.
     03  PARA-LABM-CNT  PIC  9(06)   VALUE  ZERO.
     03  PARA-RERR-CNT  PIC  9(06)   VALUE  ZERO.
     03  PARA-RET-CD    PIC  9(01)   VALUE  ZERO.
*----<< ﾌｱｲﾙ ｽﾃｰﾀｽ >>--*
 01  SOK-ST            PIC  X(02).
*
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SKE0831I DSPFILE ERROR " DSP-ST " "
...
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKE0831I ZSOKMS1 ERROR " SOK-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FKE08311.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "SKE0831I"      TO   PGID.
     MOVE    "FKE08311"      TO   FORM.
*
     MOVE     SPACE          TO   DSP-CNTL.
     MOVE     "FKE08311"     TO   DSP-FMT.
     ...
     EVALUATE DSP-FNC
         ...
         WHEN ENT
              ...
              IF  ERR-FLG   =    ZERO
                  ...
                  CALL "PKE08350" USING   PARA-SOKCD
                                          PARA-JOHO-CNT
                                          PARA-LABH-CNT
                                          PARA-LABM-CNT
                                          PARA-RERR-CNT
