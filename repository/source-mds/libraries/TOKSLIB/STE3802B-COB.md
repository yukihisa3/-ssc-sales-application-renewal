...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/STE3802B.COB`
...
***  ﾜｰｸ  ｴﾘｱ
 01  WRK-AREA.
     03  WK-TORICD                PIC  9(08)     VALUE   880.
...
*    ﾐﾀﾞｼ
 01  HEAD-00.
     ...
     03  HD001                    PIC  X(09) VALUE "ﾎｰﾏｯｸｶﾝﾄｳ".
*
