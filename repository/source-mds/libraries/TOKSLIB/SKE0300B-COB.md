...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKE0300B.COB`
...
*----<< 出荷情報データ >>--*
 RUI-ERR              SECTION.
     ...
     DISPLAY  "### SKE0300B RUISYUF    ERROR " RUI-ST " "
...
*----<< 梱包ラベルデータ >>--*
 KON-ERR                SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     "4000"         TO   PROGRAM-STATUS.
     DISPLAY  "### SKE0300B RUIKONF    ERROR " KON-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
*----<< 伝票データ >>--*
 DENL-ERR               SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     "4000"         TO   PROGRAM-STATUS.
     DISPLAY  "### SKE0300B SHTDENL1   ERROR " DEN-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
*----<< ケーヨー送信データ >>--*
 SND-ERR                SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     "4000"         TO   PROGRAM-STATUS.
     DISPLAY  "### SKE0300B SNDKENF ERROR " SND-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
*----<< 倉庫検収Ｆ >>--*
 SOK-ERR               SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     "4000"         TO   PROGRAM-STATUS.
     DISPLAY  "### SKE0300B KENSOKL1   ERROR " SOK-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
...
*    送信ＦＬＧチェック
     ...
     END-IF.
*    取引先制限
*****IF       RUI-F04   =   760  OR  173
     IF       RUI-F04   =   760
              CONTINUE
     ELSE
*    ※取引先対象外の場合は、売上伝票Ｆの送信Ｆはセットする。
*      また、送信完了データも作成する。
              PERFORM  SHTDENF-READ-SEC
