...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY0006B.COB`
...
*    修正概要　　　　　　：　基幹サーバ統合                    *
*　　更新日／更新者　　　：　12/08/16  /  NAV TAKAHASHI        *
*    修正概要　　　　　　：　小売連携区分追加                  *
*　　更新日／更新者　　　：　18/01/31  /  NAV MIURA            *
*    修正概要　　　　　　：　在庫引落ＦＬＧをセット            *
*　　更新日／更新者　　　：　20/07/17  /  NAV TAKAHASHI        *
*    修正概要　　　　　　：　ストックＮＯ管理区分追加          *
*　                                                            *
****************************************************************
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY0006B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY0006B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
****************************************************************
 INIT-SEC               SECTION.
     ...
     OPEN     INPUT     SHTDENLA  TOKMS2  SHOTBL1  MEIMS1.
     OPEN     OUTPUT    SHWHACF.
...
*#2020/07/17 NAV ST ストックNO管理区分取得
     MOVE     DEN-F1411      TO   MEI-F011.
     MOVE     DEN-F1412      TO   MEI-F012.
     READ    MEIMS1
       INVALID
             MOVE   SPACE    TO   HAC-F10(1:1)
       NOT  INVALID
             MOVE   MEI-F97  TO   HAC-F10(1:1)
     END-READ.
*#2020/07/17 NAV ED ストックNO管理区分取得
...
*2012/08/16 UPDATE ST ↓小売連携区分追加
     MOVE     DEN-F32        TO   HAC-F22.
*2012/08/16 UPDATE ED ↑小売連携区分追加
...
*
     CLOSE     SHTDENLA  TOKMS2  SHWHACF  SHOTBL1  MEIMS1.
*
     STOP      RUN.
*
 END-EXIT.
