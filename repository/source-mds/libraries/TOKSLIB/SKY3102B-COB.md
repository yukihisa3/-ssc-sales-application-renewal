...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKY3102B.COB`
...
*----<<ＡＣＯＳ計上Ｆ（全社）>>----*
 ...
 01  ACOS-REC           PIC X(150).
*----<<ＡＣＯＳ計上正常Ｆ（全社）>>----*
 FD  ACOSOK
                        BLOCK CONTAINS      1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  ACOSOK-REC         PIC X(150).
*----<<ＡＣＯＳ計上エラーＦ（全社）>>----*
 FD  ACOSERR
                        BLOCK CONTAINS      1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  ACOSERR-REC        PIC X(150).
*--------------------------------------------------------------*
...
*
 01  PG-ID              PIC  X(08)     VALUE  "SKY3102B".
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
...
*--------------------------------------------------------------*
 ...
 ACOS1                  SECTION.
     ...
     DISPLAY  "### SKY3102B ACOS ERROR " ACS-ST " "
 ...
 ACOS2                  SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKY3102B ACOSOK  ERROR " ACSOK-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
 ACOS3                  SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKY3102B ACOSERR ERROR " ACSERR-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
