...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SHA0050L.COB`
...
******************************************************************
 ...
 FD  PRTF.
     COPY        FHA00502  OF        XMDLIB
                 JOINING   PRT   AS  PREFIX.
 FD  DSPF.
     COPY        FHA00501  OF        XMDLIB
...
***********************************************************
 PROC-SEC                  SECTION.
     DISPLAY  "**  SHA0050L   START  **"   UPON  CONS.
*
     PERFORM     INIT-SEC.
     PERFORM     MAIN-SEC  UNTIL     END-FLG  =  "END".
     PERFORM     END-SEC.
*
     DISPLAY  "**  SHA0050L    END   **"   UPON  CONS.
     STOP        RUN.
 PROC-EXIT.
     EXIT.
**********************************************************
