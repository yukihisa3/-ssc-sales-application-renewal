...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SJH2701B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJH2701B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJH2701B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*****MOVE        SYS-DATE  TO        SYS-DATEW.
*****COMPUTE     SYS-DATEW = WK-NEN * 10000 + SYS-DATEW.
...
*ファイルヘッダ処理
        IF    DEN-01B(IDX)  =     "A"
              ...
              MOVE   WK-FL04      TO   WK-TORICD
              MOVE   WK-FL09      TO   WK-TORINM
        END-IF
*伝票ヘッダ処理
        IF    DEN-01B(IDX)  =     "B"
*             出荷場所件数マスタ出力
...
*各量販店領域転送
*    取引先コード
     MOVE     WK-TORICD     TO        HEN-A01.
*    伝票_
     MOVE     WK-DH06       TO        HEN-A02.
*    行_
     MOVE     WK-DD04       TO        HEN-A03.
*    部門（Ｈ）
     MOVE     WK-DH08       TO        HEN-A04.
*    直送区分
     IF       WK-DH20       =         "ﾁｮｸｿｳ"
              MOVE    "1"   TO        HEN-A05
     END-IF.
*    発注者名（社名）
     MOVE     "K.K ｴﾝﾁｮｰ"   TO        HEN-A06.
*    取引先名称
     MOVE     WK-TORINM     TO        HEN-A071.
*    発注日
     MOVE     WK-DH13       TO        HEN-A08.
*    納品日
     MOVE     WK-DH14       TO        HEN-A09.
*    便
*****MOVE                   TO        HEN-A10.
*    ルート
     MOVE     WK-DH10       TO        HEN-A12.
*    販売区分名
     MOVE     WK-DH17       TO        HEN-A131.
*    支払区分名
     MOVE     WK-DH18       TO        HEN-A132.
*    伝票区分
*****MOVE     WK-DH06       TO        HEN-A14.
*    商品コード
     MOVE     WK-DD05       TO        HEN-A151.
     MOVE     WK-DD06       TO        HEN-A152.
*    品名
     MOVE     WK-DD07       TO        HEN-A16.
*    規格
     MOVE     WK-DD08       TO        HEN-A17.
*    ジャンボ納品区分名
     MOVE     WK-DH19       TO        HEN-A181.
*    エンチョー納品区分名
     MOVE     WK-DH20       TO        HEN-A182.
*    注文書_
     MOVE     WK-DH21       TO        HEN-A183.
*    入数
...
*    原価金額
     COMPUTE  HEN-A24      =     HEN-A22      *    HEN-A23.
*    売単価
     MOVE     WK-DD13       TO        HEN-A25.
*    売価金額
     COMPUTE  HEN-A26      =     HEN-A22      *    HEN-A25.
*    店舗コード
     MOVE     WK-DH04       TO        HEN-A27.
*    伝票枚数
     MOVE     ZERO          TO        HEN-A28.
*    店舗名
     MOVE     WK-DH16       TO        HEN-A29.
*    Ａ欄
*****MOVE                   TO        HEN-A30.
*    Ｂ欄
     MOVE     WK-DH11       TO        HEN-A31.
*    Ｃ欄
     MOVE     WK-DH12       TO        HEN-A32.
*    発注内訳
     MOVE     WK-DH07       TO        HEN-A33.
*    大分類
     MOVE     WK-DH09       TO        HEN-A34.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
...
*担当者コード
     MOVE        99        TO        HEN-F06.
*店コード
     MOVE        HEN-A27   TO        HEN-F07.
*  商品変換テーブル検索
     MOVE        HEN-A01   TO        TBL-F01.
     IF      HEN-A151      NOT =     SPACE
         MOVE    HEN-A151  TO        TBL-F02
     ELSE
         MOVE    HEN-A152  TO        TBL-F02
     END-IF.
     READ    SHOTBL1
       INVALID
...
*納入日
*****MOVE        HEN-A09   TO        HEN-F113.     97/08/08
...
*店舗名（備考）
*****MOVE        HEN-A29   TO        HEN-F22.
*自社得意先コード
*    得意先マスタ検索
     MOVE    HEN-A01       TO        TOK-F01.
     READ    TOKMS2
         INVALID
           MOVE  SPACE     TO        HEN-F24
...
*相手商品コード
     IF          HEN-A151  NOT  =  SPACE
                 MOVE        HEN-A151     TO   HEN-F25
     ELSE
                 MOVE        HEN-A152     TO   HEN-F25
     END-IF.
*伝票発行区分
     MOVE        9         TO        HEN-F272.
*オンライン区分
