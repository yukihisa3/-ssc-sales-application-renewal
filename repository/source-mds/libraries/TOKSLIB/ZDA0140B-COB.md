...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/ZDA0140B.COB`
...
**** メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "ZDA0140B".
...
*
*## 1999/12/27 NAV START
*****MOVE    TO0-F10(1:4)     TO    WRK-DATE2.
...
*
*****DISPLAY   "WRK-DATE1 =  "   WRK-DATE1 UPON CONS.
*****DISPLAY   "WRK-DATE2 =  "   WRK-DATE2 UPON CONS.
...
*                        次月入庫数
                   ...
                   COMPUTE   ZAI-F04   =   ZAI-F04  +  TO0-F15
*******************COMPUTE   ZAI-F19   =   ZAI-F19  +  TO0-F15
              WHEN   2
*                        次月出庫数
