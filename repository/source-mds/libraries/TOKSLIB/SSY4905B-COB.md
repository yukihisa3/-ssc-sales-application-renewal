...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY4905B.COB`

## ソースコード

```cobol
****************************************************************
*         SYSTEM･･･仙台ガーデナー　物品受領書データ作成        *
*        PG-NAME･･･物品受領書データ作成                        *
*          PG-ID･･･SSY4905B                                    *
*                                            DATE. 03.04.15    *
*                                              BY. NAV         *
...
*    ガーデナー物品受領書ファイル
     SELECT   HOMJYUF            ASSIGN    TO   DA-01-VI-HOMJYUL1
...
***  ﾜｰｸ  ｴﾘｱ
 ...
 01  HOMJYUF-INV-FLG              PIC  X(03)     VALUE   SPACE.
*
...
****  メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SSY4905B".
...
*--- << 受信ﾃﾞｰﾀ ｴﾗｰ >> ---*
 000-DENP-ERR           SECTION.
     ...
     STOP      RUN.
*--- << 物品受領ﾃﾞｰﾀ >> ---*
 000-HOMJYUF-ERR        SECTION.
     USE      AFTER     EXCEPTION   PROCEDURE    HOMJYUF.
     MOVE     "HOMJYUL1"       TO   ERR-FL-ID.
...
*             行番号
              ...
              PERFORM HOMJYUF-READ-SEC
              IF  HOMJYUF-INV-FLG  =  "INV"
                 MOVE      DEN-REC        TO   WK-DEPD-REC
                 MOVE      SPACE          TO   JYU-REC
                 INITIALIZE                    JYU-REC
*                受信日
...
*             ファイルＲＥＡＤ処理                  2.5.1      *
****************************************************************
 HOMJYUF-READ-SEC       SECTION.
*
     READ     HOMJYUF
              INVALID      MOVE  "INV"   TO   HOMJYUF-INV-FLG
              NOT INVALID  MOVE  SPACE   TO   HOMJYUF-INV-FLG
     END-READ.
*
 HOMJYUF-READ-EXIT.
     EXIT.
