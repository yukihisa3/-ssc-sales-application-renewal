...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SJS0041L.COB`
...
*
*実績集計ファイル
     SELECT   JISSYUF        ASSIGN        TO  01-VI-JISSYUL1
...
****  見出し行１             ****
 01  MIDASI1        CHARACTER     TYPE   IS   YA.
     ...
     02  FILLER              PIC  X(08)  VALUE  "SJS0041L".
...
*メッセージ情報
 01  MSG-AREA.
     03  MSG-ABEND1.
         05  FILLER          PIC  X(12)  VALUE  "### SJS0041L".
...
*=============================================================
 CONTROL-SEC         SECTION.
     DISPLAY  "**  SJS0041L   START  **"   UPON  CONS.
*
     PERFORM  INIT-SEC.
     PERFORM  MAIN-SEC    UNTIL  MAIN-FLG  =  99.
     PERFORM  END-SEC.
*
     DISPLAY  "**  SJS0041L    END   **"   UPON  CONS.
     STOP  RUN.
 CONTROL-EXIT.
     EXIT.
*=============================================================
...
*初期画面の処理
     ...
     MOVE "FJS00401"        TO    DSP-FMT.
     MOVE  SPACE            TO    DSP-FJS00401.
     PERFORM  OPT-CLR-SEC.
*年月
...
*取引先
     MOVE  OLD-F03          TO   BUT-F01  PRT-TOKCD.
     READ  BUTOKMF
         INVALID  KEY
             MOVE  ALL NC"＊"    TO   PRT-TOKNM
         NOT INVALID  KEY
