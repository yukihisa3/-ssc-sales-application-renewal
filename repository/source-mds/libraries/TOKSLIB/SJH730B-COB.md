...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SJH730B.COB`
...
*ヘッドレコード退避ワーク
 01  WK-DEPB-REC.
     ...
     03  WK-DEPB12          PIC  X(06).
     03  WK-DEPB13          PIC  X(22).
...
*    明細レコード退避ワーク
 01  WK-DEPD-REC.
     ...
     03  WK-DEPD14          PIC  X(30).
     03  WK-DEPD15          PIC  X(01).
     03  WK-DEPD16          PIC  X(02).
     03  WK-DEPD17          PIC  X(16).
*
 01  WK-AREA.
*システム日付の編集
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJH7301B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJH7301B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    区分
     MOVE     WK-DEPD16     TO        HEN-A36.
*    空白
     MOVE     WK-DEPD17     TO        HEN-A37.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
...
*        商品名
         ...
         MOVE    HEN-A34(16:15)  TO   HEN-F1422
       NOT INVALID
         MOVE    HEN-A34(1:15)   TO   HEN-F1421
         MOVE    HEN-A34(16:15)  TO   HEN-F1422
     END-READ.
