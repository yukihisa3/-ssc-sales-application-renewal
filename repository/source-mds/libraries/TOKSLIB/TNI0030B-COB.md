...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/TNI0030B.COB`
...
*--<< ﾌﾟﾘﾝﾄ AREA >>-*
 ...
 01  HEAD04.
     03  FILLER         CHARACTER TYPE MODE-2.
         ...
         05  FILLER     PIC  X(01)     VALUE  "M".
         05  FILLER     PIC  N(03)     VALUE  NC"未登録".
         05  FILLER     PIC  X(03)     VALUE  " 5:".
         05  FILLER     PIC  N(02)     VALUE  NC"伝票".
         05  FILLER     PIC  N(03)     VALUE  NC"未承認".
...
*##               WHEN   "01541580"
*##                       MOVE   2910       TO  TOKU-F01
*2006/09/12       北海道ホーマック（植物）
*##               WHEN   "01582450"
*##                       MOVE   2910       TO  TOKU-F01
*2007/05/10       北海道サンワドー
*##               WHEN   "01536730"
*##                       MOVE   2910       TO  TOKU-F01
*2007/06/25       北海道トステムビバ
*##               WHEN   "01561200"
*##                       MOVE   2910       TO  TOKU-F01
*                 西日本コーナン
*##               WHEN   "27532070"
*##                       MOVE   2930       TO  TOKU-F01
*                 西日本カーマ
*##               WHEN   "23521530"
*##                       MOVE   2930       TO  TOKU-F01
*                 西日本カーマ植物 2006/10/05
