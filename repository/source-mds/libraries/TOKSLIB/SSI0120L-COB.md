...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSI0120L.COB`
...
*
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
 01  PG-ID              PIC  X(08)     VALUE   "SSI0120L".
*
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
...
*****DISPLAY "SSI-END = " SSI-END UPON CONS.
...
*伝票区分名称セット
     ...
     END-EVALUATE.
*取引先コード
     MOVE     SSI-F25                  TO   WK-TORI.
     MOVE     HEN-TORI                 TO   ME-04  TEN-F52.
*店舗コード
     MOVE     SSI-F22                  TO   WK-TEN.
     MOVE     HEN-TEN                  TO   ME-05  TEN-F011.
*店舗名称
...
*--------------------------------------------------------------*
 900-SSI-READ           SECTION.
     IF       SSI-END   =   1
**************DISPLAY "SSI-END(1) = " SSI-END UPON CONS
     ...
     READ     SSIHARAD
         AT END
              ...
              MOVE      1         TO   SSI-END
**************DISPLAY "SSI-END(2) = " SSI-END UPON CONS
         NOT AT END
              MOVE   SSI-F21      TO   SSI-KEY
              ADD       1         TO   IN-CNT
     END-READ.
*
 900-SSI-READ-EXIT.
