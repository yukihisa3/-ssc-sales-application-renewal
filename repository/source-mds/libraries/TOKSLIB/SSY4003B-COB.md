...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY4003B.COB`
...
*****03  SER-ST1             PIC  X(04)  VALUE  SPACE.
...
****************************************************************
 INIT-SEC                    SECTION.
     OPEN        INPUT       HSERJNL   HTOKMS   HTENMS   HMEIMS
                 I-O         SHTBIKF
                 OUTPUT      SHTDENWK.
 INIT-EXIT.
     EXIT.
...
*伝票ＲＥＣ初期化
     ...
     INITIALIZE  DEN2-REC.
*
     MOVE     SER-F11        TO        DEN2-F01.
     MOVE     SER-F01        TO        DEN2-F02.
     MOVE     SER-F02        TO        DEN2-F03.
     MOVE     40             TO        DEN2-F051.
     MOVE     NC"売上伝票"   TO        DEN2-F052.
     MOVE     SER-F03        TO        DEN2-F06.
     MOVE     SER-F162(I)    TO        DEN2-F07.
     MOVE     SER-F04        TO        DEN2-F08.
     MOVE     SER-F05        TO        DEN2-F09.
     MOVE     SER-F63        TO        DEN2-F44.
     MOVE     SER-F071       TO        DEN2-F111.
     MOVE     SER-F072       TO        DEN2-F112.
     MOVE     SER-F072       TO        DEN2-F113.
     MOVE     SER-F08        TO        DEN2-F12.
*
     MOVE     SER-F09        TO        DEN2-F131.
     MOVE     SER-F10        TO        DEN2-F132.
     MOVE     SER-F60        TO        DEN2-F134.
     MOVE     SER-F621       TO        DEN2-F1411.
     MOVE     SER-F622       TO        DEN2-F1412.
     MOVE     SER-F1211      TO        DEN2-F1421.
     MOVE     SER-F1212      TO        DEN2-F1422.
     MOVE     SER-F163(I)    TO        DEN2-F15.
*93/05/10. ﾂｲｶ S
     MOVE     SER-F621       TO        MEI-F011.
     MOVE     SER-F622       TO        MEI-F012.
     PERFORM  MEI-READ.
*\\ 94.12.01 START
*****IF       MEI-F93  =  1
*******MOVE     "1"            TO      DEN2-F16
...
*
*93/05/10. ﾂｲｶ E
     MOVE     SER-F65        TO        DEN2-F172.
     MOVE     SER-F132       TO        DEN2-F173.
*
     COMPUTE  DEN2-F181 =    DEN2-F15  *    DEN2-F172.
     COMPUTE  DEN2-F182 =    DEN2-F15  *    DEN2-F173.
     MOVE     SER-F15        TO        DEN2-F22.
     MOVE     SER-F11        TO        TOK-F01.
     PERFORM  TOK-READ.
     MOVE     TOK-F52        TO        DEN2-F24.
     MOVE     SER-F121       TO        DEN2-F25.
     MOVE     SER-F56        TO        DEN2-F26.
     MOVE     SER-F57        TO        DEN2-F27.
*    93/02/18. ﾂｲｶ S
     MOVE     TOK-F89        TO        DEN2-F276.
     MOVE     TOK-F89        TO        DEN2-F27B.
*    93/02/18. ﾂｲｶ E
     MOVE     SER-F58        TO        DEN2-F28.
     MOVE     SER-F59        TO        DEN2-F29.
     MOVE     SER-F11        TO        TEN-F52.
     MOVE     SER-F162(I)    TO        TEN-F011.
     PERFORM  TEN-READ.
     MOVE     TEN-F04        TO        DEN2-F30.
     MOVE     SER-F99        TO        DEN2-F99.
*    ｾﾘNO.
     MOVE     SER-F01        TO        DEN2-F57.
     MOVE     SER-F02        TO        DEN2-F58.
*    ｲﾘｽｳ
     MOVE     SER-F66        TO        DEN2-F171.
*
     WRITE    DEN2-REC.
 TEN-EXIT.
     EXIT.
...
*量販店備考ワーク存在したら出力しない。
     ...
     INITIALIZE                        BIK-REC.
     MOVE     SER-F11        TO        BIK-F01.
     MOVE     SER-F01        TO        BIK-F02.
     MOVE     80             TO        BIK-F03.
     READ     SHTBIKF
         INVALID
              CONTINUE
...
*
     ...
     MOVE     SER-F03        TO        BIK-F06.
     MOVE     SER-F162(I)    TO        BIK-F07.
     MOVE     SER-F04        TO        BIK-F08.
     MOVE     SER-F05        TO        BIK-F09.
     MOVE     SER-F63        TO        BIK-F44.
     MOVE     SER-F071       TO        BIK-F111.
     MOVE     SER-F072       TO        BIK-F112.
     MOVE     SER-F072       TO        BIK-F113.
     MOVE     SER-F08        TO        BIK-F12.
*
     MOVE     SER-F09        TO        BIK-F131.
     MOVE     SER-F10        TO        BIK-F132.
     MOVE     SER-F60        TO        BIK-F134.
     MOVE     SER-F61        TO        BIK-F1411.
     MOVE     SER-F141       TO        BIK-F1421.
     MOVE     SER-F142       TO        BIK-F1422.
     MOVE     SER-F11        TO        TOK-F01.
     PERFORM  TOK-READ.
     MOVE     TOK-F52        TO        BIK-F24.
     MOVE     SER-F56        TO        BIK-F26.
     MOVE     SER-F57        TO        BIK-F27.
     MOVE     SER-F58        TO        BIK-F28.
     MOVE     SER-F59        TO        BIK-F29.
     MOVE     SER-F11        TO        TEN-F52.
     MOVE     SER-F162(I)    TO        TEN-F011.
     PERFORM  TEN-READ.
     MOVE     TEN-F04        TO        BIK-F30.
     MOVE     SER-F99        TO        BIK-F99.
*
     WRITE    BIK-REC.
 TEN-EXIT2.
     EXIT.
...
****************************************************************
 END-SEC                   SECTION.
     CLOSE    HSERJNL   HTOKMS   SHTDENWK   HMEIMS    SHTBIKF.
 END-EXIT.
     EXIT.
****************************************************************
*    取引先マスタ　 READ
