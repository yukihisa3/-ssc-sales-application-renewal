...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/STE2302B.COB`
...
*
 ...
 FILE-CONTROL.
*    伝票データ
     SELECT   HKYOTU1            ASSIGN    TO    DA-01-VI-HKYOTU1
