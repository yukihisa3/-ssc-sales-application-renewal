...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SCV0170B.COB`
...
*処理区分により各項目更新
     IF   JHMTJSF-INV-FLG  =  "INV"
          ...
          MOVE LINK-IN-JTIME  TO TJS-F02
          MOVE LINK-IN-JTOKCD TO TJS-F03
          MOVE LINK-IN-JTIMES TO TJS-F04
          MOVE LINK-IN-JTIMEE TO TJS-F05
          MOVE LINK-IN-HTIMES TO TJS-F06
          MOVE LINK-IN-HTIMEE TO TJS-F07
          MOVE 1              TO TJS-F10
          WRITE TJS-REC
     ELSE
          MOVE LINK-IN-JTIMES TO TJS-F04
