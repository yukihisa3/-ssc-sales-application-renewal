...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSE7106L.COB`
...
*----<< 請求合計ファイル >>--*
 SEI-ERR                SECTION.
     ...
     ACCEPT   WK-DATE       FROM DATE.
     ACCEPT   WK-TIME       FROM TIME.
     DISPLAY  "### OSKT300 JDJSEKF ERROR " SEI-ST " "
              WK-Y "." WK-M "." WK-D " "
              WK-HH ":" WK-MN ":" WK-SS " ###"
                                       UPON CONS.
     MOVE    4000             TO    PROGRAM-STATUS.
...
*--------------------------------------------------------------*
 900-SEI-START-READ     SECTION.
     START    JDJSEKF   KEY  >=   SEI-F01   SEI-F02
                                  SEI-F03
              INVALID   KEY
