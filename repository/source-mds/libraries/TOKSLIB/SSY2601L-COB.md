...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY2601L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*ヒラサダ産業伝票データ（共通）　　
     SELECT   HSSHIRED  ASSIGN    TO        HSSHIRED
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      HSSHIRED.
...
*    規格
     MOVE     DEN-A163            TO   DT2-02.
*    商品コード
     MOVE     DEN-A15             TO   DT2-03.
*    入数
     MOVE     DEN-A19             TO   DT2-04.
*    ケース(発注数)
     MOVE     DEN-A20             TO   DT2-05.
*    数量
...
*ヘッダ３行目
*    店舗名称
     MOVE     DEN-A28            TO    HD3-01.
*    店舗コード
     MOVE     DEN-A26(3:3)       TO    HD3-02.
*    分類コード(部コード)
     MOVE     DEN-A04            TO    HD3-03.
*    伝票区分
     MOVE     DEN-A14            TO    HD3-04.
*    伝票_
     MOVE     DEN-A02            TO    HD3-05.
*    取引先コード
     MOVE     DEN-A01            TO    HD3-06.
*    発注日
     MOVE     DEN-A08            TO    HD3-07.
*    納品日
...
*項目クリア
     MOVE     SPACE               TO   HD1 HD2 HD3
                                       ...
                                       TL1 TL2.
*テスト印字項目セット
     MOVE   ALL "9"              TO   HD3-03    HD3-04    HD3-05
                                      HD3-07    HD3-08
...
*
     CLOSE    HSSHIRED   PRTFILE    DSPFILE.
*
 END-EXIT.
     EXIT.
