...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY0011B.COB`
...
*# 2020/07/17 NAV ED
*発注集計プリントファイル
     SELECT   HACYUPRT  ASSIGN         HACYUPRT
...
*    FILE = 発注集計プリントファイル                           *
****************************************************************
 FD  HACYUPRT           LABEL     RECORD   IS   STANDARD
...
*発注集計プリントファイル
 HAC-ERR                SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  SEC-NAME       UPON CONS.
     DISPLAY  "### " PG-ID " HACYUPRT ERROR " HAC-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     MOVE     "4000"         TO   PROGRAM-STATUS.
