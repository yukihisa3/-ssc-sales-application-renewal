...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSE0140B.COB`
...
*----<< ワークファイル >>--*
 WORK01-ERR              SECTION.
     ...
     DISPLAY  "### SSE0140B WORK01 ERROR " WORK-ST " "
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSE0140B HTOKMS ERROR " TOK-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
***  CLOSE    WORK01    HTOKMS    CVCSKHAI  PRTF.
...
*----<< 配信データ >>--*
 CVCSKHAI-ERR           SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSE0140B CVCSKHAI ERROR " CVCSKHAI-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
**** CLOSE    WORK01    HTOKMS    CVCSKHAI  PRTF.
...
*--------------------------------------------------------------*
 300-END-RTN            SECTION.
     ...
     CLOSE    PRTF.
*
     DISPLAY "+++ SSE0140B INPUT =" IN-CNT  " +++" UPON CONS.
     DISPLAY "+++ SSE0140B OUTPUT=" OUT-CNT " +++" UPON CONS.
*****内部統制対応 2008/08/28
     MOVE     OUT-CNT   TO       PARA-OUT-CNT.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "*** SSE0140B END *** "
              SYS-YY "." SYS-MM "." SYS-DD " "
