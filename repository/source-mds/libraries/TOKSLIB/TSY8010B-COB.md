...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/TSY8010B.COB`
...
*----<< 伝票データ >>--*
 HDENJNL-ERR            SECTION.
     ...
     DISPLAY  "### TSY8010B HDENJNL ERROR " HDENJNL-ST " "
...
*----<< 入庫データ >>--*
 NYKFILF-ERR            SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### TSY8010B NYKFILF ERROR " NYKFILF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     CLOSE    TOKU.
...
*----<< 入出庫データ >>--*
 NYSFILF-ERR            SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### TSY8010B NYSFILF ERROR " NYSFILF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     CLOSE    TOKU.
...
*----<< 作業データ >>--*
 SGYFILF-ERR            SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### TSY8010B SGYFILF ERROR " SGYFILF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     CLOSE    TOKU.
...
*----<< 売上データ >>--*
 TOKU-ERR               SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### TSY8010B TOKU ERROR " TOKU-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     CLOSE    TOKU.
...
*----<< ワークＦ >>--*
 HKYOTU-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### TSY8010B HKYOTU  ERROR " KYO-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     CLOSE    TOKU.
...
* 2011/10/06,S  S.I/NAV
     MOVE  TOKU-F07         TO  DEN-F07.  *> 店舗CD
     MOVE  TOKU-F09         TO  DEN-F112. *> 納品日
* 2011/10/06,E  S.I/NAV
     READ   HDENJNL
       INVALID
**        DISPLAY  NC"伝票未登録＝" " "
