...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY6505L.COB`
...
*
     COPY    FSY65051   OF   XMDLIB.
****************************************************************
*    FILE = ﾌﾟﾘﾝﾄ F                                            *
****************************************************************
 FD  PRTFILE.
     COPY    FSY65052   OF   XMDLIB.
****************************************************************
...
***  連番１
     MOVE     DEN-A12             TO   K08(IX).
***  連番２
     MOVE     DEN-F03             TO   K09(IX).
***  部門
     MOVE     DEN-A101            TO   K10(IX).
***  売価単価
     MOVE     DEN-A25             TO   K11(IX).
***  納品日
     MOVE     DEN-A05             TO   NOUDT(IX).
*
     PERFORM  FL-READ-SEC.
*
 DENP-WT-EXIT.
...
*
     ...
     MOVE     "FSY65051"          TO        DSP-FMT.
*項目設定
***  伝票枚数
     MOVE     WK-MAI              TO        MD01.
***  プログラムＩＤ
     MOVE     "SSY6505L"          TO        PGID.
***  日付
