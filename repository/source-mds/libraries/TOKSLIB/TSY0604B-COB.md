...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/TSY0604B.COB`
...
****************************************************************
 ...
 DEN2-ERR                    SECTION.
     ...
     DISPLAY "FILE:SHTDENWK ERROR = " DEN2-ST  UPON CONS.
 ...
 DEN-ERR                     SECTION.
     ...
     DISPLAY "FILE:SHTDENF  ERROR = " DEN-ST  UPON CONS.
     MOVE        4000        TO        PROGRAM-STATUS.
     ACCEPT      IN-DATA     FROM      CONS.
     STOP        RUN.
 TOK-ERR                     SECTION.
     ...
     DISPLAY "FILE:HTOKMS   ERROR = " TOK-ST  UPON CONS.
     MOVE        4000        TO        PROGRAM-STATUS.
     ACCEPT      IN-DATA     FROM      CONS.
     STOP        RUN.
 PRT-ERR                     SECTION.
     ...
     DISPLAY "FILE:PRTFILE  ERROR = " PRT-ST  UPON CONS.
     MOVE        4000        TO        PROGRAM-STATUS.
     ACCEPT      IN-DATA     FROM      CONS.
     STOP        RUN.
 ZAI-ERR                     SECTION.
     ...
     DISPLAY "FILE:ZAMZAIF  ERROR = " ZAI-ST  UPON CONS.
     MOVE        4000        TO        PROGRAM-STATUS.
     ACCEPT      IN-DATA     FROM      CONS.
     STOP        RUN.
 SHO-ERR                     SECTION.
     ...
     DISPLAY "FILE:HSHOTBL  ERROR = " SHO-ST  UPON CONS.
     MOVE        4000        TO        PROGRAM-STATUS.
     ACCEPT      IN-DATA     FROM      CONS.
     STOP        RUN.
 MEI-ERR                     SECTION.
     ...
     DISPLAY "FILE:HMEIMS   ERROR = " MEI-ST  UPON CONS.
     MOVE        4000        TO        PROGRAM-STATUS.
     ACCEPT      IN-DATA     FROM      CONS.
     STOP        RUN.
 BIK-ERR                     SECTION.
     ...
     DISPLAY "FILE:SHTBIKF  ERROR = " BIK-ST  UPON CONS.
     MOVE        4000        TO        PROGRAM-STATUS.
     ACCEPT      IN-DATA     FROM      CONS.
     STOP        RUN.
 DME-ERR                     SECTION.
     ...
     DISPLAY "FILE:DENMEISF ERROR = " DME-ST  UPON CONS.
     MOVE        4000        TO        PROGRAM-STATUS.
     ACCEPT      IN-DATA     FROM      CONS.
     STOP        RUN.
 END DECLARATIVES.
