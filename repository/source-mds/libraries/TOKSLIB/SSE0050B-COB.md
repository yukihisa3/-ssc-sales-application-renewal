...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSE0050B.COB`
...
*
 ...
 FILE-CONTROL.
***≪入庫ファイル≫*********************************************
     SELECT  ZNYUKDTF   ASSIGN    TO  DA-S-ZNYUKDT
...
*----≪請求合計ファイル≫--------------------------------------*
 FD  OUTF.
     COPY    ZNYUKDT    OF   XFDLIB    JOINING   OUT  PREFIX.
****  作業領域  ************************************************
 WORKING-STORAGE        SECTION.
****************************************************************
 01  PGM-ID             PIC   X(08)    VALUE     "SSE0050B".
*----≪フラグ≫------------------------------------------------*
 01  FLG.
