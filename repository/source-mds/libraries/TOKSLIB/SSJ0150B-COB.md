...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSJ0150B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJH3501B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJH3501B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*原価金額
     COMPUTE     HEN-F181 = HEN-A244 * HEN-A25.
*売価金額
     COMPUTE     HEN-F182 = HEN-A244 * HEN-A26.
*店舗名（備考）
...
*修正原価金額
     COMPUTE     HEN-F521 = HEN-A244 * HEN-A25.
*修正売価金額
     COMPUTE     HEN-F522 = HEN-A244 * HEN-A26.
*
 TENSO-EXIT.
     EXIT.
****************************************************************
