...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY3107I.COB`
...
*    サブシステム　　　　：　カーマオンラインシステム          *
*    業務名　　　　　　　：　カーマオンラインシステム          *
*    モジュール名　　　　：　カーマ出荷情報送信ＤＴ作成指示    *
*    作成日／更新日　　　：　2002/04/06                        *
*    作成者／更新者　　　：　NAV                              *
*    処理概要　　　　　　：　画面より、カーマ出荷情報送信ＤＴ  *
*                            作成の指示・確認を行なう。        *
****************************************************************
...
***********************************************************
 DSP-INT-SEC               SECTION.
     MOVE        SPACE     TO        FSY31071.
     MOVE       "SCREEN"   TO        DSP-GRP.
     MOVE       "FSY31071" TO        DSP-FORM.
     MOVE       "CL"       TO        DSP-PROC.
