...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKY3701L.COB`
...
*    サブシステム　　　　：　受配信                            *
*    モジュール名　　　　：　ＰＧ実行結果リスト                *
*    作成日／作成者　　　：　2000/08/28 T.TAKAHASHI            *
*    更新日／更新者　　　：　　　　　　                        *
*    処理概要　　　　　　：　　　　　　　　　　　　　　　　　　*
*                                                              *
****************************************************************
...
***  受信結果／エラー内容
     EVALUATE PARA-KBN
         WHEN "1"
         MOVE  NC"処理正常"  TO        PRT-JKEKKA
         MOVE  NC"電算室計上Ｆのクリアを行いました。　　　"
                             TO        PRT-ERRNM1
         MOVE  NC"確認して下さい。（エラーの有無確認）　　"
                             TO        PRT-ERRNM2
         WHEN "2"
         MOVE  NC"処理異常"  TO        PRT-JKEKKA
         MOVE  NC"電算室計上Ｆのクリア処理でエラーは発生し"
                             TO        PRT-ERRNM1
         MOVE  NC"ました。ＮＡＶへ連絡して下さい。　　　　"
                             TO        PRT-ERRNM2
     END-EVALUATE.
*プリント出力
     MOVE        SPACE       TO   PRT-CONTROL.
     MOVE        "FKY35011"  TO   PRT-FORMAT.
