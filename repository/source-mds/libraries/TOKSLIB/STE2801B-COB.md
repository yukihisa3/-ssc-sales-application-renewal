...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/STE2801B.COB`
...
*プリンター
 FD  PRTF
     ...
     COPY        FTE28011  OF        XMDLIB.
*表示ファイル
 FD  DSPF
     LABEL       RECORD    IS        OMITTED.
     COPY        FTE28012  OF        XMDLIB.
******************************************************************
...
*****ﾃﾞﾝﾋﾟﾖｳ ｷ-
     ...
     03  WK-HATYUNO               PIC  X(07)     VALUE   SPACE.
*****ﾒｯｾ-ｼﾞ ｴﾘｱ
 01  MSG-AREA.
...
*****各ファイルオープン
     OPEN        I-O       DSPF
                 ...
                 OUTPUT    PRTF.
*****画面初期化
     MOVE     SPACE              TO   FTE28012.
     MOVE     ZERO               TO   WK-DEN.
     MOVE     ZERO               TO   CNT-DENPYO.
*////PERFORM  DSP-WRT-SEC.
*****帳票初期化
     MOVE        SPACE     TO        FTE28011.
*****伝票枚数カウント
     MOVE     ZERO         TO    WK-MAI.
*  2011/10/05,S  S.I/NAV
...
*****発注日（パックタイプ変換）
     MOVE     KYO-F111            TO   DATE-HENKAN.
     MOVE     DATE-HENKAN(3:6)    TO   HD11.
*****納品日（パックタイプ変換）
*****便
*****発注依頼書Ｎｏ（ワーク格納）
     MOVE     KYO-F10             TO   WK-HATYUNO.
*
 HEAD-EDT-EXIT.
     EXIT.
**********************************************************
...
*****明細エリア転送
     ...
     END-PERFORM.
*****数字タイプ転送
     MOVE   ALL "9"              TO   HD03    HD06
                                      HD08    HD10
                                      HD11    TL01
                                      TL02    TL03    TL04.
*****文字タイプ転送
     MOVE   ALL "*"              TO   HD01    HD02
                                      BIKO1   BIKO2   HATYU.
*
*****伝票発行
     PERFORM  DENP-WRT-SEC.
