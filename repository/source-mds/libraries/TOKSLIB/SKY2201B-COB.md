...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKY2201B.COB`
...
*
 ...
 FILE-CONTROL.
*----<<計上 データ >>--*
     SELECT   TOKUERR   ASSIGN         DA-01-S-TOKUERR
...
****************************************************************
 FILE                   SECTION.
*----<< 売上データ >>--*
 FD  TOKUERR            LABEL RECORD   IS   STANDARD.
     COPY     TOKUREC   OF        XFDLIB
              JOINING   TOK1      PREFIX.
*----<< 売上データ >>--*
 FD  TOK00              LABEL RECORD   IS   STANDARD.
     COPY     TOKUREC   OF        XFDLIB
              JOINING   TOH0      PREFIX.
*----<< 売上データ >>--*
 FD  TOK01              LABEL RECORD   IS   STANDARD.
     COPY     TOKUREC   OF        XFDLIB
              JOINING   TOH1      PREFIX.
*----<< 売上データ >>--*
 FD  TOK02              LABEL RECORD   IS   STANDARD.
     COPY     TOKUREC   OF        XFDLIB
              JOINING   TOH2      PREFIX.
*----<< 売上データ >>--*
 FD  TOK03              LABEL RECORD   IS   STANDARD.
     COPY     TOKUREC   OF        XFDLIB
              JOINING   TOH3      PREFIX.
*----<< 売上データ >>--*
 FD  TOK04              LABEL RECORD   IS   STANDARD.
     COPY     TOKUREC   OF        XFDLIB
              JOINING   TOH4      PREFIX.
*----<< 売上データ >>--*
 FD  TOK05              LABEL RECORD   IS   STANDARD.
     COPY     TOKUREC   OF        XFDLIB
              JOINING   TOH5      PREFIX.
*----<< 売上データ >>--*
 FD  TOK06              LABEL RECORD   IS   STANDARD.
     COPY     TOKUREC   OF        XFDLIB
              JOINING   TOH6      PREFIX.
*----<< 売上データ >>--*
 FD  TOK07              LABEL RECORD   IS   STANDARD.
     COPY     TOKUREC   OF        XFDLIB
              JOINING   TOH7      PREFIX.
*----<< 売上データ >>--*
 FD  TOK08              LABEL RECORD   IS   STANDARD.
     COPY     TOKUREC   OF        XFDLIB
              JOINING   TOH8      PREFIX.
*----<< 売上データ >>--*
 FD  TOK09              LABEL RECORD   IS   STANDARD.
     COPY     TOKUREC   OF        XFDLIB
              JOINING   TOH9      PREFIX.
*--------------------------------------------------------------*
...
*----<< ワークＦ >>--*
 TOKUERR                SECTION.
     USE AFTER     EXCEPTION PROCEDURE      TOKUERR.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKY2201B TOKUERR ERROR " TOK1-ST " "
...
*----<< ワークＦ >>--*
 TOK00                  SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKY2201B TOK00   ERROR " TOK00-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
 TOK01                  SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKY2201B TOK01   ERROR " TOK01-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
 TOK02                  SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKY2201B TOK02   ERROR " TOK02-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
 TOK03                  SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKY2201B TOK03   ERROR " TOK03-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
 TOK04                  SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKY2201B TOK04   ERROR " TOK04-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
 TOK05                  SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKY2201B TOK05   ERROR " TOK05-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
 TOK06                  SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKY2201B TOK06   ERROR " TOK06-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
 TOK07                  SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKY2201B TOK07   ERROR " TOK07-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
 TOK08                  SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKY2201B TOK08   ERROR " TOK08-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
 TOK09                  SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKY2201B TOK09   ERROR " TOK09-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
...
**             INITIALIZE              TOH3-REC
**             MOVE     TOK1-REC TO    TOH3-REC
**             WRITE    TOH3-REC
******         ADD      1        TO    TOK03-CNT
         WHEN  2931
               MOVE     SPACE    TO    TOH4-REC
               INITIALIZE              TOH4-REC
               MOVE     TOK1-REC TO    TOH4-REC
               WRITE    TOH4-REC
               ADD      1        TO    TOK04-CNT
         WHEN  2910
               MOVE     SPACE    TO    TOH0-REC
...
**             INITIALIZE              TOH6-REC
**             MOVE     TOK1-REC TO    TOH6-REC
**             WRITE    TOH6-REC
******         ADD      1        TO    TOK06-CNT
******   WHEN  2970
**             MOVE     SPACE    TO    TOH7-REC
**             INITIALIZE              TOH7-REC
**             MOVE     TOK1-REC TO    TOH7-REC
**             WRITE    TOH7-REC
******         ADD      1        TO    TOK07-CNT
******   WHEN  2980
**             MOVE     SPACE    TO    TOH8-REC
**             INITIALIZE              TOH8-REC
**             MOVE     TOK1-REC TO    TOH8-REC
**             WRITE    TOH8-REC
******         ADD      1        TO    TOK08-CNT
         WHEN  2930
*2006/01/10 NAV 西日本から本社へ変更
******         MOVE     SPACE    TO    TOH9-REC
**             INITIALIZE              TOH9-REC
**             MOVE     TOK1-REC TO    TOH9-REC
**             WRITE    TOH9-REC
******         ADD      1        TO    TOK09-CNT
               MOVE     SPACE    TO    TOH0-REC
               INITIALIZE              TOH0-REC
...
*--------------------------------------------------------------*
 300-END-RTN            SECTION.
     CLOSE    TOKUERR TOK00 TOK01 TOK02 TOK03 TOK04
                      TOK05 TOK06 TOK07 TOK08 TOK09.
*
     DISPLAY  NC"売上Ｄエラー　件数＝" IN-CNT    UPON CONS.
     DISPLAY  NC"振分エラー　　件数＝" ERR-CNT   UPON CONS.
