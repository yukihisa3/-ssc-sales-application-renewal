...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SJH4701B.COB`
...
*ファイルヘッドレコード退避ワーク
 01  WK-DEPA-REC.
     ...
     03  WK-DEPA04          PIC  X(06).
     03  WK-DEPA05          PIC  X(08).
     03  WK-DEPA06          PIC  X(08).
     03  WK-DEPA07          PIC  9(06).
     03  WK-DEPA08          PIC  9(06).
     03  WK-DEPA09          PIC  9(01).
     03  WK-DEPA10          PIC  X(08).
     03  WK-DEPA11          PIC  X(60).
     03  WK-DEPA12          PIC  X(11).
     03  WK-DEPA13          PIC  9(04).
*ヘッドレコード退避ワーク
 01  WK-DEPB-REC.
     03  WK-DEPB01          PIC  X(02).
     03  WK-DEPB02          PIC  X(08).
     03  WK-DEPB03          PIC  9(06).
     03  WK-DEPB04          PIC  9(04).
     03  WK-DEPB05          PIC  X(20).
     03  WK-DEPB06          PIC  X(06).
     03  WK-DEPB07          PIC  9(06).
     03  WK-DEPB08          PIC  9(03).
     03  WK-DEPB09          PIC  9(01).
     03  WK-DEPB10          PIC  9(03).
     03  WK-DEPB11          PIC  X(40).
     03  WK-DEPB12          PIC  X(20).
     03  WK-DEPB13          PIC  9(02).
     03  WK-DEPB14          PIC  X(02).
     03  WK-DEPB15          PIC  9(01).
     03  WK-DEPB16          PIC  9(04).
*    明細レコード退避ワーク
 01  WK-DEPD-REC.
     03  WK-DEPD01          PIC  X(02).
     03  WK-DEPD02          PIC  X(20).
     03  WK-DEPD03          PIC  X(20).
     03  WK-DEPD04          PIC  X(07).
     03  WK-DEPD05          PIC  X(13).
     03  WK-DEPD06          PIC  9(03).
     03  WK-DEPD07          PIC  9(03).
     03  WK-DEPD08          PIC  X(07).
     03  WK-DEPD09          PIC  X(05).
     03  WK-DEPD10          PIC  X(03).
     03  WK-DEPD11          PIC  9(04).
     03  WK-DEPD12          PIC  9(07).
     03  WK-DEPD13          PIC  9(07)V9(02).
     03  WK-DEPD14          PIC  X(13).
     03  WK-DEPD15          PIC  9(01).
     03  WK-DEPD16          PIC  X(02).
     03  WK-DEPD17          PIC  9(04).
     03  WK-DEPD18          PIC  9(01).
     03  WK-DEPD19          PIC  9(04).
*
 01  WK-AREA.
*システム日付の編集
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJH4701B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJH4701B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    受注企業名称
     MOVE     WK-DEPA11     TO        HEN-A11.
*    予備
     MOVE     WK-DEPA12     TO        HEN-A12.
*    仕入先ＣＤ
     MOVE     WK-DEPA13     TO        HEN-A13.
*伝票ヘッダー転送
*    レコード区分
     MOVE     WK-DEPB01     TO        HEN-A14.
*    伝票番号
     MOVE     WK-DEPB02     TO        HEN-A15.
*    伝票処理日
     MOVE     WK-DEPB03     TO        HEN-A16.
*    店舗ＣＤ
     MOVE     WK-DEPB04     TO        HEN-A17.
*    店舗名称
     MOVE     WK-DEPB05     TO        HEN-A18.
*    仕入先ＣＤ
     MOVE     WK-DEPB06     TO        HEN-A19.
*    納品指定日
     MOVE     WK-DEPB07     TO        HEN-A20.
*    部門ＣＤ
     MOVE     WK-DEPB08     TO        HEN-A21.
*    特売区分
     MOVE     WK-DEPB09     TO        HEN-A22.
*    ルートＣＤ
     MOVE     WK-DEPB10     TO        HEN-A23.
*    取引先名称
     MOVE     WK-DEPB11     TO        HEN-A24.
*    摘要
     MOVE     WK-DEPB12     TO        HEN-A25.
*    分類ＣＤ
     MOVE     WK-DEPB13     TO        HEN-A26.
*    予備
     MOVE     WK-DEPB14     TO        HEN-A27.
*    データＩＤ
     MOVE     WK-DEPB15     TO        HEN-A28.
*    仕入先ＣＤ
     MOVE     WK-DEPB16     TO        HEN-A29.
*伝票明細転送
*    レコード区分
     MOVE     WK-DEPD01     TO        HEN-A30.
*    品名
     MOVE     WK-DEPD02     TO        HEN-A31.
*    規格名
     MOVE     WK-DEPD03     TO        HEN-A32.
*    自社品番
     MOVE     WK-DEPD04     TO        HEN-A33.
*    メーカー品番
     MOVE     WK-DEPD05     TO        HEN-A34.
*    入数
     MOVE     WK-DEPD06     TO        HEN-A35.
*    ケース数
     MOVE     WK-DEPD07     TO        HEN-A36.
*    色
     MOVE     WK-DEPD08     TO        HEN-A37.
*    サイズ
     MOVE     WK-DEPD09     TO        HEN-A38.
*    単位
     MOVE     WK-DEPD10     TO        HEN-A39.
*    数量
     MOVE     WK-DEPD11     TO        HEN-A40.
*    売価単価
     MOVE     WK-DEPD12     TO        HEN-A41.
*    原価単価
     MOVE     WK-DEPD13     TO        HEN-A42.
*    ＪＡＮＣＤ
     MOVE     WK-DEPD14     TO        HEN-A43.
*    行数
     MOVE     WK-DEPD15     TO        HEN-A44.
*    予備
     MOVE     WK-DEPD16     TO        HEN-A45.
*    納品数量
     MOVE     WK-DEPD17     TO        HEN-A46.
*    データＩＤ
     MOVE     WK-DEPD18     TO        HEN-A47.
*    仕入先ＣＤ
     MOVE     WK-DEPD19     TO        HEN-A48.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
...
*取引先コード
     DISPLAY "HEN-A19 = " HEN-A19 UPON CONS.
     MOVE        HEN-A19   TO        WK-TORICD.
     MOVE    WK-HEN-TORICD TO        HEN-F01.
     MOVE    WK-HEN-TORICD TO        WK-TOKCD.
     DISPLAY "WK-HEN-TORICD = " WK-HEN-TORICD UPON CONS.
*伝票ナンバー
     MOVE        HEN-A15   TO        WK-DENNO.
     MOVE    WK-HEN-DENNO  TO        HEN-F02.
     MOVE    WK-HEN-DENNO  TO        HEN-F23.
*行_
     MOVE        HEN-A44   TO        HEN-F03.
*伝区
     MOVE        40        TO        HEN-F051.
...
*分類（部門）
     MOVE        HEN-A21   TO        HEN-F12.
*商品区分　　
     MOVE        SPACE     TO        HEN-F131.
*伝票区分　　
     MOVE        HEN-A22   TO        HEN-F132.
*伝発区分
     MOVE        9         TO        HEN-F134.
*自社商品コード
...
*    商品名称マスタ検索
     ...
     READ    MEIMS1
       INVALID
*        商品名
         MOVE    HEN-A31(1:15)  TO   HEN-F1421(1:15)
         MOVE    HEN-A31(16:5)  TO   HEN-F1422(1:5)
         MOVE    HEN-A32(1:15)  TO   HEN-F1422(6:10)
       NOT INVALID
         MOVE    HEN-A31(1:15)  TO   HEN-F1421(1:15)
         MOVE    HEN-A31(16:5)  TO   HEN-F1422(1:5)
         MOVE    HEN-A32(1:10)  TO   HEN-F1422(6:10)
     END-READ.
*数量
...
*単
     MOVE       "1"        TO        HEN-F16.
*原価単価
     MOVE        HEN-A42   TO        HEN-F172.
*売価単価
     MOVE        HEN-A41   TO        HEN-F173.
*原価金額
     COMPUTE     HEN-F181 = HEN-A40 * HEN-A42.
*売価金額
     COMPUTE     HEN-F182 = HEN-A40 * HEN-A41.
*店舗名（備考）
...
*修正原価単価
     MOVE        HEN-A42   TO        HEN-F512.
*修正売価単価
     MOVE        HEN-A41   TO        HEN-F513.
*修正原価金額
     COMPUTE     HEN-F521 = HEN-A40 * HEN-A42.
*修正売価金額
     COMPUTE     HEN-F522 = HEN-A40 * HEN-A41.
*
 TENSO-EXIT.
     EXIT.
****************************************************************
