...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY3001L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*ムラウチホビー伝票データ（共通）　　
     SELECT   MUSHIRED  ASSIGN    TO        MUSHIRED
...
*
 01  HD1.
     03  FILLER                   PIC  X(92)     VALUE   SPACE.
     03  HD1-01                   PIC  X(17)     VALUE   SPACE.
*
 01  HD2.
     03  FILLER                   PIC  X(07)     VALUE   SPACE.
     03  HD2-01                   PIC  X(20)     VALUE   SPACE.
*
 01  HD3.
     03  FILLER                   PIC  X(07)     VALUE   SPACE.
     03  HD3-01                   PIC  X(20).
     03  FILLER                   PIC  X(05)     VALUE   SPACE.
     03  HD3-02                   PIC  999999.
...
*
 01  DT1.
     ...
     03  DT1-07                   PIC  ZZZZZZZZ9.
*
 01  DT2.
     03  FILLER                   PIC  X(05)     VALUE   SPACE.
     03  DT2-01                   PIC  X(25).
     03  DT2-02                   PIC  ZZZZZZ9999999.
     03  DT2-03                   PIC  ZZZZZZZ.
     03  DT2-04                   PIC  ZZZZZ.
     03  FILLER                   PIC  X(01)     VALUE   SPACE.
     03  DT2-05                   PIC  X.
     03  DT2-06                   PIC  X.
     03  DT2-071                  PIC  ZZZZZ.
     03  DT2-072                  PIC  Z.
     03  FILLER                   PIC  X(02)     VALUE   SPACE.
     03  DT2-081                  PIC  ZZZZZ9.
     03  DT2-082                  PIC  Z.
     03  FILLER                   PIC  X(04)     VALUE   SPACE.
     03  DT2-091                  PIC  ZZZZZZ.
     03  DT2-092                  PIC  ZZ.
     03  DT2-10                   PIC  ZZZZZZZZZ.
     03  DT2-11                   PIC  ZZZZZZ.
     03  DT2-12                   PIC  ZZZZZZZZZ.
*伝票訂正用（ＤＴ・ＴＬ共通）
 01  DT21.
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      MUSHIRED.
...
*明細１行目
***  メーカーブランド名
     MOVE     DEN-A15             TO   DT1-01.
***  規格数値
     MOVE     DEN-A16             TO   DT1-02.
***  規格単位
     MOVE     DEN-A17             TO   DT1-03.
***  クラスコード
     MOVE     DEN-A18             TO   DT1-04.
***  サイズ
     MOVE     DEN-A19             TO   DT1-05.
***  訂正伝票時処理
     IF        DEN-F15   NOT =    DEN-F50
***            訂正後原価金額
               COMPUTE  DT1-06 =  DEN-F15 * DEN-F172
***            訂正後売価金額
               COMPUTE  DT1-07 =  DEN-F15 * DEN-F173
     END-IF.
*明細２行目
***  商品名称
     MOVE     DEN-A14             TO   DT2-01.
***  商品コード
     MOVE     DEN-A13             TO   DT2-02.
***  入数
     MOVE     DEN-A20             TO   DT2-03.
***  ケース
     MOVE     DEN-A21             TO   DT2-04.
***  単位
     MOVE     DEN-A22(1:1)        TO   DT2-05.
     MOVE     DEN-A22(2:1)        TO   DT2-06.
***  数量
...
***  取引先名称
     MOVE     DEN-A09             TO    HD3-08.
***  発注日
     MOVE     DEN-A10(1:2)        TO    HD3-091.
     MOVE     DEN-A10(3:2)        TO    HD3-092.
     MOVE     DEN-A10(5:2)        TO    HD3-093.
***  納品日
     MOVE     DEN-A11(1:2)        TO    HD3-101.
     MOVE     DEN-A11(3:2)        TO    HD3-102.
     MOVE     DEN-A11(5:2)        TO    HD3-103.
***  便
***  MOVE     DEN-A12             TO    HD3-11.
*
...
*
     CLOSE    MUSHIRED   PRTFILE    DSPFILE.
*
 END-EXIT.
     EXIT.
