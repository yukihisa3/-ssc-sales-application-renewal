...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY6504L.COB`
...
***  出力取引先ＣＤ
 01  WK-TOKCD                     PIC  9(08)   VALUE  299.
...
*
 01  GYO6                         CHARACTER  TYPE IS YA.
     ...
     03  TEK-TANNM11              PIC  N(02)     VALUE   SPACE.
     03  TEK-TANNM12              PIC  X(01)     VALUE   SPACE.
     03  TEK-TANABAN1             PIC  X(06).
     03  FILLER                   PIC  X(15)     VALUE   SPACE.
     03  BUMON                    PIC  999.
     03  FILLER                   PIC  X(07)     VALUE   SPACE.
     03  BAIKA                    PIC  ZZZZZZ9.
     03  FILLER                   PIC  X(03)     VALUE   SPACE.
     03  TEK-TANNM21              PIC  N(02)     VALUE   SPACE.
     03  TEK-TANNM22              PIC  X(01)     VALUE   SPACE.
     03  TEK-TANABAN2             PIC  X(06).
*
****************************************************************
 PROCEDURE              DIVISION.
****************************************************************
...
***  ６行目漢字・テキスト項目セット
     ...
     MOVE     NC"_番"            TO   TEK-TANNM11 TEK-TANNM21.
     MOVE     ":"                 TO   TEK-TEKNM2
                                       TEK-TANNM12 TEK-TANNM22.
***  発注日
...
*テスト印字項目セット
     MOVE   NC"Ｎ"               TO   HATYUK.
     MOVE   NC"ＮＮ"             TO   TEK-TEKNM1 TEK-TANNM11.
...
*
     ...
     MOVE     "FSY65041"          TO        DSP-FMT.
*項目設定
***  伝票枚数
     MOVE     WK-MAI              TO        MD01.
***  プログラムＩＤ
     MOVE     "SSY6504L"          TO        PGID.
***  日付
