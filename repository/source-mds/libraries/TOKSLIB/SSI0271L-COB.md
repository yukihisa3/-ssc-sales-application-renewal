...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSI0271L.COB`
...
*--------------------------------------------------------------*
 ...
 01  IDX.
     03  I              PIC  9(03).
 01  ID-PROGRAM.
     03  PG-ID          PIC  X(08)     VALUE  "SSI0271L".
*
*----<< ﾌｱｲﾙ ｽﾃｰﾀｽ >>--*
 01  SSI-ST             PIC  X(02).
 01  TOK-ST             PIC  X(02).
...
*--<< ﾌﾟﾘﾝﾄ AREA >>-*
 01  HEAD01.
     03  FILLER.
         ...
         05  FILLER     PIC  X(08)     VALUE "SSI0271L".
...
*
 ...
 01  MEIS04.
     03  FILLER         CHARACTER TYPE MODE-2.
         05  FILLER     PIC  X(14)     VALUE  SPACE.
         05  FILLER     PIC  N(04)     VALUE  NC"＊＊　消".
         05  FILLER     PIC  X(01)     VALUE  SPACE.
         05  FILLER     PIC  N(01)     VALUE  NC"費".
         05  FILLER     PIC  X(01)     VALUE  SPACE.
         05  FILLER     PIC  N(04)     VALUE  NC"税　＊＊".
         05  FILLER     PIC  X(12)     VALUE  SPACE.
         05  ME-17      PIC  ----,---,--9.
*
...
*伝票区分
     ...
     END-EVALUATE.
***  IF       SSI-F06  =  "04001"
***           DISPLAY "SSI-F15 = "  SSI-F15 " : "  WK-TENKEI
***           UPON CONS.
*店舗コード
...
*****ADD      SSI-F15        TO   WK-TENKEI.
     ...
     END-EVALUATE.
*納品日
     MOVE     SSI-F05        TO   ME-141.

*金額合計
**   IF       SSI-F11  =  0  OR  3  OR  5  OR  6
*             ADD     SSI-F15    TO    WK-SOKEI
**   END-IF.
*
...
*
     ...
     COMPUTE  WK-TAX  =  WK-SOKEI  *  0.05.
     MOVE     WK-TAX         TO   ME-17.
