...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY4004B.COB`
...
*\\\ 93.06.04 END   \\\
     03  WK-SERI1            PIC  9(04)  VALUE  ZERO.
     03  WK-SERI2            PIC  9(03)  VALUE  ZERO.
...
*\\\ 93.06.04 END   \\\
*******MOVE     DEN2-F57       TO   WK-SERI1
*******MOVE     DEN2-F58       TO   WK-SERI2
*取引先マスタＲＥＡＤ
       PERFORM  TOK-RD-SEC
       IF   INV-SW  =  1
              GO        TO        INIT-010
