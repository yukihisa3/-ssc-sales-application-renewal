...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SZA0150B.COB`
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SZA0150B".
...
************************************************************
 INIT-SEC               SECTION.
     ...
     READ     HJYOKEN
         INVALID
              DISPLAY  "(SZA0150B) ｴﾗｰﾒｯｾｰｼﾞ "     UPON CONS
...
************************************************************
 END-SEC                SECTION.
     CLOSE    SGYFILF   HJYOKEN.
     DISPLAY "* SGYFILF (INPUT) = " SGYO-CNT   " *" UPON CONS.
     DISPLAY "* SGYFILF (SKIP)  = " SKIP-CNT   " *" UPON CONS.
*****DISPLAY "* SGYFILF (SELECT)= " SELECT-CNT " *" UPON CONS.
     DISPLAY "* SGYFILF (DELETE)= " DELETE-CNT " *" UPON CONS.
 END-END.
     EXIT.
*****************<<  PROGRAM  END  >>***********************
