...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SZA0051B.COB`
...
*
 ZAIKO001.
     ...
     END-IF.
*レコード更新
     MOVE  SPACE         TO     EZA-REC.
     INITIALIZE                 EZA-REC.
*
     MOVE  ZAI-REC       TO     EZA-REC.
*
     WRITE EZA-REC.
     ADD   1             TO     OUT-CNT.
*
