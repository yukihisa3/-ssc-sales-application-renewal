...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSI0230L.COB`
...
*--------------------------------------------------------------*
 ...
 01  IDX.
     03  I              PIC  9(03).
 01  ID-PROGRAM.
     03  PG-ID          PIC  X(08)     VALUE  "SSI0230L".
*
*----<< ﾌｱｲﾙ ｽﾃｰﾀｽ >>--*
 01  SSI-ST             PIC  X(02).
 01  TOK-ST             PIC  X(02).
...
*
     ...
     END-IF.
*
     MOVE     SSI-F06        TO   ME-14.
     WRITE    PRT-REC        FROM MEIS02    AFTER     2.
     MOVE     SPACE          TO   PRT-REC.
     WRITE    PRT-REC                       AFTER     1.
     ADD      3              TO   LINE-CNT.
     GO       TO   220-MEIS02-PRINT-EXIT.
*
 220-MEIS02-010.
*
     MOVE     SSI-F06        TO   ME-15.
