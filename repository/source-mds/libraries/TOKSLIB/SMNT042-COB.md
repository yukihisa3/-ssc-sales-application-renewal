...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SMNT042.COB`
...
****  メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SMNT042".
...
************************************************************
 END-SEC                SECTION.
*
     CLOSE    DSPF HJYOKEN HSHOTBL  ZSOKMS HTOKMS HMEIMS.
*
 END-END.
     EXIT.
************************************************************
