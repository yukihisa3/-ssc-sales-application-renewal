...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY1601L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*島忠伝票データ（共通）　　
     SELECT   SMSHIRED  ASSIGN    TO        SMSHIRED
...
*## 1999/12/27 NAV T.T START ﾀｲﾌﾟ ZZ --> 99 ﾍ ﾍﾝｺｳ ##*
*****03  DT2-062                  PIC  ZZ.
     03  DT2-062                  PIC  99.
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      SMSHIRED.
...
*明細２行目
***  商品名（下段）
     MOVE     DEN-A17(16:15)      TO        DT2-01.
***  商品コード
     MOVE     DEN-A15             TO        DT2-02.
***  単位
     MOVE     DEN-A16             TO        DT2-03.
***  数量
...
***  Ｄ欄
     IF       DEN-A06   =             "20"
              MOVE     "*** "          TO   HD1-02
              MOVE     DEN-A10(1:2)    TO   HD1-03(1:2)
              MOVE     "."             TO   HD1-03(3:1)
              MOVE     DEN-A10(3:2)    TO   HD1-03(4:2)
              MOVE     "ﾁﾗｼ"           TO   HD1-04
              MOVE     "***"           TO   HD1-05
     END-IF.
*
*ヘッダ２行目　
***  社名
     MOVE     "ｼﾏﾁｭｳ"             TO    HD2-01.
***  仕入先コード１
     MOVE     DEN-A071            TO    HD2-02.
***  担当営業所
     MOVE     "("                 TO    HD2-03.
     MOVE     DEN-A11             TO    HD2-04.
     MOVE     ")"                 TO    HD2-05.
*
*ヘッダ　３　行目　
***  店名
...
*
     CLOSE    SMSHIRED   PRTFILE    DSPFILE.
*
 END-EXIT.
     EXIT.
