...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SCV0071B.COB`
...
*受信処理起動
*    受信パスワード編集
     EVALUATE  LINK-JYUKBN
         WHEN   1   MOVE   "01"  TO         PASS-YOKYU
         WHEN   2   MOVE   "02"  TO         PASS-YOKYU
         WHEN   OTHER
                MOVE   "END" TO         END-FLG
                DISPLAY "***ｶｲｾﾝｼﾖｳﾁｭｳ2        ]]]***" UPON CONS
                DISPLAY "***ｻｲﾄﾞ ｼﾞｯｺｳｼﾃ ｸﾀﾞｻｲ ]]]***" UPON CONS
                GO           TO         MAIN-EXIT
     END-EVALUATE.
...
*ファイルのＯＰＥＮ
     CLOSE     JHMKAIF  JHMEOSF.
*実行管理ファイルクリア
     CALL      "PCV00310".
*ＰＧスタートメッセージ
     ACCEPT    WK-TIME  FROM     TIME.
     DISPLAY "***ｼｭﾄﾞｳｼﾞｭｼﾝ END -> " WK-YYYY "/" WK-MM "/" WK-DD
         " " WK-TIME-1(1:2) ":" WK-TIME-1(3:2) "***" UPON CONS.
*
 END-EXIT.
     EXIT.
...
*ＥＯＳ管理マスタ読込み
     MOVE      LINK-DTKBN          TO   EOS-F01.
     MOVE      "1"                 TO   EOS-F02.
     MOVE      LINK-TOKCD          TO   EOS-F03.
