...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSI0290B.COB`
...
*--------------------------------------------------------------*
*----<< ﾌﾟﾛｸﾞﾗﾑID >>--*
 01  PG-ID              PIC  X(08)     VALUE  "SSI0290B".
*----<< ﾌﾗｸﾞｴﾘｱ >>--*
...
*----<< ｶｳﾝﾄｴﾘｱ >>--*
 ...
 01  ERR-CNT            PIC  9(05)     VALUE  ZERO.
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
...
*----<< 支払合計ファイル >>--*
 SYO-ERR                SECTION.
     ...
     DISPLAY  "### " PG-ID " SITGKFFF  ERROR " SSI-ST " "
