...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY3201L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*カインズ伝票データ（共通）
     SELECT   KZSHIRED  ASSIGN    TO        KZSHIRED
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      KZSHIRED.
...
*
     CLOSE    KZSHIRED   PRTFILE    DSPFILE.
*
 END-EXIT.
     EXIT.
