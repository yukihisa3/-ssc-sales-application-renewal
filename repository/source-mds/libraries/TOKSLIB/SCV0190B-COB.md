...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SCV0190B.COB`
...
*    サブシステム　　　　：　受配信                            *
*    モジュール名　　　　：　伝票更新結果リスト                *
*    作成日／作成者　　　：　2000/03/24 T.TAKAHASHI            *
*    更新日／更新者　　　：　　　　　　                        *
*    処理概要　　　　　　：　　　　　　　　　　　　　　　　　　*
*                                                              *
****************************************************************
...
***  受信結果／エラー内容
     EVALUATE LINK-KEKKACD
         ...
         MOVE  NC"伝票更新処理が正常終了しました。"
                             TO        PRT-ERRNM1
         MOVE  NC"発注集計表等の出力を開始して下さい。"
                             TO        PRT-ERRNM2
         WHEN 2
         MOVE  NC"異常終了"  TO        PRT-JKEKKA
         MOVE  NC"伝票更新処理が異常終了しました。"
                             TO        PRT-ERRNM1
         MOVE  NC"ログを採取し、ナブへ連絡して下さい。"
                             TO        PRT-ERRNM2
         WHEN OTHER
