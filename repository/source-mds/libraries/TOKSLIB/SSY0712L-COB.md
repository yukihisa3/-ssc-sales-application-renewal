...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY0712L.COB`
...
*    退避エリア
 01  SAV-AREA.
     ...
     03  WK-MEMO-1                PIC S9(09)  PACKED-DECIMAL.
     03  WK-MEMO-2                PIC S9(09)  PACKED-DECIMAL.
...
*    メッセージ　エリア
 01  MSG-AREA.
     03  MSG-ABEND1.
         ...
         05  ERR-PG-ID            PIC  X(08)  VALUE  "SSY0712L".
...
*    配送伝票データ初期ＲＥＡＤ
     ...
     MOVE     IN-F141    TO       WK-SYOCD1.
     MOVE     IN-F25     TO       WK-SYOCD2.
     MOVE     IN-F98     TO       WK-RUTO.
     MOVE     IN-F08     TO       WK-SYUKA.
     MOVE     IN-F19     TO       WK-MEMO-1.
     MOVE     IN-F20     TO       WK-MEMO-2.
     MOVE     1          TO       TATE.
...
*    ブレイクチェック（納品日，ルート）
     ...
     END-IF.
*    商品コードブレイク時
     IF       WK-SYOCD1   NOT =  IN-F141
     OR       WK-SYOCD2   NOT =  IN-F25
*****OR       WK-MEMO-1   NOT =  IN-F19
*****OR       WK-MEMO-2   NOT =  IN-F20
              MOVE  IN-F141      TO  WK-SYOCD1
              MOVE  IN-F25       TO  WK-SYOCD2
              MOVE  IN-F19       TO  WK-MEMO-1
              MOVE  IN-F20       TO  WK-MEMO-2
...
*          店舗名略名取得
           ...
           READ    HTENMS
              INVALID
                   DISPLAY  "(SSY0712L) HTENMS INV KEY="
