...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SNY0050I.COB`
...
*入庫ファイル
     SELECT   NYKFILF        ASSIGN        TO   01-VI-NYKFILL2
...
*発注Ｆ（ヘッダ）
     SELECT   HACHEDF        ASSIGN        TO  01-VI-HACHEDL1
                             ORGANIZATION  IS  INDEXED
...
*メッセージ情報
 01  MSG-AREA.
     03  MSG-ABEND1.
         05  FILLER          PIC  X(12)  VALUE  "### SNY0050I".
...
*=============================================================
 CONTROL-SEC         SECTION.
     DISPLAY  "**  SNY0050I   START  **"   UPON  CONS.
*
     PERFORM  INIT-SEC.
     PERFORM  MAIN-SEC    UNTIL  MAIN-FLG  =  99.
     PERFORM  END-SEC.
*
     DISPLAY  "**  SNY0050I    END   **"   UPON  CONS.
     STOP  RUN.
 CONTROL-EXIT.
     EXIT.
*=============================================================
...
*
     ...
     DISPLAY "* NYJISEKF(OT)=" OT-CNT   " *" UPON CONS.
*
...
*初期画面の処理
     ...
     MOVE "FNY00501"    TO  DSP-FMT.
     MOVE  SPACE        TO  DSP-FNY00501.
     PERFORM  OPT-CLR-SEC.
*倉庫
