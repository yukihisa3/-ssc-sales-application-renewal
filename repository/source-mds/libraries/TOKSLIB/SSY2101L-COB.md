...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY2101L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*片倉工業伝票データ（共通）　　
     SELECT   DENKATSF  ASSIGN    TO        DENKATSF
...
*
 01  HD3.
     03  FILLER                   PIC  X(08)     VALUE   SPACE.
     03  HD3-01                   PIC  X(02)     VALUE   SPACE.
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      DENKATSF.
...
*明細１行目
***  商品名１
     MOVE      DEN-A151           TO        DT1-01
***  商品名２　
     MOVE      DEN-A152           TO        DT1-02
***  部門
     MOVE      DEN-A13            TO        DT1-03
***  商品コード
     MOVE      DEN-A14            TO        DT1-04
***  訂正伝票時処理
...
*明細２行目
***  取引先品番
     MOVE     DEN-A16             TO        DT2-01.
***  ＪＡＮコード
     MOVE     DEN-A17             TO        DT2-02.
***  入数
     MOVE     DEN-A18             TO        DT2-03.
***  ケース
     MOVE     DEN-A19             TO        DT2-04.
***  数量
...
*ヘッダ１行目
***  納入場所
     MOVE     DEN-A10             TO        HD1-01.
*ヘッダ２行目
***  発注者名
     MOVE     DEN-A06             TO        HD2-01.
***  取引先名上段
...
*
     MOVE     "C1"                TO        HD3-01.
***  店舗名
     MOVE     DEN-A27             TO        HD3-02.
***  店コード
     MOVE     DEN-A25(3:3)        TO        HD3-03.
***  部門
     MOVE     DEN-A04             TO        HD3-04.
***  伝票区分
     MOVE     DEN-A05             TO        HD3-05.
***  伝票番号
     MOVE     DEN-A02             TO        HD3-06.
***  取引先コード
     MOVE     DEN-A01             TO        HD3-07.
***  取引先名称下段
     MOVE     DEN-A072            TO        HD3-08.
***  発注日
     MOVE     DEN-A08             TO        HD3-09.
***  納品日
     MOVE     DEN-A09             TO        HD3-10.
*
***  Ｌ欄（催事名）退避
     MOVE     DEN-A11             TO        WK-TL2-01.
...
*項目クリア
     MOVE     SPACE               TO   HD1 HD2 HD3
                                       ...
                                       TL1 TL2.
*テスト印字項目セット
     MOVE   ALL "9"               TO   HD3-09  HD3-10
                                       DT2-051 DT2-071 DT2-08
                                       DT2-09  DT2-10  TL1-011
                                       TL1-012 TL1-03  TL1-04
                                       DT2-052 DT2-072.
     MOVE   ALL "*"               TO   HD1-01  HD2-01  HD2-02
                                       HD3-02  HD3-03  HD3-04
                                       HD3-05  HD3-06  HD3-07
                                       HD3-08  DT1-01  DT1-02
                                       DT1-03  DT1-04  DT2-01
...
*
     CLOSE    DENKATSF   PRTFILE    DSPFILE.
*
 END-EXIT.
     EXIT.
