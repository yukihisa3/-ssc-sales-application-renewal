...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SHA0250I.COB`
...
*
*---<<  発注ヘッダファイル  >>---*
     SELECT   AUTHACF   ASSIGN    TO        DA-01-VI-AUTHEDL1
                        ORGANIZATION        IS   INDEXED
...
****  メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SHA0250I".
