...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SMNT040.COB`
...
*   93.04.13  SYUUSEI  START  H.SUTO
         ...
         MOVE   "M"        TO        EDIT-OPTION   OF    ZAIK(IXA)
         MOVE   "M"        TO        EDIT-OPTION   OF    AKEI(IXA)
*   93.04.13  SYUUSEI  END    H.SUTO
*\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
     END-PERFORM.
     MOVE       "BODY"     TO        DSP-GRP.
