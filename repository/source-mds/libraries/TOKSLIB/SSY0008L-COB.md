...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY0008L.COB`
...
***  2012/08/15 END
*# 2020/07/17 NAV ST ストックＮＯ管理区分追加
***** ストックＮＯ管理区分ワーク
 01  WK-STNO-KBN                  PIC       X(01)  VALUE  SPACE.
*# 2020/07/17 NAV ED ストックＮＯ管理区分追加
***  2018/01/31 START
***** 欠品フラグワーク
 01  WK-KEPIN-FLG                 PIC       X(01)  VALUE  SPACE.
***  2018/01/31 END
***** 合計計算ワーク
...
***** メッセージエリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY0008L".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY0008L".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND1.
...
***** 見出し行１
 01  MIDASHI1.
     ...
     03  FILLER                   PIC  X(08)  VALUE "SSY0008L".
...
*****03  MEI2-KOURI-KBN           PIC       N(06)
     03  FILLER                   PIC       X(01)  VALUE  SPACE.
     03  MEI2-STNO-KBN            PIC       N(03)
                   CHARACTER      TYPE      IS     YA.
     03  MEI2-KOURI-KBN           PIC       N(04)
*# 2020/07/17 NAV ED ストックＮＯ管理区分追加
                   CHARACTER      TYPE      IS     YA.
     03  FILLER                   PIC       X(01)  VALUE  SPACE.
***  2012/08/16 END   **
...
*** 2012/08/15 START
     MOVE     HAC-F22   TO        WK-KOURI-KBN.
*** 2012/08/15 END
*# 2020/07/17 NAV ST ストック ＮＯ管理区分
     MOVE     HAC-F10(1:1) TO     WK-STNO-KBN.
*# 2020/07/17 NAV ED ストック ＮＯ管理区分
*
...
*
     ...
     WRITE    P-REC     FROM      MIDASHI5  AFTER     2.
...
*# 2020/04/30 NAV ST Ｄ３６５連携対応
     EVALUATE  WK-KOURI-KBN
*# 2020/07/17 NAV ST ストックＮＯ管理区分追加
*********WHEN  "1" MOVE  NC"☆小売出荷☆"   TO   MEI2-KOURI-KBN
*        WHEN  "2" MOVE  NC"☆直送出荷☆"   TO   MEI2-KOURI-KBN
*********WHEN  "3" MOVE  NC"セット組出荷"   TO   MEI2-KOURI-KBN
         WHEN  "1" MOVE  NC"☆小売出"       TO   MEI2-KOURI-KBN
         WHEN  "2" MOVE  NC"☆直送出"       TO   MEI2-KOURI-KBN
         WHEN  "3" MOVE  NC"☆セット"       TO   MEI2-KOURI-KBN
*# 2020/07/17 NAV ED ストックＮＯ管理区分追加
         WHEN  OTHER     MOVE   SPACE       TO   MEI2-KOURI-KBN
     END-EVALUATE.
*# 2020/04/30 NAV ED Ｄ３６５連携対応
*# 2020/07/17 NAV ST ストックＮＯ管理区分追加
     EVALUATE  WK-STNO-KBN
         WHEN  "1"       MOVE  NC"★スト"   TO   MEI2-STNO-KBN
         WHEN  OTHER     MOVE   SPACE       TO   MEI2-STNO-KBN
     END-EVALUATE.
*# 2020/07/17 NAV ED ストックＮＯ管理区分追加
*** 2012/08/16 END
*** 2018/01/31 START
     IF        T-FLG   =     1
               MOVE  NC"★"   TO   MEI2-KEPIN-FLG
     ELSE
               MOVE  SPACE    TO   MEI2-KEPIN-FLG
     END-IF.
*** 2018/01/31 END
