...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKE9992B.COB`
...
*                            倉庫コードより該当のデータを      *
*                            抽出する。                        *
*　　2004/10/26　　納品日判定を指定日と同じ日のチェックを　　*
*　　　　　　　　　実施に変更　　                              *
****************************************************************
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SKE9992B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SKE9992B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
****************************************************************
 INIT-SEC               SECTION.
     ...
     OPEN     INPUT     SHTDENLA  SHOTBL1   RUISYUF.
...
*    MOVE     WK-HEN1        TO   SDE-F11.
     COMPUTE  WK-SDE-F11  =  DEN-F15  *  100.
     MOVE     WK-SDE-F11     TO   SDE-F11.
*原価単価
     INITIALIZE                   WK-HEN1.
     IF       DEN-F172  <  ZERO
              MOVE   "-"     TO   WK-HEN1-1
...
*    MOVE     WK-HEN1        TO   SDE-F21.
     COMPUTE  WK-SDE-F21  =  DEN-F50  *  100.
     MOVE     WK-SDE-F21     TO   SDE-F21.
*取引先固有エリア
...
*    件数リスト発行
     IF  PARA-CHK  = 1
         MOVE  NC"指定バック番号未検品ＤＴ　＝　" TO MIDASHI2-01
     ELSE
         MOVE  NC"未検品ＤＴ作成件数　＝　　　　" TO MIDASHI2-01
     END-IF.
*
     PERFORM LISTWT-SEC.
*件数Ｆ出力
