...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/STE4301B.COB`
...
*    ｺﾞｳｹｲ
 ...
 01  TAIL-02.
     ...
     03  TL2-1                    PIC  X(15)     VALUE   SPACE.
 01  TAIL-03.
     03  FILLER                   PIC  X(37)     VALUE   SPACE.
     03  TL3-1                    PIC  X(15)     VALUE   SPACE.
******************************************************************
*             M A I N             M O D U L E                    *
******************************************************************
 PROCEDURE              DIVISION.
