...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY3102L.COB`
...
*ヘッダ１行目
***  伝票名称（Ｅ欄上）
     MOVE     DEN-A32             TO    HD1-01.
*ヘッダ２行目
***  納品開始／終了日（Ｅ欄下）
     MOVE     DEN-A29             TO    HD2-01.
     MOVE     "-"                 TO    HD2-02.
     MOVE     DEN-A30             TO    HD2-03.
*ヘッダ３行目
***  社名
     MOVE     DEN-A07             TO    HD3-01.
*ヘッダ４行目
***  店名
     MOVE     DEN-A08             TO    HD4-01.
***  社／店コード
     MOVE     DEN-A23             TO    HD4-02.
***  分類コード
     MOVE     DEN-A05             TO    HD4-03.
***  伝票区分
     MOVE     DEN-A04             TO    HD4-04.
***  伝票_
     MOVE     DEN-A25             TO    HD4-05.
     MOVE     DEN-A02             TO    HD4-06.
***  取引先コード
     MOVE     DEN-A01             TO    HD4-07.
***  取引先名称
     MOVE     DEN-A09             TO    HD4-08.
***  発注日
     MOVE     DEN-A10(1:2)        TO    HD4-091.
     MOVE     DEN-A10(3:2)        TO    HD4-092.
     MOVE     DEN-A10(5:2)        TO    HD4-093.
***  納品日
     MOVE     DEN-A11(1:2)        TO    HD4-101.
     MOVE     DEN-A11(3:2)        TO    HD4-102.
     MOVE     DEN-A11(5:2)        TO    HD4-103.
*
...
*項目クリア
     MOVE     SPACE               TO   HD1 HD2 HD3 HD4
                                       DT1 DT2
                                       TL1 TL2.
     MOVE   ALL "9"               TO   HD2-01   HD2-03   HD4-02
                                       HD4-03   HD4-04   HD4-06
                                       HD4-07   HD4-091  HD4-092
                                       HD4-093  HD4-101  HD4-102
                                       HD4-103
                                       DT2-031  DT2-032  DT2-051
                                       DT2-06   DT2-07   DT2-08
                                       TL1-01   TL1-02.
     MOVE   ALL "*"               TO   HD1-01   HD2-02   HD3-01
                                       HD4-05   HD4-08
                                       DT1-01   DT2-01   DT2-052.
*
**** ヘッド印字
     WRITE    PRT-REC          FROM   HD1        AFTER    2.
     WRITE    PRT-REC          FROM   HD2        AFTER    1.
...
*
     CLOSE    KMSHIRED   PRTFILE    DSPFILE.
*
 END-EXIT.
     EXIT.
