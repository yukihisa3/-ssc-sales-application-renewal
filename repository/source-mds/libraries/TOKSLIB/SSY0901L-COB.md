...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY0901L.COB`
...
*$$2014/02/05 NAV ST
 01  WK-DEN-F46         PIC  9(08)   VALUE  ZERO.
 01  WK-DEN-F47         PIC  9(04)   VALUE  ZERO.
 01  WK-DEN-F01         PIC  9(08)   VALUE  ZERO.
*$$2014/02/05 NAV ED
*開始，終了倉庫コード
...
*--<< ﾌﾟﾘﾝﾄ AREA >>-*
 01  HEAD01.
     03  FILLER         CHARACTER TYPE BAIKAKU-1-5.
         ...
         05  FILLER     PIC  X(08)     VALUE  "SSY0901L".
...
*********05  HD-031     PIC  99.
         ...
         05  HD-042     PIC  9999.
         05  FILLER     PIC  X(01)     VALUE  "-".
         05  HD-043     PIC  999999999.
         05  FILLER     PIC  X(10)     VALUE  SPACE.
         05  FILLER     PIC  N(08) VALUE  NC"出力納品日範囲：".
         05  HD-044     PIC  99999999.
         05  FILLER     PIC  N(01)     VALUE  NC"～".
         05  HD-045     PIC  99999999.
 01  HEAD03.
     03  FILLER         CHARACTER TYPE YA.
         05  FILLER     PIC  X(01)     VALUE  SPACE.
...
*
 ...
 01  MEIS03.
     03  FILLER         CHARACTER TYPE YA.
         ...
         05  ME-35      PIC  ----,---,--9.
*## 2020/06/08 NAV ST D365伝票番号行出力
 01  MEIS04.
     03  FILLER         CHARACTER TYPE YA.
         05  FILLER     PIC  X(90)     VALUE  SPACE.
         05  FILLER     PIC  X(06)     VALUE  "( D365".
         05  FILLER     PIC  N(02)     VALUE  NC"伝票".
         05  FILLER     PIC  X(05)     VALUE  "NO : ".
         05  ME-D365    PIC  X(20).
         05  FILLER     PIC  X(02)     VALUE  " )".
         05  FILLER     PIC  X(02)     VALUE  SPACE.
*## 2020/06/08 NAV ED D365伝票番号行出力
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SSY0901L DSPFILE ERROR " DSP-CNTL " "
...
*----<< 伝票データ >>--*
 SHTDENF-ERR            SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY0901L SHTDENF ERROR " SHTDENF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY0901L HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 店舗マスタ >>--*
 HTENMS-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY0901L HTENMS ERROR " HTENMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 倉庫マスタ >>--*
 HTENMS-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY0901L ZSOKMS ERROR " ZSOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*$$2014/02/05 NAV ST
     MOVE     DEN-F46             TO   WK-DEN-F46.
     MOVE     DEN-F47             TO   WK-DEN-F47.
...
*
     ...
     ELSE
              MOVE      SPACE     TO   ME-20
     END-IF.
*## 2020/06/08 NAV ST Ｄ３６５伝票番号出力
     MOVE     DEN-D99        TO   ME-D365.
*## 2020/06/08 NAV ED Ｄ３６５伝票番号出力
*
...
*****MOVE     DEN-F48             TO   HD-031  SOK-F01.
     MOVE     WK-SOKOCD           TO   HD-031  SOK-F01.
*****DISPLAY "DEN-F48   = " DEN-F48      UPON CONS.
*****DISPLAY "WK-SOKOCD = " WK-SOKOCD    UPON CONS.
*$$2014/02/05 NAV ED
     READ     ZSOKMS
       INVALID
...
*****MOVE     DEN-F01             TO   HD-043.
     MOVE     WK-DEN-F46          TO   HD-041.
     MOVE     WK-DEN-F47          TO   HD-042.
     MOVE     WK-DEN-F01          TO   HD-043.
*$$2014/02/05 NAV ED
