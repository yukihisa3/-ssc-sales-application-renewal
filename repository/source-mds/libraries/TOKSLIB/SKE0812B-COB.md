...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKE0812B.COB`
...
**************************************************************
 PROCEDURE             DIVISION USING PARA-PDATE PARA-PTIME.
**************************************************************
 DECLARATIVES.
 KEN-ERR                   SECTION.
...
*日付・時間で検品送信管理Ｆ存在チェック
     MOVE      SYS-DATEW     TO   KEN-F01.
     MOVE      SYS-TIMEW     TO   KEN-F02.
     READ      KENSNDF
...
*更新チェック
     IF        KENSNDF-INV-FLG = "INV"
               ...
               INITIALIZE               KEN-REC
               MOVE   SYS-DATEW    TO   KEN-F01 PARA-PDATE
               MOVE   SYS-TIMEW    TO   KEN-F02 PARA-PTIME
               WRITE  KEN-REC
     ELSE
