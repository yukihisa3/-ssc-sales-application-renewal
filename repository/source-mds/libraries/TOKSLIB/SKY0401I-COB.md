...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKY0401I.COB`
...
*    処理概要　　　　　　：　画面より，バッチ_を入力し，伝票 *
*                            伝票更新のキーを投入する。        *
****************************************************************
 IDENTIFICATION        DIVISION.
 PROGRAM-ID.           SKY0401I.
 AUTHOR.               NAV.
 DATE-WRITTEN.         2000/01/14.
****************************************************************
...
*
     ...
     MOVE      "NW"               TO    VLD-F03.
     MOVE      52                 TO    VLD-F10.
     MOVE      DSP-BTDATE         TO    VLD-F11.
     MOVE      DSP-BTTIME         TO    VLD-F12.
     MOVE      DSP-BTTORI         TO    VLD-F13.
