...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSE7105I.COB`
...
*---<<  請求合計ファイル  >>---*
     SELECT   JDJSEKF   ASSIGN    TO        DA-01-VI-JDJSEKL1
...
****  メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SSE7105I".
...
*
     ...
     OPEN    I-O             JDJSEKF.
     OPEN    INPUT           HTENMS.
     MOVE    "FSE71051"      TO   DSP-FORMAT.
     MOVE    SPACE           TO   DSP-FSE71051.
