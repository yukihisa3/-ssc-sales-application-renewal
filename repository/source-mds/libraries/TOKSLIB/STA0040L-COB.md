...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/STA0040L.COB`
...
****  見出し行１             ****
 01  MIDASI-1.
     ...
     02  FILLER              PIC  X(08)  VALUE  "STA0040L".
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "STA0040L".
...
*****
     ...
     IF   END-FLG    NOT =   "END"
         MOVE   SPACE         TO     TANA-REC
         MOVE   SOKCD         TO     TANA-F04
         START  ZTANADT  KEY IS  >=  TANA-F04  TANA-F05
                                     TANA-F06  TANA-F07
                                     TANA-F08  TANA-F15
           INVALID KEY
             MOVE  "END"      TO     END-FLG
