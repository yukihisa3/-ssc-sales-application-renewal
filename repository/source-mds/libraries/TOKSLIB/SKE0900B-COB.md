...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKE0900B.COB`
...
*----<< 出荷情報データ >>--*
 RUI-ERR              SECTION.
     ...
     DISPLAY  "### SKE0900B RUISYUF    ERROR " RUI-ST " "
...
*----<< 条件ファイル >>--*
 JYO-ERR              SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     "4000"         TO   PROGRAM-STATUS.
     DISPLAY  "### SKE0900B HJYOKEN    ERROR " JYO-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
...
*　　出荷情報データスタート　　　　　　　　　　　　　　　　　　*
****************************************************************
 RUISYUF-START-SEC      SECTION.
*スタートキーセット
     MOVE     PARA-TOKCD     TO   RUI-F04.
     MOVE     ZERO           TO   RUI-F06 RUI-F07.
     START    RUISYUF   KEY  IS  >=  RUI-F04 RUI-F06 RUI-F07
              INVALID
              MOVE    "END"  TO   END-FLG
     END-START.
*
...
*    読込み件数表示
     ...
     END-IF.
*    取引先チェック
     IF       RUI-F04  >  PARA-TOKCD
              MOVE  "END"    TO   END-FLG
              GO             TO   RUISYUF-READ-EXIT
     END-IF.
*    取引先が０１７３の時
     IF       PARA-TOKCD  =  173
              IF   RUI-F05  <   WK-ZAIKO-DATE
                   CONTINUE
              ELSE
