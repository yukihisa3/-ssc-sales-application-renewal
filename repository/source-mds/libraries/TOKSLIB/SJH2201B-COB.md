...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SJH2201B.COB`
...
*    ヘッドレコード退避ワーク
 01  WK-DH-REC.
     ...
     03  WK-DH06                  PIC       9(08).
     03  WK-DH07.
         05  WK-DH071             PIC       9(06).
         05  WK-DH072             PIC       9(02).
     03  WK-DH08                  PIC       9(08).
     03  WK-DH09                  PIC       9(01).
     03  WK-DH10                  PIC       9(01).
     03  WK-DH11                  PIC       X(12).
     03  WK-DH12.
         05  WK-DH121             PIC       X(20).
         05  WK-DH122             PIC       X(20).
     03  WK-DH13                  PIC       9(01).
     03  WK-DH14                  PIC       X(06).
     03  WK-DH15                  PIC       9(08).
     03  WK-DH16                  PIC       9(08).
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJH2201B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJH2201B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*各量販店領域転送
*    取引先コード
     MOVE     WK-DH071      TO        HEN-A01.
*    伝票_
     MOVE     WK-DH06       TO        HEN-A02.
*    行_
     ADD      1             TO        CNT-GYO.
     MOVE     CNT-GYO       TO        HEN-A03.
*    ヘッド部門
     MOVE     WK-DH03       TO        HEN-A04.
*    伝票区分（発注区分）
     MOVE     WK-DH13       TO        HEN-A05.
*    発注者名（発信企業名）
     MOVE     WK-FL09       TO        HEN-A06.
*    取引先名称（上段）
     MOVE     WK-DH121      TO        HEN-A071.
*    取引先名称（下段）
     MOVE     WK-DH122      TO        HEN-A072.
*    発注日
     MOVE     WK-DH04       TO        HEN-A08.
*    納品日
     MOVE     WK-DH05       TO        HEN-A09.
*    ルート名（上段）
     MOVE     WK-FL101      TO        HEN-A111.
*    ルート名（下段）
     MOVE     WK-FL102      TO        HEN-A112.
*    仕入申請書_
     MOVE     WK-DH08       TO        HEN-A12.
*    伝票Ｌ欄
*****MOVE     XXXXXXX       TO        HEN-A13.
*    ルートコード
     MOVE     WK-DH072      TO        HEN-A14.
*    商品コード
...
*****MOVE                   TO        HEN-A27.
*    店舗名称
     MOVE     WK-DH11       TO        HEN-A28.
*    伝票Ａ欄
     MOVE     WK-DH09       TO        HEN-A29.
*    伝票Ｂ欄
     MOVE     WK-DH10       TO        HEN-A30.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
...
*****COMPUTE     HEN-F112  = WK-NEN * 10000 + HEN-A09.
     ...
     IF   HEN-A09  =  ZERO
          ...
          MOVE   01              TO   L1-HIZUKE
          CALL   "SKTADDDT"     USING LINK-SYSDATE
                                      LINK-HIZUKE
                                      LINK-HENKAN-DATE
                                      LINK-RET
          IF     LINK-RET  =  0
*****************MOVE  LINK-HENKAN-DATE  TO  WK-SEIREKI-DATE
*****************COMPUTE HEN-F112 = WK-NEN * 10000
*****************                          + WK-SEIREKI-DATE
                 MOVE "3"         TO       LINK-IN-KBN
