...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SZA0230L.COB`
...
****  見出し行１             ****
 01  MIDASI-1.
     ...
     02  FILLER              PIC  X(08)  VALUE  "SZA0230L".
...
****  明細行２               ****
 01  MEISAI-2       CHARACTER     TYPE   IS   YB.
     ...
     02  PRT-SHONM1          PIC  N(12).
*****02  PRT-SHONM2          PIC  N(05).
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SZA0230L".
...
*      0.0       全体処理                                  *
************************************************************
 SZA0230L-START         SECTION.
     PERFORM       INIT-SEC.
     PERFORM       MAIN-SEC        UNTIL  END-FLG = "END".
     PERFORM       END-SEC.
     IF   PG-END   NOT =  "END"
          MOVE     SPACE   TO   END-FLG
          GO  TO   SZA0230L-START
     END-IF.
     STOP     RUN.
 SZA0230L-END.
     EXIT.
...
*
     MOVE    "FZA02301" TO     DSP-FORMAT.
     MOVE     SPACE     TO     FZA02301.
     MOVE     SPACE     TO     MSG1.
     MOVE     PMSG01    TO     MSG2.
     MOVE     62        TO     L-CNT.
     MOVE     0         TO     P-CNT.
