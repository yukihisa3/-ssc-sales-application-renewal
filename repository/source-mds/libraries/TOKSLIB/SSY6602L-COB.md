...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY6602L.COB`
...
****  メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SSY6602L".
...
*    ﾐﾀﾞｼ
 01  HEAD-01.
     ...
     03  FILLER                   PIC  X(08)     VALUE "SSY6602L".
...
*    欠品数量
     ...
     COMPUTE  BD01-KEPIN  =  WK-DEPD05 - WK-DEPD06.
