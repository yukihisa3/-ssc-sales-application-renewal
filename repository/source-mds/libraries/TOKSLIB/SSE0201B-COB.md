...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSE0201B.COB`
...
*--------------------------------------------------------------*
 ...
 FILE-CONTROL.
*---<<  ＩＮ１ファイル  >>---*
     SELECT   SETGKFQ  ASSIGN    TO        DA-01-SETGKFQ
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   IN-ST.
*----<< 請求合計Ｆ >>--*
     SELECT   SETGKFA   ASSIGN    TO        DA-01-VI-SEIGKFA1
