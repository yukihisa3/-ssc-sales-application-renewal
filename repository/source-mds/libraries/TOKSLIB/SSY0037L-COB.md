...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY0037L.COB`
...
*メッセージ情報
 01  MSG-AREA.
     03  SEC-NAME.
         ...
         05  S-NAME          PIC  X(30).
     03  MSG-ABEND1.
         05  FILLER          PIC  X(12)  VALUE  "### SSY0037L".
...
*ﾁｮｳﾋｮｳﾃｲｷﾞｴﾘｱ
 01  HEAD01.
     ...
     03  FILLER     PIC  X(08)     VALUE  "SSY0037L".
 ...
 01  MEISAI03.
     03  FILLER     PIC  X(11)     VALUE  SPACE.
     03  FILLER     PIC  N(01)     CHARACTER TYPE PIT-15.
     03  FILLER     PIC  X(64)     VALUE  SPACE.
     03  MEI03-SEN1 PIC  X(03).
     03  MEI03-01   PIC  ZZZ,ZZ9.
     03  MEI03-SEN2 PIC  X(03).
 01  SEN01.
     03  FILLER         OCCURS    90.
...
*=============================================================
 CONTROL-SEC         SECTION.
     DISPLAY  "**  SSY0037L   START  **"   UPON  CONS.
*
     ...
     PERFORM  END-SEC.
*
     DISPLAY  "**  SSY0037L   END    **"   UPON  CONS.
     STOP  RUN.
 CONTROL-EXIT.
     EXIT.
*=============================================================
...
*    MOVE  SYU-F12             TO  MEI01-07 MEI02-07.
     MOVE  SYU-F18             TO  MEI01-07 MEI02-07.
*
...
*
*    売上単価（税込）
     MOVE  SPACE               TO  MEISAI03.
     MOVE  " ( "               TO  MEI03-SEN1.
     MOVE  " ) "               TO  MEI03-SEN2.
     MOVE  SYU-F18             TO  MEI03-01.
*
