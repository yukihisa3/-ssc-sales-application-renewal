...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY4803L.COB`
...
***** メッセージエリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY4803L".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY4803L".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND1.
...
***** 明細行１
 01  MD01.
     ...
     03  FILLER                   PIC       X(01)  VALUE  SPACE.
     03  MD01-HATYUSU             PIC       ---,--9.9.
     03  FILLER                   PIC       X(01)  VALUE  SPACE.
     03  MD01-KENSYSU             PIC       ---,--9.9.
     03  FILLER                   PIC       X(01)  VALUE  SPACE.
...
***** 合計１
 01  GK01                         CHARACTER  TYPE  IS  YA.
     03  FILLER                   PIC       X(113) VALUE  SPACE.
...
*             プロセス                      0.0                *
****************************************************************
 SSY4803L-START         SECTION.
*
     MOVE   "SSY4803L-START"      TO   S-NAME.
     PERFORM            INIT-SEC.
*
