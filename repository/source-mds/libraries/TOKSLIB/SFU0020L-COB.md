...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SFU0020L.COB`
...
*----<< 画面ファイル >>-*
 FD  DSPFILE.
     COPY     FFU00201   OF   XMDLIB.
*--------------------------------------------------------------*
 WORKING-STORAGE        SECTION.
*--------------------------------------------------------------*
 01  PGM-ID                  PIC  X(08)  VALUE  "SFU0020L".
*----<< ﾃﾞｨｽﾌﾟﾚｲ ｺﾝﾄﾛｰﾙ ｴﾘｱ >>-*
 01  DSP-CNTL.
...
****  見出し行０             ****
 01  MIDASI-0.
     ...
     03  FILLER              PIC  X(08)  VALUE  "SFU0020L".
...
*--------------------------------------------------------------*
 PROG-CNTL          SECTION.
     DISPLAY  "**  SFU0020L   START  **"   UPON  CONS.
*
     PERFORM  INIT-RTN.
     PERFORM  MAIN-RTN   UNTIL     END-FLG  =   "END".
     PERFORM  END-RTN.
*
     DISPLAY  "**  SFU0020L    END   **"   UPON  CONS.
     STOP RUN.
 PROG-CNTL-EXIT.
     EXIT.
*--------------------------------------------------------------*
