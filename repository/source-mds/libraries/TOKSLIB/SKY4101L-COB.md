...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKY4101L.COB`
...
*----<< ﾌｱｲﾙ ｽﾃｰﾀｽ >>--*
     ...
     03  PRT-ST         PIC  X(02).
*
 01  PG-ID             PIC  X(08)      VALUE  "SKY4101L".
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
...
*--------------------------------------------------------------*
 ...
 JYOERR                 SECTION.
     ...
     DISPLAY  "### SKY4101L JYOKEN ERROR " JYO-ST " "
