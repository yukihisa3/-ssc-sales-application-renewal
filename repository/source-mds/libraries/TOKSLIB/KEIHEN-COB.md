...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/KEIHEN.COB`
...
*----<< 画面ファイル >>-*
 FD  DSPFILE.
     COPY     FKEIHEN   OF   XMDLIB.
*--------------------------------------------------------------*
 WORKING-STORAGE        SECTION.
*--------------------------------------------------------------*
 01  PGM-ID                  PIC  X(08)     VALUE  "KEIHEN  ".
*----<< ﾃﾞｨｽﾌﾟﾚｲ ｺﾝﾄﾛｰﾙ ｴﾘｱ >>-*
 01  DSP-CNTL.
     03  DSP-FMT             PIC  X(08).
     03  DSP-GRP             PIC  X(08).
...
***   93/05/26    END   ***
*画面退避用
     COPY   FKEIHEN  OF XMDLIB  JOINING   SAV  AS   PREFIX.
*
***  93/05/08  START  ***
 01  SAVE-AREA.
...
**** COMPUTE  WK-NOUHIN-DT = HENKAN-TI * 10000 + R00016
     MOVE    "3"        TO        LINK-IN-KBN.
     ...
     END-IF.
**** COMPUTE  WK-NOUHIN-DT = HENKAN-TI * 10000 + R00021.
...
***  94.05.16  END   ***
     ...
     MOVE      SPACE     TO   FKEIHEN   TABLE-AREA.
     INITIALIZE               TBL-XX.
     MOVE      ZERO      TO   WK-TAIHI.
...
**** DISPLAY  "ACOS-DATE2= " ACOS-DATE2  UPON CONS.
...
************* DISPLAY "WK-DEN112YM  =  " WK-DEN112YM    UPON CONS
************* DISPLAY "ACOS-YYMM    =  " ACOS-YYMM      UPON CONS
              IF   DEN-F112  NOT  =  0
              AND  ACOS-DATE  <  WK-SYS-DATE
**************AND  DEN-F112   <  ACOS-DATE
              AND  WK-DEN112YM   <   ACOS-YYMM
...
*データ表示
     ...
     PERFORM   VARYING  I  FROM  1  BY  1
               UNTIL    I  >  30
               OR       END-FLG  =  1
***************DISPLAY "AA=I " I UPON CONS
          PERFORM   900-DEN-TO-TBL
          PERFORM   900-DEN-READ
***************DISPLAY "END  " END-FLG UPON CONS
     END-PERFORM.
     IF  GPAGE-FLG = 1
     AND ERR-FLG = ZERO
          MOVE      21        TO   ERR-FLG
...
**************DISPLAY    "DEN-F27C = " DEN-F27C UPON CONS
              WRITE     DEN-REC
            END-IF
       END-IF
     END-PERFORM.
*    PERFORM  VARYING  I  FROM  1  BY  1  UNTIL  I  >  TOK-F82
*      IF   TBL-R10101(I)  NOT  =  "9"
*      AND (TBL-R10301(I)  NOT  =  SPACE
*      OR   TBL-R10401(I)  NOT  =  SPACE
*      OR   TBL-R10501(I)  NOT  =  SPACE
*      OR   TBL-R11501(I)  NOT  =  SPACE )
*             INITIALIZE     DEN-REC
...
***   93/05/26  START   ***
*在庫更新したなら引落フラグに１
*****DISPLAY "ZAI-FLG " ZAI-FLG UPON CONS.
     IF       ZAI-FLG        =    1
              MOVE     1     TO   DEN-F27C
     END-IF.
***   93/05/26    END   ***
...
****          COMPUTE   DEN-F113  =  HENKAN-TI * 10000 +  R00016
**** END-IF.
**** 納品日 ***
     IF       R00016  =  ZERO
              MOVE      0         TO   DEN-F112
...
***  93.05.16 START  ***
**** DISPLAY  "WWWWWW DEN-F27 = " DEN-F27C UPON CONS.
**** DISPLAY  "WWWWWW R00001  = " R00001   UPON CONS.
**** IF     ( R00001             =    1           AND
****          R00021             >    SYS-DATE )  OR
****        ( R00001         NOT =    1           AND
****          DEN-F27C       NOT =    1 )         OR
...
*--------------------------------------------------------------*
 ZAI-WIN-RTN         SECTION.
* ワークの数量セット（入庫データ）
*****DISPLAY "1 " TBL-WSURYO(I)  UPON CONS.
...
* ワークの数量セット（出庫データ）
*****DISPLAY "2 " TBL-WSURYO(I)  UPON CONS.
     ...
     EVALUATE P-CNT
         WHEN 1
              PERFORM   VARYING  I  FROM  1  BY  1
                                    UNTIL  I  >  6
                   MOVE      TBL (I)        TO   BDY (I)
****               DISPLAY "TBL(A) = " TBL(I) UPON CONS
****               DISPLAY "TBL(1) = " TBL(13) UPON CONS
              END-PERFORM
         WHEN 2
              MOVE      1         TO   J
              PERFORM   VARYING  I  FROM  7  BY  1
                   ...
                   MOVE      TBL (I)        TO   BDY (J)
                   ADD       1              TO   J
****               DISPLAY "TBL(B) = " TBL(I) UPON CONS
****               DISPLAY "TBL(2) = " TBL(13) UPON CONS
              END-PERFORM
         WHEN 3
              MOVE      1         TO   J
              PERFORM   VARYING  I  FROM  13 BY  1
                   ...
                   MOVE      TBL (I)        TO   BDY (J)
                   ADD       1              TO   J
****               DISPLAY "TBL(3) = " TBL(13) UPON CONS
              END-PERFORM
         WHEN 4
              MOVE      1         TO   J
**************PERFORM   VARYING  I  FROM  19 BY  24
************************************UNTIL  I  >  TOK-F82
...
*\\
              ...
              END-IF
*\\
**************MOVE  SHT-F031 TO   TBL-WHINCD (DEN-F03)
     END-IF.
...
**** DISPLAY "DEN-F01 = " DEN-F01 " R00005 = " R00005 UPON CONS
**** DISPLAY "DEN-F23 = " DEN-F23 " R00007 = " R00007 UPON CONS
**** DISPLAY "DEN-F04 = " DEN-F04 " WK-R02 = " WK-R00002 UPON CONS
**** DISPLAY "DEN-F051= " DEN-F051 " R00008 = " R00008 UPON CONS
