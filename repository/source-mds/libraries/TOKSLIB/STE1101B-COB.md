...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/STE1101B.COB`
...
*プリンター
 FD  PRTF
     ...
     COPY        FTE11011    OF        XMDLIB.
*表示ファイル
 FD  DSPF
     LABEL       RECORD    IS        OMITTED.
     COPY        FTE11012     OF        XMDLIB.
******************************************************************
...
**                                      DEN-F051 DEN-F03
**              INVALID
**              DISPLAY  "ﾃﾞﾝﾋﾟｮｳ ﾃﾞｰﾀ  ﾅｼ!!"  UPON  STATION
**              ACCEPT   IN-DATA               FROM  STATION
**              STOP  RUN
**     END-START.
     START    HDENJNL   KEY  IS  >=   DEN-F01  DEN-F02  DEN-F04
