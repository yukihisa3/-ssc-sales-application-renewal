...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY4701L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*伝票データ（共通）　　
     SELECT   TRSHIRED  ASSIGN    TO        TRSHIRED
...
*
 01  HD1.
     03  FILLER                   PIC  X(94)     VALUE   SPACE.
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      TRSHIRED.
...
*明細２行目
***  規格
     MOVE     DEN-A32             TO        DT2-01.
***  商品コード（ＪＡＮＣＤ）
     MOVE     DEN-A43             TO        DT2-02.
***  入数
     MOVE     DEN-A35             TO        DT2-03.
***  発注単位数（ケース）
     MOVE     DEN-A36             TO        DT2-04.
***  単位
     MOVE     DEN-A39             TO        DT2-05.
***  数量
...
*ヘッダ２行目
***  ＥＯＳロゴ印字
     MOVE     "* E O S  *"        TO        HD2-02.
*ヘッダ３行目
***  社名
     MOVE     "(ｶﾌﾞ)ﾂﾙﾔ"          TO        HD3-01.
*ヘッダ３行目
***  取引先名（上段）
     MOVE     DEN-A24(1:20)       TO        HD4-01.
*ヘッダ４行目
***  店名
     MOVE     DEN-A18             TO        HD5-01.
***  店舗ＣＤ
     MOVE     DEN-A17             TO        HD5-02.
***  部門ＣＤ
     MOVE     DEN-A21             TO        HD5-03.
***  分類コード
     MOVE     DEN-A26             TO        HD5-04.
***  伝票区分
     IF       DEN-A22  =  0
...
***  取引先名（下段）
     MOVE     DEN-A24(21:20)      TO        HD5-08.
***  発注日
     MOVE     DEN-A16             TO        HD5-09.
***  納品日
     MOVE     DEN-A20             TO        HD5-10.
*
...
*
     CLOSE    TRSHIRED   PRTFILE    DSPFILE.
*
 END-EXIT.
     EXIT.
