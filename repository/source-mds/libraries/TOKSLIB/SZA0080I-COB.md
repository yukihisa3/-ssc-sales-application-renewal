...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SZA0080I.COB`
...
*----<< 画面ファイル >>-*
 FD  DSPFILE.
     COPY     FZA00801  OF   XMDLIB.
*--------------------------------------------------------------*
 WORKING-STORAGE        SECTION.
*--------------------------------------------------------------*
 01  PGM-ID                  PIC  X(08)     VALUE  "SZA0080I".
...
*----<< ﾃﾞｨｽﾌﾟﾚｲ ｺﾝﾄﾛｰﾙ ｴﾘｱ >>-*
 ...
 01  STATUS-AREA.
     ...
     03  KBM-STATUS.
         ...
         05  KBM-ST2         PIC  X(04).
*画面退避用
     COPY   FZA00801  OF XMDLIB  JOINING   SAV  AS   PREFIX.
*----<< ﾜｰｸ ｴﾘｱ >>----
 01  WK-AREA.
