...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/CSV0099B.COB`
...
****<< 発注データ >>*********************************
 FD  HACYUPRT           BLOCK CONTAINS 27   RECORDS
     ...
     COPY     HACYUPRT OF         XFDLIB
              JOINING  HAC        PREFIX.
****<< ＣＳＶデータ  >>****************************
 FD  CSVDATA            LABEL RECORD   IS   STANDARD.
     COPY     CSVDATA OF         XFDLIB
              JOINING  CSV        PREFIX.
****<< 店舗マスタ  >>**************************************
 FD  TENMS1.
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "CSV0099B".
