...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY0010I.COB`
...
*実行
         ...
         DISPLAY "LINK-SOKO-KAISI = " LINK-SOKO-KAISI UPON CONS
         DISPLAY "LINK-SOKO-OWARI = " LINK-SOKO-OWARI UPON CONS
                MOVE    "END"         TO   END-FLG
*終了
         WHEN   "F005"
                MOVE    "END"    TO   END-FLG
