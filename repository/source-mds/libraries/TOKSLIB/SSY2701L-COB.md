...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY2701L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*エンチョー伝票データ（共通）　　
     SELECT   ENSHIRE  ASSIGN    TO        ENSHIRE
...
***  ﾜｰｸ ｴﾘｱ
 01  WRK-AREA.
     ...
     03  WK-DEN-A183              PIC  9(06)     VALUE  ZERO.
 01  SEC-NAME.
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      ENSHIRE.
...
*明細２行目
***  規格
     MOVE     DEN-A17             TO   DT2-01
***  商品コード
     IF       DEN-A152      NOT  =   SPACE
              MOVE     DEN-A152(1:6) TO   DT2-02
     ELSE
              MOVE     DEN-A151      TO   DT2-02
     END-IF.
***  入数
     MOVE     DEN-A20             TO   DT2-03.
***  ケース(発注数)
...
***  Ａ欄
     IF       DEN-A12       NOT  =    ZERO
              MOVE     DEN-A12(6:3)   TO    HD1-01
     END-IF.
***  Ｂ欄
     IF       DEN-A31       NOT  =    ZERO
              MOVE     DEN-A31        TO    HD1-02
     END-IF.
***  Ｃ欄
     IF       DEN-A32       NOT  =    ZERO
              MOVE     DEN-A32        TO    HD1-03
     END-IF.
***  Ｄ欄
     MOVE     "EOSﾊｯﾁｭｳ"          TO    HD1-04.
     MOVE     DEN-A131            TO    HD1-05.
     MOVE     DEN-A132            TO    HD1-06.
*ヘッダ２行目
***  発注者名
     MOVE     "K.K ｴﾝﾁｮｰ"         TO    HD2-01.
***  取引先名
     MOVE     DEN-A071            TO    HD2-02.
*ヘッダ３行目
***  店舗名称
     MOVE     DEN-A29             TO    HD3-01.
***  店舗コード
     MOVE     DEN-A27(4:2)        TO    HD3-02.
***  分類コード(部コード)
     IF       DEN-A34       =   ZERO
              MOVE      DEN-A04       TO    HD3-03(1:2)
     ELSE
              MOVE      DEN-A04       TO    HD3-03(1:2)
              MOVE      DEN-A34       TO    HD3-03(3:2)
     END-IF.
***  伝票_
     MOVE     DEN-A02             TO    HD3-04.
***  取引先コード
     MOVE     DEN-A01             TO    HD3-05.
***  発注日
     MOVE     DEN-A08             TO    HD3-06.
***  納品日
     IF       DEN-A09       NOT  =    ZERO
              MOVE      DEN-A09       TO    HD3-07
     END-IF.
*
     MOVE     DEN-A181            TO    WK-DEN-A181.
*
     MOVE     DEN-A183            TO    WK-DEN-A183.
*
...
*テール２行目
***  Ｆ欄下段（注文書_）
     IF       WK-DEN-A183    NOT = ZERO
              MOVE     "ﾁｭｳﾓﾝｼｮNO="    TO        TL2-01
              MOVE     WK-DEN-A183     TO        TL2-02
     END-IF.
*テール３行目
...
*項目クリア
     MOVE     SPACE               TO  HD1 HD2 HD3
                                      ...
                                      TL1 TL2
*テスト印字項目セット
     MOVE   ALL "9"              TO   HD1-01  HD1-02  HD1-03
                                      HD3-02  HD3-03  HD3-04
                                      HD3-05  HD3-06  HD3-07
                                      DT2-03  DT2-04
                                      DT2-051 DT2-052 DT2-071
                                      DT2-072 DT2-08
                                      DT2-09  DT2-10
                                      TL1-02  TL1-03  TL2-02.
     MOVE   ALL "*"              TO   HD1-04  HD1-05  HD1-06
                                      HD2-01  HD2-02  HD3-01
                                      DT1-01  DT2-01  DT2-02
                                      TL1-01   TL2-01.
*ヘッダ部
     WRITE    PRT-REC          FROM   HD1        AFTER    3.
     WRITE    PRT-REC          FROM   HD2        AFTER    3.
