...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/STE0121L.COB`
...
***** メッセージエリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "STE0121L".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "STE0121L".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND1.
...
***** 見出し行１
 01  MIDASHI1.
     ...
     03  FILLER                   PIC  X(08)  VALUE "STE0121L".
...
*             プロセス                      0.0                *
****************************************************************
 STE0120-START          SECTION.
*
     MOVE     "STE0120-START"     TO   S-NAME.
     PERFORM            INIT-SEC.
*
...
*
     ...
     DISPLAY "WSURYO = " WSURYO UPON CONS.
**** IF       WSURYO    NOT =     ZERO
              PERFORM   S-CHECK-SEC.
              PERFORM   SYOKEI-SEC.
              PERFORM   CYUKEI-SEC.
