...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY5002L.COB`
...
*    作成日／更新日　　　：　2004/10/25                        *
*    作成者／更新者　　　：　ＮＡＶ　　　　　　　　　　　　　　*
*    処理概要　　　　　　：　物品受領データより物品受領書を発行*
*    伝票フォーマット　　：　汎用用紙                          *
****************************************************************
 IDENTIFICATION         DIVISION.
 PROGRAM-ID.            SSY5002L.
 AUTHOR.                NAV.
 DATE-WRITTEN.          04/10/25.
*REMARKS.
*
******************************************************************
*                                                                *
...
****  メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SSY5002L".
...
*    ﾐﾀﾞｼ
 01  HEAD-01.
     ...
     03  FILLER                   PIC  X(08)     VALUE "SSY5002L".
...
*
 01  BODY-01.
     ...
     03  FILLER                   PIC  X(01)     VALUE   SPACE.
     03  BD01-NOHIN-M             PIC  X(01)     VALUE   SPACE.
     03  BD01-NOHIN               PIC  Z,ZZ9.9.
     03  BD01-NOHIN-E             PIC  X(01)     VALUE   SPACE.
     03  FILLER                   PIC  X(01)     VALUE   SPACE.
...
*伝票ヘッダレコード（２）
 01  WK-DEPD-REC.
     ...
     03  WK-DEPD03          PIC  X(01).
     03  WK-DEPD04          PIC  X(30).
     03  WK-DEPD05          PIC  X(20).
     03  WK-DEPD06          PIC  X(20).
     03  WK-DEPD07          PIC  X(17).
     03  WK-DEPD08          PIC  X(17).
     03  WK-DEPD09          PIC  X(12).
     03  WK-DEPD10          PIC  X(01).
     03  WK-DEPD11          PIC  X(04).
     03  WK-DEPD12          PIC  X(03).
*伝票明細レコード
 01  WK-DEPT-REC.
     03  WK-DEPT01          PIC  X(01).
     03  WK-DEPT02          PIC  X(02).
     03  WK-DEPT03          PIC  9(02).
     03  WK-DEPT04          PIC  X(08).
     03  WK-DEPT05          PIC  X(02).
     03  WK-DEPT06          PIC  9(03).
     03  WK-DEPT07          PIC  9(05).
     03  WK-DEPT08          PIC  X(03).
     03  WK-DEPT09          PIC  9(05).
     03  WK-DEPT10          PIC  9(01).
     03  WK-DEPT11          PIC  9(07)V9(02).
     03  WK-DEPT12          PIC  9(07).
     03  WK-DEPT13          PIC  9(09).
     03  WK-DEPT14          PIC  9(09).
     03  WK-DEPT15          PIC  X(25).
     03  WK-DEPT16          PIC  X(15).
     03  WK-DEPT17          PIC  9(13).
     03  WK-DEPT18          PIC  9(05).
     03  WK-DEPT19          PIC  X(01).
     03  WK-DEPT20          PIC  X(01).
     03  WK-DEPT21          PIC  X(02).
*
*日付変換サブルーチン用ワーク
...
*    品名
     MOVE     WK-DEPT15          TO   BD01-SYOUHIN-UE.
*    品名
     MOVE     WK-DEPT16          TO   BD02-SYOUHIN-SITA.
*    商品ＣＤ
     MOVE     WK-DEPT04          TO   BD01-SYOCD.
*    ＪＡＮＣＤ
     MOVE     WK-DEPT17          TO   BD02-JANCD.
*    発注数量
     MOVE     WK-DEPT09          TO   BD01-SURYO.
*    実納品数量
     MOVE     "("                TO   BD01-NOHIN-M.
     MOVE     WK-DEPT18          TO   BD01-NOHIN.
     MOVE     ")"                TO   BD01-NOHIN-E.
*    原価単価
     MOVE     WK-DEPT11          TO   BD01-GENKA-TANKA.
*    原価金額
     COMPUTE  BD01-GENKA-KINGAKU =   WK-DEPT18 * WK-DEPT11.
     COMPUTE WK-GOKEI-GEN = WK-GOKEI-GEN + WK-DEPT18 * WK-DEPT11.
*売価単価
     MOVE     WK-DEPT12          TO   BD01-BAIKA-TANKA.
*    売価金額
     COMPUTE  BD01-BAIKA-KINGAKU =   WK-DEPT18 * WK-DEPT12.
     COMPUTE WK-GOKEI-BAI = WK-GOKEI-BAI + WK-DEPT18 * WK-DEPT12.
*    欠品数量
     MOVE     "("                TO   BD01-KEPIN-M.
     COMPUTE  BD01-KEPIN  =  WK-DEPT09 - WK-DEPT18.
     MOVE     ")"                TO   BD01-KEPIN-E.
*    取消区分
     MOVE     WK-DEPT19          TO   BD01-TORIKESI.
*
...
*    取引先
     ...
     MOVE     WK-DEPB13        TO      HD03-TORIMEI.
*    分類
     MOVE     WK-DEPB07        TO      HD03-BUNRUI.
*    定番特売区分
     MOVE     WK-DEPD03        TO      HD03-TEITOKU.
     EVALUATE WK-DEPD03
