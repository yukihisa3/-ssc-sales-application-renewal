...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY2501L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*ユニディー伝票データ（共通）　　
     SELECT   YUNSHIRE  ASSIGN    TO        YUNSHIRE
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      YUNSHIRE.
...
***  色／入数
     MOVE     DEN-A19             TO   DT2-03.
***  ケース数
     MOVE     DEN-A20             TO   DT2-04.
***  数量
...
***  取引先名
     MOVE     DEN-A07             TO    HD2-02.
*
*ヘッダ３行目
***  店名
     MOVE     DEN-A28             TO    HD3-01.
***  社／店コード
     MOVE     DEN-A26(1:2)        TO    HD3-02.
***  分類コード
     MOVE     DEN-A34             TO    HD3-03.
***  伝票区分
...
*
     ...
     MOVE   ALL "*"              TO   HD1-01  HD2-01
                                      HD2-02  HD3-01  HD3-02
                                      HD3-03  HD3-04  HD3-06
                                      DT1-01  DT2-02
                                      DT2-01.
*
*ヘッド印字
...
*
     CLOSE    YUNSHIRE   PRTFILE    DSPFILE.
*
 END-EXIT.
     EXIT.
