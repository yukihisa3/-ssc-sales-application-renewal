...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SNY0010I.COB`
...
*           発注番号、発注番号枝、相殺
            IF   NYU-F02 = HACYU  AND  NYU-F03 = HACYUE  AND
                 NYU-F04 = SOSAI
**********DISPLAY "NYU-F311= " NYU-F31 UPON CONS
**********DISPLAY "NYU-F011= " NYU-F01 UPON CONS
*                計上済フラグ＝０、伝票区分＝５０、６０
                 IF  (( NYU-F31 = 0 ) AND ( NYU-F01 = 50 OR 60))
**********DISPLAY "AAAAAAAAAA" UPON CONS
**********DISPLAY "NYU-F313= " NYU-F31 UPON CONS
                     CONTINUE
                 ELSE
**********DISPLAY "NYU-F312= " NYU-F31 UPON CONS
**********DISPLAY "NYU-F012= " NYU-F01 UPON CONS
