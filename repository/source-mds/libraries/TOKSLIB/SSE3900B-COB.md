...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSE3900B.COB`
...
*--------------------------------------------------------------*
 ...
 FILE-CONTROL.
*---<<  ＩＮ１ファイル  >>---*
     SELECT   SETGKF  ASSIGN    TO        DA-01-SETGKF
...
**
 FILEERR-SEC2           SECTION.
     USE AFTER     EXCEPTION
                   PROCEDURE      HSEIGKF.
     DISPLAY "OUT-ST = " OUT-ST UPON CONS.
     MOVE      4000          TO   PROGRAM-STATUS.
     STOP     RUN.
 END     DECLARATIVES.
****************************************************************
