...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/STE5101B.COB`
...
***  ﾜｰｸ  ｴﾘｱ
 01  WRK-AREA.
     03  WK-TORICD                PIC  9(08)     VALUE   59099.
...
*    テスト印字項目セット
     ...
     MOVE   ALL "*"              TO   HD02    HD04    MS03
                                      BIKO01  BIKO02  MS01  MS02
                                      TANT01  TANT02.
     MOVE   ALL NC"＊"           TO   HD01    HD07.
*    ヘッド印字
