...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY7002B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY7002B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY7002B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*
     IF     ( PARA-JDATE     =    DEN-F46 ) AND
            ...
            ( PARA-TORICD    =    DEN-F01 )
************DISPLAY "PARA-JDATE=" PARA-JDATE
*                   "PARA-JTIME=" PARA-JTIME
*                   "PARA-TORICD=" PARA-TORICD
*                   "DEN-F46=" DEN-F46
*                   "DEN-F47=" DEN-F47
************        "DEN-F01=" DEN-F01  UPON CONS
...
*ゴンドラ_が空白の場合読み飛ばし
*****IF       RD-CNT(6:3)  =  "000"
*****         DISPLAY NC"通過" UPON CONS
*****END-IF.
     IF       DEN-A12A(13:4)  =  SPACE
