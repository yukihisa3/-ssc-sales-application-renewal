...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY3109B.COB`
...
*
 ...
 FILE-CONTROL.
*カーマ出荷確定データ
     SELECT   SNDKMSS   ASSIGN    TO        DA-01-S-SNDKMSS
...
*明細ヘッダ編集
 01  WK-HED-REC.
     ...
     03  WK-HED-F17          PIC  X(20).
     03  WK-HED-F18          PIC  X(34).
*明細編集
 01  WK-MEI-REC.
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY3109B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY3109B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
