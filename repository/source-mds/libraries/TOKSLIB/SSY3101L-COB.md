...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY3101L.COB`
...
*
 01  HD1.
     ...
     03  HD1-01                   PIC  X(15)     VALUE   SPACE.
*
 01  HD2.
     03  FILLER                   PIC  X(52)     VALUE   SPACE.
     03  HD2-01                   PIC  99.
...
*
 01  DT2.
     ...
     03  DT2-052                  PIC  ZZ.
     03  FILLER                   PIC  X(03)     VALUE   SPACE.
     03  DT2-06                   PIC  ZZZZZZ9.
     03  FILLER                   PIC  X(02)     VALUE   SPACE.
     03  DT2-07                   PIC  ZZZZZ9.
     03  FILLER                   PIC  X(01)     VALUE   SPACE.
     03  DT2-08                   PIC  ZZZZZZZ9.
*伝票訂正用
 01  DT22.
...
*ヘッダ２行目
*納品開始日／納品終了日
     MOVE     DEN-A29(1:2)         TO    HD2-01.
     MOVE     DEN-A29(3:2)         TO    HD2-03.
     MOVE     DEN-A29(5:2)         TO    HD2-05.
     MOVE     DEN-A30(1:2)         TO    HD2-07.
     MOVE     DEN-A30(3:2)         TO    HD2-09.
     MOVE     DEN-A30(5:2)         TO    HD2-11.
     MOVE     "/"                  TO    HD2-02.
     MOVE     "/"                  TO    HD2-04.
     MOVE     "/"                  TO    HD2-08.
     MOVE     "/"                  TO    HD2-10.
...
*伝票記号
     MOVE     DEN-A25              TO    HD3-02.
*伝票番号
     MOVE     DEN-A02              TO    HD3-03.
*ヘッダ４行目
*店名
     MOVE     DEN-A24              TO    HD4-01.
*社／店コード
...
*発注日
     MOVE     DEN-A10              TO    HD4-05.
*取引先コード
     MOVE     DEN-A01              TO    HD4-06.
*取引先名称
     MOVE     DEN-A09              TO    HD4-07.
*
