...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY0201I.COB`
...
*----<< 画面ファイル >>-*
 FD  DSPFILE.
     COPY     FSY02011  OF   XMDLIB.
*--------------------------------------------------------------*
 WORKING-STORAGE        SECTION.
*--------------------------------------------------------------*
 01  PGM-ID                  PIC  X(08)     VALUE  "SSY0201I".
*----<< ﾃﾞｨｽﾌﾟﾚｲ ｺﾝﾄﾛｰﾙ ｴﾘｱ >>-*
 01  DSP-CNTL.
     03  DSP-FMT             PIC  X(08).
     03  DSP-GRP             PIC  X(08).
...
***   93/05/26    END   ***
*画面退避用
     COPY   FSY02011  OF XMDLIB  JOINING   SAV  AS   PREFIX.
*
***  93/05/08  START  ***
 01  SAVE-AREA.
...
***  94.05.16  END   ***
     ...
     MOVE      SPACE     TO   FSY02011   TABLE-AREA.
     INITIALIZE               TBL-XX.
     MOVE      ZERO      TO   WK-TAIHI.
...
*## 2000/04/05 NAV START ##*売上日付をワークへセット
...
*--------------------------------------------------------------*
 DSP-RD-RTN           SECTION.
*
     MOVE    "SSY0201I"      TO        PGID.
     MOVE    "FSY02011"      TO        FORM.
