...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SJH0011I.COB`
...
*****MOVE     ZERO           TO   KEN-F04.
     ...
     START    JHMKENF   KEY  IS   >=   KEN-F01 KEN-F02 KEN-F03
                                       KEN-F04
     INVALID
              MOVE      9    TO   KEN-FLG
     NOT INVALID
...
****************************************************************
 END-SEC               SECTION.
*ファイル ＣＬＯＳＥ
     CLOSE             JHMKENF HTOKMS DSPFILE.
**
 END-EXIT.
     EXIT.
*****************<<  SJH0011I   END PROGRAM  >>******************
