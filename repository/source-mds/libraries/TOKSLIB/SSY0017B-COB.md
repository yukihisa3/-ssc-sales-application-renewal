...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY0017B.COB`
...
***2011.11.29 ST
***      05  DEN1-05              PIC       X(12).
         05  DEN1-051             PIC       9(02).
         05  DEN1-052             PIC       N(04).
         05  DEN1-053             PIC       9(02).
***2011.11.29 ED
         05  DEN1-06              PIC       9(05).
***2011.11.29 ST
***      05  DEN1-07              PIC       X(32).
         05  DEN1-071             PIC       X(02).
         05  DEN1-072             PIC       X(02).
         05  DEN1-073             PIC       X(07).
         05  DEN1-074             PIC       9(08) PACKED-DECIMAL.
         05  DEN1-075             PIC       9(08) PACKED-DECIMAL.
         05  DEN1-076             PIC       9(08) PACKED-DECIMAL.
         05  DEN1-077             PIC       X(04).
         05  DEN1-078             PIC       X(02).
***2011.11.29 ED
         05  DEN1-08              PIC       X(02).
         05  DEN1-09              PIC       X(02).
     03  DEN2.
         05  DEN2-01              PIC       X(08).
         05  DEN2-02              PIC       X(117).
     03  DEN3                     PIC       X(13).
     03  DEN4.
...
*プログラムＩＤ
 01  PG-ID.
     03  ID-PG          PIC  X(08)     VALUE  "SSY0017B".
*日付ワーク
...
***2011.11.29 ST
     ...
     INITIALIZE                        DEN-REC.
***2011.11.29 ED
     MOVE     LINK-DATE           TO   DEN4-02
     MOVE     LINK-TIME           TO   DEN4-03
     MOVE     LINK-TORICD         TO   DEN1-01
     MOVE     LINK-SOKO-KAISI     TO   DEN4-04
***2011.11.29 ST
***  START    SHTDENF   KEY       >=   DEN4-02
***                                    DEN4-03
***                                    DEN1-01
***                                    DEN4-04
     START    SHTDENF   KEY       >=   DEN4-02
...
*
     ...
     END-READ.
*ブレイクチェック
     IF       DEN4-04   >      LINK-SOKO-OWARI  OR
              DEN1-01   NOT =  LINK-TORICD      OR
              DEN4-03   NOT =  LINK-TIME        OR
              DEN4-02   NOT =  LINK-DATE
              MOVE     "END"      TO   END-FLG
              GO        TO        FL-RD-EXIT
     END-IF.
*
