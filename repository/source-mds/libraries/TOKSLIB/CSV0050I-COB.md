...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/CSV0050I.COB`
...
*    サブシステム　　　　：　出荷管理システム　　　　　　　　　*
*    業務名　　　　　　　：　投入リストデータ連携              *
*    モジュール名　　　　：　投入リストデータＣＳＶ出力        *
*    作成日／更新日　　　：　03/07/22                          *
*    作成者／更新者　　　：　NAV                               *
*    処理概要　　　　　　：　　　　　　　　　　　　　　　　　　*
*    更新日／更新者　　　：　11/10/04 / YOSHIDA.M              *
*    修正概要　　　　　　：　基幹サーバ統合                    *
*                        ：　Ｆ１３２→Ｆ０５１キー修正        *
*                                                              *
****************************************************************
...
***           ゼロ以外，開始倉庫コードまでチェック
              ELSE
*           DISPLAY "DSP-SOKCD1 = " DSP-SOKCD1 UPON CONS
*           DISPLAY "DSP-SOKCD2 = " DSP-SOKCD2 UPON CONS
*           DISPLAY "DEN-F48    = " DEN-F48    UPON CONS
                   IF  DSP-BTDATE =    DEN-F46 AND
                       DSP-BTTIME =    DEN-F47 AND
                       DSP-BTTORI =    DEN-F01 AND
                     ( DSP-SOKCD1 <=   DEN-F48 AND
                       DSP-SOKCD2 >=   DEN-F48 )
                       MOVE  SPACE TO  EDIT-CURSOR OF DSP-BTDATE
                   ELSE
                       MOVE   9   TO   ERR-FLG
...
*実行
         WHEN   "E000"
                ...
                MOVE    DSP-SOKCD1    TO   LINK-SOKO-KAISI
                MOVE    DSP-SOKCD2    TO   LINK-SOKO-OWARI
                MOVE    DSP-BTDATE    TO   PARA-HIDUKE
                MOVE    DSP-BTTIME    TO   PARA-JIKAN
                MOVE    DSP-BTTORI    TO   PARA-TOKCD
                MOVE    "END"         TO   END-FLG
*終了
         WHEN   "F005"
                MOVE    "END"    TO   END-FLG
