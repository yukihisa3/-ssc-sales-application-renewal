...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SZA0140B.COB`
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SZA0140B".
...
************************************************************
 300-END-SEC            SECTION.
     CLOSE  NYKFILF  HACHEDF  HACMEIF  SHO  TOKU  TOKMS2.
 300-END-SEC-EXT.
     EXIT.
*--------------------------------------------------------------*
*    条件マスタ読込み
