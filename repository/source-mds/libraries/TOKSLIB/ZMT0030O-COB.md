...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/ZMT0030O.COB`
...
****  メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "ZMT0030O".
...
*
     OPEN    I-O             DSPF.
     OPEN    I-O             ZSHIMS.
     MOVE    "ZMT0030"       TO   DSP-FORMAT.
     MOVE    SPACE           TO   DSP-ZMT0030.
...
*  処理モードにより追加・更新・削除
     EVALUATE    WK-SYORI
        WHEN  1    WRITE      SHI-REC
                   END-WRITE
        WHEN  2    REWRITE    SHI-REC
                   END-REWRITE
        WHEN  3    DELETE     ZSHIMS
                   END-DELETE
     END-EVALUATE.
*
     PERFORM       HEADDEL-SUB.
