...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/ZTA0055B.COB`
...
*----<< ＯＵＴファイル >>-*
     SELECT   OUTFILE   ASSIGN    TO        DA-01-S-OUTFILE
                        ACCESS    MODE      SEQUENTIAL
...
*--------------------------------------------------------------*
 ...
 01  MSG-AREA1-1.
     03  MSG-ABEND1.
       ...
       05  ERR-PG-ID         PIC  X(08)  VALUE "ZTA0055B".
...
****************************************************************
 END-SEC                SECTION.
     DISPLAY "***   IN      DATA = "  IN-CNT    UPON  CONS.
     DISPLAY "***   OUT     DATA = "  OUT-CNT   UPON  CONS.
     CLOSE    ZTANADT2  OUTFILE.
 END-END.
     EXIT.
*****************<<  PROGRAM  END  >>***********************
