...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKE0090B.COB`
...
*送信用データ２
     SELECT   KNPTAN02  ASSIGN    TO        KNPTAN02
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   D02-STATUS.
*送信用データ３
     SELECT   KNPTAN03  ASSIGN    TO        KNPTAN03
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   D03-STATUS.
*送信用データ４
     SELECT   KNPTAN04  ASSIGN    TO        KNPTAN04
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   D04-STATUS.
*送信用データ５
     SELECT   KNPTAN05  ASSIGN    TO        KNPTAN05
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   D05-STATUS.
*送信用伝票データ６
     SELECT   KNPTAN06  ASSIGN    TO        KNPTAN06
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   D06-STATUS.
*送信用伝票データ７
     SELECT   KNPTAN07  ASSIGN    TO        KNPTAN07
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   D07-STATUS.
*送信用伝票データ８
     SELECT   KNPTAN08  ASSIGN    TO        KNPTAN08
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   D08-STATUS.
*送信用伝票データ９
     SELECT   KNPTAN09  ASSIGN    TO        KNPTAN09
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   D09-STATUS.
*送信用伝票データ１０
     SELECT   KNPTAN10  ASSIGN    TO        KNPTAN10
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   D10-STATUS.
*送信用伝票データ１１
     SELECT   KNPTAN11  ASSIGN    TO        KNPTAN11
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   D11-STATUS.
*送信用伝票データ１２
     SELECT   KNPTAN12  ASSIGN    TO        KNPTAN12
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   D12-STATUS.
*送信用伝票データ１３
     SELECT   KNPTAN13  ASSIGN    TO        KNPTAN13
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   D13-STATUS.
*送信用伝票データ１４
     SELECT   KNPTAN14  ASSIGN    TO        KNPTAN14
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   D14-STATUS.
*送信用伝票データ１５
     SELECT   KNPTAN15  ASSIGN    TO        KNPTAN15
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   D15-STATUS.
*送信用伝票データ１６
     SELECT   KNPTAN16  ASSIGN    TO        KNPTAN16
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   D16-STATUS.
*送信用伝票データ１７
     SELECT   KNPTAN17  ASSIGN    TO        KNPTAN17
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   D17-STATUS.
*送信用伝票データ１８
     SELECT   KNPTAN18  ASSIGN    TO        KNPTAN18
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   D18-STATUS.
*送信用伝票データ１９
     SELECT   KNPTAN19  ASSIGN    TO        KNPTAN19
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   D19-STATUS.
*送信用伝票データ２０
     SELECT   KNPTAN20  ASSIGN    TO        KNPTAN20
                        ACCESS    MODE      IS   SEQUENTIAL
...
*件数ファイル０２
     SELECT   KNPTAK02  ASSIGN    TO        KNPTAK02
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   K02-STATUS.
*件数ファイル０３
     SELECT   KNPTAK03  ASSIGN    TO        KNPTAK03
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   K03-STATUS.
*件数ファイル０４
     SELECT   KNPTAK04  ASSIGN    TO        KNPTAK04
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   K04-STATUS.
*件数ファイル０５
     SELECT   KNPTAK05  ASSIGN    TO        KNPTAK05
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   K05-STATUS.
*件数ファイル０６
     SELECT   KNPTAK06  ASSIGN    TO        KNPTAK06
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   K06-STATUS.
*件数ファイル０７
     SELECT   KNPTAK07  ASSIGN    TO        KNPTAK07
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   K07-STATUS.
*件数ファイル０８
     SELECT   KNPTAK08  ASSIGN    TO        KNPTAK08
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   K08-STATUS.
*件数ファイル０９
     SELECT   KNPTAK09  ASSIGN    TO        KNPTAK09
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   K09-STATUS.
*件数ファイル１０
     SELECT   KNPTAK10  ASSIGN    TO        KNPTAK10
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   K10-STATUS.
*件数ファイル１１
     SELECT   KNPTAK11  ASSIGN    TO        KNPTAK11
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   K11-STATUS.
*件数ファイル１２
     SELECT   KNPTAK12  ASSIGN    TO        KNPTAK12
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   K12-STATUS.
*件数ファイル１３
     SELECT   KNPTAK13  ASSIGN    TO        KNPTAK13
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   K13-STATUS.
*件数ファイル１４
     SELECT   KNPTAK14  ASSIGN    TO        KNPTAK14
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   K14-STATUS.
*件数ファイル１５
     SELECT   KNPTAK15  ASSIGN    TO        KNPTAK15
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   K15-STATUS.
*件数ファイル１６
     SELECT   KNPTAK16  ASSIGN    TO        KNPTAK16
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   K16-STATUS.
*件数ファイル１７
     SELECT   KNPTAK17  ASSIGN    TO        KNPTAK17
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   K17-STATUS.
*件数ファイル１８
     SELECT   KNPTAK18  ASSIGN    TO        KNPTAK18
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   K18-STATUS.
*件数ファイル１９
     SELECT   KNPTAK19  ASSIGN    TO        KNPTAK19
                        ACCESS    MODE      IS   SEQUENTIAL
                        FILE      STATUS    IS   K19-STATUS.
*件数ファイル２０
     SELECT   KNPTAK20  ASSIGN    TO        KNPTAK20
                        ACCESS    MODE      IS   SEQUENTIAL
...
******************************************************************
 FD  KNPTAN01           LABEL RECORD   IS   STANDARD.
     COPY     KNPTANF   OF        XFDLIB
              JOINING   D01       PREFIX.
******************************************************************
*    送信用店舗データ２
******************************************************************
 FD  KNPTAN02           LABEL RECORD   IS   STANDARD.
     COPY     KNPTANF   OF        XFDLIB
              JOINING   D02       PREFIX.
******************************************************************
*    送信用店舗データ３
******************************************************************
 FD  KNPTAN03           LABEL RECORD   IS   STANDARD.
     COPY     KNPTANF   OF        XFDLIB
              JOINING   D03       PREFIX.
******************************************************************
*    送信用店舗データ４
******************************************************************
 FD  KNPTAN04           LABEL RECORD   IS   STANDARD.
     COPY     KNPTANF   OF        XFDLIB
              JOINING   D04       PREFIX.
******************************************************************
*    送信用店舗データ５
******************************************************************
 FD  KNPTAN05           LABEL RECORD   IS   STANDARD.
     COPY     KNPTANF   OF        XFDLIB
              JOINING   D05       PREFIX.
******************************************************************
*    送信用店舗データ６
******************************************************************
 FD  KNPTAN06           LABEL RECORD   IS   STANDARD.
     COPY     KNPTANF   OF        XFDLIB
              JOINING   D06       PREFIX.
******************************************************************
*    送信用店舗データ７
******************************************************************
 FD  KNPTAN07           LABEL RECORD   IS   STANDARD.
     COPY     KNPTANF   OF        XFDLIB
              JOINING   D07       PREFIX.
******************************************************************
*    送信用店舗データ８
******************************************************************
 FD  KNPTAN08           LABEL RECORD   IS   STANDARD.
     COPY     KNPTANF   OF        XFDLIB
              JOINING   D08       PREFIX.
******************************************************************
*    送信用店舗データ９
******************************************************************
 FD  KNPTAN09           LABEL RECORD   IS   STANDARD.
     COPY     KNPTANF   OF        XFDLIB
              JOINING   D09       PREFIX.
******************************************************************
*    送信用店舗データ１０
******************************************************************
 FD  KNPTAN10           LABEL RECORD   IS   STANDARD.
     COPY     KNPTANF   OF        XFDLIB
              JOINING   D10       PREFIX.
******************************************************************
*    送信用店舗データ１１
******************************************************************
 FD  KNPTAN11           LABEL RECORD   IS   STANDARD.
     COPY     KNPTANF   OF        XFDLIB
              JOINING   D11       PREFIX.
******************************************************************
*    送信用店舗データ１２
******************************************************************
 FD  KNPTAN12           LABEL RECORD   IS   STANDARD.
     COPY     KNPTANF   OF        XFDLIB
              JOINING   D12       PREFIX.
******************************************************************
*    送信用店舗データ１３
******************************************************************
 FD  KNPTAN13           LABEL RECORD   IS   STANDARD.
     COPY     KNPTANF   OF        XFDLIB
              JOINING   D13       PREFIX.
******************************************************************
*    送信用店舗データ１４
******************************************************************
 FD  KNPTAN14           LABEL RECORD   IS   STANDARD.
     COPY     KNPTANF   OF        XFDLIB
              JOINING   D14       PREFIX.
******************************************************************
*    送信用店舗データ１５
******************************************************************
 FD  KNPTAN15           LABEL RECORD   IS   STANDARD.
     COPY     KNPTANF   OF        XFDLIB
              JOINING   D15       PREFIX.
******************************************************************
*    送信用店舗データ１６
******************************************************************
 FD  KNPTAN16           LABEL RECORD   IS   STANDARD.
     COPY     KNPTANF   OF        XFDLIB
              JOINING   D16       PREFIX.
******************************************************************
*    送信用店舗データ１７
******************************************************************
 FD  KNPTAN17           LABEL RECORD   IS   STANDARD.
     COPY     KNPTANF   OF        XFDLIB
              JOINING   D17       PREFIX.
******************************************************************
*    送信用店舗データ１８
******************************************************************
 FD  KNPTAN18           LABEL RECORD   IS   STANDARD.
     COPY     KNPTANF   OF        XFDLIB
              JOINING   D18       PREFIX.
******************************************************************
*    送信用店舗データ１９
******************************************************************
 FD  KNPTAN19           LABEL RECORD   IS   STANDARD.
     COPY     KNPTANF   OF        XFDLIB
              JOINING   D19       PREFIX.
******************************************************************
*    送信用店舗データ２０
******************************************************************
 FD  KNPTAN20           LABEL RECORD   IS   STANDARD.
     COPY     KNPTANF   OF        XFDLIB
              JOINING   D20       PREFIX.
******************************************************************
*    件数データ０１
...
*    件数データ０２
******************************************************************
 FD  KNPTAK02           BLOCK CONTAINS 1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  K02-REC.
     03  K02-F01             PIC  9(08).
     03  K02-F02             PIC  X(02).
...
*    件数データ０３
******************************************************************
 FD  KNPTAK03           BLOCK CONTAINS 1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  K03-REC.
     03  K03-F01             PIC  9(08).
     03  K03-F02             PIC  X(02).
...
*    件数データ０４
******************************************************************
 FD  KNPTAK04           BLOCK CONTAINS 1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  K04-REC.
     03  K04-F01             PIC  9(08).
     03  K04-F02             PIC  X(02).
...
*    件数データ０５
******************************************************************
 FD  KNPTAK05           BLOCK CONTAINS 1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  K05-REC.
     03  K05-F01             PIC  9(08).
     03  K05-F02             PIC  X(02).
...
*    件数データ０６
******************************************************************
 FD  KNPTAK06           BLOCK CONTAINS 1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  K06-REC.
     03  K06-F01             PIC  9(08).
     03  K06-F02             PIC  X(02).
...
*    件数データ０７
******************************************************************
 FD  KNPTAK07           BLOCK CONTAINS 1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  K07-REC.
     03  K07-F01             PIC  9(08).
     03  K07-F02             PIC  X(02).
...
*    件数データ０８
******************************************************************
 FD  KNPTAK08           BLOCK CONTAINS 1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  K08-REC.
     03  K08-F01             PIC  9(08).
     03  K08-F02             PIC  X(02).
...
*    件数データ０９
******************************************************************
 FD  KNPTAK09           BLOCK CONTAINS 1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  K09-REC.
     03  K09-F01             PIC  9(08).
     03  K09-F02             PIC  X(02).
...
*    件数データ１０
******************************************************************
 FD  KNPTAK10           BLOCK CONTAINS 1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  K10-REC.
     03  K10-F01             PIC  9(08).
     03  K10-F02             PIC  X(02).
...
*    件数データ１１
******************************************************************
 FD  KNPTAK11           BLOCK CONTAINS 1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  K11-REC.
     03  K11-F01             PIC  9(08).
     03  K11-F02             PIC  X(02).
...
*    件数データ１２
******************************************************************
 FD  KNPTAK12           BLOCK CONTAINS 1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  K12-REC.
     03  K12-F01             PIC  9(08).
     03  K12-F02             PIC  X(02).
...
*    件数データ１３
******************************************************************
 FD  KNPTAK13           BLOCK CONTAINS 1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  K13-REC.
     03  K13-F01             PIC  9(08).
     03  K13-F02             PIC  X(02).
...
*    件数データ１４
******************************************************************
 FD  KNPTAK14           BLOCK CONTAINS 1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  K14-REC.
     03  K14-F01             PIC  9(08).
     03  K14-F02             PIC  X(02).
...
*    件数データ１５
******************************************************************
 FD  KNPTAK15           BLOCK CONTAINS 1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  K15-REC.
     03  K15-F01             PIC  9(08).
     03  K15-F02             PIC  X(02).
...
*    件数データ１６
******************************************************************
 FD  KNPTAK16           BLOCK CONTAINS 1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  K16-REC.
     03  K16-F01             PIC  9(08).
     03  K16-F02             PIC  X(02).
...
*    件数データ１７
******************************************************************
 FD  KNPTAK17           BLOCK CONTAINS 1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  K17-REC.
     03  K17-F01             PIC  9(08).
     03  K17-F02             PIC  X(02).
...
*    件数データ１８
******************************************************************
 FD  KNPTAK18           BLOCK CONTAINS 1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  K18-REC.
     03  K18-F01             PIC  9(08).
     03  K18-F02             PIC  X(02).
...
*    件数データ１９
******************************************************************
 FD  KNPTAK19           BLOCK CONTAINS 1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  K19-REC.
     03  K19-F01             PIC  9(08).
     03  K19-F02             PIC  X(02).
...
*    件数データ２０
******************************************************************
 FD  KNPTAK20           BLOCK CONTAINS 1    RECORDS
                        LABEL RECORD   IS   STANDARD.
 01  K20-REC.
     03  K20-F01             PIC  9(08).
     03  K20-F02             PIC  X(02).
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SKE0090B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SKE0090B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    線２
 01  SEN2.
     ...
     03  FILLER                   PIC       X(36)  VALUE
         "------------------------------------".
*
     COPY   KNPTANF  OF XFDLIB  JOINING   WK  AS   PREFIX.
*    名称編集１
 01  WK-HEN1.
...
****************************************************************
 INIT-SEC               SECTION.
     ...
     OPEN     INPUT     SOKKENF JYOKENF HSHOTBL.
     OPEN     OUTPUT    KNPTAN01.
     OPEN     OUTPUT    KNPTAN02.
     OPEN     OUTPUT    KNPTAN03.
     OPEN     OUTPUT    KNPTAN04.
     OPEN     OUTPUT    KNPTAN05.
     OPEN     OUTPUT    KNPTAN06.
     OPEN     OUTPUT    KNPTAN07.
     OPEN     OUTPUT    KNPTAN08.
     OPEN     OUTPUT    KNPTAN09.
     OPEN     OUTPUT    KNPTAN10.
     OPEN     OUTPUT    KNPTAN11.
     OPEN     OUTPUT    KNPTAN12.
     OPEN     OUTPUT    KNPTAN13.
     OPEN     OUTPUT    KNPTAN14.
     OPEN     OUTPUT    KNPTAN15.
     OPEN     OUTPUT    KNPTAN16.
     OPEN     OUTPUT    KNPTAN17.
     OPEN     OUTPUT    KNPTAN18.
     OPEN     OUTPUT    KNPTAN19.
     OPEN     OUTPUT    KNPTAN20.
     OPEN     OUTPUT    KNPTAK01.
     OPEN     OUTPUT    KNPTAK02.
     OPEN     OUTPUT    KNPTAK03.
     OPEN     OUTPUT    KNPTAK04.
     OPEN     OUTPUT    KNPTAK05.
     OPEN     OUTPUT    KNPTAK06.
     OPEN     OUTPUT    KNPTAK07.
     OPEN     OUTPUT    KNPTAK08.
     OPEN     OUTPUT    KNPTAK09.
     OPEN     OUTPUT    KNPTAK10.
     OPEN     OUTPUT    KNPTAK11.
     OPEN     OUTPUT    KNPTAK12.
     OPEN     OUTPUT    KNPTAK13.
     OPEN     OUTPUT    KNPTAK14.
     OPEN     OUTPUT    KNPTAK15.
     OPEN     OUTPUT    KNPTAK16.
     OPEN     OUTPUT    KNPTAK17.
     OPEN     OUTPUT    KNPTAK18.
     OPEN     OUTPUT    KNPTAK19.
     OPEN     OUTPUT    KNPTAK20.
*****OPEN     OUTPUT    PRINTF.
