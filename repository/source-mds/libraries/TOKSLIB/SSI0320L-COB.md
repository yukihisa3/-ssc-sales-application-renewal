...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSI0320L.COB`
...
*
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
 01  PG-ID              PIC  X(08)     VALUE   "SSI0320L".
*
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
...
*--<< ﾌﾟﾘﾝﾄ AREA >>-*
 01  HEAD01.
     03  FILLER         CHARACTER TYPE BAIKAKU-1-5.
         ...
         05  FILLER     PIC  X(08)     VALUE  "SSI0320L".
...
*----<< 支払合計ファイル >>--*
 SSI-ERR                SECTION.
     ...
     DISPLAY  "### " PG-ID " SITGKF39  ERROR " SSI-ST " "
