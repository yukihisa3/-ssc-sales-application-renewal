...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SFU0106B.COB`
...
**** メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SFU0106B".
...
*判定処理
     EVALUATE   TO0-F02
         WHEN   20
                PERFORM  FURI-20-SEC
         WHEN   70
***             IF  TO0-F01(1:2)  NOT =  "29"
***                 PERFORM  FURI-701-SEC
***             ELSE
***                 PERFORM  FURI-70-SEC
***             END-IF
                IF  TO0-F01 =  3346 OR 3356 OR 3346 OR 3136 OR
                               3236 OR 3266
                    PERFORM  FURI-70-SEC
                ELSE
                    PERFORM  FURI-701-SEC
...
*    END-READ.
     EVALUATE TO0-F01
         WHEN 3266
              MOVE 99999290  TO  WRK1-F06
         WHEN 3436
              MOVE 99999291  TO  WRK1-F06
         WHEN 3236
              MOVE 99999292  TO  WRK1-F06
         WHEN 2930
              MOVE 99999293  TO  WRK1-F06
         WHEN 3356
              MOVE 99999294  TO  WRK1-F06
         WHEN 3136
              MOVE 99999295  TO  WRK1-F06
         WHEN 2960
