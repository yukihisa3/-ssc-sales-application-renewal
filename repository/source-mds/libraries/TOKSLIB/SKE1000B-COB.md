...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKE1000B.COB`
...
*----<< ﾌｱｲﾙ ｽﾃｰﾀｽ >>--*
     ...
     03  ER3-ST         PIC  X(02).
*
 01  PG-ID              PIC  X(08)     VALUE  "SKE1000B".
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
...
*--------------------------------------------------------------*
 ...
 RCVERRF1               SECTION.
     ...
     DISPLAY  "### SKE1000B RCVERRF1 ERROR " ER1-ST " "
 ...
 RCVERRF2               SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKE1000B RCVERRF2 ERROR " ER2-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
 RCVERRF3               SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKE1000B RCVERRF3 ERROR " ER3-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
