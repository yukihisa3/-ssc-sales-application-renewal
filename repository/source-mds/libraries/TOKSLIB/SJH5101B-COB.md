...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SJH5101B.COB`
...
*伝票ヘッダ（１）
 01  WK-DEPA-REC.
     ...
     03  WK-DEPA10          PIC  X(06).
     03  WK-DEPA11          PIC  X(02).
     03  WK-DEPA12          PIC  X(20).
     03  WK-DEPA13          PIC  X(20).
     03  WK-DEPA14          PIC  X(20).
     03  WK-DEPA15          PIC  X(17).
     03  WK-DEPA16          PIC  X(01).
     03  WK-DEPA17          PIC  X(04).
*    明細レコード退避ワーク
 01  WK-DEPD-REC.
     ...
     03  WK-DEPD15          PIC  X(06).
     03  WK-DEPD16          PIC  X(07).
     03  WK-DEPD17          PIC  X(05).
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJH5101B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJH5101B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    発注企業ＣＤ
     MOVE     WK-DEPA04     TO        HEN-A041.
*    発注センターＣＤ
     MOVE     WK-DEPA05     TO        HEN-A042.
*    分類ＣＤ
...
*    受注企業ＣＤ
     MOVE     WK-DEPA10     TO        HEN-A091.
*    受注センターＣＤ
     MOVE     WK-DEPA11     TO        HEN-A092.
*    発注元企業名
     MOVE     WK-DEPA12     TO        HEN-A10.
*    発注元店舗名
     MOVE     WK-DEPA13     TO        HEN-A11.
*    取引先企業名
     MOVE     WK-DEPA14     TO        HEN-A12.
*    Ｅ欄
     MOVE     WK-DEPA15     TO        HEN-A13.
*    便NO.
     MOVE     WK-DEPA16     TO        HEN-A14.
*    予備
     MOVE     WK-DEPA17     TO        HEN-A15.
*伝票明細転送
*    レコード区分（Ｄ）
...
*    数量
     MOVE     WK-DEPD08     TO        HEN-A23.
*    原価単価
     MOVE     WK-DEPD09     TO        HEN-A24.
*    売価単価
...
*    色コード
     MOVE     WK-DEPD16     TO        HEN-A31.
*    サイズコード
     MOVE     WK-DEPD17     TO        HEN-A32.
*    予備
     MOVE     WK-DEPD18     TO        HEN-A33.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
...
*取引先コード
     MOVE        HEN-A091  TO        HEN-F01  WK-TOKCD.
*伝票ナンバー
     MOVE        HEN-A03   TO        HEN-F02  HEN-F23.
*行_
...
*担当者コード
     MOVE        99        TO        HEN-F06.
*店コード
     MOVE        HEN-A041  TO        HEN-F07.
*  商品変換テーブル検索
     MOVE        SPACE     TO        TBL-REC.
     INITIALIZE                      TBL-REC.
     MOVE        HEN-F01   TO        TBL-F01.
     MOVE        HEN-A19   TO        TBL-F02.
     READ    SHOTBL1
       INVALID
         MOVE    SPACE     TO        TBL-REC
         INITIALIZE                  TBL-REC
...
*        商品名
         ...
         MOVE    HEN-A30        TO   HEN-F1422(11:5)
       NOT INVALID
         MOVE    HEN-A29(1:15)  TO   HEN-F1421
         MOVE    HEN-A29(16:10) TO   HEN-F1422(1:10)
         MOVE    HEN-A30        TO   HEN-F1422(11:5)
