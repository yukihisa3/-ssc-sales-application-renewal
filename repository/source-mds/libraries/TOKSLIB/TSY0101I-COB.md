...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/TSY0101I.COB`
...
*--------------------------------------------------------------*
 01  PGM-ID                  PIC  X(08)     VALUE  "TSY0101I".
*----<< ﾃﾞｨｽﾌﾟﾚｲ ｺﾝﾄﾛｰﾙ ｴﾘｱ >>-*
 01  DSP-CNTL.
     03  DSP-FMT             PIC  X(08).
     03  DSP-GRP             PIC  X(08).
...
*****  DISPLAY "STB-F01     = " STB-F01       UPON CONS
*****  DISPLAY "STB-F02(1:8)= " STB-F02(1:8)  UPON CONS
*****  DISPLAY "STB-F02(9:5)= " STB-F02(9:5)  UPON CONS
...
***    DISPLAY "TBL-SHOCD(T) 1 = " TBL-SHOCD(T)(1:8) UPON CONS
***    DISPLAY "TBL-SHOCD(T) 2 = " TBL-SHOCD(T)(9:8) UPON CONS
...
***    DISPLAY "MEI-F93        = " MEI-F93           UPON CONS
****        IF        MEI-F93   =    1
...
**************DEN-F27C       NOT =    1 )
              ...
              GO   TO    ZAI-REWRITE-EXIT
     END-IF.
*****DISPLAY "77777" UPON CONS.
*出荷日が０の時
     IF       R00021             =    ZERO
              PERFORM    ZAI-YOTEI-RTN
              GO   TO    ZAI-REWRITE-EXIT
     END-IF.
*****DISPLAY "88888" UPON CONS.
*修正以外の時
     IF       R00001         NOT =    2
              GO   TO    ZAI-REWRITE-01
     END-IF.
*****DISPLAY "99999" UPON CONS.
     IF       TBL-R10101(I)    =    "9"
              GO   TO    ZAI-REWRITE-01
     END-IF.
*
*****DISPLAY "ZZZZZ" UPON CONS.
     IF       TBL-WTANA (I)      =    SPACE   AND
              TBL-WHINCD(I)      =    SPACE   AND
              TBL-WHTAN (I)      =    SPACE
              GO   TO    ZAI-REWRITE-01
     END-IF.
*****DISPLAY "YYYYY" UPON CONS.
*修正前更新処理
...
*
*****DISPLAY "00000" UPON CONS.
*    売上伝票以外は処理対象外
     IF      R00008    NOT =      40
             GO  TO               ZAI-YOTEI-EXT
     END-IF.
*****DISPLAY "11111" UPON CONS.
*****DISPLAY "TBL-F27C = " TBL-F27C(I) UPON CONS.
...
********IF   DEN-F27C      =      1
        ...
        END-IF
     END-IF.
*****DISPLAY "22222" UPON CONS.
*    相殺区分が　ゼロ以外は対象外
     IF      R00002    NOT =      ZERO
             GO  TO               ZAI-YOTEI-EXT
     END-IF.
*
*****DISPLAY "33333" UPON CONS.
     IF      R00001        =      1
             GO  TO               ZAI-YOTEI-50
     END-IF.
*
...
*****         DISPLAY "TBL-R10601 1 = " TBL-R10601(I) UPON CONS
*****         DISPLAY "ZAI-F27    1 = " ZAI-F27       UPON CONS
              ADD TBL-R10601(I)   TO     ZAI-F27
*****         DISPLAY "TBL-R10601 2 = " TBL-R10601(I) UPON CONS
*****         DISPLAY "ZAI-F27    2 = " ZAI-F27       UPON CONS
