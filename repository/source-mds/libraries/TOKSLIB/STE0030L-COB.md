...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/STE0030L.COB`
...
*    サブシステム　　　　：　出荷管理　　　　　　　　　　　　　*
*    業務名　　　　　　　：　手書発注集計表　                  *
*    モジュール名　　　　：　手書発注集計表発行（商品順）　    *
*    作成日／作成者　　　：　99/09/16  /  HAGIWARA             *
*    更新日／更新者　　　：　　　　　　　　　　　　　　　　　　*
*    処理概要　　　　　　：　発注集計表データファイルより、    *
*                            発注集計表を作表する。            *
*　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　*
...
*
 ...
 FILE-CONTROL.
*****<<集計表データ　Ｆ >>**************************************
     SELECT   TEGHACF   ASSIGN    TO        TEGHACF
...
***** メッセージエリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "STE0030L".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "STE0030L".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND1.
...
***** 見出し行１
 01  MIDASHI1.
     ...
     03  FILLER                   PIC  X(08)  VALUE "STE0030L".
...
*****WRITE    P-REC     FROM      MIDASHI2  AFTER     1.
     WRITE    P-REC     FROM      MIDASHI3  AFTER     2.
