...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY0028B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY0028B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY0028B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
**************END-EVALUATE
     ...
     END-IF.
*$$2013/12/12 NAV ED 消費税増税対応
*2018/01/31 UPDATE ST ↓欠品ＦＬＧ追加
     MOVE     DEN-F27D       TO   HAC-F23.
*2018/01/31 UPDATE ED ↑小売連携区分追加
*
