...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSI0050L.COB`
...
*----<< 支払合計ファイル >>--*
     SELECT   HSHIGKF   ASSIGN         DA-01-S-HSHIGKF
                        ...
                        STATUS         SHI-ST.
*----<< 請求合計Ｆ >>--*
     SELECT   HSEIGKF   ASSIGN         DA-01-VI-SEIGKF51
 ...
 01  TAIL02.
     03  FILLER         CHARACTER TYPE MODE-2.
         ...
         05  FILLER     PIC  N(07)     VALUE
                        NC"　　　　　　　".
*********05  FILLER     PIC  X(07).
*### 1999/04/02 NAV TAKAHASHI START ###*
         05  FILLER     PIC  X(07)     VALUE  SPACE.
*### 1999/04/02 NAV TAKAHASHI END   ###*
...
*----<< 請求合計Ｆ >>--*
 HSEIGKF-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### VDA0930 HSEIGKF ERROR " SEI-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
**** CLOSE    HSHIGKF   HSEIGKF    HTENMS    PRTF.
...
*----<< 店舗マスタ >>--*
 HTENMS-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### VDA0930 HTENMS ERROR " TEN-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
**** CLOSE    HSHIGKF   HSEIGKF    HTENMS    PRTF.
