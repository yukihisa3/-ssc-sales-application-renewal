...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/STE2201B.COB`
...
*プリンター
 FD  PRTF
     ...
     COPY        FTE22011  OF        XMDLIB.
*表示ファイル
 FD  DSPF
     LABEL       RECORD    IS        OMITTED.
     COPY        FTE22012   OF        XMDLIB.
******************************************************************
