...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY7162L.COB`
...
*----<< 受信仕入実績ファイル >>--*
 JDJISKL3-ERR           SECTION.
     ...
     DISPLAY  "### SSY7162L HDSYUKF ERROR " JDJISKL3-ST " "
...
*----<< Ｊ本田出荷確定データ >>--*
 HDSYUKF-ERR            SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY7162L HDSYUKF ERROR " HDSYUKF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*    仕入実績ファイルスタート
     ...
     INITIALIZE                       JIS-REC.
     MOVE     ZERO                TO  JIS-F01.
     MOVE     ZERO                TO  JIS-F02.
...
*
     ...
     END-READ.
*指定パラメタ以外は読飛し
***  IF       JIS-F01   NOT =  LINK-JDATE
***           MOVE     "END"      TO   END-FLG
***           GO                  TO   900-HDJ-READ-EXIT
***  END-IF.
*指定パラメタ以外は読飛し
***  IF       LINK-JTIME  NOT =  ZERO
***           IF   JIS-F01   NOT =  LINK-JDATE
***                MOVE     "END"      TO   END-FLG
***                GO                  TO   900-HDJ-READ-EXIT
***           END-IF
