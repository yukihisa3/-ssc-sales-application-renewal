...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/STE4801B.COB`
...
***  ﾜｰｸ  ｴﾘｱ
 01  WRK-AREA.
     03  WK-TORICD                PIC  9(08)     VALUE   298.
...
*    ﾐﾀﾞｼ
 01  HEAD-00.
     ...
     03  HD001                    PIC  X(09) VALUE "ﾎｰﾏｰｸﾞﾘｰﾝ".
*
...
****************************************************************
 INIT-SEC               SECTION.
*    ファイルのＯＰＥＮ
     OPEN     INPUT     HKYOTU1  TENMS1.
     OPEN     I-O       DSPFILE.
*    ワーク初期化
     MOVE     ZERO               TO   DENNO1.
     MOVE     ZERO               TO   CNT-DENPYO.
     MOVE     SPACE              TO   END-FLG.
     MOVE     SPACE              TO   FTE48011.
*伝票枚数カウント
...
*    店舗名称
     ...
     READ    TENMS1
             INVALID     MOVE KYO-F30  TO  HD01
             NOT INVALID MOVE TEN-F04  TO  HD01
     END-READ.
...
***  連番
     MOVE     SPACE               TO        WRK-HEN01.
     MOVE     "   ( "             TO        WRK-HEN011.
     MOVE     ZERO                TO        WRK-HEN02.
     MOVE     SPACE               TO        WRK-HEN021.
     MOVE     ")"                 TO        WRK-HEN03.
     MOVE     WRK-HEN             TO        TL00.
*    テイル印字制御
...
****************************************************************
 END-SEC                SECTION.
*    ファイルのＣＬＯＳＥ
     CLOSE    HKYOTU1   TENMS1   DSPFILE.
*
 END-EXIT.
     EXIT.
******************************************************************
 END PROGRAM  STE4801B.
******************************************************************
