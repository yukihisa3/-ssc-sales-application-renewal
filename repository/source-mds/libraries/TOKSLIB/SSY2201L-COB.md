...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY2201L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*片倉工業伝票データ（共通）　　
     SELECT   NCSHIRE  ASSIGN    TO        NCSHIRE
...
***  ﾜｰｸ ｴﾘｱ
 01  WRK-AREA.
     ...
     03  SYS-TIME                 PIC  9(08)      VALUE  ZERO.
     03  IN-DATA                  PIC  X(01).
...
*
 ...
 01  HD6.
     ...
     03  HD6-05                   PIC  Z9999999.
     03  FILLER                   PIC  X(01)     VALUE   SPACE.
     03  HD6-06                   PIC  ZZ9999.
     03  FILLER                   PIC  X(04)     VALUE   SPACE.
     03  HD6-07                   PIC  X(20).
     03  FILLER                   PIC  X(01)     VALUE   SPACE.
     03  HD6-08                   PIC  9(06).
     03  FILLER                   PIC  X(01).
     03  HD6-09                   PIC  ZZZZZZ.
*--------------------------------------------------------------*
*    明細                                                      *
*--------------------------------------------------------------*
*
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      NCSHIRE.
...
*明細２行目
***  規格
     MOVE     DEN-A162            TO        DT2-01.
***  取引先品番
     MOVE     DEN-A17             TO        DT2-02.
***  入数
     MOVE     DEN-A19(1:3)        TO        DT2-03.
***  ケース
     MOVE     DEN-A20(1:3)        TO        DT2-04.
***  数量
...
*ﾙ-ﾄ
     IF      DEN-A14 NOT = ZERO
             MOVE                 DEN-A14   TO      HD1-02
     END-IF.
     MOVE    "***"                TO        HD1-03.
*ヘッダ２行目
*    ﾙ-ﾄ     （上段）
     IF      DEN-A14 NOT = ZERO
             MOVE             DEN-A111      TO      HD2-01
     END-IF.
*ヘッダ3行目
***  A欄
     MOVE     DEN-A29             TO        HD3-01.
***  B欄　　　
     MOVE     DEN-A30             TO        HD3-02.
*    ﾙ-ﾄ　　　（下段）
     IF       DEN-A14 NOT = ZERO
              MOVE            DEN-A112      TO     HD3-03
     END-IF.
*ヘッダ4行目
***  発注社名
     MOVE     DEN-A06             TO        HD4-01.
*ヘッダ5行目
***  取引先名（上段）
     MOVE     DEN-A071            TO        HD5-01.
*ヘッダ6行目
***  店舗名称
     MOVE     DEN-A28             TO        HD6-01.
***  店舗コード
     MOVE     DEN-A26             TO        HD6-02.
***  分類コード
     MOVE     DEN-A04             TO        HD6-03.
***  伝票区分
     MOVE     DEN-A05             TO        HD6-04.
***  伝票_
     MOVE     DEN-A02             TO        HD6-05.
***  取引先コード
     MOVE     DEN-A01             TO        HD6-06.
***  取引先名（下段）
     MOVE     DEN-A072            TO        HD6-07.
***  発注日
     MOVE     DEN-A08             TO        HD6-08.
***  納品日
     MOVE     DEN-A09             TO        HD6-09.
*
...
*項目クリア
     MOVE     SPACE               TO   HD1 HD2 HD3 HD4 HD5 HD6
                                       ...
                                       TL1 TL2.
*テスト印字項目セット
     MOVE   ALL "9"               TO   HD1-02  HD3-01  HD3-02
                                       HD6-02  HD6-03  HD6-04
                                       HD6-05  HD6-06  HD6-08
                                       HD6-09
                                       DT1-02  DT2-03  DT2-04
                                       DT2-051 DT2-052 DT2-061
                                       DT2-062 DT2-08  DT2-09
                                       DT2-10
                                       TL1-011 TL1-012 TL1-03
                                       TL1-04  TL2-01.
     MOVE   ALL "*"               TO   HD1-01  HD1-03  HD2-01
                                       HD3-03  HD4-01  HD5-01
                                       HD6-01  HD6-07  DT1-01
                                       DT2-01  DT2-02.
*ヘッド印字
     WRITE    PRT-REC          FROM   HD1        AFTER    2.
     WRITE    PRT-REC          FROM   HD2        AFTER    1.
