...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKE0240B.COB`
...
*
 ...
 FILE-CONTROL.
*----<< 検品送信結果パラメータＦ >>--*
     SELECT   SNDFINPF   ASSIGN         DA-01-S-SNDFINPF
...
****************************************************************
 FILE                   SECTION.
*----<< 検品送信結果パラメータＦ >>--*
 FD  SNDFINPF            LABEL RECORD   IS   STANDARD
     COPY        SNDFINPF     OF      XFDLIB
                 JOINING     SDP     PREFIX.
*----<< 累積検品明細Ｆ >>--*
...
*----<< 検品送信結果パラメータＦ >>--*
 SDP-ERR              SECTION.
     USE AFTER     EXCEPTION PROCEDURE      SNDFINPF.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKE0240B SNDFINPF    ERROR " SDP-ST " "
...
*----<< 累積検品明細Ｆ >>--*
 RUI-ERR                SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKE0240B RUISYUF ERROR " RUI-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
*----<< 売上伝票Ｆ >>--*
 DEN-ERR                SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKE0240B SNDFINF ERROR " DEN-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
*----<< 検品送信結果Ｆ >>--*
 SDF-ERR                SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKE0240B SNDFINF ERROR " SDF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
