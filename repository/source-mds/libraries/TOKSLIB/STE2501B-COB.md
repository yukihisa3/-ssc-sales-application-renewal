...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/STE2501B.COB`
...
*JANCD転送へ変更 2007/10/05 ST
     MOVE     DEN-F25(1:7) TO        W016(I).
     MOVE     DEN-F25(8:6) TO        JANCD(I).
*JANCD転送へ変更 2007/10/05 END
*数量
