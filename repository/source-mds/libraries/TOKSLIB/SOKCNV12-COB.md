...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SOKCNV12.COB`
...
*
 ...
 FILE-CONTROL.
*実績集計Ｆ
     SELECT   RUISEKF   ASSIGN    TO        DA-01-S-RUISEKF
...
*　　実績集計Ｆ
******************************************************************
 FD  RUISEKF            LABEL RECORD   IS   STANDARD.
