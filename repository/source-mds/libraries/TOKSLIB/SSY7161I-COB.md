...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY7161I.COB`
...
****************************************************************
*    顧客名　　　　　　　：　（株）サカタのタネ殿　　　　　　　*
*    サブシステム　　　　：　ジョイフル本田オンラインシステム  *
*    業務名　　　　　　　：　仕入実績リスト発行　　            *
*    モジュール名　　　　：　仕入実績リスト発行                *
*    作成日／更新日　　　：　2005/08/16                        *
*    作成者／更新者　　　：　NAV T.TAKAHASHI                   *
*    処理概要　　　　　　：　画面より，日付＋時間を入力し、パ　*
*                            ラメタに渡す。　　　　　　        *
****************************************************************
...
**************************************************************
 LINKAGE               SECTION.
 01  PARA-JDATES           PIC  9(08).
 01  PARA-JDATEE           PIC  9(08).
**************************************************************
 PROCEDURE             DIVISION USING  PARA-JDATES PARA-JDATEE.
**************************************************************
 DECLARATIVES.
 DSP-ERR                   SECTION.
...
*実行
         WHEN   "E000"
                MOVE     DSP-JDATES  TO   PARA-JDATES
                MOVE     DSP-JDATEE  TO   PARA-JDATEE
                MOVE    "END"        TO   END-FLG
*終了
         WHEN   "F005"
                MOVE    "END"    TO   END-FLG
