...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY0705L.COB`
...
*    顧客名　　　　　　　：　サカタのタネ（株）殿　　　　　　　*
*    業務名　　　　　　　：　出荷管理サブシステム　　　　　　　*
*    モジュール名　　　　：　量販店データ変換リスト（ルート）　*
*    作成日／更新日　　　：　2000/01/27 TAKAHASHI              *
*    更新日　　　　　　　：　2020/04/22 MIURA                  *
*    作成者／更新者　　　：　ＮＡＶ　　　　　　　　　　　　　　*
*    処理概要　　　　　　：　変換された量販店データより量販店　*
*                        ：　変換リストを発行する．　　　　　　*
*                                                              *
****************************************************************
****************************************************************
...
*--<< ﾌﾟﾘﾝﾄ AREA >>-*
 01  HEAD01.
     03  FILLER         CHARACTER TYPE BAIKAKU-1-5.
         ...
         05  FILLER     PIC  X(08)     VALUE  "SSY0705L".
...
*
 ...
 01  MEIS015.
     03  FILLER         CHARACTER TYPE MODE-2.
         05  FILLER     PIC  X(03)     VALUE  SPACE.
         05  ME-36L     PIC  N(07)   VALUE  NC"【Ｄ３６５連携".
         05  FILLER     PIC  X(01)     VALUE  SPACE.
         05  ME-36      PIC  X(20).
         05  FILLER     PIC  X(01)     VALUE  SPACE.
         05  ME-36R     PIC  N(01)     VALUE  NC"】".
 01  MEIS02.
     03  FILLER.
         05  FILLER     PIC  X(01).
         05  ME-21      PIC  Z9.
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SSY0705L DSPFILE ERROR " DSP-CNTL " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
     MOVE     4000           TO   PROGRAM-STATUS.
     CLOSE    SHTDENWK   HTOKMS    HTENMS    DSPFILE.
     STOP     RUN.
*----<< 伝票データ >>--*
 SHTDENWK-ERR            SECTION.
     USE AFTER     EXCEPTION PROCEDURE      SHTDENWK.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY0705L SHTDENWK ERROR " SHTDENWK-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY0705L HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 店舗マスタ >>--*
 HTENMS-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY0705L HTENMS ERROR " HTENMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FSY07051.
*
     MOVE    "SSY0705L"      TO   PGID.
     MOVE    "FSY07051"      TO   FORM.
     MOVE     LINK-WS        TO   WSNM.
*
     MOVE     SPACE          TO   DSP-CNTL.
     MOVE     "FSY07051"     TO   DSP-FMT.
...
*
     ...
     ELSE
              MOVE      SPACE     TO   ME-20
     END-IF.
     MOVE     NC"【Ｄ３６５連携"       TO   ME-36L.
     MOVE     DEN-D99                  TO   ME-36.
     MOVE     NC"】"                   TO   ME-36R.
*
*****DISPLAY "AA".
     WRITE    PRT-REC        FROM MEIS01    AFTER     2.
*# 2020/04/27 NAV ST Ｄ３６５伝票番号
*****WRITE    PRT-REC        FROM P-SPACE   AFTER     1.
     WRITE    PRT-REC        FROM MEIS015   AFTER     1.
*# 2020/04/27 NAV ED Ｄ３６５伝票番号
     ADD      3              TO   LINE-CNT.
