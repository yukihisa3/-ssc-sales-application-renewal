...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY2301L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*丸長伝票データ（共通）　　
     SELECT   MARSHIRE  ASSIGN    TO        MARSHIRE
...
*
 01  HD5.
     ...
     03  HD5-04                   PIC  X(01)     VALUE   SPACE.
     03  FILLER                   PIC  X(05)     VALUE   SPACE.
     03  HD5-05                   PIC  Z9999999.
     03  FILLER                   PIC  X(01)     VALUE   SPACE.
     03  HD5-06                   PIC  9(06).
     03  FILLER                   PIC  X(04)     VALUE   SPACE.
     03  HD5-07                   PIC  X(20).
     03  FILLER                   PIC  X(01)     VALUE   SPACE.
     03  HD5-08                   PIC  ZZZZZZ.
     03  FILLER                   PIC  X(01)     VALUE   SPACE.
     03  HD5-09                   PIC  ZZZZZZ.
*
*--------------------------------------------------------------*
*    明細                                                      *
*--------------------------------------------------------------*
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      MARSHIRE.
...
*ヘッダ２行目
***  Ａ欄
     MOVE     DEN-A29             TO        HD2-01.
***  Ｂ欄
     MOVE     DEN-A30             TO        HD2-02.
*ヘッダ３行目
***  社名
     MOVE     DEN-A06             TO        HD3-01.
***  取引先名（上段）
     MOVE     DEN-A071            TO        HD3-02.
*ヘッダ４行目
***  取引先名（中段）
     MOVE     DEN-A072            TO        HD4-01.
*ヘッダ５行目
***  店舗名称
     MOVE     DEN-A28             TO        HD5-01.
***  店舗コード
     MOVE     DEN-A26             TO        HD5-02.
***  分類コード
     MOVE     DEN-A04             TO        HD5-03.
***  伝票区分
     MOVE     DEN-A05             TO        HD5-04.
***  伝票_
     MOVE     DEN-A02             TO        HD5-05.
***  取引先コード
     MOVE     DEN-A01             TO        HD5-06.
**** 取引先名（下段）
**** MOVE     DEN-A111            TO        HD5-07.
***  発注日
     MOVE     DEN-A08             TO        HD5-08.
***  納品日
     MOVE     DEN-A09             TO        HD5-09.
*
*Ｆ欄退避
     MOVE     DEN-A12             TO    WK-SINSEINO.
*
...
*項目クリア
     MOVE     SPACE               TO   HD1 HD2 HD3 HD4 HD5
                                       ...
                                       TL1 TL2.
*テスト印字項目セット
     MOVE   ALL "9"              TO   HD2-01  HD2-02
                                      HD5-02  HD5-03  HD5-05
                                      HD5-06  HD5-08  HD5-09
                                      DT1-02  DT2-03  DT2-04
                                      DT2-051 DT2-061 DT2-062
                                      DT2-07  DT2-08  DT2-09
                                      DT2-052
                                      TL1-01  TL1-02  TL2-01.
     MOVE   ALL "*"              TO   HD1-01  HD3-02  HD5-04
                                      HD4-01  HD5-01  HD5-07
...
*
     CLOSE    MARSHIRE   PRTFILE    DSPFILE.
*
 END-EXIT.
     EXIT.
