...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SHOM0900.COB`
...
*初期画面表示
 ...
 MAIN-010.
     ...
     EVALUATE  DSP-FUNC
         WHEN  "F009"
               MOVE      "END"          TO   END-FLG
               MOVE      NC"打ち切り"   TO   OPRMSG
               MOVE      0155           TO   PROGRAM-STATUS
         WHEN  "E000"
               MOVE      "END"          TO   END-FLG
               MOVE      NC"続　　行"   TO   OPRMSG
...
****************************************************************
 DSP-INIT-SEC                SECTION.
     MOVE    LOW-VALUE           TO   FHOM0900.
     MOVE   "FHOM0900"           TO   DSP-FORMAT.
*    MOVE   "CL"                 TO   DSP-PROC.
