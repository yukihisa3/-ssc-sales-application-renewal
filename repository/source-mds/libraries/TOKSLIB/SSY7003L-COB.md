...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY7003L.COB`
...
*メッセージ情報
 01  MSG-AREA.
     03  SEC-NAME.
         ...
         05  S-NAME          PIC  X(30).
     03  MSG-ABEND1.
         05  FILLER          PIC  X(12)  VALUE  "### SSY7003L".
...
*=============================================================
 CONTROL-SEC         SECTION.
     DISPLAY  "**  SSY7003L   START  **"   UPON  CONS.
*
     ...
     PERFORM  END-SEC.
*
     DISPLAY  "**  SSY7003L   END    **"   UPON  CONS.
     STOP  RUN.
 CONTROL-EXIT.
     EXIT.
*=============================================================
...
*        店舗ＣＤブレイク判定
     ...
     END-IF.
*ゴンドラ番号　ブレイク判定
*****DISPLAY "SYU-F14     = " SYU-F14    UPON CONS.
*****DISPLAY "WK-GONDORA  = " WK-GONDORA UPON CONS.
...
*ゴンドラ番号の設定
     MOVE  WK-GONDORA           TO   PRT-GONDRA.
*印刷
     MOVE "FSY70032"             TO  PRT-FMT.
     MOVE "PW"                   TO  PRT-PRO.
