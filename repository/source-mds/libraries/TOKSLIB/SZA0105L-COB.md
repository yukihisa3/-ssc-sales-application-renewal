...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SZA0105L.COB`
...
*       帳票編集エリア
 01  HEAD1.
     ...
     03  FILLER                  PIC  X(08)     VALUE "SZA0105L".
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SZA0105L".
...
* 商品名
     ...
     END-READ.
* 前月末在庫数
     MOVE    ZWK-F05             TO   BD-ZZAISU.
* 当月入庫数
     MOVE    ZWK-F07             TO   BD-TNYUSU.
* 当月出庫数
     MOVE    ZWK-F08             TO   BD-TSHUSU.
* 当月返品数
     MOVE    ZWK-F10             TO   BD-THEPSU.
* 当月末在庫数
     MOVE    ZWK-F04             TO   BD-TZAISU.
*
     IF      LINE-CNT  >=   62
             PERFORM        KAI-PAGE
     END-IF.
