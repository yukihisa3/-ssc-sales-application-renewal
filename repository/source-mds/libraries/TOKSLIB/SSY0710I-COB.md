...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY0710I.COB`
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SSY0710I DSPFILE ERROR " DSP-CNTL " "
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FSY07101.
*
     MOVE    "SSY0710I"      TO   PGID.
     MOVE    "FSY07101"      TO   FORM.
     MOVE     LINK-WS        TO   WSNM.
*
     MOVE     SPACE          TO   DSP-CNTL.
     MOVE     "FSY07101"     TO   DSP-FMT.
