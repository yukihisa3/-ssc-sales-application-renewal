...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY5101L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*島忠伝票データ（共通）　　
     SELECT   SHSHIRED  ASSIGN    TO        SHSHIRED
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      SHSHIRED.
...
****************************************************************
 DEN-CNT-SEC            SECTION.
*
     READ     SHSHIRED AT  END
              MOVE     "END"     TO   END-FLG
              GO                 TO   DEN-CNT-EXIT
     END-READ.
*    島忠以外は読み飛ばし（取引先）
     IF       DEN-F01  NOT =  59099
              GO                 TO   DEN-CNT-SEC
     END-IF.
*    伝票枚数カウント
...
***  店コード
     MOVE     DEN-A041            TO    HD3-02.
***  部門
     MOVE     DEN-A05(3:2)        TO    HD3-03.
***  伝区
...
***  発注日
     MOVE     DEN-A07(1:2)        TO    HD3-081.
     MOVE     DEN-A07(3:2)        TO    HD3-082.
     MOVE     DEN-A07(5:2)        TO    HD3-083.
***  納品日
     MOVE     DEN-A08(1:2)        TO    HD3-091.
     MOVE     DEN-A08(3:2)        TO    HD3-092.
     MOVE     DEN-A08(5:2)        TO    HD3-093.
*
...
*
     CLOSE    SHSHIRED   PRTFILE    DSPFILE.
*
 END-EXIT.
     EXIT.
