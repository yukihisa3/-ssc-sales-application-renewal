...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SMNT020.COB`
...
*画面ファイル
 FD  DSPFILE.
     COPY        FM020    OF        XMDLIB.
 01  FM020R.
*****03  D-SYORI          PIC X(06).
     03  D-SYORI          PIC X(34).
     03  D-KOMOKU         PIC X(367).
     03  D-MSG            PIC X(110).
     03  D-R002           PIC X(06).
******************************************************************
...
***  DISPLAY "SYUKKA 1= " SYUKKA UPON CONS.
***  DISPLAY "RUTO   1= " RUTO   UPON CONS.
***  DISPLAY "RUTONO 1= " RUTONO UPON CONS.
***  DISPLAY "TEN-F801= " TEN-F80 UPON CONS.
***  DISPLAY "TEN-F811= " TEN-F81 UPON CONS.
***  DISPLAY "TEN-F821= " TEN-F82 UPON CONS.
*%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
*
 DSP-TEN1-EXIT.
     EXIT.
...
***  DISPLAY "SYUKKA 2= " SYUKKA UPON CONS.
***  DISPLAY "RUTO   2= " RUTO   UPON CONS.
***  DISPLAY "RUTONO 2= " RUTONO UPON CONS.
***  DISPLAY "TEN-F802= " TEN-F80 UPON CONS.
***  DISPLAY "TEN-F812= " TEN-F81 UPON CONS.
***  DISPLAY "TEN-F822= " TEN-F82 UPON CONS.
*%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
