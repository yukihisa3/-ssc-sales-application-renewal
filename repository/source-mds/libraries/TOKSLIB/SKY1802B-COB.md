...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKY1802B.COB`
...
*    プログラム　　名：　ユポラベル印刷                        *
*    作成者　　　　　：　ＮＡＶ　　　　　                      *
*    作成日　　　　　：　1993.06.24      UPDATE: YYYY.MM.DD    *
*                                                              *
****************************************************************
...
*----<< ユポラベルファイル  >>---*
     SELECT   ZYUPODT        ASSIGN        TO  01-VI-ZYUPODT1
...
*----<< 画面　Ｆ >>----*
 FD  DSPF.
     COPY    FKY18021  OF   XMDLIB.
*----<< ユポラベルファイル  >>---*
 FD  ZYUPODT.
     COPY     ZYUPODT  OF  XFDLIB
     JOINING  ZYU      AS  PREFIX.
*----<< プリンタＦ >>-----*
 FD  PRTF.
     COPY     FKY18022 OF  XMDLIB.
*=============================================================
...
*ステータス
 ...
 01  WORK-AREA.
     ...
     03  W-KINGK             PIC  N(06)  VALUE  SPACE.
     03  W-SU                PIC  9(01).
...
*メッセージ情報
 01  MSG-AREA.
     03  MSG-ABEND1.
         05  FILLER          PIC  X(12)  VALUE  "### SKY1802B".
...
*ユポラベルＦ
 ZYU-ERR-SEC        SECTION.
     USE      AFTER  EXCEPTION   PROCEDURE       ZYUPODT.
     MOVE    "ZYUPODT"     TO    ERR-FL-ID.
...
*=============================================================
 INIT-SEC            SECTION.
     DISPLAY  "**  SKY1802B   START  **"   UPON  CONS.
*
*システム日付・時刻の取得
...
*初期画面表示
 DSP-010.
     MOVE      LOW-VALUE         TO        FKY18021.
     MOVE      "FKY18021"        TO        DSP-FRM.
     MOVE      "CL"              TO        DSP-TYP.
...
*=============================================================
 TEST-SEC            SECTION.
     ...
     MOVE   NC"９９，９９９"       TO       KINGKL  KINGKR.
     MOVE   "9999"               TO       BUMON1  BUMON2.
     MOVE "FKY18022"             TO  PRT-FMT.
...
*ユポラベルＦ　ＲＥＡＤ
     ...
     PERFORM     UNTIL  MAISU  >= ZYU-F10
       ...
       PERFORM  VARYING  I  FROM  1  BY  1  UNTIL  I > 5
          ADD      1          TO       J
          IF       I     =     3
             IF    (ZYU-F09(1:1) = ZERO) AND (ZYU-F09(2:1) = ZERO)
...
*=============================================================
 END-SEC             SECTION.
*ファイル ＣＬＯＳＥ
     CLOSE      DSPF    PRTF    ZYUPODT.
     DISPLAY  "**  SKY1802B     END  **"   UPON  CONS.
 END-EXIT.
     EXIT.
