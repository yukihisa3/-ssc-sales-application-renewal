...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKY1301I.COB`
...
****  画面ファイル  ****
 COPY   FKY13011         OF        XMDLIB.
 COPY   FKY13012         OF        XMDLIB.
****  画面制御項目  ****
 01  DSP-CONTROL.
...
*
     MOVE     SPACE          TO   FKY13011.
     MOVE     SPACE          TO   FKY13012.
     MOVE    "FKY13011"      TO   DSP-FORMAT.
...
*----------------------------------------------------------*
 DSP-READ-SEC           SECTION.
     MOVE  "NE"    TO   DSP-PROC.
     READ   DSPF.
     IF  DSP-FORMAT  = "FKY13011"
         MOVE    DSP-AREA    TO   FKY13011
     ELSE
         MOVE    DSP-AREA    TO   FKY13012
     END-IF.
 DSP-READ-EXIT.
     EXIT.
*----------------------------------------------------------*
