...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSE4601B.COB`
...
*--------------------------------------------------------------*
 ...
 FILE-CONTROL.
*---<<  ＩＮ１ファイル  >>---*
     SELECT   SEIGK46  ASSIGN    TO        DA-01-SEIGK46
...
**
 ...
 FILEERR-SEC1           SECTION.
     USE AFTER     EXCEPTION
                   PROCEDURE      SEIGK46.
     DISPLAY "FILE ERROR SEIGK46 : " IN-ST UPON CONS.
...
**
 FILEERR-SEC2           SECTION.
     USE AFTER     EXCEPTION
                   PROCEDURE      HSEIGKF.
     DISPLAY "FILE ERROR SETGKFA : " OUT-ST UPON CONS.
     MOVE      4000          TO   PROGRAM-STATUS.
     STOP     RUN.
 END     DECLARATIVES.
****************************************************************
