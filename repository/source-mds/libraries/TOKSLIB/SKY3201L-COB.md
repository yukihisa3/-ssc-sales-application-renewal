...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKY3201L.COB`
...
*
 ...
 FILE-CONTROL.
*    ＡＣＯＳ計上エラーＦ（重複）
     SELECT   ACOSERR            ASSIGN    TO   ACOSERR
                                 ACCESS    MODE IS   SEQUENTIAL
                                 FILE STATUS    IS   ACOSERR-ST.
*    プリントファイル
...
****  メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SSY3201L".
...
*
 01  HEAD-00.
     ...
     03  FILLER              PIC  X(08)  VALUE  "SSY3201L".
