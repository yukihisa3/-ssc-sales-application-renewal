...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY4011I.COB`
...
*    顧客名　　　　　　　：　サカタのタネ（株）殿　　　　　　　*
*    業務名　　　　　　　：　出荷管理サブシステム　　　　　　　*
*    モジュール名　　　　：　量販店データ配送リスト（変換）    *
*    作成日／更新日　　　：　2000/03/01 TAKAHASHI              *
*    作成者／更新者　　　：　ＮＡＶ　　　　　　　　　　　　　　*
*    処理概要　　　　　　：　配送ルート表出力時の確認画面表示  *
*                        ：　取消選択時はＣＬ終了              *
*                                                              *
****************************************************************
****************************************************************
...
*----<< ﾌｱｲﾙ ｽﾃｰﾀｽ >>--*
 01  SEC-NAME.
     03  S-NAME         PIC  X(30)     VALUE  SPACE.
*
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SSY4011I DSPFILE ERROR " DSP-CNTL " "
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FSY40111.
*
     MOVE    "SSY4011I"      TO   PGID.
     MOVE    "FSY40111"      TO   FORM.
     MOVE     LINK-WS        TO   WSNM.
*
     MOVE     SPACE          TO   DSP-CNTL.
     MOVE     "FSY40111"     TO   DSP-FMT.
