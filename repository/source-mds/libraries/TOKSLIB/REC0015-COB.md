...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/REC0015.COB`
...
*--------------------------------------------------------------*
 ...
 01  CNT-AREA.
     ...
     03  OUT-CNT1            PIC  9(06)  VALUE ZERO.
     03  OUT-CNT2            PIC  9(06)  VALUE ZERO.
 01  WRK-AREA.
 ...
 01  MSG-AREA1-1.
     03  MSG-ABEND1.
       ...
       05  ERR-PG-ID         PIC  X(08)  VALUE "REC0015 ".
...
****************************************************************
 END-SEC                SECTION.
     ...
     DISPLAY "***   OUTPUT1 DATA = "  OUT-CNT1  UPON  CONS.
     DISPLAY "***   OUTPUT2 DATA = "  OUT-CNT2  UPON  CONS.
     CLOSE    INFILE    HMEIMS
              ZZAIMS    HSHOTBL.
 END-END.
     EXIT.
