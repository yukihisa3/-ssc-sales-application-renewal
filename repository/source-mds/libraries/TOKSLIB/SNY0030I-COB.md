...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SNY0030I.COB`
...
*    プログラム　　名：　入荷予定リスト　抽出                  *
*    作成者　　　　　：　ＮＡＶ　　　　　                      *
*    作成日　　　　　：　2000.05.01      UPDATE: YYYY.MM.DD    *
*                                                              *
****************************************************************
...
*抽出Ｆ
     SELECT   NYYOTEIF       ASSIGN        TO  01-S-NYYOTEIF
                             ORGANIZATION  IS  SEQUENTIAL
                             ACCESS MODE   IS  SEQUENTIAL
...
*メッセージ情報
 01  MSG-AREA.
     03  MSG-ABEND1.
         05  FILLER          PIC  X(12)  VALUE  "### SNY0030I".
...
*=============================================================
 CONTROL-SEC         SECTION.
     DISPLAY  "**  SNY0030I   START  **"   UPON  CONS.
*
     PERFORM  INIT-SEC.
     PERFORM  MAIN-SEC    UNTIL  MAIN-FLG  =  99.
     PERFORM  END-SEC.
*
     DISPLAY  "**  SNY0030I    END   **"   UPON  CONS.
     STOP  RUN.
 CONTROL-EXIT.
     EXIT.
*=============================================================
...
*
     ...
     DISPLAY "* NYYOTEIF(OT)=" OT-CNT   " *" UPON CONS.
*
...
*初期画面の処理
     ...
     MOVE "FNY00301"    TO  DSP-FMT.
     MOVE  SPACE        TO  DSP-FNY00301.
     PERFORM  OPT-CLR-SEC.
*倉庫
