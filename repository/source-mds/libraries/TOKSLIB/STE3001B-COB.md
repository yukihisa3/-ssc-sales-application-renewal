...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/STE3001B.COB`
...
*プリンター
 FD  PRTF
     ...
     COPY        FTE30011  OF        XMDLIB.
*表示ファイル
 FD  DSPF
     LABEL       RECORD    IS        OMITTED.
     COPY        FTE30012  OF        XMDLIB.
******************************************************************
...
*****各ファイルオープン
     OPEN        I-O       DSPF
                 ...
                 OUTPUT    PRTF.
*****画面初期化
     MOVE     SPACE              TO   FTE30012.
     MOVE     ZERO               TO   WK-DEN.
     MOVE     ZERO               TO   CNT-DENPYO.
*////PERFORM  DSP-WRT-SEC.
*****帳票初期化
     MOVE        SPACE     TO        FTE30011.
*****伝票枚数カウント
     MOVE     ZERO         TO    WK-MAI.
***2011.10.07 ST
