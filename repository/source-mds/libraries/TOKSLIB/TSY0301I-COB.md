...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/TSY0301I.COB`
...
*    作成日／更新日　　　：　99/09/20
*    作成者／更新者　　　：　ＮＡＶ吉田　　　　　　　　　　　　
*    処理概要　　　　　　：　画面より、バッチNO_、倉庫コード
*                            商品コードを入力し、該当の商品
*                            のデータを表示させ、発注数の訂
*　　　　　　　　　　　　　　正按分入力を行う。　　　　　　　　
*    修正履歴　　　　　　：
*      2011/10/04 飯田/NAV 基幹サーバ統合    　　　　　　　
*      2012/10/12 三浦/NAV ＬＩＮＫＳ連携    　　　　　　　
*　    訂正伝票の物流連携フラグ、物流連携日をクリアする。
*      2013/11/27 高橋/NAV 障害修正　　　　 　　　　　　　
*　    　明細の２ページ目以降でＰＦ６を行なうと明細数量が
*　    　異常な値になる現象を修正
*      2018/03/05 高橋/NAV 障害修正　　　　 　　　　　　　
*　    　更新時の伝票区分キーに４０をセットに変更
*　    　伝票番号が重複時、更新がエラーになってしまう。
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### TSY0301I DSPFILE ERROR " DSP-CNTL " "
...
*----<< 伝票データ >>--*
 SHTDENLB-ERR           SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### TSY0301I SHTDENLB ERROR " SHTDENLB-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### TSY0301I HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### TSY0301I ZSOKMS1 ERROR " ZSOKMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 商品変換テーブル >>--*
 SHOTBL1-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### TSY0301I SHOTBL1 ERROR " SHOTBL1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 商品名称マスタ >>--*
 MEIMS1-ERR              SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### TSY0301I MEIMS1 ERROR " MEIMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 店舗マスタ >>--*
 TENMS1-ERR              SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### TSY0301I TENMS1 ERROR " TENMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 在庫マスタ >>--*
 ZAMZAIF-ERR              SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### TSY0301I TENMS1 ERROR " ZAI-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   MSY03011.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-BODY1-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "TSY0301I"      TO   PGID.
     MOVE    "MSY03011"      TO   FORM.
*
     MOVE     SPACE          TO   DSP-CNTL.
     MOVE     "MSY03011"     TO   DSP-FMT.
...
***** KEY ADD 2012/02/03 NAV ST
     MOVE     WRK-TENPO(IX)  TO   DE2-F07.
     MOVE     WRK-NOHIN(IX)  TO   DE2-F112.
***** KEY ADD 2012/02/03 NAV ED
***** KEY ADD 2018/03/05 NAV ST
     MOVE     40             TO   DE2-F051.
***** KEY ADD 2018/03/005NAV ED
*　2011/10/04,S  S.I/NAV
...
**                                  DE2-F051  DE2-F03
**         INVALID   KEY
**              DISPLAY  "TSY0301I  SHTDENLA START INV 1"
**                                       UPON CONS
...
*********************DISPLAY "BBBBBBBBBB"   UPON CONS
              IF ( JDATE          =    DE2-F46 ) AND
                 ...
                 ( ZERO           =    DE2-F04 ) AND
*********** KEY ADD 2012/02/02 NAV ST
                 ( WRK-TENPO(IX)  =    DE2-F07 ) AND
                 ( WRK-NOHIN(IX)  =    DE2-F112 ) AND
*********** KEY ADD 2012/02/02 NAV ED
...
**                                  DE2-F051  DE2-F03
**         INVALID   KEY
**              DISPLAY  "TSY0301I  SHTDENLA START INV 2"
**                                       UPON CONS
