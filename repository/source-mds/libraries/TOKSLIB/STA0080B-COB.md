...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/STA0080B.COB`
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "STA0080B".
...
************************************************************
 MAIN-SEC               SECTION.
     ...
     READ     ZAMZAIF
       ...
       NOT  INVALID  KEY
              COMPUTE  ZAI-F04   =  TANA-F11  +  ZAI-F07
                                              -  ZAI-F08
              COMPUTE  ZAI-F05   =  TANA-F11
              REWRITE  ZAI-REC
              ADD      1            TO        ZAIMS-CNT
     END-READ.
     PERFORM  TANA-READ-SEC.
...
************************************************************
 ZAIMS-INS-SEC          SECTION.
     ...
     MOVE     TANA-F06X      TO     ZAI-F022.
     MOVE     TANA-F15       TO     ZAI-F03.
     MOVE     TANA-F11       TO     ZAI-F04.
     MOVE     TANA-F11       TO     ZAI-F05.
...
************************************************************
 END-SEC                SECTION.
     CLOSE    ZTANADT   ZAMZAIF   MEIMS1.
     DISPLAY "* ZTANADT    (IN)= " TANA-CNT  " *" UPON CONS.
     DISPLAY "* ZTANADT  (SKIP)= " SKIP-CNT  " *" UPON CONS.
     DISPLAY "* ZAMZAIF (REWRT)= " ZAIMS-CNT " *" UPON CONS.
     DISPLAY "* ZAMZAIF   (ADD)= " INS-CNT   " *" UPON CONS.
     DISPLAY "* MEIKS     (INV)= " MEIMS-CNT " *" UPON CONS.
 END-END.
     EXIT.
*****************<<  PROGRAM  END  >>***********************
