...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSI0141B.COB`
...
*--------------------------------------------------------------*
*----<< ﾌﾟﾛｸﾞﾗﾑID >>--*
 01  PG-ID              PIC  X(08)     VALUE  "SSI0141B".
*----<< ﾌﾗｸﾞｴﾘｱ >>--*
...
*----<< 支払合計ファイル >>--*
 SYO-ERR                SECTION.
     ...
     DISPLAY  "### " PG-ID " SYOGOSEKF ERROR " SYO-ST " "
...
*レコード区分＝空白の時（エラー区分）
     MOVE     321717         TO   SEI-F01.
     MOVE     SYO-F04        TO   WK-DENNO.
