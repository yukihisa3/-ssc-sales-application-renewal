...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY3904L.COB`
...
***  出力取引先ＣＤ
 01  WK-TOKCD                     PIC  9(08)   VALUE  881.
...
*
     ...
     MOVE     "FSY39041"          TO        DSP-FMT.
*項目設定
***  伝票枚数
     MOVE     WK-MAI              TO        MD01.
***  プログラムＩＤ
     MOVE     "SSY3904L"          TO        PGID.
***  日付
