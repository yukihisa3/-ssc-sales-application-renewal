...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKE0700I.COB`
...
*        05  FKE07001TBLG     PIC X(150) OCCURS  7.
         05  FKE07001TBLG     PIC X(193) OCCURS  7.
...
*    検品グループマスタチェック
     ...
     AND  KENPGR(IXA)  NOT =  ZERO
          MOVE        SYUK(IXA) TO     KPG-F01
          MOVE        KENPGR(IXA) TO    KPG-F02
****      DISPLAY "SOKKENF-INV-FLG = " SOKKENF-INV-FLG UPON CONS
          READ        SOKKPGF
            INVALID
**************2008/04/23 STA
...
***************2008/04/23 END
            NOT INVALID
              MOVE    SPACE     TO     ERRMSG
              PERFORM DSPMSG-SEC
              MOVE   "M"        TO     EDIT-OPTION OF KENPGR(IXA)
              MOVE   "KEPG"     TO     WK-GRP1
              MOVE    WK-GRP2R(IXA) TO WK-GRP2
              MOVE    WK-GRP    TO     DSP-GRP
              PERFORM DSPWT-SEC
...
**********************************************************
 END-SEC                   SECTION.
     CLOSE   DSPF HMEIMS HTOKMS HSHOTBL HJYOKEN SOKKPGF SOKKENF.
 END-EXIT.
     EXIT.
**********************************************************
*                     画面初期表示                       *
**********************************************************
 DSPINIT-SEC               SECTION.
     MOVE        SPACE     TO        FKE07001.
     MOVE       "ALLF"     TO        DSP-GRP.
     MOVE       "FKE07001"    TO        DSP-FMT.
     MOVE       "CL"       TO        DSP-PRO.
     PERFORM     VARYING   IXA       FROM     1  BY  1
                 UNTIL     IXA       >        7
         MOVE    IXA       TO        LNO(IXA)
