...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY1401L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*ドイト伝票データ（共通）　　
     SELECT   DSHIRED   ASSIGN    TO        DSHIRED
...
***  テール部用項目退避
 01  WK-DEN-A13                    PIC  X(09)     VALUE  SPACE.
 01  WK-DEN-A15                    PIC  X(04)     VALUE  SPACE.
 01  WK-DEN-A09.
     03  WK-DEN-A091               PIC  9(02)     VALUE  ZERO.
     03  WK-DEN-A092               PIC  9(02)     VALUE  ZERO.
     03  WK-DEN-A093               PIC  9(02)     VALUE  ZERO.
 01  WK-DEN-A14.
     03  WK-DEN-A141               PIC  9(02)     VALUE  ZERO.
     03  WK-DEN-A142               PIC  9(02)     VALUE  ZERO.
     03  WK-DEN-A143               PIC  9(02)     VALUE  ZERO.
 01  WK-DEN-A16                    PIC  X(03)     VALUE  SPACE.
***  エラーセクション名
 01  SEC-NAME.
...
*****03  FILLER                   PIC  X(01)     VALUE SPACE.
     03  DT2-03                   PIC  X(08).
     03  FILLER                   PIC  X(02)     VALUE SPACE.
     03  DT2-041                  PIC  ZZZZ9.
     03  DT2-042                  PIC  Z.
     03  FILLER                   PIC  X(02)     VALUE SPACE.
     03  DT2-051                  PIC  ZZZZ9.
     03  DT2-051X                 PIC  X(01).
     03  DT2-052                  PIC  Z.
     03  DT2-061                  PIC  ZZZZZZZ.
     03  DT2-062                  PIC  ZZ.
     03  FILLER                   PIC  X(02)     VALUE SPACE.
     03  DT2-07                   PIC  ZZZZZZZ9.
     03  FILLER                   PIC  X(01)     VALUE SPACE.
     03  DT2-08                   PIC  ZZZZZZ9.
     03  FILLER                   PIC  X(01)     VALUE SPACE.
     03  DT2-09                   PIC  ZZZZZZZ9.
     03  FILLER                   PIC  X(20)     VALUE SPACE.
*伝票訂正用
 01  DT22.
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      DSHIRED.
...
*明細２行目
*品名２
     MOVE     DEN-A282            TO        DT2-01.
*重点管理区分判定
     IF       DEN-A22              =         ZERO
              MOVE SPACE          TO        DT2-02
         ELSE
              MOVE "*"            TO        DT2-02
     END-IF.
*商品コード
     MOVE     DEN-A21             TO        DT2-03.
...
*ヘッダ１行目
***  オーダー番号
     MOVE     DEN-A12             TO        HD1-01.
*ヘッダ２行目
*
     MOVE     DEN-A11             TO        HD2-01.
*ヘッダ３行目
***  伝票番号
     MOVE     DEN-A03             TO        HD3-01.
*ヘッダ４行目
***  店名
     MOVE     DEN-A17             TO        HD4-01.
***  取引先名
     MOVE     DEN-A18             TO        HD4-02.
*ヘッダ５行目
***  店／部門コード
     MOVE     DEN-A04             TO        HD5-01.
     MOVE     "-"                 TO        HDHAIFN.
...
***  発注日
     MOVE     DEN-A08             TO        HD5-05.
***  取引先コード
     MOVE     DEN-A10             TO        HD5-06.
********* テール部用項目
***  備考
     MOVE     DEN-A13             TO        WK-DEN-A13.
*****原価金額計
*****MOVE     DEN-A29             TO        WK-DEN-A29.
*****売価金額計
*****MOVE     DEN-A30             TO        WK-DEN-A30.
***  センター表示
     MOVE     DEN-A15             TO        WK-DEN-A15.
***  納品日
     MOVE     DEN-A09             TO        WK-DEN-A09.
***  有効期限日
     MOVE     DEN-A14             TO        WK-DEN-A14.
***  ＤＭＣ表示
     MOVE     DEN-A16             TO        WK-DEN-A16.
*********
*
...
*テール１行目
***  備考
     MOVE     WK-DEN-A13          TO        TL1-01.
***  原価金額計
     MOVE     GENKINKEI           TO        TL1-02.
***  売価金額計
     MOVE     BAIKINKEI           TO        TL1-03.
***  センター表示
     MOVE     WK-DEN-A15          TO        TL1-04.
*テール２行目
***  納品日
     MOVE     WK-DEN-A091         TO        TL2-01.
     MOVE     WK-DEN-A092         TO        TL2-02.
     MOVE     WK-DEN-A093         TO        TL2-03.
*
*テール３行目
***  訂正後原価金額合計
*****IF       TS-FLG =  1
...
*テール４行目
***  有効期限日
     MOVE     WK-DEN-A141         TO        TL4-01.
     MOVE     WK-DEN-A142         TO        TL4-02.
     MOVE     WK-DEN-A143         TO        TL4-03.
*ＤＭＣ表示
     MOVE     WK-DEN-A16          TO        TL4-04.
*
...
*項目クリア
     MOVE     SPACE               TO   HD1 HD2 HD3 HD4 HD5
                                       ...
                                       TL1 TL2 TL3 TL4.
*********** ﾐﾀﾞｼ
     MOVE     999                 TO        HD1-01 HD5-02.
     MOVE     ALL "*"             TO        HD2-01 HD4-01 HD4-02.
     MOVE     9999999             TO        HD3-01.
     MOVE     99                  TO        HD5-01 HD5-04.
     MOVE     "-"                 TO        HDHAIFN.
     MOVE     9                   TO        HD5-03.
     MOVE     999999              TO        HD5-05.
     MOVE     99999               TO        HD5-06.
**
*ヘッダ出力
     WRITE    PRT-REC   FROM     HD1    AFTER    1.
     WRITE    PRT-REC   FROM     HD2    AFTER    2.
...
**
     MOVE     ALL "*"             TO        DT1-01 DT2-01 DT2-02
                                            DT2-03.
     MOVE     9999999             TO        DT2-061 DT2-08.
     MOVE     99999               TO        DT2-041.
     MOVE     9                   TO        DT2-042.
     MOVE     99                  TO        DT2-062.
     MOVE     99999999            TO        DT2-07 DT2-09.
**
     WRITE    PRT-REC   FROM      DT1       AFTER     1.
     WRITE    PRT-REC   FROM      DT2       AFTER     1.
*
 ...
 TEST-02.
**
     MOVE     ALL "*"             TO        TL1-01 TL1-04 TL4-04.
     MOVE     999999999           TO        TL1-02 TL1-03.
     MOVE     99                  TO        TL2-01 TL2-02 TL2-03.
     MOVE     99                  TO        TL4-01 TL4-02 TL4-03.
*
