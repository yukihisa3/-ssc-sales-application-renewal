...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY7004L.COB`
...
*ステータス
 ...
 01  WORK-AREA.
     ...
     03  WK-GONDORA          PIC  X(04)  VALUE  SPACE.
*ﾊﾞｯﾁNO.
 01  WK-BATCH.
...
*メッセージ情報
 01  MSG-AREA.
     03  SEC-NAME.
         ...
         05  S-NAME          PIC  X(30).
     03  MSG-ABEND1.
         05  FILLER          PIC  X(12)  VALUE  "### SSY7004L".
...
*ﾁｮｳﾋｮｳﾃｲｷﾞｴﾘｱ
 01  HEAD01.
     ...
     03  FILLER     PIC  X(08)     VALUE  "SSY7004L".
 ...
 01  HEAD02.
     03  FILLER     PIC  X(02)     VALUE  SPACE.
     03  FILLER     PIC  X(06)     VALUE  "ｺﾞﾝﾄﾞﾗ".
...
*=============================================================
 CONTROL-SEC         SECTION.
     DISPLAY  "**  SSY7004L   START  **"   UPON  CONS.
*
     ...
     PERFORM  END-SEC.
*
     DISPLAY  "**  SSY7004L   END    **"   UPON  CONS.
     STOP  RUN.
 CONTROL-EXIT.
     EXIT.
*=============================================================
...
*        店舗ＣＤブレイク判定
     ...
     END-IF.
*ゴンドラ番号　ブレイク判定
     IF  SYU-F14     NOT  =  WK-GONDORA
         MOVE     SYU-F14     TO   WK-GONDORA
         MOVE     1           TO   PAGE-FLG
     END-IF.
*_番（上１桁）ブレイク判定
...
*ﾊﾞｯﾁNO.
     MOVE    SYU-F011            TO  HD02-02.
     MOVE    SYU-F012            TO  HD02-03.
     MOVE    SYU-F013            TO  HD02-04.
*取引先名
     IF  FLG-TOK   =    ZERO
*    得意先マスタ検索
