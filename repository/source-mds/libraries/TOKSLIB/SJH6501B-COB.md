...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SJH6501B.COB`
...
*                            ホーマック　　　　　　　　　　　　*
*　　　　　　　　　　　　　　（ホーマーグリーン）　　　　　　　*
*    2001/10/03 ルート取得を明細１行目の出荷場所へ変更         *
****************************************************************
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJH6501B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJH6501B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*****END-READ.
*ルートＣＤのセット 2001/10/03 追加
     IF    WK-RUTO  =  SPACE
           MOVE  TOK-F81   TO        HEN-F48
     ELSE
           MOVE  WK-RUTO   TO        HEN-F48
     END-IF.
*_番
