...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSI0020L.COB`
...
*----<< 請求合計Ｆ >>--*
 HSEIGKF-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSI0020L HSEIGKF ERROR " SEI-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
**** CLOSE    HSHIGKF   HSEIGKF    HTENMS    PRTF.
...
*----<< 店舗マスタ >>--*
 HTENMS-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSI0020L HTENMS ERROR " TEN-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
**** CLOSE    HSHIGKF   HSEIGKF    HTENMS    PRTF.
...
*
     ...
     END-EVALUATE.
*
     IF       SHI-F21(1:2)   =    "71" OR  "72" OR "73" OR "74"
              OR   "75" OR  "76" OR "77" OR "78" OR "79" OR "80"
              MOVE      SPACE          TO   ME-11
                                            ME-12
     END-IF.
*
...
*
     EVALUATE SHI-F21(1:2)
         WHEN "71"
              MOVE NC"（伝票代及び処理代）" TO   ME-13
              PERFORM   220-MEIS02-PRINT
         WHEN "72"
              MOVE NC"（封筒代）"           TO   ME-13
              PERFORM   220-MEIS02-PRINT
         WHEN "73"
              MOVE NC"（コンピュータ伝票の配送料）"
                                            TO   ME-13
              PERFORM   220-MEIS02-PRINT
         WHEN "74"
              MOVE NC"（手書伝票代）"       TO   ME-13
              PERFORM   220-MEIS02-PRINT
         WHEN "75"
              MOVE NC"（物品受領書返送料）" TO   ME-13
              PERFORM   220-MEIS02-PRINT
         WHEN "76"
              MOVE NC"（オンライン手数料）" TO   ME-13
              PERFORM   220-MEIS02-PRINT
         WHEN "77"
              MOVE NC"（割戻し金）"         TO   ME-13
              PERFORM   220-MEIS02-PRINT
         WHEN "78"
              MOVE NC"（センコー運送料）"   TO   ME-13
              PERFORM   220-MEIS02-PRINT
         WHEN "79"
              MOVE NC"（その他）"           TO   ME-13
              PERFORM   220-MEIS02-PRINT
         WHEN "80"
              MOVE NC"（消費税）"           TO   ME-13
              PERFORM   220-MEIS02-PRINT
     END-EVALUATE.
*
...
*
 ...
 210-HEAD-PRINT-EXIT.
     EXIT.
*--------------------------------------------------------------*
*    LEVEL 4       ｿｳｻｲﾃﾞﾝﾋﾟｮｳﾖｳ ﾌﾟﾘﾝﾄ ｼｮﾘ                     *
*--------------------------------------------------------------*
...
*
     ...
     MOVE     CNT-8          TO   TA-02.
     MOVE     CNT-9          TO   TA-03.
     COMPUTE  TA-04     =    CNT-7  +  CNT-8  +  CNT-9.
     MOVE     CNT-7          TO   TA-05.
