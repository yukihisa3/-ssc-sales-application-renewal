...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY3301L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*山新伝票データ（共通）　　
     SELECT   JFSHIRED  ASSIGN    TO        JFSHIRED
...
***  ﾜｰｸ ｴﾘｱ
 01  WRK-AREA.
     ...
     03  WK-HENKAN-1              PIC  9(08)     VALUE   ZERO.
     03  WK-YYYYMMDD.
         05  WK-YY1               PIC  9(02).
         05  WK-YY2               PIC  9(02).
         05  WK-MM                PIC  9(02).
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      JFSHIRED.
...
***            訂正後原価金額
               COMPUTE  DT1-01 =  DEN-F15 * DEN-F172
***            訂正後売価金額
               COMPUTE  DT1-02 =  DEN-F15 * DEN-F173
     END-IF.
*明細２行目
***  商品名
     MOVE     DEN-A07             TO   DT2-01.
***  商品コード
...
***  伝票発行区分が"01","11","21"の時
     EVALUATE  DEN-A01
        WHEN     "01"
                 MOVE     "ﾃｲﾊﾞﾝ"        TO    HD1-02
        WHEN     "11"
                 MOVE     "ﾄｸﾊﾞｲ"        TO    HD1-02
        WHEN     "21"
                 MOVE     "ｷｶﾝﾎｳｼ"       TO    HD1-02
     END-EVALUATE.
*ヘッダ２行目
***  発注者名
...
***  伝票番号　
     MOVE     DEN-F02             TO    HD3-06.
***  取引先コード
     MOVE     DEN-F01             TO    HD3-07.
***  取引先名
     MOVE     DEN-A05             TO    HD3-08.
***  発注日(注文日)
     MOVE     DEN-F111            TO    WK-HENKAN-1.
     MOVE     WK-HENKAN-1         TO    WK-YYYYMMDD.
     MOVE     WK-YY2              TO    HD3-091.
     MOVE     WK-MM               TO    HD3-092.
     MOVE     WK-DD               TO    HD3-093.
***  納品日
     MOVE     DEN-F112            TO    WK-HENKAN-1.
     MOVE     WK-HENKAN-1         TO    WK-YYYYMMDD.
     MOVE     WK-YY2              TO    HD3-101.
     MOVE     WK-MM               TO    HD3-102.
     MOVE     WK-DD               TO    HD3-103.
***  伝票_Ｌ欄へ出力の為ワークへ退避
...
*テスト印字項目セット
     MOVE   ALL "*"               TO   HD1-01 HD1-02
                                       HD2-01
                                       HD3-01  HD3-04  HD3-05
                                       HD3-08
                                       DT2-01  DT2-04  DT2-05
*
     MOVE   ALL  "9"              TO   HD3-02  HD3-03  HD3-06
                                       HD3-07  HD3-091 HD3-092
                                       HD3-093 HD3-101 HD3-102
                                       HD3-103
                                       DT1-01  DT1-02
                                       DT2-02  DT2-03  DT2-061
                                       DT2-062
                                       DT2-081 DT2-082 DT2-09
                                       DT2-10  DT2-11
                                       TL1-011 TL1-012
                                       TL1-03  TL1-04  TL2-01.
*ヘッダ部
     WRITE    PRT-REC            FROM  HD1    AFTER  2.
     WRITE    PRT-REC            FROM  HD2    AFTER  2.
     WRITE    PRT-REC            FROM  HD3    AFTER  1.
...
*
     CLOSE    JFSHIRED   PRTFILE    DSPFILE.
*
 END-EXIT.
     EXIT.
