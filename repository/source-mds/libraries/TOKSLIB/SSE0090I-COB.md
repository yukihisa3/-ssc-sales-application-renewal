...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSE0090I.COB`
...
****  メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SSE0090I".
...
*
     ...
     MOVE    "FSE00901"       TO   DSP-FORMAT.
     MOVE    SPACE           TO   DSP-FSE00901.
...
**** ELSE
****         MOVE   "D"     TO   EDIT-OPTION  OF  DSP-SIME02
****         MOVE    SPACE  TO   EDIT-CURSOR  OF  DSP-SIME02
**** END-IF.
****
**** IF      DSP-SIME03     >    31    OR
****         DSP-SIME03     <     1
...
**** ELSE
****         MOVE   "D"     TO   EDIT-OPTION  OF  DSP-SIME03
****         MOVE    SPACE  TO   EDIT-CURSOR  OF  DSP-SIME03
**** END-IF.
*日付チェック
*****IF      DSP-NOU01      =    ZERO      OR
     IF      DSP-NOU02      =    ZERO      OR
             DSP-NOU03      =    ZERO
             MOVE   "R"     TO  EDIT-OPTION  OF  DSP-NOU01
             MOVE   "R"     TO  EDIT-OPTION  OF  DSP-NOU02
             MOVE   "R"     TO  EDIT-OPTION  OF  DSP-NOU03
             MOVE   "C"     TO  EDIT-CURSOR  OF  DSP-NOU01
             MOVE   "C"     TO  EDIT-CURSOR  OF  DSP-NOU02
             MOVE   "C"     TO  EDIT-CURSOR  OF  DSP-NOU03
             IF     ERR-MSG-CD   =     ZERO
                    MOVE         10    TO   ERR-MSG-CD
             END-IF
     ELSE
             MOVE  DSP-NOU01 TO WK-CHKN-YY
             MOVE  DSP-NOU02 TO WK-CHKN-MM
             MOVE  DSP-NOU03 TO WK-CHKN-DD
             MOVE     "3"                 TO   LINK-IN-KBN
             MOVE     WK-CHKN-DATE        TO   LINK-IN-YMD6
             MOVE     ZERO                TO   LINK-IN-YMD8
             MOVE     ZERO                TO   LINK-OUT-RET
             MOVE     ZERO                TO   LINK-OUT-YMD
             CALL     "SKYDTCKB"       USING   LINK-IN-KBN
             ...
             IF        LINK-OUT-RET  NOT =  ZERO
                       ...
                       MOVE         09    TO   ERR-MSG-CD
             ELSE
                       MOVE "D" TO EDIT-OPTION OF DSP-NOU01
                       MOVE "D" TO EDIT-OPTION OF DSP-NOU02
                       MOVE "D" TO EDIT-OPTION OF DSP-NOU03
                       MOVE "C" TO EDIT-CURSOR OF DSP-NOU01
             END-IF
     END-IF.
**** IF      DSP-NOU01      NOT =     ZERO
****         MOVE   "D"     TO   EDIT-OPTION  OF  DSP-NOU01
****         MOVE    SPACE  TO   EDIT-CURSOR  OF  DSP-NOU01
**** END-IF.
****
**** IF      DSP-NOU02      >    12    OR
****         DSP-NOU02      <     1
...
**** ELSE
****         MOVE   "D"     TO   EDIT-OPTION  OF  DSP-NOU02
****         MOVE    SPACE  TO   EDIT-CURSOR  OF  DSP-NOU02
**** END-IF.
****
**** IF      DSP-NOU03      >    31    OR
****         DSP-NOU03      <     1
...
**** ELSE
****         MOVE   "D"     TO   EDIT-OPTION  OF  DSP-NOU03
****         MOVE    SPACE  TO   EDIT-CURSOR  OF  DSP-NOU03
**** END-IF.
*
...
****************************************************************
 END-SEC                SECTION.
     CLOSE    DSPF      HSEIGKF     HTOKMS     HTENMS.
 END-END.
     EXIT.
******************<<  PROGRAM  END  >>**************************
