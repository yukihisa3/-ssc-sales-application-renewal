...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SSY1301L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*トーク伝票データ（共通）　　
     SELECT   TOUSHIRE  ASSIGN    TO        TOUSHIRE
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      TOUSHIRE.
...
*明細２行目
***  品名２
     MOVE     DEN-A152            TO   DT2-01.
***  商品コード
     MOVE     DEN-A16             TO   DT2-02.
***  色／入数
     MOVE     DEN-A17             TO   DT2-03.
***  ケース数
     COMPUTE  DT2-04  =  DEN-A18  /  DEN-A17.
***  単位
     MOVE     SPACE              TO   DT2-05.
     IF       DEN-A26  =  01
              MOVE "ﾊﾞﾗ"         TO   DT2-05
     END-IF.
     IF       DEN-A26  =  02
...
*ヘッダ２行目
***  取引先コード
     MOVE     DEN-A27             TO    HD2-01.
*ヘッダ３行目
***  社名
     MOVE     "ﾄｰｸﾎｰﾑｾﾝﾀｰ"        TO    HD3-01.
***  取引先名称（上段）
     MOVE     DEN-A061            TO    HD3-02.
*ヘッダ４行目
***  店名
     MOVE     DEN-A25             TO    HD4-01.
***  社／店コード
     MOVE     DEN-A23             TO    HD4-02.
***  分類コード
     MOVE     DEN-A04             TO    HD4-03.
***  伝票区分
     MOVE     DEN-A13             TO    HD4-04.
***  伝票_
     MOVE     DEN-A02             TO    HD4-05.
***  取引先名称（下段）
     MOVE     DEN-A062            TO    HD4-06.
***  発注日
     MOVE     DEN-A07             TO    HD4-07.
***  納品日
     MOVE     DEN-A08             TO    HD4-08.
***  便
     MOVE     DEN-A09             TO    HD4-09.
*
...
*
     CLOSE    TOUSHIRE   PRTFILE    DSPFILE.
*
 END-EXIT.
     EXIT.
