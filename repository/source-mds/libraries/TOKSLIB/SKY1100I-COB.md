...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIB/SKY1100I.COB`
...
****  画面ファイル  ****
 COPY   FKY11001         OF        XMDLIB.
 COPY   FKY11002         OF        XMDLIB.
****  画面制御項目  ****
 01  DSP-CONTROL.
...
****  メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SKY1100I".
...
************************************************************
 END-SEC                SECTION.
     CLOSE    HTOKMS    HTENMS    TOKURIF   DSPF.
 END-END.
     EXIT.
*----------------------------------------------------------*
*      2.1       初期画面処理                              *
*----------------------------------------------------------*
 INIT1-DSP-SEC        SECTION.
     MOVE     SPACE          TO   FKY11001.
     MOVE     SPACE          TO   FKY11002.
     MOVE    "FKY11001"      TO   DSP-FORMAT.
...
*----------------------------------------------------------*
 DSP-READ-SEC           SECTION.
     MOVE  "NE"    TO   DSP-PROC.
     READ   DSPF.
     IF  DSP-FORMAT  = "FKY11001"
         MOVE    DSP-AREA    TO   FKY11001
     ELSE
         MOVE    DSP-AREA    TO   FKY11002
     END-IF.
 DSP-READ-EXIT.
     EXIT.
*----------------------------------------------------------*
