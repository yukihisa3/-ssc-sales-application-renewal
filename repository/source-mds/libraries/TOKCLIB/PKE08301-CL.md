...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PKE08301.CL`
...
SKY1701I:
    ...
    ELSE
              IF  ?SOKO  =  '6A'  THEN
                  ?SOKO := '62'
                  FEXPORT FILE-SYJOHO62.TOKFLIB,MODE-@REP,
                          PARA-SYUKA,UNIT-3
                  FEXPORT FILE-SYLABH62.TOKFLIB,MODE-@REP,
                          PARA-SYUKA,UNIT-4
                  FEXPORT FILE-SYLABM62.TOKFLIB,MODE-@REP,
                          PARA-SYUKA,UNIT-5
              END
    END
...
SKE0830I:
    ...
    OVRF      FILE-ZSOKMS1,TOFILE-ZSOKMS1.TOKFLIB
    OVRDSPF   FILE-DSPF,TOFILE-DSPF.XUCL,MEDLIB-TOKELIB
    CALL      PGM-SKE0830I.TOKELIB,PARA-(?SOKO,?JOHO,?LABH,?LABM,
                                         ?RERR)
    IF        @PGMEC    ^=   0    THEN
              GOTO   ABEND
    END
