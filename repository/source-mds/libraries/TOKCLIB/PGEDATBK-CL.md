...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PGEDATBK.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PGEDATBK'
    VAR       ?STEP     ,STRING*8
...
STEP00:
    ...
    DACTLF    FILE-ZNYUSDT1.SKTFLIBZ
    CNDPF     FILE-ZNYUSDT.SKTFLIBZ
    ACTLF     FILE-ZNYUSDT1.SKTFLIBZ
...
TAIHI1:
    ...
    SNDMSG MSG-'＃発注Ｆ　　　　　退避中＃',TO-XCTL
    SAVFILE FILE-ZHACHDT.TOKFLIB,TODEV-MO,ADD-@YES,MODE-@USED
