...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/IONHACJ.CL`
...
STEP01:
    ...
    SBMJOB JOB-IONHACJ,JOBD-CVCS.XUCL,JOBK-@B,
           PGM-PIONHAC.TOKELIB,LIBL-TOKELIB
