...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PSJH4599.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PSJH4599'  /.PROGRAM-ID./
...
SCV0075B:
    ...
    CALL      PGM-SCV0075B.TOKELIB,PARA-(?HIDUKE,?JIKAN,?TOKCD,?LINE,
...
SJH4560B:
    ...
    CALL      PGM-SJH4560B.TOKELIB,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := '92'
