...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PSJH4504.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PSJH4504'  /.PROGRAM-ID./
...
SCV1000B:
    ...
    CALL      PGM-SCV1000B.TOKELIB,PARA-(?HIDUKE,?JIKAN,?TOKCD,?LINE,
...
SJH4555B:
    ...
    CALL      PGM-SJH4555B.TOKELIB,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := '92'
