...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PONLEG03.CL`
...
SEG0050B:
    ...
    OVRF      FILE-SHTDENLA,TOFILE-EGYOOSL1.TOKFLIB
    OVRF      FILE-JHSDENF,TOFILE-EGYDENF.TOKFLIB
    CALL      PGM-SEG0050B.TOKELIB,PARA-(?P1,?P2,?P3)
    IF        @PGMEC    ^=   0    THEN
              ?P4 :=  '2'
              OVRF      FILE-TOKMS2,TOFILE-TOKMS2.TOKFLIB
              OVRPRTF   FILE-PRTF,TOFILE-PRTF.XUCL,MEDLIB-TOKELIB
              CALL      PGM-SEG0170B.TOKELIB,PARA-(?P1,?P2,?P3,?P4)
              IF        @PGMEC    ^=   0    THEN
                         GOTO ABEND
              END
              GOTO ABEND
