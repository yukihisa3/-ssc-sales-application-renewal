...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PSY60010.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PSY60010'
    VAR       ?STEP     ,STRING*8
...
PSY60010:
    ...
    CALL      PGM-SSY6001I.TOKELIB,PARA-(?P1,?P2,?P3,
                                         ?P4,?P5,?P6,?P7)
    IF        @PGMEC    ^=   0    THEN
        IF    @PGMEC     =   4010 THEN
...
SSY6002L:
    ...
    CALL      PGM-SSY6002L.TOKELIB,PARA-(?P5,?P6)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
