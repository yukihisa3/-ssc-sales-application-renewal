...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PTE36020.CL`
...
/. *   SYSTEM-NAME :    ナフコオンラインシステム　　         *  ./
/. *   JOB-ID      :    PTE36020                             *  ./
/. *   JOB-NAME    :    手書伝票発行処理（ＴＡ_）　         *  ./
/. *               :    ＜倉庫ＣＤよりＩＮファイル判断＞     *  ./
/. ***********************************************************  ./
    PGM
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PTE15010'    /.ﾌﾟﾛｸﾞﾗﾑID./
