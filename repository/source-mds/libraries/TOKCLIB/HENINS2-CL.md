...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/HENINS2.CL`
...
KENLST:
    ...
    SBMJOB JOB-KENLSTI2,JOBD-CVCS.XUCL,JOBK-@B,PGM-KENLST.TOKELIB,
...
/.##ﾌﾟﾛｸﾞﾗﾑ正常終了##./
RTN:
    CALL SCVMSG.TOKELIB,PARA-('ｾｲｼﾞｮｳ ｼｭｳﾘｮｳ HENINS')

   /.##ｴﾗｰﾘｽﾄ発行##./
    SBMJOB JOB-KEKLSTI2,JOBD-CVCS.XUCL,JOBK-@B,
