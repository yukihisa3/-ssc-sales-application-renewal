...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PTA99999.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PTA99999'
    VAR       ?STEP     ,STRING*8
...
/.  SAVFILE FILE-ZAMZAIF.TOKFLIB,TODEV-MO,ADD-@NO
             ./
/.## DEFLIBL ##./
...
ZTANASET:
    ...
    OVRF      FILE-INFILE,TOFILE-TANAHOK.TOKFLIB
