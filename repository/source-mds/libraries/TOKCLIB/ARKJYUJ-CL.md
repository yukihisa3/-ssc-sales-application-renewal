...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/ARKJYUJ.CL`
...
STEP01:
    ...
    SBMJOB JOB-ARKJYUJ,JOBD-CVCS.XUCL,JOBK-@B,
           PGM-PARKJYU.TOKELIB,LIBL-TOKELIB
