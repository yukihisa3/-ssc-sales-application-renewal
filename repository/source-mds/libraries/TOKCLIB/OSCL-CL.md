...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/OSCL.CL`
...
CL SRC-?NAME,STORE-@YES,OBJLIB-OSKELIB,REP-@YES,
   SRCL-@NO,PCHECK-@YES,WORK-100
              IF   @PGMEC  ^=   0      THEN
                   IF   @PGMEL  =   'I'
                        THEN      ?COMENT   :=   '<]]OSCL  翻訳ｴﾗｰ:'
                        ?PGM      :=   ?COMENT && @PGMEM
                                    && ' '    && @PGMES  && ' >'
