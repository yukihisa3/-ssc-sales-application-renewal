...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/SOSCBL.CL`
...
START:
    DEFLIBL  TOKFLIB/TOKELIB/OSKELIB/OSKFLIB/TOKKLIB
    SNDMSG MSG-'<< SOSCBL   翻訳開始 >>',TO-XCTL
...
RTN:
     ...
     IF   ?PGMEC    ^=   0
          ...
          END
     SNDMSG    MSG-'<< SOSCBL   翻訳終了 >>',TO-XCTL
     RETURN    PGMEC-?PGMEC
