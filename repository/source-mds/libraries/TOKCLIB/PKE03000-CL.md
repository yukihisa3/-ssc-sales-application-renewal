...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PKE03000.CL`
...
MOBACKUP:
    ...
    SAVFILE FILE-RUISYUF.TOKKLIB/RUIKONF.TOKKLIB/
            ...
            SYJOHO63.TOKBLIB/SYJOHO62.TOKBLIB/
            SYLABH63.TOKBLIB/SYLABH62.TOKBLIB/
            SYLABM63.TOKBLIB/SYLABM62.TOKBLIB,
            TODEV-MO,
            MODE-@USED
    IF        @PGMEC    ^=   0   THEN
              ?KEKA4  :=  '【ＭＯ待避】'
...
SNDCOPY:
    ...
    CNVFILE FILE-SNDKENF.TOKKLIB,TOFILE-SNDKENDT.TOKFLIB,
            BF-31
    IF        @PGMEC    ^=   0   THEN
              ?KEKA4  :=  '【送信用ファイルヘＣＯＰＹ】'
              GOTO ABEND
...
SNDBAKUP:
    ...
    SAVFILE FILE-SNDKENDT.TOKFLIB,TODEV-MO,MODE-@USED
    IF        @PGMEC    ^=   0   THEN
              ?KEKA4  :=  '【作成済データバックアップ】'
              GOTO ABEND
    END
