...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PTURJYU.CL`
...
/. ************************************************************ ./
    ...
    VAR       ?MSG      ,STRING*13
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PTURJYU '
    VAR       ?STEP     ,STRING*8
/.ライブラリリストの登録                                        ./
...
GP6000CP:
    ...
    CPYFILE FILE-CVCSG001.CVCSLBT,TOFILE-TURUYA.ONLBLIB,
            CRTFILE-@REU
...
KENTYUSY:
    ...
    OVRF      FILE-CVCSCARD,TOFILE-TURUYA.CVCSLBT
