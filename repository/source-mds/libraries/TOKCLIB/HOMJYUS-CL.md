...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/HOMJYUS.CL`
...
STEP01:
    ...
    SBMJOB JOB-HOMJYUS,JOBD-CVCS.XUCL,JOBK-@B,
           PGM-PHOMSHI.TOKELIB,LIBL-TOKELIB
