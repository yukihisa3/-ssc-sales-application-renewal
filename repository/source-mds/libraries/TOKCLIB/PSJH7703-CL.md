...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PSJH7703.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PSJH7703'  /.PROGRAM-ID./
...
/.  OVRF      FILE-VLD500,TOFILE-LD500.TOKFLIB   ./
    ...
    CALL      PGM-SJH7702B.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := '92'
...
/.  OVRF      FILE-VLD500,TOFILE-LD500.TOKFLIB   ./
    OVRVLDF   FILE-VLD500,TOFILE-LD500.XUCL
/. 20100910 TEISI
    CALL      PGM-SJH7703B.TOKELIBO,PARA-(?PARA)
./  IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := '92'
/.            CALL PGM-SCV0090B.TOKELIB,
