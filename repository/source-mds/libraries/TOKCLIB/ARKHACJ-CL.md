...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/ARKHACJ.CL`
...
STEP01:
    ...
    SBMJOB JOB-ARKHACJ,JOBD-CVCS.XUCL,JOBK-@B,
           PGM-PARKHAC.TOKELIB,LIBL-TOKELIB
