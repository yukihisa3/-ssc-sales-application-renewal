...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/HOGJYUJ.CL`
...
STEP01:
    ...
    SBMJOB JOB-HOGJYUJ,JOBD-CVCS.XUCL,JOBK-@B,
           PGM-PHOGJYU.TOKELIB,LIBL-TOKELIB
