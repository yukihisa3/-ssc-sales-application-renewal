...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PTE23020.CL`
...
/. *   SYSTEM-NAME :    丸長商事（パワーセンター）           *  ./
/. *   JOB-ID      :    PTE23020（パワーセンター）           *  ./
/. *   JOB-NAME    :    手書き伝票発行                       *  ./
/. *               :    ＜倉庫ＣＤよりＩＮファイル判断＞     *  ./
/. ***********************************************************  ./
    PGM
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PTE23020'    /.ﾌﾟﾛｸﾞﾗﾑID./
