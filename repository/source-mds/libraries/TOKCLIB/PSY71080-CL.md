...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PSY71080.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY71080'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SSY7108I:
    ...
    OVRF      FILE-HDSYUKL2,TOFILE-HDSYUKL2.TOKFLIB
    OVRF      FILE-TOKMS2,TOFILE-TOKMS2.TOKFLIB
    OVRF      FILE-ZSOKMS1,TOFILE-ZSOKMS1.TOKFLIB
    CALL      PGM-SSY7108I.TOKELIB,PARA-(?P1,?P2,?P3,?P4,?P6,?P5)
    IF        @PGMEC    ^=   0    THEN
         IF   @PGMEC     =   4010 THEN
...
/.  OVRF      FILE-SHTDENL1,TOFILE-SHTDENL1.TOKFLIB
    ...
    CALL      PGM-SSY7109L.TOKELIB,PARA-(?P1,?P2,?P3,?P4,?P6)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '確定リスト出力'
              GOTO ABEND END
