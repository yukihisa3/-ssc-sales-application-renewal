...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PSJH4592.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PSJH4592'  /.PROGRAM-ID./
...
SCV1003B:
    ...
    CALL      PGM-SCV1003B.OSKELIB,PARA-(?HIDUKE,?JIKAN,?TOKCD,?LINE,
...
SJH4592B:
    ...
    CALL      PGM-SJH4592B.OSKELIB,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := '92'
