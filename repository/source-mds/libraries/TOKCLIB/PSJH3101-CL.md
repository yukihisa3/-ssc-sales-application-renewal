...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PSJH3101.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PSJH3101'  /.PROGRAM-ID./
...
SCV0073B:
    ...
    CALL      PGM-SCV0073B.TOKELIB,PARA-(?HIDUKE,?JIKAN,?TOKCD,?LINE,
...
SJH3101B:
    ...
    CALL      PGM-SJH3101B.TOKELIB,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := '92'
