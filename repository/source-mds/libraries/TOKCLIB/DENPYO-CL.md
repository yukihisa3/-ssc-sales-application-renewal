...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/DENPYO.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'DENPYO  '    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SBMJOB:
    ...
    SNDMSG    ?MSGX,TO-XCTL.@ORGPROF,JLOG-@YES
                                           /.##各種ﾌｧｲﾙ置換え##./
    SBMJOB JOB-DENUP,JOBD-XJDV5R4.XUCL,JOBK-@B,
           PGM-PKY01010.TOKELIB,
