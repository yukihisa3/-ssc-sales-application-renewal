...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PSY31030.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY31030'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SSY3103I:
    ...
    OVRF      FILE-KMJOHOL2,TOFILE-KMJOHOL2.TOKFLIB
    OVRF      FILE-TOKMS2,TOFILE-TOKMS2.TOKFLIB
    OVRF      FILE-ZSOKMS1,TOFILE-ZSOKMS1.TOKFLIB
    CALL      PGM-SSY3103I.TOKELIB,PARA-(?P1,?P2,?P3,?P4,?P6,?P5)
    IF        @PGMEC    ^=   0    THEN
         IF   @PGMEC     =   4010 THEN
...
SSY3111B:
    ...
    OVRF      FILE-KMSYUKL2,TOFILE-KMSYUKL1.TOKFLIB
    CALL      PGM-SSY3111B.TOKELIB,PARA-(?P1,?P2,?P3,?P4,?P6)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  'データ削除'
              GOTO ABEND END
...
SSY3104B:
    ...
    OVRF      FILE-KMJOHOL3,TOFILE-KMJOHOL3.TOKFLIB
    OVRF      FILE-KMSYUKL2,TOFILE-KMSYUKL1.TOKFLIB
    CALL      PGM-SSY3104B.TOKELIB,PARA-(?P1,?P2,?P3,?P4,?P6)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  'データ抽出'
              GOTO ABEND END
