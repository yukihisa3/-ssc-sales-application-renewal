...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/CVCSTEL1.CL`
...
/.##ワーク定義##./
    ...
    VAR  ?PGMID    ,STRING*8,VALUE-'CVCSTEL1'  /.PROGRAM-ID./
...
/.##プログラム開始メッセージ##./
    ...
    SNDMSG MSG-'＊　　（ＴＥＬ－１）　＊',TO-XCTL.@ORGPROF,JLOG-@YES
    SNDMSG MSG-'＊＊＊＊＊＊＊＊＊＊＊＊',TO-XCTL.@ORGPROF,JLOG-@YES
...
RETEL:
   ...
   /.##ｼﾞｭｼﾝｶﾝｹｲﾌｧｲﾙ ｵｷｶｴ##./
/.  OVRVLDF  FILE-LD901,TOFILE-LD901.CVCSLBT
    OVRVTMF  FILE-DICVCS01,AFILE-DOCVCS01,TOFILE-DICVCS01.CVCSLBT
    OVRISF   FILE-CVCSI001,TOFILE-CVCSI001.CVCSLBT
    OVRF     FILE-CVCSG001,TOFILE-CVCSG001.CVCSLBT        ./
   /.##ｼﾞｭｼﾝﾌﾟﾛｸﾞﾗﾑ START##./
...
PARASND:
    ...
    SNDFILE COM-PCPATH02.PCNODE02,SFILE-PARATEL1.TOKFLIB,
...
SNDRSJJ:
    ...
    SNDRSJJ COM-PCPATH02.PCNODE02,DFILE-'HENTEL1'
 /. CALL PGM-HENTEL1.TOKELIB ./
    ?PGMEC := @PGMEC
    IF  ?PGMEC ^= 0 THEN
