...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PSJH4702.CL`
...
/. *   JOB-ID      :    PSJH4702                             *  ./
/. *   JOB-NAME    :    ツルヤオンラインシステム　　　　　　 *  ./
/. ***********************************************************  ./
    PGM

/.##ﾊﾟﾗﾒﾀ定義##./
    VAR       ?HIDUKE   ,STRING*8,VALUE-'20040322' /.受信日付./
    VAR       ?JIKAN    ,STRING*4,VALUE-'1530'     /.受信時間./
    VAR       ?TOKCD    ,STRING*8,VALUE-'00000423' /.受信取引先./
    VAR       ?LINE     ,STRING*1,VALUE-'T'        /.回線./
    VAR       ?YUSEN    ,STRING*1,VALUE-'1'        /.回線優先./
    VAR       ?LIBNM    ,STRING*8,VALUE-'ONLBLIB ' /.集信LIB./
    VAR       ?FILNM    ,STRING*8,VALUE-'TURUYA  ' /.集信FILE./
    VAR       ?JKEKA    ,STRING*2,VALUE-'00'      /.結果./
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PSJH4702'  /.PROGRAM-ID./
...
SJH4701B:
    ...
    CALL      PGM-SJH4701B.TOKELIB,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := '92'
