...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PEGTOJIT.CL`
...
SNDFILE1:
    ...
    SNDFILE COM-?SCOMNM,SFILE-?TOJITUF,DFILE-'TOJITUF',RL-100,BF-1
    IF        @PGMEC    ^=   0
          THEN
              ?MSGX     :=    '## ﾄｳｼﾞﾂﾃﾞｰﾀ再送信異常 ##'
              SNDMSG MSG-?MSGX,TO-XCTL.@ORGPROF,JLOG-@YES
