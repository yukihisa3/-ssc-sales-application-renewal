...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PEG01000.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PEG01000'    /.ﾌﾟﾛｸﾞﾗﾑID      ./
...
SEG0100B:
    ...
    OVRF      FILE-JHTDENF,TOFILE-EGYTEGF.TOKFLIB
    CALL      PGM-SEG0100B.TOKELIB
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
