...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PHOMJYU.CL`
...
/. ************************************************************ ./
    ...
    VAR       ?MSG      ,STRING*13
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PHOMJYU '
    VAR       ?STEP     ,STRING*8
/.ライブラリリストの登録                                        ./
...
KENTYUSY:
    ...
    OVRF      FILE-CVCSCARD,TOFILE-HOMJYU.CVCSLBT
