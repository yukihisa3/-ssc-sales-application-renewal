...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PSSY0036.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PSSY0032'
    VAR       ?STEP     ,STRING*8
...
SSY0032B:
    ...
    OVRF      FILE-TOKMS2,TOFILE-TOKMS2.TOKFLIB
    OVRF      FILE-JYOKEN1,TOFILE-JYOKEN1.TOKFLIB
    CALL      PGM-SSY0032B.TOKELIB,PARA-(?P1,?P2,?P3,
...
/.ＳＯＲＴ順：ﾊﾞｯﾁ番号、倉庫、納品日、分類、店舗、_番、Ｓ商品./
    ...
    SORT      INFILE-SHWSYUKF.TOKFLIB,INRL-200,INBF-5,
              ...
              KEY4-23!5!CA,KEY5-32!6!CA,KEY6-38!16!CA,
              RCDL-@DSP
...
/.##出力パターンが’２’（通常）の場合##./
    ...
    CALL      PGM-SSY0036L.TOKELIB,PARA-(?P1)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
    /.##ﾌﾟﾛｸﾞﾗﾑ終了ﾍ##./
    GOTO  RTN
...
SSY0037L:
    ...
    OVRF      FILE-ZSOKMS1,TOFILE-ZSOKMS1.TOKFLIB
    OVRF      FILE-MEIMS1,TOFILE-MEIMS1.TOKFLIB
    OVRPRTF   FILE-XU04LP,TOFILE-PRTF.TOKELIB,MEDLIB-TOKELIB
    CALL      PGM-SSY0037L.TOKELIB,PARA-(?P1)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
