...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/HOGJYUS.CL`
...
STEP01:
    ...
    SBMJOB JOB-HOGJYUS,JOBD-CVCS.XUCL,JOBK-@B,
           PGM-PHOGSHI.TOKELIB,LIBL-TOKELIB
