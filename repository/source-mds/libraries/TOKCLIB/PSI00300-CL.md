...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PSI00300.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PSI00300'
    VAR       ?STEP     ,STRING*8
...
SSI0030B:
    ...
    CALL      PGM-SSI0030B.TOKELIB,PARA-(?SYORIKN1)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
...
CNDPF:
    ...
    DACTLF FILE-SETGKFB1.TOKFLIB
    CNDPF  FILE-SETGKFB.TOKFLIB
    ACTLF  FILE-SETGKFB1.TOKFLIB
...
RTN:
    ...
    ?SYORINM2 := 'ケーヨー請求ＤＴ消込処理が正常終了しました。　　'
    ?SYORINM3 := '件数を確認して下さい。　　　　　　　　　　　　　'
...
ABEND:
    ...
    OVRPRTF FILE-PRTF,TOFILE-PRTF.TOKELIB,MEDLIB-TOKELIBO
                /.１２３４５６７８９０１２３４５６７８９０１２３４'./
    ?SYORINM2 := 'ケーヨー請求ＤＴ消込処理が異常終了しました。　　'
