...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PSJH4590.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PSJH4590'  /.PROGRAM-ID./
...
SCV1001B:
    ...
    CALL      PGM-SCV1001B.OSKELIB,PARA-(?HIDUKE,?JIKAN,?TOKCD,?LINE,
...
SJH4590B:
    ...
    CALL      PGM-SJH4590B.OSKELIB,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := '92'
