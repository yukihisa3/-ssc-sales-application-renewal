...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PSY31050.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY31050'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
/.  OVRPRTF   FILE-PRTF,TOFILE-KMA4PRT.XUCL./
    OVRF      FILE-KMSYUKL1,TOFILE-KMSYUKL1.TOKFLIB
    OVRF      FILE-TOKMS2,TOFILE-TOKMS2.TOKFLIB
    OVRF      FILE-ZSOKMS1,TOFILE-ZSOKMS1.TOKFLIB
    CALL      PGM-SSY3105I.TOKELIB,PARA-(?P1,?P2,?P3,?P4,?P5,?P6,?P7)
    IF        @PGMEC    ^=   0    THEN
         IF   @PGMEC     =   4010 THEN
...
SSY3106B:
    ...
    OVRF      FILE-KMSYUKL2,TOFILE-KMSYUKL2.TOKFLIB
    CALL      PGM-SSY3106L.TOKELIB,PARA-(?P1,?P2,?P3,?P4,?P6,?P7)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '出荷リスト出力'
              GOTO ABEND END
