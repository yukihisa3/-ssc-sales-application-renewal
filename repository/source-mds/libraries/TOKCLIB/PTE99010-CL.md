...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PTE99010.CL`
...
/. *   SYSTEM-NAME :    ダイシンオンラインシステム           *  ./
/. *   JOB-ID      :    PTE99010（伝票番号有り）             *  ./
/. *   JOB-NAME    :    手書伝票発行                         *  ./
/. *               :    ＜倉庫ＣＤよりＩＮファイル判断＞     *  ./
/. ***********************************************************  ./
    PGM
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PTE99010'    /.ﾌﾟﾛｸﾞﾗﾑID./
