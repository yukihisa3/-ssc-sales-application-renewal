...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/POS06900.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'POS06900'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,STRING*8
...
SOS0690B:
    ...
    OVRF      FILE-KAHMAL1,TOFILE-KAHMAL1.TOKFLIB
