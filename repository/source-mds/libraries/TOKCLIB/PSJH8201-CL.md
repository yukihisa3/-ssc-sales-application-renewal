...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PSJH8201.CL`
...
/.##ﾊﾟﾗﾒﾀ定義##./
    ...
    PARA      ?JKEKA    ,STRING*2,OUT,VALUE-'  '      /.結果FLG./
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PSJH4101'  /.PROGRAM-ID./
...
SJH6601B:
 ...
 /. CALL      PGM-SJH8201B.TOKELIBO,PARA-(?PARA)./
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := '92'
