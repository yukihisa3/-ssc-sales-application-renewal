...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/JUNHACJ.CL`
...
/.  *    取引先：ジュンテンドーＴＣ発注オンライン          *    ./
/.  *    作成者：NAV T.TAKAHASHI                           *    ./
/.  *    作成日：03/02/07                   ID:JUNHACJ     *    ./
/.  ********************************************************    ./
    PGM
...
STEP01:
    ...
    SBMJOB JOB-JUNHACJ,JOBD-CVCS.XUCL,JOBK-@B,
           PGM-PJUNHAC.TOKELIB,LIBL-TOKELIB
