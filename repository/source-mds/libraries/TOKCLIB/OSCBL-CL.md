...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/OSCBL.CL`
...
START:
    DEFLIBL  TOKFLIB/TOKELIB/OSKELIB/OSKFLIB
    SNDMSG MSG-'<< OCBL   翻訳開始 >>',TO-XCTL
