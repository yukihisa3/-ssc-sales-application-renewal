...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PRCVTANA.CL`
...
/.####################./
    ...
    ?KEKA4 := 'ＡＣＯＳ_卸ＤＴ受信'
    RCVFTPC FILE-'SSC.TOKTANA',TOENT-ZTANAWK.TOKFLIB,DTYPE-@BINARY
    IF      @PGMEC  ^=  0
        THEN
              ?MSGX :=  '## ＡＣＯＳ_卸受信異常 ##'
              SNDMSG    ?MSGX,TO-XCTL
...
PCNVFILE:
    ...
    ?KEKA4 := '_卸確定前ＤＴバックアップ'
    CNVFILE FILE-ZTANADT.TOKFLIB,TOFILE-BKTANADT.TOKWLIB,
            ADD-@NO,BF-51
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
