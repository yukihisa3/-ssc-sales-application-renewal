...
**種別**: JCL  
**ライブラリ**: TOKCLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIB/PSJH1203.CL`
...
/.##ﾊﾟﾗﾒﾀ定義##./
    ...
    PARA      ?JKEKA    ,STRING*2,OUT,VALUE-'  '      /.集信FILE./
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PSJH1203'  /.PROGRAM-ID./
...
SJH1203B:
    ...
    OVRF      FILE-KOJYURYO,TOFILE-KOJYURYO.OSKFLIB
    OVRVLDF   FILE-VLD500,TOFILE-LD500.XUCL
    CALL      PGM-SJH1203B.OSKELIB,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := '92'
