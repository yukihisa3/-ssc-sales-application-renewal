...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SNA0280B.COB`
...
*
**************************************************************
 PROCEDURE         DIVISION   USING  PARA-RENNO PARA-ONLTGK.
**************************************************************
 DECLARATIVES.
...
*-------排他制御ファイルの読み込み
     READ  NARLOCF  AT   END
           GO TO    MAIN-EXIT
     END-READ.
     MOVE  PARA-RENNO         TO   NAR-F04.
     MOVE  PARA-ONLTGK        TO   NAR-F05.
     MOVE  HZK                TO   NAR-F98.
