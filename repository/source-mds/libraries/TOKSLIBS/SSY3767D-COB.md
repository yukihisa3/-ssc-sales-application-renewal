...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY3767D.COB`
...
*受領累積ファイル
     SELECT  NFJYURF
       ASSIGN        TO  DA-01-VI-NFJYURL1
       ORGANIZATION  IS  INDEXED
       ACCESS MODE   IS  RANDOM
       RECORD KEY    IS  JYR-F02 *> 仕入計上日
                         JYR-F05 *> 店舗ＣＤ
                         JYR-F03 *> 伝票区分
                         JYR-F04 *> 赤黒区分
                         JYR-F07 *> 伝票番号
...
*****03  JYO-SI11               PIC  X(01).
*****03  JYD-RENRK-JIKO1        PIC  N(15).
*****03  JYD-RENRK-JIKO2        PIC  N(15).
     03  JYD-RENRK-JIKO         PIC  N(30).
     03  JYO-SO11               PIC  X(01).
...
*読込・書込カウント領域
 01  CNT-AREA.
     ...
     03  CHK-CNT            PIC  9(07)  VALUE ZERO.
***  エラーセクション名
 01  SEC-NAME.
     03  FILLER             PIC  X(18)
         VALUE "### ERR-SEC    => ".
...
*
     ...
     MOVE  JYD-DENKBN       TO  JYR-F03. *> 伝票区分
...
*
     IF  CHK-CNT = 1
         DISPLAY "JYD-SIR-KEIJYBI = " JYD-SIR-KEIJYBI UPON  CONS
         DISPLAY "JYD-TENCD       = " JYD-TENCD       UPON  CONS
         DISPLAY "JYD-DENKBN      = " JYD-DENKBN      UPON  CONS
         DISPLAY "JYD-AKAKRKBN    = " JYD-AKAKRKBN    UPON  CONS
         DISPLAY "JYD-DENNO       = " JYD-DENNO       UPON  CONS
         DISPLAY "JYD-GYONO       = " JYD-GYONO       UPON  CONS
     END-IF.
*
     READ  NFJYURF
       INVALID
...
*連絡事項
*****MOVE  JYD-RENRK-JIKO1  TO  JYR-F19(1:15).
*****MOVE  JYD-RENRK-JIKO2  TO  JYR-F19(16:15).
     MOVE  JYD-RENRK-JIKO   TO  JYR-F19.
*空白
...
****************************************************************
 END-SEC               SECTION.
     ...
     DISPLAY  "NFJYURF OT = "  OT-CNT  UPON CONS.
* ファイルのＯＰＥＮ
     CLOSE  NFJYUDT.
     CLOSE  NFJYURF.
