...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/PSO0020I.COB`
...
*
 LINKAGE                SECTION.
   ...
   01  PARA-STENCD        PIC   ZZZZZ9.
   01  PARA-ETENCD        PIC   ZZZZZ9.
   01  PARA-SSHOCD        PIC   ZZZZZZZZZZZZ9.
   01  PARA-ESHOCD        PIC   ZZZZZZZZZZZZ9.
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     DISPLAY  "### PSO0020I HTOKMS ERROR " HTOKMS-ST " "
...
*----<< 基本情報ファイル >>--*
 SHOTBL1-ERR            SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### PSO0020I SHOTBL1 ERROR " SHOTBL1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 店舗マスタ >>--*
 HTENMS-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### PSO0020I HTENMS ERROR " HTENMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< POS売上情報F >>--*
 HTENMS-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### PSO0020I DYPSURL2 ERROR " DYPSURL2-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FPO0020.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "PSO0020I"      TO   PGID.
     MOVE    "FPO0020"      TO   FORM.
*
     MOVE     SPACE          TO   DSP-CNTL.
     MOVE     "FPO0020"     TO   DSP-FMT.
