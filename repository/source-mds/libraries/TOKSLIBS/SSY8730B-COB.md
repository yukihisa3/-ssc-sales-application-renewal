...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8730B.COB`
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SSY8730I DSPFILE ERROR " DSP-CNTL " "
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY8730I HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FSI87301.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "SSY8730I"      TO   PGID.
     MOVE    "FSI87301"      TO   FORM.
*
     MOVE     SPACE          TO   DSP-CNTL.
     MOVE     "FSI87301"     TO   DSP-FMT.
...
*    取引先チェック
     IF  TORICD  NOT  NUMERIC  OR TORICD = ZERO
     ...
     IF  ERR-FLG   =    ZERO
         EVALUATE  TORICD
         WHEN  00000880  WHEN  00000882  WHEN  00000883
         WHEN  00001427  WHEN  00014272  WHEN  00014273
         WHEN  00013938  WHEN  00017137  WHEN  00100403
         WHEN  01004031
               CONTINUE
         WHEN  OTHER
               IF   ERR-FLG   =    ZERO
