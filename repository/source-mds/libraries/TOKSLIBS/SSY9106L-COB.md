...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY9106L.COB`
...
*    メッセージ　エリア
 01  MSG-AREA.
     03  MSG-ABEND1.
         ...
         05  ERR-PG-ID            PIC  X(08)  VALUE  "SSY9106L".
...
*#2017/04/06 NAV ST
         WHEN "9"   MOVE NC"ＢＹ改廃"           TO   PRT-KBN
         WHEN "A"   MOVE NC"本部在庫補充"       TO   PRT-KBN
         WHEN "B"   MOVE NC"備品用度品"         TO   PRT-KBN
         WHEN "C"   MOVE NC"プロモーション"     TO   PRT-KBN
*#2017/04/06 NAV ED
