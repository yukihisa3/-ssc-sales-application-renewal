...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/HIDUKEPG.COB`
...
*メッセージ情報
 01  MSG-AREA.
     03  MSG-ABEND1.
         05  FILLER          PIC  X(12)  VALUE  "### HIDUKEPG".
...
*=============================================================
 CONTROL-SEC         SECTION.
     DISPLAY  "**  HIDUKEPG   START  **"   UPON  CONS.
*
     PERFORM  IHIZ-SEC.
     PERFORM  MAIN-SEC   UNTIL  END-FLG = "END".
     PERFORM  END-SEC.
*
     DISPLAY  "**  HIDUKEPG    END   **"   UPON  CONS.
     STOP  RUN.
 CONTROL-EXIT.
     EXIT.
*=============================================================
