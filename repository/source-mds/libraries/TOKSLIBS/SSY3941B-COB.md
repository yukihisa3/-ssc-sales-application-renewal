...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY3941B.COB`
...
****<< 発注書店舗ワーク >>* RANDOM *************************
     SELECT   HCTPXXXF  ASSIGN    TO        DA-01-VI-HCTPXXX1
                        ORGANIZATION        IS   INDEXED
                        ACCESS    MODE      IS   RANDOM
                        RECORD    KEY       IS   HCT-F01
                                                 HCT-F05
                                                 HCT-F09
                                                 HCT-F06
                                                 HCT-F07
...
****<< 発注書店舗ワーク >>* SEQUENTIAL *********************
     SELECT   HCTPXXXS  ASSIGN    TO        DA-01-VI-HCTPXXX1
                        ORGANIZATION        IS   INDEXED
                        ACCESS    MODE      IS   SEQUENTIAL
                        RECORD    KEY       IS   HCS-F01
                                                 HCS-F05
                                                 HCS-F09
                                                 HCS-F06
                                                 HCS-F07
                        FILE      STATUS    IS   HCS-STATUS.
***************************************************************
 DATA                   DIVISION.
***************************************************************
 FILE                   SECTION.
...
****  ステイタス情報          ****
 01  STATUS-AREA.
     ...
     02 HCS-STATUS           PIC  X(02).
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       03  FILLER            PIC  X(04)  VALUE  "### ".
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SSY3941B".
 ...
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY3941B".
...
****  フラグ                  ****
 ...
 01  WK-TBL-NO               PIC  9(03)  VALUE  ZERO.
****  カウント                ****
 01  CNT-AREA.
...
***
 FILEERR-SEC4           SECTION.
     USE AFTER     EXCEPTION
                   PROCEDURE  HCTPXXXS.
     MOVE   "HCTPXXXS"        TO    ERR-FL-ID.
     MOVE    HCS-STATUS       TO    ERR-STCD.
     DISPLAY MSG-ABEND1       UPON  CONS.
     DISPLAY MSG-ABEND2       UPON  CONS.
     MOVE    4000             TO    PROGRAM-STATUS.
     STOP     RUN.
...
*
*発注書店舗ワーク存在チェック
     PERFORM  HCTPXXXF-READ-SEC.
     IF  HCTPXXXF-INV-FLG  =  "INV"
         WRITE HCT-REC
         ADD   1     TO  HCT-CNT
     END-IF.
*
...
*    発注書店舗ワーク読込み
************************************************************
 HCTPXXXS-READ-SEC                  SECTION.
*ＴＢＬＮＯ採番
     OPEN  I-O  HCTPXXXS.
 HCTP010.
     READ    HCTPXXXS
             AT  END  GO            TO HCTP999
     END-READ.
*
     ADD     1                      TO  WK-TBL-NO.
     MOVE    WK-TBL-NO              TO  HCS-F13.
*
     REWRITE  HCS-REC.
     GO                             TO  HCTP010.
*
