...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSI7805I.COB`
...
*    業務名　　　　　　　：　ロイヤルＨＣ　新ＥＤＩ対応　　　　*
*    モジュール名　　　　：　支払明細書／不照合リスト発行指示  *
*    作成日／更新日　　　：　2008/12/11                        *
*    作成者／更新者　　　：　NAV                               *
*    処理概要　　　　　　：　画面より、支払明細書／不照合リス  *
*                            ト発行に必要な締日を入力する。　  *
****************************************************************
****************************************************************
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SSI7805I DSPFILE ERROR " DSP-CNTL " "
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FSI78051.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "SSI7805I"      TO   PGID.
     MOVE    "FSI78051"      TO   FORM.
*
     MOVE     SPACE          TO   DSP-CNTL.
     MOVE     "FSI78051"     TO   DSP-FMT.
...
*
     EVALUATE  PARA-KBN
         WHEN  "1"  MOVE  NC"支払明細書"   TO  TYOHYO
         WHEN  "2"  MOVE  NC"不照合リスト" TO  TYOHYO
         WHEN  "3"  MOVE  NC"請求ＤＴ消込" TO  TYOHYO
     END-EVALUATE.
*
     PERFORM  900-DSP-WRITE.
*
