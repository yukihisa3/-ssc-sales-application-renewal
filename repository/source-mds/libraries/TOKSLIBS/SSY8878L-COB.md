...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8878L.COB`
...
*ステータス
 ...
 01  WORK-AREA.
     ...
     03  WK-SYUBETU          PIC  X(04)  VALUE  SPACE.
*ﾊﾞｯﾁNO.
 01  WK-BATCH.
...
*メッセージ情報
 01  MSG-AREA.
     03  SEC-NAME.
         ...
         05  S-NAME          PIC  X(30).
     03  MSG-ABEND1.
         05  FILLER          PIC  X(12)  VALUE  "### SSY8878L".
...
*ﾁｮｳﾋｮｳﾃｲｷﾞｴﾘｱ
 01  HEAD01.
     ...
     03  FILLER     PIC  X(08)     VALUE  "SSY8878L".
 ...
 01  MEISAI01.
     ...
     03  FILLER     PIC  X(02)     VALUE  SPACE.
     03  MEI01-081  PIC  X(15).
     03  MEI01-082  PIC  X(15).
     03  FILLER     PIC  X(02)     VALUE  SPACE.
     03  MEI01-09   PIC  X(13).
 01  MEISAI011.
     03  FILLER     PIC  X(114)    VALUE  SPACE.
     03  FILLER      PIC  X(01)    VALUE  "(".
     03  MEI011-101  PIC  X(08).
     03  MEI011-SEN4 PIC  X(01).
     03  MEI011-102  PIC  X(05).
     03  MEI011-SEN5 PIC  X(01).
     03  MEI011-103  PIC  X(02).
     03  MEI011-SEN6 PIC  X(01).
     03  MEI011-104  PIC  X(01).
     03  FILLER      PIC  X(01)    VALUE  ")".
 01  MEISAI02.
     03  FILLER     PIC  X(03)     VALUE  SPACE.
     ...
     03  FILLER     PIC  X(02)     VALUE  SPACE.
     03  MEI02-081  PIC  X(15).
     03  MEI02-082  PIC  X(15).
     03  FILLER     PIC  X(02)     VALUE  SPACE.
     03  MEI02-09   PIC  X(13).
 01  MEISAI021.
     03  FILLER     PIC  X(114)    VALUE  SPACE.
     03  FILLER      PIC  X(01)    VALUE  "(".
     03  MEI021-101  PIC  X(08).
     03  MEI021-SEN4 PIC  X(01).
     03  MEI021-102  PIC  X(05).
     03  MEI021-SEN5 PIC  X(01).
     03  MEI021-103  PIC  X(02).
     03  MEI021-SEN6 PIC  X(01).
     03  MEI021-104  PIC  X(01).
     03  FILLER      PIC  X(01)    VALUE  ")".
 01  SEN01.
...
*=============================================================
 CONTROL-SEC         SECTION.
     DISPLAY  "**  SSY8878L   START  **"   UPON  CONS.
*
     ...
     PERFORM  END-SEC.
*
     DISPLAY  "**  SSY8878L   END    **"   UPON  CONS.
     STOP  RUN.
 CONTROL-EXIT.
     EXIT.
*=============================================================
...
*        店舗ＣＤブレイク判定
     ...
     END-IF.
*発注種別区分／形状区分／発注単位区分
     IF  SYU-F99(1:4)  NOT  =  WK-SYUBETU
         MOVE     SYU-F99(1:4) TO  WK-SYUBETU
         MOVE     1            TO  PAGE-FLG
     END-IF.
*_番（上１桁）ブレイク判定
...
*出力順の設定
     ...
     ELSE
           IF      PARA-OUTNO    =     2
                   MOVE NC"部門＋_番毎集計"  TO HD06-02
           ELSE
                   MOVE SPACE               TO   HD06-02
           END-IF
     END-IF.
*発注種別区分
     MOVE  SYU-F99(1:2)         TO   HD065-01.
     EVALUATE  SYU-F99(1:2)
         ...
         WHEN  "04"  MOVE NC"ダイレクト　　" TO HD065-02
     ...
     END-EVALUATE.
*形状区分
     MOVE  SYU-F99(3:1)         TO   HD065-03.
     EVALUATE  SYU-F99(3:1)
     ...
     END-EVALUATE.
*発注単位区分
     MOVE  SYU-F99(4:1)         TO   HD065-05.
     EVALUATE  SYU-F99(4:1)
...
*商品名称カナ
     MOVE  SYU-F081            TO  MEI01-081 MEI02-081.
     MOVE  SYU-F082            TO  MEI01-082 MEI02-082.
*ＪＡＮＣＤ
     MOVE  SYU-F18             TO  MEI01-09  MEI02-09.
*サカタＣＤ
     MOVE  SYU-F061            TO  MEI011-101  MEI021-101.
     MOVE  "-"                 TO  MEI011-SEN4 MEI021-SEN4.
     MOVE  SYU-F062(1:5)       TO  MEI011-102  MEI021-102.
     MOVE  "-"                 TO  MEI011-SEN5 MEI021-SEN5.
     MOVE  SYU-F062(6:2)       TO  MEI011-103  MEI021-103.
     MOVE  "-"                 TO  MEI011-SEN6 MEI021-SEN6.
     MOVE  SYU-F062(8:1)       TO  MEI011-104  MEI021-104.
*
...
*
     IF    HMEIMS-INV-FLG = "INV"
              ...
              WRITE PRT-REC FROM   MEISAI021 AFTER   1
              WRITE PRT-REC FROM   SEN02     AFTER   1
     ELSE
              WRITE PRT-REC FROM   MEISAI01  AFTER   1
              WRITE PRT-REC FROM   MEISAI011 AFTER   1
              WRITE PRT-REC FROM   SEN02     AFTER   1
     END-IF.
*印刷
     ADD   3                     TO  LINE-CNT.
