...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SNA0061I.COB`
...
*    業務名　　　　　：
*    モジュール名　　：小売連携発注データ照会選択（オンライン）
*    作成日／更新日　：2011/11/08
*    作成者／更新者　：飯田/NAV
*    処理概要　　　　：
*      小売連携したｵﾝﾗｲﾝ発注ﾃﾞｰﾀの状態を確認
 ...
 01  TB-DT.
     03  TB-DT-G.
       05  TB-DT-G2  OCCURS 50. *> ページ
         07  TB-DT-G2  OCCURS 12. *> 行
           ...
           09  TB-BATNO.
             11  TB-BATHZK       PIC  X(08).
             11  FILLER          PIC  X(01).
             11  TB-BAT-HYPHEN1  PIC  X(01).
             11  FILLER          PIC  X(01).
             11  TB-BATHM        PIC  X(04).
             11  FILLER          PIC  X(01).
             11  TB-BAT-HYPHEN2  PIC  X(01).
             11  FILLER          PIC  X(01).
             11  TB-BATTOR       PIC  X(08).
     ...
     03  TB-DT-GR  REDEFINES TB-DT-G.
       05  TB-DT-G2R  OCCURS 600.
         ...
         07  TB-BATNO-R.
           09  TB-BATHZK-R       PIC  X(08).
           09  FILLER            PIC  X(01).
           09  TB-BAT-HYPHEN1-R  PIC  X(01).
           09  FILLER            PIC  X(01).
           09  TB-BATHM-R        PIC  X(04).
           09  FILLER            PIC  X(01).
           09  TB-BAT-HYPHEN2-R  PIC  X(01).
           09  FILLER            PIC  X(01).
           09  TB-BATTOR-R       PIC  X(08).
...
****************************************************************
 TBL-SETB-SEC           SECTION.
     ...
     MOVE  KAN-F0721        TO  TB-BATHZK-R (IX-TBL).
     MOVE  KAN-F0722        TO  TB-BATHM-R  (IX-TBL).
     MOVE  KAN-F0723        TO  TB-BATTOR-R (IX-TBL).
     MOVE  "-"              TO  TB-BAT-HYPHEN1-R (IX-TBL).
     MOVE  "-"              TO  TB-BAT-HYPHEN2-R (IX-TBL).
...
*I↑
         ...
         MOVE  SPACE        TO  DSP-BATNO  (IX-GYO)
...
*I↑
     ...
     MOVE  TB-BATNO  (CT-PAGE IX-GYO)     TO  DSP-BATNO  (IX-GYO).
...
*I*↓****MOVE  "END"        TO  END-FLG
         MOVE  DSP-FNA00601 TO  WK-FNA00601
         CLOSE DSPFILE
         CLOSE HTOKMS
         CLOSE NARKANF
         CLOSE HTANMS
         ...
         OPEN  INPUT NARKANF
         OPEN  INPUT HTANMS
         MOVE  WK-FNA00601  TO  DSP-FNA00601
         MOVE  "4"          TO  PSW
*I*↑********************************************
*    終了
       WHEN  "F005"
...
* バッチＮｏ
     MOVE  SPACE            TO  PAA-BATNO.
     STRING
       DSP-BATNO (WK-SELGYO) (1:8)
       DSP-BATNO (WK-SELGYO) (12:4)
       DSP-BATNO (WK-SELGYO) (19:8)
       DELIMITED BY SIZE  INTO  PAA-BATNO.
...
* 取引先ＣＤ
     MOVE  DSP-BATNO (WK-SELGYO) (19:8)  TO  PAA-TORCD.
