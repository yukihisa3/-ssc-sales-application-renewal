...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSE0191B.COB`
...
*
     ...
     DISPLAY "WRITE    = " OUT-CNT1  UPON CONS.
     DISPLAY "DELETE   = " OUT-CNT2  UPON CONS.
     DISPLAY "REWRITE  = " OUT-CNT3  UPON CONS.
*
 END-END.
     EXIT.
*****************<<  PROGRAM  END  >>***********************
