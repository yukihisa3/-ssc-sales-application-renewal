...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY0803L.COB`
...
*
 ...
 FILE-CONTROL.
*欠品ファイル
     SELECT  KPNFILF   ASSIGN    TO        KPNFILL1
...
**************************************************************
 DECLARATIVES.
 KPN-ERR                   SECTION.
     USE         AFTER     EXCEPTION PROCEDURE KPNFILF.
...
****************************************************************
 PROCESS-SEC             SECTION.
     ...
     DISPLAY  "***   SSY0803L   START    ***"  UPON CONS.
*
*ワーク初期化
     MOVE      ZERO     TO    P-CNT.
     MOVE      ZERO     TO    L-CNT.
...
*ファイルのＯＰＥＮ
     OPEN     INPUT     KPNFILF HTOKMS   HTENMS   ZSOKMS.
     OPEN     OUTPUT    PRTFILE.
*ワークの初期化
     INITIALIZE         FLG-AREA.
*
...
*明細部出力
***    伝票_ブレイク時，合計及び破線表示
     IF       KPN-F02   NOT =     WK-DENNO
              IF   RD-SW   =   ZERO
                   MOVE      1    TO   RD-SW
                   MOVE      KPN-F02   TO   WK-DENNO
              ELSE
***              合計欄出力
...
*    店舗，伝票_の重複表示不可
***           店舗コード
              MOVE      KPN-F07   TO   DT1-01  TEN-F011
***           店舗名称
              MOVE     KPN-F01             TO   TEN-F52
              READ     HTENMS
                INVALID
              ...
              END-READ
              MOVE     KPN-F111            TO   WK-HENKAN-DATE
              ...
              MOVE     KPN-F112            TO   WK-HENKAN-DATE
              MOVE     WK-HENKAN-DATE      TO   WK-OUT-DATE
