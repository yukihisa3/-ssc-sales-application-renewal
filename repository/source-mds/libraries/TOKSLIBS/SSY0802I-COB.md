...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY0802I.COB`
...
*画面定義ファイル
     SELECT  DSPFILE   ASSIGN    TO        GS-DSPF
                       ...
                       FILE      STATUS    DSP-ST.
*伝票データワーク(伝票単位順）
     SELECT  KPNFILL1  ASSIGN    TO        KPNFILL1
                       ORGANIZATION        INDEXED
                       ACCESS    MODE      RANDOM
                       RECORD    KEY       KP1-F46
                                           KP1-F47
                       ...
                       FILE      STATUS    KP1-ST.
*伝票データワーク(商品単位順）
     SELECT  KPNFILL2  ASSIGN    TO        KPNFILL2
                       ORGANIZATION        INDEXED
                       ACCESS    MODE      RANDOM
                       RECORD    KEY       KP2-F46
                                           KP2-F47
...
**************************************************************
 ...
 DSP-ERR                   SECTION.
     ...
     STOP        RUN.
 KP1-ERR                   SECTION.
     USE         AFTER     EXCEPTION PROCEDURE KPNFILL1.
     ...
     STOP        RUN.
 KP2-ERR                   SECTION.
     USE         AFTER     EXCEPTION PROCEDURE KPNFILL2.
...
*ファイルのＯＰＥＮ
     OPEN     I-O       DSPFILE   KPNFILL1 KPNFILL2.
