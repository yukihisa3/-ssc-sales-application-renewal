...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SZA0091L.COB`
...
****  見出し行（表題）  ****
 01  HYODAI.
     ...
     03  FILLER              PIC  X(08)  VALUE  "SZA0091L".
...
****  メッセージ情報  ****
 01  MSG-AREA.
     03  MSG-ABEND1.
       ...
       05  ERR-PG-ID         PIC  X(08)  VALUE  "SZA0091L".
...
*      <0.0>    メインモジュール                           *
************************************************************
 SZA0091L-START         SECTION.
     DISPLAY  "**  SZA0091L   START   **"   UPON  CONS.
*
     PERFORM            INIT-SEC.
     PERFORM            MAIN-SEC
                        UNTIL      END-FLG  =    "END".
     PERFORM            END-SEC.
*
     DISPLAY  "**  SZA0091L    END    **"   UPON  CONS.
     STOP               RUN.
 SZA0091L-END.
     EXIT.
************************************************************
...
*
     ...
     DISPLAY "* NYSFILF(SKIP)=" NYU-SKIP " *" UPON CONS.
...
*属性のクリア
     MOVE   SPACE                TO   FZA00902   DSP-CONTROL.
     PERFORM   ERR-CLR-SEC.
*倉庫コードのセット
...
*****MOVE    0000000              TO   SDENNO.
*****MOVE    9999999              TO   EDENNO.
*画面初期表示
     MOVE    SPACE                TO   DSP-CONTROL.
     MOVE    "FZA00902"           TO   DSP-FORMAT.
