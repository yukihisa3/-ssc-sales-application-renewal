...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY3835I.COB`
...
*画面表示用ワーク
 01  DSP-WORK.
     03  WORK-PGID                PIC  X(08)  VALUE  "SSY3835I".
     03  WORK-FORMID              PIC  X(08)  VALUE  "FSY38351".
*フラグ領域
 01  FLG-AREA.
...
*ファイルのＯＰＥＮ
     OPEN     I-O       DSPFILE.
     OPEN     INPUT     NFJOHOF   SAKUBAF   HTANMS.
*ワークの初期化
     INITIALIZE   FLG-AREA.
...
****************************************************************
 END-SEC               SECTION.
*ファイル ＣＬＯＳＥ
     CLOSE             NFJOHOF SAKUBAF  HTANMS  DSPFILE.
**
 END-EXIT.
     EXIT.
*****************<<  SSY3835I   END PROGRAM  >>******************
