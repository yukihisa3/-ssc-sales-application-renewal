...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8875B.COB`
...
*    修正概要　　　　　　：　基幹サーバ統合                    *
*    更新日／更新者　　　：　14/09/17 / TAKAHASHI              *
*    修正概要　　　　　　：　ホーマック様データ作成            *
*    更新日／更新者　　　：　18/02/19 / TAKAHASHI              *
*    修正概要　　　　　　：　ケーヨー様追加　　　　            *
*    更新日／更新者　　　：　19/03/14 / TAKAHASHI              *
*    修正概要　　　　　　：　ＨＭ仕様追加（単位区分＝Ｃの時）  *
*　　　　　　　　　　　　　　形状区分を強制的に３をセット　　　*
*　　　　　　　　　　　　　　（ＨＭ様仕様変更依頼のため）      *
****************************************************************
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY8875B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY8875B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*### 1999/11/22 NAV T.T START ###*
*## 2014/09/17 NAV ST ホーマック用区分追加
     MOVE     DEN-A161(1:1)  TO   SYU-F99(1:1).
     MOVE     DEN-A161(2:1)  TO   SYU-F99(2:1).
     MOVE     DEN-A163       TO   SYU-F99(3:1).
*#2019/03/174 NAV ST発注単位区分＝Ｃの時、形状区分をケースに変更
     IF       DEN-A162  =  "C"
              MOVE  3        TO   SYU-F99(3:1)
     END-IF.
*#2019/03/174 NAV ED
*## 2018/02/14 NAV ST  発注単位は空白セット
*****MOVE     DEN-A162       TO   SYU-F99(4:1).
     MOVE     SPACE          TO   SYU-F99(4:1).
*## 2014/09/17 NAV ED ホーマック用区分追加
*## 2018/02/14 NAV ST カーマ用区分追加
...
*#2018/02/19 NAV ED
         ...
         MOVE KMS-A35(1:1)   TO  SYU-F99(1:1)
         MOVE KMS-A35(2:1)   TO  SYU-F99(2:1)
         IF   DEN-F40  =  1
              MOVE  KMS-A37  TO  SYU-F99(3:1)
         ELSE
              MOVE  SPACE    TO  SYU-F99(3:1)
         END-IF
         MOVE KMS-A36        TO  SYU-F99(4:1)
     END-IF.
*## 2018/02/14 NAV ED カーマ用区分追加
     WRITE    SYU-REC.
     ADD      1              TO   WRT-CNT.
*
 MAIN-010.
