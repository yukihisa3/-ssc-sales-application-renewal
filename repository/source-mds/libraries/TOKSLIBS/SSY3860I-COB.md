...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY3860I.COB`
...
****  メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SSY3860I".
...
*ファイルオープン
     ...
     OPEN  I-O    NFSHOMS.
*##2019/12/05 UPDATE START
*****OPEN  INPUT  HSHOTBL  HMEIMS  HTANMS  SAKUBAF  HJYOKEN.
     OPEN  I-O    HSHOTBL.
     OPEN  INPUT           HMEIMS  HTANMS  SAKUBAF  HJYOKEN.
     OPEN  INPUT  ZSOKMS.
*##2019/12/05 END

     MOVE  "FSY38601"        TO  DSP-FORMAT.
     MOVE  SPACE            TO  DSP-FSY38601.
...
*--------------------------------------------------------------*
 DSP-WRITE-SUB               SECTION.
     ...
     MOVE  "SSY3860I"       TO  DSP-PGID.
     MOVE  "FSY38601"       TO  DSP-FORMID.
     WRITE  DSP-FSY38601.
 DSP-WRITE-END.
     EXIT.
*--------------------------------------------------------------*
