...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8507I.COB`
...
*----<< 伝票データ >>--*
 KGSYUKF-ERR            SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY3105I KGSYUKF ERROR " KGSYUKF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*    売上伝票データ存在チェック
     IF  ERR-FLG        =    ZERO
         ...
         START     KGSYUKF   KEY  >=   KMS-F01   KMS-F02
                                       KMS-F03   KMS-F04
                                       KMS-F05   KMS-F09A
                                       KMS-F09B  KMS-F06
                                       KMS-F07
