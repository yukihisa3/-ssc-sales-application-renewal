...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SKY3582B.COB`
...
*    サブシステム　　　　：　受配信                            *
*    モジュール名　　　　：　ＰＧ実行結果リスト                *
*    作成日／作成者　　　：　2000/08/21 T.TAKAHASHI            *
*    更新日／更新者　　　：　　　　　　                        *
*    処理概要　　　　　　：　　　　　　　　　　　　　　　　　　*
*                                                              *
****************************************************************
...
*項目設定
***  受信結果／エラー内容
     MOVE  NC"受領有り"  TO        PRT-JKEKKA.
     MOVE  NC"ホーマー北海道の受領データの受信を行いま"
                         TO        PRT-ERRNM1.
     MOVE  NC"した。受領書を発行して下さい。（植物）　"
                         TO        PRT-ERRNM2.
*プリント出力
