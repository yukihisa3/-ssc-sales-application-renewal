...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8201L.COB`
...
***  _番
     MOVE     NC"_番："          TO   TANA-NM(IX).
     MOVE     DEN-F49             TO   TANA-NO(IX).
*
 DENP-WT-SEC-READ.
     PERFORM  FL-READ-SEC.
*
...
*テスト印字項目セット
     PERFORM VARYING IX FROM 1 BY 1 UNTIL IX > 3
             MOVE   ALL NC"Ｎ"   TO   HATYUK(IX) TANA-NM(IX)
...
*
     ...
     MOVE     "FSY66051"          TO        DSP-FMT.
*項目設定
***  伝票枚数
     MOVE     WK-MAI              TO        MD01.
***  プログラムＩＤ
     MOVE     "SSY8201L"          TO        PGID.
***  日付
