...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SKY1101B.COB`
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SKY1101B".
...
* ファイルＣＬＯＳＥ
     ...
     DISPLAY "(SKY1101B)ﾆｭｳﾘｮｸ ｹﾝｽｳ(ｵﾔ) = " IN-CNT1  UPON  CONS.
     DISPLAY "(SKY1101B)ﾆｭｳﾘｮｸ ｹﾝｽｳ(ｺ)  = " IN-CNT2  UPON  CONS.
     DISPLAY "(SKY1101B)ﾌﾟﾘﾝﾄ  ｹﾝｽｳ(ｵﾔ) = " PRT-CNT1 UPON  CONS.
     DISPLAY "(SKY1101B)ﾌﾟﾘﾝﾄ  ｹﾝｽｳ(ｺ)  = " PRT-CNT2 UPON  CONS.
 END-END.
     EXIT.
*----------------------------------------------------------*
*      2.1       初期画面処理                              *
*----------------------------------------------------------*
 INIT-DSP-SEC        SECTION.
     MOVE     SPACE          TO   FKY11011.
     MOVE    "FKY11011"      TO   DSP-FORMAT.
