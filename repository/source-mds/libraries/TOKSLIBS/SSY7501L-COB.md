...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY7501L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*サンワドー伝票データ（共通）
     SELECT   SWSHIRED  ASSIGN    TO        SWSHIRED
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      SWSHIRED.
...
***  取引先ＣＤ
     MOVE     DEN-A03             TO    HD3-06.
***  仕入先略称
     MOVE     DEN-A12             TO    HD3-07.
***  発注日
     MOVE     DEN-A10(3:2)        TO    HD3-081.
     MOVE     DEN-A10(5:2)        TO    HD3-082.
     MOVE     DEN-A10(7:2)        TO    HD3-083.
***  納品日
     MOVE     DEN-A11(3:2)        TO    HD3-091.
     MOVE     DEN-A11(5:2)        TO    HD3-092.
     MOVE     DEN-A11(7:2)        TO    HD3-093.
*
...
*テスト印字項目セット
     MOVE   ALL "9"              TO   HD3-02  HD3-03  HD3-04
                                      HD3-05  HD3-06  HD3-081
                                      HD3-082 HD3-083 HD3-091
                                      HD3-092 HD3-093
                                      DT2-02  DT2-031 DT2-032
                                      DT2-041 DT2-042 DT2-051
                                      DT2-052 DT2-06  DT2-07
                                      DT2-08
                                      TL1-011 TL1-021 TL1-03
                                      TL1-012 TL1-022 TL1-04.
     MOVE   ALL "*"              TO   HD2-01  HD3-01  HD3-07
...
*
     CLOSE    SWSHIRED   PRTFILE    DSPFILE.
*
 END-EXIT.
     EXIT.
