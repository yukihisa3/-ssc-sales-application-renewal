...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH6001B.COB`
...
*原価金額
 01  WK-GENKA              PIC  9(08).
 01  WK-GENKA-R            REDEFINES  WK-GENKA.
     03  WK-HEN-GENKA      PIC  9(06)V9(02).
*
 01  MSG-AREA.
     03  MSG-START.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  ST-PG          PIC   X(08)  VALUE "NJH6001B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH6001B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    原単価
     MOVE     WK-DEPD16     TO        WK-GENKA.
     MOVE     WK-HEN-GENKA  TO        HEN-A32.
*    売単価
...
*分類（大分類＋中分類）
     MOVE        HEN-A05   TO        HEN-F12(1:2).
     MOVE        HEN-A14   TO        HEN-F12(3:2).
*商品区分　　
...
*        商品名
         ...
         MOVE    HEN-A23(16:10) TO   HEN-F1422(1:10)
       NOT INVALID
         MOVE    HEN-A23(1:15)  TO   HEN-F1421(1:15)
         MOVE    HEN-A23(16:10) TO   HEN-F1422(1:10)
     END-READ.
