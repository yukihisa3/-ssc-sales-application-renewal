...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/TSY0103I.COB`
...
*    更新日　　　　　：　00/09/11                              *
*      更新者　　　　：　 T.T                                  *
*      更新内容　　　：　仕様変更　（ＡＣＯＳ締日のチェック変更*
*                                    ＡＣＯＳ締日＜＝はエラー）*
*    更新日　　　　　：　05/10/07 - 10/24                      *
*      更新者　　　　：　 TAKEI.                               *
*      更新内容　　　：　仕様変更　（一覧画面・サブルーチン）  *
*    更新日　　　　　：　06/11/24                              *
*      更新者　　　　：　 T.T                                  *
*      更新内容　　　：　仕様変更　（サンワドー対応）　　　　  *
*                                                              *
...
*    更新者　　    　：　 MIURA.                             *
*    更新内容　　　　：　ＬＩＮＫＳ連携対応　　　　　　　　　*
*    小売連携フラグセット、物流連携フラグ、連携日クリア      *
*    更新日　　　　　： 13/04/04                             *
*    更新者          ： NAV TAKAHASHI                        *
*    更新内容　　　　：　バグ対応（店舗ＣＤ、納品日）　　　　*
*    更新日　　　　　： 13/12/03                             *
*    更新者          ： NAV TAKAHASHI                        *
*    更新内容　　　　：　バグ対応（店舗ＣＤの更新方法を変更）*
*    更新日　　　　　： 13/12/12                             *
*    更新者          ： NAV INOUE                            *
*    更新内容　　　　：　消費税増税対応　　　　　　　　　　　*
*    更新日　　　　　： 13/12/24                             *
...
*    更新日　　　　　： 18/07/30                             *
*    更新者          ： NAV TAKAHASHI                        *
*    更新内容　　　　：　リック伝票番号チェック制限追加　　　*
****************************************************************
*<履歴>*********************************************************
* XXXX/XX/XX XXXXXXXXX ＮＮＮＮＮＮＮＮＮＮＮＮＮＮＮＮＮＮＮＮ
* 2018/03/30 高橋　　　受注残ファイル更新処理を追加（４０のみ）
* 2020/04/20 高橋　　　Ｄ３６５連携対応（伝票ＮＯ採番）
* 2020/05/07 井上　　　Ｄ３６５連携対応（直送／セット区分追加）
* 2020/12/14 高橋　　　Ｄ３６５連携対応
*　　　　　　（小売連携区分取得方法を変更　オーダー区分セット）
* 2020/12/24 高橋　　　Ｄ３６５連携対応　修正時対応　　
* 2020/05/14 井上　　　未計上区分追加　　　　　　　　　　　
* 2021/09/16 高橋　　　チェック機能追加　　　　　　　　　　
****************************************************************
 IDENTIFICATION         DIVISION.
****************************************************************
 PROGRAM-ID.            TSY0103I.
 AUTHOR.                NAV Y.YOSHIDA.
 DATE-WRITTEN.          00/05/13.
...
*----<< 画面ファイル >>-*
 FD  DSPFILE.
     COPY     MSY01011  OF   XMDLIB.
*--------------------------------------------------------------*
 WORKING-STORAGE        SECTION.
*--------------------------------------------------------------*
 01  PGM-ID                  PIC  X(08)     VALUE  "TSY0103I".
*----<< ﾃﾞｨｽﾌﾟﾚｲ ｺﾝﾄﾛｰﾙ ｴﾘｱ >>-*
 01  DSP-CNTL.
     03  DSP-FMT             PIC  X(08).
     03  DSP-GRP             PIC  X(08).
...
*----<< ﾃﾞｰﾀ ﾃｰﾌﾞﾙ >>-*
 01  TABLE-AREA.
     03  TBL                 OCCURS    12.
         ...
         05  TBL-F27E        PIC  9(01).
         05  TBL-MAER10301   PIC X(08).
         05  TBL-MAER10401   PIC X(05).
         05  TBL-MAER10501   PIC X(02).
         05  TBL-MAER11501   PIC X(01).
         05  TBL-MAER10601   PIC 9(08)V99.
         05  TBL-F32         PIC X(01).
*#2020/12/24 NAV ST
         05  TBL-F33         PIC X(09).
         05  TBL-D93         PIC X(01).
...
*#2020/12/24 NAV ED
*#2021/09/16 NAV ST
         05  TBL-F461        PIC 9(04).
         05  TBL-F462        PIC 9(02).
         05  TBL-F463        PIC 9(02).
         05  TBL-F471        PIC 9(02).
         05  TBL-F472        PIC 9(02).
         05  TBL-F48         PIC X(02).
         05  TBL-F272        PIC 9(01).
         05  TBL-F274        PIC 9(01).
         05  TBL-F275        PIC 9(01).
         05  TBL-F276        PIC 9(01).
         05  TBL-F278        PIC X(01).
         05  TBL-F28         PIC 9(03).
         05  TBL-F30         PIC X(10).
         05  TBL-XI0004      PIC X(485).
         05  TBL-F42         PIC X(10).
*#2021/09/16 NAV ED
...
*画面退避用
     COPY   MSY01011 OF XMDLIB  JOINING   SAV  AS   PREFIX.
*
 01  SAVE-AREA.
...
** カーソルエリア
 01  CSL-TY.
     03  CSL-T               PIC  9(02)  VALUE  ZERO.
     03  CSL-Y               PIC  9(02)  VALUE  ZERO.
*----<< ﾌｱﾝｸｼﾖﾝ ｷｰ ﾃ-ﾌﾞﾙ >>-*
 01  FNC-TABLE.
     ...
     03  PF07                PIC  X(04)  VALUE "F007".
     03  PF08                PIC  X(04)  VALUE "F008".
     03  PF10                PIC  X(04)  VALUE "F010".
...
*----<< ﾃﾞｨｽﾌﾟﾚｲ ｶﾞｲﾀﾞﾝｽ ｴﾘｱ >>-*
 01  GUIDE-AREA.
     ...
     03  G005                PIC  N(30)  VALUE
         NC"_取消_項目戻り_一覧".
     03  G006                PIC  N(30)  VALUE
         NC"_取消_項目戻り_一覧_次頁".
     03  G007                PIC  N(30)  VALUE
         NC"_取消_項目戻り_一覧_前頁".
     03  G008                PIC  N(30)  VALUE
         NC"_取消_項目戻り_伝票一覧_店舗一覧".
     03  G009                PIC  N(30)  VALUE
         NC"_取消_項目戻り_店舗一覧".
 01  MSG-AREA.
...
** 一覧サブルーチン用  2005/10/07
 01  LINK-SB1.
     03  LINK-SB1-01        PIC   9(08).
 01  LINK-SB2.
     03  LINK-SB2-01        PIC   9(08).
     03  LINK-SB2-02        PIC   9(05).
 01  LINK-SB3.
     03  LINK-SB3-00        PIC   9(01).
     03  LINK-SB3-01        PIC   9(08).
     03  LINK-SB3-02        PIC   X(08).
     03  LINK-SB3-03        PIC   X(08).
     03  LINK-SB3-04        PIC   X(08).
     03  LINK-SB3-05        PIC   X(05).
 01  LINK-SB4.
...
*#2018/03/30 NAV ED
*#2018/04/02 NAV ST 受注残Ｆ更新用バックアップ
...
*#2021/09/16 NAV ST オンライン伝票チェック関係
 01  WK-DENPYO-CHK.
     03  WK-ONL-CHK-FLG     PIC   9(01).
     03  WK-DEN-F46         PIC   9(08).
     03  WK-DEN-F47         PIC   9(04).
     03  WK-DEN-F48         PIC   X(02).
*#2021/09/16 NAV ED オンライン伝票チェック関係
...
*----------  サブ商品変換テーブル　----------------------------*
 STB-ERR                     SECTION.
     ...
     ACCEPT      SYS-DATE    FROM  DATE.
     ACCEPT      SYS-TIME    FROM  TIME.
     DISPLAY  "### " PGM-ID " " NC"サブ商品変換テーブル異常！"
              "ST1=" SUB-ST1                 " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"  UPON STAT.
*
...
*
     ...
     WHEN     PF04
              MOVE      0         TO   GR-NO
*** 取引先一覧サブ  2005/10/07 - 10/18
     WHEN     PF10
**@@          PERFORM  DSP-SAV-SET
              MOVE     ZERO       TO   LINK-SB1-01
              CALL "FSB0101I"  USING   LINK-SB1
***@@  全画面クリア
              MOVE  "CL"          TO   DSP-PRO
              MOVE  "MSY01011"    TO   DSP-FMT
              MOVE  "ALLF"        TO   DSP-GRP
...
**
              IF  ( R00001  =  1 ) AND
                  ( LINK-SB1-01  NOT =  ZERO )
                  MOVE  LINK-SB1-01   TO   R00005
                  MOVE  SPACE         TO   R00006
              END-IF
     WHEN     PF06
                   MOVE      2         TO   GR-NO
     WHEN     ENT
                 ...
                 ELSE
                   ...
                   ELSE
                     ...
                     ELSE
                        ...
                        IF R00001  =  2
                           MOVE  4         TO   GR-NO
                           MOVE  "X"  TO   EDIT-STATUS OF R00010
                           MOVE  "X"  TO   EDIT-STATUS OF R00016
                        END-IF
                     END-IF
                   END-IF
                 END-IF
...
*
     ...
     WHEN     PF06
                   MOVE      3         TO   GR-NO
*** 店舗一覧サブ  2005/10/07 - 10/18
     WHEN     PF10
              MOVE  R00005        TO   LINK-SB2-01
              MOVE     ZERO       TO   LINK-SB2-02
              CALL "FSB0201I"  USING  LINK-SB2
              MOVE  "CL"          TO   DSP-PRO
              MOVE  "MSY01011"    TO   DSP-FMT
              MOVE  "ALLF"        TO   DSP-GRP
              WRITE  MSY01011
**
              IF  ( R00001  =  1  OR  2 ) AND
                  ( LINK-SB2-02  NOT = ZERO )
                  MOVE  LINK-SB2-02   TO   R00010
...
**
                  ...
                  MOVE      CHK-DATE    TO   SAV-NOU-DATE2
     WHEN     ENT
              MOVE  R00010          TO   WK-TENCD SAV-HTENCD
              MOVE  SAV-NOU-DATE2   TO   WK-NOHINBI
              PERFORM   CHK-3-RTN
              CLOSE            SHTDENF
              OPEN  I-O        SHTDENF
              IF   ERR-FLG  =  ZERO  OR 21 OR 36 OR 37
...
*
     ...
     WHEN     PF06
              IF R00001  =  2
                 MOVE  3         TO   GR-NO
                 MOVE  " "  TO   EDIT-STATUS OF R00010
                 MOVE  " "  TO   EDIT-STATUS OF R00016
              END-IF
              MOVE      9         TO   GR-NO
*** 店舗一覧サブ  2005/10/07 - 10/18
     WHEN     PF10
...
**
              IF  ( R00001  =  1  OR  2 ) AND
                  ( LINK-SB2-02  NOT = ZERO )
                  MOVE  LINK-SB2-02   TO   R00030  SAV-HTENCD
...
*画面＆ＴＢＬクリア
     ...
     MOVE      SPACE     TO   MSY01011   TABLE-AREA.
     INITIALIZE               TBL-XX.
     MOVE      ZERO      TO   WK-TAIHI.
...
*オンラインＦＬＧチェック
     ...
     AND  DEN-F274 NOT = ZERO
          ...
          GO   TO   CHK-DEN-EXIT
     END-IF.
*#2021/09/22 NAV ST オンライン分チェック追加
*#   修正でオンラインデータの場合、ＦＬＧ、ＯＮ
     IF   R00001   =  2
     AND  DEN-F461 NOT = ZERO
          MOVE     1        TO   WK-ONL-CHK-FLG
     ELSE
          MOVE     0        TO   WK-ONL-CHK-FLG
     END-IF.
*#2021/09/22 NAV ED オンライン分チェック追加
*相殺登録時のデータ表示
     IF       R00001  =  1
     AND      R00002  NOT  =  0
*             全レコード解放（排他制御用）
...
*                                     DEN-F03
*           INVALID   KEY
*       DISPLAY "CHK-2 INVALID =  "  DEN-REC UPON STAT
*                 MOVE      0         TO   END-FLG
*           NOT  INVALID   KEY
*                 MOVE      1         TO   END-FLG
*      END-START
...
*未計上区分チェック
     IF     ( MIKKBN  NOT  =   " " ) AND
            ( MIKKBN  NOT  =   "1" )
              MOVE      43        TO   ERR-FLG
              MOVE     "C"        TO   EDIT-CURSOR OF MIKKBN
              MOVE     "R"        TO   EDIT-OPTION OF MIKKBN
              GO   TO   CHK-2-EXIT
     END-IF.
     IF       MIKKBN       =    "1"
              MOVE     NC"未"     TO   MIKNM
...
*2013/04/04 NAV ED
         MOVE      R00016         TO   CHK-DATE
         PERFORM   900-DATE-CHECK
         MOVE      CHK-DATE       TO   SAV-NOU-DATE  WK-NOHINBI
         MOVE      CHK-DATE       TO   SAV-NOU-DATE2
*
         IF   ERR-FLG   =  0
              IF   ACOS-DATE  <=  WK-SYS-DATE
...
*
     ...
     WHEN     PF04
              MOVE      0         TO   GR-NO
*** 商品一覧サブ 2005/10/07 - 10/18
     WHEN     PF10
***@@         PERFORM  DSP-SAV-SET
              PERFORM  CSL-GET-SEC
              MOVE     2    TO   LINK-SB3-00
              CALL "FSB0301I"  USING  LINK-SB3
...
**
              IF  ( IL >  ZERO ) AND
                  ( R00001  =  1  OR  2 )  AND
                  ( LINK-SB3-04  NOT = SPACE )
                  MOVE  LINK-SB3-04       TO  R10301(IL)
                  MOVE  LINK-SB3-05       TO  R10401(IL)
                  MOVE  SPACE             TO  R11101(IL)
                  MOVE  SPACE             TO  R11201(IL)
              END-IF
     WHEN     PF06
              MOVE      4         TO   GR-NO
     WHEN     PF11
...
*--------------------------------------------------------------*
 DEN-UPDT-RTN          SECTION.
     EVALUATE   R00001
         WHEN  1
         WHEN  2
*明細変更（商品・数量）があった場合、フラグを立てる
              MOVE    0        TO   HEN-MEI-FLG
              PERFORM  VARYING   I FROM 1 BY 1 UNTIL I > 12
                IF TBL-R10301(I) = TBL-MAER10301(I)
                AND TBL-R10401(I) = TBL-MAER10401(I)
                AND TBL-R10501(I) = TBL-MAER10501(I)
                AND TBL-R11501(I) = TBL-MAER11501(I)
                AND TBL-R10601(I) = TBL-MAER10601(I)
                AND TBL-R10101(I) = SPACE
                  CONTINUE
                ELSE
                  MOVE    1        TO   HEN-MEI-FLG
                END-IF
*     DISPLAY "TBL-R10601(I)= " TBL-R10601(I) UPON CONS
*     DISPLAY "TBL-MAER10601(I)= " TBL-MAER10601(I) UPON CONS
*     DISPLAY "TBL-R10101(I)   = " TBL-R10101(I)    UPON CONS
*     DISPLAY "HEN-MEI-FLG     = " HEN-MEI-FLG      UPON CONS
              END-PERFORM
...
*******DISPLAY "TBL-R10101 = " TBL-R10101(I) UPON CONS
       IF   TBL-R10101(I)       =  "9"
         IF R00008     =        40 OR 41
...
*　明細行変更時、物流連携フラグをクリアする。
              IF HEN-MEI-FLG = 1
                 MOVE  SPACE  TO DEN-F68  DEN-F69
              END-IF
*　小売連携区分をセットする。
*TTTTTTTTTTTTTINITIALIZE     MEI-REC
*TT           MOVE  DEN-F1411 TO   MEI-F011
*TT           MOVE  DEN-F1412 TO   MEI-F012
*TT           PERFORM   900-MEI-READ
*TT           IF   INV-FLG  =  0
...
*TT2020/12/14 NAV ST T IF  SUB-F19  =  "1"
*TT                        MOVE  "2"      TO    DEN-F32
*TT                    ELSE
*TT                        IF  SUB-F19  =  "2"
*TT                            MOVE "3"   TO    DEN-F32
*TT                        ELSE
*TT                            MOVE SPACE TO    DEN-F32
*TT                        END-IF
*TT2020/12/14 NAV ED T END-IF
*2020/12/14 NAV ST
...
*2020/12/14 NAV ED
                   END-IF
*#2020/12/24 NAV ST 修正時対応 修正時、連携番号が空白以外
*                   もとに連携番号をセットする。小売連携区分も
*                   更新しない
                   IF  TBL-F33(I)  NOT =  SPACE
                       MOVE    TBL-F32(I) TO    DEN-F32
                       MOVE    TBL-F33(I) TO    DEN-F33
                   END-IF
*#2020/12/24 NAV ED
              END-IF
*            ↑2020/05/07
*#2021/09/16 NAV ST 伝区＝４２の時はＯＲＤセット区分はセット×
              IF   DEN-F051  =  42
                   MOVE         SPACE     TO    DEN-F32
*******************MOVE         SPACE     TO    DEN-F33
              END-IF
*#2021/09/16 NAV ED 伝区＝４２の時はＯＲＤセット区分はセット×
              WRITE     DEN-REC
            END-IF
       END-IF
     END-PERFORM.
 ...
 900-DEN-DELETE         SECTION.
     ...
     PERFORM  UNTIL  END-FLG  =  1
              IF  R00001      =  3
                  ...
                  END-IF
              END-IF
**************#2018/03/30 NAV ST 受注残ファイル更新（４０のみ）
              IF     R00008  =    40
                  MOVE    "3"            TO    PARA-KOSINKBN
...
*--------------------------------------------------------------*
 900-DSP-TO-DEN         SECTION.
     PERFORM  900-DSP-TO-DEN-2.
*****DISPLAY "TBL-SHOCD (I) = " TBL-SHOCD(I) UPON CONS.
...
*2006/11/24 サンワドー対応
     MOVE     TBL-F27E   (I) TO   DEN-F27E.
*#2020/12/24 NAV ST
     MOVE     TBL-D93    (I) TO   DEN-D93.
     MOVE     TBL-D94    (I) TO   DEN-D94.
     MOVE     TBL-D95    (I) TO   DEN-D95.
     MOVE     TBL-D96    (I) TO   DEN-D96.
     MOVE     TBL-D97    (I) TO   DEN-D97.
     MOVE     TBL-D98    (I) TO   DEN-D98.
*****MOVE     TBL-D99    (I) TO   DEN-D99.
*#2020/12/24 NAV ED
*#2021/09/16 NAV ST
     IF  TBL-F461(I)  NOT NUMERIC
         MOVE  ZERO          TO   DEN-F461
     ELSE
         MOVE  TBL-F461  (I) TO   DEN-F461
     END-IF.
     IF  TBL-F462(I)  NOT NUMERIC
         MOVE  ZERO          TO   DEN-F462
     ELSE
         MOVE  TBL-F462  (I) TO   DEN-F462
     END-IF.
     IF  TBL-F463(I)  NOT NUMERIC
         MOVE  ZERO          TO   DEN-F463
     ELSE
         MOVE  TBL-F463  (I) TO   DEN-F463
     END-IF.
     IF  TBL-F471(I)  NOT NUMERIC
         MOVE  ZERO          TO   DEN-F471
     ELSE
         MOVE  TBL-F471  (I) TO   DEN-F471
     END-IF.
     IF  TBL-F472(I)  NOT NUMERIC
         MOVE  ZERO          TO   DEN-F472
     ELSE
         MOVE  TBL-F472  (I) TO   DEN-F472
     END-IF.
     MOVE     TBL-F48    (I) TO   DEN-F48.
     IF  DEN-F461  NOT =  ZERO
         MOVE     TBL-F272   (I) TO   DEN-F272
         MOVE     TBL-F274   (I) TO   DEN-F274
         MOVE     TBL-F275   (I) TO   DEN-F275
         MOVE     TBL-F276   (I) TO   DEN-F276
         MOVE     TBL-F278   (I) TO   DEN-F278
         MOVE     TBL-F28    (I) TO   DEN-F28
         MOVE     TBL-F30    (I) TO   DEN-F30
         MOVE     TBL-XI0004 (I) TO   DEN-XI0004
         MOVE     TBL-F42    (I) TO   DEN-F42
     END-IF.
*#2021/09/16 NAV ED
*在庫更新したなら引落フラグに１
     IF       ZAI-FLG        =    1
...
**************END-IF
*#2018/04/12 NAV ST 登録時と同じものを更新する。
*        登録時、訂正前項目セット
         MOVE      TBL-R10601(I)      TO   DEN-F50
         IF   TBL-R10701 (I) =    "3"
              MOVE     TBL-R10801 (I) TO   DEN-F521
...
*****#2018/03/30 NAV ST 受注残ファイル更新（４０のみ）
     IF  DEN-F051  =  40
         ...
         MOVE    TBL-TANABN(I)  TO    WK-TANABAN
         PERFORM JYUZANF-UPD-SEC
     END-IF.
*****#2018/03/30 NAV ED
*
...
*2013/12/03 NAV ST 店舗ＣＤの更新方法を変更
*****IF       SAV-HTENCD   =    ZERO
*****    MOVE R00010         TO   DEN-F07
*****ELSE
*****    MOVE SAV-HTENCD     TO   DEN-F07
*****END-IF.
*****画面項目より店舗ＣＤ又は変更店舗ＣＤをセットする（変更）
     IF       R00030  =  ZERO
     OR       R00030  NOT  NUMERIC
         MOVE R00010         TO   DEN-F07
     ELSE
         MOVE R00030         TO   DEN-F07
     END-IF.
*2013/12/03 NAV ED 店舗ＣＤの更新方法を変更
...
*    注文日
     ...
     END-IF.
*    MOVE     SAV-HNOU-DATE       TO   SAV-HNOU-DATE2.
     MOVE     SAV-HNOU-DATE2      TO   DEN-F112.
*2013/04/04 NAV ST　更新日納品日が０の場合は、画面の納品日を更新
     IF   DEN-F112  =  ZERO
          MOVE     "3"        TO        LINK-IN-KBN
...
*****DISPLAY "D365DN = " D365DN " - " DEN-D99 UPON CONS.
*# D365 2020/04/20 NAV ED
*****DISPLAY "TAN-F06 = " TAN-F06  UPON CONS.
     EVALUATE  R00001
        WHEN    "1"
...
*    売上伝票以外は処理対象外
     IF      R00008    NOT =      40
             GO  TO               ZAI-YOTEI-EXT
     END-IF.
     IF      TBL-F27C(I)  NOT  NUMERIC
             MOVE   ZERO  TO   TBL-F27C(I)
     END-IF.
*    在庫引落しされているデータは対象外
     IF      R00001    NOT =      1
        IF   TBL-F27C(I)   =      1
...
*
     ...
     IF       DEN-F25  =  SPACE
              ...
              MOVE      DEN-F1411      TO TBL-MAER10301 (DEN-F03)
              MOVE      DEN-F1412(1:5) TO TBL-MAER10401 (DEN-F03)
              MOVE      DEN-F1412(6:2) TO TBL-MAER10501 (DEN-F03)
              MOVE      DEN-F1412(8:1) TO TBL-MAER11501 (DEN-F03)
     ...
     ELSE
              ...
              MOVE      DEN-F25 (1:8)  TO TBL-MAER10301 (DEN-F03)
              MOVE      DEN-F25 (9:5)  TO TBL-MAER10401 (DEN-F03)
              MOVE      SPACE          TO TBL-MAER10501 (DEN-F03)
              MOVE      SPACE          TO TBL-MAER11501 (DEN-F03)
...
*
     ...
     MOVE     DEN-F32        TO   TBL-F32(DEN-F03).
*#2020/12/24 NAV ST
     MOVE     DEN-F33        TO   TBL-F33(DEN-F03).
     MOVE     DEN-D93        TO   TBL-D93(DEN-F03).
     MOVE     DEN-D94        TO   TBL-D94(DEN-F03).
     MOVE     DEN-D95        TO   TBL-D95(DEN-F03).
     MOVE     DEN-D96        TO   TBL-D96(DEN-F03).
     MOVE     DEN-D97        TO   TBL-D97(DEN-F03).
     MOVE     DEN-D98        TO   TBL-D98(DEN-F03).
*****MOVE     DEN-D99        TO   TBL-D99(DEN-F03).
*#2020/12/24 NAV ED
*#2021/09/16 NAV ST
     MOVE     DEN-F461       TO   TBL-F461(DEN-F03).
     MOVE     DEN-F462       TO   TBL-F462(DEN-F03).
     MOVE     DEN-F463       TO   TBL-F463(DEN-F03).
     MOVE     DEN-F471       TO   TBL-F471(DEN-F03).
     MOVE     DEN-F472       TO   TBL-F472(DEN-F03).
     MOVE     DEN-F48        TO   TBL-F48(DEN-F03).
     MOVE     DEN-F272       TO   TBL-F272(DEN-F03).
     MOVE     DEN-F274       TO   TBL-F274(DEN-F03).
     MOVE     DEN-F275       TO   TBL-F275(DEN-F03).
     MOVE     DEN-F276       TO   TBL-F276(DEN-F03).
     MOVE     DEN-F278       TO   TBL-F278(DEN-F03).
     MOVE     DEN-F28        TO   TBL-F28(DEN-F03).
     MOVE     DEN-F30        TO   TBL-F30(DEN-F03).
     IF  DEN-F461  NOT =  ZERO
         MOVE DEN-XI0004     TO   TBL-XI0004(DEN-F03)
     END-IF.
     MOVE     DEN-F42        TO   TBL-F42(DEN-F03).
*#2021/09/16 NAV ED
*更新前在庫ＫＥＹ退避
     MOVE     DEN-F113       TO   TBL-SYUKKA (DEN-F03).
     MOVE     DEN-F08        TO   TBL-WSOKCD (DEN-F03).
     MOVE     DEN-F15        TO   TBL-WSURYO (DEN-F03).
     MOVE     DEN-F15        TO   TBL-MAER10601 (DEN-F03).
...
*2006/11/24　サンワドー対応
     MOVE     DEN-F27E       TO   TBL-F27E(DEN-F03).
*
*次頁存在チェック
     IF       DEN-F03  >  6
              MOVE     1     TO  GPAGE-FLG
...
*--------------------------------------------------------------*
 DSP-RD-RTN           SECTION.
*
     MOVE    "TSY0103I"      TO        PGID.
     MOVE    "MSY01011"      TO        FORM.
     ...
     END-IF.
*#2021/09/16 NAV ST オンラインＭＳＧセット
     IF  WK-ONL-CHK-FLG  =  0
         MOVE  SPACE              TO   WNGMSG
     ELSE
         MOVE  MSGWNG-02          TO   WNGMSG
     END-IF.
****************************
     MOVE     "ALLF"         TO   DSP-GRP.
...
*--------------------------------------------------------------*
 ...
 CLR-TAIL-EXIT.
     EXIT.
*--------------------------------------------------------------*
*    LEVEL  4      画面　から　ワークエリアへ　　　　　　　　　*
*--------------------------------------------------------------*
 DSP-SAV-SET           SECTION.
*** ＨＥＡＤ部
     MOVE   R00001      TO  SAV-R00001.
     MOVE   R00002      TO  SAV-R00002.
     MOVE   R00003      TO  SAV-R00003.
     MOVE   R00004      TO  SAV-R00004.
*2013/12/12↓ 計上税区分
     MOVE   ZEIKB       TO  SAV-ZEIKB.
*2013/12/12↑
     MOVE   R00005      TO  SAV-R00005.
     MOVE   R00007      TO  SAV-R00007.
     MOVE   R00008      TO  SAV-R00008.
     MOVE   R00010      TO  SAV-R00010.
     MOVE   R00012      TO  SAV-R00012.
     MOVE   R00013      TO  SAV-R00013.
     MOVE   R00014      TO  SAV-R00014.
     MOVE   R00015      TO  SAV-R00015.
     MOVE   R00016      TO  SAV-R00016.
     MOVE   R00021      TO  SAV-R00021.
     MOVE   R00017      TO  SAV-R00017.
     MOVE   R00018      TO  SAV-R00018.
     MOVE   R00019      TO  SAV-R00019.
     MOVE   R00020      TO  SAV-R00020.
*2021/05/13↓
     MOVE   MIKKBN      TO  SAV-MIKKBN.
     MOVE   MIKNM       TO  SAV-MIKNM.
*2021/05/13↑
     MOVE   R00029      TO  SAV-R00029.
     MOVE   R00030      TO  SAV-R00030.
*
     MOVE   R00006      TO  SAV-R00006.
     MOVE   R00009      TO  SAV-R00009.
     MOVE   R00011      TO  SAV-R00011.
     MOVE   R00031      TO  SAV-R00031.
*** ボディ部
     PERFORM  VARYING  I  FROM  1  BY  1  UNTIL  I  >  6
            MOVE   R10101(I)    TO  SAV-R10101(I)
            MOVE   R10201(I)    TO  SAV-R10201(I)
            MOVE   R10301(I)    TO  SAV-R10301(I)
            MOVE   R10401(I)    TO  SAV-R10401(I)
            MOVE   R10501(I)    TO  SAV-R10501(I)
            MOVE   R11501(I)    TO  SAV-R11501(I)
            MOVE   R10601(I)    TO  SAV-R10601(I)
            MOVE   R10701(I)    TO  SAV-R10701(I)
            MOVE   R10801(I)    TO  SAV-R10801(I)
            MOVE   R10901(I)    TO  SAV-R10901(I)
            MOVE   R11001(I)    TO  SAV-R11001(I)
            MOVE   R11101(I)    TO  SAV-R11101(I)
            MOVE   R11201(I)    TO  SAV-R11201(I)
            MOVE   R11301(I)    TO  SAV-R11301(I)
            MOVE   R11401(I)    TO  SAV-R11401(I)
     END-PERFORM.
*
*** テイル部
     MOVE   R00023      TO  SAV-R00023.
     MOVE   R00024      TO  SAV-R00024.
     MOVE   R00025      TO  SAV-R00025.
     MOVE   R00028      TO  SAV-R00028.
     MOVE   KKNN        TO  SAV-KKNN.
 DSP-SAV-SET-EXIT.
     EXIT.
*--------------------------------------------------------------*
*    LEVEL  4      ワークエリアから　画面へ  　　　　　　　　
*--------------------------------------------------------------*
 DSP-SAV-RESET          SECTION.
*** ＨＥＡＤ部
 DSP-SAV-GHEAD1.
     MOVE   SAV-R00001  TO  R00001.
     MOVE   SAV-R00002  TO  R00002.
     MOVE   SAV-R00005  TO  R00005.
     MOVE   SAV-R00006  TO  R00006.
     MOVE   SAV-R00007  TO  R00007.
     MOVE   SAV-R00008  TO  R00008.
     MOVE   SAV-R00009  TO  R00009.
     MOVE   SAV-R00015  TO  R00015.
*     MOVE   SAV-R00016  TO  R00016.
     PERFORM  VARYING  I  FROM  1  BY  1  UNTIL  I  >  6
            IF  SAV-R10201(I)  NOT = ZERO
                MOVE   SAV-R10201(I)    TO  R10201(I)
            END-IF
     END-PERFORM.
     IF  WK-GRP  =  "GHEAD1"
            GO  TO      DSP-SAV-RESET-EXIT
     END-IF.
 DSP-SAV-GHEAD2.
     MOVE   SAV-R00003  TO  R00003.
     MOVE   SAV-R00004  TO  R00004.
*2013/12/12↓ 計上税区分
     MOVE   SAV-ZEIKB   TO  ZEIKB.
*2013/12/12↑
*    MOVE   SAV-R00010  TO  R00010.
     MOVE   SAV-R00011  TO  R00011.
     MOVE   SAV-R00012  TO  R00012.
     MOVE   SAV-R00013  TO  R00013.
     MOVE   SAV-R00014  TO  R00014.
     MOVE   SAV-R00017  TO  R00017.
     MOVE   SAV-R00018  TO  R00018.
     MOVE   SAV-R00019  TO  R00019.
     MOVE   SAV-R00020  TO  R00020.
*2021/05/13↓
     MOVE   SAV-MIKKBN  TO  MIKKBN.
     MOVE   SAV-MIKNM   TO  MIKNM.
*2021/05/13↑
     MOVE   SAV-R00021  TO  R00021.
     MOVE   SAV-R00029  TO  R00029.
     MOVE   SAV-R00030  TO  R00030.
     MOVE   SAV-R00031  TO  R00031.
*
     IF  WK-GRP  =  "GHEAD2"
            GO  TO      DSP-SAV-RESET-EXIT
     END-IF.
...
*** ボディ部
 DSP-SAV-GBODY1.
     PERFORM  VARYING  I  FROM  1  BY  1  UNTIL  I  >  6
            MOVE   SAV-R10101(I)    TO  R10101(I)
            MOVE   SAV-R10201(I)    TO  R10201(I)
            MOVE   SAV-R10301(I)    TO  R10301(I)
            MOVE   SAV-R10401(I)    TO  R10401(I)
            MOVE   SAV-R10501(I)    TO  R10501(I)
            MOVE   SAV-R11501(I)    TO  R11501(I)
            MOVE   SAV-R10601(I)    TO  R10601(I)
            MOVE   SAV-R10701(I)    TO  R10701(I)
            MOVE   SAV-R10801(I)    TO  R10801(I)
            MOVE   SAV-R10901(I)    TO  R10901(I)
            MOVE   SAV-R11001(I)    TO  R11001(I)
            MOVE   SAV-R11101(I)    TO  R11101(I)
            MOVE   SAV-R11201(I)    TO  R11201(I)
            MOVE   SAV-R11301(I)    TO  R11301(I)
            MOVE   SAV-R11401(I)    TO  R11401(I)
     END-PERFORM.
*
     IF  WK-GRP  =  "GBODY1"
            GO  TO      DSP-SAV-RESET-EXIT
     END-IF.
*** テイル部
     MOVE   SAV-R00023  TO  R00023.
     MOVE   SAV-R00024  TO  R00024.
     MOVE   SAV-R00025  TO  R00025.
     MOVE   SAV-R00028  TO  R00028.
     MOVE   SAV-KKNN    TO  KKNN.
 DSP-SAV-RESET-EXIT.
     EXIT.
*--------------------------------------------------------------*
*    LEVEL  5     カーソル位置取得　　　　　　　　　　　　　　 *
*--------------------------------------------------------------*
 CSL-GET-SEC            SECTION.
     CALL    "XSBRDCSR"     USING  DSPFILE  CSL-TY.
* カーソル行位置
     EVALUATE  CSL-T
         WHEN  10  THRU  11
             MOVE  1        TO   IL
     ...
     END-EVALUATE.
*
     MOVE  R00005        TO   LINK-SB3-01.
     MOVE  R10301(IL)    TO   LINK-SB3-04.
     MOVE  R10401(IL)    TO   LINK-SB3-05.
     MOVE  SPACE         TO   LINK-SB3-02.
     MOVE  SPACE         TO   LINK-SB3-03.
*
 CSL-GET-EXIT.
     EXIT.
*--------------------------------------------------------------*
...
* カーソル行位置
     ...
     END-EVALUATE.
*
     CALL    "XSBSTCSR"     USING  DSPFILE  CSL-TY.
*
 CSL-PUT-EXIT.
     EXIT.
*#############################################################*
...
*****手書伝票入力の場合は、受注数、出荷数とも画面の数量を更新
     ...
     MOVE      LNK-M-BUMON             TO   PARA-UPBUMON
                                            PARA-BUMON.
     MOVE      LNK-M-TAN               TO   PARA-UPTANCD
                                            PARA-TANCD.
