...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY3845B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY3845B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY3845B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*対象データチェック
     ...
     AND   THK-F02  =   KAK-F02
     AND   THK-F03  =   KAK-F03
     AND   THK-F121 =   KAK-F110
     AND   THK-F122 =   KAK-F111
     AND   THK-F123 =   KAK-F112
     AND   THK-F124 =   KAK-F113
     AND   THK-F12B =   KAK-F11H
     AND   THK-F126 =   KAK-F115
     AND   THK-F127 =   KAK-F116
     AND   THK-F128 =   KAK-F119
           CONTINUE
     ELSE
           MOVE  "END"          TO        SUTE-FLG
           GO                   TO        TRKAKUF-READ-EXIT
...
*2015/10/20 NAV ST 伝票番号の取得方法を変更
*********MOVE  KAK-F11A     TO        STE-F09
         MOVE  KAK-F12      TO        STE-F09
*2015/10/20 NAV ED 伝票番号の取得方法を変更
