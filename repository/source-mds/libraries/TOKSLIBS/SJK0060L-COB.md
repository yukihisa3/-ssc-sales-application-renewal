...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SJK0060L.COB`
...
*****03  FILLER                  PIC  X(01)  VALUE  SPACE.
     ...
     03  FILLER                  PIC  X(02)  VALUE  SPACE.
     03  DT2-05                  PIC  --,---,--9.99.
     03  DT2-051                 PIC  X(01)  VALUE  SPACE.
...
****************************************************************
 PROCESS-SEC             SECTION.
     ...
     DISPLAY  "***   SJK0060L   START    ***"  UPON CONS.
*
*ワーク初期化
     MOVE      ZERO     TO    P-CNT.
     MOVE      ZERO     TO    L-CNT.
