...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH4601B.COB`
...
*ヘッドレコード退避ワーク
 01  WK-DEPB-REC.
     ...
     03  WK-DEPB11          PIC  X(10).
     03  WK-DEPB12          PIC  X(30).
     03  WK-DEPB13          PIC  X(12).
     03  WK-DEPB14          PIC  9(07).
     03  WK-DEPB15          PIC  X.
     03  WK-DEPB16          PIC  X.
     03  WK-DEPB17          PIC  X.
     03  WK-DEPB18          PIC  X.
...
*    明細レコード退避ワーク
 01  WK-DEPD-REC.
     ...
     03  WK-DEPD051         PIC  9(04).
     03  WK-DEPD052         PIC  9(04).
     03  WK-DEPD053         PIC  X(02).
     03  WK-DEPD054         PIC  9(05)V9.
     03  WK-DEPD06          PIC  9(07)V9(02).
     03  WK-DEPD07          PIC  9(07).
     03  WK-DEPD08          PIC  X(13).
     03  WK-DEPD09          PIC  X(20).
     03  WK-DEPD10          PIC  X(20).
     03  WK-DEPD11          PIC  X(06).
     03  WK-DEPD12          PIC  X(05).
     03  WK-DEPD13          PIC  X.
     03  FILLER             PIC  X(13).
*
 01  WK-AREA.
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH4601B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH4601B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    入数
     MOVE     WK-DEPD051    TO        HEN-A241.
*    発注単位数
     MOVE     WK-DEPD052    TO        HEN-A242.
*    単位
     MOVE     WK-DEPD053    TO        HEN-A243.
*    数量
     MOVE     WK-DEPD054    TO        HEN-A244.
*    原単価
...
*    商品名称マスタ検索
     ...
     READ    MEIMS1
       INVALID
*        商品名
         MOVE    HEN-A28(1:15)  TO   HEN-F1421
         MOVE    HEN-A28(16:5)  TO   HEN-F1422
       NOT INVALID
         MOVE    HEN-A28(1:15)  TO   HEN-F1421
         MOVE    HEN-A28(16:5)  TO   HEN-F1422
     END-READ.
*数量
     MOVE        HEN-A244  TO        HEN-F15.
*単
     MOVE       "1"        TO        HEN-F16.
*原価単価
...
*原価金額
     COMPUTE     HEN-F181 ROUNDED = HEN-A244 * HEN-A25.
*売価金額
     COMPUTE     HEN-F182 ROUNDED = HEN-A244 * HEN-A26.
*店舗名（備考）
...
****          MOVE   "99"     TO     RUT-F03
**** ELSE
****          MOVE   HEN-A    TO     HEN-RUT-2
****          MOVE   HEN-RUT  TO     RUT-F03
**** END-IF.
     READ     JHMRUTL1
         INVALID
           MOVE  1         TO        INV-RUT
...
*訂正前数量
     MOVE        HEN-A244  TO        HEN-F50.
*修正原価単価
     MOVE        HEN-A25   TO        HEN-F512.
*修正売価単価
     MOVE        HEN-A26   TO        HEN-F513.
*修正原価金額
     COMPUTE     HEN-F521 ROUNDED = HEN-A244 * HEN-A25.
*修正売価金額
     COMPUTE     HEN-F522 ROUNDED = HEN-A244 * HEN-A26.
*
 TENSO-EXIT.
     EXIT.
****************************************************************
