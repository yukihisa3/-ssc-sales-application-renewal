...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH1410B.COB`
...
*                            変換伝票データファイルを作成する　*
*                            ドイト用                          *
*2003/12/12 ｲﾝﾀｰﾈｯﾄEDIの変更によりレイアウト変更対応           *
*2010/02/23 ｲﾝｽﾄｱCD=>JANCDへの変更対応                         *
*2013/03/25 ドンキホーテに合併するため、発注レイアウト変更　   *
*2013/04/23 納品日＝０の為、限度日付を納品日にセットに変更　   *
*2013/06/27 振分倉庫特定条件変更（ルート←分類）　　　　　　   *
****************************************************************
...
*    ｶｳﾝﾄ
 ...
 01  IDX1                    PIC  9(02)     VALUE  ZERO.
 01  IDX2                    PIC  9(02)     VALUE  ZERO.
...
*ファイルヘッダー
 01  WK-DENA.
     03  WK-DENA01           PIC  X(01).
     03  WK-DENA02           PIC  9(02).
     03  WK-DENA03           PIC  9(06).
     03  WK-DENA04           PIC  9(06).
     03  WK-DENA05           PIC  9(06).
     03  WK-DENA06           PIC  X(08).
     03  WK-DENA07           PIC  X(08).
     03  WK-DENA08           PIC  X(08).
     03  WK-DENA09           PIC  X(03).
     03  WK-DENA10           PIC  X(06).
     03  WK-DENA11           PIC  X(05).
     03  WK-DENA12           PIC  X(13).
     03  WK-DENA13           PIC  X(13).
     03  WK-DENA14           PIC  X(10).
     03  WK-DENA15           PIC  X(15).
     03  WK-DENA16           PIC  X(15).
     03  WK-DENA17           PIC  X(03).
*伝票ヘッダー
 01  WK-DENB.
     03  WK-DENB01           PIC  X(01).
     03  WK-DENB02           PIC  9(02).
     03  WK-DENB03           PIC  9(09).
     03  WK-DENB04           PIC  9(04).
     03  WK-DENB05           PIC  9(05).
     03  WK-DENB06           PIC  9(04).
     03  WK-DENB07           PIC  9(02).
     03  WK-DENB08           PIC  9(06).
     03  WK-DENB09           PIC  9(06).
     03  WK-DENB10           PIC  9(06).
     03  WK-DENB11           PIC  9(02).
     03  WK-DENB12           PIC  9(06).
     03  WK-DENB13           PIC  X(16).
     03  WK-DENB14           PIC  X(16).
     03  WK-DENB15           PIC  9(03).
     03  WK-DENB16           PIC  9(01).
     03  WK-DENB17           PIC  9(01).
     03  WK-DENB18           PIC  X(20).
     03  WK-DENB19           PIC  9(08).
     03  WK-DENB20           PIC  X(10).
*伝票明細
 01  WK-DENC.
     03  WK-DENC01           PIC  X(01).
     03  WK-DENC02           PIC  9(02).
     03  WK-DENC03           PIC  9(02).
     03  WK-DENC04           PIC  9(13).
     03  WK-DENC05           PIC  9(04).
     03  WK-DENC06           PIC  9(04).
     03  WK-DENC07           PIC  X(02).
     03  WK-DENC08           PIC  9(05)V9(01).
     03  WK-DENC09           PIC  9(07)V9(02).
     03  WK-DENC10           PIC  9(07).
     03  WK-DENC11           PIC  9(10).
     03  WK-DENC12           PIC  9(10).
     03  WK-DENC13           PIC  9(13).
     03  WK-DENC14           PIC  X(08).
     03  WK-DENC15           PIC  X(16).
     03  WK-DENC16           PIC  X(08).
     03  WK-DENC17           PIC  9(01).
     03  WK-DENC18           PIC  9(01).
     03  WK-DENC19           PIC  9(07).
     03  WK-DENC20           PIC  X(04).
*
*
 01  WK-AREA.
*システム日付の編集
...
*店舗ＣＤ変換
 01  WK-TEN-CD             PIC  X(02).
 01  WK-TEN-CD-R           REDEFINES   WK-TEN-CD.
     03  WK-TEN-HEN        PIC  9(02).
*
 01  MSG-AREA.
     03  MSG-START.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  ST-PG          PIC   X(08)  VALUE "NJH1410B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH1410B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*ファイルヘッダー退避
     IF       DEN-01A  =  "A"
              MOVE  DEN-REC      TO   WK-DENA
     END-IF.
*伝票ヘッダー
     IF       DEN-01A  =  "B"
              MOVE  DEN-REC      TO   WK-DENB
*             出荷場所件数マスタ出力
              IF   CNT-MAISU     >    ZERO
...
*各量販店領域転送
*    伝票ヘッダー転送
     MOVE     WK-DENA       TO        HEN-A00.
*    伝票明細転送
     MOVE     WK-DENB       TO        HEN-B00.
*    伝票合計転送
     MOVE     WK-DENC       TO        HEN-C00.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
...
*取引先コード
     MOVE        HEN-B10   TO        HEN-F01.
*伝票ナンバー
     MOVE        HEN-B03   TO        HEN-F02.
     MOVE        HEN-F02   TO        HEN-F23.
*行_
     MOVE        HEN-C03   TO        HEN-F03.
*取区
     MOVE        40        TO        HEN-F051.
...
*担当者コード
     MOVE        99        TO        HEN-F06.
*店コード
     MOVE        HEN-B05   TO        HEN-F07.
*  商品変換テーブル検索
     MOVE        SPACE     TO        TBL-REC.
     INITIALIZE                      TBL-REC.
     MOVE        HEN-B10   TO        TBL-F01.
     MOVE        HEN-C04   TO        TBL-F02.
     READ    SHOTBL1
       INVALID
         MOVE    SPACE     TO        TBL-REC
         INITIALIZE                  TBL-REC
...
*分類（部門）
     MOVE        HEN-B06   TO        HEN-F12.
*商品区分　　
*****MOVE        HEN-A13   TO        HEN-F131.
*伝票区分　　
     MOVE        HEN-B07   TO        HEN-F132.
*伝発区分
     MOVE        9         TO        HEN-F134.
*自社商品コード
...
*    商品名称マスタ検索
     ...
     READ    MEIMS1
       INVALID
*        商品名
         MOVE    HEN-C15(1:15)  TO   HEN-F1421
         MOVE    HEN-C15(16:1)  TO   HEN-F1422(1:1)
         MOVE    HEN-C16        TO   HEN-F1422(2:8)
       NOT INVALID
         MOVE    HEN-C15(1:15)  TO   HEN-F1421
         MOVE    HEN-C15(16:1)  TO   HEN-F1422(1:1)
         MOVE    HEN-C16        TO   HEN-F1422(2:8)
     END-READ.
*数量
     MOVE        HEN-C08   TO        HEN-F15.
*単
     MOVE       "1"        TO        HEN-F16.
*原価単価
     MOVE        HEN-C09   TO        HEN-F172.
*売価単価
     MOVE        HEN-C10   TO        HEN-F173.
*原価金額
     MOVE        HEN-C11   TO        HEN-F181.
*売価金額
     MOVE        HEN-C12   TO        HEN-F182.
*自社得意先コード
     IF  FLG-TOK   =    ZERO
*    得意先マスタ検索
         MOVE    SPACE         TO    TOK-REC
         INITIALIZE                  TOK-REC
         MOVE    HEN-B10       TO    TOK-F01
         READ    TOKMS2
             INVALID
               MOVE  SPACE     TO    TOK-REC
               INITIALIZE            TOK-REC
...
*振分倉庫コード
*    ルート条件マスタ検索
*2013/03/25 ドイトはすべて富岡ＨＣ振分
     MOVE     ZERO         TO        INV-RUT.
     MOVE     HEN-B10      TO        RUT-F01.
     MOVE     SPACE        TO        RUT-F02.
*↓13/06/27 振分倉庫特定条件変更（ルート←分類）
*****MOVE     SPACE        TO        RUT-F03  HEN-F42.
     MOVE     HEN-F12      TO        RUT-F03  HEN-F42.
*↑13/06/27
     READ     JHMRUTL1
         INVALID
           MOVE  1         TO        INV-RUT
