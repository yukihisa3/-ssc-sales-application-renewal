...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH3001B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH3001B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH3001B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    伝票_
     MOVE     WK-DD03       TO        HEN-A02.
*    行_
     MOVE     WK-DD04       TO        HEN-A03.
*    伝票区分
     MOVE     WK-DH06       TO        HEN-A04.
*    大分類コード
     MOVE     WK-DH05       TO        HEN-A05.
*    中分類コード
     MOVE     WK-DH14       TO        HEN-A06.
*    発注企業名称
     MOVE     WK-DH10       TO        HEN-A07.
*    発注店舗名称
     MOVE     WK-DH11       TO        HEN-A08.
*    取引先名称
     MOVE     WK-DH12       TO        HEN-A09.
*    発注日
     MOVE     WK-DH08       TO        HEN-A10.
*    納品日
     MOVE     WK-DH09       TO        HEN-A11.
*    ルート
     MOVE     WK-DH15       TO        HEN-A12.
*    商品コード
     MOVE     WK-DD05       TO        HEN-A13.
*    商品名称
     MOVE     WK-DD07       TO        HEN-A14.
*    メーカーブランド
     MOVE     WK-DD06       TO        HEN-A15.
*    規格数値
     MOVE     WK-DD08       TO        HEN-A16.
*    規格単位
     MOVE     WK-DD09       TO        HEN-A17.
*    クラスコード
     MOVE     WK-DD10       TO        HEN-A18.
*    サイズ
     MOVE     WK-DD11       TO        HEN-A19.
*    ケース入数
     MOVE     WK-DD12       TO        HEN-A20.
*    ケース数量
     MOVE     WK-DD13       TO        HEN-A21.
*    発注単位
     MOVE     WK-DD14       TO        HEN-A22.
*    バラ数量
     MOVE     WK-DD15       TO        HEN-A23.
*    原価単価
     MOVE     WK-DD16       TO        HEN-A24.
*    原価金額
     COMPUTE  HEN-A26  =  WK-DD15   *   WK-DD16.
*    売価単価
     MOVE     WK-DD17       TO        HEN-A25.
*    売価金額
     COMPUTE  HEN-A27  =  WK-DD15   *   WK-DD17.
*    店舗コード
     MOVE     WK-DH04       TO        HEN-A28.
*    Ｅ欄
     MOVE     WK-DH13       TO        HEN-A30.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
