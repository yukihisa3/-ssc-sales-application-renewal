...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SBM9050B.COB`
...
*
 01  SIH-BR-KEY2.
     03  SIH-BR-KEY21         PIC  X(08).
     03  SIH-BR-KEY22         PIC  X(04).
     03  SIH-BR-KEY23         PIC  X(08).
 01  WK-BR-KEY2.
...
****************************************************************
 INIT-SEC              SECTION.
*
     DISPLAY  "***  START SBM9050B  ***"   UPON  CONS.
...
* 定型
 INSTART-100.
     MOVE       ZERO              TO   SIH-F011.
     GO  TO    INSTART-300.
* 非定型
 INSTART-200.
     IF  PARA-SHURUI  =  "1"
*
         MOVE     PARA-JYUSINHI       TO   SIH-F011
         MOVE     PARA-JYUSINTIME     TO   SIH-F012
         MOVE     PARA-TOKCD          TO   SIH-F013
         MOVE     PARA-JYUSINHI       TO   WK-BR-KEY21
         MOVE     PARA-JYUSINTIME     TO   WK-BR-KEY22
         MOVE     PARA-TOKCD          TO   WK-BR-KEY23
     ELSE
         MOVE     PARA-SOUJYUSIN      TO   SIH-F011
     END-IF.
*
*
 INSTART-300.
     START  BMSSIHF  KEY  IS  >=
                                   SIH-F011  SIH-F012
                                   SIH-F013
*
            INVALID
...
**
     GO  TO   MAIN-900.
 MAIN-210.
     IF  SIH-BR-KEY2  =  WK-BR-KEY2
         PERFORM SAKUJYO-SEC
         GO  TO  MAIN-900
     END-IF.
     IF  SIH-BR-KEY2  NOT =  WK-BR-KEY2
         MOVE  "1"    TO   END-FLG
     GO  TO   MAIN-EXIT
     END-IF.
 MAIN-220.
     IF  SIH-F011     =  PARA-SOUJYUSIN
         ...
         GO  TO    MAIN-900
     END-IF.
     IF  SIH-F011   NOT =  PARA-SOUJYUSIN
         MOVE  "1"     TO   END-FLG
         GO  TO    MAIN-EXIT
     END-IF.
*
...
*ファイルのCLOSE処理
     CLOSE     BMSSIHF.
     DISPLAY  "***  END   SBM9050B  ***"   UPON  CONS.
*
 END-EXIT.
     EXIT.
*
...
*
     IF   PARA-TEIKEI  =  "2"
         MOVE     SIH-F011    TO   SIH-BR-KEY21
         MOVE     SIH-F012    TO   SIH-BR-KEY22
         MOVE     SIH-F013    TO   SIH-BR-KEY23
     END-IF.
*
     ADD      1           TO   READ-CNT.
*
