...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SKY1602B.COB`
...
******************************************************************
 ...
 01  LKOUT-BUMON             PIC  9(04).
*
****************************************************************
*             PROCEDURE           DIVISION                     *
****************************************************************
 PROCEDURE    DIVISION     USING  LKIN-WKSNAME  LKOUT-BUMON.
 DECLARATIVES.
 JYO-ERR                   SECTION.
...
*
     ...
     READ        HJYOKEN
       INVALID
         MOVE    2920             TO   LKOUT-BUMON
       NOT INVALID
         MOVE    JYO-F05          TO   LKOUT-BUMON
     END-READ.
     DISPLAY "BUMON   = " LKOUT-BUMON   UPON CONS.
*ファイルＣＬＯＳＥ
     CLOSE       HJYOKEN.
     STOP        RUN.
*
