...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY5750I.COB`
...
***           売上ファイル存在チェック
              READ     SHTDENF  NEXT  AT  END
                       ...
                       GO         TO   PARA-CHK-EXIT
              END-READ
              IF  DSP-BTDATE  =  DEN-F46
              AND DSP-BTTIME  =  DEN-F47
              AND DSP-BTTORI  =  DEN-F01
                  CONTINUE
              ELSE
                  MOVE  9    TO   ERR-FLG
                  MOVE "C"   TO   EDIT-CURSOR  OF  DSP-BTDATE
