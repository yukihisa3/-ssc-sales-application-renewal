...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH4592B.COB`
...
*
 ...
 FILE-CONTROL.
*受信データファイル
     SELECT   CVCSG001  ASSIGN    TO        DA-01-S-CVCSG002
...
*
 01  DEN-REC.
     03  DEN-01A             PIC  X(03).
     03  DEN-01B             PIC  X(13).
     03  DEN-01B2            PIC  X(02).
     03  DEN-01B3            PIC  X(10).
     03  DEN-01C             PIC  X(01).
     03  DEN-01D             PIC  X(99).
******************************************************************
*    取引先マスタ
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH4592B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH4592B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*ＪＡＮＣＤ
     MOVE     JSB-F12       TO    HEN-A35.
*ライン
     MOVE     JSB-F20       TO    HEN-A36.
*サブクラス
     MOVE     JSB-F22       TO    HEN-A37.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
