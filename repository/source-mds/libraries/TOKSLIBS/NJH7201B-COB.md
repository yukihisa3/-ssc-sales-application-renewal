...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH7201B.COB`
...
*ヘッドレコード退避ワーク
 01  WK-DEPB-REC.
     ...
     03  WK-DEPB04.
         05  WK-DEPB041     PIC  9(06).
         05  WK-DEPB042     PIC  9(04).
     03  WK-DEPB05          PIC  X(04).
...
*    明細レコード退避ワーク
 01  WK-DEPD-REC.
     ...
     03  WK-DEPD05          PIC  X(09).
     03  WK-DEPD06          PIC  X(16).
     03  WK-DEPD07          PIC  X(06).
     03  WK-DEPD08          PIC  X(04).
     03  WK-DEPD09          PIC  9(04).
     03  WK-DEPD10          PIC  X(02).
     03  WK-DEPD11          PIC  9(05)V9(01).
     03  WK-DEPD12          PIC  X(01).
     03  WK-DEPD13          PIC  9(07)V9(02).
     03  WK-DEPD14          PIC  9(09).
     03  WK-DEPD15          PIC  9(06).
     03  WK-DEPD16          PIC  9(09).
     03  WK-DEPD17          PIC  X(13).
     03  WK-DEPD18          PIC  X(13).
     03  WK-DEPD19          PIC  X(01).
     03  WK-DEPD20          PIC  X(02).
*
 01  WK-AREA.
*システム日付の編集
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH7201B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH7201B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*取引先コード
     MOVE    HEN-A11       TO        WK-TORICD.
     MOVE    WK-HEN-TORICD TO        HEN-F01  WK-TOKCD.
*伝票ナンバー
     MOVE    HEN-A03       TO        WK-DENNO.
...
*    商品名称マスタ検索
     ...
     READ    MEIMS1
       INVALID
*        商品名
         MOVE    HEN-A25(1:15)  TO   HEN-F1421(1:15)
         MOVE    HEN-A25(16:1)  TO   HEN-F1422(1:1)
         MOVE    HEN-A26(1:6)   TO   HEN-F1422(2:6)
       NOT INVALID
         MOVE    HEN-A25(1:15)  TO   HEN-F1421(1:15)
         MOVE    HEN-A25(16:1)  TO   HEN-F1422(1:1)
         MOVE    HEN-A26(1:6)   TO   HEN-F1422(2:6)
...
*原価金額
     COMPUTE     HEN-F181 = HEN-A30 * HEN-A32.
*売価金額
     COMPUTE     HEN-F182 = HEN-A30 * HEN-A34.
*店舗名（備考）
*****MOVE                  TO        HEN-F22.
*自社得意先コード
     IF  FLG-TOK   =    ZERO
...
*修正原価金額
     COMPUTE     HEN-F521 = HEN-A30 * HEN-A32.
*修正売価金額
     COMPUTE     HEN-F522 = HEN-A30 * HEN-A34.
*
 TENSO-EXIT.
     EXIT.
****************************************************************
