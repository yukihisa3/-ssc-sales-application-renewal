...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY9003L.COB`
...
***** メッセージエリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY9003L".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY9003L".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND1.
...
*             プロセス                      0.0                *
****************************************************************
 SSY9003L-START         SECTION.
*
     MOVE   "SSY9003L-START"      TO   S-NAME.
     PERFORM            INIT-SEC.
*
...
*事業部名称セット
     EVALUATE  JYU-F00
         WHEN  1681
         MOVE NC"（資材）　　　" TO  HD01-JIGYOBU
         WHEN  1682
         MOVE NC"（植物）　　　" TO  HD01-JIGYOBU
         WHEN  OTHER
         MOVE NC"　　　　　　　" TO  HD01-JIGYOBU
     END-EVALUATE.
*頁セット
     ADD      1              TO   P-CNT.
