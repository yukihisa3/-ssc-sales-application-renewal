...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SLST043.COB`
...
*商品マスタ編集
 01  WK-SYOHIN.
     03  WKSYOHIN1         PIC N(15)  VALUE  SPACE.
     03  WKSYOHIN2         PIC N(15)  VALUE  SPACE.
*日付変換サブルーチン用ワーク
...
*商品名称ＲＥＡＤ
     ...
     INVALID
*         MOVE   SPACE     TO        SHONM
          MOVE  ALL NC"＊" TO        WKSYOHIN1
          MOVE  ALL NC"＊" TO        WKSYOHIN2
          MOVE  WK-SYOHIN  TO        SHONM
     NOT INVALID
          MOVE   MEI-F021  TO        WKSYOHIN1
          MOVE   MEI-F022  TO        WKSYOHIN2
          MOVE  WK-SYOHIN  TO        SHONM
     END-READ.
 MEIEDT-EXIT.
     EXIT.
