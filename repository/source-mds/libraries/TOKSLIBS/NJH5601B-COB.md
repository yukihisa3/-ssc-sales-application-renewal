...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH5601B.COB`
...
*ファイルヘッドレコード退避ワーク
 01  WK-DEPA-REC.
     ...
     03  WK-DEPA17          PIC  X(64).
*ヘッドレコード退避ワーク
 01  WK-DEPB-REC.
     03  WK-DEPB01          PIC  X(01).
     03  WK-DEPB02          PIC  9(02).
     03  WK-DEPB03          PIC  9(09).
     03  WK-DEPB041         PIC  9(04).
     03  WK-DEPB042         PIC  9(05).
     ...
     03  WK-DEPB10          PIC  X(25).
     03  WK-DEPB11          PIC  X(25).
     03  WK-DEPB12          PIC  X(25).
     03  WK-DEPB13          PIC  X(03).
     03  WK-DEPB14          PIC  X(01).
     03  WK-DEPB15          PIC  X(02).
*    明細レコード退避ワーク
 01  WK-DEPD-REC.
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH5601B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH5601B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*伝票明細転送
*    レコード区分
     MOVE     WK-DEPD01     TO        HEN-A16.
*    データ種別
     MOVE     WK-DEPD02     TO        HEN-A17.
*    行番号
     MOVE     WK-DEPD03     TO        HEN-A18.
*    商品コード
     MOVE     WK-DEPD04     TO        HEN-A19.
*    入数
     MOVE     WK-DEPD05     TO        HEN-A20.
*    発注単位数
     MOVE     WK-DEPD06     TO        HEN-A21.
*    単位
     MOVE     WK-DEPD07     TO        HEN-A22.
*    数量
     MOVE     WK-DEPD08     TO        WK-SURYO.
     MOVE     WK-HEN-SURYO  TO        HEN-A23.
*    原価単価
     MOVE     WK-DEPD09     TO        WK-GENKA.
     MOVE     WK-HEN-GENKA  TO        HEN-A24.
*    売価単価
     MOVE     WK-DEPD10     TO        HEN-A25.
*    原価金額
     MOVE     WK-DEPD11     TO        HEN-A26.
*    売価金額
     MOVE     WK-DEPD12     TO        HEN-A27.
*    受注者商品コード
     MOVE     WK-DEPD13     TO        HEN-A28.
*    商品名
     MOVE     WK-DEPD14     TO        HEN-A29.
*    予備
     MOVE     WK-DEPD15     TO        HEN-A30.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
...
*****MOVE    HEN-A091      TO        WK-TOKCD.
     EVALUATE  HEN-A042
         WHEN  61  WHEN  62
         MOVE  3731        TO        HEN-F01
         MOVE  3731        TO        WK-TOKCD2
         MOVE  "1"         TO        WK-TOKCD-CHK2
         WHEN  81
         MOVE  3732        TO        HEN-F01
         MOVE  3732        TO        WK-TOKCD3
         MOVE  "1"         TO        WK-TOKCD-CHK3
         WHEN  OTHER
         MOVE  373         TO        HEN-F01
         MOVE  373         TO        WK-TOKCD1
...
*    商品名称マスタ検索
     ...
     READ    MEIMS1
       INVALID
*        商品名
         MOVE    HEN-A29(1:15)  TO   HEN-F1421(1:15)
         MOVE    HEN-A29(16:10) TO   HEN-F1422(1:10)
       NOT INVALID
         MOVE    HEN-A29(1:15)  TO   HEN-F1421(1:15)
         MOVE    HEN-A29(16:10) TO   HEN-F1422(1:10)
     END-READ.
...
*****MOVE    WK-TOKCD      TO        KEN-F03.
     EVALUATE  HEN-A042
         WHEN  61  WHEN  62
         MOVE  3731        TO        KEN-F03
         WHEN  81
         MOVE  3732        TO        KEN-F03
         WHEN  OTHER
         MOVE  373         TO        KEN-F03
     END-EVALUATE.
     IF      INV-RUT       =         ZERO
