...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY3790D.COB`
...
****<<受領累積マスタ >>*********************************
     SELECT   NFJYURF            ASSIGN    TO   DA-01-VI-NFJYURL1
                                 ...
                                 STATUS         JYU-STATUS.
****<<受領累積バックアップ >>***************************
     SELECT  NFJYRBK             ASSIGN    TO   DA-01-S-NFJYRBK
                                 STATUS         JYD-STATUS.
*                                                                *
****************************************************************
 DATA                   DIVISION.
...
*    FILE = 受領累積バックアップ　　　　　　　　               *
*--------------------------------------------------------------*
 FD  NFJYRBK           BLOCK     CONTAINS  20   RECORDS
...
***** メッセージエリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY3790D".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY3790D".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND1.
...
*             プロセス                      0.0                *
****************************************************************
 SSY3790D-START         SECTION.
*
     MOVE   "SSY3790D-START"      TO   S-NAME.
     PERFORM            INIT-SEC.
*
...
*    削除前にレコードをバックアップ
     MOVE    SPACE                TO    JYD-REC.
     INITIALIZE                         JYD-REC.
     MOVE    JYU-REC              TO    JYD-REC.
     WRITE   JYD-REC.
*    レコードを削除する。
     DELETE  NFJYURF.
     ADD     1                    TO    OUT-CNT.
