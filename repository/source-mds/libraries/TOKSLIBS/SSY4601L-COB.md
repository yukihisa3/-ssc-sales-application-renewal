...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY4601L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*伝票データ（共通）　　
     SELECT   IWSHIRED  ASSIGN    TO        IWSHIRED
...
*
 01  HD4.
     ...
     03  HD4-06                   PIC  9(07).
     03  FILLER                   PIC  X(02)     VALUE   SPACE.
*2010/08/13 前０を取る START*
*****03  HD4-07                   PIC  9(06).
     03  HD4-07                   PIC  ZZZZZ9.
*2010/08/13 前０を取る END  *
     03  FILLER                   PIC  X(05)     VALUE   SPACE.
     03  HD4-08                   PIC  X(12).
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      IWSHIRED.
...
*
*****DISPLAY "DEN-A22=" DEN-A22 UPON CONS
*****DISPLAY "WK-GYONO= " WK-GYONO UPON CONS
*伝票行_により明細印字位置の判定を行う
     IF       DEN-A22   NOT =   WK-GYONO
...
*明細１行目
***  商品名
     MOVE     DEN-A28             TO   DT1-01.
***  受注者商品コード
     MOVE     DEN-A27             TO   DT1-02.
***  カラー名
     MOVE     DEN-A30             TO   DT1-03.
***  サイズ名
     MOVE     DEN-A31             TO   DT1-04.
...
*明細２行目
***  規格
     MOVE     DEN-A29             TO        DT2-01.
***  商品コード
     MOVE     DEN-A23             TO        DT2-02.
***  入数
     MOVE     DEN-A241            TO        DT2-03.
***  発注単位数（ケース）
     MOVE     DEN-A242            TO        DT2-04.
***  単位
     MOVE     DEN-A243            TO        DT2-05.
...
*ヘッダ１行目
***  チラシコード
     MOVE     DEN-A14             TO        HD1-01.
***  店舗直納区分
     IF       DEN-A16  = "1"
         MOVE     NC"店舗直納"    TO        HD1-02
     ELSE
...
*ヘッダ２行目
***  社名
     MOVE     DEN-A10             TO        HD2-01.
***  取引先名上段
     MOVE     DEN-A12(1:15)       TO        HD2-02.
*ヘッダ３行目
***  取引先名下段
     MOVE     DEN-A12(16:15)      TO        HD3-01.
*ヘッダ４行目
***  店名
     MOVE     DEN-A11             TO        HD4-01.
***  社コード（下２桁）
*2010/08/13 転送停止 START*
*****MOVE     DEN-A041(3:2)       TO        HD4-02.
*2010/08/13 転送停止 END  *
***  店コード（下４桁）
     MOVE     DEN-A042(2:4)       TO        HD4-03.
***  分類コード
     MOVE     DEN-A05             TO        HD4-04.
***  伝票区分
     MOVE     DEN-A06             TO        HD4-05.
***  伝票_（下７桁）
     MOVE     DEN-A03(3:7)        TO        HD4-06.
***  取引先コード
     MOVE     DEN-A091            TO        HD4-07.
***  電話番号
     MOVE     DEN-A13             TO        HD4-08.
***  発注日
     MOVE     DEN-A07             TO        HD4-09.
***  納品日
     MOVE     DEN-A08             TO        HD4-10.
*
...
*項目クリア
     MOVE     SPACE               TO   HD1 HD2 HD3 HD4
                                       ...
                                       TL1 TL2.
*テスト印字項目セット
     MOVE   ALL "9"              TO   HD1-01  HD4-02  HD4-03
                                      HD4-04  HD4-05  HD4-06
                                      HD4-07  HD4-09  HD4-10
                                      DT2-02  DT2-03  DT2-04
                                      DT2-061 DT2-071 DT2-081
                                      DT2-082 DT2-09  DT2-10
                                      DT2-11
                                      TL1-011 TL1-021 TL1-03
                                      TL1-04.
     MOVE   ALL "*"              TO   HD1-03  HD2-01
                                      HD2-02  HD3-01  HD4-01
                                      HD4-08
                                      DT1-01  DT1-02  DT1-03
                                      DT1-04  DT2-01  DT2-05.
*ヘッダ部
     WRITE    PRT-REC          FROM   HD1        AFTER    3.
     WRITE    PRT-REC          FROM   HD2        AFTER    2.
     WRITE    PRT-REC          FROM   HD3        AFTER    1.
...
*
     CLOSE    IWSHIRED   PRTFILE    DSPFILE.
*
 END-EXIT.
     EXIT.
