...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY5801L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*伝票データ（共通）　　
     SELECT   DKSHIRED  ASSIGN    TO        DKSHIRED
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      DKSHIRED.
...
*ヘッダ２行目
***  支払条件
     MOVE     DEN-A25             TO        HD6-01.
***  分割回数
     MOVE     DEN-A26             TO        HD6-02.
***  ルート名
     IF       DEN-A23 NOT = ZERO
...
***  取引先名（上段）
     MOVE     DEN-A28(1:20)       TO        HD3-02.
*
*ヘッダ４行目
***  取引先名（中段）
     MOVE     DEN-A28(21:20)      TO        HD4-01.
*
*ヘッダ５行目
***  店名
     MOVE     DEN-A27             TO        HD5-01.
***  店舗ＣＤ
     MOVE     DEN-A17(1:2)        TO        HD5-021.
     MOVE     DEN-A17(3:2)        TO        HD5-022.
***  分類ＣＤ
     MOVE     DEN-A18             TO        HD5-03.
***  伝票区分
...
***  発注日
     MOVE     DEN-A19             TO        HD5-07.
***  納品日
     IF       DEN-A20 NOT = ZERO
              MOVE     DEN-A20    TO        HD5-08
     END-IF.
***  便（引取のとき）
*    MOVE    "***"                TO        HD5-09.
*
...
*
     CLOSE    DKSHIRED   PRTFILE    DSPFILE.
*
 END-EXIT.
     EXIT.
