...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY9013L.COB`
...
***** メッセージエリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY9013L".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY9013L".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND1.
...
*             プロセス                      0.0                *
****************************************************************
 SSY9013L-START         SECTION.
*
     MOVE   "SSY9013L-START"      TO   S-NAME.
     PERFORM            INIT-SEC.
*
...
*
 INIT-06.
     DISPLAY  NC"（受領書）出力年月度を入力（６桁）" UPON CONS.
*
...
*事業部名称セット
     EVALUATE   LINK-TOKCD
         WHEN   1681
                MOVE NC"（資材部門）　" TO  HD01-JIGYOBU
         WHEN   1682
                MOVE NC"（植物部門）　" TO  HD01-JIGYOBU
         WHEN   OTHER
