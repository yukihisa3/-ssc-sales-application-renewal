...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SJH5704B.COB`
...
*    ｶｳﾝﾄ
 ...
 01  GTJOHOF-INV-FLG         PIC  X(03)     VALUE  ZERO.
*ルート変換
 01  HEN-RUT.
...
*ヘッドレコード退避ワーク
 01  WK-DEPB-REC.
     ...
     03  FILLER             PIC  X(03).
     03  WK-DEPB13          PIC  N(20).
     03  WK-DEPB14          PIC  N(30).
     03  WK-DEPB15          PIC  N(30).
     03  FILLER             PIC  X(01).
     03  WK-DEPB16          PIC  X(01).
     03  WK-DEPB17          PIC  9(03).
     03  WK-DEPB18          PIC  X(27).
*    明細レコード退避ワーク
 01  WK-DEPD-REC.
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJH5704B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJH5704B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*伝票明細転送
*    レコード区分
     MOVE     WK-DEPD01     TO        HEN-A19.
*    行番号
     MOVE     WK-DEPD02     TO        HEN-A20.
*    品番コード
     MOVE     WK-DEPD03     TO        HEN-A21.
*    ＪＡＮコード
     MOVE     WK-DEPD04     TO        HEN-A22.
*    発注数量
     MOVE     WK-DEPD05     TO        HEN-A23.
*    販売単位単価
     MOVE     WK-DEPD06     TO        HEN-A24.
*    原価単価
     MOVE     WK-DEPD07     TO        WK-GENKA.
     MOVE     WK-HEN-GENKA  TO        HEN-A25.
*    売価単価
     MOVE     WK-DEPD08     TO        HEN-A26.
*    原価複価
     MOVE     WK-DEPD09     TO        HEN-A27.
*    売価複価
     MOVE     WK-DEPD10     TO        HEN-A28.
*    商品名上段
     MOVE     WK-DEPD11     TO        HEN-A29.
*    商品名下段
     MOVE     WK-DEPD12     TO        HEN-A30.
*    ＪＡＮコード区分
     MOVE     WK-DEPD13     TO        HEN-A31.
*    ラベル区分
     MOVE     WK-DEPD14     TO        HEN-A32.
*    予備
     MOVE     WK-DEPD15     TO        HEN-A33.
*
     PERFORM  TENSO-SEC.
*ウタネの商品の場合は、サカタ側で処理しない。
     IF   HEN-F25(3:5) = "62484"
          CONTINUE
     ELSE
          WRITE    HEN-REC
          ADD      1             TO   WRT-CNT
...
*****COMPUTE     HEN-F111  = WK-NEN * 10000 + HEN-A06.
     MOVE       "3"        TO        LINK-IN-KBN.
