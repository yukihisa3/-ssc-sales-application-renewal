...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY5045L.COB`
...
****  メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SSY5045L".
...
*    ﾐﾀﾞｼ
 01  HEAD-01.
     ...
     03  FILLER                   PIC  X(08)     VALUE "SSY5045L".
...
*    DISPLAY "WK-DEPC03 = " WK-DEPC03 UPON CONS.
     EVALUATE WK-DEPC03
