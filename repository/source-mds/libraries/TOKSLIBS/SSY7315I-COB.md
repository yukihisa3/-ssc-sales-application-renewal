...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY7315I.COB`
...
*----<< 表示ファイル >>--*
     SELECT   DSPFILE   ASSIGN         01-GS-DSPF
                        ...
                        STATUS         DSP-ST.
*----<< 出荷情報ファイル >>--*
     SELECT   DYSYUKF   ASSIGN         DA-01-VI-DYSYUKL1
                        ORGANIZATION   INDEXED
                        ACCESS    MODE SEQUENTIAL
                        RECORD    KEY  DYK-F01   DYK-F02
                                       DYK-F03   DYK-F04
                                       DYK-F05   DYK-F06
                                       DYK-F07   DYK-F08
                        STATUS         DYSYUKF-ST.
...
*
 ...
 01  PARA-DENNO1        PIC   9(09).
 01  PARA-DENNO2        PIC   9(09).
*
****************************************************************
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SSY7315I DSPFILE ERROR " DSP-CNTL " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
     CLOSE    DYSYUKF   HTOKMS    ZSOKMS1    DSPFILE.
     STOP     RUN.
*----<< 出荷情報ファイル >>--*
 DYSYUKF-ERR            SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY7315I DYSYUKF ERROR " DYSYUKF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 取引先マスタ >>--*
 HTODYK-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY7315I HTOKMS ERROR " HTODYK-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY7315I ZSOKMS1 ERROR " ZSOKMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FSY7315I.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "SSY7315I"      TO   PGID.
     MOVE    "FSY7315I"      TO   FORM.
...
*             ELSE
*                  MOVE  "M"      TO   EDIT-OPTION  OF  SNOUDT
*                  MOVE  SPACE    TO   EDIT-CURSOR  OF  SNOUDT
              END-IF
     END-IF.
*    終了納品日論理チェック
...
*             ELSE
*                  MOVE  "M"      TO   EDIT-OPTION  OF  ENOUDT
*                  MOVE  SPACE    TO   EDIT-CURSOR  OF  ENOUDT
              END-IF
     END-IF.
*納品日入力範囲チェック
     IF       SNOUDT      >  ENOUDT
...
*             MOVE  SPACE    TO   EDIT-CURSOR  OF  SNOUDT
     END-IF.
*    伝票番号チェック
*****DISPLAY "DENNO1=" DENNO1  UPON CONS.
*****DISPLAY "DENNO2=" DENNO2  UPON CONS.
*****IF  DENNO1  > 0  AND  DENNO2  > 0
     IF  DENNO1  IS  NUMERIC  OR
         DENNO2  IS  NUMERIC
       IF       DENNO1  >  DENNO2
                DISPLAY "CHEK ERR DENNO1=" DENNO1  UPON CONS
                DISPLAY "CHEK ERR DENNO2=" DENNO2  UPON CONS
                IF   ERR-FLG   =    ZERO
                     MOVE     10    TO   ERR-FLG
                END-IF
      ...
      ELSE
       ...
       IF   DENNO2 NOT NUMERIC
                MOVE     "C"   TO   EDIT-CURSOR OF DENNO2
       END-IF
     END-IF.
*    出荷情報ファイル存在チェック
     IF  ERR-FLG        =    ZERO
         MOVE      SPACE          TO   DYK-REC
         INITIALIZE                    DYK-REC
         MOVE      JDATE          TO   DYK-F01
         MOVE      JTIME          TO   DYK-F02
         MOVE      TORICD         TO   DYK-F03
         MOVE      WK-SOKCD       TO   DYK-F04
         MOVE      STENCD         TO   DYK-F05
         MOVE      DENNO1         TO   DYK-F06
         MOVE      SNOUDT         TO   DYK-F16
         START     DYSYUKF   KEY  >=   DYK-F01   DYK-F02
                                       DYK-F03   DYK-F04
                                       DYK-F05   DYK-F06
                                       DYK-F07   DYK-F08
              INVALID   KEY
...
*                       DISPLAY " ETENCD = " ETENCD  UPON CONS
*                       DISPLAY " DENNO1 = " DENNO1  UPON CONS
*                       DISPLAY " DYK-F01= " DYK-F01 UPON CONS
*                       DISPLAY " DYK-F02= " DYK-F02 UPON CONS
*                       DISPLAY " DYK-F03= " DYK-F03 UPON CONS
*                       DISPLAY " DYK-F04= " DYK-F05 UPON CONS
*                       DISPLAY " DYK-F05= " DYK-F01 UPON CONS
*                       DISPLAY " DYK-F06= " DYK-F06 UPON CONS
*                       DISPLAY " DYK-F14= " DYK-F14 UPON CONS
*                       DISPLAY " DYK-F15= " DYK-F15 UPON CONS
*                       DISPLAY " DYK-F16= " DYK-F16 UPON CONS
                        IF ( JDATE     =    DYK-F01 ) AND
                           ( JTIME     =    DYK-F02 ) AND
                           ( TORICD    =    DYK-F03 ) AND
                           ( STENCD    <=   DYK-F05 ) AND
                           ( ETENCD    >=   DYK-F05 )
*## 2008/03/11 ST *********( ETENCD    >=   DYK-F05)  AND
***************************( SNOUDT    <=   DYK-F08 ) AND
***************************( ENOUDT    >=   DYK-F08)
                             IF ( WK-SOKCD  NOT =    SPACE )
                                  IF   SOKO     =     DYK-F04
                                  ...
                                  ELSE
                                    DISPLAY " ERR3 " UPON CONS
                                       ...
                                       MOVE "R"  TO
                                            ...
                                            EDIT-OPTION OF DENNO1
                                            EDIT-OPTION OF DENNO2
                                  END-IF
                             ELSE
                                  CONTINUE
                             END-IF
...
*
     ...
     IF       DENNO1   NOT NUMERIC  OR
              DENNO1     = 00000000
              MOVE      000000001      TO   PARA-DENNO1
     ELSE
              MOVE      DENNO1         TO   PARA-DENNO1
     END-IF.
     IF       DENNO2  NOT NUMERIC  OR
              DENNO2    = 000000000
              MOVE      999999999      TO   PARA-DENNO2
     ELSE
              MOVE      DENNO2         TO   PARA-DENNO2
     END-IF.
...
*--------------------------------------------------------------*
 CLR-HEAD-RTN           SECTION.
     MOVE     " "            TO   EDIT-CURSOR OF JDATE
                                  ...
                                  EDIT-CURSOR OF DENNO1
                                  EDIT-CURSOR OF DENNO2.
