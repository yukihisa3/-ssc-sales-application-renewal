...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY7316C.COB`
...
*----<< ダイユーエイト出荷情報ファイル >>--*
 DYSYUKF-ERR            SECTION.
     ...
     DISPLAY  "### SSY7316C DYSYUKF ERROR " DYSYUKF-ST " "
