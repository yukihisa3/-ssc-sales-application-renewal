...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SZA0111I.COB`
...
*****MOVE     TTL-F16             TO   ZENSYK (IX01).
     MOVE     TTL-F27             TO   MISYUK (IX01).
     MOVE     TTL-F28             TO   HIKIAZ (IX01).
     MOVE     TTL-HIKIAK          TO   HIKIAK (IX01).
*-------------------------
     ADD      1                   TO           IX01 .
 TOTAL-SET-EXIT.
     EXIT.
...
*****MOVE     ZAI-F16             TO   ZENSYK (IX01).
     MOVE     ZAI-F27             TO   MISYUK (IX01).
     MOVE     ZAI-F28             TO   HIKIAZ (IX01).
     COMPUTE  WK-HIKIAK = GEN(IX01) -  MISYUK (IX01).
     MOVE     WK-HIKIAK           TO   HIKIAK (IX01).
*-------------------------
 BODY-SET-EXIT.
     EXIT.
****************************************************************
