...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/CSV0046B.COB`
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "CSV0046B".
...
****  キー退避                ****
 01  KEY-BACKUP.
     ...
     03  WK-SYO-F07-X        PIC  9(04)   VALUE  ZERO.
...
*                   ﾀﾞﾐｰ明細出力
                    ADD 1      TO  MEISAI-CNT
                    MOVE    WK-SYO-F07   TO   WK-SYO-F07-X
