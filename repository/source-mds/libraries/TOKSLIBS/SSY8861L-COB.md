...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8861L.COB`
...
*
 ...
 01  PG-ID             PIC  X(08)      VALUE  "SSY8861L".
 01  WK-MSG1           PIC  N(14)
...
*--------------------------------------------------------------*
 ...
 LBLERR                 SECTION.
     ...
     DISPLAY  "### SSY8861L LBL ERROR " LBL-ST " "
 ...
 PRTERR                 SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY8861L PRTFILE ERROR " PRT-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     MOVE     4000           TO        PROGRAM-STATUS.
