...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSI8703P.COB`
...
*--------------------------------------------------------------*
 ...
 01  IDX.
     03  I              PIC  9(03).
 01  ID-PROGRAM.
     03  PG-ID          PIC  X(08)     VALUE  "SSI8703P".
*
*----<< ﾌｱｲﾙ ｽﾃｰﾀｽ >>--*
 01  SIH-ST             PIC  X(02).
 01  TOK-ST             PIC  X(02).
...
*****EVALUATE SIH-F02
     EVALUATE PARA-TORICD
         ...
         WHEN 13938  MOVE NC"（資材）カーマ"       TO HD01-JIGYO
         WHEN 17137  MOVE NC"（植物）カーマ"       TO HD01-JIGYO
*#2018/03/07 NAV ST
         WHEN 139381 MOVE NC"（資材）カーマ東日本" TO HD01-JIGYO
         WHEN 171371 MOVE NC"（植物）カーマ西日本" TO HD01-JIGYO
         WHEN 1731   MOVE NC"（資材）ケーヨー　東" TO HD01-JIGYO
         WHEN 1732   MOVE NC"（資材）ケーヨー　西" TO HD01-JIGYO
         WHEN 7601   MOVE NC"（植物）ケーヨー　東" TO HD01-JIGYO
         WHEN 7602   MOVE NC"（植物）ケーヨー　西" TO HD01-JIGYO
*#2018/03/07 NAV ED
