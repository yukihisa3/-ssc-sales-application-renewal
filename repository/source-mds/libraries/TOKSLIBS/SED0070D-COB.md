...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SED0070D.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SED0070D".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SED0070D".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    ＥＤＩＣ　　　　　出荷確定ファイルスタート
     ...
     MOVE     PARA-SOKO      TO   SYK-F02.
     MOVE     ZERO           TO   SYK-F03.
         DISPLAY "PARA-DENNOS=" PARA-DENNOS UPON CONS.
     MOVE     PARA-DENNOS    TO   SYK-F05.
