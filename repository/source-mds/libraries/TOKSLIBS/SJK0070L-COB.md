...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SJK0070L.COB`
...
*
 ...
 FILE-CONTROL.
*欠品ファイル
     SELECT  KPNDATF   ASSIGN    TO        KPNDATL2
...
****************************************************************
 PROCESS-SEC             SECTION.
     ...
     DISPLAY  "***   SJI0070L   START     ***"  UPON CONS.
*
*ワーク初期化
     MOVE      ZERO     TO    P-CNT.
     MOVE      ZERO     TO    L-CNT.
...
*ファイル ＣＬＯＳＥ
     ...
     DISPLAY  "***   SJI0070L   END       ***"  UPON CONS.
**
 END-EXIT.
     EXIT.
