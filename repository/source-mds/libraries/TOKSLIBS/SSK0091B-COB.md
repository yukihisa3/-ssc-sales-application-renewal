...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSK0091B.COB`
...
*
 ...
 FILE-CONTROL.
*---<<  返品累積データ  >>---*
     SELECT   KEIJHRF   ASSIGN    TO             KEIJHRL5
                        ORGANIZATION        IS   INDEXED
                        ACCESS    MODE      IS   SEQUENTIAL
                        RECORD    KEY       IS   KEI-F80
                                                 KEI-F86
                                                 KEI-F82
...
**** メッセージ情報  ***
 01  MSG-AREA1-1.
     03  MSG-ABEND1.
       ...
       05  ERR-PG-ID         PIC  X(08)  VALUE  "SSK0091B".
...
**
 ...
 FILEERR-SEC1                SECTION.
     USE AFTER       EXCEPTION
                     PROCEDURE    KEIJHRF.
     MOVE     "KEIJHRF"      TO   ERR-FL-ID.
     MOVE     KEI-STATUS     TO   ERR-STCD.
...
*返品累積Ｆスタート
     MOVE    1            TO KEI-F80.
     MOVE    ZERO         TO KEI-F86.
     MOVE    ZERO         TO KEI-F82.
     START   KEIJHRF KEY  IS  >=  KEI-F80  KEI-F86
                                  KEI-F82
             INVALID
             MOVE   "END" TO END-FLG
             DISPLAY
...
*-------------------------------------------------------------*
 END-SEC                SECTION.
     CLOSE              KEIJHRF  HJYOKEN.
     DISPLAY  "DELDATE         = "  WK-DEL-DATE   UPON   CONS.
     DISPLAY  "KEIJHRF    (IN) = "  READ-CNT      UPON   CONS.
     DISPLAY  "KEIJHRF   (DEL) = "  DEL-CNT       UPON   CONS.
 END-END.
     EXIT.
******************<<  PROGRAM  END  >>**************************
