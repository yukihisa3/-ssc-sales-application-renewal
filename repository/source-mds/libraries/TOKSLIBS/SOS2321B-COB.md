...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SOS2321B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SOS2321B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SOS2321B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*倉庫ＣＤ入替え
     MOVE     PARA-SOKCD2         TO   DEN-F08.
*****MOVE     PARA-SOKCD2         TO   DEN-F09  DEN-F48.
     REWRITE  DEN-REC.
*
     PERFORM  SHTDENF-READ-SEC.
*
...
*
     ...
     DISPLAY "REWT-CNT  =  "  CRT-CNT   UPON CONS.
*
     CLOSE    SHTDENF.
*
     STOP      RUN.
...
*売上計上済の時は、ＰＧ終了
     ...
     END-IF.
*指定倉庫の場合
*****DISPLAY "DEN-F08 = " DEN-F08 UPON CONS.
*****DISPLAY "DEN-F09 = " DEN-F08 UPON CONS.
*****DISPLAY "DEN-F48 = " DEN-F48 UPON CONS.
*****DISPLAY "PARA-SOKCD1 = " PARA-SOKCD1 UPON CONS.
