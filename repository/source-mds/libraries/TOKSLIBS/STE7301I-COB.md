...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/STE7301I.COB`
...
*
*----<< ﾜｰｸｴﾘｱ　>--*
 01  WK-DENST           PIC  9(09).
 01  WK-DENED           PIC  9(09).
*伝票NO終了の最大値
 01  DDMAX              PIC  9(09)  VALUE  999999999.
*
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### STE7301I DSPFILE ERROR " DSP-CNTL " "
...
*----<< 伝票データ >>--*
 SHTDENF-ERR            SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### STE7301I SHTDENF ERROR " SHTDENF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### STE7301I HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### STE7301I ZSOKMS1 ERROR " ZSOKMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FSY7301I.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "STE7301I"      TO   PGID.
     MOVE    "FSY7301I"      TO   FORM.
...
*    伝票NO終了チェック
     IF       DENED NOT NUMERIC
              MOVE      DDMAX     TO   WK-DENED
     ELSE
              MOVE      DENED     TO   WK-DENED
     END-IF.
*    伝票NO開始・終了の大小チェック
     IF  WK-DENST   >   WK-DENED
         IF   ERR-FLG   =    ZERO
              MOVE      13   TO   ERR-FLG
         END-IF
         ...
         START     SHTDENF   KEY  >=   DEN-F01   DEN-F02
              ...
              INVALID   KEY
                   ...
                   IF   NOUDT     NOT =    ZERO
                        MOVE  "R" TO   EDIT-OPTION OF NOUDT
                   END-IF
*                  伝票NO開始・終了が入力された場合、項目反転
                   IF   WK-DENST NOT =    1
                        MOVE    "R"   TO    EDIT-OPTION OF DENST
                   END-IF
                   IF   WK-DENED NOT =    DDMAX
                        MOVE    "R"   TO    EDIT-OPTION OF DENED
                   END-IF
...
*
     MOVE     WK-DENST            TO   PARA-DENST.
     MOVE     WK-DENED            TO   PARA-DENED.
*
     MOVE     99                  TO   GR-NO.
*
 240-PARA-SEC-EXIT.
