...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/CSV0070B.COB`
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "CSV0070B".
...
*
     IF   CSVTBLF-INV-FLG = "INV"
          ...
          MOVE  HAC-F07      TO  TBL-F08
          MOVE  HAC-F08      TO  TBL-F09
          MOVE  HAC-F09      TO  TBL-F10
*# 2020/07/17 NAV ST
          MOVE  HAC-F17      TO  TBL-F10(2:1)
          MOVE  HAC-F18      TO  TBL-F10(3:1)
          IF  HAC-F16 = "0"
                MOVE  "1"    TO  TBL-F10(1:1)
          END-IF
*# 2020/07/17 NAV ED
          MOVE  HAC-F101     TO  TBL-F111
          MOVE  HAC-F102     TO  TBL-F112
          MOVE  HAC-F11      TO  TBL-F12
...
*
     ...
     MOVE    HAC-F04             TO   TBL-F06.
     READ    CSVTBLF
             INVALID     MOVE "INV" TO CSVTBLF-INV-FLG
             NOT INVALID MOVE SPACE TO CSVTBLF-INV-FLG
     END-READ.
*
 CSVTBLF-READ-EXIT.
     EXIT.
...
*************DISPLAY "TBL-TENPO  = " TBL-TENPOCD(IY)  UPON CONS
             IF   HAC-F06  =  TBL-TENPOCD(IY)
                  MOVE   "OK"    TO   OK-FLG
                  ADD    HAC-F15 TO   TBL-F14(IY)
             END-IF
     END-PERFORM.
*
 TENPO-SET-EXIT.
...
************************************************************
 300-END-SEC           SECTION.
     CLOSE             CSVTBLF  HACYUPRT  SEQTENF.
*
