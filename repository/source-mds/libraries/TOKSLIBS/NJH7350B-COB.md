...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH7350B.COB`

## ソースコード

```cobol
****************************************************************
*    ※新ＥＤＩシステムの構築に伴う変更 2010/09/09             *
*    顧客名　　　　　　　：　（株）サカタのタネ殿　　　　　　　*
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH7350B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH7350B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*取引先コード
     MOVE        1225      TO        HEN-F01  HEN-A15  WK-TORICD.
*****MOVE        RHD-H04   TO        HEN-F01  HEN-A15.
*伝票番号　　
