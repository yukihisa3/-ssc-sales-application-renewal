...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SKE6010L.COB`
...
*
 ...
 FILE-CONTROL.
*欠品ファイル
     SELECT  CHKFILF   ASSIGN    TO        CHKFILL3
...
**************************************************************
 DECLARATIVES.
 KPN-ERR                   SECTION.
     USE         AFTER     EXCEPTION PROCEDURE CHKFILF.
...
****************************************************************
 PROCESS-SEC             SECTION.
     ...
     DISPLAY  "***   SKE6010L   START     ***"  UPON CONS.
*
*ワーク初期化
     MOVE      ZERO     TO    P-CNT.
     MOVE      ZERO     TO    L-CNT.
...
*ファイルのＯＰＥＮ
     OPEN     INPUT     CHKFILF HTOKMS   HTENMS   ZSOKMS.
     OPEN     OUTPUT    PRTFILE.
*ワークの初期化
     INITIALIZE         FLG-AREA.
*
