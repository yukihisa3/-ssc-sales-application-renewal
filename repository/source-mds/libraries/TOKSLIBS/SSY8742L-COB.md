...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8742L.COB`
...
*----<< カーマ出荷確定データ >>--*
 DJSYUKF-ERR            SECTION.
     ...
     DISPLAY  "### SSY8742L DJSYUKF ERROR " DJSYUKF-ST " "
...
*
*納品日範囲チェック
     IF       LINK-SNOUDT  <=  KMK-F06
     AND      LINK-ENOUDT  >=  KMK-F06
              CONTINUE
     ELSE
              GO        TO        900-KMK-READ
     END-IF.
