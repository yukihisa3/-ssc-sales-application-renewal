...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH2401B.COB`
...
*    明細レコード退避ワーク
 01  WK-DD-REC.
     ...
     03  WK-DD04                  PIC       9(07).
     03  WK-DD05                  PIC       X(16).
     03  WK-DD06                  PIC       9(05)V9.
     03  WK-DD07                  PIC       9(07)V99.
     03  WK-DD08                  PIC       9(07).
     03  WK-DD09                  PIC       X(30).
     03  FILLER                   PIC       X(48).
*
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH2401B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH2401B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*各量販店領域転送
*    取引先コード
     MOVE     WK-DH09       TO        HEN-A01.
*    伝票■
     MOVE     WK-DH03       TO        HEN-A02.
*    行■
     MOVE     WK-DD03       TO        HEN-A03.
*    部門（Ｈ）
     MOVE     WK-DH05       TO        HEN-A04.
*    直送区分
     MOVE     WK-DH13       TO        HEN-A05.
*    発注者名（社名）
     MOVE     WK-DH12       TO        HEN-A06.
*    取引先名称（仕入先名）
     MOVE     WK-DH10       TO        HEN-A07.
*    発注日
     MOVE     WK-DH07       TO        HEN-A08.
*    納品日
*****MOVE     XXXXXXX       TO        HEN-A09.
*    便
*****MOVE     XXXXXXX       TO        HEN-A10.
*    直送先名
     MOVE     WK-DH14       TO        HEN-A11.
*    ルート（直送先）
     MOVE     WK-DH17       TO        HEN-A12.
*    Ｌ欄
*****MOVE     XXXXXXX       TO        HEN-A13.
*    伝票区分
     MOVE     WK-DH06       TO        HEN-A14.
*    商品コード
     MOVE     WK-DD04       TO        HEN-A15.
*    商品名
     MOVE     WK-DD09       TO        HEN-A16.
*    適要１
     MOVE     WK-DH15       TO        HEN-A17.
*    適要２
     MOVE     WK-DH16       TO        HEN-A18.
*    入数
*****MOVE     XXXXXXX       TO        HEN-A19.
*    ケース数
*****MOVE     XXXXXXX       TO        HEN-A20.
*    数量
     MOVE     WK-DD06       TO        HEN-A21.
*    原単価
     MOVE     WK-DD07       TO        HEN-A22.
*    原価金額
     COMPUTE  WK-HEN-A23  =  WK-DD06  *  WK-DD07.
     MOVE     WK-HEN-A23    TO        HEN-A23.
*    売単価
     MOVE     WK-DD08       TO        HEN-A24.
*    売価金額
     COMPUTE  WK-HEN-A25  =  WK-DD06  *  WK-DD08.
     MOVE     WK-HEN-A25    TO        HEN-A25.
*    店舗コード
     MOVE     WK-DH04       TO        HEN-A26.
*    伝票枚数
*****MOVE     XXXXXXX       TO        HEN-A27.
*    店舗名
     MOVE     WK-DH11       TO        HEN-A28.
*    Ａ欄
*****MOVE     XXXXXXX       TO        HEN-A29.
*    Ｂ欄
*****MOVE     XXXXXXX       TO        HEN-A30.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
...
*
 ...
 TEN001.
*取引先コード
*****MOVE     HEN-A01(1:4) TO        HEN-F01.
     MOVE        WK-DH09   TO        HEN-F01.
     MOVE        WK-DH09   TO        WK-TOKCD.
 TEN002.
*伝票ナンバー
     COMPUTE     HEN-F02  =  HEN-A26 * 10000000.
     COMPUTE     HEN-F02  =  HEN-F02 + HEN-A02.
...
*****************                          + WK-SEIREKI-DATE
          ...
          END-IF
     ELSE
**********MOVE    SYS-DATEW  TO   WK-SEIREKI-DATE
**********COMPUTE HEN-F112 = WK-NEN * 10000 + WK-SEIREKI-DATE
          MOVE    SYS-DATEW  TO   HEN-F112
     END-IF.
 TEN010.
*納品日を出荷日にセット
