...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/STE7801B.COB`
...
***  ﾜｰｸ  ｴﾘｱ
 01  WRK-AREA.
     03  WK-TORICD                PIC  9(08)     VALUE   51649.
...
***  ﾌﾟﾘﾝﾄ ｴﾘｱ
*    ﾐﾀﾞｼ
 01  HEAD-00                      CHARACTER  TYPE  IS  YA.
     03  FILLER                   PIC  X(07)     VALUE   SPACE.
     03  HD001                    PIC  N(07)     VALUE
                                  NC"ロイヤルＨＣ_".
*
