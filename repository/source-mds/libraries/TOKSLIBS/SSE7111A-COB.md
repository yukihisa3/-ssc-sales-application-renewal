...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSE7111A.COB`
...
*
 ...
 FILE-CONTROL.
*----<< 伝票データ >>--*
     SELECT   SHTDENF   ASSIGN         DA-01-VI-SHTDENL5
...
*----<< 伝票データ >>--*
 SHTDENF-ERR            SECTION.
     ...
     DISPLAY  "### SSE7111A SHTDENF ERROR " DEN-ST " "
...
*----<< 条件ファイル >>--*
 HJYOKEN-ERR            SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSE7111A HJYOKEN ERROR " JYO-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
*----<< 請求Ｆ >>--*
 JHSEIKF-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSE7111A JHSEIKF ERROR " SEI-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
...
*
     ...
     ACCEPT   SYS-TIME       FROM TIME.
*****2010/06/28 件数を追加 ST
     MOVE     OUT-CNT        TO   PARA-KENSU.
*****2010/06/28 件数を追加 ED
     DISPLAY  "*** SSE7111A END *** "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS
                                       UPON CONS.
 300-END-RTN-EXIT.
...
*--------------------------------------------------------------*
 900-JYO-READ           SECTION.
     ...
     READ     HJYOKEN   INVALID
              MOVE      1         TO   INV-FLG
     DISPLAY  "### SSE7111A HJYOKEN INVALID KEY=" JYO-F01 " ###"
                                       UPON CONS
     END-READ.
 900-JYO-READ-EXIT.
     EXIT.
...
***2011.10.11 ST
***  START    SHTDENF   KEY  >=   DEN-F01   DEN-F23
***                               DEN-F04   DEN-F051
***                               DEN-F03
     START    SHTDENF   KEY  >=   DEN-F01   DEN-F23
                                  DEN-F04   DEN-F051
