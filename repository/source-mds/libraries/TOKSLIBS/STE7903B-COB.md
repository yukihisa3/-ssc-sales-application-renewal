...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/STE7903B.COB`
...
***  ｺﾞｳｹｲ ｴﾘｱ
 01  GOUKEI.
     ...
     03  G-SURYO                  PIC  9(06)     VALUE   ZERO.
***  ｹｲｻﾝ ｴﾘｱ
 01  KEISAN.
...
*    ワーク初期化
     ...
     MOVE     SPACE              TO   FTE79011.
*伝票枚数カウント
     MOVE     ZERO         TO    WRK-MAI.
     MOVE     PARA-TOKCD   TO    KYO-F01.
...
*    数量
     ...
     COMPUTE  G-SURYO    =   G-SURYO  +  KYO-F15.
*    原価単価
...
*    伝票区分
*****MOVE     "11"               TO    HD04. 2007/09/27 TEISI
...
*    テスト印字項目セット
     MOVE   ALL "9"              TO   HD01    HD02    HD06
                                      HD07    HD08
                                      MS04    MS05    MS06
                                      MS07    MS08    MS09
                                      TL01    TL02
**************************************HD05
     MOVE   ALL "*"              TO   HD03    HD04
                                      MS01    MS02    MS03
                                      BIKO01  BIKO02.
*    ヘッド印字
     WRITE    PRT-REC          FROM   HEAD-00    AFTER    6.
