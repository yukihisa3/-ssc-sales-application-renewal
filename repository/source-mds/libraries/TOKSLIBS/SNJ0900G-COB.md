...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SNJ0900G.COB`
...
-          "さい。".
 ...
 01  ERR-MSG-AREA-R  REDEFINES ERR-MSG-AREA.
     03  ERR-MSG-R             PIC   N(30)  OCCURS 10.
*基本スケジュール退避エリア
 01  TABLE-AREA.
     03  TBL-JDATE.
...
*  2011/10/13,E  S.I/NAV
    ...
    *> 以外
       WHEN  OTHER
         DISPLAY "SNJ0900G PSW HANIGAI ??? PSW=" PSW
            "*" UPON CONS
         MOVE  4000         TO  PROGRAM-STATUS
         EXIT PROGRAM
     END-EVALUATE.
...
* TOK-FIL1(10:1) : 発注集計表出力区分
     ...
     IF  WK-HCSYU-KBN = "1"  *>発注集計表(税込)
         CALL "PSSY0038"  USING
**         CALL "XSSY0038"  USING  *> TST
               WK-JDATE
               DSP-MTIME  (DSP-HCHYO)
               DSP-MTOKCD (DSP-HCHYO)
*      全画面クリア（呼んだPGの画面表示をクリアする)
         MOVE  "CL"              TO  DSP-PRO
         MOVE  "SCREEN"          TO  DSP-GRP
         MOVE  "FNJ0900I"        TO  DSP-FMT
...
* ファイル ＣＬＯＳＥ
     CLOSE  DSPFILE  JSMDAYF  HTOKMS  JSMMSGF.

 END-EXIT.
     EXIT.
*******************< PROGRAM-END SNJ0900G >*********************
