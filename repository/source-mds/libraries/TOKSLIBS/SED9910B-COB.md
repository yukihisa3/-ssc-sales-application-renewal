...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SED9910B.COB`
...
*    サブシステム　　　　：　ＥＤＩＣオンライン　　　　　　　　*
*    業務名　　　　　　　：　出荷送信データリカバリ　　　　　　*
*    モジュール名　　　　：　基本情報ＤＴ送信ＦＬＧ解除　　　　*
*    作成日／更新日　　　：　2016/04/21                        *
*    作成者／更新者　　　：　NAV                               *
*    処理概要　　　　　　：　基本情報ＤＴ送信ＦＬＧ解除を行う　*
*　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　*
****************************************************************
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SED9910B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SED9910B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*送信済ＦＬＧ解除
     MOVE     SPACE              TO   JOH-F801.
     MOVE     ZERO               TO   JOH-F802  JOH-F803.
     REWRITE  JOH-REC.
     ADD      1                  TO   REWT-CNT.
*
     PERFORM EDJOHOF-READ-SEC.
