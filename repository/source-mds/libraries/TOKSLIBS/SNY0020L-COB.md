...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SNY0020L.COB`
...
****  見出し行０             ****
 01  MIDASI-0.
     ...
     02  FILLER              PIC  X(08)  VALUE  "SNY0020L".
     02  FILLER              PIC  X(02)  VALUE  SPACE.
...
************************************************************
 FNY00201B-START         SECTION.
     DISPLAY  "**  SNY0020L   START  **"   UPON  CONS.
*
     PERFORM       INIT-SEC.
     PERFORM       MAIN-SEC      UNTIL  END-FLG  =  "END".
     PERFORM       END-SEC.
*
     DISPLAY  "**  SNY0020L    END   **"   UPON  CONS.
     STOP     RUN.
 FNY00201B-END.
     EXIT.
************************************************************
...
****************************************************************
 DSP-INIT-SEC           SECTION.
     MOVE    SPACE               TO   FNY00201.
     MOVE    SPACE               TO   DSP-CONTROL.
     MOVE    "CL"                TO   DSP-PROC.
     MOVE    "FNY00201"          TO   DSP-FORMAT.
