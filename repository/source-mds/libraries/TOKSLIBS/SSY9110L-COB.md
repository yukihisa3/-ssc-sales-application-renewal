...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY9110L.COB`
...
*
 ...
 01  PG-ID             PIC  X(08)      VALUE  "SSY9110L".
 01  WK-MSG1           PIC  N(14)
...
*--------------------------------------------------------------*
 ...
 LBLERR                 SECTION.
     ...
     DISPLAY  "### SSY9110L LBL ERROR " LBL-ST " "
 ...
 PRTERR                 SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY9110L PRTFILE ERROR " PRT-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     MOVE     4000           TO        PROGRAM-STATUS.
