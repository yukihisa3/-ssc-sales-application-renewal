...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH6401B.COB`
...
*ヘッドレコード退避ワーク
 01  WK-DEPB-REC.
     ...
     03  WK-DEPB10          PIC  X(20).
     03  WK-DEPB11          PIC  X(20).
     03  WK-DEPB12          PIC  X(20).
     03  WK-DEPB13          PIC  X(17).
     03  WK-DEPB14          PIC  X(02).
     03  WK-DEPB15          PIC  X(03).
     03  WK-DEPB16          PIC  X(04).
*    明細レコード退避ワーク
 01  WK-DEPD-REC.
     03  WK-DEPD01          PIC  X(01).
     03  WK-DEPD02          PIC  9(06).
     03  WK-DEPD03          PIC  9(07).
     03  WK-DEPD04          PIC  9(02).
     03  WK-DEPD05          PIC  9(13).
     03  WK-DEPD06          PIC  X(15).
     03  WK-DEPD07          PIC  X(25).
     03  WK-DEPD08          PIC  X(05).
     03  WK-DEPD09          PIC  X(05).
     03  WK-DEPD10          PIC  X(07).
     03  WK-DEPD11          PIC  X(05).
     03  WK-DEPD12          PIC  9(07).
     03  WK-DEPD13          PIC  9(05).
     03  WK-DEPD14          PIC  X(02).
     03  WK-DEPD15          PIC  9(06).
     03  WK-DEPD16          PIC  9(06)V9(02).
     03  WK-DEPD17          PIC  9(06).
     03  WK-DEPD18          PIC  X(03).
*
 01  WK-AREA.
*システム日付の編集
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH6401B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH6401B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    規格数値
     MOVE     WK-DEPD08     TO        HEN-A24.
*    規格単位
     MOVE     WK-DEPD09     TO        HEN-A25.
*    色
...
*    売価単価
     MOVE     WK-DEPD17     TO        HEN-A33.
*    空白
     MOVE     WK-DEPD18     TO        HEN-A34.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
...
*    商品名称マスタ検索
     ...
     READ    MEIMS1
       INVALID
*        商品名
         MOVE    HEN-A23(1:15)  TO   HEN-F1421(1:15)
         MOVE    HEN-A23(16:5)  TO   HEN-F1422(1:5)
         MOVE    HEN-A23(21:5)  TO   HEN-F1422(6:10)
       NOT INVALID
         MOVE    HEN-A23(1:15)  TO   HEN-F1421(1:15)
         MOVE    HEN-A23(16:5)  TO   HEN-F1422(1:5)
         MOVE    HEN-A23(21:5)  TO   HEN-F1422(6:10)
...
*原価金額
     COMPUTE     HEN-F181 = HEN-A31 * HEN-A32.
*売価金額
     COMPUTE     HEN-F182 = HEN-A31 * HEN-A33.
*店舗名（備考）
*****MOVE                  TO        HEN-F22.
*自社得意先コード
     IF  FLG-TOK   =    ZERO
...
*修正原価金額
     COMPUTE     HEN-F521 = HEN-A31 * HEN-A32.
*修正売価金額
     COMPUTE     HEN-F522 = HEN-A31 * HEN-A33.
*
 TENSO-EXIT.
     EXIT.
****************************************************************
