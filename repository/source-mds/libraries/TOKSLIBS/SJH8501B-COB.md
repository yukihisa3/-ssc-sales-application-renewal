...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SJH8501B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJH8501B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJH8501B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*各量販店領域転送
*    レコード区分
     MOVE     WK-DH01       TO        HEN-A01.
*    データ種別
     MOVE     WK-DH02       TO        HEN-A02.
*    取引先ＣＤ
     MOVE     WK-DH03       TO        HEN-A03.
*    法人ＣＤ
     MOVE     WK-DH04       TO        HEN-A04.
*    店ＣＤ
     MOVE     WK-DH05       TO        HEN-A05.
*    伝票番号
     MOVE     WK-DH06       TO        HEN-A06.
*    予備
     MOVE     WK-DH07       TO        HEN-A07.
*    部門
     MOVE     WK-DH08       TO        HEN-A08.
*    伝票区分
     MOVE     WK-DH09       TO        HEN-A09.
*    発注日
     MOVE     WK-DH10       TO        HEN-A10.
*    納品日
     MOVE     WK-DH11       TO        HEN-A11.
*    仕入先略称
     MOVE     WK-DH12       TO        HEN-A12.
*    社名
     MOVE     WK-DH13       TO        HEN-A13.
*    店名
     MOVE     WK-DH14       TO        HEN-A14.
*    伝票名称
     MOVE     WK-DH15       TO        HEN-A15.
*    伝票打出区分
     MOVE     WK-DH16       TO        HEN-A16.
*    納品開始日
     MOVE     WK-DH17       TO        HEN-A17.
*    納品終了日
     MOVE     WK-DH18       TO        HEN-A18.
*    予備
     MOVE     WK-DH19       TO        HEN-A19.
*    特売ＣＤ
     MOVE     WK-DH20       TO        HEN-A20.
*    館番号
     MOVE     WK-DH21       TO        HEN-A21.
*    納品先店舗ＣＤ
     MOVE     WK-DH22       TO        HEN-A22.
*    予備
     MOVE     WK-DH23       TO        HEN-A23.
*    レコード区分
     MOVE     WK-DD01       TO        HEN-A24.
*    データ種別
     MOVE     WK-DD02       TO        HEN-A25.
*    店ＣＤ
*****MOVE     WK-DD03       TO        HEN-A26.
*    伝票番号
     MOVE     WK-DD04       TO        HEN-A27.
*    伝票行番号
     MOVE     WK-DD05       TO        HEN-A28.
*    商品ＣＤ
     MOVE     WK-DD06       TO        HEN-A29.
*    商品種別
     MOVE     WK-DD07       TO        HEN-A30.
*    商品名１
     MOVE     WK-DD08       TO        HEN-A31.
*    商品名２
     MOVE     WK-DD09       TO        HEN-A32.
*    ＪＡＮＣＤ
     MOVE     WK-DD10       TO        HEN-A33.
*    発注数量
     MOVE     WK-DD11       TO        HEN-A34.
*    原価単価
     MOVE     WK-DD12       TO        HEN-A35.
*    総額売価
     MOVE     WK-DD13       TO        HEN-A36.
*    予備
     MOVE     WK-DD14       TO        HEN-A37.
*
     PERFORM  TENSO-SEC.
*    くろがねや出荷情報保存データ作成
*    ヘッダ部転送
...
*担当者コード
     MOVE        99        TO        HEN-F06.
*店コード
     MOVE        HEN-A05   TO        HEN-F07  JOH-F05.
*  商品変換テーブル検索
     MOVE        SPACE     TO        TBL-REC.
     INITIALIZE                      TBL-REC.
     MOVE        HEN-A01   TO        TBL-F01.
     MOVE        HEN-A33   TO        TBL-F02.
     READ    SHOTBL1
       INVALID
         MOVE    SPACE     TO        TBL-REC
         INITIALIZE                  TBL-REC
...
*****END-IF.
     MOVE        HEN-A11        TO   HEN-F112  JOH-F08A.
*分類（部門）
...
*        商品名（規格）
     ...
     END-READ.
*数量
     MOVE        HEN-A34   TO        HEN-F15.
*単
     MOVE       "1"        TO        HEN-F16.
*原価単価
     MOVE        HEN-A35   TO        HEN-F172.
*売価単価
     MOVE        HEN-A36   TO        HEN-F173.
*原価金額
...
*    ルート条件マスタ検索
     ...
     INITIALIZE                      RUT-REC.
     MOVE     HEN-A03      TO        RUT-F01.
     MOVE     SPACE        TO        RUT-F02.
     MOVE     HEN-A16      TO        RUT-F03  HEN-F42.
     READ     JHMRUTL1
         INVALID
           MOVE  1         TO        INV-RUT
...
*訂正前数量
     MOVE        HEN-A34   TO        HEN-F50.
*修正原価単価
     MOVE        HEN-A35   TO        HEN-F512.
*修正売価単価
     MOVE        HEN-A36   TO        HEN-F513.
*修正原価金額
     COMPUTE HEN-F521 = HEN-F15  *  HEN-F172.
*修正売価金額
     COMPUTE HEN-F522 = HEN-F15  *  HEN-F173.
*
 TENSO-EXIT.
     EXIT.
****************************************************************
