...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SNA0220B.COB`
...
*　日付論理チェック
 ...
 01  HEAD01.
     03  FILLER  PIC  X(08)  VALUE "SNA0220B".
...
****************************************************************
 INIT-SEC              SECTION.
     ...
     DISPLAY   "**  START SNA0220B  **"  UPON CONS.
...
*ファイル ＣＬＯＳＥ
     ...
     CLOSE  HTANMS.
     CLOSE  PRTFILE.
     DISPLAY   "**  END   SNA0220B  **"  UPON CONS.

 END-EXIT.
     EXIT.
*****************<<  SNA0220B   END PROGRAM  >>******************
