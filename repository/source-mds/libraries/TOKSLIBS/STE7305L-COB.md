...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/STE7305L.COB`
...
*
 ...
 01  WK-NOUSU           PIC S9(07)V9(1) VALUE  ZERO.
*----<< ｺﾞｳｹｲ ﾜｰｸ >>--*
 01  GOKEI-AREA.
 ...
 01  GK01.
     03  FILLER            CHARACTER TYPE PITCH-1-5.
         ...
         05  GK01-GKMEI    PIC  N(10)
                           VALUE  NC"伝　　票　　合　　計".
         05  FILLER        PIC  X(01)     VALUE  ALL SPACE.
...
*    03  LINK-SOKO          PIC  X(02).
*    03  LINK-STENCD        PIC  9(05).
*    03  LINK-ETENCD        PIC  9(05).
*    03  LINK-SNOUDT        PIC  9(08).
*    03  LINK-ENOUDT        PIC  9(08).
*    03  LINK-SDENNO        PIC  9(09).
*    03  LINK-EDENNO        PIC  9(09).
...
*----<< リック出荷情報ファイル >>--*
 DYSYUKF-ERR            SECTION.
     ...
     DISPLAY  "### STE7305L DYSYUKF ERROR " DYSYUKF-ST " "
...
*リック出荷確定データＲＥＡＤ
     ...
     INITIALIZE                        DYE-REC.
     MOVE     99999999            TO   DYE-F01.
     MOVE     9999                TO   DYE-F02.
...
*    発注日／店舗ＣＤ／部門ＣＤ／伝票区分／
*    ブレイク時改ページ
*    DISPLAY "DYE-F01  = " DYE-F01 "-" WK-DYE-F01 UPON CONS.
*    DISPLAY "DYE-F02  = " DYE-F02 "-" WK-DYE-F02 UPON CONS.
*    DISPLAY "DYE-F03  = " DYE-F03 "-" WK-DYE-F03 UPON CONS.
*    DISPLAY "DYE-F04  = " DYE-F04 "-" WK-DYE-F04 UPON CONS.
*    DISPLAY "DYE-F15  = " DYE-F15 "-" WK-DYE-F15 UPON CONS.
*    DISPLAY "DYE-F05  = " DYE-F05 "-" WK-DYE-F05 UPON CONS.
*    DISPLAY "DYE-F08  = " DYE-F08 "-" WK-DYE-F08 UPON CONS.
*    DISPLAY "DYE-F13  = " DYE-F13 "-" WK-DYE-F13 UPON CONS.
*    DISPLAY "DYE-F14  = " DYE-F14 "-" WK-DYE-F14 UPON CONS.
     ...
     OR       DYE-F14   NOT =  WK-DYE-F14
              IF    SET-CNT       >  ZERO
*              明細行出力
***************DISPLAY "SET-CNT =" SET-CNT UPON CONS
...
*    納品数量
     COMPUTE    WK-NOUSU   =   DYE-M09A /  10.
     MOVE   WK-NOUSU              TO   LST-NOHSU(IX2).
