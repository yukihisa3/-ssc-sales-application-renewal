...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY3797B.COB`
...
*    ｶｳﾝﾄ
 ...
 01  WK-CNT.
     ...
     03  DEL-CNT2            PIC  9(08)     VALUE  ZERO.
*
*ワーク項目
*
 01  WK-AREA.
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY3797B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY3797B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    繰返削除する。
     PERFORM  NFSUTEF-DELETE-SEC  UNTIL  END-FLG1 = "END".
*
 NFSUTEF-EXIT.
     EXIT.
****************************************************************
...
*    繰返削除する。
     PERFORM  NFHAKOF-DELETE-SEC  UNTIL  END-FLG2 = "END".
*
 NFHAKOF-EXIT.
     EXIT.
****************************************************************
...
*
     ...
     DISPLAY "## NFSUTEF DELETE CNT = " DEL-CNT1  UPON CONS.
     DISPLAY "## NFHAKOF READ   CNT = " READ-CNT2 UPON CONS.
     DISPLAY "## NFHAKOF DELETE CNT = " DEL-CNT2  UPON CONS.
*
