...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SJH8301L.COB`
...
*----<<北海道事業部>>----*
 ...
 01  HOH-REC            PIC  X(150).
*----<<東北　事業部>>----*
 FD  HOS
                        BLOCK CONTAINS 1 RECORDS.
 01  HOS-REC            PIC  X(150).
*----<<関東　事業部>>----*
 FD  HOK
                        BLOCK CONTAINS 1 RECORDS.
 01  HOK-REC            PIC  X(150).
*----<<プリントファイル>>----*
 FD  PRTFILE
...
*----<< ﾌｱｲﾙ ｽﾃｰﾀｽ >>--*
     ...
     03  PRT-ST         PIC  X(02).
*
 01  PG-ID             PIC  X(08)      VALUE  "SJH8301L".
 01  WK-MSG1           PIC  N(08)
                       VALUE NC"発注データ有り。".
 01  WK-MSG2           PIC  N(08)
                       VALUE NC"発注データ無し。".
...
*--------------------------------------------------------------*
 ...
 HOHERR                 SECTION.
     ...
     DISPLAY  "### SJH8301L HOH ERROR " HOH-ST " "
 ...
 HOSERR                 SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SJH8301L HOS ERROR " HOS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
 HOKERR                 SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SJH8301L HOK ERROR " HOK-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
 PRTERR                 SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SJH8301L PRTFILE ERROR " PRT-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
...
*--------------------------------------------------------------*
 100-INIT-RTN           SECTION.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "*** SJH8301L START *** "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS
                                       UPON CONS.
     OPEN     INPUT     HOH HOS HOK.
     OPEN     OUTPUT    PRTFILE.
*クリア
