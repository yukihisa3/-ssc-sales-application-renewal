...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SJH8701B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJH8701B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJH8701B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*
     ...
     DISPLAY NC"＃ＨＣ北海道ＣＮＴ＝"  JCA-CNT1  UPON CONS.
     DISPLAY NC"＃ＨＣ東北　ＣＮＴ＝"  JCA-CNT2  UPON CONS.
     DISPLAY NC"＃ＨＣ関東　ＣＮＴ＝"  JCA-CNT3  UPON CONS.
     DISPLAY NC"＃対象外　　ＣＮＴ＝"  JCA-CNT4  UPON CONS.
*
     STOP      RUN.
*
 END-EXIT.
