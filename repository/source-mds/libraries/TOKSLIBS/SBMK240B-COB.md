...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SBMK240B.COB`
...
*
 ...
 FILE-CONTROL.
*----<< 支払ワーク　　　 >>--*
     SELECT   BMSSIHF  ASSIGN         DA-01-VI-BMSSI2W1
                        ...
                        STATUS         SSI-ST.
*----<< 請求合計Ｆ >>--*
     SELECT   SETGKF    ASSIGN         DA-01-VI-SETGKFK3
                        ORGANIZATION   INDEXED
                        ACCESS    MODE RANDOM
