...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH1801B.COB`
...
*    ヘッドレコード退避ワーク
 01  WK-DENA.
     03  WK-DENA1.
         05  WK-DENA01       PIC  X(01).
         05  WK-DENA02       PIC  9(06).
         05  WK-DENA03       PIC  9(07).
     03  WK-DENA2.
         05  WK-DENA04       PIC  9(06).
         05  WK-DENA05       PIC  9(02).
         05  WK-DENA06       PIC  9(02).
         05  WK-DENA07       PIC  9(06).
         05  WK-DENA08       PIC  9(06).
         05  WK-DENA09       PIC  9(06).
         05  WK-DENA10       PIC  X(20).
         05  WK-DENA11       PIC  X(20).
         05  WK-DENA12       PIC  X(20).
         05  WK-DENA13       PIC  X(17).
     03  WK-DENA3.
         05  WK-DENA14       PIC  X(09).
*
*    明細レコード退避ワーク
 01  WK-DENB.
     03  WK-DENB1.
         05  WK-DENB21       PIC  X(01).
         05  WK-DENB22       PIC  9(06).
         05  WK-DENB23       PIC  9(07).
     03  WK-DENB2.
         05  WK-DENB24       PIC  9(02).
         05  WK-DENB25       PIC  9(13).
         05  WK-DENB26       PIC  X(15).
         05  WK-DENB27       PIC  X(25).
         05  WK-DENB28       PIC  X(05).
         05  WK-DENB29       PIC  X(05).
         05  WK-DENB30       PIC  X(07).
         05  WK-DENB31       PIC  X(05).
         05  WK-DENB32       PIC  9(07).
         05  WK-DENB33       PIC  9(05).
         05  WK-DENB34       PIC  X(02).
         05  WK-DENB35       PIC  9(06).
         05  WK-DENB36       PIC  9(06)V99.
         05  WK-DENB37       PIC  9(06).
     03  WK-DENB3.
         05  WK-DENB38       PIC  X(03).
*
 01  WK-AREA.
*システム日付の編集
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH1801B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH1801B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*各量販店領域転送
*    区分
     MOVE     WK-DENA01     TO        HEN-A01.
*    連_
     MOVE     WK-DENA02     TO        HEN-A02.
*    伝票_
     MOVE     WK-DENA03     TO        HEN-A03.
*    店コード
     MOVE     WK-DENA04     TO        HEN-A04.
*    分類
     MOVE     WK-DENA05     TO        HEN-A05.
*    伝区
     MOVE     WK-DENA06     TO        HEN-A06.
*    取引先コード
     MOVE     WK-DENA07     TO        WK-TORICD.
     MOVE     WK-TORICD-H   TO        HEN-A07.
*****MOVE     6002          TO        HEN-A07.
*****MOVE     WK-DENA07     TO        HEN-A07.
*    発注日
     MOVE     WK-DENA08     TO        HEN-A08.
*    納品日
     MOVE     WK-DENA09     TO        HEN-A09.
*    社名
     MOVE     WK-DENA10     TO        HEN-A10.
*    店名
     MOVE     WK-DENA11     TO        HEN-A11.
*    取引先名
     MOVE     WK-DENA12     TO        HEN-A12.
*    Ｅ欄
     MOVE     WK-DENA13     TO        HEN-A13.
*    区分
     MOVE     WK-DENB21     TO        HEN-A14.
*    行_
     MOVE     WK-DENB24     TO        HEN-A15.
*    商品コード
     MOVE     WK-DENB25     TO        HEN-A16.
*    メーカーブランド名
     MOVE     WK-DENB26     TO        HEN-A17.
*    商品名
     MOVE     WK-DENB27     TO        HEN-A18.
*    数値
     MOVE     WK-DENB28     TO        HEN-A19.
*    単位
     MOVE     WK-DENB29     TO        HEN-A20.
*    色
     MOVE     WK-DENB30     TO        HEN-A21.
*    サイズ
     MOVE     WK-DENB31     TO        HEN-A22.
*    入数
     MOVE     WK-DENB32     TO        HEN-A23.
*    ケース
     MOVE     WK-DENB33     TO        HEN-A24.
*    発注単位
     MOVE     WK-DENB34     TO        HEN-A25.
*    数量
     MOVE     WK-DENB35     TO        HEN-A26.
*    原単価
     MOVE     WK-DENB36     TO        HEN-A27.
*    売単価
     MOVE     WK-DENB37     TO        HEN-A28.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
...
*  商品変換テーブル検索
     ...
     INITIALIZE                      TBL-REC.
     MOVE        HEN-A07   TO        TBL-F01.
     MOVE        HEN-A16   TO        TBL-F02.
     READ    SHOTBL1
       INVALID
         MOVE    SPACE     TO        TBL-REC
         INITIALIZE                  TBL-REC
...
*    商品名称マスタ検索
     ...
     READ    MEIMS1
       INVALID
*        商品名
         MOVE    HEN-A18(1:15)  TO   HEN-F1421
         MOVE    HEN-A18(16:10) TO   HEN-F1422
       NOT INVALID
         MOVE    HEN-A18(1:15)  TO   HEN-F1421
         MOVE    HEN-A18(16:10) TO   HEN-F1422
     END-READ.
*数量
     MOVE        HEN-A26   TO        HEN-F15.
*単
     MOVE       "1"        TO        HEN-F16.
*原価単価
     MOVE        HEN-A27   TO        HEN-F172.
*売価単価
     MOVE        HEN-A28   TO        HEN-F173.
*原価金額
     COMPUTE     HEN-F181 = HEN-A26 *  HEN-A27.
*売価金額
     COMPUTE     HEN-F182 = HEN-A26 *  HEN-A28.
*店舗名（備考）
...
*訂正前数量
     MOVE        HEN-A26   TO        HEN-F50.
*修正原価単価
     MOVE        HEN-A27   TO        HEN-F512.
*修正売価単価
     MOVE        HEN-A28   TO        HEN-F513.
*修正原価金額
     COMPUTE     HEN-F521 = HEN-A26 *  HEN-A27.
*修正売価金額
     COMPUTE     HEN-F522 = HEN-A26 *  HEN-A28.
*
 TENSO-EXIT.
     EXIT.
****************************************************************
