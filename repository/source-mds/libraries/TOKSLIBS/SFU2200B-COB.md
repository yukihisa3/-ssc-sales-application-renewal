...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SFU2200B.COB`
...
**** メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SFU2200B".
...
*更新判定
     EVALUATE   WRK-F01
         WHEN   "2920"
                ...
                ADD   1         TO   HON-CNT
*               ｽﾄｯｸ_ﾁｪｯｸ
                PERFORM  SUTOKU-HON-SEC
         WHEN   "2940"
                MOVE  WRK-REC   TO   FUK-REC
                WRITE FUK-REC
                ADD   1         TO   FUK-CNT
*               ｽﾄｯｸ_ﾁｪｯｸ
                PERFORM  SUTOKU-KYU-SEC
         WHEN   "2921"
...
*             特販部内の場合
         WHEN "1"        ALSO "1"
*             IF    WRK-F16 = "1"
*             AND ( WRK-F02 = 70   OR  WRK-F02 = 71 )
*             IF  ( WRK-F02 = 70   OR  WRK-F02 = 71 )
...
*             END-IF
*             IF    WRK1-F16 = "1"
*             AND ( WRK1-F02 = 70   OR  WRK1-F02 = 71 )
              IF  ( WRK1-F02 = 70   OR  WRK1-F02 = 71 )
                    MOVE  SPACE     TO   SHO-REC
                    INITIALIZE           SHO-REC
                    MOVE  WRK-REC   TO   SHO-REC
