...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/STE2502B.COB`
...
*プリンター
 FD  PRTF
     ...
     COPY        FTE25021  OF        XMDLIB.
*表示ファイル
 FD  DSPF
     LABEL       RECORD    IS        OMITTED.
     COPY        FTE25012   OF        XMDLIB.
******************************************************************
...
*****MOVE        DEN-F25   TO        W016(I).
     MOVE        DEN-F25(1:7) TO     W016(I).
     MOVE        DEN-F25(8:6) TO     W999(I).
*数量
