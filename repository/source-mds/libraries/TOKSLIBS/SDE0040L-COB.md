...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SDE0040L.COB`
...
****  見出し行１             ****
 01  MIDASI-1.
     ...
     02  FILLER              PIC  X(08)  VALUE  "SDE0040L".
...
****  明細行８               ****
 01  MEISAI-8.
     02  FILLER              PIC  X(33) VALUE  SPACE.
     02  FILLER              PIC  N(09) VALUE
         NC"売上伝票件数　　：" CHARACTER TYPE  IS YB-21.
     02  FILLER              PIC  X(02) VALUE  SPACE.
...
****  明細行９               ****
 01  MEISAI-9.
     02  FILLER              PIC  X(33) VALUE  SPACE.
     02  FILLER              PIC  N(09) VALUE
         NC"返品伝票件数　　：" CHARACTER TYPE  IS YB-21.
     02  FILLER              PIC  X(02) VALUE  SPACE.
...
****  明細行10               ****
 01  MEISAI-10.
     02  FILLER              PIC  X(33) VALUE  SPACE.
     02  FILLER              PIC  N(09) VALUE
         NC"値引伝票件数　　：" CHARACTER TYPE  IS YB-21.
     02  FILLER              PIC  X(02) VALUE  SPACE.
...
****  明細行11               ****
 01  MEISAI-11.
     02  FILLER              PIC  X(33) VALUE  SPACE.
     02  FILLER              PIC  N(09) VALUE
         NC"エラー　件数　　：" CHARACTER TYPE  IS YB-21.
     02  FILLER              PIC  X(02) VALUE  SPACE.
...
*実行区分
     ...
     END-EVALUATE.
*ＥＸＣＥＬ種別
     EVALUATE PAR-IN-EXCEL
        WHEN  "1"
          MOVE NC"伝票入力形式＿伝票番号指定"     TO EXCEL
        WHEN  "2"
          MOVE NC"伝票入力形式＿伝票番号自動採番" TO EXCEL
        WHEN  "3"
          MOVE NC"量販店入力形式＿伝票自動採番"   TO EXCEL
        WHEN  OTHER
          MOVE NC"＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊" TO EXCEL
     END-EVALUATE.
*取込件数
...
**************
     ...
     WRITE      P-REC   FROM    MEISAI-1-2 AFTER  3.
