...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8323B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY8323B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY8323B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*納品予定数量
 01  WK-NOUHIN.
     ...
     03  NOU-F01           PIC  9(05)   VALUE  ZERO.
     03  FILLER            PIC  X(08)   VALUE  SPACE.
...
*    納品数量
     ...
     COMPUTE   NOU-F02  =  DEN-F15  *  HCS-M17.
     MOVE      WK-NOUHIN           TO  HCS-A36  HCJ-A39.
*    納品原価金額
     MOVE     SPACE                TO  WK-GENKA.
     INITIALIZE                        WK-GENKA.
     COMPUTE   GEN-F01  =  DEN-F15  *  ( HCS-M16 / 100 ).
     MOVE      WK-GENKA            TO  HCS-A39  HCJ-A39.
*    欠品区分
     IF        HCS-M10  >  ZERO
               MOVE   10           TO  HCS-M20
     END-IF.
*2007/05/01 NAV TAKAHASHI ST 納品予定日追加
     INITIALIZE                        WK-A05.
*2007/05/28 NAV TAKAHASHI ST 出荷日追加
*****MOVE      HCS-F06             TO  WK-A053.
     MOVE      HCS-F06             TO  WK-A053  WK-A052.
*2007/05/28 NAV TAKAHASHI ED 出荷日追加
     MOVE      WK-A05              TO  HCS-A05.
*2007/05/01 NAV TAKAHASHI ED 納品予定日追加
*    ダミーセット
