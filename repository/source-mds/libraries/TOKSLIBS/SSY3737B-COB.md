...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY3737B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY3737B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY3737B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
****************************************************************
 INIT-SEC               SECTION.
     ...
     INITIALIZE                   WRK-AREA.
     OPEN     INPUT     TRKAKUF  NFSHOMS  HSHOTBL  HMEIMS
                        HTOKMS   HTENMS
...
*****特値区分判断
     IF  KAK-F11I  NOT =  SPACE
         EVALUATE KAK-F11I
             WHEN "0"
             MOVE  NFM-F11      TO  DEN-F172
             MOVE  NFM-F12      TO  DEN-F173
             WHEN "1"
             MOVE  NFM-F13      TO  DEN-F172
             MOVE  NFM-F14      TO  DEN-F173
             WHEN "2"
             MOVE  NFM-F15      TO  DEN-F172
             MOVE  NFM-F16      TO  DEN-F173
             WHEN "3"
             MOVE  NFM-F17      TO  DEN-F172
             MOVE  NFM-F18      TO  DEN-F173
             WHEN "4"
             MOVE  NFM-F19      TO  DEN-F172
             MOVE  NFM-F20      TO  DEN-F173
             WHEN "5"
             MOVE  NFM-F21      TO  DEN-F172
             MOVE  NFM-F22      TO  DEN-F173
             WHEN OTHER
             MOVE  TBL-F05      TO  DEN-F172
             MOVE  TBL-F06      TO  DEN-F173
         END-EVALUATE
...
*****MOVE    KAK-F110           TO  DEN-F68.
     MOVE    KAK-F110           TO  DEN-F68    DEN-F413.
*2013/01/25 NAV ED
     MOVE    KAK-F116           TO  DEN-F69.
     MOVE    KAK-F11G           TO  DEN-F70.
     MOVE    KAK-F11H           TO  DEN-F71.
     MOVE    KAK-F11D           TO  DEN-F72.
     WRITE   DEN-REC.
