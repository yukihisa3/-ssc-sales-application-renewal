...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH6101B.COB`
...
*ヘッドレコード退避ワーク
 01  WK-DEPB-REC.
     ...
     03  WK-DEPB07          PIC  X(04).
     03  WK-DEPB08          PIC  9(02).
     03  WK-DEPB09          PIC  9(06).
     03  WK-DEPB10          PIC  9(06).
     03  WK-DEPB11          PIC  9(06).
     03  WK-DEPB12          PIC  9(02).
     03  WK-DEPB13          PIC  X(12).
     03  WK-DEPB14          PIC  X(08).
     03  WK-DEPB15          PIC  X(15).
     03  WK-DEPB16          PIC  X(05).
     03  WK-DEPB17          PIC  X(25).
...
*    明細レコード退避ワーク
 01  WK-DEPD-REC.
     ...
     03  WK-DEPD15          PIC  X(05).
     03  WK-DEPD16          PIC  X(01).
     03  WK-DEPD17          PIC  X(04).
     03  WK-DEPD18          PIC  X(10).
*
 01  WK-AREA.
*システム日付の編集
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH6101B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH6101B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    売価値入率
     MOVE     WK-DEPD17     TO        HEN-A38.
*    予備
     MOVE     WK-DEPD18     TO        HEN-A39.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
...
*取引先コード
     MOVE    HEN-A11       TO        HEN-F01.
     MOVE    HEN-A11       TO        WK-TOKCD.
*伝票ナンバー
...
*分類（部門）
     MOVE        HEN-A07   TO        HEN-F12.
*商品区分　　
     MOVE        SPACE     TO        HEN-F131.
*伝票区分（発注区分）
     MOVE        HEN-A08   TO        HEN-F132.
*伝発区分
     MOVE        9         TO        HEN-F134.
*自社商品コード
...
*    商品名称マスタ検索
     ...
     READ    MEIMS1
       INVALID
*        商品名
         MOVE    HEN-A35(1:15)  TO   HEN-F1421(1:15)
         MOVE    HEN-A35(16:5)  TO   HEN-F1422(1:5)
         MOVE    HEN-A35(21:5)  TO   HEN-F1422(6:10)
       NOT INVALID
         MOVE    HEN-A35(1:15)  TO   HEN-F1421(1:15)
         MOVE    HEN-A35(16:5)  TO   HEN-F1422(1:5)
         MOVE    HEN-A35(21:5)  TO   HEN-F1422(6:10)
...
*原価金額
     COMPUTE     HEN-F181 = HEN-A29 * HEN-A30.
*売価金額
     COMPUTE     HEN-F182 = HEN-A29 * HEN-A31.
*店舗名（備考）
*****MOVE                  TO        HEN-F22.
*自社得意先コード
     IF  FLG-TOK   =    ZERO
...
*訂正前数量
     MOVE        HEN-A29   TO        HEN-F50.
*修正原価単価
     MOVE        HEN-A30   TO        HEN-F512.
*修正売価単価
     MOVE        HEN-A31   TO        HEN-F513.
*修正原価金額
     COMPUTE     HEN-F521 = HEN-A29 * HEN-A30.
*修正売価金額
     COMPUTE     HEN-F522 = HEN-A29 * HEN-A31.
*
 TENSO-EXIT.
     EXIT.
****************************************************************
