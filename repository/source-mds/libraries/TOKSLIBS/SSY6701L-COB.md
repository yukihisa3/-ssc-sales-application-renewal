...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY6701L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*伝票データ（共通）　　
     SELECT   MHSHIRED  ASSIGN    TO        MHSHIRED
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      MHSHIRED.
...
*明細１行目
***  商品名
     MOVE     DEN-A37             TO        DT1-01.
***  自社品番
     MOVE     DEN-A39             TO        DT1-02.
***  カラー名
***  サイズ名
...
*明細２行目
***  商品名（規格）
     MOVE     DEN-A38             TO        DT2-01.
***  商品コード（ＪＡＮＣＤ）
     MOVE     DEN-A40             TO        DT2-02.
***  入数
     MOVE     DEN-A41             TO        DT2-03.
***  発注単位数（ケース）
     MOVE     DEN-A42             TO        DT2-04.
***  単位
*
***  数量
...
*ヘッダ１行目
***  コメント
     MOVE    "*** ｵﾝﾗｲﾝTA ***"    TO        HD1-01.
*
*ヘッダ２行目
***  支払条件
     MOVE     DEN-A26             TO        HD6-01.
***  分割回数
     MOVE     DEN-A27             TO        HD6-02.
***  ルート名
     IF       DEN-A24 NOT = ZERO
              MOVE DEN-A10(21:20) TO        HD6-03
     END-IF.
*
*ヘッダ３行目
***  社名
     MOVE     DEN-A09             TO        HD3-01.
***  取引先名（上段）
     MOVE     DEN-A29(1:20)       TO        HD3-02.
*
*ヘッダ４行目
***  取引先名（中段）
     MOVE     DEN-A29(21:20)      TO        HD4-01.
*
*ヘッダ５行目
***  店名
     MOVE     DEN-A28             TO        HD5-01.
***  店舗ＣＤ
     MOVE     DEN-A18(1:2)        TO        HD5-021.
     MOVE     DEN-A18(3:2)        TO        HD5-022.
***  分類ＣＤ
     MOVE     DEN-A19             TO        HD5-03.
***  伝票区分
*****MOVE     DEN-A29             TO        HD5-04.
***  伝票_
     MOVE     DEN-F02(2:1)        TO        HD5-051.
     MOVE     DEN-F02(3:7)        TO        HD5-052.
***  取引先コード
     MOVE     DEN-F01             TO        HD5-06.
***  発注日
     MOVE     DEN-A20             TO        HD5-07.
***  納品日
     IF       DEN-A21 NOT = ZERO
              MOVE     DEN-A21    TO        HD5-08
     END-IF.
***  便（引取のとき）
*    MOVE    "***"                TO        HD5-09.
*
...
*項目クリア
     MOVE     SPACE               TO   HD1 HD2 HD3 HD4 HD5 HD6
                                       ...
                                       TL1 TL2 TL3.
*テスト印字項目セット
     MOVE   ALL "9"              TO   HD5-02  HD5-03  HD5-04
                                      HD5-05  HD5-06  HD5-07
                                      HD5-09  HD6-01  HD6-02
                                      DT2-03  DT2-04  DT2-061
                                      DT2-081 DT2-09  DT2-10
                                      DT2-11
                                      TL1-011 TL1-021 TL1-03
                                      TL1-04  TL3-01.
     MOVE   ALL "*"              TO   HD1-01  HD2-02  HD3-01
                                      HD4-01  HD5-01  HD5-08
                                      HD2-03  HD3-02  HD6-03
                                      DT1-01  DT1-02
*****                                 DT1-01  DT1-021 DT1-022
*****                                 DT1-023 DT1-03  DT1-04
                                      DT2-01  DT2-02.
     MOVE   NC"＊"               TO   HD2-01.
*ヘッダ部
     WRITE    PRT-REC          FROM   HD1    AFTER    2.
...
*
     CLOSE    MHSHIRED   PRTFILE    DSPFILE.
*
 END-EXIT.
     EXIT.
