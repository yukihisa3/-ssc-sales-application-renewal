...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8733L.COB`
...
*
 ...
 FILE-CONTROL.
****<<DCMJAPAN物品受領データ >>*********************************
     SELECT   DCMJYUF            ASSIGN    TO   DA-01-VI-DCMJYUL2
...
***** メッセージエリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY8733L".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY8733L".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND1.
...
*****03  MD01-GENTANKA            PIC       -,---,--9.
     03  MD01-GENTANKA            PIC       ---,--9.
*#2019/09/17 NAV ED 消費税軽減税率対応 -2
     03  FILLER                   PIC       X(01)  VALUE  SPACE.
*#2019/09/17 NAV ST 消費税軽減税率対応
*****03  MD01-GENKAKIN            PIC       --,---,--9.
*****03  FILLER                   PIC       X(03)  VALUE  SPACE.
     03  MD01-GENKAKIN            PIC       -,---,--9.
*#2019/09/17 NAV ED 消費税軽減税率対応 -4
     03  MD01-KU1                 PIC       X(01).
     03  MD01-KEPPIN              PIC       ---,---.
     03  MD01-KU2                 PIC       X(01).
*#2019/09/17 NAV ST 消費税軽減税率対応
     03  FILLER                   PIC       X(01)  VALUE  SPACE.
     03  MD01-ZEIRITU             PIC       ZZZ.
     03  MD01-ZEIRITU-N           PIC       X(01).
*#2019/09/17 NAV ED 消費税軽減税率対応
*
***** 合計１
...
*             プロセス                      0.0                *
****************************************************************
 SSY8733L-START         SECTION.
*
     MOVE   "SSY8733L-START"      TO   S-NAME.
     PERFORM            INIT-SEC.
*
...
*    ホーマック物品受領書データ読込み
****************************************************************
 DCMJYUF-RD-SEC             SECTION.
*
     MOVE    "DCMJYUF-RD-SEC"    TO   S-NAME.
*
     READ     DCMJYUF
          AT END
              MOVE     "END"      TO        END-FLG
...
*事業部名称セット
     EVALUATE PARA-TOKCD
         WHEN 880     MOVE NC"ＨＣ関東資材　" TO  HD01-JIGYOBU
         WHEN 882     MOVE NC"ＨＣ東北資材　" TO  HD01-JIGYOBU
         WHEN 883     MOVE NC"ＨＣ北海道資材" TO  HD01-JIGYOBU
         WHEN 1427    MOVE NC"ＨＣ関東植物　" TO  HD01-JIGYOBU
         WHEN 14272   MOVE NC"ＨＣ東北植物　" TO  HD01-JIGYOBU
         WHEN 14273   MOVE NC"ＨＣ北海道植物" TO  HD01-JIGYOBU
         WHEN 13938   MOVE NC"カーマ　資材西" TO  HD01-JIGYOBU
         WHEN 17137   MOVE NC"カーマ　植物西" TO  HD01-JIGYOBU
*#2017/03/22 NAV ST
         WHEN 139381  MOVE NC"カーマ　資材東" TO  HD01-JIGYOBU
         WHEN 171371  MOVE NC"カーマ　植物東" TO  HD01-JIGYOBU
*#2017/03/22 NAV ED
         WHEN 100403  MOVE NC"　ダイキ資材１" TO  HD01-JIGYOBU
         WHEN 100441  MOVE NC"　ダイキ資材２" TO  HD01-JIGYOBU
         WHEN 100427  MOVE NC"　ダイキ植物　" TO  HD01-JIGYOBU
*#2018/02/22 NAV ST
         WHEN 1731    MOVE NC"ケーヨー資材東" TO  HD01-JIGYOBU
         WHEN 1732    MOVE NC"ケーヨー資材西" TO  HD01-JIGYOBU
         WHEN 7601    MOVE NC"ケーヨー植物東" TO  HD01-JIGYOBU
         WHEN 7602    MOVE NC"ケーヨー植物西" TO  HD01-JIGYOBU
*#2018/02/22 NAV ED
         WHEN OTHER   MOVE NC"＊＊＊＊＊＊＊" TO  HD01-JIGYOBU
     END-EVALUATE.
*頁セット
     ADD      1              TO   P-CNT.
...
*#############2019/09/17 NAV ST 消費税軽減税率対応
              COMPUTE MD01-ZEIRITU = JYU-F18 / 1000
              MOVE  "%"      TO   MD01-ZEIRITU-N
*#############2019/09/17 NAV ED 消費税軽減税率対応
         WHEN 02 WHEN 03
