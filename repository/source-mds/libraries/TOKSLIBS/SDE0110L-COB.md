...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SDE0110L.COB`
...
*
 01  HEAD01.
     03  FILLER         CHARACTER TYPE BAIKAKU-1-5.
         ...
         05  FILLER     PIC  X(08)     VALUE  "SDE0110L".
...
*
 01  MEIS015.
     03  FILLER         CHARACTER TYPE MODE-2.
         05  FILLER     PIC  X(04).
         05  ME015-01   PIC  N(07).
         05  FILLER     PIC  X(01).
         05  ME015-02   PIC  X(20).
         05  FILLER     PIC  X(01).
         05  ME015-03   PIC  N(01).
*#2020/04/16 NAV ED
*
 01  MEIS02.
     03  FILLER.
...
*----<< 伝票データ >>--*
 URIXXXF-ERR            SECTION.
     ...
     DISPLAY  "### SDE0110L URIXXXF ERROR " URIXXXF-ST " "
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SDE0110L HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 店舗マスタ >>--*
 HTENMS-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SDE0110L HTENMS ERROR " HTENMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 担当者マスタ >>--*
 HTANMS-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SDE0110L HTANMS ERROR " HTANMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*
*#2020/04/16 NAV ST
     MOVE     SPACE          TO   MEIS015.
     MOVE     NC"【Ｄ３６５連携"  TO  ME015-01.
     MOVE     URI-D99        TO   ME015-02.
     MOVE     NC"】"         TO   ME015-03.
*#2020/04/16 NAV ED
*
