...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY3720I.COB`
...
****************************************************************
 END-SEC               SECTION.
*ファイル ＣＬＯＳＥ
     CLOSE             NFHAKOF  NFSUTEF  DSPFILE.
**
 END-EXIT.
     EXIT.
*****************<<  SSY3720I   END PROGRAM  >>******************
