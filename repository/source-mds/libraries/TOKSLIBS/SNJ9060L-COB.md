...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SNJ9060L.COB`
...
*    サブシステム　　　　：　受配信                            *
*    モジュール名　　　　：　伝票更新結果リスト                *
*    作成日／作成者　　　：　2010/09/03 T.TAKAHASHI            *
*    更新日／更新者　　　：　　　　　　                        *
*    処理概要　　　　　　：　　　　　　　　　　　　　　　　　　*
*                                                              *
****************************************************************
