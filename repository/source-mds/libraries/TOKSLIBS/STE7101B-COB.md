...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/STE7101B.COB`
...
*   システム名    ：   販売管理システム                   *
*   サブシステム名：   手書伝票発行　                     *
*   プログラム名　：   ジョイフル本田手書伝票発行　　　　 *
*   プログラムID  ：   STE7101B                           *
*   作成者        ：   ナブ・アシスト　                   *
*   作成日        ：   2010.02.08                         *
*   更新日        ：                                      *
*   更新日／更新者：   2012.02.23 / MIURA                 *
*   更新概要      ：   基幹サーバ統合                     *
*   更新日／更新者：   2018.06.11 / T.TAKAHASHI           *
*   更新概要      ：   ＰＯＳシステム導入伴う変更　店舗CD *
***********************************************************
...
***  ﾜｰｸ  ｴﾘｱ
 01  WRK-AREA.
     03  WK-TORICD                PIC  9(08)     VALUE   2243.
...
*****03  HD001                    PIC  X(05) VALUE "ｼﾞｬｽｺ".
     03  HD001                    PIC  X(10) VALUE "ｼﾞｮｲﾌﾙﾎﾝﾀﾞ".
*
