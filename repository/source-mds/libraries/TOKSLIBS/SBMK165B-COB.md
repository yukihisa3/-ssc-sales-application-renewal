...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SBMK165B.COB`
...
*
 ...
 FILE-CONTROL.
*返品伝票メッセージ受信日
     SELECT   BMSHEPL2  ASSIGN    TO        DA-01-VI-BMSHEPL2
...
*返品伝票メッセージ計上日
     SELECT   BMSHEPL3  ASSIGN    TO        DA-01-VI-BMSHEPL3
                        ORGANIZATION        INDEXED
                        ACCESS    MODE      SEQUENTIAL
                        RECORD    KEY       HEP2-F013 HEP2-F330
                        FILE  STATUS   IS   HEP2-STS.
*返品伝票ワークＶＥＲ２
     SELECT   BMSHE2W   ASSIGN    TO        DA-01-VS-BMSHE2W
...
*    返品伝票メッセージ受信日　　　　
******************************************************************
 FD  BMSHEPL2           LABEL RECORD   IS   STANDARD.
     COPY     BMSHEPF   OF        XFDLIB
              JOINING   HEP1      PREFIX.
******************************************************************
*    返品伝票メッセージ計上日　　　　
******************************************************************
 FD  BMSHEPL3           LABEL RECORD   IS   STANDARD.
     COPY     BMSHEPF   OF        XFDLIB
              JOINING   HEP2      PREFIX.
******************************************************************
*    返品伝票ワーク
******************************************************************
 FD  BMSHE2W            LABEL RECORD   IS   STANDARD.
...
* 2023/10/23 ARK ADD START
 ...
 01  WK-JIYU-R             REDEFINES  WK-JIYU.
     03  WK-JIYUH1         PIC  X(08).
     03  WK-JIYUH2         PIC  X(112).
* 2023/10/23 ARK ADD END
*
 01  MSG-AREA.
     03  MSG-START.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  ST-PG          PIC   X(08)  VALUE "SBMK165B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SBMK165B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
* 受信日順
     START  BMSHEPL2 KEY  IS  >=  HEP1-F013   HEP1-F011
                                  HEP1-F012
            INVALID
            MOVE    "END"         TO   END-FLG
     END-START.
...
* 計上日順
     START  BMSHEPL3 KEY  IS  >=  HEP2-F013   HEP2-F330
*
            INVALID
            MOVE    "END"         TO   END-FLG
     END-START.
...
*返品伝票ワ－ク出力
     DISPLAY "BMSHE2W  WRITE CNT = " WRITE-CNT UPON CONS.
     IF  PARA-HSYU  =  "1"
         CLOSE  BMSHEPL2
     END-IF.
     IF  PARA-HSYU  =  "2"
...
*
     ...
     MOVE     WHEP-F412      TO  HEW-F11.
     MOVE     WHEP-F416      TO  HEW-F12.
     MOVE     WHEP-F419      TO  HEW-F13.
...
*    2013/03/06↓　SBM0165Bとの相違項目
     MOVE     WHEP-F344      TO  HEW-F19.
*    2013/03/06↑　SBM0165Bとの相違項目
* 2023/10/23 ARK ADD START
     MOVE     WHEP-F343      TO  WK-JIYU.
     MOVE     WK-JIYUH1      TO  HEW-F20.
* 2023/10/23 ARK ADD END
*
