...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SJK0040I.COB`
...
*    処理概要　　　　　　：　自動欠品処理取消の指示を行う　　　*
*                        ：　　　　　　　　　　　　　　　　　　*
*    更新日／更新者　　　：　2017/12/21 NAV TAKAHASHI          *
*    更新概要　　　　　　：　自動欠品Ｆスタート時の振分倉庫の　*
*                            初期値を変更                      *
****************************************************************
****************************************************************
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SJK0040I DSPFILE ERROR " DSP-CNTL " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
     CLOSE    SHTDENF   HTOKMS    JIDKEKF    DSPFILE.
     STOP     RUN.
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SJK0040I HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 売上伝票ファイル >>--*
 SHTDENF-ERR            SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SJK0040I SHTDENF ERROR " SHTDENF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 自動欠品結果ファイル >>--*
 JIDKEKF-ERR            SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SJK0040I JIDKEKF ERROR " JIDKEKF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FJK00401.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "SJK0040I"      TO   PGID.
     MOVE    "FJK00401"      TO   FORM.
*
     MOVE     SPACE          TO   DSP-CNTL.
     MOVE     "FJK00401"     TO   DSP-FMT.
...
*
*----<< キー項目セット >>--*
     MOVE      JDATE              TO   JID-F46.
     MOVE      JTIME              TO   JID-F47.
     MOVE      TORICD             TO   JID-F01.
*#2017/12/21 NAV ST
*****MOVE      ZERO               TO   JID-F48.
     MOVE      SPACE              TO   JID-F48.
*#2017/12/21 NAV ED
     MOVE      ZERO               TO   JID-F02.
     MOVE      ZERO               TO   JID-F04.
     MOVE      ZERO               TO   JID-F051.
     MOVE      ZERO               TO   JID-F07.
     MOVE      ZERO               TO   JID-F112.
     MOVE      ZERO               TO   JID-F03.
*
*----<< FILE START >>--*
     START     JIDKEKF   KEY  >=   JID-F46   JID-F47
                                   JID-F01   JID-F48
                                   JID-F02   JID-F04
                                   JID-F051  JID-F07
                                   JID-F112  JID-F03
