...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH6701B.COB`
...
*ファイルヘッドレコード退避ワーク
 01  WK-DEPA-REC.
     ...
     03  WK-DEPA11          PIC  X(08).
     03  WK-DEPA12          PIC  9(08).
     03  WK-DEPA13          PIC  9(06).
     03  WK-DEPA14          PIC  9(02).
     03  WK-DEPA15          PIC  9(01).
     03  WK-DEPA16          PIC  9(06).
*ヘッドレコード退避ワーク
 01  WK-DEPB-REC.
     ...
     03  WK-DEPB14          PIC  X(07).
     03  WK-DEPB15          PIC  9(08).
     03  WK-DEPB16          PIC  9(06).
     03  WK-DEPB17          PIC  9(02).
...
*    明細レコード退避ワーク
 01  WK-DEPD-REC.
     ...
     03  WK-DEPD11          PIC  9(17).
     03  WK-DEPD12          PIC  9(08).
     03  WK-DEPD13          PIC  9(06).
     03  WK-DEPD14          PIC  9(02).
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH6701B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH6701B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    ルートコード
     MOVE     WK-DEPA14     TO        HEN-A14.
*    ヘッダフラグ
     MOVE     WK-DEPA15     TO        HEN-A15.
*    ＳＥＱ－_
     MOVE     WK-DEPA16     TO        HEN-A16.
*伝票ヘッダー転送
*    レコード区分（ＤＨ）
...
*    発注日
     MOVE     WK-DEPB04     TO        HEN-A20.
*    納入指定日
     MOVE     WK-DEPB05     TO        HEN-A21.
*    伝票番号
     MOVE     WK-DEPB06     TO        HEN-A22.
*    取引先コード
     MOVE     WK-DEPB07     TO        HEN-A23.
*    ルートコード
     MOVE     WK-DEPB08     TO        HEN-A24.
*    申請書_
     MOVE     WK-DEPB09     TO        HEN-A25.
*    支払条件
     MOVE     WK-DEPB10     TO        HEN-A26.
*    分割回数
     MOVE     WK-DEPB11     TO        HEN-A27.
*    店名
     MOVE     WK-DEPB12     TO        HEN-A28.
*    取引先名
     MOVE     WK-DEPB13     TO        HEN-A29.
*    ダミー
     MOVE     WK-DEPB14     TO        HEN-A30.
*    ＶＡＮＣＤ
     MOVE     WK-DEPB15     TO        HEN-A31.
*    取引先コード
...
*    取引先コード
     MOVE     WK-DEPD13     TO        HEN-A48.
*    ルート
     MOVE     WK-DEPD14     TO        HEN-A49.
*    ヘッダーフラグ
     MOVE     WK-DEPD15     TO        HEN-A50.
*    ＳＥＱ _
     MOVE     WK-DEPD16     TO        HEN-A51.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
...
*取引先コード
     MOVE    HEN-A23       TO        HEN-F01.
     MOVE    HEN-A23       TO        WK-TOKCD.
*伝票ナンバー
     MOVE    HEN-A22       TO        HEN-F02.
     MOVE    HEN-A22       TO        HEN-F23.
*行_
...
*担当者コード
     MOVE        99        TO        HEN-F06.
*店コード
     MOVE    HEN-A18       TO        HEN-F07.
*  商品変換テーブル検索
     MOVE        SPACE     TO        TBL-REC.
     INITIALIZE                      TBL-REC.
     MOVE        HEN-F01   TO        TBL-F01.
     MOVE        HEN-A39   TO        TBL-F02.
     READ    SHOTBL1
       INVALID
         MOVE    SPACE     TO        TBL-REC
         INITIALIZE                  TBL-REC
