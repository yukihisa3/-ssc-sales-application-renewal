...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH2501B.COB`
...
*    ヘッドレコード退避ワーク
 01  WK-DH-REC.
     ...
     03  WK-DH03                  PIC       X(09).
     03  WK-DH04.
         05  WK-DH041             PIC       X(04).
         05  WK-DH042             PIC       X(05).
     03  WK-DH05                  PIC       X(04).
     03  WK-DH06                  PIC       X(02).
     03  WK-DH07                  PIC       9(06).
     03  WK-DH08                  PIC       9(06).
     03  WK-DH09.
         05  WK-DH091             PIC       X(06).
         05  WK-DH092             PIC       X(02).
     03  WK-DH10                  PIC       X(20).
     03  WK-DH11                  PIC       X(30).
     03  WK-DH12                  PIC       X(22).
     03  WK-DH13                  PIC       X(01).
...
*    明細レコード退避ワーク
 01  WK-DD-REC.
     ...
     03  WK-DD13                  PIC       X(09).
     03  WK-DD14.
         05  WK-DD141             PIC       X(20).
         05  WK-DD142             PIC       X(20).
     03  FILLER                   PIC       X(09).
*
 01  WK-AREA.
*システム日付の編集
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH2501B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH2501B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*各量販店領域転送
*    取引先コード
     MOVE     WK-DH091      TO        HEN-A01.
*    伝票_
     MOVE     "00"          TO        HEN-A02(1:2).
     MOVE     WK-DH03(1:8)  TO        HEN-A02(3:8).
*    行_
     MOVE     WK-DD03       TO        HEN-A03.
*    部門（Ｈ）
**** MOVE     XXXXXXX       TO        HEN-A04.
*    直送区分
*****MOVE     XXXXXXX       TO        HEN-A05.
*    発注者名（社名）
...
*    便
     MOVE     WK-DH13       TO        HEN-A10.
*    ルート
     MOVE     WK-DH15       TO        HEN-A12.
*    伝票区分
     MOVE     WK-DH06       TO        HEN-A14.
*    商品コード
     MOVE     WK-DD04       TO        HEN-A15.
*    品名
     MOVE     WK-DD14       TO        HEN-A16.
*    取引先品番
*****MOVE     XXXX          TO        HEN-A17.
*    ＪＡＮコード
     MOVE     WK-DD04       TO        HEN-A18.
*    入数
...
*    原価金額
     MOVE     WK-DD11       TO        HEN-A23.
*    売単価
     MOVE     WK-DD10       TO        HEN-A24.
*    売価金額
     MOVE     WK-DD12       TO        HEN-A25.
*    店舗コード
     MOVE     WK-DH042      TO        HEN-A26.
*    伝票枚数
*****MOVE     XXXX          TO        HEN-A27.
*    店舗名
     MOVE     WK-DH11       TO        HEN-A28.
*    Ａ欄
*****MOVE     XXXX          TO        HEN-A29.
*    Ｂ欄
*****MOVE     XXXX          TO        HEN-A30.
*    単位
     MOVE     WK-DD07       TO        HEN-A31.
*    Ｃ欄
*****MOVE     XXXX          TO        HEN-A32.
*    Ｄ欄
     MOVE     WK-DH14       TO        HEN-A33.
*    分類
     MOVE     WK-DH05       TO        HEN-A34.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
