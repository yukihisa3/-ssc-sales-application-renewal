...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY7881L.COB`
...
*
 01  WK-KEY.
     ...
     03  WK-DENPYO-NO             PIC       9(09)  VALUE  ZERO.
     03  WK-DENPYO-NO1            PIC       9(09)  VALUE  ZERO.
*
 01  WK-GOKEI.
...
***** メッセージエリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY7881L".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY7881L".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND1.
...
*             プロセス                      0.0                *
****************************************************************
 SSY7881L-START         SECTION.
*
     MOVE   "SSY7881L-START"      TO   S-NAME.
     PERFORM            INIT-SEC.
*
...
*事業部名称セット
     MOVE NC"ロイヤルＨＣ　" TO    HD01-JIGYOBU.
*頁セット
     ADD      1              TO   P-CNT.
