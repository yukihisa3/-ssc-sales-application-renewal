...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SKYSNCKB.COB`
...
*--------------------------------------------------------------*
 01  WK-SGYNO                PIC  9(07).
 01  SGYNO-NEXT              PIC  9(07).
 01  JYO-ST                  PIC  X(02).
 01  MSG-AREA.
     03  MSG-START.
...
*--------------------------------------------------------------*
 LINKAGE                SECTION.
*--------------------------------------------------------------*
 01  OUT-SGYNO               PIC  9(07).
*
******************************************************************
 PROCEDURE    DIVISION       USING     OUT-SGYNO.
******************************************************************
 DECLARATIVES.
...
*伝票番号(OUT)初期化
     OPEN     I-O       HJYOKEN.
     MOVE     ZERO      TO   OUT-SGYNO.
*条件マスタ読込
     PERFORM  JYO-READ.
     IF       OUT-SGYNO =    9999999
              MOVE      1    TO   JYO-F04
     ELSE
              ADD       1         TO   WK-SGYNO
              MOVE      WK-SGYNO  TO   JYO-F04
     END-IF.
     REWRITE  JYO-REC.
     CLOSE              HJYOKEN.
 000-PROG-CNTL-EXIT.
 ...
 JYO-READ         SECTION.
     ...
     READ     HJYOKEN
         INVALID
              ...
              INITIALIZE            JYO-REC
         NOT INVALID
              MOVE   JYO-F04 TO     OUT-SGYNO  WK-SGYNO
     END-READ.
  JYO-READ-EXIT.
 EXIT.
*-----------------<< PROGRAM END >>----------------------------*
