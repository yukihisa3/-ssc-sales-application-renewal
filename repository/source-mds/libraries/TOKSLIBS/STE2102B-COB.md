...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/STE2102B.COB`
...
***  ﾜｰｸ  ｴﾘｱ
 01  WRK-AREA.
     03  WK-TORICD                PIC  9(08)     VALUE   120020.
...
*    ﾐﾀﾞｼ
 01  HEAD-00.
     ...
     03  HD001                    PIC  X(10) VALUE "ｶﾀｸﾗｺｳｷﾞｮｳ".
*
...
*    部門コード（伝票データ上の分類より）
*****MOVE     KYO-F12            TO    HD021.
*    分類コード（伝票データ上の商区より）
*****MOVE     KYO-F131           TO    HD03.
