...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY0502I.COB`
...
*             出荷場所別件数Ｆ　　ＲＥＡＤ　                   *
****************************************************************
 JSMKENF-READ             SECTION.
     MOVE     "JSMKENF-READ"      TO   S-NAME.
*
     MOVE     ZERO                TO   INV-FLG.
     MOVE     DSP-BTDATE          TO   KEN-F01.
     MOVE     DSP-BTTIME          TO   KEN-F02.
...
****************************************************************
 END-SEC               SECTION.
*ファイル ＣＬＯＳＥ
     CLOSE             JSMKENF  HTOKMS  ZSOKMS  DSPFILE.
**
 END-EXIT.
     EXIT.
