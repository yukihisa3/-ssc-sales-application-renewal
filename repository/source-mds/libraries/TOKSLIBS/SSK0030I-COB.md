...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSK0030I.COB`
...
*    作成日／更新日　　　：　2014/03/17                        *
*    作成者／更新者　　　：　NAV/MIURA                         *
*    処理概要　　　　　　：　受領アンマッチ・ＣＳＶ出力の指示を*
*                        ：　行なう　　　　　　　　　　　　　　*
****************************************************************
 IDENTIFICATION        DIVISION.
 PROGRAM-ID.           SSK0030I.
 AUTHOR.               NAV.
 DATE-WRITTEN.         14/03/17.
****************************************************************
...
*画面の表示
     ...
     MOVE    "SSK0030I"          TO   DSP-PGID.
     MOVE    "FSK00301"          TO   DSP-FORMID.
     MOVE    "FSK00301"          TO   DSP-FMT.
     WRITE    DSP-FSK00301.
*
 DSP-WRITE-EXIT.
     EXIT.
