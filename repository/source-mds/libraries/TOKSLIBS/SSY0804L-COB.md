...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY0804L.COB`
...
*
 ...
 FILE-CONTROL.
*欠品ファイル
     SELECT  KPNFILF   ASSIGN    TO        KPNFILL2
...
****************************************************************
 PROCESS-SEC             SECTION.
     ...
     DISPLAY  "***   SSY0804L   START     ***"  UPON CONS.
*
*ワーク初期化
     MOVE      ZERO     TO    P-CNT.
     MOVE      ZERO     TO    L-CNT.
...
*ファイル ＣＬＯＳＥ
     ...
     DISPLAY  "***   SSY0804L   END       ***"  UPON CONS.
**
 END-EXIT.
     EXIT.
