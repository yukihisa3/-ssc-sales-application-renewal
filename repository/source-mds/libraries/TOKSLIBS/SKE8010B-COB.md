...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SKE8010B.COB`
...
*
 ...
 FILE-CONTROL.
****<< 店舗マスタ　　　ＣＳＶ >>******************************
     SELECT   LBLTEN    ASSIGN  TO   DA-01-S-LBLTEN
...
****  カウンタ                ****
 ...
 01  LBLTEN-CNT              PIC  9(8)   VALUE  ZERO.
****  フラグ                  ****
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SKE8010B".
...
*      _１      店舗マスタ　　　ＣＳＶ出力                *
************************************************************
 LBLTEN-WRITE-SEC       SECTION.
*レコード初期化　　　　　　　　　　
     MOVE     SPACE         TO      CSV-REC.
     INITIALIZE                     CSV-REC.
*カンマセット
     MOVE     ","           TO      CSV-A01(1:1).
     MOVE     X"28"         TO      CSV-A01(2:1).
     MOVE     ","           TO      CSV-A02(2:1).
     MOVE     X"29"         TO      CSV-A02(1:1).
*カウントアップ
     ADD       1            TO      LBLTEN-CNT.
*店舗コード
     MOVE      TEN-F011     TO      CSV-F01.
*店舗名（日本語）
     MOVE      TEN-F03      TO      CSV-F02.
*センター区分
     MOVE      TEN-F75      TO      CSV-F03.
*レコード出力
     WRITE     CSV-REC.
...
************************************************************
 END-SEC                SECTION.
     ...
     DISPLAY  " LBLTEN-WRITE-CNT = " LBLTEN-CNT UPON CONS
     END-IF.
 END-END.
     EXIT.
*****************<<  PROGRAM  END  >>***********************
