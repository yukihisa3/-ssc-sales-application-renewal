...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SJS0101I.COB`
...
*    作成者／更新者　　　：　ＮＡＶ
*    更新日／更新者　　　：
*      2005/09/15 NAV      得意先名追加(2005/09/15)
...
*-------------------------
*2002/01/08*ST*    IF ( RUI-F02   =   "41" OR  "51" OR "71" ) AND
***************       ( RUI-F05   =  0  OR 2 OR 4 OR 6 OR 8)
***************         COMPUTE   UKE-F06   =
***************                        RUI-F13  *  -1
***************    ELSE
...
*  2011/11/25,S  S.I/NAV
         MOVE  UKE-F99      TO  TANCD (IX1) *> 担当者ＣＤ
*  2011/11/25,E  S.I/NAV
