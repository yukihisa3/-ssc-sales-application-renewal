...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8306I.COB`
...
*----<< 表示ファイル >>--*
     SELECT   DSPFILE   ASSIGN         01-GS-DSPF
                        ...
                        STATUS         DSP-ST.
*----<< ホーマック基本情報データ >>--*
     SELECT   HCSYUKF   ASSIGN         DA-01-VI-HCSYUKL2
...
*
 01  MSG-AREA.
     ...
     03  MSG11               PIC  N(20)  VALUE
              NC"資材関係の取引先ＣＤのみの指定です。".
*
 01  FILLER                  REDEFINES   MSG-AREA.
     03  MSG-TBL             PIC  N(20)  OCCURS      111
*
 01  SEC-AREA.
     03  SEC-NAME.
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SSY8306I DSPFILE ERROR " DSP-CNTL " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
     CLOSE    HCSYUKF   HTOKMS    ZSOKMS1    DSPFILE.
     STOP     RUN.
*----<< 伝票データ >>--*
 HCSYUKF-ERR            SECTION.
     USE AFTER     EXCEPTION PROCEDURE      HCSYUKF.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY8306I HCSYUKF ERROR " HCSYUKF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY8306I HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY8306I ZSOKMS1 ERROR " ZSOKMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FSY83041.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "SSY8306I"      TO   PGID.
     MOVE    "FSY83041"      TO   FORM.
...
*    取引先チェック
     ...
     IF  TORICD    NOT =     ZERO
         ...
         END-READ
         IF   TORICD  =  1427 OR 14272 OR 14273
              CONTINUE
         ELSE
              IF   ERR-FLG   =    ZERO
                   MOVE      11   TO   ERR-FLG
...
*    売上伝票データ存在チェック
     IF  ERR-FLG        =    ZERO
         ...
         START     HCSYUKF   KEY  >=   HCJ-K01   HCJ-K02
                                       HCJ-K03   HCJ-K04
                                       HCJ-K08
              INVALID   KEY
                   MOVE      5    TO   ERR-FLG
