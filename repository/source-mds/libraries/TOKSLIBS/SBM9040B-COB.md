...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SBM9040B.COB`
...
*
 01  HEP-BR-KEY2.
     03  HEP-BR-KEY21         PIC  X(08).
     03  HEP-BR-KEY22         PIC  X(04).
     03  HEP-BR-KEY23         PIC  X(08).
 01  WK-BR-KEY2.
...
****************************************************************
 INIT-SEC              SECTION.
*
     DISPLAY  "***  START SBM9040B  ***"   UPON  CONS.
...
* 定型
 INSTART-100.
     MOVE       ZERO              TO   HEP-F011.
     GO  TO    INSTART-300.
* 非定型
 INSTART-200.
     IF  PARA-SHURUI  =  "1"
*
         MOVE     PARA-JYUSINHI       TO   HEP-F011
         MOVE     PARA-JYUSINTIME     TO   HEP-F012
         MOVE     PARA-TOKCD          TO   HEP-F013
         MOVE     PARA-JYUSINHI       TO   WK-BR-KEY21
         MOVE     PARA-JYUSINTIME     TO   WK-BR-KEY22
         MOVE     PARA-TOKCD          TO   WK-BR-KEY23
     ELSE
         MOVE     PARA-SOUJYUSIN      TO   HEP-F011
     END-IF.
*
*
 INSTART-300.
     START  BMSHEPF  KEY  IS  >=
                                   HEP-F011  HEP-F012
                                   HEP-F013
*
            INVALID
...
**
     GO  TO   MAIN-900.
 MAIN-210.
     IF  HEP-BR-KEY2  =  WK-BR-KEY2
         PERFORM SAKUJYO-SEC
         GO  TO  MAIN-900
     END-IF.
     IF  HEP-BR-KEY2  NOT =  WK-BR-KEY2
         MOVE  "1"    TO   END-FLG
     GO  TO   MAIN-EXIT
     END-IF.
 MAIN-220.
     IF  HEP-F011     =  PARA-SOUJYUSIN
         ...
         GO  TO    MAIN-900
     END-IF.
     IF  HEP-F011   NOT =  PARA-SOUJYUSIN
         MOVE  "1"     TO   END-FLG
         GO  TO    MAIN-EXIT
     END-IF.
*
...
*ファイルのCLOSE処理
     CLOSE     BMSHEPF.
     DISPLAY  "***  END   SBM9040B  ***"   UPON  CONS.
*
 END-EXIT.
     EXIT.
*
...
*
     IF   PARA-TEIKEI  =  "2"
         MOVE     HEP-F011    TO   HEP-BR-KEY21
         MOVE     HEP-F012    TO   HEP-BR-KEY22
         MOVE     HEP-F013    TO   HEP-BR-KEY23
     END-IF.
*
     ADD      1           TO   READ-CNT.
*
