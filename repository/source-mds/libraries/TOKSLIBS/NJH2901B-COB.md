...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH2901B.COB`
...
*
 01  DEN-REC.
     03  DEN-01                  OCCURS 2.
         05  DEN-01A             PIC  X(03).
         05  DEN-01B             PIC  X(13).
         05  DEN-01B2            PIC  X(02).
         05  DEN-01B3            PIC  X(10).
         05  DEN-01C             PIC  X(01).
         05  DEN-01D             PIC  X(99).
******************************************************************
*    取引先マスタ
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH2901B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH2901B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
***  DISPLAY "JSBH-F10 = " JSBH-F10  UPON CONS.
***  DISPLAY "HEN-A27  = " HEN-A27   UPON CONS.
*店舗名称
...
*取引先コード
     ...
     MOVE     87375         TO    HEN-F01  WK-TOKCD.
*伝票ナンバー
