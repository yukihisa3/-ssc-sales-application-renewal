...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH4551B.COB`
...
*    取引先ＣＤ設定
 01  WK-TOKCD                     PIC  9(08)  VALUE  87371.
*    伝票カウンタ
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  FILLER               PIC X(08) VALUE "SJH4551B".
     ...
     03  MSG-ABEND1.
         05  FILLER               PIC X(04) VALUE "### ".
         05  ERR-PG-ID            PIC X(08) VALUE "SJH4551B".
...
*
     EVALUATE  WK-TEN-F77
         ...
         WHEN  5
               IF   FIL-FLG5 = SPACE
                    MOVE   SPACE   TO    DATAF5-REC
                    INITIALIZE           DATAF5-REC
                    MOVE WK-JSA-REC TO   DATAF5-REC
                    WRITE DATAF5-REC
                    ADD  1              TO    WK-CNT5
                    MOVE "OK"       TO   FIL-FLG5
               END-IF
               MOVE SPACE          TO    DATAF5-REC
               INITIALIZE                DATAF5-REC
               MOVE CV128-REC(IDX) TO    DATAF5-REC
               WRITE DATAF5-REC
               ADD  1              TO    WK-CNT5
         WHEN  6
               IF   FIL-FLG6 = SPACE
