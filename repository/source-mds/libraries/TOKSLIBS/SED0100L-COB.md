...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SED0100L.COB`
...
***
                   ...
                   PERFORM   DENP-WT-SEC
                             UNTIL     END-FLG   =   "END"
                   CLOSE     DENKATSF  PRTFILE  EDJOHOF
                   OPEN      INPUT     DENKATSF
                   OPEN      OUTPUT    PRTFILE
                   OPEN      INPUT     EDJOHOF
                   MOVE      1         TO   ERR-FLG
...
*
     CLOSE    DENKATSF   PRTFILE    DSPFILE   EDJOHOF.
*
 END-EXIT.
     EXIT.
****************************************************************
