...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/CSV011NW.COB`
...
*
 ...
 FILE-CONTROL.
****<< 発注データ >>************************************
     SELECT   HACYUDT2  ASSIGN    TO        DA-01-S-HACYUDT2
                        FILE      STATUS    IS   HAC-STATUS.
****<< ＣＳＶデータ     >>************************************
     SELECT   CSVDT3   ASSIGN    TO        DA-01-S-CSVDT3
...
***************************************************************
****<< 発注データ >>*********************************
 FD  HACYUDT2           BLOCK CONTAINS 16   RECORDS
                       LABEL RECORD   IS   STANDARD.
     COPY     HACYUDT2 OF         XFDLIB
              JOINING  HAC        PREFIX.
****<< ＣＳＶデータ  >>****************************
 FD  CSVDT3             BLOCK CONTAINS 16   RECORDS
                       LABEL RECORD   IS   STANDARD.
     COPY     CSVDT3 OF         XFDLIB
              JOINING  CSV        PREFIX.
****<< 店舗マスタ  >>**************************************
 FD  TENMS1.
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "CSV011NW".
...
*    発注データ読込み
************************************************************
 HACYUDT2-READ-SEC                 SECTION.
*
     READ    HACYUDT2
             AT   END
             MOVE      "END"     TO   END-FLG
             GO        TO        HACYUDT2-READ-EXIT
     END-READ.
     ADD     1         TO        CSV-CNT.
*
 HACYUDT2-READ-EXIT.
