...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8721I.COB`
...
****************************************************************
*    顧客名　　　　　　　：　（株）サカタのタネ殿　　　　　　　*
*    サブシステム　　　　：　ＤＣＭＪＡＰＡＮＷＥＢＥＤＩ対応  *
*    業務名　　　　　　　：　ＤＣＭＪＡＰＡＮＷＥＢＥＤＩ対応  *
*    モジュール名　　　　：　納品予定データ作成指示            *
*    作成日／更新日　　　：　2007/05/17                        *
*    作成者／更新者　　　：　NAV                               *
*    処理概要　　　　　　：　画面より、バッチ_、出力倉庫、    *
...
*----<< 表示ファイル >>--*
     SELECT   DSPFILE   ASSIGN         01-GS-DSPF
                        ...
                        STATUS         DSP-ST.
*----<< ＤＣＭＪＡＰＡＮ基本情報データ >>--*
     SELECT   DJJOHOF   ASSIGN         DA-01-VI-DJJOHOL2
...
*#2017/02/20 NAV ST
 01  WK-KAHMASZ1        PIC  9(08)  VALUE  ZERO.
 01  WK-KAHMASK1        PIC  9(08)  VALUE  ZERO.
*#2017/02/20 NAV ED
 01  WK-DAIK1           PIC  9(08)  VALUE  ZERO.
 01  WK-DAIK2           PIC  9(08)  VALUE  ZERO.
 01  WK-DAIK3           PIC  9(08)  VALUE  ZERO.
 01  WK-DAIK4           PIC  9(08)  VALUE  ZERO.
 01  WK-DAIK5           PIC  9(08)  VALUE  ZERO.
 01  WK-DAIK6           PIC  9(08)  VALUE  ZERO.
 01  WK-DAIK7           PIC  9(08)  VALUE  ZERO.
*#2018/02/14 NAV ST
 01  WK-KEIYO1          PIC  9(08)  VALUE  ZERO.
 01  WK-KEIYO2          PIC  9(08)  VALUE  ZERO.
 01  WK-KEIYO3          PIC  9(08)  VALUE  ZERO.
 01  WK-KEIYO4          PIC  9(08)  VALUE  ZERO.
*#2018/02/14 NAV ED
*----<< ﾃﾞｨｽﾌﾟﾚｲ ｺﾝﾄﾛｰﾙ ｴﾘｱ >>-*
 01  GR-NO              PIC  9(02).
 01  WK-GRP             PIC  X(08).
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SSY8721I DSPFILE ERROR " DSP-CNTL " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
     CLOSE    DJJOHOF   HTOKMS    ZSOKMS1    DSPFILE.
     STOP     RUN.
*----<< 伝票データ >>--*
 DJJOHOF-ERR            SECTION.
     USE AFTER     EXCEPTION PROCEDURE      DJJOHOF.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY8721I DJJOHOF ERROR " DJJOHOF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY8721I HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY8721I ZSOKMS1 ERROR " ZSOKMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*ﾁｪｯｸ取引先CDｾｯﾄ
     ...
     MOVE     100441              TO   WK-DAIK3.
     MOVE     100427              TO   WK-DAIK4.
     MOVE     100404              TO   WK-DAIK5.
     MOVE     100442              TO   WK-DAIK6.
     MOVE     100428              TO   WK-DAIK7.
*#2017/02/20 NAV ST
     MOVE     139381              TO   WK-KAHMASZ1.
     MOVE     171371              TO   WK-KAHMASK1.
*#2017/02/20 NAV ED
*#2018/02/15 NAV ST
     MOVE     1731                TO   WK-KEIYO1.
     MOVE     1732                TO   WK-KEIYO2.
     MOVE     7601                TO   WK-KEIYO3.
     MOVE     7602                TO   WK-KEIYO4.
*#2018/02/15 NAV ED
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FSY87011.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "SSY8721I"      TO   PGID.
     MOVE    "FSY87011"      TO   FORM.
...
*    取引先チェック
     ...
     AND TORICD  =  ZERO
         ...
         MOVE     "R"   TO   EDIT-OPTION OF TORICD
     ELSE
         IF   TORICD  =  WK-HCSZHOK OR WK-HCSZTOH OR WK-HCSZKAN
         OR WK-KAHMASZ OR WK-HCSKHOK OR WK-HCSKTOH
         OR WK-HCSKKAN OR WK-KAHMASK OR WK-DAIK1  OR WK-DAIK2
         OR WK-DAIK3  OR WK-DAIK4
         OR WK-DAIK5  OR WK-DAIK6  OR  WK-DAIK7
*********#2017/02/20 NAV ST
         OR WK-KAHMASZ1 OR WK-KAHMASK1
*********#2017/02/20 NAV ED
*********#2018/02/15 NAV ST
         OR WK-KEIYO1 OR WK-KEIYO2 OR WK-KEIYO3 OR WK-KEIYO4
*********#2018/02/15 NAV ED
              CONTINUE
         ELSE
              IF   ERR-FLG   =    ZERO
...
*    売上伝票データ存在チェック
     IF  ERR-FLG        =    ZERO
         ...
         INITIALIZE                    DJJ-REC
         MOVE      JDATE          TO   DJJ-K01
         MOVE      JTIME          TO   DJJ-K02
         MOVE      TORICD         TO   DJJ-K03
         MOVE      WK-SOKCD       TO   DJJ-K04
         MOVE      NOUDT          TO   DJJ-K08
