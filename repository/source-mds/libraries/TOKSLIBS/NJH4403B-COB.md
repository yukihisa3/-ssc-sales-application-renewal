...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH4403B.COB`
...
*伝票ヘッダー退避ワーク
 01  WK-DEPB-REC.
     ...
     03  WK-DEPB17          PIC  9(01).
     03  WK-DEPB18          PIC  9(05).
     03  WK-DEPB19          PIC  9(01).
     03  WK-DEPB20          PIC  9(02).
     03  WK-DEPB21          PIC  X(01).
     03  WK-DEPB22          PIC  X(02).
*    明細レコード退避ワーク
 01  WK-DEPD-REC.
     03  WK-DEPD01          PIC  X.
...
*
 01  WK-TENPO-CD.
     03  WK-TENPO-1        PIC  9(02)  VALUE  ZERO.
     03  WK-TENPO-2        PIC  9(03)  VALUE  ZERO.
 01  WK-AREA.
*システム日付の編集
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH4403B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH4403B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*店コード
     MOVE        HEN-A05   TO        HEN-F07  WK-TENPO-CD.
*伝票ナンバー（店舗ＣＤ＋伝票番号をサカタ管理伝票番号とする）
*##2003/06/26 NAV 伝票番号頭に店舗ＣＤ３桁付加
     COMPUTE     HEN-F02  =  WK-TENPO-2 * 10000000 + HEN-A03.
...
*商品名　　　
     MOVE        HEN-A37(1:15)  TO   HEN-F1421.
     MOVE        HEN-A37(16:10) TO   HEN-F1422.
*数量
