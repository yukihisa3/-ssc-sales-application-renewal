...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SZA0241L.COB`
...
****  インデックス            ****
 ...
 01  IXB                     PIC  9(02).
****  フラグ                  ****
 01  WK-ZAI-F01              PIC  X(02)  VALUE  SPACE.
****  品単右詰め用エリア      ****
...
****  見出し行１             ****
 01  MIDASI-1.
     ...
     02  FILLER              PIC  X(08)  VALUE  "SZA0241L".
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SZA0241L".
...
*      0.0       全体処理                                  *
************************************************************
 SZA0241L-START         SECTION.
     PERFORM       INIT-SEC.
     PERFORM       MAIN-SEC        UNTIL  END-FLG = "END".
     PERFORM       END-SEC.
     IF   PG-END   NOT =  "END"
          MOVE     SPACE   TO   END-FLG
          GO  TO   SZA0241L-START
     END-IF.
     STOP     RUN.
 SZA0241L-END.
     EXIT.
...
************************************************************
 INIT-SEC               SECTION.
     OPEN     I-O       DSPF.
     OPEN     INPUT     ZAMZAIF   ZAMJISF   ZSOKMS   HMEIMS
              HJYOKEN.
     OPEN     OUTPUT    PRINTF.
*
*システム日付・時刻の取得
...
************************************************************
 END-SEC                SECTION.
     CLOSE    DSPF  PRINTF  ZAMZAIF  ZAMJISF  ZSOKMS  HMEIMS
              HJYOKEN.
 END-END.
     EXIT.
*****************<<  PROGRAM  END  >>***********************
