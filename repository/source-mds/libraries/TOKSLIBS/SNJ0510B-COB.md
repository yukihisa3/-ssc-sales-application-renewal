...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SNJ0510B.COB`
...
*            ( KAI2-F01  =  EDI-F04 )
               MOVE   "END" TO         END-FLG
               DISPLAY "***ｺﾃｲﾀﾝﾏﾂ ｶｲｾﾝ ｼﾖｳﾁｭｳ]]]***" UPON CONS
               GO           TO         MAIN-EXIT
*        END-IF
*
**       READ      JSMKAIF2  AT  END
