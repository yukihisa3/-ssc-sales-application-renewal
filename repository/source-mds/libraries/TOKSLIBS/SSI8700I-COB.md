...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSI8700I.COB`
...
****************************************************************
*    顧客名　　　　　　　：　（株）サカタのタネ殿　　　　　　　*
*    サブシステム　　　　：　ＤＣＭＪＡＰＡＮ　ＷｅｂＥＤＩ対応*
*    業務名　　　　　　　：　ＤＣＭＪＡＰＡＮ　ＷｅｂＥＤＩ対応*
*    モジュール名　　　　：　支払明細書／差異明細書発行指示    *
*    作成日／更新日　　　：　2007/05/28                        *
*    作成者／更新者　　　：　NAV                               *
*    処理概要　　　　　　：　画面より、締日＋取引先＋出力区分  *
*                            を入力する。入力後は、指示内容を  *
*                            パラメタへ渡す。                  *
****************************************************************
****************************************************************
...
*
 LINKAGE                SECTION.
 01  PARA-SIMEDT            PIC   9(08).
 01  PARA-TORICD            PIC   9(08).
 01  PARA-SYUKBN            PIC   9(01).
*
****************************************************************
 PROCEDURE              DIVISION USING PARA-SIMEDT
                                       PARA-TORICD
                                       PARA-SYUKBN.
****************************************************************
*--------------------------------------------------------------*
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SSI8700I DSPFILE ERROR " DSP-CNTL " "
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSI8700I HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FSI87001.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "SSI8700I"      TO   PGID.
     MOVE    "FSI87001"      TO   FORM.
*
     MOVE     SPACE          TO   DSP-CNTL.
     MOVE     "FSI87001"     TO   DSP-FMT.
...
*
     IF       SIMEDT    =    ZERO
              MOVE      2         TO   ERR-FLG
              MOVE     "C"        TO   EDIT-CURSOR OF SIMEDT
              MOVE     "R"        TO   EDIT-OPTION OF SIMEDT
              GO   TO   220-GRP01-CHECK-EXIT
     END-IF.
*    締日チェック
     IF  SIMEDT    NOT =     ZERO
         MOVE     "2"        TO        LINK-IN-KBN
         MOVE      SIMEDT    TO        LINK-IN-YMD8
         CALL     "SKYDTCKB" USING     LINK-IN-KBN
                                       LINK-IN-YMD6
                                       LINK-IN-YMD8
                                       LINK-OUT-RET
...
*--------------------------------------------------------------*
 CLR-HEAD-RTN           SECTION.
     MOVE     " "            TO   EDIT-CURSOR OF SIMEDT
                                  EDIT-CURSOR OF TORICD
                                  EDIT-CURSOR OF SYUKBN.
     MOVE     "M"            TO   EDIT-OPTION OF SIMEDT
