...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH5401B.COB`
...
*ヘッドレコード退避ワーク
 01  WK-DEPB-REC.
     ...
     03  WK-DEPB111         PIC  9(02).
     03  WK-DEPB112         PIC  X(10).
     03  WK-DEPB12          PIC  X(20).
     03  WK-DEPB13          PIC  X(20).
     03  WK-DEPB14          PIC  X(12).
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH5401B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH5401B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    発注区分（コード）
     MOVE     WK-DEPB111    TO        HEN-A111.
*    発注区分（名称）
     MOVE     WK-DEPB112    TO        HEN-A112.
*    店名
...
*伝票_
*2013/05/02 ST 伝票番号の桁数変更に伴う変更（９桁をセット）
*****MOVE    HEN-A032      TO        HEN-F02.
*****MOVE    HEN-A032      TO        HEN-F23.
     MOVE    HEN-A03       TO        HEN-F02.
     MOVE    HEN-A03       TO        HEN-F23.
*2013/05/02 ED 伝票番号の桁数変更に伴う変更（９桁をセット）
*行_
