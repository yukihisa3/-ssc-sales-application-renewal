...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH5301B.COB`
...
*ヘッドレコード退避ワーク
 01  WK-DEPB-REC.
     ...
     03  WK-DEPB10          PIC  X(15).
     03  WK-DEPB11          PIC  X(15).
     03  WK-DEPB12          PIC  X(20).
     03  WK-DEPB13          PIC  9(10).
     03  WK-DEPB14          PIC  9(10).
     03  WK-DEPB15          PIC  X(11).
*    明細レコード退避ワーク
 01  WK-DEPD-REC.
     ...
     03  WK-DEPD15          PIC  X(16).
     03  WK-DEPD16          PIC  X(08).
     03  WK-DEPD17          PIC  X(02).
*
 01  WK-AREA.
*システム日付の編集
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH5301B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH5301B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*****MOVE    HEN-A091      TO        WK-TOKCD.
     MOVE    HEN-A091(1:4) TO        HEN-F01.
     MOVE    HEN-A091(1:4) TO        WK-TOKCD.
*伝票_
...
*        商品名
         ...
         MOVE    HEN-A29(16:9)  TO   HEN-F1422(1:9)
       NOT INVALID
         MOVE    HEN-A29(1:15)  TO   HEN-F1421(1:15)
         MOVE    HEN-A29(16:9)  TO   HEN-F1422(1:9)
     END-READ.
