...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SJH1403B.COB`
...
*ヘッダーレコード退避
 01  WK-DENA.
     ...
     03  WK-DENA02           PIC  X(02).
     03  WK-DENA03           PIC  9(02).
     03  WK-DENA04           PIC  9(02).
     03  WK-DENA05           PIC  9(03).
     03  WK-DENA06           PIC  X(05).
     03  WK-DENA07           PIC  9(03).
     03  WK-DENA08           PIC  9(06).
     03  WK-DENA09           PIC  9(06).
     03  WK-DENA10           PIC  9(06).
     03  WK-DENA11           PIC  X(02).
     03  WK-DENA12           PIC  X(03).
     03  WK-DENA13           PIC  X(01).
     03  WK-DENA14           PIC  9(07).
     03  WK-DENA15           PIC  X(01).
     03  WK-DENA16           PIC  X(01).
     03  WK-DENA17           PIC  X(15).
     03  WK-DENA18           PIC  X(20).
     03  WK-DENA19           PIC  X(30).
     03  WK-DENA20           PIC  X(01).
     03  WK-DENA21           PIC  X(11).
*明細レコード退避
 01  WK-DENB.
     03  WK-DENB-REC         OCCURS  6.
         05  WK-DENB22       PIC  X(01).
         05  WK-DENB23       PIC  X(02).
         05  WK-DENB24       PIC  9(04).
         05  WK-DENB25       PIC  9(01).
         05  WK-DENB26       PIC  X(01).
         05  WK-DENB27       PIC  X(01).
         05  WK-DENB28       PIC  9(01).
         05  WK-DENB29       PIC  X(20).
         05  WK-DENB30       PIC  X(20).
         05  WK-DENB31       PIC  9(07).
         05  WK-DENB32       PIC  9(06).
         05  WK-DENB33       PIC  9(09).
         05  WK-DENB34       PIC  9(08).
         05  WK-DENB35       PIC  9(07).
         05  WK-DENB36       PIC  9(08).
         05  WK-DENB37       PIC  X(01).
         05  WK-DENB38       PIC  X(01).
         05  WK-DENB39       PIC  X(01).
         05  WK-DENB40       PIC  X(01).
         05  WK-DENB41       PIC  X(06).
         05  WK-DENB42       PIC  X(01).
         05  WK-DENB43       PIC  X(01).
         05  WK-DENB44       PIC  9(13).
         05  WK-DENB45       PIC  X(07).
*明細レコード退避
 01  WK-DENC.
     03  WK-DENC46           PIC  X(01).
     03  WK-DENC47           PIC  X(02).
     03  WK-DENC48           PIC  9(09).
     03  WK-DENC49           PIC  9(09).
     03  WK-DENC50           PIC  9(09).
     03  WK-DENC51           PIC  X(03).
     03  WK-DENC52           PIC  X(04).
     03  WK-DENC53           PIC  X(10).
     03  WK-DENC54           PIC  X(11).
     03  WK-DENC55           PIC  X(70).
*
*
 01  WK-AREA.
*システム日付の編集
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJH1403B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJH1403B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*
     IF       DEN-01A  =  "D"
              ADD   1            TO   IDX1
              MOVE  DEN-REC      TO   WK-DENB-REC(IDX1)
              ADD   1            TO   CNT-KENSU
...
*各量販店領域転送
*    伝票ヘッダー転送
     MOVE     WK-DENA       TO        HEN-DTRECA.
*    伝票明細転送
     MOVE     WK-DENB-REC(IDX2) TO    HEN-DTRECB.
*    伝票合計転送
     MOVE     WK-DENC       TO        HEN-DTRECC.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
...
*取引先コード
     MOVE        HEN-A06   TO        HEN-F01.
*伝票ナンバー
     MOVE        HEN-A14   TO        HEN-F02.
...
*担当者コード
     MOVE        99        TO        HEN-F06.
*店コード
     MOVE        HEN-A11   TO        WK-TEN-CD.
     MOVE     WK-TEN-HEN   TO        HEN-F07.
*  商品変換テーブル検索
     MOVE        SPACE     TO        TBL-REC.
     INITIALIZE                      TBL-REC.
     MOVE        HEN-A06   TO        TBL-F01.
*2010/02/10 ｲﾝｽﾄｱCD=>JANCDに変更
*****MOVE        HEN-A31   TO        TBL-F02.
     MOVE        HEN-A44   TO        TBL-F02.
     READ    SHOTBL1
       INVALID
         MOVE    SPACE     TO        TBL-REC
         INITIALIZE                  TBL-REC
...
*分類（部門）
     MOVE        HEN-A12   TO        HEN-F12.
*商品区分　　
     MOVE        HEN-A13   TO        HEN-F131.
*伝票区分　　
     MOVE        HEN-A03   TO        HEN-F132.
*伝発区分
     MOVE        9         TO        HEN-F134.
*自社商品コード
...
*売価単価
     MOVE        HEN-A35   TO        HEN-F173.
*原価金額
     MOVE        HEN-A34   TO        HEN-F181.
*売価金額
     MOVE        HEN-A36   TO        HEN-F182.
*自社得意先コード
     IF  FLG-TOK   =    ZERO
*    得意先マスタ検索
         MOVE    SPACE         TO    TOK-REC
         INITIALIZE                  TOK-REC
         MOVE    HEN-A06       TO    TOK-F01
         READ    TOKMS2
             INVALID
               MOVE  SPACE     TO    TOK-REC
               INITIALIZE            TOK-REC
...
*    ルート条件マスタ検索
     ...
     MOVE     HEN-A04      TO        RUT-F03  HEN-F42.
     READ     JHMRUTL1
         INVALID
           MOVE  1         TO        INV-RUT
