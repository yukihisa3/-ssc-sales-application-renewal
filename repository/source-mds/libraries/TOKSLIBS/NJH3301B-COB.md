...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH3301B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH3301B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH3301B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    発注者名
     MOVE     WK-DH12       TO        HEN-A04.
*    取引先名
     MOVE     WK-DH14       TO        HEN-A05.
*    相手商品コード
     MOVE     WK-DD04       TO        HEN-A06.
*    商品名
     MOVE     WK-DD14       TO        HEN-A07.
*    数量
     MOVE     WK-DD08       TO        HEN-A08.
*    原単価
     MOVE     WK-DD09       TO        HEN-A10.
*    売単価
     MOVE     WK-DD10       TO        HEN-A11.
*    原価金額
     MOVE     WK-DD11       TO        HEN-A12.
*    売価金額
     MOVE     WK-DD12       TO        HEN-A13.
*
*    入数
     MOVE     WK-DD05       TO        HEN-A21.
*    発注単位数
     MOVE     WK-DD06       TO        HEN-A22.
*    店舗名称カナ
     MOVE     WK-DH13       TO        HEN-A29.
*    商品コード
     MOVE     WK-DD04       TO        HEN-A30.
*    社（法人）コード
     MOVE     WK-DH04       TO        HEN-A31.
*    配送パターン
...
*取引先コード
     MOVE        WK-DH10   TO        HEN-F01.
*伝票ナンバー
     MOVE        WK-DH03   TO        HEN-F02.
     MOVE        HEN-F02   TO        HEN-F23.
*行_
     MOVE        WK-DD03   TO        HEN-F03.
*取区
     MOVE        40        TO        HEN-F051.
...
*担当者コード
     MOVE        99        TO        HEN-F06.
*店コード
     MOVE        WK-DH05   TO        HEN-F07.
*  商品変換テーブル検索
     MOVE        SPACE     TO        TBL-REC.
     INITIALIZE                      TBL-REC.
     MOVE        WK-DH10   TO        TBL-F01.
...
*    商品名称マスタ検索
     ...
     READ    MEIMS1
       INVALID
*        商品名
         MOVE    HEN-A07   TO        HEN-F142
       NOT INVALID
         MOVE    HEN-A07   TO        HEN-F142
     END-READ.
*数量
     MOVE        HEN-A08   TO        HEN-F15.
*単
     MOVE       "1"        TO        HEN-F16.
*原価単価
     MOVE        HEN-A10   TO        HEN-F172.
*売価単価
     MOVE        HEN-A11   TO        HEN-F173.
*原価金額
     MOVE        HEN-A12   TO        HEN-F181.
*売価金額
     MOVE        HEN-A13   TO        HEN-F182.
*自社得意先コード
     IF  FLG-TOK   =    ZERO
*    得意先マスタ検索
         MOVE    SPACE         TO    TOK-REC
         INITIALIZE                  TOK-REC
         MOVE    WK-DH10       TO    TOK-F01
         READ    TOKMS2
             INVALID
               MOVE  SPACE     TO    TOK-REC
               INITIALIZE            TOK-REC
...
*## 2001/06/20 NAV START ##* サカタ殿依頼により
*ルート
     MOVE     "00"         TO        HEN-F42.
*## 2015/02/19 NAV START ##* サカタ殿依頼により
     MOVE     HEN-A32(2:2) TO        HEN-F42.
*## 2015/02/19 NAV END   ##*
*## 2001/06/20 NAV END   ##*
*振分倉庫コード
*    ルート条件マスタ検索
     ...
     INITIALIZE                      RUT-REC.
     MOVE     WK-DH10      TO        RUT-F01.
     MOVE     SPACE        TO        RUT-F02.
*****MOVE     HEN-A32(2:2) TO        RUT-F03  HEN-F42.
     MOVE     HEN-A32(2:2) TO        RUT-F03.
     READ     JHMRUTL1
         INVALID
           MOVE  1         TO        INV-RUT
...
*訂正前数量
     MOVE        HEN-A08   TO        HEN-F50.
*修正原価単価
     MOVE        HEN-A10   TO        HEN-F512.
*修正売価単価
     MOVE        HEN-A11   TO        HEN-F513.
*修正原価金額
     MOVE        HEN-A12   TO        HEN-F521.
*修正売価金額
     MOVE        HEN-A13   TO        HEN-F522.
*
 TENSO-EXIT.
     EXIT.
****************************************************************
