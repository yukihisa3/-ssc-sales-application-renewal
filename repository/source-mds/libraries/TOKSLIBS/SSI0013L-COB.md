...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSI0013L.COB`
...
*----<< 支払合計ファイル >>--*
 SHI-ERR                SECTION.
     ...
     DISPLAY  "### SSI0013L HSHIGKF ERROR " SHI-ST " "
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSI0013L HTOKMS ERROR " TOK-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
**** CLOSE    HSHIGKF   HTOKMS    HTENMS    PRTF.
...
*----<< 店舗マスタ >>--*
 HTENMS-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSI0013L HTENMS ERROR " TEN-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
**** CLOSE    HSHIGKF   HTOKMS    HTENMS    PRTF.
...
*****IF       SHI-F21(1:2) = "77" OR "71"
*             DISPLAY "SHI-F21(1:2) = " SHI-F21 UPON CONS
*****END-IF.
     IF  CHK-FLG  =  SPACE
