...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/CSV010NN.COB`
...
*商品コード変換ファイル
     SELECT   HSHOTBL   ASSIGN         SHOTBL1
                        ...
                        STATUS         SHO-ST.
*発注集計プリントファイル
     SELECT   HACYUDT1  ASSIGN         HACYUDT1
...
*    FILE = 発注集計プリントファイル                           *
****************************************************************
 FD  HACYUDT1           LABEL     RECORD   IS   STANDARD
...
*発注集計プリントファイル
 HAC-ERR                SECTION.
     USE AFTER     EXCEPTION PROCEDURE      HACYUDT1.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  SEC-NAME       UPON CONS.
     DISPLAY  "### " PG-ID " HACYUDT1 ERROR " HAC-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     MOVE     "4000"         TO   PROGRAM-STATUS.
