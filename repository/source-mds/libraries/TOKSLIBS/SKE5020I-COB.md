...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SKE5020I.COB`
...
*----<< 表示ファイル >>--*
     SELECT   DSPFILE   ASSIGN         01-GS-DSPF
                        ...
                        STATUS         DSP-ST.
*----<< 伝票データ >>--*
     SELECT   SHTDENF   ASSIGN         DA-01-VI-SHTDENL6
...
*
*----<< 倉庫別検品取引先設定マスタ >>--*
     SELECT   SOKKENF   ASSIGN         DA-01-VI-SOKKENL1
                        ORGANIZATION   INDEXED
                        ACCESS    MODE RANDOM
...
*----<< 倉庫マスタ >>--*
 FD  ZSOKMS             LABEL RECORD   IS   STANDARD.
     COPY     ZSOKMS    OF        XFDLIB
              JOINING   SOK       PREFIX.
*----<< 倉庫別検品取引先設定マスタ >>--*
 FD  SOKKENF            LABEL RECORD   IS   STANDARD.
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SKE5020I DSPFILE ERROR " DSP-CNTL " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
     CLOSE    SHTDENF   HTOKMS    ZSOKMS    DSPFILE.
     STOP     RUN.
*----<< 伝票データ >>--*
 SHTDENF-ERR            SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKE5020I SHTDENF ERROR " SHTDENF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKE5020I HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 倉庫マスタ >>--*
 ZSOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKE5020I ZSOKMS ERROR " ZSOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 倉庫別検品取引先設定マスタ >>--*
 SOKKENF-ERR             SECTION.
     USE AFTER     EXCEPTION PROCEDURE      SOKKENF.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKE5020I SOKKENF ERROR " SOKKENF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FKE01201.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "SKE5020I"      TO   PGID.
     MOVE    "FKE01201"      TO   FORM.
...
*    倉庫ＣＤ入力チェック
     IF  SOKO  NOT =  SPACE
         ...
         ELSE
              MOVE     SOK-F02    TO   SOKONM
              MOVE     SPACE      TO   EDIT-CURSOR OF SOKO
...
*    伝票番号大小チェック
     IF  SDEN  >  EDEN
         IF        ERR-FLG   =    ZERO
                   MOVE      4    TO   ERR-FLG
         END-IF
         MOVE     "C"        TO   EDIT-CURSOR OF SDEN
         MOVE     "R"        TO   EDIT-OPTION OF SDEN
         MOVE     "R"        TO   EDIT-OPTION OF EDEN
     ELSE
         MOVE    SPACE       TO   EDIT-CURSOR OF SDEN
         MOVE     "M"        TO   EDIT-OPTION OF SDEN
         MOVE     "M"        TO   EDIT-OPTION OF EDEN
     END-IF.
*    倉庫別検品取引先マスタチェック
     IF   ERR-FLG  =  ZERO
          MOVE    SOKO     TO    KEN-F01
...
*
     ...
     MOVE     TOKCD               TO   PARA-TOKCD.
     MOVE     SDEN                TO   PARA-SDEN.
     MOVE     EDEN                TO   PARA-EDEN.
*
     MOVE     99                  TO   GR-NO.
*
 240-PARA-SEC-EXIT.
...
*--------------------------------------------------------------*
 CLR-HEAD-RTN           SECTION.
     MOVE     " "            TO   EDIT-CURSOR OF SOKO
                                  EDIT-CURSOR OF TOKCD
                                  EDIT-CURSOR OF SDEN
                                  EDIT-CURSOR OF EDEN.
     MOVE     "M"            TO   EDIT-OPTION OF SOKO
                                  EDIT-OPTION OF TOKCD
                                  EDIT-OPTION OF SDEN
                                  EDIT-OPTION OF EDEN.
 CLR-HEAD-EXIT.
     EXIT.
...
*
 HTOKMS-READ-EXIT.
     EXIT.
*--------------------------------------------------------------*
*    LEVEL ALL     倉庫別検品取引先設定マスタ読込み            *
*--------------------------------------------------------------*
 SOKKENF-READ-SEC       SECTION.
     MOVE     "SOKKENF-READ-SEC"  TO   S-NAME.
*
     READ  SOKKENF
           INVALID       MOVE   "INV"  TO  SOKKENF-INV-FLG
           NOT INVALID   MOVE   SPACE  TO  SOKKENF-INV-FLG
     END-READ.
*
 SOKKENF-READ-EXIT.
     EXIT.
