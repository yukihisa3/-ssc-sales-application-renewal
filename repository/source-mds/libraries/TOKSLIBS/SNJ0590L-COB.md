...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SNJ0590L.COB`
...
*    サブシステム　　　　：　ＥＤＩ受信                        *
*    モジュール名　　　　：　オンライン受信結果リスト          *
*    作成日／作成者　　　：　10/08/09  /OONO  9/1 ABE          *
*    更新日／更新者　　　：　　　　　　                        *
*    処理概要　　　　　　：　オンライン受信結果マスタより、出荷*
*                            箇所別件数Ｆを元に受信件数リストを*
*                            行う。                            *
****************************************************************
...
*エラー内容編集領域
 01  WK-ERRNM.
     03  WK-ERRNM1                PIC  N(25)  VALUE  SPACE.
     03  WK-ERRNM2                PIC  N(25)  VALUE  SPACE.
     03  WK-ERRNM3                PIC  N(25)  VALUE  SPACE.
     03  WK-ERRNM4                PIC  N(25)  VALUE  SPACE.
*日付／時刻
 01  TIME-AREA.
...
****************************************************************
 MAIN-SEC                  SECTION.
*ファイルＯＰＥＮ
     OPEN        INPUT       JSMMSGF  HTOKMS.
     OPEN        OUTPUT      PRTFILE.
     MOVE        SPACE       TO   PRT-FNJ0590L.
*システム日付・時刻の取得
...
***  受信結果／エラー内容
     ...
     READ     JSMMSGF
       INVALID
              MOVE      LINK-KEKKACD  TO    PRT-ERRCD
              MOVE      SPACE     TO        PRT-JKEKKA
                                            PRT-ERRNM1 PRT-ERRNM2
                                            PRT-ERRNM3 PRT-ERRNM4
                                            PRT-ERRSYO
       NOT INVALID
              MOVE      ERR-F03   TO        PRT-JKEKKA
              MOVE      ERR-F01   TO        PRT-ERRCD
              MOVE      ERR-F04   TO        WK-ERRNM
              MOVE      WK-ERRNM1 TO        PRT-ERRNM1
              MOVE      WK-ERRNM2 TO        PRT-ERRNM2
              MOVE      WK-ERRNM3 TO        PRT-ERRNM3
              MOVE      WK-ERRNM4 TO        PRT-ERRNM4
              MOVE      ERR-F02   TO        PRT-ERRSYO
     END-READ.
*プリント出力
     MOVE        SPACE       TO   PRT-CONTROL.
     MOVE        "FNJ0590L"  TO   PRT-FORMAT.
     MOVE        "SCREEN"    TO   PRT-GROUP.
     WRITE       PRT-FNJ0590L.
*終了処理
     CLOSE       PRTFILE  JSMMSGF  HTOKMS.
*
 MAIN-SEC-EXIT.
     EXIT.
