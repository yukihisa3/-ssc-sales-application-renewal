...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SKY6010L.COB`
...
***** メッセージエリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SKY6010L".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SKY6010L".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND1.
...
*    取引先マスタ読込み
****************************************************************
 HTOKMS-RD-SEC             SECTION.
*
     MOVE    "HTOKMS-RD-SEC"   TO   S-NAME.
**** MOVE    PARA-TOKCD        TO   TOK-F01.
     MOVE    JYU-F01           TO   TOK-F01.
*
     READ     HTOKMS
          INVALID
...
*事業部名称セット
     PERFORM  HTOKMS-RD-SEC.
*
     IF       HTOKMS-INV-FLG = SPACE
              MOVE TOK-F02    TO  HD01-JIGYOBU
     ELSE
              MOVE ALL NC"＊" TO  HD01-JIGYOBU
     END-IF.
*頁セット
     ADD      1              TO   P-CNT.
