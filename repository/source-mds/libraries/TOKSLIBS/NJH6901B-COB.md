...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH6901B.COB`
...
*ファイルヘッドレコード退避ワーク
 01  WK-DEPA-REC.
     ...
     03  WK-DEPA03          PIC  9(09).
     03  WK-DEPA04          PIC  9(03).
     03  WK-DEPA05          PIC  9(02).
     03  WK-DEPA06          PIC  X(04).
     03  WK-DEPA07          PIC  X(02).
     03  WK-DEPA08          PIC  9(02).
     03  WK-DEPA09          PIC  9(02).
     03  WK-DEPA10          PIC  9(08).
     03  WK-DEPA11          PIC  9(08).
     03  WK-DEPA12          PIC  9(06).
     03  WK-DEPA13          PIC  X(02).
     03  WK-DEPA14          PIC  X(15).
     03  WK-DEPA15          PIC  X(15).
     03  WK-DEPA16          PIC  X(15).
     03  WK-DEPA17          PIC  X(12).
     03  WK-DEPA18          PIC  9(01).
     03  WK-DEPA19          PIC  9(01).
     03  WK-DEPA20          PIC  X(17).
     03  WK-DEPA21          PIC  9(01).
*ヘッドレコード退避ワーク
 01  WK-DEPB-REC.
     03  WK-DEPB01          PIC  X(01).
     03  WK-DEPB02          PIC  9(02).
     03  WK-DEPB03          PIC  X(07).
     03  WK-DEPB04          PIC  X(26).
     03  WK-DEPB05          PIC  X(14).
     03  WK-DEPB06          PIC  X(07).
     03  WK-DEPB07          PIC  X(05).
     03  WK-DEPB08          PIC  X(15).
     03  WK-DEPB09          PIC  X(07).
     03  WK-DEPB10          PIC  X(16).
     03  WK-DEPB11          PIC  X(20).
     03  WK-DEPB12          PIC  X(07).
...
*    明細レコード退避ワーク
 01  WK-DEPD-REC.
     ...
     03  WK-DEPD13          PIC  X(13).
     03  WK-DEPD14          PIC  X(20).
     03  WK-DEPD15          PIC  X(10).
     03  WK-DEPD16          PIC  X(10).
     03  WK-DEPD17          PIC  X(04).
*
 01  WK-AREA.
*システム日付の編集
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH6901B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH6901B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    取引先電話
     MOVE     WK-DEPA17     TO        HEN-A17.
*    発注区分
     MOVE     WK-DEPA18     TO        HEN-A18.
*    特売区分
     MOVE     WK-DEPA19     TO        HEN-A19.
*    予備
     MOVE     WK-DEPA20     TO        HEN-A20.
*    伝票Ｈオプションライン
     MOVE     WK-DEPA21     TO        HEN-A21.
*伝票ヘッダー転送
*    レコード区分（ＤＨ）
     MOVE     WK-DEPB01     TO        HEN-A22.
*    データ種別
     MOVE     WK-DEPB02     TO        HEN-A23.
*    Ａ欄
     MOVE     WK-DEPB03     TO        HEN-A24.
*    Ｄ欄の上段
     MOVE     WK-DEPB04     TO        HEN-A25.
*    Ｄ欄の下段左
     MOVE     WK-DEPB05     TO        HEN-A26.
*    Ｄ欄の下段右
     MOVE     WK-DEPB06     TO        HEN-A27.
*    Ｅ欄
     MOVE     WK-DEPB07     TO        HEN-A28.
*    Ｆ欄の下段
     MOVE     WK-DEPB08     TO        HEN-A29.
*    Ｆ欄の上段
     MOVE     WK-DEPB09     TO        HEN-A30.
*    Ｌ欄の中段
     MOVE     WK-DEPB10     TO        HEN-A31.
*    Ｌ欄の上段
     MOVE     WK-DEPB11     TO        HEN-A32.
*    Ｌ欄の下段
     MOVE     WK-DEPB12     TO        HEN-A33.
*    伝票Ｈオプションライン
     MOVE     WK-DEPB13     TO        HEN-A34.
*伝票明細転送
*    レコード区分（ＤＤ）
     MOVE     WK-DEPD01     TO        HEN-A35.
*    データ種別
     MOVE     WK-DEPD02     TO        HEN-A36.
*    行番号
     MOVE     WK-DEPD03     TO        HEN-A37.
*    商品ＣＤ
     MOVE     WK-DEPD04     TO        HEN-A38.
*    入数
     MOVE     WK-DEPD05     TO        HEN-A39.
*    発注単位数
     MOVE     WK-DEPD06     TO        HEN-A40.
*    予備
     MOVE     WK-DEPD07     TO        HEN-A41.
*    数量
     MOVE     WK-DEPD08     TO        HEN-A42.
*    原価単価
     MOVE     WK-DEPD09     TO        HEN-A43.
*    売価単価
     MOVE     WK-DEPD10     TO        HEN-A44.
*    原価金額
     MOVE     WK-DEPD11     TO        HEN-A45.
*    売価金額
     MOVE     WK-DEPD12     TO        HEN-A46.
*    受注者商品ＣＤ
     MOVE     WK-DEPD13     TO        HEN-A47.
*    商品名
     MOVE     WK-DEPD14     TO        HEN-A48.
*    規格１
     MOVE     WK-DEPD15     TO        HEN-A49.
*    規格２
     MOVE     WK-DEPD16     TO        HEN-A50.
*    空白
     MOVE     WK-DEPD17     TO        HEN-A51.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
...
*取引先コード
     ...
     DISPLAY "HEN-F12 = " HEN-F12 UPON CONS.
     DISPLAY "WK-TOKCD = " WK-TOKCD UPON CONS.
*伝票ナンバー
     MOVE    HEN-A03       TO        HEN-F02.
     MOVE    HEN-A03       TO        HEN-F23.
*行■
     MOVE    HEN-A37       TO        HEN-F03.
*伝区
     MOVE        40        TO        HEN-F051.
...
*    商品名称マスタ検索
     ...
     READ    MEIMS1
       INVALID
*        商品名
         MOVE    HEN-A48(1:15)  TO   HEN-F1421(1:15)
         MOVE    HEN-A48(16:5)  TO   HEN-F1422(1:5)
         MOVE    HEN-A49(1:10)  TO   HEN-F1422(6:10)
       NOT INVALID
         MOVE    HEN-A48(1:15)  TO   HEN-F1421(1:15)
         MOVE    HEN-A48(16:5)  TO   HEN-F1422(1:5)
         MOVE    HEN-A49(1:10)  TO   HEN-F1422(6:10)
...
*修正売価金額
     COMPUTE     HEN-F522 = HEN-A42 * HEN-A44.
*
 TENSO-EXIT.
     EXIT.
****************************************************************
