...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY7399B.COB`
...
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
 ...
 01  WK-ZAI-12-1        PIC S9(02)     VALUE  ZERO.
 01  LINK-AREA2.
...
*----<< 出荷情報データ >>--*
 KMS-ERR              SECTION.
     ...
     DISPLAY  "### SSY7399B DYSYUKF    ERROR " KMS-ST " "
...
*----<< 条件ファイル >>--*
 JYO-ERR              SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     "4000"         TO   PROGRAM-STATUS.
     DISPLAY  "### SSY7399B HJYOKEN    ERROR " JYO-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
...
*2013/04/27 削除月数を３カ月に固定する。
             MOVE     3           TO   WK-SAKUJO
     END-READ.
*----<< 基準日付算出 >>-*
     MOVE     99                  TO   WK-ZAI-2.
*****COMPUTE  WK-ZAI-12  =  WK-ZAI-12  -  WK-SAKUJO.
     COMPUTE  WK-ZAI-12-1  =  WK-ZAI-12  -  WK-SAKUJO.
     DISPLAY "WK-ZAI-12-1  = " WK-ZAI-12-1  UPON CONS.
*****IF  WK-ZAI-12  <=  ZERO
     IF  WK-ZAI-12-1  <=  ZERO
         ADD    -1      TO        WK-ZAI-11
         MOVE   WK-ZAI-12-1  TO   WK-ZAI-12
         COMPUTE WK-ZAI-12 =  12   -   WK-ZAI-12
*********MOVE   12      TO        WK-ZAI-12
     ELSE
         MOVE   WK-ZAI-12-1  TO   WK-ZAI-12
     END-IF.
     DISPLAY "WK-ZAI-11    = " WK-ZAI-11    UPON CONS.
     DISPLAY "WK-ZAI-11    = " WK-ZAI-12    UPON CONS.
*----<< 削除基準日出力 >>-*
