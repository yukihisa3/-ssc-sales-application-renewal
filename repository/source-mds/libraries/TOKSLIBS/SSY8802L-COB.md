...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8802L.COB`
...
***数量
     ...
     03  FILLER                   PIC  X(03)     VALUE SPACE.
***訂正後数量
     03  DT1-07                   PIC  ZZZZZ9.
     03  FILLER                   PIC  X(05)     VALUE SPACE.
***原単価（整数）
     03  DT1-081                  PIC  ZZZZZ9.
***原単価（小数）
     03  DT1-082                  PIC  ZZ.
***原価金額
     03  DT1-09                   PIC  ZZZZZZZZ9.
***売単価
     03  DT1-10                   PIC  ZZZZZ9.
***売価金額
     03  DT1-11                   PIC  ZZZZZZZZ9.
*
*--------------------------------------------------------------*
*    テイル行                                                  *
*--------------------------------------------------------------*
