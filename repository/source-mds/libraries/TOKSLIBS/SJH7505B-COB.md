...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SJH7505B.COB`
...
*ファイルヘッドレコード退避ワーク
 01  WK-DEPA-REC.
     ...
     03  WK-DEPA15          PIC  X(65).
*ヘッドレコード退避ワーク
 01  WK-DEPB-REC.
     03  WK-DEPB01          PIC  X(01).
     03  WK-DEPB02          PIC  9(02).
     03  WK-DEPB03          PIC  9(06).
     03  WK-DEPB04          PIC  X(03).
     03  WK-DEPB05          PIC  9(03).
     03  WK-DEPB06          PIC  9(08).
     03  WK-DEPB07          PIC  X(01).
     03  WK-DEPB08          PIC  9(02).
     03  WK-DEPB09          PIC  9(02).
     03  WK-DEPB10          PIC  9(08).
     03  WK-DEPB11          PIC  9(08).
     03  WK-DEPB12          PIC  X(10).
     03  WK-DEPB13          PIC  X(07).
     03  WK-DEPB14          PIC  X(10).
     03  WK-DEPB15          PIC  X(15).
     03  WK-DEPB16          PIC  9(02).
     03  WK-DEPB17          PIC  X(08).
     03  WK-DEPB18          PIC  X(08).
     03  WK-DEPB19          PIC  X(05).
     03  WK-DEPB20          PIC  X(08).
     03  WK-DEPB21          PIC  X(11).
*    明細レコード退避ワーク
 01  WK-DEPD-REC.
     03  WK-DEPD01          PIC  X(01).
     03  WK-DEPD02          PIC  9(02).
     03  WK-DEPD03          PIC  9(03).
     03  WK-DEPD04          PIC  9(08).
     03  WK-DEPD05          PIC  9(02).
     03  WK-DEPD06          PIC  X(05).
     03  WK-DEPD07          PIC  9(01).
     03  WK-DEPD08          PIC  X(20).
     03  WK-DEPD09          PIC  X(20).
     03  WK-DEPD10          PIC  X(13).
     03  WK-DEPD11          PIC  9(05)V9(01).
     03  WK-DEPD12          PIC  9(07)V9(02).
     03  WK-DEPD13          PIC  9(07).
     03  WK-DEPD14          PIC  9(07).
     03  WK-DEPD15          PIC  9(05).
     03  WK-DEPD16          PIC  X(19).
*
 01  WK-AREA.
*システム日付の編集
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJH7505B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJH7505B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*伝票明細転送
*    レコード区分
     MOVE     WK-DEPD01     TO        HEN-A22.
*    データ種別
     MOVE     WK-DEPD02     TO        HEN-A23.
*    店舗コード
     MOVE     WK-DEPD03     TO        HEN-A24.
*    伝票番号
     MOVE     WK-DEPD04     TO        HEN-A25.
*    行番号
     MOVE     WK-DEPD05     TO        HEN-A26.
*    予備　
     MOVE     WK-DEPD06     TO        HEN-A27.
*    商品種別
     MOVE     WK-DEPD07     TO        HEN-A28.
*    商品名１
     MOVE     WK-DEPD08     TO        HEN-A29.
*    商品名２
     MOVE     WK-DEPD09     TO        HEN-A30.
*    ＪＡＮコード
     MOVE     WK-DEPD10     TO        HEN-A31.
*    発注数量
     MOVE     WK-DEPD11     TO        HEN-A32.
*    原価単価
     MOVE     WK-DEPD12     TO        HEN-A33.
*    総額売価単価
     MOVE     WK-DEPD13     TO        HEN-A34.
*    総額売価単価（プライスカード用）
     MOVE     WK-DEPD14     TO        HEN-A35.
*    ケース数　
     MOVE     WK-DEPD15     TO        HEN-A36.
*    予備
     MOVE     WK-DEPD16     TO        HEN-A37.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
...
*原価金額
     COMPUTE     HEN-F181  =  HEN-A32  *  HEN-A33.
*売価金額
     COMPUTE     HEN-F182  =  HEN-A32  *  HEN-A34.
...
*訂正前数量
     MOVE        HEN-A32         TO        HEN-F50.
*修正原価単価
     MOVE        HEN-A33         TO        HEN-F512.
*修正売価単価
     MOVE        HEN-A34         TO        HEN-F513.
*修正原価金額
