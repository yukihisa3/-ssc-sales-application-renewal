...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8771L.COB`
...
*
 ...
 FILE-CONTROL.
*----<< ＤＣＭ出荷確定データ >>--*
     SELECT   DJSYUKF   ASSIGN         DA-01-VI-DJSYUKL7
...
*----<< カーマ出荷確定データ >>--*
 DJSYUKF-ERR            SECTION.
     ...
     DISPLAY  "### SSY8771L DJSYUKF ERROR " DJSYUKF-ST " "
