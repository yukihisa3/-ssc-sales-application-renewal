...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY2904L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*ジャスコ伝票データ（共通）　　
     SELECT   JUSHIRED  ASSIGN    TO        JUSHIRED
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      JUSHIRED.
...
*    クラス
     MOVE     DEN-A24             TO   DT21-02  DT22-02.
*    商品コード
     MOVE     DEN-A18             TO   DT21-03  DT22-03.
*    入数
     IF       DEN-A22   =   SPACE
...
***  MOVE     DEN-A27             TO        HD5-02.
     ...
     MOVE     DEN-A27             TO        HD5-02.
***  DISPLAY "DEN-A27 = " DEN-A27 UPON CONS.
***  DISPLAY "HD5-02  = " HD5-02  UPON CONS.
***  分類コード(大分類)
...
*
     CLOSE    JUSHIRED   PRTFILE    DSPFILE.
*
 END-EXIT.
     EXIT.
