...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8509L.COB`
...
*--<< ﾌﾟﾘﾝﾄ AREA >>-*
 ...
 01  HD02.
     03  FILLER         CHARACTER TYPE PITCH-1-5.
         ...
         05  FILLER     PIC  N(02)     VALUE  NC"納品".
 01  HD03.
     03  FILLER         CHARACTER TYPE PITCH-1-5.
         05  FILLER     PIC  X(02)     VALUE  SPACE.
 ...
 01  HD05.
     03  FILLER         CHARACTER TYPE PITCH-1-5.
         ...
         05  FILLER     PIC  X(01)     VALUE  SPACE.
         05  FILLER     PIC  N(03)     VALUE  NC"行番号".
...
*    納品　
     EVALUATE KMK-F09L
         WHEN 2
              MOVE     "ﾊｲｿｳｾﾝﾀｰ"   TO   HD03-KANNM
         WHEN 3
              MOVE     "ﾃﾝﾎﾟ"       TO   HD03-KANNM
     END-EVALUATE.
*    納品先店ＣＤ
     MOVE     KMK-F09M  TO   HD03-NOUS.
*    納品指定日
     MOVE     KMK-F09B(1:4)   TO   WK-H-YYYY.
     MOVE     KMK-F09B(5:2)   TO   WK-H-MM.
     MOVE     KMK-F09B(7:2)   TO   WK-H-DD.
     MOVE     "/"             TO   WK-H-KU1 WK-H-KU2.
     MOVE     WK-HIZUKE-HENSYU TO HD03-NOUBI.
*    発注日
...
*    ヘッダ印刷
     ...
     WRITE    PRT-REC  FROM  HD031 AFTER  1.
...
*    売価金額
     ...
     COMPUTE  WK-GK-BAIKA  =  WK-GK-BAIKA +
                              ( WK-SURYO * KMK-F10D ).
*    行番号　　
     MOVE   KMK-F105            TO   MS02-GYONO.
*    〇以上の場合に出力対象
*1/29IF   WK-SURYO  >  ZERO
