...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SEG0080I.COB`
...
*
 LINKAGE                SECTION.
 01  PARA-EIGYO             PIC   9(02).
 01  PARA-SOKO              PIC   9(02).
...
*
****************************************************************
 PROCEDURE     DIVISION USING PARA-EIGYO     PARA-SOKO
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SEG0080I DSPFILE ERROR " DSP-CNTL " "
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SEG0080I HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SEG0080I ZSOKMS1 ERROR " ZSOKMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FEG00801.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-BODY-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "SEG0080I"      TO   PGID.
     MOVE    "FEG00801"      TO   FORM.
*営業所名表示
     MOVE     PARA-SOKO      TO   SOKO.
     MOVE     PARA-EIGYO     TO   SOK-F01.
     READ     ZSOKMS1
              INVALID  KEY
                 MOVE      SPACE     TO   EIGYON
              NOT INVALID  KEY
                 MOVE      SOK-F02   TO   EIGYON
     END-READ.
*
     MOVE      1             TO   GR-NO.
*
     MOVE     SPACE          TO   DSP-CNTL.
     MOVE     "FEG00801"     TO   DSP-FMT.
