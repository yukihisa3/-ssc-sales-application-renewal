...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SBT2030L.COB`
...
*    サブシステム　　　　：　甘木ＬＩＮＫＳ連携　
*    業務名　　　　　　　：　出荷業務　　　　　　
*    モジュール名　　　　：　新ナフコLINKS連携結果リスト出力
*    作成日／作成者　　　：　2016/08/19  NAV TAKAHASHI
*    処理概要　　　　　　：　データ抽出結果をパラメータで　　
*    　　　　　　　　　　：  受取り、抽出結果としてリストを
*    　　　　　　　　　　：　出力する。　　　　　　　　　　　
*    更新履歴　　　　　　：
...
****  見出し行１             ****
 01  MIDASI-1.
     ...
     02  FILLER              PIC  X(08)  VALUE  "SBT2030L".
...
****  明細行１２             ****
 01  MEISAI-12.
     ...
     02  FILLER              PIC  N(01) VALUE  NC"："
                                        CHARACTER TYPE IS YB-21.
     02  SUUCHI6             PIC  N(08) CHARACTER TYPE IS YB-21.
     02  FILLER              PIC  N(01) VALUE NC"件"
     CHARACTER TYPE IS YB-21.
****  明細行１４             ****
 01  MEISAI-14.
...
**********************************************************
 INIT-SEC                  SECTION.
     ...
     MOVE        61        TO        LINE-CNT.
*パラメタ内容をチェック
     DISPLAY NC"部門　　　＝　" PAR-BMNCD        UPON CONS.
     DISPLAY NC"担当者　　＝　" PAR-TANCD        UPON CONS.
     DISPLAY NC"抽出区分　＝　" PAR-CHUKBN       UPON CONS.
     DISPLAY NC"倉庫ＣＤ　＝　" PAR-SOKOCD       UPON CONS.
     DISPLAY NC"件数１　　＝　" PAR-KENSU1       UPON CONS.
     DISPLAY NC"件数２　　＝　" PAR-KENSU2       UPON CONS.
     DISPLAY NC"件数３　　＝　" PAR-KENSU3       UPON CONS.
     DISPLAY NC"件数４　　＝　" PAR-KENSU4       UPON CONS.
     DISPLAY NC"件数５　　＝　" PAR-KENSU5       UPON CONS.
     DISPLAY NC"件数６　　＝　" PAR-KENSU6       UPON CONS.
*システム日付・時刻の取得
...
*    DISPLAY  "SBT2030L READ =" READ-CNT UPON STA.
 END-EXIT.
     EXIT.
**********************************************************
*                 ヘッダデータ編集                      *
...
*抽出区分
     EVALUATE  PAR-CHUKBN
        WHEN   "1"
               MOVE NC"本発デリバリ以外出荷数ＤＴ" TO CHUKBNM
        WHEN   "2"
               MOVE NC"本発デリバリ　　出荷数ＤＴ" TO CHUKBNM
        WHEN   "3"
               MOVE NC"リピート　箱データ　　　　" TO CHUKBNM
        WHEN   "4"
               MOVE NC"リピート　出荷数　　　　　" TO CHUKBNM
        WHEN   "5"
               MOVE NC"本発すべて　　　出荷数ＤＴ" TO CHUKBNM
        WHEN   "6"
