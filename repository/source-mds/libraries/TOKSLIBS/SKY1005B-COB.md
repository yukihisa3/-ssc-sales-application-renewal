...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SKY1005B.COB`
...
*****取引先マスタ検索*****
     MOVE     33189     TO   TOK-F01  TOKCD.
     READ     HTOKMS
        INVALID
              DISPLAY "イオン取引先ＣＤ未登録" UPON CONS
              STOP  RUN
        NOT  INVALID
