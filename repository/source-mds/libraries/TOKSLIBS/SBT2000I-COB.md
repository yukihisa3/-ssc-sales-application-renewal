...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SBT2000I.COB`
...
*画面表示用ワーク
 01  DSP-WORK.
     03  WORK-PGID                PIC  X(08)  VALUE  "SBT2000I".
     03  WORK-FORMID              PIC  X(08)  VALUE  "FBT20001".
*フラグ領域
 01  FLG-AREA.
