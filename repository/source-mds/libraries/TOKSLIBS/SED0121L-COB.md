...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SED0121L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*ＥＤＩＣ伝票データ（共通）　　
     SELECT   MKSHIRED  ASSIGN    TO        MKSHIRED
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      MKSHIRED.
...
***
                   ...
                   PERFORM   DENP-WT-SEC
                             UNTIL     END-FLG   =   "END"
                   CLOSE     MKSHIRED  PRTFILE  EDJOHOF
                   OPEN      INPUT     MKSHIRED
                   OPEN      OUTPUT    PRTFILE
                   OPEN      INPUT     EDJOHOF
                   MOVE      1         TO   ERR-FLG
...
*
     CLOSE    MKSHIRED   PRTFILE    DSPFILE   EDJOHOF.
*
 END-EXIT.
     EXIT.
****************************************************************
