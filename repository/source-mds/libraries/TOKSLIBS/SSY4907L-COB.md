...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY4907L.COB`
...
***** メッセージエリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY4907L".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY4907L".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND1.
...
*             プロセス                      0.0                *
****************************************************************
 SSY4907L-START         SECTION.
*
     MOVE   "SSY4907L-START"      TO   S-NAME.
     PERFORM            INIT-SEC.
*
...
*事業部名称セット
     EVALUATE PARA-TOKCD
         WHEN 880   MOVE NC"関東資材　" TO  HD01-JIGYOBU
         WHEN 882   MOVE NC"仙台資材　" TO  HD01-JIGYOBU
         WHEN 883   MOVE NC"北海道資材" TO  HD01-JIGYOBU
         WHEN 1427  MOVE NC"関東植物　" TO  HD01-JIGYOBU
         WHEN 14272 MOVE NC"仙台植物　" TO  HD01-JIGYOBU
         WHEN 14273 MOVE NC"北海道植物" TO  HD01-JIGYOBU
...
*発注数
     ...
     EVALUATE JYU-F08
         WHEN 01
              ...
              COMPUTE MD01-GENKAKIN = JYU-F12 * JYU-F13
