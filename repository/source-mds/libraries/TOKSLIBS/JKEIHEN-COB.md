...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/JKEIHEN.COB`
...
*--------------------------------------------------------------*
 01  PGM-ID                  PIC  X(08)     VALUE  "JKEIHEN ".
*----<< ﾃﾞｨｽﾌﾟﾚｲ ｺﾝﾄﾛｰﾙ ｴﾘｱ >>-*
 01  DSP-CNTL.
     03  DSP-FMT             PIC  X(08).
     03  DSP-GRP             PIC  X(08).
...
*画面退避用
     COPY   JHONHEN  OF XMDLIB  JOINING   SAV  AS   PREFIX.
*
 01  SAVE-AREA.
...
*画面＆ＴＢＬクリア
     ...
     MOVE      SPACE     TO   JHONHEN   TABLE-AREA.
     INITIALIZE               TBL-XX.
     MOVE      ZERO      TO   WK-TAIHI.
...
*--------------------------------------------------------------*
 900-DENNO-GET          SECTION.
     ...
     ELSE
              DISPLAY   NC"伝票Ｎｏ採番エラー"  UPON CONS
