...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SNA0030I.COB`
...
*    業務名　　　　　：
*    モジュール名　　：小売連携発注データ抽出指示（手書き）
*    作成日／更新日　：2011/10/28
*    作成者／更新者　：飯田/NAV
*    処理概要　　　　：
*      苗業務システムへ送信する小売連携（手書き分）
