...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SED0010I.COB`
...
*----<< 取引先マスタ >>--*
     SELECT   HTOKMS    ASSIGN         DA-01-VI-TOKMS2
                        ...
                        STATUS         HTOKMS-ST.
*----<< EDIC受領MSG >>--*
     SELECT   JURYOMSG  ASSIGN         DA-01-VI-EDJYURL2
                        ORGANIZATION   INDEXED
                        ACCESS    MODE RANDOM
                        RECORD    KEY  JUR-F013
                        STATUS         JURYOMSG-ST.
...
*----<< 表示ファイル >>--*
 FD  DSPFILE            LABEL     RECORD   IS   STANDARD.
     COPY     FED00101  OF        XMDLIB.
*----<< 取引先マスタ >>--*
 FD  HTOKMS             LABEL RECORD   IS   STANDARD.
     COPY     HTOKMS    OF        XFDLIB
              JOINING   TOK       PREFIX.
*----<< EDIC受領MSG >>--*
 FD  JURYOMSG           LABEL     RECORD   IS   STANDARD.
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SED0010I DSPFILE ERROR " DSP-CNTL " "
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SED0010I HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
     ...
     STOP     RUN.
*----<< ＥＤＩＣ受領ＭＳＧ >>--*
 JURYOMSG-ERR             SECTION.
     USE AFTER     EXCEPTION PROCEDURE      JURYOMSG.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SED0010I EDJYURF ERROR " JURYOMSG-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FED00101.
*
     MOVE     SPACE          TO   DSP-CNTL.
     MOVE     "FED00101"     TO   DSP-FMT.
...
*ＥＤＩＣ受領ＭＳＧ存在チェック
***  ＥＤＩＣ受領ＭＳＧ　ＲＥＡＤ
     MOVE     TORICD TO   JUR-F013.
     PERFORM  900-JUR-READ.
     IF       JUR-INVALID-FLG = "1"
              MOVE     JUR-F011  TO  JUSHIN
     ELSE
...
*
     EVALUATE DSP-FNC
         ...
         WHEN ENT
              ...
              MOVE      JUSHIN    TO   PARA-DATE
              MOVE      JUR-F012  TO   PARA-TIME
         WHEN OTHER
              MOVE NC"ＰＦキーが違います"   TO   MSGSPC
     END-EVALUATE.
*
