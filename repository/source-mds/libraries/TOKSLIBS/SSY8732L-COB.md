...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8732L.COB`
...
***** メッセージエリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY8732L".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY8732L".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND1.
...
*             プロセス                      0.0                *
****************************************************************
 SSY8732L-START         SECTION.
*
     MOVE   "SSY8732L-START"      TO   S-NAME.
     PERFORM            INIT-SEC.
*
...
*事業部名称セット
     EVALUATE PARA-TOKCD
         ...
         WHEN 13938   MOVE NC"カーマ　資材　" TO  HD01-JIGYOBU
         WHEN 17137   MOVE NC"カーマ　植物　" TO  HD01-JIGYOBU
         WHEN 100403  MOVE NC"　ダイキ　　　" TO  HD01-JIGYOBU
...
*発注数
     ...
     EVALUATE JYU-F08
         WHEN 01
              ...
              COMPUTE WK-GENKA-KIN  = JYU-F12 * JYU-F13
...
*#############2019/09/17 NAV ST 消費税軽減税率対応
              COMPUTE MD01-ZEIRITU = JYU-F17 / 1000
...
**************MOVE  WK-KENSYU-SU TO  MD01-GENTANKA
              ...
              COMPUTE WK-GENKA-KIN = WK-KENSYU-SU * JYU-F13
              MOVE  WK-GENKA-KIN TO  MD01-GENKAKIN
              ADD   WK-GENKA-KIN TO  WK-DENPYO-KEI
              ADD   WK-GENKA-KIN TO  WK-TENPO-KEI
              ADD   WK-GENKA-KIN TO  WK-SOGOKEI
