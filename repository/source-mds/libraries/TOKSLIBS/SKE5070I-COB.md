...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SKE5070I.COB`
...
*----<< 表示ファイル >>--*
 FD  DSPFILE            LABEL     RECORD   IS   STANDARD.
     COPY     FKE50701  OF        XMDLIB.
*--------------------------------------------------------------*
 WORKING-STORAGE        SECTION.
*--------------------------------------------------------------*
 01  FLAGS.
     03  ERR-FLG        PIC  9(02)    VALUE  ZERO.
     03  CNT-FLG        PIC  9(02)    VALUE  ZERO.
*
*----<< ﾌｱｲﾙ ｽﾃｰﾀｽ >>--*
...
*
 LINKAGE                SECTION.
 01  PARA-TENMS             PIC   X(01).
 01  PARA-SHOMS             PIC   X(01).
 01  PARA-LCTMS             PIC   X(01).
 01  PARA-KGPMS             PIC   X(01).
 01  PARA-SKTMS             PIC   X(01).
*
****************************************************************
 PROCEDURE              DIVISION USING PARA-TENMS
                                       PARA-SHOMS
                                       PARA-LCTMS
                                       PARA-KGPMS
                                       PARA-SKTMS.
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SKE5070I DSPFILE ERROR " DSP-CNTL " "
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FKE50701.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "SKE5070I"      TO   PGID.
     MOVE    "FKE50701"      TO   FORM.
...
*
     MOVE     TENMS               TO   PARA-TENMS.
     MOVE     SHOMS               TO   PARA-SHOMS.
     MOVE     LCTMS               TO   PARA-LCTMS.
     MOVE     KGPMS               TO   PARA-KGPMS.
     MOVE     SKTMS               TO   PARA-SKTMS.
*
**QQ MOVE     0                   TO   GR-NO.
     MOVE     99                  TO   GR-NO.
*
...
*--------------------------------------------------------------*
 CLR-HEAD-RTN           SECTION.
     MOVE     " "            TO   EDIT-CURSOR OF TENMS
                                  EDIT-CURSOR OF SHOMS
                                  EDIT-CURSOR OF LCTMS
                                  EDIT-CURSOR OF KGPMS
                                  EDIT-CURSOR OF SKTMS.
     MOVE     "M"            TO   EDIT-OPTION OF TENMS
                                  EDIT-OPTION OF SHOMS
                                  EDIT-OPTION OF LCTMS
                                  EDIT-OPTION OF KGPMS
                                  EDIT-OPTION OF SKTMS.
 CLR-HEAD-EXIT.
     EXIT.
*--------------------------------------------------------------*
*    LEVEL  3      ＴＡＩＬ　属性クリア　　　　　　　　　　　　*
