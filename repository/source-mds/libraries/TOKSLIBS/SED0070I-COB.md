...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SED0070I.COB`
...
*
 ...
 01  PARA-DENNOF            PIC   9(09).
 01  PARA-DENNOT            PIC   9(09).
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SED0070I DSPFILE ERROR " DSP-CNTL " "
...
*----<< 伝票データ >>--*
 SHTDENF-ERR            SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SED0070I SHTDENF ERROR " SHTDENF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SED0070I HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SED0070I ZSOKMS1 ERROR " ZSOKMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FED00701.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "SED0070I"      TO   PGID.
     MOVE    "FED00701"      TO   FORM.
*
                        ...
                        IF ( TORICD    =    DEN-F01 )
                             ...
                             ELSE
                                  ...
                                  MOVE "R"  TO
                                        ...
                                        EDIT-OPTION OF DENST
                                        EDIT-OPTION OF DENED
                                        EDIT-OPTION OF SOKO
...
*
     MOVE     99999999            TO   PARA-DATE.
     MOVE     9999                TO   PARA-TIME.
     MOVE     TORICD              TO   PARA-TORICD.
     MOVE     DENST               TO   PARA-DENNOF.
     MOVE     DENED               TO   PARA-DENNOT.
     IF       SOKO      NOT =  SPACE
...
*                                 EDIT-CURSOR OF JTIME
     MOVE     " "            TO   EDIT-CURSOR OF TORICD
                                  EDIT-CURSOR OF DENST
                                  EDIT-CURSOR OF DENED
