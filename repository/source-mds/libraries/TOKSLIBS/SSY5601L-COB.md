...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY5601L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*伝票データ（共通）　　
     SELECT   SNSHIRED  ASSIGN    TO        SNSHIRED
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      SNSHIRED.
...
*ヘッダ３行目
***  社名
     MOVE     DEN-A10(1:20)       TO        HD3-01.
*ヘッダ４行目
***  取引先名（中段）
     MOVE     DEN-A12(1:20)       TO        HD4-01.
*ヘッダ５行目
***  店名
     MOVE     DEN-A11(1:20)       TO        HD5-01.
***  社ＣＤ
     MOVE     DEN-A041            TO        HD5-02.
***  店舗ＣＤ
     MOVE     DEN-A042            TO        HD5-03.
***  分類コード
     MOVE     DEN-A05             TO        HD5-04.
***  伝票区分
     MOVE     DEN-A06             TO        HD5-05.
***  伝票_
     MOVE     DEN-F02             TO        HD5-06.
***  取引先コード
     MOVE     DEN-A091            TO        HD5-07.
***  取引先名（下段）
     MOVE     DEN-A12(21:5)       TO        HD5-08.
***  発注日
...
*
     CLOSE    SNSHIRED   PRTFILE    DSPFILE.
*
 END-EXIT.
     EXIT.
