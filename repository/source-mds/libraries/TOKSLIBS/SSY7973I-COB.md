...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY7973I.COB`
...
*                                                              *
*                                                              *
*2007/11/19 DCMJAPANへの変更による発注種別区分修正             *
*2008/02/20 部門CD変更
****************************************************************
...
*
*---<<  ダイキセンター納品データ  >>---*
     SELECT   DKCENTF   ASSIGN    TO        DA-01-VI-DSCENTL1
...
*---<<  画面ファイル  >>---*
 ...
 01  DSP-REC            PIC  X(2000).
     COPY     FSY79731  OF        XMDLIB.
*---<<  ダイキセンター納品データ  >>---*
 FD  DKCENTF.
     COPY     DKCENTF   OF        XFDLIB
              JOINING   DKC       PREFIX.
*---<<  取引先マスタ  >>---*
 FD  HTOKMS.
...
****  メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SSY7973I".
...
*2007/11/19 DCMJAPANへの変更による発注種別区分変更
              WHEN    "6"
                   MOVE "6"              TO   HACCD(IXA)
...
******** EVALUATE  DKC-F07
************* WHEN    001
****************** MOVE     NC"日曜大工"   TO   BUMONM(IXA)
************* WHEN    002
****************** MOVE     NC"建築建物"   TO   BUMONM(IXA)
************* WHEN    003
****************** MOVE     NC"木材・建材" TO   BUMONM(IXA)
************* WHEN    004
****************** MOVE     NC"インテリア" TO   BUMONM(IXA)
************* WHEN    005
****************** MOVE     NC"塗料接着剤" TO   BUMONM(IXA)
************* WHEN    006
****************** MOVE     NC"家庭用品"   TO   BUMONM(IXA)
************* WHEN    007
****************** MOVE     NC"住設配管"   TO   BUMONM(IXA)
************* WHEN    008
****************** MOVE     NC"園芸用品"   TO   BUMONM(IXA)
************* WHEN    009
****************** MOVE     NC"ペット用品" TO   BUMONM(IXA)
************* WHEN    010
****************** MOVE     NC"電気用品"   TO   BUMONM(IXA)
************* WHEN    011
****************** MOVE     NC"保安自転車" TO   BUMONM(IXA)
************* WHEN    012
****************** MOVE     NC"エクステリア" TO BUMONM(IXA)
************* WHEN    013
****************** MOVE     NC"カー用品"   TO   BUMONM(IXA)
************* WHEN    014
****************** MOVE     NC"文教用品"   TO   BUMONM(IXA)
************* WHEN    015
****************** MOVE     NC"花木"       TO   BUMONM(IXA)
************* WHEN    016
****************** MOVE     NC"日用雑貨"   TO   BUMONM(IXA)
************* WHEN    018
****************** MOVE     NC"収納用品"   TO   BUMONM(IXA)
************* WHEN    019
****************** MOVE     NC"ガーデン用品" TO BUMONM(IXA)
************* WHEN    021
****************** MOVE     NC"ライフ用品" TO   BUMONM(IXA)
************* WHEN    OTHER
...
**08/02/20 STR
         EVALUATE     DKC-F07
              ...
              WHEN    006
                   MOVE     NC"カー用品"        TO   BUMONM(IXA)
              WHEN    007
                   MOVE     NC"電材"            TO   BUMONM(IXA)
              WHEN    008
                   MOVE     NC"日用消耗"        TO   BUMONM(IXA)
              WHEN    009
                   MOVE     NC"スポーツ・玩具"  TO   BUMONM(IXA)
              WHEN    010
                   MOVE     NC"文具"            TO   BUMONM(IXA)
              WHEN    011
                   MOVE     NC"ガーデンＥＸ"    TO   BUMONM(IXA)
              WHEN    012
                   MOVE     NC"ペット"          TO   BUMONM(IXA)
              WHEN    013
                   MOVE     NC"植物"            TO   BUMONM(IXA)
              WHEN    014
                   MOVE     NC"家具・収納"      TO   BUMONM(IXA)
              WHEN    015
              ...
              WHEN    016
                   MOVE     NC"自転車・レジャー"
                                                TO   BUMONM(IXA)
              WHEN    017
                   MOVE     NC"家電"            TO   BUMONM(IXA)
              WHEN    018
                   MOVE     NC"ダイニングキッチン"
                                                TO   BUMONM(IXA)
              WHEN    019
                   MOVE     NC"ソフトグッズ"    TO   BUMONM(IXA)
              WHEN    020
                   MOVE   NC"カウンター用品・サングラス・喫煙具"
                                                TO   BUMONM(IXA)
              WHEN    022
                   MOVE   NC"ＨＢＣ（ヘアケア・ボディ・車椅子）"
                                                TO   BUMONM(IXA)
              WHEN    023
                   MOVE     NC"作業用品"        TO   BUMONM(IXA)
              WHEN    024
                   MOVE     NC"リフォーム"      TO   BUMONM(IXA)
              WHEN    025
                   MOVE     NC"寝具"            TO   BUMONM(IXA)
              WHEN    027
                   MOVE     NC"照明"            TO   BUMONM(IXA)
              WHEN    028
                   MOVE     NC"バス・トイレタリー"
                                                TO   BUMONM(IXA)
              WHEN    029
                   MOVE     NC"ペットコンセ"    TO   BUMONM(IXA)
              WHEN    030
                   MOVE     NC"食品"            TO   BUMONM(IXA)
              WHEN    031
...
*
     ...
     START   DKCENTF     KEY  >=  DKC-F01 DKC-F02 DKC-F03
...
*
     ...
     END-READ.
*
*****DISPLAY "DKC-F01    = " DKC-F01     UPON CONS.
*****DISPLAY "DKC-F02    = " DKC-F02     UPON CONS.
*****DISPLAY "DKC-F03    = " DKC-F03     UPON CONS.
*****DISPLAY "DKC-F04    = " DKC-F04     UPON CONS.
*****DISPLAY "DKC-F05    = " DKC-F05     UPON CONS.
*****DISPLAY "DKC-F06    = " DKC-F06     UPON CONS.
 ...
 BODY-SUB            SECTION.
     ...
     PERFORM  VARYING  IXB   FROM  1  BY  1
         ...
         IF   BUMON(IXB)    IS  NOT NUMERIC     OR
            ( BUMON(IXB)    =   ZERO   OR  017  OR  020  OR
              BUMON(IXB)    >   021 )
...
*2007/11/19 DCMJAPANへの変更による発注種別区分変更
     ...
     END-IF.
*    部門ＣＤ
**** IF     ( BUMON(IXA)    >=    001  AND
************* BUMON(IXA)    <=    016  )   OR
************* BUMON(IXA)    =     018  OR  019  OR  021
*        部門名
******** EVALUATE  BUMON(IXA)
************* WHEN    001
****************** MOVE     NC"日曜大工"   TO   BUMONM(IXA)
...
************************************************************
 END-SEC                SECTION.
*
     CLOSE    DSPF DKCENTF  ZSOKMS HTOKMS HTENMS.
*
 END-END.
     EXIT.
************************************************************
