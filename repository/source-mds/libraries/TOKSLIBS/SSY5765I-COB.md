...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY5765I.COB`
...
*----<< 表示ファイル >>--*
     SELECT   DSPFILE   ASSIGN         01-GS-DSPF
                        ...
                        STATUS         DSP-ST.
*----<< グッデイ基本情報ファイル >>--*
     SELECT   GDJOHOL2   ASSIGN        DA-01-VI-GDJOHOL2
                        ...
                        STATUS         GDJOHOL2-ST.
*----<< グッデイ出荷情報ファイル >>--*
     SELECT   GDSYUKL2   ASSIGN        DA-01-VI-GDSYUKL2
                        ORGANIZATION   INDEXED
                        ACCESS    MODE SEQUENTIAL
...
*
*----<< ﾌｱｲﾙ ｽﾃｰﾀｽ >>--*
 01  GDJOHOL2-ST       PIC  X(02).
 01  GDSYUKL2-ST       PIC  X(02).
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SSY5765I DSPFILE ERROR " DSP-CNTL " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
*    CLOSE    GDJOHOL2   GDSYUKL2  TOKMS2    ZSOKMS1    DSPFILE.
     STOP     RUN.
*----<< 基本情報ファイル >>--*
 GDJOHOL2-ERR            SECTION.
     USE AFTER     EXCEPTION PROCEDURE      GDJOHOL2.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY5765I GDJOHOL2 ERROR " GDJOHOL2-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
*    CLOSE    GDJOHOL2   GDSYUKL2  TOKMS2    ZSOKMS1    DSPFILE.
     STOP     RUN.
*----<< 出荷情報ファイル >>--*
 GDSYUKL2-ERR            SECTION.
     USE AFTER     EXCEPTION PROCEDURE      GDSYUKL2.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY5765I GDSYUKL2 ERROR " GDSYUKL2-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 取引先マスタ >>--*
 TOKMS2-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY5765I TOKMS2 ERROR " TOKMS2-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY5765I ZSOKMS1 ERROR " ZSOKMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FSY57651.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "SSY5765I"      TO   PGID.
     MOVE    "FSY57651"      TO   FORM.
...
*    基本情報ファイル存在チェック
     IF  ERR-FLG        =    ZERO
         ...
         INITIALIZE                    JOH-REC
         MOVE      JDATE          TO   JOH-F01
         MOVE      JTIME          TO   JOH-F02
         MOVE      TORICD         TO   JOH-F03
         MOVE      WK-SOKCD       TO   JOH-F04
         MOVE      NOUDT          TO   JOH-F08
...
*    出荷情報ファイル存在チェック
     IF  ERR-FLG        =    ZERO
         ...
         INITIALIZE                    SYU-REC
         MOVE      JDATE          TO   SYU-F01
         MOVE      JTIME          TO   SYU-F02
         MOVE      TORICD         TO   SYU-F03
         MOVE      WK-SOKCD       TO   SYU-F04
         MOVE      NOUDT          TO   SYU-F08
...
*
*バッチNO.チェック
     IF ( JDATE     =    JOH-F01 ) AND
        ( JTIME     =    JOH-F02 ) AND
        ( TORICD    =    JOH-F03 )
          CONTINUE
     ELSE
*↓TEST
*                DISPLAY "BACH-NO NG   " UPON CONS
*↑TEST
          MOVE      5    TO   ERR-FLG
          MOVE     "C"   TO   EDIT-CURSOR OF JDATE
          MOVE     "R"   TO   EDIT-OPTION OF JDATE
