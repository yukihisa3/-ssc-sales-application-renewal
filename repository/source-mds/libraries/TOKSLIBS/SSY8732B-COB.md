...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8732B.COB`
...
*                                            DATE. 07.05.29    *
*                                              BY. NAV         *
* 2018/06/14 NAV TAKAHASHI 発注数のセット方法を変更　　　　　　*
* 2019/09/17 NAV TAKAHASHI 消費税軽減税率対応　　　　　　　　　*
* 2021/03/23 NAV TAKAHASHI 仕入先統合　　　　　　　　　　　　　*
****************************************************************
...
****  メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SSY8732B".
...
*             伝票番号
*#2017/09/04 NAV ST
              MOVE      WK-DEPB161     TO   JYU-F06
**2021/03/23  IF  PARA-TORICD  =  880  OR  882  OR  883  OR
*                                 1427 OR  14272 OR 14273
*                 MOVE WK-DEPB161(1:7) TO   WK-DENNO
*                 MOVE WK-DENNO1       TO   JYU-F06
*             ELSE
*                 MOVE WK-DEPB161      TO   JYU-F06
**2021/03/23  END-IF
*#2017/09/04 NAV ED
*********DISPLAY "WK-DEPB161 = " WK-DEPB161 UPON CONS
...
*****DISPLAY "DCMJYRF-INV-FLG =  " DCMJYRF-INV-FLG  UPON CONS
...
*    伝票データ読込み
 READ-000.
     ...
     END-READ.
*
*****DISPLAY "DEN-01 = " DEN-01 UPON CONS.
     IF       DEN-01  =  "H" OR "L"
*****DISPLAY "DEN-02 = " DEN-01 UPON CONS
              ADD       1         TO   TAIS-CNT
     ELSE
*****DISPLAY "DEN-03 = " DEN-01 UPON CONS
              GO                  TO   READ-000
     END-IF.
*
 FL-READ-EXIT.
