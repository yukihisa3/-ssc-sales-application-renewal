...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SKY7000I.COB`
...
****  画面ファイル  ****
 COPY   FKY70001         OF        XMDLIB.
 COPY   FKY70002         OF        XMDLIB.
****  画面制御項目  ****
 01  DSP-CONTROL.
...
****  メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SKY7000I".
...
*----------------------------------------------------------*
 INIT1-DSP-SEC        SECTION.
     MOVE     SPACE          TO   FKY70001.
     MOVE     SPACE          TO   FKY70002.
     MOVE    "FKY70001"      TO   DSP-FORMAT.
...
*----------------------------------------------------------*
 DSP-READ-SEC           SECTION.
     MOVE  "NE"    TO   DSP-PROC.
     READ   DSPF.
     IF  DSP-FORMAT  = "FKY70001"
         MOVE    DSP-AREA    TO   FKY70001
     ELSE
         MOVE    DSP-AREA    TO   FKY70002
     END-IF.
 DSP-READ-EXIT.
     EXIT.
*----------------------------------------------------------*
