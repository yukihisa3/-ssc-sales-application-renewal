...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY3850I.COB`
...
*    サブシステム　　　　：　ナフコ出荷支援システム　　　　　　*
*    業務名　　　　　　　：　本発業務　　　　　　　　　　　　　*
*    モジュール名　　　　：　本発ＥＸＣＥＬデータ取消処理　    *
*    　　　　　　　　　　：　　（指示画面）　　　　　　　　　　*
*    作成日／更新日　　　：　2015/04/13                        *
*    作成者／更新者　　　：　NAV                               *
*    処理概要　　　　　　：　取込を取り消けす管理番号を指定し　*
*                        ：　パラメタに引き渡す　　　　　　    *
****************************************************************
...
*画面表示用ワーク
 01  DSP-WORK.
     03  WORK-PGID                PIC  X(08)  VALUE  "SSY3850I".
     03  WORK-FORMID              PIC  X(08)  VALUE  "FSY38501".
*フラグ領域
 01  FLG-AREA.
...
*
**************************************************************
*PROCEDURE             DIVISION   USING  LINK-KBN LINK-KANRINO.
...
*ファイルのＯＰＥＮ
     OPEN     I-O       DSPFILE HTANMS.
*ワークの初期化
     INITIALIZE         FLG-AREA.
*パラメタチェック
*    IF  LINK-KBN = 1 OR 2 OR 3 OR 4
*        CONTINUE
*    ELSE
...
****************************************************************
 END-SEC               SECTION.
*ファイル ＣＬＯＳＥ
     CLOSE             DSPFILE  HTANMS.
**
 END-EXIT.
     EXIT.
*****************<<  SSY3850I   END PROGRAM  >>******************
