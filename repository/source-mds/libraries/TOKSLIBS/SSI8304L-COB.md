...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSI8304L.COB`
...
*----<< 支払合計ファイル >>--*
     SELECT   SIHARASF  ASSIGN         DA-01-S-SIHARASF
                        ...
                        STATUS         SSI-ST.
*----<< 請求合計Ｆ >>--*
     SELECT   SETGK831  ASSIGN         DA-01-VI-SETGK831
...
*----<< 支払合計ファイル >>--*
 FD  SIHARASF           LABEL RECORD   IS   STANDARD
     ...
     COPY     SIHARASF  OF        XFDLIB
              JOINING   SSI       PREFIX.
*----<< 請求合計Ｆ >>--*
 FD  SETGK831           LABEL RECORD   IS   STANDARD.
     COPY     SETGK831  OF        XFDLIB
              JOINING   SEI       PREFIX.
*----<< 店舗マスタ >>--*
...
*
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
 01  PG-ID              PIC  X(08)     VALUE   "SSI8304L".
*
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
...
*--<< ﾌﾟﾘﾝﾄ AREA >>-*
 01  HEAD01.
     03  FILLER         CHARACTER TYPE BAIKAKU-1-5.
         ...
         05  FILLER     PIC  X(08)     VALUE  "SSI8304L".
...
*----<< 支払合計ファイル >>--*
 SSI-ERR                SECTION.
     ...
     STOP     RUN.
*----<< 請求合計Ｆ >>--*
 SETGK831-ERR             SECTION.
     USE AFTER     EXCEPTION PROCEDURE      SETGK831.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### " PG-ID " SETGK831  ERROR " SEI-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
...
*請求合計Fスタート
     ...
     START  SETGK831  KEY  IS  >=  SEI-F01  SEI-F05
            INVALID
