...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SNJ9110B.COB`
...
*入力パラメータ領域
 ...
 01  LINK-IN-RNKBN          PIC  9(01). *> 更新区分
...
**     登録
         ...
         MOVE  LINK-IN-RNKBN       TO  TJS-F14  *> 完了ﾌﾗｸﾞ
         MOVE  9999                TO  TJS-F15
