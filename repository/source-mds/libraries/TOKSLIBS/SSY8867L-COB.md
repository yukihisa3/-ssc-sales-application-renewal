...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8867L.COB`
...
*
 ...
 FILE-CONTROL.
*----<< ＤＣＭ出荷確定データ >>--*
     SELECT   KPSYUKF   ASSIGN         DA-01-VI-KPSYUKL3
...
*--<< ﾌﾟﾘﾝﾄ AREA >>-*
 ...
 01  HD04.
     03  FILLER         CHARACTER TYPE PITCH-2.
         ...
         05  HD04-HACTA PIC  X(01).
         05  FILLER     PIC  X(01)     VALUE  SPACE.
         05  HD04-HACTN PIC  N(03).
...
*----<< カーマ出荷確定データ >>--*
 KPSYUKF-ERR            SECTION.
     ...
     DISPLAY  "### SSY8867L KPSYUKF ERROR " KPSYUKF-ST " "
...
*#2019/02/21 NAV ST
              IF  KMK-K03  =  880  OR  882  OR  883  OR  1427
              OR  14272  OR  14273
                  MOVE NC"　専用_在庫補充　　" TO HD02-2
              END-IF
*#2019/02/21 NAV ED
         WHEN 71
...
*#2018/01/26 NAV ST
         WHEN "4"
              MOVE NC"大カゴ"       TO  HD04-KEIJY
*#2018/01/26 NAV ED
         WHEN OTHER
              MOVE NC"＊＊＊"       TO  HD04-KEIJY
     END-EVALUATE.
*    発注単位区分
     MOVE     KMK-M09               TO  HD04-HACTA.
*    発注単位区分名
     EVALUATE KMK-M09
         WHEN "P"
              MOVE NC"ピース"       TO  HD04-HACTN
         WHEN "C"
              MOVE NC"ケース"       TO  HD04-HACTN
         WHEN OTHER
              MOVE NC"＊＊＊"       TO  HD04-HACTN
     END-EVALUATE.
*    発注日
