...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY9101I.COB`
...
*                                                              *
*    顧客名　　　　　　　：　（株）サカタのタネ殿　　　　　　　*
*    サブシステム　　　　：　センター納品対応（ダイキ／カーマ）*
*    業務名　　　　　　　：　センター納入業務　　　　　　      *
*    モジュール名　　　　：　センター納入データ抽出指示        *
*    作成日／更新日　　　：  17/02/10                          *
*    作成者／更新者　　　：　NAV TAKAHASHI                     *
*    処理概要　　　　　　：　個口数記入一覧表データ作成の指示を*
*                            画面より行う。　　                *
****************************************************************
...
***           取引先ＲＥＡＤ
              ...
              END-READ
              IF  DSP-BTTORI = 13938 OR  17137 OR 100441
              OR  100442  OR  100403 OR 100404 OR 100427
              OR  100428  OR  139381 OR 171371
                  CONTINUE
              ELSE
                  MOVE   9     TO   ERR-FLG
                  MOVE  "R"    TO   EDIT-OPTION  OF  DSP-BTTORI
