...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SKY1001B.COB`
...
*店舗ＣＤ編集
 01  WK-HD1-02                    PIC   9(08)  VALUE  ZERO.
*日付編集
 01  HEN-DATE.
...
*
 01  HD1   CHARACTER          TYPE IS        YA.
     ...
     03  HD1-01                   PIC  X(15).
     03  FILLER                   PIC  X(07)     VALUE   SPACE.
     03  HD1-02                   PIC  ZZZZZZZ9.
     03  FILLER                   PIC  X(04)     VALUE   SPACE.
     03  HD1-03                   PIC  X(04).
     03  FILLER                   PIC  X(01)     VALUE   SPACE.
     03  HD1-04                   PIC  X(02).
     03  FILLER                   PIC  X(02)     VALUE   SPACE.
     03  HD1-05                   PIC  ZZ9999999.
     03  FILLER                   PIC  X(01)     VALUE   SPACE.
     03  HD1-06                   PIC  ZZZZZ9.
     03  FILLER                   PIC  X(05)     VALUE   SPACE.
     03  HD1-061                  PIC  N(10).
     03  FILLER                   PIC  X(01)     VALUE   SPACE.
     03  HD1-07                   PIC  999999.
     03  FILLER                   PIC  X(01)     VALUE   SPACE.
     03  HD1-08                   PIC  999999.
...
*****売上ファイルスタート*****
     START  SHTDENF  KEY  IS >=  DEN-F01 DEN-F02 DEN-F04
                                 DEN-F051 DEN-F07 DEN-F112 DEN-F03
          INVALID  KEY
...
*アヅタラビスタの時、特別対応
     IF       DEN-F01  =  13
              MOVE    20030000   TO    WK-HD1-02
              ADD     DEN-F07    TO    WK-HD1-02
              MOVE    WK-HD1-02  TO    HD1-02
     ELSE
              MOVE    DEN-F07    TO    HD1-02
     END-IF.
*////店舗名称
...
*////// 九州対応 START
     EVALUATE DEN-F01
         WHEN 22051  MOVE  2205     TO    HD1-06
*////////WHEN 22051  MOVE  2702     TO    HD1-06
         WHEN 22052  MOVE  2205     TO    HD1-06
         WHEN 22053  MOVE  2702     TO    HD1-06
         WHEN 22054  MOVE  2702     TO    HD1-06
         WHEN 22055  MOVE  2702     TO    HD1-06
         WHEN 22056  MOVE  2702     TO    HD1-06
         WHEN 22057  MOVE  2702     TO    HD1-06
         WHEN 22058  MOVE  2702     TO    HD1-06
         WHEN 3731   MOVE  373      TO    HD1-06
         WHEN 3732   MOVE  373      TO    HD1-06
*////////2005/11/02 対応
         WHEN 46583520   MOVE  784      TO    HD1-06
         WHEN OTHER  MOVE  DEN-F01  TO    HD1-06
     END-EVALUATE.
*////// 九州対応 END
*サンコーの時、特別対応
*2010/07/19 START NAV
     IF       DEN-F01  =  373
              EVALUATE  DEN-F131
                  WHEN  "4 "
                        MOVE  374      TO  HD1-06
...
*
     WRITE    PRT-REC          FROM   HD0    AFTER    5.
