...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SBM9020B.COB`
...
*
 01  JYR-BR-KEY2.
     03  JYR-BR-KEY21         PIC  X(08).
     03  JYR-BR-KEY22         PIC  X(04).
     03  JYR-BR-KEY23         PIC  X(08).
 01  WK-BR-KEY2.
...
****************************************************************
 INIT-SEC              SECTION.
*
     DISPLAY  "***  START SBM9020B  ***"   UPON  CONS.
...
* 定型
 INSTART-100.
     MOVE       ZERO              TO   JYR-F011.
     GO  TO    INSTART-300.
* 非定型
 INSTART-200.
     IF  PARA-SHURUI  =  "1"
*
         MOVE     PARA-JYUSINHI       TO   JYR-F011
         MOVE     PARA-JYUSINTIME     TO   JYR-F012
         MOVE     PARA-TOKCD          TO   JYR-F013
         MOVE     PARA-JYUSINHI       TO   WK-BR-KEY21
         MOVE     PARA-JYUSINTIME     TO   WK-BR-KEY22
         MOVE     PARA-TOKCD          TO   WK-BR-KEY23
     ELSE
         MOVE     PARA-SOUJYUSIN      TO   JYR-F011
     END-IF.
*
*
 INSTART-300.
     START  BMSJYRF  KEY  IS  >=
                                   JYR-F011  JYR-F012
                                   JYR-F013
*
            INVALID
...
**
     GO  TO   MAIN-900.
 MAIN-210.
     IF  JYR-BR-KEY2  =  WK-BR-KEY2
         PERFORM SAKUJYO-SEC
         GO  TO  MAIN-900
     END-IF.
     IF  JYR-BR-KEY2  NOT =  WK-BR-KEY2
         MOVE  "1"    TO   END-FLG
     GO  TO   MAIN-EXIT
     END-IF.
 MAIN-220.
     IF  JYR-F011     =  PARA-SOUJYUSIN
         ...
         GO  TO    MAIN-900
     END-IF.
     IF  JYR-F011   NOT =  PARA-SOUJYUSIN
         MOVE  "1"     TO   END-FLG
         GO  TO    MAIN-EXIT
     END-IF.
*
...
*ファイルのCLOSE処理
     CLOSE     BMSJYRF.
     DISPLAY  "***  END   SBM9020B  ***"   UPON  CONS.
*
 END-EXIT.
     EXIT.
*
...
*
     IF   PARA-TEIKEI  =  "2"
         MOVE     JYR-F011    TO   JYR-BR-KEY21
         MOVE     JYR-F012    TO   JYR-BR-KEY22
         MOVE     JYR-F013    TO   JYR-BR-KEY23
     END-IF.
*
     ADD      1           TO   READ-CNT.
*
