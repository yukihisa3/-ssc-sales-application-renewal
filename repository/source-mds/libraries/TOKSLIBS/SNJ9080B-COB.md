...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SNJ9080B.COB`
...
*    DISPLAY "LINK-LINE  = "  LINK-LINE   UPON CONS.
*    DISPLAY "LINK-YUSEN = "  LINK-YUSEN  UPON CONS.
*ファイルＫＥＹ項目セット
