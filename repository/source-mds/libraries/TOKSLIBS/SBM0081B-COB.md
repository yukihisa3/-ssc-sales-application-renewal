...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SBM0081B.COB`
...
*     修正概要           ： 任意日付項目の編集をゼロから
*                           スペースに変更
*     修正概要           ： 日本語制御文字コードを付加する
*     更新日／更新者     ： 2018/03/23 / INOUE
*     修正概要           ： IN-PARA追加 LF2→LF3に変更
*     　　　　           ： IN-PARAと一致レコードを変換対象
*
******************************************************************
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG                PIC  X(08)     VALUE "SBM0081B".
...
*取引レコード区分
     IF      ( TORI-NO   NOT =     SYK-F302 )  OR
             ...
             ( LAST-DATE NOT =     SYK-F349 )
               ...
               MOVE      "1"       TO        WK-REC(1198:1)
               IF  ( SYK-F350  =  ZERO  )
                   MOVE  WK-KAISIBI    TO   WK-REC(868:8)
               END-IF
               IF  ( SYK-F351  =  ZERO  )
                   MOVE  WK-KAISIBI    TO   WK-REC(876:8)
               END-IF
               IF  ( SYK-F352  =  ZERO  )
                   MOVE  WK-KAISIBI    TO   WK-REC(884:8)
               END-IF
               IF  ( SYK-F353  =  ZERO  )
...
*↓2018.03.23
* 対象ＫＥＹ判定
*#***DISPLAY "SYK-011 " SYK-F011 ":" PARA-IN-BDATE UPON CONS.
*    DISPLAY "SYK-012 " SYK-F012 ":" PARA-IN-BTIME UPON CONS.
*    DISPLAY "SYK-013 " SYK-F013 ":" PARA-IN-BTORI UPON CONS.
*    DISPLAY "SYK-02  " SYK-F02  ":" PARA-IN-SOKO  UPON CONS.
*#***DISPLAY "SYK-349 " SYK-F349 ":" PARA-IN-NDATE UPON CONS.
