...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH9120M.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG                PIC  X(08)     VALUE "NJH9120M".
...
****************MOVE  CVCSG001-REC(88:117) TO WHEP-F300(90:117)
                MOVE  CVCSG001-REC(88:129) TO WHEP-F300(90:129)
*#2023/11/24 NAV ED
****************ファイル出力する準備を行う
****************初期化
...
*
     ...
     IF  RD-CNT(6:3) = "000" OR "500"
         DISPLAY "## NJH9120M RD-CNT = " RD-CNT  UPON CONS
     END-IF.
*
 CVCSG001-READ-EXIT.
     EXIT.
