...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY6101L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*伝票データ（共通）　　
     SELECT   ABSHIRED  ASSIGN    TO        ABSHIRED
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      ABSHIRED.
...
***  発注区分判断
     EVALUATE  DEN-A18
         WHEN  0     MOVE NC"定番" TO       HD1-02
         WHEN  1     MOVE NC"特売" TO       HD1-02
         WHEN  2     MOVE NC"返品" TO       HD1-02
         WHEN OTHER  MOVE NC"＊＊" TO       HD1-02
     END-EVALUATE.
*
*ヘッダ２行目
***  社名
...
*ヘッダ３行目
***  取引先名
     MOVE "ｶﾌﾞ)ｻｶﾀﾉﾀﾈ ｷｭｳｼｭｳ"     TO        HD3-01.
*
*ヘッダ４行目
***  店名
     MOVE     DEN-A15             TO        HD4-01.
***  店舗ＣＤ
     MOVE     DEN-A14             TO        HD4-02.
***  分類ＣＤ
     MOVE     DEN-A07             TO        HD4-03.
***  伝票区分
     MOVE     DEN-A08             TO        HD4-04.
***  伝票■
     MOVE     DEN-F02             TO        HD4-05.
***  取引先コード
     MOVE     DEN-F01             TO        HD4-06.
***  取引先名
     MOVE     SPACE               TO        HD4-07.
***  発注日
     MOVE     DEN-A09             TO        HD4-08.
***  納品日
     MOVE     DEN-A10             TO        HD4-09.
***  便（引取のとき）
     MOVE     DEN-A20             TO        HD4-10.
*
...
*項目クリア
     MOVE     SPACE               TO   HD1 HD2 HD3 HD4
                                       ...
                                       TL1 TL2.
*テスト印字項目セット
     MOVE   ALL "9"              TO   HD4-02  HD4-04  HD4-05
                                      HD4-06  HD4-08  HD4-09
                                      DT2-031 DT2-041
                                      DT2-051 DT2-06
                                      DT2-07  DT2-08
                                      TL1-011 TL1-021 TL1-03
                                      TL1-04.
     MOVE   ALL "*"              TO   HD2-01  HD3-01  HD4-01
                                      HD4-03  HD4-07  HD4-10
                                      DT2-01  DT2-02  DT2-032
                                      DT2-042
                                      TL1-012 TL1-022.
     MOVE   NC"＊"               TO   HD1-01  HD1-02.
*ヘッダ部
     WRITE    PRT-REC          FROM   HD1    AFTER    3.
     WRITE    PRT-REC          FROM   HD2    AFTER    3.
     WRITE    PRT-REC          FROM   HD3    AFTER    1.
...
*
     CLOSE    ABSHIRED   PRTFILE    DSPFILE.
*
 END-EXIT.
     EXIT.
