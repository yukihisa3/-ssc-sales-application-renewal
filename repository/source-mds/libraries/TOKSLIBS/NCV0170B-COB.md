...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NCV0170B.COB`
...
*日付変換サブルーチン用ワーク
 ...
 01  LINK-IN-JTIMES        PIC 9(04).
 01  LINK-IN-JTIMEE        PIC 9(04).
 01  LINK-IN-HTIMES        PIC 9(04).
 01  LINK-IN-HTIMEE        PIC 9(04).
*
**************************************************************
...
*処理区分により各項目更新
     IF   JSMDAYF-INV-FLG  =  "INV"
          ...
          MOVE LINK-IN-JTIME  TO TJS-F02
          MOVE LINK-IN-JTOKCD TO TJS-F03
          MOVE LINK-IN-JTIMES TO TJS-F05
          MOVE LINK-IN-JTIMEE TO TJS-F06
          MOVE LINK-IN-HTIMES TO TJS-F07
          MOVE LINK-IN-HTIMEE TO TJS-F08
          MOVE 1              TO TJS-F14
          WRITE TJS-REC
     ELSE
          MOVE LINK-IN-JTIMES TO TJS-F05
