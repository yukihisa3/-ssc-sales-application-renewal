...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SBT1200I.COB`
...
*固定取引先(ナフコ)
 01  WK-TORCD                     PIC   9(08)  VALUE  00137607.
*ＰＦガイド
 01  PF-MSG-AREA.
     03  PF-MSG1.
         05  FILLER               PIC   N(15)
...
*メッセージの取得
 ...
 VALUE NC"条件に誤りがないか確認し、ＥＮＴＥＲを実行して下さい".
     ...
     03  ERR-MSG16           PIC  N(30)  VALUE
              NC"開始が終了を越えています。".
     03  ERR-MSG17           PIC  N(30)  VALUE
              NC"手書用の管理番号を入力してください。".
 01  ERR-MSG-AREA-R      REDEFINES     ERR-MSG-AREA.
     03  ERR-MSG-R   OCCURS  17  PIC   N(30).
*
 01  FILE-ERR.
...
**************************************************************
 PROCEDURE             DIVISION   USING  LINK-IN-BMNCD
                       ...
                       LINK-OUT-TORICD LINK-OUT-KANRI
...
*    取引先チェック
     ...
     END-IF.
*    管理番号チェック（ナフコのみ有効）
     IF  DSP-TORICD    NOT  =    WK-TORCD
         MOVE   ZERO        TO   DSP-KANRI
...
*実行
         WHEN   "E000"
                ...
                MOVE    DSP-KANRI     TO  LINK-OUT-KANRI
