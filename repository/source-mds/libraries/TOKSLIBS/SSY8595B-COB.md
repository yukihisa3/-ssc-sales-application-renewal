...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8595B.COB`
...
*　　顧客名　　　　　　　：　（株）サカタのタネ殿　　　　　　　*
*　　業務名　　　　　　　：　くろがねや出荷検品システム        *
*　　モジュール名　　　　：　くろがねや基本情報データ削除      *
*　　作成日／更新日　　　：　2006/12/12                        *
*　　作成者／更新者　　　：　NAV                               *
*　　処理概要　　　　　　：　くろがねや基本情報データの削除を　*
*                                                              *
****************************************************************
...
*
 ...
 FILE-CONTROL.
*---<<  出荷情報データ  >>---*
     SELECT   KGJOHOF   ASSIGN         DA-01-VI-KGJOHOL1
...
*----<< 出荷情報データ >>--*
 KJH-ERR              SECTION.
     ...
     DISPLAY  "### SSY8595B KGJOHOF    ERROR " KJH-ST " "
...
*----<< 条件ファイル >>--*
 JYO-ERR              SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     "4000"         TO   PROGRAM-STATUS.
     DISPLAY  "### SSY8595B HJYOKEN    ERROR " JYO-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
