...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SBMK010B.COB`
...
*
 ...
 FILE-CONTROL.
*流通ＢＭＳ受信ファイル
     SELECT   BMSRCV    ASSIGN    TO   DA-01-S-BMSRCVF
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG                PIC  X(08)     VALUE "SBM0011B".
...
**************MOVE      RCV-REC   TO   WHAC-F20
              MOVE      RCV-REC(1:393)   TO   WHAC-F20(1:393)
              MOVE      RCV-REC(395:40)  TO   WHAC-F20(394:40)
              MOVE      RCV-REC(436:20)  TO   WHAC-F20(434:20)
             WHEN  "C"
**************MOVE      RCV-REC   TO   WHAC-F30
              MOVE      RCV-REC(1:47)    TO   WHAC-F30(1:47)
              MOVE      RCV-REC(49:40)   TO   WHAC-F30(48:40)
              MOVE      RCV-REC(90:46)   TO   WHAC-F30(88:46)
              MOVE      RCV-REC(137:40)  TO   WHAC-F30(134:40)
              MOVE      RCV-REC(178:205) TO   WHAC-F30(174:205)
              MOVE      RCV-REC(384:40)  TO   WHAC-F30(379:40)
              MOVE      RCV-REC(425:46)  TO   WHAC-F30(419:46)
              MOVE      RCV-REC(472:40)  TO   WHAC-F30(465:40)
              MOVE      RCV-REC(513:381) TO   WHAC-F30(505:381)
              MOVE      RCV-REC(895:120) TO   WHAC-F30(886:120)
              MOVE    RCV-REC(1016:115)  TO   WHAC-F30(1006:115)
             WHEN  "D"
**************MOVE      RCV-REC   TO   WHAC-F40
              MOVE      RCV-REC(1:119)   TO   WHAC-F40(1:119)
              MOVE      RCV-REC(121:40)  TO   WHAC-F40(120:50)
              MOVE      RCV-REC(172:25)  TO   WHAC-F40(170:25)
              IF        RCV-REC(197:1)  =   X"28"
                MOVE      RCV-REC(198:50)  TO   WHAC-F40(195:50)
                MOVE      RCV-REC(249:662) TO   WHAC-F40(245:662)
              ELSE
                MOVE      RCV-REC(197:50)  TO   WHAC-F40(195:50)
                MOVE      RCV-REC(247:662) TO   WHAC-F40(245:662)
              END-IF
...
**************MOVE      RCV-REC   TO   WJYR-F20
              MOVE      RCV-REC(1:393)   TO   WJYR-F20(1:393)
              MOVE      RCV-REC(395:40)  TO   WJYR-F20(394:40)
              MOVE      RCV-REC(436:20)  TO   WJYR-F20(434:20)
             WHEN  "C"
**************MOVE      RCV-REC   TO   WJYR-F30
              MOVE      RCV-REC(1:57)    TO   WJYR-F30(1:57)
              MOVE      RCV-REC(59:40)   TO   WJYR-F30(58:40)
              MOVE      RCV-REC(100:46)  TO   WJYR-F30(98:46)
              MOVE      RCV-REC(147:40)  TO   WJYR-F30(144:40)
              MOVE      RCV-REC(188:205) TO   WJYR-F30(184:205)
              MOVE      RCV-REC(394:40)  TO   WJYR-F30(389:40)
              MOVE      RCV-REC(435:46)  TO   WJYR-F30(429:46)
              MOVE      RCV-REC(482:40)  TO   WJYR-F30(475:40)
              MOVE      RCV-REC(523:649) TO   WJYR-F30(515:649)
             WHEN  "D"
**************MOVE      RCV-REC   TO   WJYR-F40
**************IF        RCV-REC(123:1)  =   X"28"
*               MOVE      RCV-REC(1:123)   TO   WJYR-F40(1:123)
*               MOVE      RCV-REC(125:50)  TO   WJYR-F40(124:50)
*               MOVE      RCV-REC(176:39)  TO   WJYR-F40(174:39)
*               IF        RCV-REC(215:1)  =   X"28"
*                 MOVE    RCV-REC(216:50)  TO   WJYR-F40(213:50)
*                 MOVE    RCV-REC(267:710) TO   WJYR-F40(263:710)
*               ELSE
*                 MOVE    RCV-REC(215:50)  TO   WJYR-F40(213:50)
*                 MOVE    RCV-REC(265:710) TO   WJYR-F40(263:710)
*               END-IF
*             ELSE
*               MOVE      RCV-REC(1:123)   TO   WJYR-F40(1:123)
*               MOVE      RCV-REC(124:50)  TO   WJYR-F40(124:50)
*               MOVE      RCV-REC(174:39)  TO   WJYR-F40(174:39)
*               IF        RCV-REC(213:1)  =   X"28"
*                 MOVE    RCV-REC(214:50)  TO   WJYR-F40(213:50)
*                 MOVE    RCV-REC(265:710) TO   WJYR-F40(263:710)
*               ELSE
*                 MOVE    RCV-REC(213:50)  TO   WJYR-F40(213:50)
*                 MOVE    RCV-REC(263:710) TO   WJYR-F40(263:710)
*               END-IF
**************END-IF
**************2013/07/05 旧指定に変更する。高橋　↓
              MOVE      RCV-REC(1:123)   TO   WJYR-F40(1:123)
              MOVE      RCV-REC(125:50)  TO   WJYR-F40(124:50)
              MOVE      RCV-REC(176:39)  TO   WJYR-F40(174:39)
              IF        RCV-REC(215:1)  =   X"28"
...
**************MOVE      RCV-REC   TO   WHEP-F20
              MOVE      RCV-REC(1:393)   TO   WHEP-F20(1:393)
              MOVE      RCV-REC(395:40)  TO   WHEP-F20(394:40)
              MOVE      RCV-REC(436:20)  TO   WHEP-F20(434:20)
             WHEN  "C"
**************MOVE      RCV-REC   TO   WHEP-F30
              MOVE      RCV-REC(1:57)    TO   WHEP-F30(1:57)
              MOVE      RCV-REC(59:40)   TO   WHEP-F30(58:40)
              MOVE      RCV-REC(100:46)  TO   WHEP-F30(98:46)
              MOVE      RCV-REC(147:40)  TO   WHEP-F30(144:40)
              MOVE      RCV-REC(188:132) TO   WHEP-F30(184:132)
              MOVE      RCV-REC(321:40)  TO   WHEP-F30(316:40)
              MOVE      RCV-REC(362:46)  TO   WHEP-F30(356:46)
              MOVE      RCV-REC(409:40)  TO   WHEP-F30(402:40)
              MOVE      RCV-REC(450:350) TO   WHEP-F30(442:350)
             WHEN  "D"
**************MOVE      RCV-REC   TO   WHEP-F40
              MOVE      RCV-REC(1:108)   TO   WHEP-F40(1:108)
              MOVE      RCV-REC(110:50)  TO   WHEP-F40(109:50)
              MOVE      RCV-REC(161:39)  TO   WHEP-F40(159:39)
              IF        RCV-REC(200:1)  =   X"28"
                MOVE      RCV-REC(201:50)  TO   WHEP-F40(198:50)
                MOVE      RCV-REC(252:638) TO   WHEP-F40(248:638)
              ELSE
                MOVE      RCV-REC(200:50)  TO   WHEP-F40(198:50)
                MOVE      RCV-REC(250:638) TO   WHEP-F40(248:638)
              END-IF
...
**************MOVE      RCV-REC   TO   WSIH-F20
              MOVE      RCV-REC(1:393)   TO   WSIH-F20(1:393)
              MOVE      RCV-REC(395:40)  TO   WSIH-F20(394:40)
              MOVE      RCV-REC(436:20)  TO   WSIH-F20(434:20)
             WHEN  "C"
**************MOVE      RCV-REC   TO   WSIH-F30
              MOVE      RCV-REC(1:37)    TO   WSIH-F30(1:37)
              MOVE      RCV-REC(39:40)   TO   WSIH-F30(38:40)
              MOVE      RCV-REC(80:36)   TO   WSIH-F30(78:36)
*↓2013/06/28
              MOVE      JYO-F04          TO   WSIH-F308
*↑2013/06/28
             WHEN  "D"
**************MOVE      RCV-REC   TO   WSIH-F40
              MOVE      RCV-REC(1:130)   TO   WSIH-F40(1:130)
              MOVE      RCV-REC(132:40)  TO   WSIH-F40(131:40)
              MOVE      RCV-REC(173:118) TO   WSIH-F40(171:118)
              IF        RCV-REC(291:1)  =   X"28"
                MOVE      RCV-REC(292:50)  TO   WSIH-F40(289:50)
                MOVE      RCV-REC(343:32)  TO   WSIH-F40(339:32)
              ELSE
                MOVE      RCV-REC(291:50)  TO   WSIH-F40(289:50)
                MOVE      RCV-REC(341:32)  TO   WSIH-F40(339:32)
              END-IF
              MOVE      WSIH-REC  TO   SIH-REC
***           DISPLAY "PAYME(SIH-REC) WRITE" UPON CONS
              WRITE     SIH-REC
              ADD       1         TO   WRT-CNT5
           END-EVALUATE
     END-EVALUATE.
