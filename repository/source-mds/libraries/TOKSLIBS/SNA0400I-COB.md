...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SNA0400I.COB`
...
*    サブシステム　　　　：　商品変換ＴＢＬ一覧出力            *
*    業務名　　　　　　　：　商品変換ＴＢＬ一覧出力指示        *
*    モジュール名　　　　：　商品変換ＴＢＬ一覧表出力指示      *
*    作成日／更新日　　　：　2012/08/15                        *
*    作成者／更新者　　　：　NAV T.TAKAHASHI                   *
*    処理概要　　　　　　：　画面より，一覧表発行の取引先ＣＤを*
*                            指定する。　　　　　　　　        *
****************************************************************
 IDENTIFICATION        DIVISION.
 PROGRAM-ID.           SNA0400I.
 AUTHOR.               NAV.
 DATE-WRITTEN.         2012/08/15.
****************************************************************
