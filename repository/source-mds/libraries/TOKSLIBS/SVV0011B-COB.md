...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SVV0011B.COB`
...
****<< 商品変換テーブルＣＳＶ >>******************************
     SELECT   SVVTBL1    ASSIGN  TO   DA-01-S-SVVTBL1
                        ACCESS  MODE         IS   SEQUENTIAL
...
****  カウンタ                ****
 ...
 01  SVVTBL1-CNT              PIC  9(8)   VALUE  ZERO.
****  フラグ                  ****
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SVV0011B".
...
************************************************************
 END-SEC                SECTION.
     CLOSE    DSPF   SVVTBL1  HSHOTBL.

     IF    HSHOTBL-CNT NOT = ZERO
     DISPLAY  " HSHOTBL-READ-CNT = " HSHOTBL-CNT UPON CONS
     DISPLAY  " SVVTBL1-WRITE-CNT = " SVVTBL1-CNT UPON CONS
     END-IF.
 END-END.
     EXIT.
*****************<<  PROGRAM  END  >>***********************
