...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY5055V.COB`
...
*
*****<<受領データCSV   >>**************************************
     SELECT   TOSCSV             ASSIGN    TO   TOSCSVJ
                                 STATUS         CSV-STATUS.
*                                                                *
****************************************************************
 DATA                   DIVISION.
...
***** メッセージエリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY5055V".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY5055V".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND1.
...
*             プロセス                      0.0                *
****************************************************************
 SSY5055V-START         SECTION.
*
     MOVE   "SSY5055V-START"      TO   S-NAME.
     PERFORM            INIT-SEC.
