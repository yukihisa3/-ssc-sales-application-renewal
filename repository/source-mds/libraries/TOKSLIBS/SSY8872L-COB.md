...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8872L.COB`
...
*
 ...
 01  PG-ID             PIC  X(08)      VALUE  "SSY8872L".
 01  WK-MSG1           PIC  N(14)
...
*--------------------------------------------------------------*
 ...
 LBLERR                 SECTION.
     ...
     DISPLAY  "### SSY8872L LBL ERROR " LBL-ST " "
 ...
 PRTERR                 SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY8872L PRTFILE ERROR " PRT-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     MOVE     4000           TO        PROGRAM-STATUS.
...
*
     EVALUATE LBL-F11
         ...
         WHEN "5"   MOVE NC"ダイレクト"     TO   HD8-01(IY)
