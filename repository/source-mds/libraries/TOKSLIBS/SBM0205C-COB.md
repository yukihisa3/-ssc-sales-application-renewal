...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SBM0205C.COB`
...
*支払ワーク
     SELECT   BMSSHIW   ASSIGN    TO        DA-01-VS-BMSSIHW
...
*---<< ｻﾌﾞﾙｰﾁﾝ LINK AREA >>-*
 ...
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SBM0205C".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SBM0205C".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
* 計上部署判定
*    IF  SHW-F405  =  ZERO
*            MOVE   ALL  "9"    TO   SHW-F405
     IF  SHW-F405(1:4)  =  "0000"
             MOVE   "99999"     TO   SHW-F405
     END-IF.
*相殺レコードは店舗ＣＤを９９９９に変更する。
     IF  SHW-F428  =  "2000"
             MOVE   "99999"     TO   SHW-F405
     END-IF.
* 取引番号ＣＤ値計算
...
*----DIVIDE   WK-DENCHK1 BY  7    GIVING    WK-DIV-1
     DIVIDE   WK-DENNO   BY  7    GIVING    WK-DIV-1
                                REMAINDER   WK-DIV-2
     COMPUTE  CALC-CD   =         WK-DIV-2.
     MOVE     SPACE          TO   SHW-F402.
     MOVE     LI-DENNO(4:6)  TO   SHW-F402(1:6).
     MOVE     CALC-CD        TO   SHW-F402(7:1).
*
     WRITE   SHW-REC.
     ADD     1      TO      WRITE-CNT.
 MAIN-200.
