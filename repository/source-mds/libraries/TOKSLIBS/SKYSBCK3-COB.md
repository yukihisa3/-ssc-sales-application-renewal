...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SKYSBCK3.COB`
...
*取引先マスタ
     SELECT    NFTENMS1 ASSIGN     TO    DA-01-VI-NFTENMS1
                        ...
                        RECORD   KEY     IS  NTP-F01  NTP-F02
                        FILE  STATUS     IS  NTP-ST.
******************************************************************
 DATA                      DIVISION.
******************************************************************
*--------------------------------------------------------------*
...
*--------------------------------------------------------------*
 ...
 01  LI-TPCD         PIC  9(05).
 01  LO-ERR          PIC  9(01).
 01  LO-DENNO        PIC  9(09).
 01  LO-NEXT         PIC  9(09).
*
******************************************************************
 PROCEDURE                 DIVISION    USING     LI-TRCD
                                                 LI-TPCD
                                                 LO-ERR
                                                 LO-DENNO
                                                 LO-NEXT.
******************************************************************
 ...
 FILERR-SEC1            SECTION.
     ...
     DISPLAY " *** SKYSBCK3   ABEND *** "      UPON CONS.
     DISPLAY " *** SEC = " SEC-NAME     " ***" UPON CONS.
     DISPLAY " *** NFTENMS1 ST = " NTP-ST " ***" UPON CONS.
...
*   LEVEL  ALL          取引先マスタ　読込
*---------------------------------------------------------------
 NTP-READ-SEC              SECTION.
     MOVE     "TOR-READ-SEC " TO  SEC-NAME.
     MOVE     SPACE        TO     NTP-REC.
     INITIALIZE                   NTP-REC.
     MOVE     LI-TRCD      TO     NTP-F01.
     MOVE     LI-TPCD      TO     NTP-F02.
     READ     NFTENMS1
         INVALID
              MOVE    SPACE   TO  NTP-REC
              INITIALIZE          NTP-REC
         NOT  INVALID
              ...
              ELSE
                   MOVE 0     TO  PR-KBN
              END-IF
              MOVE    NTP-F18 TO  PR-KETA
              MOVE    NTP-F16 TO  PR-START
              MOVE    NTP-F17 TO  PR-END
              MOVE    NTP-F15 TO  LO-DENNO
     END-READ.
 NTP-READ-END.
     EXIT.
