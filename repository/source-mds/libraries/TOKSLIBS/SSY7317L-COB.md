...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY7317L.COB`
...
*
 ...
 FILE-CONTROL.
****<<DCMJAPAN物品受領データ >>*********************************
     SELECT   DYJRYOF            ASSIGN    TO   DA-01-VI-DYJRYOL2
...
*
 01  WK-GOKEI.
     03  WK-DENPYO-KEI            PIC      S9(08)  VALUE  ZERO.
     03  WK-TENPO-KEI             PIC      S9(08)  VALUE  ZERO.
     03  WK-SOGOKEI               PIC      S9(08)  VALUE  ZERO.
...
***** メッセージエリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY7317L".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY7317L".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND1.
...
*             プロセス                      0.0                *
****************************************************************
 SSY7317L-START         SECTION.
*
     MOVE   "SSY7317L-START"      TO   S-NAME.
     PERFORM            INIT-SEC.
*
...
*事業部名称セット
     EVALUATE PARA-TOKCD
         WHEN 1225    MOVE NC"ダイユーエイト" TO  HD01-JIGYOBU
         WHEN 12251   MOVE NC"エイトファーム" TO  HD01-JIGYOBU
*        2013/09/19 追加  ↓
         WHEN 12252   MOVE NC"日敷　　　　　" TO  HD01-JIGYOBU
*        2013/09/19 追加  ↑
*        2018/02/28 追加  ↓
         WHEN 1994    MOVE NC"リック資材　　" TO  HD01-JIGYOBU
         WHEN 1995    MOVE NC"リック植物　　" TO  HD01-JIGYOBU
*        2018/02/28 追加  ↑
