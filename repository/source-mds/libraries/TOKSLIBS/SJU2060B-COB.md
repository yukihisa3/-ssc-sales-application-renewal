...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SJU2060B.COB`
...
*
 ...
 FILE-CONTROL.
*受信ファイル
     SELECT  CVCSGF    ASSIGN    TO        DA-01-S-CVCSG006
                       ACCESS    MODE      SEQUENTIAL
                       FILE      STATUS    CVC-ST.
*バックアップファイル
     SELECT  BKCVCF    ASSIGN    TO        DA-01-S-BKCVCS06
                       ACCESS    MODE      SEQUENTIAL
                       FILE      STATUS    BKC-ST.
*
****************************************************************
