...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SJH5003B.COB`
...
*    ｶｳﾝﾄ
 ...
 01  WK-DENNO-RT             PIC  9(09)     VALUE  ZERO.
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJH5003B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJH5003B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*出荷場所／伝発場所
     MOVE        TBL-F04   TO        HEN-F08
                                     HEN-F09.
*振分ルート取得 2008/05/01  追加
     IF  HEN-F02  NOT =  WK-DENNO-RT
         MOVE   TBL-F04    TO        WK-RUTO
         MOVE   HEN-F02    TO        WK-DENNO-RT
     END-IF.
