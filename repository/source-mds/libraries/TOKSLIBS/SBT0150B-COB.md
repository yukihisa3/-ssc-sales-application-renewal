...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SBT0150B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG           PIC   X(08)  VALUE "SBT0150B".
         05  FILLER          PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER          PIC   X(05)  VALUE " *** ".
         05  END-PG          PIC   X(08)  VALUE "SBT0150B".
         05  FILLER          PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER          PIC   X(05)  VALUE " *** ".
...
*売上伝票ファイルスタート
     ...
     START    SHTDENF   KEY  >=   DEN-F46   DEN-F47
         ...
         INVALID   KEY
         MOVE "END"     TO   END-FLG
         DISPLAY NC"＃＃連携対象無　売上伝票＃＃" UPON CONS
