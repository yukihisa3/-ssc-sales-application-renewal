...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SBM0030B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SBM0030B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SBM0030B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*店舗ＣＤ
 01  WK-TEN5-NO.
     03  WK-TEN5-S         PIC        X(05).
     03  WK-TEN5-S-R       REDEFINES WK-TEN5-S.
         05  WK-TEN5-H     PIC        9(05).
*##2015/05/28 NAV ED
*
 01  LINK-AREA.
...
*****DISPLAY "HAC-F302(1:7) = "  HAC-F302(1:7)  UPON CONS.
     MOVE  WK-DEN-H        TO        HEN-F02.
*****DISPLAY "WK-DEN-H      = "  WK-DEN-H       UPON CONS.
...
*##2015/05/28 NAV ST 店舗ＣＤ５桁対応
     IF  HAC-F308(5:1)  =  SPACE
         ...
         MOVE WK-TEN-H       TO      HEN-F07
     ELSE
         MOVE HAC-F308(1:5)  TO      WK-TEN5-S
         MOVE WK-TEN5-H      TO      HEN-F07
     END-IF.
*##2015/05/28 NAV ED
*  商品変換テーブル検索
