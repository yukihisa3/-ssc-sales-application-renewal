...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/TKEIHEN.COB`
...
*--------------------------------------------------------------*
 01  PGM-ID                  PIC  X(08)     VALUE  "TKEIHEN ".
*----<< ﾃﾞｨｽﾌﾟﾚｲ ｺﾝﾄﾛｰﾙ ｴﾘｱ >>-*
 01  DSP-CNTL.
     03  DSP-FMT             PIC  X(08).
     03  DSP-GRP             PIC  X(08).
...
*画面退避用
     COPY   MKEIHEN  OF XMDLIB  JOINING   SAV  AS   PREFIX.
*
 01  SAVE-AREA.
...
*画面＆ＴＢＬクリア
     ...
     MOVE      SPACE     TO   MKEIHEN   TABLE-AREA.
     INITIALIZE               TBL-XX.
     MOVE      ZERO      TO   WK-TAIHI.
...
*T↓
       ...
       DISPLAY "TBL-R10301(I)= " TBL-R10301(I) UPON CONS
*T↑
              MOVE  90    TO   I
          END-IF
*T↓
       DISPLAY "P-CNT,T,L,I  = " P-CNT "," T "," L "," I UPON CONS
*T↑
       END-PERFORM
       IF   I  <   90
            MOVE      29             TO   ERR-FLG
