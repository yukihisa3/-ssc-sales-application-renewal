...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSE8810B.COB`
...
*----<< ワークファイル >>--*
 SETGKFA-ERR            SECTION.
     ...
     DISPLAY  "### SSE8810B SETGKFA ERROR " SEI-ST  " "
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSE8810B HTOKMS ERROR " TOK-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
*----<< 配信データ >>--*
 CVCSKHAI-ERR           SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSE8810B CVCSF    ERROR " CVCS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
...
*************MOVE  SEI-F06   TO   ONL1-A096(IDX)
     ...
     MOVE    SEI-F05(3:6)    TO   ONL1-A095(IDX).
*****MOVE    SEI-F06         TO   ONL1-A096(IDX).
...
*
     ...
     MOVE     CONST-TOKCD    TO   ME-03.
     MOVE     CONST-TOKCD    TO   TOK-F01.
     PERFORM  TOK-READ.
