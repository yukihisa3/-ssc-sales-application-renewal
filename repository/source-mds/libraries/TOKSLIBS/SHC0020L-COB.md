...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SHC0020L.COB`
...
*
 ...
 FILE-CONTROL.
*****<<集計表データ　Ｆ >>**************************************
     SELECT   SHWHACWK   ASSIGN    TO        SHWHACWK
...
*
 01  WL-IDX-AREA.
     03  WK-IXM                   PIC       9(04)  VALUE  ZERO.
     03  WK-IXD                   PIC       9(04)  VALUE  ZERO.
     03  WK-IX                    PIC       9(04)  VALUE  ZERO.
*
 01  WK-NEW-KEY.
...
***** メッセージエリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SHC0020L".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SHC0020L".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND1.
...
***** 見出し行１
 01  MIDASHI1.
     ...
     03  FILLER                   PIC  X(08)  VALUE "SHC0020L".
