...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSI3303L.COB`
...
*----<< 支払合計ファイル >>--*
     SELECT   SSIHARAD  ASSIGN         DA-01-S-SITGKFE
                        ...
                        STATUS         SSI-ST.
*----<< 請求合計Ｆ >>--*
     SELECT   HSEIGKF   ASSIGN         DA-01-VI-SETGKFG1
...
*
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
 01  PG-ID              PIC  X(08)     VALUE   "SSI3303L".
*
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
...
*----<< BREAK KEY >>--*
 01  BREAK-KEY.
     03  SSI-KEY.
         05  SSI-DENNO  PIC  X(08)    VALUE  SPACE.
     03  SEI-KEY.
         05  SEI-DENNO  PIC  X(08)    VALUE  SPACE.
*
 01  WK-TORICD          PIC  9(08)    VALUE  ZERO.
*
 01  WK-DENNO-9         PIC  X(09).
 01  WK-DENNO-R         REDEFINES     WK-DENNO-9.
     03  HEN-DENNO-A    PIC  X(01).
     03  HEN-DENNO      PIC  X(08).
*
...
*----<< ｶｳﾝﾄｴﾘｱ >>--*
 01  CNT-AREA.
     ...
     03  IN-SEI-CNT     PIC  9(05)    VALUE  ZERO.
     03  IN-SSI-CNT     PIC  9(05)    VALUE  ZERO.
*
*--<< ﾌﾟﾘﾝﾄ AREA >>-*
 01  HEAD01.
     03  FILLER         CHARACTER TYPE BAIKAKU-1-5.
         05  FILLER     PIC  X(02)     VALUE  SPACE.
         05  FILLER     PIC  X(08)     VALUE  "SSI3303L".
...
*ファイルのクローズ
     ...
     CLOSE    PRTF.
*データ内容メッセージ
     DISPLAY "ｾｲｷｭｳﾃﾞｰﾀ IN = "  IN-SEI-CNT  UPON CONS.
     DISPLAY "ｼﾊﾗｲ ﾃﾞｰﾀ IN = "  IN-SSI-CNT  UPON CONS.
...
*伝票区分名称セット
     EVALUATE SSI-F04
         WHEN  50
              MOVE  NC"５０納品伝票"   TO   ME-03
         WHEN  51
*********WHEN  42
              MOVE  NC"５１返品値引"   TO   ME-03
         WHEN OTHER
...
*伝票区分名称セット
     EVALUATE SEI-F07
         WHEN 40
              MOVE  NC"４０納品伝票"       TO   ME-03
         WHEN 41
              MOVE  NC"４１返品伝票"       TO   ME-03
         WHEN 42
              MOVE  NC"４２値引伝票"   TO   ME-03
         WHEN OTHER
              MOVE  ALL NC"＊"         TO   ME-03
     END-EVALUATE.
