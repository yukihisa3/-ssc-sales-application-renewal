...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY0805B.COB`
...
*
*欠品出力用ファイル
     SELECT  KEPCSVF   ASSIGN    TO        KEPCSVL1
                       ORGANIZATION        INDEXED
                       ACCESS    MODE      RANDOM
                       RECORD    KEY       KEP-F01
                                           KEP-F05
...
**************************************************************
 ...
 SOK-ERR                   SECTION.
     ...
     STOP        RUN.
 KEP-ERR                   SECTION.
     USE         AFTER     EXCEPTION PROCEDURE KEPCSVF.
...
****************************************************************
 PROCESS-SEC             SECTION.
     ...
     DISPLAY  "***   SSY0805B   START    ***"  UPON CONS.
*
     PERFORM   INIT-SEC.
...
****************************************************************
 END-SEC               SECTION.
*ファイル ＣＬＯＳＥ
     CLOSE             KPNFILF  HTOKMS  HTENMS  KEPCSVF
                       ZSOKMS.
     DISPLAY  "***   KPN-CNT = " READ-CNT " *** " UPON CONS.
     DISPLAY  "***   SSY0805B   END      ***"  UPON CONS.
**
 END-EXIT.
     EXIT.
