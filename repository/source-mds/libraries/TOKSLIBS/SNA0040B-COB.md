...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SNA0040B.COB`
...
****************************************************************
 INIT-SEC              SECTION.
     ...
     DISPLAY   "**  START SNA0040B  **"  UPON CONS.
...
* URI-F04 : 相殺区分
* URI-F051: 伝区コード
     IF  URI-F04 = ZERO  AND  URI-F051 = 40
         CONTINUE
     ELSE
...
*↑2012/09/04
     ...
     DISPLAY   "**  END   SNA0040B  **"  UPON CONS.
