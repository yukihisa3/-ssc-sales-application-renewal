...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SBT0320B.COB`
...
*    変更概要　　　　　　：　商品変換ＴＢＬが無くても商品名称  *
*      　　　　　　　　　　　マスタが存在すれば、ＪＡＮＣＤを　*
*      　　　　　　　　　　　セットし、連携されるに変更　　　　*
*　　更新日／更新者　　　：　2013/10/30                        *
*　　更新日／更新者　　　：　NAV TAKAHASHI                     *
*    変更概要　　　　　　：　リックの場合、売上伝票Ｆ内の商区  *
*      　　　　　　　　　　　＝９９の場合、届け先ＣＤには何も　*
*      　　　　　　　　　　　セットしない様に変更する。　　　　*
*　　更新日／更新者　　　：　2014/08/12                        *
*　　更新日／更新者　　　：　NAV TAKAHASHI                     *
...
*
 ...
 FILE-CONTROL.
*売上伝票データ
     SELECT   SHTDENF   ASSIGN    TO        DA-01-VI-SHTDENLF
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SBT0320B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SBT0320B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-IN.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
**************2013/10/30 NAV ST 商区＝９９の場合、届け先ＣＤは
**************                  セットしない
*##           IF  DEN-F131 = "99"
...
*2013/03/08 NAV ST 商品変換ＴＢＬが未登録の場合でも対象とする。
*****IF         HSHOTBL-INV-FLG   NOT =  SPACE
*               GO            TO         SHTDENF-READ-SEC
*****END-IF.
*2013/03/08 NAV ED 商品変換ＴＢＬが未登録の場合でも対象とする。
*商品名称マスタ取得
