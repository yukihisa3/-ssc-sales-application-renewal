...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSI7705B.COB`
...
*----<< 支払合計ファイル >>--*
     SELECT   SITGKFS  ASSIGN         DA-01-S-SITGKFS
                        ...
                        STATUS         SSI-ST.
*----<< 請求合計Ｆ >>--*
     SELECT   SETGKFS   ASSIGN         DA-01-VI-SETGKFS2
...
*----<< 支払合計ファイル >>--*
 FD  SITGKFS           LABEL RECORD   IS   STANDARD
     ...
     COPY     SITGKFS   OF        XFDLIB
              JOINING   SSI       PREFIX.
*----<< 請求合計Ｆ >>--*
 FD  SETGKFS            LABEL RECORD   IS   STANDARD.
...
*--------------------------------------------------------------*
*----<< ﾌﾟﾛｸﾞﾗﾑID >>--*
 01  PG-ID              PIC  X(08)     VALUE  "SSI7705B".
*----<< ﾌﾗｸﾞｴﾘｱ >>--*
...
*----<< 支払合計ファイル >>--*
 SYO-ERR                SECTION.
     ...
     DISPLAY  "### " PG-ID " SITGKFSF ERROR " SSI-ST " "
...
*----<< 請求合計Ｆ >>--*
 SEI-ERR                 SECTION.
     USE AFTER     EXCEPTION PROCEDURE      SETGKFS.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### " PG-ID " SETGKFS   ERROR " SEI-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
...
*
     IF       SSI-F01   =    ZERO
              ...
              MOVE     HEN-DENNO      TO   SEI-F13
**************DISPLAY "SEI-F13 = " SEI-F13  UPON CONS
