...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY1004L.COB`
...
*----<2005/10/05 追加>----
 01  WTSURYO                      PIC       9(06)  VALUE  ZERO.
 01  WTGENHEI                     PIC       9(07)  VALUE  ZERO.
 01  WTBAIHEI                     PIC       9(07)  VALUE  ZERO.
*-------------------------
*
***** 合計見出し領域
 01  G-MIDASI      CHARACTER      TYPE      IS     YA.
     03  SYO-MI                   PIC       N(08)  VALUE
       NC"【　小　　計　】".
     03  GOU-MI                   PIC       N(08)  VALUE
       NC"【　合　　計　】".
     03  SOU-MI                   PIC       N(08)  VALUE
       NC"【　総合　計　】".
     03  CYU-MI                   PIC       N(08)  VALUE
       NC"【　中　　計　】".
*---<2005/10/05 追加>----
 01  TG-MIDASI      CHARACTER      TYPE      IS     YA.
     03  TSYO-MI                   PIC       N(08)  VALUE
       NC"【訂正後　小計】".
     03  TGOU-MI                   PIC       N(08)  VALUE
       NC"【訂正後　合計】".
     03  TSOU-MI                   PIC       N(08)  VALUE
       NC"【訂正後総合計】".
     03  TCYU-MI                   PIC       N(08)  VALUE
       NC"【訂正後　中計】".
*
***** 合計集計ワーク
 01  G-WORK.
...
***** 合計集計ワーク
 01  TG-WORK.
     03  TSYO-WORK.
         05  TSYO-SU              PIC       9(06)  VALUE  ZERO.
         05  TSYO-GENKIN          PIC      S9(09)  VALUE  ZERO.
         05  TSYO-GENHEI          PIC       9(07)  VALUE  ZERO.
         05  TSYO-BAIKIN          PIC      S9(09)  VALUE  ZERO.
         05  TSYO-BAIHEI          PIC       9(07)  VALUE  ZERO.
     03  TCYU-WORK.
         05  TCYU-SU              PIC       9(06)  VALUE  ZERO.
         05  TCYU-GENKIN          PIC      S9(09)  VALUE  ZERO.
         05  TCYU-GENHEI          PIC       9(07)  VALUE  ZERO.
         05  TCYU-BAIKIN          PIC      S9(09)  VALUE  ZERO.
         05  TCYU-BAIHEI          PIC       9(07)  VALUE  ZERO.
     03  TGOU-WORK.
         05  TGOU-SU              PIC       9(06)  VALUE  ZERO.
         05  TGOU-GENKIN          PIC      S9(09)  VALUE  ZERO.
         05  TGOU-GENHEI          PIC       9(07)  VALUE  ZERO.
         05  TGOU-BAIKIN          PIC      S9(09)  VALUE  ZERO.
         05  TGOU-BAIHEI          PIC       9(07)  VALUE  ZERO.
     03  TSOU-WORK.
         05  TSOU-SU              PIC       9(06)  VALUE  ZERO.
         05  TSOU-GENKIN          PIC      S9(09)  VALUE  ZERO.
         05  TSOU-GENHEI          PIC       9(07)  VALUE  ZERO.
         05  TSOU-BAIKIN          PIC      S9(09)  VALUE  ZERO.
         05  TSOU-BAIHEI          PIC       9(07)  VALUE  ZERO.
*--------------------------
*
***** メッセージエリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY1004L".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY1004L".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND1.
...
***** 見出し行１
 01  MIDASHI1.
     ...
     03  FILLER                   PIC  X(08)  VALUE "SSY1004L".
...
*****03  FILLER                   PIC       X(01)  VALUE  SPACE.
     03  FILLER                   PIC       N(07)  VALUE  SPACE.
     03  FILLER                   PIC       X(03)  VALUE  SPACE.
     03  FILLER                   PIC       N(03)  VALUE  SPACE.
     03  FILLER                   PIC       X(26)  VALUE  SPACE.
     03  FILLER                   PIC       N(03)  VALUE  SPACE.
*****03  FILLER                   PIC       X(12)  VALUE  SPACE.
     03  FILLER                   PIC       X(02)  VALUE  SPACE.
     ...
     03  FILLER                   PIC       X(10)  VALUE  SPACE.
***** 明細行８
 01  MIDASHI8      CHARACTER      TYPE      IS     YA.
*****03  FILLER                   PIC       X(01)  VALUE  SPACE.
     03  FILLER                   PIC       N(02)  VALUE
       NC"_番".
*
...
*****03  FILLER                   PIC       X(10)  VALUE  SPACE.
     03  FILLER                   PIC       X(11)  VALUE  SPACE.
     03  TSURYOKEI                PIC       ZZZZZZ.
     03  FILLER                   PIC       X(01)  VALUE  SPACE.
     03  TSURYO-TBL               OCCURS    10.
         05  TSURYO               PIC       ZZZZ9  VALUE  ZERO.
         05  FILLER               PIC       X(02)  VALUE  SPACE.
*
***** 明細行４
 01  MEISAI4.
...
*----<2005/10/05 追加>----
***** 合計行（訂正前）
 01  TGOUKEI        CHARACTER      TYPE      IS     YA.
     03  FILLER                   PIC       X(10)  VALUE  SPACE.
     03  TGKMIDASI                PIC       N(08).
     03  FILLER                   PIC       X(02)  VALUE  SPACE.
     03  FILLER                   PIC       N(04)  VALUE
       NC"数量合計".
     03  FILLER                   PIC       X(01)  VALUE  SPACE.
     03  TSUKEI                   PIC       ZZZ,ZZ9.
     03  FILLER                   PIC       X(02)  VALUE  SPACE.
     03  FILLER                   PIC       N(04)  VALUE
       NC"原価金額".
     03  FILLER                   PIC       X(01)  VALUE  SPACE.
...
*
     MOVE     SPACE     TO        MEISAI1 MEISAI2 MEISAI3 MEISAI4.
...
*
     ...
     WRITE    P-REC     FROM      MIDASHI9  AFTER     1.
...
**** IF        HAC-F13  NOT =  HAC-F14
               MOVE      HAC-F14   TO   T-TSURYO(WK-IXM).
*****END-IF.
     COMPUTE   WSURYO    =    HAC-F13   +    WSURYO.
     COMPUTE   WTSURYO   =    HAC-F14   +    WTSURYO.
*
...
*
     ...
     COMPUTE   TSYO-SU    =
                             WTSURYO    +         TSYO-SU.
     COMPUTE   TSYO-GENKIN  =
                             WTSURYO *  WGENTAN + TSYO-GENKIN.
     COMPUTE   TSYO-BAIKIN  =
                             WTSURYO *  WBAITAN + TSYO-BAIKIN.
*
...
*
     END-PERFORM.
*
     WRITE     P-REC  FROM  MEISAI5  AFTER  1.
     ADD       1              TO        L-CNT.
*****MOVE      SPACE          TO        MEISAI5.
*
     MOVE      ZERO           TO        TBL-MISE-AREA.
     MOVE      ZERO           TO        WK-IXM.
*
...
*
     ...
     IF   T-SURYO(WK-IXM) NOT = T-TSURYO(WK-IXM)
          MOVE     T-TSURYO(WK-IXM)    TO   TSURYO(WK-IX)
     END-IF.
*
 MEISAI-EXIT.
     EXIT.
...
*
     ...
     MOVE     TSYO-MI        TO        TGKMIDASI.
     MOVE     TSYO-SU        TO        TSUKEI.
     MOVE     TSYO-GENKIN    TO        TGENKEI.
     MOVE     TSYO-BAIKIN    TO        TBAIKEI.
*
     IF       SYO-SU      =  ZERO
              MOVE           ZERO      TO        GENHEI
                                                 BAIHEI
     ...
     END-IF.
     IF      TSYO-SU  = ZERO
             MOVE       ZERO      TO        TGENHEI
                                            TBAIHEI
     ELSE
             COMPUTE    WTGENHEI   =     TSYO-GENKIN / TSYO-SU
             MOVE       WTGENHEI   TO    TGENHEI
             COMPUTE    WTBAIHEI   =     TSYO-BAIKIN / TSYO-SU
             MOVE       WTBAIHEI   TO    TBAIHEI
     END-IF.
*
     IF       L-CNT       >= 56
              PERFORM        MIDASI-SEC
     END-IF.
*
     COMPUTE  W-L-CNT     =  56             -    L-CNT.
     WRITE    P-REC          FROM      GOUKEI    AFTER    W-L-CNT.
     WRITE    P-REC          FROM     TGOUKEI    AFTER    1.
*
     COMPUTE  CYU-SU      =  SYO-SU         +    CYU-SU.
     COMPUTE  CYU-GENKIN  =  SYO-GENKIN     +    CYU-GENKIN.
     COMPUTE  CYU-BAIKIN  =  SYO-BAIKIN     +    CYU-BAIKIN.
     COMPUTE  TCYU-SU     =  TSYO-SU        +    TCYU-SU.
     COMPUTE  TCYU-GENKIN =  TSYO-GENKIN    +    TCYU-GENKIN.
     COMPUTE  TCYU-BAIKIN =  TSYO-BAIKIN    +    TCYU-BAIKIN.
*
     MOVE     ZERO           TO        SYO-SU
                                       SYO-GENKIN
                                       SYO-BAIKIN
...
*
     ...
     MOVE     TCYU-MI        TO        TGKMIDASI.
     MOVE     TCYU-SU        TO        TSUKEI.
     MOVE     TCYU-GENKIN    TO        TGENKEI.
     MOVE     TCYU-BAIKIN    TO        TBAIKEI.
*
     IF       CYU-SU      =  ZERO
              MOVE           ZERO      TO        GENHEI
                                                 BAIHEI
     ...
     IF      TCYU-SU  = ZERO
             MOVE       ZERO      TO        TGENHEI
                                            TBAIHEI
     ELSE
             COMPUTE    WTGENHEI   =     TCYU-GENKIN / TCYU-SU
             MOVE       WTGENHEI   TO    TGENHEI
             COMPUTE    WTBAIHEI   =     TCYU-BAIKIN / TCYU-SU
             MOVE       WTBAIHEI   TO    TBAIHEI
     END-IF.
*
...
*
     ...
     COMPUTE  TGOU-SU     =  TCYU-SU        +    TGOU-SU.
     COMPUTE  TGOU-GENKIN =  TCYU-GENKIN    +    TGOU-GENKIN.
     COMPUTE  TGOU-BAIKIN =  TCYU-BAIKIN    +    TGOU-BAIKIN.
*
     MOVE     ZERO           TO        CYU-SU
                                       CYU-GENKIN
                                       CYU-BAIKIN
...
*
     ...
     MOVE     TGOU-MI        TO        TGKMIDASI.
     MOVE     TGOU-SU        TO        TSUKEI.
     MOVE     TGOU-GENKIN    TO        TGENKEI.
     MOVE     TGOU-BAIKIN    TO        TBAIKEI.
*
     IF       GOU-SU      =  ZERO
              MOVE           ZERO      TO        GENHEI
                                                 BAIHEI
     ...
     IF      TGOU-SU  = ZERO
             MOVE       ZERO      TO        TGENHEI
                                            TBAIHEI
     ELSE
             COMPUTE    WTGENHEI   =     TGOU-GENKIN / TGOU-SU
             MOVE       WTGENHEI   TO    TGENHEI
             COMPUTE    WTBAIHEI   =     TGOU-BAIKIN / TGOU-SU
             MOVE       WTBAIHEI   TO    TBAIHEI
     END-IF.
*
     WRITE    P-REC          FROM      GOUKEI    AFTER     1.
...
*
     ...
     COMPUTE  TSOU-SU     =  TGOU-SU        +    TSOU-SU.
     COMPUTE  TSOU-GENKIN =  TGOU-GENKIN    +    TSOU-GENKIN.
     COMPUTE  TSOU-BAIKIN =  TGOU-BAIKIN    +    TSOU-BAIKIN.
*
     MOVE     ZERO           TO        GOU-SU
                                       GOU-GENKIN
                                       GOU-BAIKIN
...
*
     ...
     MOVE     TSOU-MI        TO        TGKMIDASI.
     MOVE     TSOU-SU        TO        TSUKEI.
     MOVE     TSOU-GENKIN    TO        TGENKEI.
     MOVE     TSOU-BAIKIN    TO        TBAIKEI.
*
     IF       SOU-SU      =  ZERO
              MOVE           ZERO      TO        GENHEI
                                                 BAIHEI
     ...
     IF      TSOU-SU  = ZERO
             MOVE       ZERO      TO        TGENHEI
                                            TBAIHEI
     ELSE
             COMPUTE    WTGENHEI   =     TSOU-GENKIN / TSOU-SU
             MOVE       WTGENHEI   TO    TGENHEI
             COMPUTE    WTBAIHEI   =     TSOU-BAIKIN / TSOU-SU
             MOVE       WTBAIHEI   TO    TBAIHEI
     END-IF.
*
     WRITE    P-REC          FROM      GOUKEI    AFTER     1.
