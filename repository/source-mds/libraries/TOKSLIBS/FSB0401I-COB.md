...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/FSB0401I.COB`
...
***  伝票キーエリア（画面遷移制御）
 ...
 01  WK-KEYAREA2.
     ...
     03  WK2-F02                   PIC  9(05)  VALUE  ZERO.
