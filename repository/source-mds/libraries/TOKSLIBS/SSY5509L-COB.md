...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY5509L.COB`
...
****************************************************************
 ...
 FILE-CONTROL.
*伝票データ（共通）　　
     SELECT   YTSHIRED  ASSIGN    TO        YTSHIRED
...
*--- << 仕入データエラー >> ---*
 000-MAST-ERR           SECTION.
     USE AFTER          EXCEPTION      PROCEDURE      YTSHIRED.
...
****************************************************************
 DEN-CNT-SEC            SECTION.
*
     READ     YTSHIRED AT  END
              MOVE     "END"     TO   END-FLG
              GO                 TO   DEN-CNT-EXIT
     END-READ.
*    ユートク以外は読み飛ばし（取引先）
     IF       DEN-F01  NOT =  22051
                       GO       TO   DEN-CNT-SEC
     END-IF.
 DEN-CNT-01.
*    伝票枚数カウント
...
*明細１行目
***  商品名
*    MOVE     DEN-A31             TO   DT1-01.
***  自社品番
*    MOVE     "("                 TO   DT1-021.
*    MOVE     DEN-A33             TO   DT1-022.
*    MOVE     ")"                 TO   DT1-023.
***  カラー名
*    MOVE     DEN-A37             TO   DT1-03.
***  サイズ名
*    MOVE     DEN-A38             TO   DT1-04.
...
***  商品コード（ＪＡＮＣＤ）
     MOVE     DEN-A20             TO        DT2-02.
***  入数
     MOVE     DEN-A21             TO        DT2-03.
***  発注単位数（ケース）
     MOVE     DEN-A22             TO        DT2-04.
***  単位
     MOVE     DEN-A23             TO        DT2-05.
***  数量
...
*ヘッダ４行目
***  取引先名（中段）
     MOVE     "ｶﾌﾞ)ｻｶﾀﾉﾀﾈ"        TO        HD4-01.
*ヘッダ５行目
***  店名
     MOVE     DEN-A12             TO        HD5-01.
***  店舗ＣＤ
     MOVE     DEN-A11             TO        HD5-02.
***  分類コード
...
***  取引先コード
     MOVE     DEN-A091            TO        HD5-07.
***  発注日
     MOVE     DEN-A07             TO        HD5-09.
***  納品日
     MOVE     DEN-A08             TO        HD5-10.
*
...
*
     CLOSE    YTSHIRED   PRTFILE    DSPFILE.
*
 END-EXIT.
     EXIT.
