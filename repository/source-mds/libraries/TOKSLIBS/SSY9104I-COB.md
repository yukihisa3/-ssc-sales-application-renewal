...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY9104I.COB`
...
*2008/02/20 部門CD変更
*2009/02/23 部門CD変更(DCMJAPANに統合)
*2013/08/15 発注種別区分変更
*2017/04/06 ＢＹ改廃追加
*2019/03/18 発注種別変換マスタ対応
****************************************************************
...
****  メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SSY9104I".
...
************************************************************
 END-SEC                SECTION.
*
     CLOSE    DSPF DKCENTF  ZSOKMS HTOKMS HTENMS DCMHSBL2.
*
 END-END.
     EXIT.
************************************************************
