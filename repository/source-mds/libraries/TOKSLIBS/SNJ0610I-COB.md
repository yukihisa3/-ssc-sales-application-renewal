...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SNJ0610I.COB`
...
*基本スケジュール退避エリア
 01  TABLE-AREA.
     03  TBL-KAISEN.
         ...
         05  TBL-SEN5             PIC   N(03).
         05  TBL-SEN6             PIC   N(03).
     03  TABLE1      OCCURS  5.
         05  TABLE2  OCCURS  15.
             07  TBL-SEQ          PIC   9(02).
...
***  DISPLAY "LINK-JUKBN = " LINK-JYUKBN  UPON CONS.
...
*配信起動    (2.4)
         WHEN      "4"       PERFORM   PARA-WATASHI-SEC
*以外
         WHEN      OTHER     CONTINUE
     END-EVALUATE.
*
...
*初期画面の表示
     MOVE    SPACE                TO   DSP-PRO.
*画面の初期化
     MOVE    SPACE                TO   DSP-FNJ0520I.
*フォームＩＤ転送
     MOVE   "FNJO520I"            TO   DSP-FORMID.
*PGID転送
     MOVE   "SNJ0610I"            TO   DSP-PGMID.
*システム日付転送
...
*                WHEN "3" MOVE NC"ＰＣ全銀" TO DSP-MSENNM(Y)
             ...
             EVALUATE TBL-MDTKBN(P-CNT Y)
                 ...
                 WHEN "06" MOVE NC"欠品"    TO  DSP-MDTNM(Y)
                 WHEN "07" MOVE NC"商品"    TO  DSP-MDTNM(Y)
             ...
             READ JSMKAIF
                  ...
                  NOT  AT  END
                    EVALUATE KAI-F01 ALSO KAI-F02  ALSO  KAI-F07
                      ...
                      WHEN   "2"     ALSO   2      ALSO  " "
                          MOVE NC"ＯＫ　"  TO     TBL-SEN5
                      WHEN   "2"     ALSO   2      ALSO   1
                          MOVE NC"使用中"  TO     TBL-SEN5
                      WHEN   "2"     ALSO   3      ALSO  " "
                          MOVE NC"ＯＫ　"  TO     TBL-SEN6
                      WHEN   "2"     ALSO   3      ALSO   1
                          MOVE NC"使用中"  TO     TBL-SEN6
                  END-EVALUATE
              END-READ
     END-PERFORM.
     CLOSE    JSMKAIF.
