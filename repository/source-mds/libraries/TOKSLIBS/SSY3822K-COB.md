...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY3822K.COB`
...
*    メッセージ　エリア
 01  MSG-AREA.
     03  MSG-ABEND1.
         ...
         05  ERR-PG-ID            PIC  X(08)  VALUE  "SSY3822K".
...
*    帳票名
     EVALUATE LINK-SYUPTN
        WHEN  "1"    MOVE  NC"在庫確認書" TO  PRT-ZAITIL
                     MOVE  NC"※折り返しご連絡をお願い致します"
                                          TO  PRT-MSG1
                     MOVE  NC"出荷場所／" TO  PRT-MSG2
                     MOVE  NC"不足時"     TO  PRT-MSG3
                     MOVE  NC"可能数"     TO  PRT-MSG4
                     MOVE  NC"※回答は当日中に頂けます様"
                                          TO  PRT-MSG5
                     MOVE  NC"　ご協力お願い申し上げます。"
                                          TO  PRT-MSG6
                     MOVE  NC"在庫確認をお願いします。"
                                          TO  PRT-MSG7
                     MOVE  NC"出荷可能数が数に満たないときは"
                                          TO  PRT-MSG8
                     MOVE  NC"「不足時可能数」にご記入下さい。"
                                          TO  PRT-MSG9
        WHEN  "2"    MOVE  NC"確定発注書" TO  PRT-ZAITIL
                     MOVE  SPACE          TO  PRT-MSG1
                     MOVE  NC"発注ＮＯ／" TO  PRT-MSG2
                     MOVE  SPACE          TO  PRT-MSG3
                     MOVE  SPACE          TO  PRT-MSG4
                     MOVE  SPACE          TO  PRT-MSG5
                     MOVE  SPACE          TO  PRT-MSG6
                     MOVE  SPACE          TO  PRT-MSG7
                     MOVE  SPACE          TO  PRT-MSG8
                     MOVE  SPACE          TO  PRT-MSG9
