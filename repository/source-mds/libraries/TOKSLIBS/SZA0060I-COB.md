...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SZA0060I.COB`
...
*    更新者　　　　　：  ＮＡＶ松野                          *
*    更新日　　　　　：  10/01/08                              *
*    更新者　　　　　：  ＮＡＶ高橋　部門入力許可：８６西尾*
*    更新日　　　　　：  14/01/17                              *
*    更新者　　　　　：  ＮＡＶ高橋　部門入力許可：ＴＶフロ*
****************************************************************
****************************************************************
...
*****DISPLAY "WK-SYSDATE = " WK-SYSDATE UPON CONS.
...
*    REWRITE  JYO-REC.
*
     CALL     "SKYSNCKB"       USING   OUT-SGYNO.
     MOVE     OUT-SGYNO        TO      SGYNO.
*
*作業完成日システム日付設定
     IF       SAV-YMD       =          ZERO
...
**************IF   WK-BASYO1 NOT = "6A"
**************## 2014/01/17 NAV ST
**************IF   WK-BASYO1 = "6A" OR "86"
              IF   WK-BASYO1 = "6A" OR "86"  OR  "TV"
**************## 2014/01/17 NAV ED
                   CONTINUE
              ELSE
