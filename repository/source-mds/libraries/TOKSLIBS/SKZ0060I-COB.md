...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SKZ0060I.COB`
...
*    サブシステム　　　　：　出荷業務　　　　　　　　　　　　　*
*    業務名　　　　　　　：　業務改善                          *
*    モジュール名　　　　：　手書出荷指示データ削除指示        *
*    作成日／更新日　　　：　2011/04/22                        *
*    作成者／更新者　　　：　ＮＡＶ高橋　　　　　　　　　　　　*
*    処理概要　　　　　　：　画面より手書出荷指示データ削除を  *
*                            行なう条件を入力する。　　　　　  *
*                            バッチ番号＋倉庫＋納品日　　　　　*
*　　更新日／更新者　　　：                                    *
*　                                                            *
...
*----<< 表示ファイル >>--*
     SELECT   DSPFILE   ASSIGN         01-GS-DSPF
                        ...
                        STATUS         DSP-ST.
*----<< 出荷状況管理ファイル >>--*
     SELECT   SYUJISF   ASSIGN         DA-01-VI-SYUJISL1
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SKZ0060I DSPFILE ERROR " DSP-CNTL " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
     CLOSE    SYUJISF   HTOKMS    ZSOKMS1    DSPFILE.
     STOP     RUN.
*----<< 伝票データ >>--*
 SYUJISF-ERR            SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SKZ0060I SYUJISF ERROR " SYUJISF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SKZ0060I HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SKZ0060I ZSOKMS1 ERROR " ZSOKMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FKZ00601.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "SKZ0060I"      TO   PGID.
     MOVE    "FKZ00601"      TO   FORM.
...
*    売上伝票データ存在チェック
     IF  ERR-FLG        =    ZERO
         ...
         INITIALIZE                    JIS-REC
         MOVE      "2"            TO   JIS-F01
         MOVE      JDATE          TO   JIS-F02
         MOVE      JTIME          TO   JIS-F03
         MOVE      TORICD         TO   JIS-F04
         MOVE      WK-SOKCD       TO   JIS-F05
         MOVE      NOUDT          TO   JIS-F06
         START     SYUJISF   KEY  >=   JIS-F01   JIS-F02
                                       JIS-F03   JIS-F04
                                       JIS-F05   JIS-F06
              INVALID   KEY
                   MOVE      5    TO   ERR-FLG
