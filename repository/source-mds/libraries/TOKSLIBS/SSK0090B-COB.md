...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSK0090B.COB`
...
*
 ...
 FILE-CONTROL.
*---<<  受領累積データ  >>---*
     SELECT   KEIJYRF   ASSIGN    TO             KEIJYRL4
                        ORGANIZATION        IS   INDEXED
                        ACCESS    MODE      IS   SEQUENTIAL
                        RECORD    KEY       IS   KEI-F10
...
**** メッセージ情報  ***
 01  MSG-AREA1-1.
     03  MSG-ABEND1.
       ...
       05  ERR-PG-ID         PIC  X(08)  VALUE  "SSK0090B".
...
*経過件数表示
     ...
     END-IF.
*受領累積データの検収日が削除基準日より大きい場合
     IF      KEI-F10  >  WK-DEL-DATE
             MOVE   "END"      TO   END-FLG
     END-IF.
*
 KEI-READ-EXIT.
...
*-------------------------------------------------------------*
 END-SEC                SECTION.
     CLOSE              KEIJYRF  HJYOKEN.
     DISPLAY  "DELDATE         = "  WK-DEL-DATE   UPON   CONS.
     DISPLAY  "KEIJYRF    (IN) = "  READ-CNT      UPON   CONS.
     DISPLAY  "KEIJYRF   (DEL) = "  DEL-CNT       UPON   CONS.
 END-END.
     EXIT.
******************<<  PROGRAM  END  >>**************************
