...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSK0015I.COB`
...
*メッセージの取得
 01  ERR-MSG-AREA.
     ...
     03  ERR-MSG6.
         05  FILLER              PIC   N(20)
             VALUE NC"対象バッチ_が当日スケＭに存在しません".
     03  ERR-MSG7.
         05  FILLER              PIC   N(20)
             VALUE NC"指定されたバッチ_は受領ではありません".
     03  ERR-MSG8.
         05  FILLER              PIC   N(20)
             VALUE NC"無効キー！！".
     03  ERR-MSG9.
         05  FILLER              PIC   N(20)
             VALUE NC"出力区分の指定に誤りがあります。".
 01  ERR-MSG-AREA-R      REDEFINES     ERR-MSG-AREA.
     03  ERR-MSG-R   OCCURS  9   PIC   N(20).
*
 01  FILE-ERR.
     03  TJS-ERR           PIC N(20) VALUE
                        NC"当日スケジュールＭエラー".
...
*出力区分
     ...
     ELSE
              ...
              GO             TO   PARA-CHK-EXIT
     END-IF.
*当日スケジュールマスタ存在チェック／受領データチェック
     MOVE     DSP-BTDATE          TO   TJS-F01.
     MOVE     DSP-BTTIME          TO   TJS-F02.
     MOVE     DSP-BTTORI          TO   TJS-F03.
...
*
     READ  JSMDAYF
           INVALID     MOVE  "INV"   TO   JSMDAYF-INV-FLG
           NOT INVALID MOVE  SPACE   TO   JSMDAYF-INV-FLG
     END-READ.
*
 JSMDAYF-READ-EXIT.
     EXIT.
*****************<<  SSK0015I   END PROGRAM  >>******************
