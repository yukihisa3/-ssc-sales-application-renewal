...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSYK004L.COB`
...
*メッセージ情報
 01  MSG-AREA.
     03  SEC-NAME.
         ...
         05  S-NAME          PIC  X(30).
     03  MSG-ABEND1.
         05  FILLER          PIC  X(12)  VALUE  "### SSYK004L".
...
*=============================================================
 CONTROL-SEC         SECTION.
     DISPLAY  "**  SSYK004L   START  **"   UPON  CONS.
*
     ...
     PERFORM  END-SEC.
*
     DISPLAY  "**  SSYK004L   END    **"   UPON  CONS.
     STOP  RUN.
 CONTROL-EXIT.
     EXIT.
*=============================================================
...
*出力順の設定
     ...
     END-IF.
*各取引先別区分
     MOVE  SYU-F20              TO   PRT-KBN1.
*各取引先別区分
     MOVE  SYU-F21              TO   PRT-KBN2.
*各取引先別区分
     MOVE  SYU-F22              TO   PRT-KBN3.
*_番（１：１）の設定
     MOVE  WK-TANA(1:1)         TO   PRT-TANA1.
*印刷
     MOVE "FSYK0042"             TO  PRT-FMT.
     MOVE "PW"                   TO  PRT-PRO.
