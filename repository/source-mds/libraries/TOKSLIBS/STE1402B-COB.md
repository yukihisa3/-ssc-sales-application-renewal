...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/STE1402B.COB`
...
***  ﾜｰｸ  ｴﾘｱ
 01  WRK-AREA.
     03  WK-TORICD                PIC  9(08)     VALUE  10545.
     ...
     03  WK-BIKO00                PIC  X(06)     VALUE   SPACE.
     03  WK-BIKO01                PIC  X(09)     VALUE   SPACE.
...
*    ﾐﾀﾞｼ
 01  HEAD-00   CHARACTER          TYPE IS        YA.
     ...
     03  HD001                    PIC  N(03) VALUE NC"ドイト".
*
...
*    伝票データ読込み
 READ-000.
     ...
     IF       KYO-F03 >    20
              IF  KYO-F03  =  80
                  MOVE KYO-F1421(1:6)  TO   WK-BIKO00
                  MOVE KYO-F1421(7:9)  TO   WK-BIKO01
...
*    備考印字
     WRITE    PRT-REC          FROM   TAIL-015  AFTER   1.
...
****************************************************************
 TEST-PRT-SEC           SECTION.
     INITIALIZE                  HEAD-00 HEAD-01
                                 BODY-01 BODY-02
                                 TAIL-01 TAIL-02 TAIL-03.
     MOVE   NC"ドイト"           TO   HD001.
*    テスト印字項目セット
