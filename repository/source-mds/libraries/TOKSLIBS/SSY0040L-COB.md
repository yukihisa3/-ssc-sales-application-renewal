...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY0040L.COB`
...
*メッセージ情報
 01  MSG-AREA.
     03  SEC-NAME.
         ...
         05  S-NAME          PIC  X(30).
     03  MSG-ABEND1.
         05  FILLER          PIC  X(12)  VALUE  "### SSY0040L".
...
*ﾁｮｳﾋｮｳﾃｲｷﾞｴﾘｱ
 01  HEAD01.
     ...
     03  FILLER     PIC  X(08)     VALUE  "SSY0040L".
     03  FILLER     PIC  X(04)     VALUE  SPACE.
     03  FILLER     PIC  N(16)     VALUE
     NC"※※出荷明細表（ケース算出）※※" CHARACTER TYPE PIT-3.
     03  FILLER     PIC  X(04)     VALUE  SPACE.
     03  HD01-01    PIC  9999.
...
*=============================================================
 CONTROL-SEC         SECTION.
     DISPLAY  "**  SSY0040L   START  **"   UPON  CONS.
*
     ...
     PERFORM  END-SEC.
*
     DISPLAY  "**  SSY0040L   END    **"   UPON  CONS.
     STOP  RUN.
 CONTROL-EXIT.
     EXIT.
*=============================================================
