...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8852L.COB`
...
*
 ...
 01  PG-ID             PIC  X(08)      VALUE  "SSY8852L".
 01  WK-MSG1           PIC  N(14)
...
*--------------------------------------------------------------*
 ...
 DKCERR                 SECTION.
     ...
     DISPLAY  "### SSY8852L DKC ERROR " DKC-ST " "
...
*得意先マスタ
 TOKERR                SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY8852L TOK ERROR " TOK-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
*店舗マスタ
 TENERR                SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY8852L TEN ERROR " TEN-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
*倉庫マスタ
 SOKERR                SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY8852L SOK ERROR " SOK-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
 PRTERR                 SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY8852L PRTFILE ERROR " PRT-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
...
*
     EVALUATE     DKC-F16
         WHEN    "1"
              MOVE     NC"【定期　　　　】"   TO   DT1-08
         WHEN    "2"
              MOVE     NC"【特売　　　　】"   TO   DT1-08
         WHEN    "3"
              MOVE     NC"【投入　　　　】"   TO   DT1-08
         WHEN    "4"
              MOVE     NC"【新店改装　　】"   TO   DT1-08
         WHEN    "6"
              MOVE     NC"【緊急ダイレク】"   TO   DT1-08
*#2019/02/21 NAV ST
         WHEN    "F"
              MOVE     NC"【客注ダイレク】"   TO   DT1-08
         WHEN    "A"
              MOVE     NC"【本部在庫補充】"   TO   DT1-08
         WHEN    "B"
              MOVE     NC"【専用_在庫補】"   TO   DT1-08
         WHEN    "C"
              MOVE     NC"【用度品　　　】"   TO   DT1-08
         WHEN    "D"
