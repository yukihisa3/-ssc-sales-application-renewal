...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY7530I.COB`
...
****************************************************************
*    顧客名　　　　　　　：　（株）サカタのタネ殿　　　　　　　*
*    サブシステム　　　　：　ＤＣＭサンワオンラインシステム    *
*    業務名　　　　　　　：　ＤＣＭサンワオンライン            *
*    モジュール名　　　　：　伝票くんデータ抽出指示            *
*    作成日／更新日　　　：　2016/01/12                        *
*    作成者／更新者　　　：　NAV                               *
*    処理概要　　　　　　：　画面より、伝票くん連携データの    *
*                            抽出指示を行う。　　　　　　　　　*
****************************************************************
****************************************************************
...
*----<< 表示ファイル >>--*
     SELECT   DSPFILE   ASSIGN         01-GS-DSPF
                        ...
                        STATUS         DSP-ST.
*----<< ＤＣＭサンワ基本情報データ >>--*
     SELECT   SWJOHOF   ASSIGN         DA-01-VI-SWJOHOL1
                        ORGANIZATION   INDEXED
                        ACCESS    MODE SEQUENTIAL
                        RECORD    KEY  SWJ-F01   SWJ-F02
                                       SWJ-F03   SWJ-F04
                                       SWJ-F06   SWJ-F05
                                       SWJ-F07   SWJ-F08
                        STATUS         SWJOHOF-ST.
...
*
*----<< ﾌｱﾝｸｼﾖﾝ ｷｰ ｶﾞｲﾄﾞ >>-*
 01  GUIDE01       PIC  N(40)  VALUE   NC"Ｆ５：終　了".
 01  GUIDE02       PIC  N(40)  VALUE
         NC"Ｆ４：取消　Ｆ５：終了　Ｆ６：項目戻り".
*
 01  MSG-AREA.
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SSY7530I DSPFILE ERROR " DSP-CNTL " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
     CLOSE    SWJOHOF   HTOKMS    ZSOKMS1    DSPFILE.
     STOP     RUN.
*----<< 伝票データ >>--*
 SWJOHOF-ERR            SECTION.
     USE AFTER     EXCEPTION PROCEDURE      SWJOHOF.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY7530I SWJOHOF ERROR " SWJOHOF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY7530I HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY7530I ZSOKMS1 ERROR " ZSOKMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FSY75301.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "SSY7530I"      TO   PGID.
     MOVE    "FSY75301"      TO   FORM.
...
*    基本情報データ存在チェック
     IF  ERR-FLG        =    ZERO
         MOVE      SPACE          TO   SWJ-REC
         INITIALIZE                    SWJ-REC
         MOVE      JDATE          TO   SWJ-F01
         MOVE      JTIME          TO   SWJ-F02
         MOVE      TORICD         TO   SWJ-F03
         MOVE      WK-SOKCD       TO   SWJ-F04
         MOVE      NOUDT          TO   SWJ-F06
         START     SWJOHOF   KEY  >=   SWJ-F01   SWJ-F02
                                       SWJ-F03   SWJ-F04
                                       SWJ-F06   SWJ-F05
                                       SWJ-F07   SWJ-F08
              INVALID   KEY
