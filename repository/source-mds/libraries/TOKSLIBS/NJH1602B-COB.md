...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH1602B.COB`
...
*    ｶｳﾝﾄ
 ...
 01  WK-DEN-F01              PIC  9(07)     VALUE  ZERO.
*
 01  WK-AREA.
*システム日付の編集
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH1602B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH1602B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*各量販店領域転送
*    伝票番号
     MOVE     DEN-F01       TO   HEN-A01.
*    事業部ＣＤ
     MOVE     DEN-F02       TO   HEN-A02.
*    店ＣＤ
     MOVE     DEN-F03       TO   HEN-A03.
*    部門
     MOVE     DEN-F04       TO   HEN-A04.
*    仕入先ＣＤ（３桁）
     MOVE     DEN-F05       TO   HEN-A05.
*    仕入先ＣＤ（５桁）
     MOVE     DEN-F06       TO   HEN-A06.
*    ロケーションＣＤ
     MOVE     DEN-F07       TO   HEN-A07.
*    取引先管理ＣＤ１
     MOVE     DEN-F08       TO   HEN-A08.
*    取引先管理ＣＤ２
     MOVE     DEN-F09       TO   HEN-A09.
*    取引先管理ＣＤ３
     MOVE     DEN-F10       TO   HEN-A10.
*    取引先管理ＣＤ４
     MOVE     DEN-F11       TO   HEN-A11.
*    取引先管理ＣＤ５
     MOVE     DEN-F12       TO   HEN-A12.
*    発注日
     MOVE     DEN-F13       TO   HEN-A13.
*    納期
     MOVE     DEN-F14       TO   HEN-A14.
*    店舗名称
     MOVE     DEN-F15       TO   HEN-A15.
*    特売年月
     MOVE     DEN-F16       TO   HEN-A16.
*    担当営業所区分
     MOVE     DEN-F17       TO   HEN-A17.
*    行番号
     MOVE     DEN-F18       TO   HEN-A18.
*    ＪＡＮＣＤ
     MOVE     DEN-F19       TO   HEN-A19.
*    発注数量
     MOVE     DEN-F20       TO   HEN-A20.
*    原価単価
     MOVE     DEN-F21       TO   HEN-A21.
*    売価単価
     MOVE     DEN-F22       TO   HEN-A22.
*    商品名
     MOVE     DEN-F23       TO   HEN-A23.
     MOVE     DEN-F24       TO   HEN-A24.
*    規格
     MOVE     DEN-F25       TO   HEN-A25.
*    単位
     MOVE     DEN-F26       TO   HEN-A26.
*    消費税額
     MOVE     DEN-F27       TO   HEN-A27.
*    注文品フラグ
     MOVE     DEN-F28       TO   HEN-A28.
*    担当者
     MOVE     DEN-F29       TO   HEN-A29.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
...
*伝票ナンバー
     MOVE        HEN-A01   TO        HEN-F02.
     MOVE        HEN-A01   TO        HEN-F23.
*行_
...
*出荷場所／伝発場所
     MOVE        TBL-F04   TO        HEN-F08
                                     HEN-F09.
*発注日
     MOVE        HEN-A13   TO        HEN-F111.
*納品日
     MOVE        HEN-A14   TO        HEN-F112.
*分類（部門）
...
*売価単価
     MOVE        HEN-A22   TO        HEN-F173.
*原価金額
     COMPUTE     HEN-F181  =     HEN-A20    *    HEN-A21.
*売価金額
     COMPUTE     HEN-F182  =     HEN-A20    *    HEN-A22.
*店舗名（備考）
...
*    ルート条件マスタ検索
     ...
     MOVE     HEN-A07      TO        RUT-F03  HEN-F42.
     READ     JHMRUTL1
         INVALID
           MOVE  1         TO        INV-RUT
           MOVE  TOK-F81   TO        HEN-F48
...
*修正売価単価
     MOVE        HEN-A22   TO        HEN-F513.
*修正原価金額
     COMPUTE     HEN-F521  =     HEN-A20    *    HEN-A21.
*修正売価金額
     COMPUTE     HEN-F522  =     HEN-A20    *    HEN-A22.
*
 TENSO-EXIT.
     EXIT.
****************************************************************
