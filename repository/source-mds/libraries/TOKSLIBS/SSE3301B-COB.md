...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSE3301B.COB`
...
*
 ...
 FILE-CONTROL.
*----<< 請求合計ファイル>>-*
     SELECT   SEIGKF    ASSIGN         DA-01-VI-SETGKFA2
...
**** SELECT   CVCSF     ASSIGN         DA-01-S-CVCSF
     SELECT   CVCSF     ASSIGN         DA-01-S-SEIDYAMA
...
*----<< 配信データ >>--*
 ...
 01  ONL1-REC.
         ...
         05  ONL1-A07             PIC  9(08).       *>伝票日付
         05  ONL1-FIL             PIC  X(16).       *>空白
***
*
*----<< プリンタ >>-*
...
*----<< ワークファイル >>--*
 SEIGKF-ERR              SECTION.
     ...
     DISPLAY  "### SSE3301B SEIGKF ERROR " SEI-ST  " "
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSE3301B HTOKMS ERROR " TOK-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
*----<< 配信データ >>--*
 CVCSKHAI-ERR           SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSE3301B CVCSF    ERROR " CVCS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
...
*    伝票データ出力
     ...
     INITIALIZE                   ONL1-REC.
     MOVE     SEI-F01        TO   ONL1-A01.
     MOVE     SEI-F03        TO   ONL1-A02.
     MOVE     SEI-F05(3:7)   TO   ONL1-A03.
     EVALUATE   SEI-F07
          WHEN  40
              MOVE      50        TO   ONL1-A04
          WHEN  41
...
*
     ...
     CALL    "SKYDTCKB"   USING   LINK-IN-KBN
                                  ...
                                  LINK-OUT-RET
                                  LINK-OUT-YMD.
     MOVE     LINK-OUT-YMD   TO   ONL1-A07.
     MOVE     LINK-OUT-YMD   TO   WK-NENYMD.
     MOVE     WK-NENGETU     TO   ONL1-A06.
     MOVE     SEI-F06        TO   ONL1-A05.
     MOVE  "0000000000000000"    TO   ONL1-FIL.
*
     ADD      1              TO   KEI-KEN.
