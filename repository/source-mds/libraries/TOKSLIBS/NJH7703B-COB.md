...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH7703B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH7703B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH7703B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    空白
     MOVE     WK-DEPB22(1:6)  TO      HEN-A221.
     MOVE     WK-DEPB22(7:7)  TO      HEN-A222.
     MOVE     WK-DEPB22(14:3) TO      HEN-A223.
*伝票明細転送
*    レコード区分
...
*    商品ＣＤ
     MOVE     WK-DEPD07     TO        HEN-A29(1:8).
*    予備
     MOVE     WK-DEPD08     TO        HEN-A29(9:5).
*    発注数量
