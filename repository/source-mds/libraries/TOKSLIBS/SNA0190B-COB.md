...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SNA0190B.COB`
...
*　日付論理チェック
 ...
 01  HEAD01.
     03  FILLER  PIC  X(08)  VALUE "SNA0190B".
 ...
 01  MEISAI01  CHARACTER TYPE IS PIT-2-2W2H.
     ...
     03  FILLER  PIC  N(06)  VALUE NC"　取込依頼　".
...
****************************************************************
 INIT-SEC              SECTION.
     ...
     DISPLAY   "**  START SNA0190B  **"  UPON CONS.
...
*ファイル ＣＬＯＳＥ
     ...
     CLOSE  HTANMS.
     CLOSE  PRTFILE.
     DISPLAY   "**  END   SNA0190B  **"  UPON CONS.

 END-EXIT.
     EXIT.
*****************<<  SNA0190B   END PROGRAM  >>******************
