...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8321I.COB`
...
*----<< 表示ファイル >>--*
     SELECT   DSPFILE   ASSIGN         01-GS-DSPF
                        ...
                        STATUS         DSP-ST.
*----<< ホーマック基本情報データ >>--*
     SELECT   HCJOHOF   ASSIGN         DA-01-VI-HCJOHOL2
...
*
 ...
 01  WK-HOK             PIC  9(08)  VALUE  ZERO.
 01  WK-TOH             PIC  9(08)  VALUE  ZERO.
 01  WK-KAN             PIC  9(08)  VALUE  ZERO.
*----<< ﾃﾞｨｽﾌﾟﾚｲ ｺﾝﾄﾛｰﾙ ｴﾘｱ >>-*
 01  GR-NO              PIC  9(02).
 01  WK-GRP             PIC  X(08).
 01  DSP-CNTL.
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SSY8321I DSPFILE ERROR " DSP-CNTL " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
     CLOSE    HCJOHOF   HTOKMS    ZSOKMS1    DSPFILE.
     STOP     RUN.
*----<< 伝票データ >>--*
 HCJOHOF-ERR            SECTION.
     USE AFTER     EXCEPTION PROCEDURE      HCJOHOF.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY8321I HCJOHOF ERROR " HCJOHOF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY8321I HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY8321I ZSOKMS1 ERROR " ZSOKMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*ﾁｪｯｸ取引先CDｾｯﾄ
     IF      PARA-KBN = "1"
             ...
             MOVE  880    TO  WK-KAN
     ELSE
             MOVE  14273  TO  WK-HOK
             MOVE  14272  TO  WK-TOH
             MOVE  1427   TO  WK-KAN
     END-IF.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FSY83011.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "SSY8321I"      TO   PGID.
     MOVE    "FSY83011"      TO   FORM.
...
*********MOVE    ZERO        TO   TORICD
         ...
         MOVE     "R"   TO   EDIT-OPTION OF TORICD
     ELSE
         IF   TORICD  =  WK-HOK OR WK-TOH OR WK-KAN
              CONTINUE
         ELSE
              IF   ERR-FLG   =    ZERO
                   IF  PARA-KBN  = "1"
...
*    売上伝票データ存在チェック
     IF  ERR-FLG        =    ZERO
         ...
         INITIALIZE                    HCJ-REC
         MOVE      JDATE          TO   HCJ-K01
         MOVE      JTIME          TO   HCJ-K02
         MOVE      TORICD         TO   HCJ-K03
         MOVE      WK-SOKCD       TO   HCJ-K04
         MOVE      NOUDT          TO   HCJ-K08
