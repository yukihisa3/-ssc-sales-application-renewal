...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH7401B.COB`
...
*ヘッダーレコード退避ワーク
 01  WK-DEPA-REC.
     ...
     03  WK-DEPA10          PIC  9(03).
     03  WK-DEPA11          PIC  9(08).
     03  WK-DEPA12          PIC  9(04).
     03  WK-DEPA13          PIC  9(02).
     03  WK-DEPA14          PIC  X(15).
     03  WK-DEPA15          PIC  X(16).
     03  WK-DEPA16          PIC  X(24).
     03  WK-DEPA17-1        PIC  9(01).
     03  WK-DEPA17-2        PIC  9(01).
     03  WK-DEPA17-3        PIC  9(01).
     03  WK-DEPA17-4        PIC  X(05).
*明細レコード退避ワーク
 01  WK-DEPB-REC.
     03  WK-DEPB01          PIC  X(02).
     03  WK-DEPB02          PIC  X(10).
     03  WK-DEPB03          PIC  X(25).
     03  WK-DEPB04          PIC  9(13).
     03  WK-DEPB05          PIC  9(05).
     03  WK-DEPB06          PIC  9(02).
     03  WK-DEPB07          PIC  X(03).
     03  WK-DEPB08          PIC  9(05)V9.
     03  WK-DEPB09          PIC  9(06)V99.
     03  WK-DEPB10          PIC  9(06).
     03  WK-DEPB11          PIC  9(09).
     03  WK-DEPB12          PIC  9(09).
     03  WK-DEPB13          PIC  X(13).
     03  WK-DEPB14-1        PIC  9(05)V9.
     03  WK-DEPB14-2        PIC  X(11).
*
 01  WK-AREA.
*システム日付の編集
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH7401B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH7401B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    納品ルート
     MOVE     WK-DEPA17-1   TO        HEN-A17-1.
*    直送区分
     MOVE     WK-DEPA17-2   TO        HEN-A17-2.
*    ｾﾝﾀｰ区分
     MOVE     WK-DEPA17-3   TO        HEN-A17-3.
*    ダミー
     MOVE     WK-DEPA17-4   TO        HEN-A17-4.
*伝票明細転送
*    フォーマットＩＤ
     MOVE     WK-DEPB01     TO        HEN-A18.
*    ダミー
     MOVE     WK-DEPB02     TO        HEN-A19.
*    商品名
     MOVE     WK-DEPB03     TO        HEN-A20.
*    商品コード
     MOVE     WK-DEPB04     TO        HEN-A21.
*    入数
     MOVE     WK-DEPB05     TO        HEN-A22.
*    発注ケース数
     MOVE     WK-DEPB06     TO        HEN-A23.
*    単位
     MOVE     WK-DEPB07     TO        HEN-A24.
*    発注数
     MOVE     WK-DEPB08     TO        HEN-A25.
*    原単価
     MOVE     WK-DEPB09     TO        HEN-A26.
*    売単価
     MOVE     WK-DEPB10     TO        HEN-A27.
*    原価金額
     MOVE     WK-DEPB11     TO        HEN-A28.
*    売価金額
     MOVE     WK-DEPB12     TO        HEN-A29.
*    ＪＡＮコード
     MOVE     WK-DEPB13     TO        HEN-A30.
*    納品数量
     MOVE     WK-DEPB14-1   TO        HEN-A31-1.
*    ダミー
     MOVE     WK-DEPB14-2   TO        HEN-A31-2.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
...
*取引先コード
     MOVE    HEN-A03             TO        HEN-F01
                                           WK-TOKCD.
*伝票ナンバー
     MOVE    HEN-A11             TO        HEN-F02
                                           HEN-F23.
*行番号
     MOVE    HEN-A18(2:1)        TO        HEN-F03.
*伝区
     MOVE        40              TO        HEN-F051.
...
*    商品名称マスタ検索
     ...
     READ    MEIMS1
       INVALID
*        商品名
         MOVE    HEN-A20(1:15)   TO   HEN-F1421
         MOVE    HEN-A20(16:10)  TO   HEN-F1422
       NOT INVALID
         MOVE    HEN-A20(1:15)   TO   HEN-F1421
         MOVE    HEN-A20(16:10)  TO   HEN-F1422
     END-READ.
...
*    MOVE     HEN-A03            TO        RUT-F03.
     MOVE     HEN-A17-1          TO        RUT-F03.
     READ     JHMRUTL1
         INVALID
           MOVE  1               TO        INV-RUT
