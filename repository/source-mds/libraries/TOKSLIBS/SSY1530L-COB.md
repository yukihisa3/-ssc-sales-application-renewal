...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY1530L.COB`
...
********************************************************
 FD  PRTFILE.
     COPY    FSY15302  OF        XMDLIB
             JOINING   PRT  AS   PREFIX.
********************************************************
*    表示ファイル                                      *
********************************************************
 FD  DSPFILE.
     COPY    FSY15301   OF        XMDLIB
...
***********************************************************
 DSP-INIT-SEC               SECTION.
     CLOSE   PRTFILE.
     OPEN    OUTPUT      PRTFILE.
     MOVE    SPACE               TO  DSP-FSY15301.
     INITIALIZE  FORM-PARA.
     MOVE   "FSY15301"            TO  DSP-FORM.
