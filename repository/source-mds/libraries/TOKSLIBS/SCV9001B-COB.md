...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SCV9001B.COB`
...
*取引先ＣＤ
 01  WK-TORIHIKICD.
     03  WK-TORICD                PIC  9(08)  VALUE  168201.
*ファイルエラーメッセージ
 01  FILE-ERR.
