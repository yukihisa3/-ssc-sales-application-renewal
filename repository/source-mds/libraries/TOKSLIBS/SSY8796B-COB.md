...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8796B.COB`
...
*
 ...
 FILE-CONTROL.
*---<<  出荷情報データ  >>---*
     SELECT   DJJOHOF   ASSIGN         DA-01-VI-DJJOHOL1
...
*----<< 出荷情報データ >>--*
 KMS-ERR              SECTION.
     ...
     DISPLAY  "### SSY8796B DJJOHOF    ERROR " KMS-ST " "
...
*----<< 条件ファイル >>--*
 JYO-ERR              SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     "4000"         TO   PROGRAM-STATUS.
     DISPLAY  "### SSY8796B HJYOKEN    ERROR " JYO-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
