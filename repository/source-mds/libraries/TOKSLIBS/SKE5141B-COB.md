...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SKE5141B.COB`
...
*----<< ﾌﾟﾛｸﾞﾗﾑID  >>--*
 01  PG-ID.
     03  ID-PG          PIC  X(08)     VALUE  "SKE5141B".
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
...
*件数Ｆ出力
     ...
     INITIALIZE                        SYK-REC.
*
     MOVE      READ-CNT           TO   SYK-F01.
     MOVE      X"0D0A"            TO   SYK-F02.
*
     WRITE     SYK-REC.
*ファイルのクローズ
     CLOSE     KNPSYOF  KNPSYKF.
*
 300-END-RTN-EXIT.
     EXIT.
*--------------------------------------------------------------*
