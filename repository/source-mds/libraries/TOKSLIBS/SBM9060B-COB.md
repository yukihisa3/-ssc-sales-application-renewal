...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SBM9060B.COB`
...
*
*出荷メッセージファイル
     SELECT  BMSSYKF  ASSIGN TO    DA-01-VI-BMSSYKL1
...
****************************************************************
 INIT-SEC              SECTION.
*
     DISPLAY  "***  START SBM9060B  ***"   UPON  CONS.
...
*
     ...
     ELSE
         MOVE     PARA-SOUJYUSIN      TO   SYK-F011
     END-IF.
*
*
 INSTART-300.
...
**
 ...
 MAIN-220.
     IF  SYK-F011     =  PARA-SOUJYUSIN
         ...
         GO  TO    MAIN-900
     END-IF.
     IF  SYK-F011   NOT =  PARA-SOUJYUSIN
         MOVE  "1"     TO   END-FLG
         GO  TO    MAIN-EXIT
     END-IF.
*
...
*ファイルのCLOSE処理
     CLOSE     BMSSYKF.
     DISPLAY  "***  END   SBM9060B  ***"   UPON  CONS.
*
 END-EXIT.
     EXIT.
*
