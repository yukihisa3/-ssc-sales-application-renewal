...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SBT0190B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SBT0190B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SBT0190B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-IN.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*入荷区分
     MOVE     "02"                TO   NYU-F01.
*入荷日
     MOVE     SG3-F05             TO   NYU-F02.
*伝票番号　　
     MOVE     SG3-F01             TO   NYU-F03.
*入荷元コード
     MOVE     SG3-F04             TO   NYU-F04.
*品名コード
     IF       MEI-F06   =         SPACE
              GO        TO        MAIN-L3-99
     END-IF.
...
*入荷区分
     MOVE     "02"                TO   NYU-F01.
*入荷日
     MOVE     SG4-F05             TO   NYU-F02.
*伝票番号　　
     MOVE     SG4-F01             TO   NYU-F03.
*入荷元コード
     MOVE     SG4-F04             TO   NYU-F04.
*品名コード
     MOVE     MEI-F06             TO   NYU-F05.
*
*数量
