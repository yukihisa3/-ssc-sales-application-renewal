...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY0602L.COB`
...
*    更新日／更新者　　　：　2016/06/30 NAV TAKAHASHI          *
*　　　　　　　　　　　　　　担当者情報取得方法変更            *
****************************************************************
****************************************************************
...
*2008/07/31)NAV 後閑
         05  FILLER     PIC  X(04)     VALUE  SPACE.
         05  FILLER     PIC  N(03)     VALUE  NC"担当者".
*2008/07/31)NAV 後閑
 01  HEAD03.
     03  FILLER         CHARACTER TYPE MODE-2.
         05  FILLER     PIC  X(01)     VALUE  SPACE.
 ...
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SSY0602L DSPFILE ERROR " DSP-CNTL " "
              ...
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
*2008/07/31)NAV 後閑 BGN
*    CLOSE    SHTRYTF   HTOKMS    HSHOTBL   DSPFILE.
     CLOSE    SHTRYTF   HTOKMS    HSHOTBL    HTANMS   DSPFILE.
*2008/07/31)NAV 後閑 END
     STOP     RUN.
*----<< 量販データ >>--*
 SHTRYTF-ERR            SECTION.
...
*----<< 担当者マスタ >>--*
 HTANMS-ERR             SECTION.
     ...
     ACCEPT   WK-DATE        FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY0602L HTOKMS ERROR " HTANMS-ST " "
              WK-Y "." WK-M "." WK-D " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     CLOSE    SHTRYTF   HTOKMS    HSHOTBL    HTANMS   DSPFILE.
...
*\\  93.06.30 END    \\
*2008/07/29)NAV 後閑 BGN
     MOVE     TAN-BMN             TO   TAN-F01.
*#2016/06/30 NAV ST 担当者情報取得方法変更
*****MOVE     RYO-F03             TO   TAN-F02.
*****MOVE     RYO-F80(1:2)        TO   TAN-F02.
*****DISPLAY "#ﾀﾝﾄｳｼｬCD = " TAN-F02 " #" UPON CONS.
     IF       RYO-F80(1:2)  NOT =  SPACE
              MOVE  RYO-F80(1:2)  TO   TAN-F02
     ELSE
              MOVE  RYO-F03       TO   TAN-F02
     END-IF.
...
*****MOVE     RYO-F03             TO   ME-101.
*#2016/06/30 NAV ST 担当者情報取得方法変更
*****MOVE     RYO-F80(1:2)        TO   ME-101.
     IF       RYO-F80(1:2)  NOT =  SPACE
              MOVE  RYO-F80(1:2)  TO   ME-101
     ELSE
              MOVE  RYO-F03       TO   ME-101
