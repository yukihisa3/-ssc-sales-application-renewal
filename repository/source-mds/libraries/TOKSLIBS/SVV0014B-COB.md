...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SVV0014B.COB`
...
****<< 商品変換テーブルＣＳＶ >>******************************
     SELECT   SVVTBL3    ASSIGN  TO   DA-01-S-SVVTBL3
                        ACCESS  MODE         IS   SEQUENTIAL
...
****  カウンタ                ****
 ...
 01  SVVTBL3-CNT              PIC  9(8)   VALUE  ZERO.
****  フラグ                  ****
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SVV0014B".
...
*カンマセット
     MOVE     ","           TO      CSV-A01  CSV-A02  CSV-A03
                                    ...
                                    CSV-A10  CSV-A11  CSV-A14
                                    CSV-A15.
     MOVE     X"28"         TO      CSV-A12(2:1).
     MOVE     ","           TO      CSV-A12(1:1).
     MOVE     X"29"         TO      CSV-A13(1:1).
     MOVE     ","           TO      CSV-A13(2:1).
*カウントアップ
     ADD       1            TO      SVVTBL3-CNT.
*取引先コード
...
*****MOVE      TBL-F09      TO      CSV-F10.
     ...
     MOVE      "."          TO      HENKAN1-DATA2.
     MOVE      HENKAN1-2    TO      HENKAN1-DATA3.
     MOVE      HENKAN1-DATA TO      CSV-F10.
*在庫期間
*****MOVE      TBL-F10      TO      CSV-F11.
*登録日
     MOVE      TBL-F98      TO      CSV-F11.
*更新日
     MOVE      TBL-F99      TO      CSV-F12.
*商品名称マスタ検索
     ...
     READ    HMEIMS
       INVALID
*        商品名
         MOVE ALL NC"＊"   TO       CSV-F13
       NOT INVALID
         MOVE    MEI-F021  TO       WK-KANJI1
         MOVE    MEI-F022  TO       WK-KANJI2
         MOVE    WK-KANJI  TO       CSV-F13
     END-READ.
*検品Ｇ
     MOVE      TBL-F11      TO      CSV-F14.
*入数
     MOVE      MEI-F07      TO      CSV-F15.
*レコード出力
     WRITE     CSV-REC.
...
************************************************************
 END-SEC                SECTION.
     CLOSE    DSPF   SVVTBL3  HSHOTBL  HMEIMS.

     IF    HSHOTBL-CNT NOT = ZERO
     DISPLAY  " HSHOTBL-READ-CNT = " HSHOTBL-CNT UPON CONS
     DISPLAY  " SVVTBL3-WRITE-CNT = " SVVTBL3-CNT UPON CONS
     END-IF.
 END-END.
     EXIT.
*****************<<  PROGRAM  END  >>***********************
