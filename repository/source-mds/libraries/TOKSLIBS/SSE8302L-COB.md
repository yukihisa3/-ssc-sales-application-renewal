...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSE8302L.COB`
...
*----<< ﾌｱｲﾙ ｽﾃｰﾀｽ >>--*
     ...
     03  PRT-ST         PIC  X(02).
*
 01  PG-ID             PIC  X(08)      VALUE  "SSE8302L".
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
...
*--------------------------------------------------------------*
 ...
 HACKENDTERR                 SECTION.
     ...
     DISPLAY  "### SSE8302L HACKENDT ERROR " KEN-ST " "
 ...
 PRTERR                 SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSE8302L PRTFILE ERROR " PRT-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
...
*
     EVALUATE  KEN-F02
         WHEN  883  WHEN  14273
         MOVE NC"北海道事業部"  TO  DT1-01
         WHEN  882  WHEN  14272
         MOVE NC"東北事業部"    TO  DT1-01
         WHEN  880  WHEN  1427
         MOVE NC"関東事業部"    TO  DT1-01
     END-EVALUATE.
*
