...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SVV0013B.COB`
...
****<< 商品変換テーブルＣＳＶ >>******************************
     SELECT   SVVTBL2    ASSIGN  TO   DA-01-S-SVVTBL2
                        ACCESS  MODE         IS   SEQUENTIAL
...
****  カウンタ                ****
 ...
 01  SVVTBL2-CNT              PIC  9(8)   VALUE  ZERO.
****  フラグ                  ****
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SVV0012B".
...
************************************************************
 END-SEC                SECTION.
     CLOSE    DSPF   SVVTBL2  HSHOTBL  HMEIMS.

     IF    HSHOTBL-CNT NOT = ZERO
     DISPLAY  " HSHOTBL-READ-CNT = " HSHOTBL-CNT UPON CONS
     DISPLAY  " SVVTBL2-WRITE-CNT = " SVVTBL2-CNT UPON CONS
     END-IF.
 END-END.
     EXIT.
*****************<<  PROGRAM  END  >>***********************
