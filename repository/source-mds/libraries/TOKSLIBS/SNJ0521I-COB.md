...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SNJ0521I.COB`
...
*初期画面の表示
     MOVE    SPACE                TO   DSP-PRO.
*画面の初期化
     MOVE    SPACE                TO   DSP-FNJ0521I.
*フォームＩＤ転送
     MOVE   "FNJO521I"            TO   DSP-FORMID.
*PGID転送
     MOVE   "SNJ0521I"            TO   DSP-PGMID.
*システム日付転送
...
*取引先選択入力チェック（画面表示範囲のＮＯチェック）
     IF       DSP-JSNDCD = 01  OR  02  OR  03  OR  07 OR  08
*** 2012/10/31
                       OR  09
              CONTINUE
     ELSE
...
*受信ＤＴ区分名称の表示
     EVALUATE DSP-JSNDCD
         WHEN 01 MOVE NC"『　発　注　』" TO   DSP-JSNDNM
         WHEN 02 MOVE NC"『　受　領　』" TO   DSP-JSNDNM
         WHEN 03 MOVE NC"『　支　払　』" TO   DSP-JSNDNM
         WHEN 07 MOVE NC"『　商　台　』" TO   DSP-JSNDNM
         WHEN 08 MOVE NC"『その他受信』" TO   DSP-JSNDNM
*** 2012/10/31
...
*自動受信処理監視　開始
     CALL    "SNJ0510B"   USING   WK-JYU-DTKBN
                                  WK-JYU-TOKCD
                                  LINK-JYUKBN.
*処理終了へ
     MOVE    "END"         TO         END-FLG.
...
*マスタ読込み
     ...
     END-READ.
*受信対象の取引先のみ有効
     IF      EDI-F01  =   "01" OR "02" OR "03" OR "07" OR "08"
*** 2012/11/01
                        OR  "09"
             CONTINUE
     ELSE
