...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/STE1403B.COB`
...
*    ﾐﾀﾞｼ
 01  HEAD-00.
     ...
     03  HD001                    PIC  X(07) VALUE "KK.ﾄﾞｲﾄ".
*
...
*
 01  BODY-03   CHARACTER          TYPE IS        YA.
     03  FILLER                   PIC  X(02)     VALUE   SPACE.
     03  MS08                     PIC  N(07).
*
*    ｺﾞｳｹｲ
...
*    発注日
     ...
     COMPUTE  WK-F111  = WK-F111 - 19880000.
     MOVE     WK-F111            TO    HD07.
*    納品日
     MOVE     KYO-F112           TO    WK-F112.
     COMPUTE  WK-F112  = WK-F112 - 19880000.
     MOVE     WK-F112            TO    HD08.
*
...
****************************************************************
 TAIL-WT-SEC            SECTION.
*    テイル部初期化
     INITIALIZE                  BODY-03 TAIL-01 TAIL-02 TAIL-03.
*    数量合計
...
*    明細が６行以内の場合、”以下余白”を印字
     IF  L-CNT < 23
         MOVE     SPACE                TO   MS08
         MOVE     NC"以　下　余　白"   TO   MS08
         WRITE    PRT-REC              FROM BODY-03   AFTER   2
         ADD      2                    TO   L-CNT
     END-IF.
*    テイル印字制御
