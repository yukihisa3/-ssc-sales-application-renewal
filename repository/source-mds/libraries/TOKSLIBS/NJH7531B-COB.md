...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH7531B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH7531B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH7531B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*計上取引先判定
     IF  HTENMS-INV-FLG = SPACE
         IF      TEN-F73 = SPACE
                 MOVE     26491  TO        SWW-F02
         ELSE
                 MOVE     264911 TO        SWW-F02
         END-IF
     ELSE
         MOVE     26491          TO        SWW-F02
     END-IF.
