...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SKY2199B.COB`
...
*                            並び順のファイルを読み、伝票発行  *
*                            用Ｆへ出力する。                  *
*    変更履歴            : 各ソート順処理に店舗範囲指定を追加*
*    更新日／更新者　　　: 12/03/23  MIURA                   *
****************************************************************
 IDENTIFICATION         DIVISION.
*
 PROGRAM-ID.            SKY2199B.
 AUTHOR.                NAV M.YOSHIDA.
 DATE-WRITTEN.          11/12/01.
*
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SKY2199B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SKY2199B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
