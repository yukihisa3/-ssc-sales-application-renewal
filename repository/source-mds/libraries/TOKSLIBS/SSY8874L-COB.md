...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSY8874L.COB`
...
*    メッセージ　エリア
 01  MSG-AREA.
     03  MSG-ABEND1.
         ...
         05  ERR-PG-ID            PIC  X(08)  VALUE  "SSY8874L".
...
*
     EVALUATE WK-HACKBN
         WHEN "1"   MOVE NC"定期"           TO   PRT-KBN
         WHEN "2"   MOVE NC"特売"           TO   PRT-KBN
         WHEN "3"   MOVE NC"投入"           TO   PRT-KBN
         WHEN "4"   MOVE NC"新店改装"       TO   PRT-KBN
         WHEN "6"   MOVE NC"緊急ダイレクト" TO   PRT-KBN
*#2019/02/21 NAV ST
         WHEN "F"   MOVE NC"客注ダイレクト" TO   PRT-KBN
         WHEN "A"   MOVE NC"本部在庫補充"   TO   PRT-KBN
         WHEN "B"   MOVE NC"専用_在庫補充" TO   PRT-KBN
         WHEN "C"   MOVE NC"用度品　　　　" TO   PRT-KBN
         WHEN "D"   MOVE NC"改廃　　　　　" TO   PRT-KBN
         WHEN "E"   MOVE NC"ＢＹ改廃　　　" TO   PRT-KBN
*#2019/02/21 NAV ED
...
**09/02/23 STR
     EVALUATE     DKC-F07
         ...
         WHEN    003
         MOVE NC"用土・肥料・薬品"         TO   PRT-BUMONM(TATE)
         WHEN    004
         MOVE NC"植物"                     TO   PRT-BUMONM(TATE)
         WHEN    005
         MOVE NC"エクステリア・屋外資材"   TO   PRT-BUMONM(TATE)
         WHEN    006
         ...
         WHEN    025
         MOVE NC"冷暖房・住宅設備"         TO   PRT-BUMONM(TATE)
         WHEN    026
