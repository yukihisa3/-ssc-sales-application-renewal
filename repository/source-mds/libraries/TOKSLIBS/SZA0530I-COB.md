...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SZA0530I.COB`
...
*    作成日／更新日　　　：　2005/12/26                        *
*    作成者／更新者　　　：　ＮＡＶ松野                        *
*    処理概要　　　　　　：　画面より、日次受注残再計算処理　  *
*                            の指示・確認を行う。　　　        *
****************************************************************
 IDENTIFICATION                      DIVISION.
 PROGRAM-ID.               SZA0530I.
 AUTHOR.                   NAV.
 DATE-WRITTEN.             05/12/26.
...
***********************************************************
 DSP-INT-SEC               SECTION.
     MOVE        SPACE     TO        FZA05301.
     MOVE       "SCREEN"   TO        DSP-GRP.
     MOVE       "FZA05301" TO        DSP-FORM.
     MOVE       "CL"       TO        DSP-PROC.
