...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SSI3304B.COB`
...
*--------------------------------------------------------------*
*----<< ﾌﾟﾛｸﾞﾗﾑID >>--*
 01  PG-ID              PIC  X(08)     VALUE  "SSI3304B".
*----<< ﾌﾗｸﾞｴﾘｱ >>--*
...
*----<< 伝票_変換（９桁用） >>--*
 ...
 01  WK-DENNO-R         REDEFINES     WK-DENNO.
     03  HEN-DENNO-9    PIC  9(01).
     03  HEN-DENNO      PIC  9(08).
*
 LINKAGE                SECTION.
...
*----<< 支払合計ファイル >>--*
 SYO-ERR                SECTION.
     ...
     DISPLAY  "### " PG-ID " SSIHARADF ERROR " SSI-ST " "
...
*
     ...
     MOVE     SSI-F03        TO   HEN-DENNO.
     MOVE     0              TO   HEN-DENNO-9.
     MOVE     WK-DENNO      TO   SEI-F05.
...
*ファイルのクローズ
     ...
     CLOSE    HSEIGKF.
*削除件数表示
     DISPLAY "ｼｮﾘ   ｹﾝｽｳ = " IN-CNT UPON CONS.
