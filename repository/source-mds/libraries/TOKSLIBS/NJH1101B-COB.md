...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH1101B.COB`
...
*データ情報退避ワーク
 01  WK-DEPB-REC.
     ...
     03  WK-DEPB04.
       05  WK-DEPB041       PIC  9(04).
       05  WK-DEPB042       PIC  9(05).
     03  WK-DEPB05          PIC  X(04).
     03  WK-DEPB06          PIC  X(02).
     03  WK-DEPB07          PIC  9(06).
     03  WK-DEPB08          PIC  9(06).
     03  WK-DEPB09.
       05  WK-DEPB091       PIC  9(06).
       05  WK-DEPB092       PIC  9(02).
     03  WK-DEPB10          PIC  X.
     03  WK-DEPB11          PIC  X.
     03  WK-DEPB12          PIC  X.
     03  WK-DEPB13          PIC  X(16).
...
*    ヘッドレコード退避ワーク
 01  WK-DEPC-REC.
     ...
     03  WK-DEPC05          PIC  X(30).
     03  WK-DEPC06          PIC  X(12).
     03  FILLER             PIC  X(32).
     03  WK-DEPC07          PIC  X(01).
*
*    明細レコード退避ワーク
 01  WK-DEPD-REC.
     03  WK-DEPD01          PIC  X.
     ...
     03  WK-DEPD05          PIC  X(04).
     03  WK-DEPD06          PIC  X(04).
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH1101B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH1101B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    伝票メッセージ欄
     MOVE     WK-DEPB13     TO        HEN-A12A.
*    ルート区分
     IF       WK-DEPB11     =         SPACE
              MOVE     "*"            TO    HEN-A12B
         ELSE
              MOVE      WK-DEPB11     TO    HEN-A12B.
*    商品区分名称
     MOVE     WK-DEPB14     TO        HEN-A20.
*    レコード区分
     MOVE     WK-DEPC01     TO        HEN-A13.
*    データ種別
     MOVE     WK-DEPC02     TO        HEN-A14.
*    発注企業名
     MOVE     WK-DEPC03     TO        HEN-A15.
*    店舗名
     MOVE     WK-DEPC04     TO        HEN-A16.
*    取引先名
     MOVE     WK-DEPC05     TO        HEN-A17.
*    電話番号
     MOVE     WK-DEPC06     TO        HEN-A18.
*    レコード区分
...
*    規格
     MOVE     WK-DEPD15     TO        HEN-A351.
*    サイズ
     MOVE     WK-DEPD16     TO        HEN-A352.
*
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
...
*        商品名
         ...
         MOVE    HEN-A34(16:13) TO   HEN-F1422
       NOT INVALID
         MOVE    HEN-A34(1:15)  TO   HEN-F1421
         MOVE    HEN-A34(16:13) TO   HEN-F1422
     END-READ.
...
*単
     MOVE       "1"        TO        HEN-F16.
*原価単価
     MOVE        HEN-A29   TO        HEN-F172.
*売価単価
     MOVE        HEN-A30   TO        HEN-F173.
*原価金額
     MOVE        HEN-A31   TO        HEN-F181.
*売価金額
...
*修正原価単価
     MOVE        HEN-A29   TO        HEN-F512.
*修正売価単価
     MOVE        HEN-A30   TO        HEN-F513.
*修正原価金額
     MOVE        HEN-A31   TO        HEN-F521.
*修正売価金額
     MOVE        HEN-A32   TO        HEN-F522.
*
 TENSO-EXIT.
     EXIT.
****************************************************************
