...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/SJH7398B.COB`
...
*    サブシステム　　　　：　出荷管理　　　　　　　　　　　　　*
*    業務名　　　　　　　：　ベンダーオンライン　　　　　　　　*
*    モジュール名　　　　：　情報ファイル再送リカバリ処理　　　*
*    作成日／更新日　　　：　2010/08/19                        *
*    作成者／更新者　　　：　NAV                               *
*    処理概要　　　　　　：　指定されたバッチ番号の送信ＦＬＧ　*
*                            を解除する。　　　　　　　　　　　*
****************************************************************
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJH7398B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJH7398B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*
     ...
     START    DYJOHOF   KEY  >=   JOH-F01   JOH-F02
                                  JOH-F03   JOH-F04
                                  JOH-F08   JOH-F05
                                  JOH-F06   JOH-F07
         INVALID   KEY
