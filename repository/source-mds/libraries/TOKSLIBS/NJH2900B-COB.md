...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKSLIBS/NJH2900B.COB`
...
*    メッセージ　エリア
 ...
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  FILLER               PIC X(08) VALUE "VDA2010B".
     ...
     03  MSG-ABEND1.
         05  FILLER               PIC X(04) VALUE "### ".
         05  ERR-PG-ID            PIC X(08) VALUE "VDA2010B".
...
*
     ...
     DISPLAY NC"発伝件数　＝　"  WK-CNT2  UPON  CONS.
