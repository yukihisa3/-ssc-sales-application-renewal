...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/CSV2000I.COB`
...
******************************************************************
 PROCEDURE   DIVISION
             USING  BATNO  SOKOCD
                    PARA-HIDUKE PARA-JIKAN PARA-TOKCD PARA-OUTKBN.
******************************************************************
 DECLARATIVES.
 DEN-ERR                   SECTION.
...
*実行
         WHEN   "E000"
                ...
                MOVE    DSP-OUTKBN    TO   PARA-OUTKBN
                MOVE    "END"         TO   END-FLG
*終了
         WHEN   "F005"
                MOVE    "END"    TO   END-FLG
