...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/STE1201H.COB`
...
*         PG-NAME･･･手書き伝票行（コーナン東日本分）
*         PG-ID･･･STE1201H
*    更新履歴            ：
*      1993/05/24 小数以下＝０はＳＰＡＣＥで印字
*      2011/10/05 飯田/NAV 基幹サーバ統合
****************************************************************
 IDENTIFICATION         DIVISION.
 PROGRAM-ID.            STE1201H.
 AUTHOR.                Y.Y.
 DATE-WRITTEN.          92/11/24.
******************************************************************
...
*プリンター
 FD  PRTF
     ...
     COPY        FTE12011    OF        XMDLIB.
*表示ファイル
 FD  DSPF
     LABEL       RECORD    IS        OMITTED.
     COPY        FTE12012     OF        XMDLIB.
******************************************************************
...
**********************************************************
 END-SEC                   SECTION.
     ...
     END-IF.
*****CLOSE       HTENMS    HTOKMS   HDENJNL   HJYOKEN   PRTF.
...
*****MOVE        DEN-F051  TO        W011.
     IF          DEN-F132  NOT       NUMERIC
         MOVE    04        TO        W011
     ELSE
         MOVE    DEN-F132  TO        W011
     END-IF.
*## 2009/03/12 表示桁数修正 ST##*
*****MOVE        DEN-F02   TO        W012.
     MOVE DEN-F02(2:8)     TO        W012(2:8).
     MOVE SPACE            TO        W012(1:1).
*## 2009/03/12 表示桁数修正 ST##*
