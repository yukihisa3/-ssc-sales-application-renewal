...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SFU0100N.COB`
...
*2009/10/06 在庫改善／販売実績対応　　　　　　                 *
*2011/04/04 伝区＝７０、仕入＋振替同時発生時の対応　行＞１０以上
*2012/01/23 振替返品出荷場所障害　リコンパイル　　　　　　　　 *
*2014/02/27 振替返品　入出庫区分障害対応　　　　　　　　　　　 *
*2014/10/10 振替返品　他部→ＨＧの場合、入出庫区分障害対応　　 *
*2016/12/23 振替の場合　振替元／先項目に部門ＣＤのみをセットへ *
*           変更　　　　　　　　　　　　　　　　　　　　　　　 *
*2017/03/29 振替の場合　ストック番号を振替更新Ｆにセットする。 *
*2019/08/26 振替返品　他部→ＨＧの場合、入出庫区分障害対応　　 *
****************************************************************
...
**** メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SFU0100N".
...
*判定処理
     EVALUATE   TO0-F02
         WHEN   20
                PERFORM  FURI-20-SEC
         WHEN   70
                IF  TO0-F01 = 2910 OR 2920 OR 2930 OR
                              2940
                    MOVE    "1"   TO     WK-BUMON-1
                ELSE
                    MOVE    "2"   TO     WK-BUMON-1
                END-IF
                IF  TO0-F06(5:4) = 2910 OR 2920 OR
                              2930 OR 2940
...
*振替元／振替先
*****MOVE   TO0-F06          TO   WRK-F06.
     MOVE   TO0-F06(5:4)     TO   WRK-F06(1:4).
*発注日
     MOVE   TO0-F08          TO   WRK-F07.
*納品日
     MOVE   TO0-F09          TO   WRK-F08.
...
*## 2002/03/04 NAV START ## 数量ﾏｲﾅｽ時に区分を反対にする
     ...
     END-IF.
*2010/01/18 行番号を制御
     EVALUATE  TO0-F04  ALSO  WRK-F16
         WHEN  1  ALSO  "1"  MOVE   1   TO   WRK-F04
         WHEN  1  ALSO  "2"  MOVE   2   TO   WRK-F04
         WHEN  2  ALSO  "1"  MOVE   3   TO   WRK-F04
         WHEN  2  ALSO  "2"  MOVE   4   TO   WRK-F04
         WHEN  3  ALSO  "1"  MOVE   5   TO   WRK-F04
         WHEN  3  ALSO  "2"  MOVE   6   TO   WRK-F04
         WHEN  4  ALSO  "1"  MOVE   7   TO   WRK-F04
         WHEN  4  ALSO  "2"  MOVE   8   TO   WRK-F04
         WHEN  5  ALSO  "1"  MOVE   9   TO   WRK-F04
         WHEN  5  ALSO  "2"  MOVE  10   TO   WRK-F04
         WHEN  6  ALSO  "1"  MOVE  11   TO   WRK-F04
         WHEN  6  ALSO  "2"  MOVE  12   TO   WRK-F04
         WHEN  7  ALSO  "1"  MOVE  13   TO   WRK-F04
         WHEN  7  ALSO  "2"  MOVE  14   TO   WRK-F04
         WHEN  8  ALSO  "1"  MOVE  15   TO   WRK-F04
         WHEN  8  ALSO  "2"  MOVE  16   TO   WRK-F04
         WHEN  9  ALSO  "1"  MOVE  17   TO   WRK-F04
         WHEN  9  ALSO  "2"  MOVE  18   TO   WRK-F04
         WHEN 10  ALSO  "1"  MOVE  19   TO   WRK-F04
         WHEN 10  ALSO  "2"  MOVE  20   TO   WRK-F04
*# 2011/04/04 追加 NAV ST #*
         WHEN 20  ALSO  "1"  MOVE  21   TO   WRK-F04
         WHEN 20  ALSO  "2"  MOVE  22   TO   WRK-F04
         WHEN 30  ALSO  "1"  MOVE  23   TO   WRK-F04
         WHEN 30  ALSO  "2"  MOVE  24   TO   WRK-F04
         WHEN 40  ALSO  "1"  MOVE  25   TO   WRK-F04
         WHEN 40  ALSO  "2"  MOVE  26   TO   WRK-F04
         WHEN 50  ALSO  "1"  MOVE  27   TO   WRK-F04
         WHEN 50  ALSO  "2"  MOVE  28   TO   WRK-F04
         WHEN 60  ALSO  "1"  MOVE  29   TO   WRK-F04
         WHEN 60  ALSO  "2"  MOVE  30   TO   WRK-F04
*# 2011/04/04 追加 NAV ED #*
     END-EVALUATE.
*## 2002/03/04 NAV END   ##
*場所
     MOVE   TO0-F18          TO   WRK-F17.
...
*## 2002/03/04 NAV START ## 数量ﾏｲﾅｽ時に区分を反対にする
     ...
     END-IF.
*2010/01/18 行番号を制御
     EVALUATE  TO0-F04  ALSO  WRK1-F16
         WHEN  1  ALSO  "1"  MOVE   1   TO   WRK1-F04
         WHEN  1  ALSO  "2"  MOVE   2   TO   WRK1-F04
         WHEN  2  ALSO  "1"  MOVE   3   TO   WRK1-F04
         WHEN  2  ALSO  "2"  MOVE   4   TO   WRK1-F04
         WHEN  3  ALSO  "1"  MOVE   5   TO   WRK1-F04
         WHEN  3  ALSO  "2"  MOVE   6   TO   WRK1-F04
         WHEN  4  ALSO  "1"  MOVE   7   TO   WRK1-F04
         WHEN  4  ALSO  "2"  MOVE   8   TO   WRK1-F04
         WHEN  5  ALSO  "1"  MOVE   9   TO   WRK1-F04
         WHEN  5  ALSO  "2"  MOVE  10   TO   WRK1-F04
         WHEN  6  ALSO  "1"  MOVE  11   TO   WRK1-F04
         WHEN  6  ALSO  "2"  MOVE  12   TO   WRK1-F04
         WHEN  7  ALSO  "1"  MOVE  13   TO   WRK1-F04
         WHEN  7  ALSO  "2"  MOVE  14   TO   WRK1-F04
         WHEN  8  ALSO  "1"  MOVE  15   TO   WRK1-F04
         WHEN  8  ALSO  "2"  MOVE  16   TO   WRK1-F04
         WHEN  9  ALSO  "1"  MOVE  17   TO   WRK1-F04
         WHEN  9  ALSO  "2"  MOVE  18   TO   WRK1-F04
         WHEN 10  ALSO  "1"  MOVE  19   TO   WRK1-F04
         WHEN 10  ALSO  "2"  MOVE  20   TO   WRK1-F04
*# 2011/04/04 追加 NAV ST #*
         WHEN 20  ALSO  "1"  MOVE  21   TO   WRK1-F04
         WHEN 20  ALSO  "2"  MOVE  22   TO   WRK1-F04
         WHEN 30  ALSO  "1"  MOVE  23   TO   WRK1-F04
         WHEN 30  ALSO  "2"  MOVE  24   TO   WRK1-F04
         WHEN 40  ALSO  "1"  MOVE  25   TO   WRK1-F04
         WHEN 40  ALSO  "2"  MOVE  26   TO   WRK1-F04
         WHEN 50  ALSO  "1"  MOVE  27   TO   WRK1-F04
         WHEN 50  ALSO  "2"  MOVE  28   TO   WRK1-F04
         WHEN 60  ALSO  "1"  MOVE  29   TO   WRK1-F04
         WHEN 60  ALSO  "2"  MOVE  30   TO   WRK1-F04
*# 2011/04/04 追加 NAV ED #*
     END-EVALUATE.
*## 2002/03/04 NAV END   ##
*場所
*****MOVE   TO0-F21          TO   WRK1-F17.
     MOVE   TO0-F21          TO   WRK1-F17.
     MOVE   TO0-F18          TO   WRK1-F22.
*社内発注番号
*****MOVE   TO0-F35          TO   WRK1-F18.
     MOVE   TO0-F23          TO   WRK1-F18.
*完納区分
...
*## 2002/03/04 NAV START ## 数量ﾏｲﾅｽ時に区分を反対にする
     IF     TO0-F15  >=  ZERO
*2014/02/27 MOVE   "1"       TO   WRK-F16
            MOVE   "2"       TO   WRK-F16
     ELSE
*2014/0227  MOVE   "2"       TO   WRK-F16
            MOVE   "1"       TO   WRK-F16
     END-IF.
*2010/01/18 行番号を制御
     EVALUATE  TO0-F04  ALSO  WRK-F16
...
*## 2002/03/04 NAV START ## 数量ﾏｲﾅｽ時に区分を反対にする
     IF     TO0-F15  >=  ZERO
*2014/02/27 MOVE   "2"       TO   WRK1-F16
            MOVE   "1"       TO   WRK1-F16
     ELSE
*2014/02/27 MOVE   "1"       TO   WRK1-F16
            MOVE   "2"       TO   WRK1-F16
     END-IF.
*2010/01/18 行番号を制御
     EVALUATE  TO0-F04  ALSO  WRK1-F16
...
*## 2002/03/04 NAV START ## 数量ﾏｲﾅｽ時に区分を反対にする
     IF     TO0-F15  >=  ZERO
*2014/02/27 MOVE   "1"       TO   WRK-F16
*2014/10/10 MOVE   "2"       TO   WRK-F16
*2019/08/26 MOVE   "1"       TO   WRK-F16
            MOVE   "2"       TO   WRK-F16
     ELSE
*2014/02/27 MOVE   "2"       TO   WRK-F16
*2014/10/10 MOVE   "1"       TO   WRK-F16
*2019/08/26 MOVE   "2"       TO   WRK-F16
            MOVE   "1"       TO   WRK-F16
     END-IF.
*## 2002/03/04 NAV END   ##
*場所
