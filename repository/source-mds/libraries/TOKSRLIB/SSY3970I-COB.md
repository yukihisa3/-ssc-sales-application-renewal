...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY3970I.COB`
...
*    業務名　　　　　　　：　ナフコＥＤＩ　　　　　　　        *
*    モジュール名　　　　：　ナフコ受領出荷照会　              *
*    作成日／作成者　　　：　2020.06.17   /  INOUE             *
*    更新日／更新者　　　：　　　　　　                        *
*    処理概要　　　　　　：　ナフコの受領出荷状況の照会を行う  *
*                                                              *
****************************************************************
 IDENTIFICATION        DIVISION.
 PROGRAM-ID.           SSY3970I.
 AUTHOR.               NAV.
 DATE-WRITTEN.         2020/06/17.
****************************************************************
...
*---<<  ナフコ受領出荷照会ワーク  >>--*
     SELECT   NFCKJWF        ASSIGN        TO  01-VI-NFCKJWL1
                             ORGANIZATION  IS  INDEXED
                             ACCESS MODE   IS  SEQUENTIAL
...
**************************************************************
 ...
 NFC-SEC                   SECTION.
     ...
     STOP        RUN.
 NFW-SEC                   SECTION.
     USE         AFTER     EXCEPTION PROCEDURE NFCKJWF.
     MOVE        NFW-ST    TO        E-ST.
     MOVE        "NFCKJWL1" TO       E-FILE.
     DISPLAY     SEC-NAME  UPON      CONS.
     DISPLAY     ERR-FILE  UPON      CONS.
     DISPLAY     ERR-NAME  UPON      CONS.
...
*ファイル ＣＬＯＳＥ
     CLOSE             DSPFILE  NFCKJWF  NFCKDTF  NFTENMS.
**
 END-EXIT.
     EXIT.
****************************************************************
...
**
     MOVE     SPACE               TO   DSP-PRO.
*
     MOVE    SPACE                TO   DSP-FSY39701.
     MOVE    "SSY3970I"           TO   DSP-PGID.
     MOVE    "FSY39701"           TO   DSP-FORMID.
...
*伝票_範囲チェック
     ...
     END-IF.
*抽出区分チェック
     IF       DSP-TYUKBN = " " OR "1" OR "2"
              MOVE  "M"      TO   EDIT-OPTION  OF  DSP-TYUKBN
              MOVE  SPACE    TO   EDIT-CURSOR  OF  DSP-TYUKBN
     ELSE
              MOVE   6       TO   ERR-FLG
              MOVE  "R"      TO   EDIT-OPTION  OF  DSP-TYUKBN
              MOVE  "C"      TO   EDIT-CURSOR  OF  DSP-TYUKBN
              GO             TO   HEAD-CHK-EXIT
     END-IF.
*#####################
*該当データ検索
...
*    ナフコ受領出荷照会ワーク　順ＲＥＡＤ                      *
****************************************************************
 NFCKJWF-READ-SEC      SECTION.
*
     MOVE     "NFCKJWF-READ-SEC"  TO   S-NAME.
**
     READ     NFCKJWF
