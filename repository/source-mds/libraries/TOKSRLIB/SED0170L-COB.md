...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SED0170L.COB`
...
*ヘッダ１行目　
***  配送コード
     MOVE     JOH-F209(1:3)       TO    HD1-01.
***  自社名
     MOVE     JOH-F318            TO    HD1-02.
*
*ヘッダ２行目　
***  社名
     MOVE     JOH-F207            TO    HD2-01.
***  自社名
     MOVE     JOH-F226            TO    HD2-02.
*
*ヘッダ　３　行目　
***  店名
...
***  部門
     MOVE     JOH-F302(9:2)       TO    HD3-03(1:2).
     MOVE     JOH-F303(9:2)       TO    HD3-03(3:2).
***  伝区
     MOVE    SPACE                TO    HD3-04(2:1).
***  伝票_
...
*
     CLOSE    ENSHIRE   PRTFILE    DSPFILE   EDJOHOF.
*
 END-EXIT.
     EXIT.
****************************************************************
