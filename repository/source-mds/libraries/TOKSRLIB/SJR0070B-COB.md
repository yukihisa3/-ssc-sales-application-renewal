...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SJR0070B.COB`
...
*    更新内容　　　　　　：　ジュンテンドー追加　　　　　      *
*    更新日　　　　　　　：　2020/01/23 T.TAKAHASHI            *
*    更新内容　　　　　　：　イオン店舗ＣＤ４→５桁に変更      *
*    更新日　　　　　　　：　2023/01/20 INOUE                  *
*    更新内容　　　　　　：　アレンザＨＤ追加（３社）　　      *
*                            　　　　　　　　　　　　　　　　　*
****************************************************************
...
*
 ...
 FILE-CONTROL.
*返品データファイル
     SELECT   BMSHEPL1  ASSIGN    TO        DA-01-VI-BMSHEPL1
...
*    返品データ
******************************************************************
 FD  BMSHEPL1           LABEL RECORD   IS   STANDARD.
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJR0070B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJR0070B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*データ初期READ
 INIT-00.
     ...
     START    BMSHEPL1  KEY IS >= ONL-F011 ONL-F012 ONL-F013
...
*    MOVE     ONL-F309       TO        TEN-F011.
     EVALUATE ONL-F013
*#2020/01/23 NAV ST 店舗CD桁数を変更　４→５桁
        WHEN  00008737  MOVE ONL-F309(1:5)   TO   TEN-F011
        WHEN  00033189  MOVE ONL-F309(1:5)   TO   TEN-F011
        WHEN  00087371  MOVE ONL-F309(1:5)   TO   TEN-F011
        WHEN  00087372  MOVE ONL-F309(1:5)   TO   TEN-F011
        WHEN  00087373  MOVE ONL-F309(1:5)   TO   TEN-F011
        WHEN  00087374  MOVE ONL-F309(1:5)   TO   TEN-F011
        WHEN  00087375  MOVE ONL-F309(1:5)   TO   TEN-F011
        WHEN  00087376  MOVE ONL-F309(1:5)   TO   TEN-F011
*#2020/01/23 NAV ED 店舗CD桁数を変更　４→５桁
        WHEN  00013020  MOVE ONL-F309(1:5)   TO   TEN-F011
        WHEN  00013052  MOVE ONL-F309(1:5)   TO   TEN-F011
*↓2023/01/20
        WHEN  00751225  MOVE ONL-F309(1:5)   TO   TEN-F011
        WHEN  00781225  MOVE ONL-F309(1:5)   TO   TEN-F011
        WHEN  00761995  MOVE ONL-F309(1:5)   TO   TEN-F011
*↑2023/01/20
...
*↑2019/04/15
        WHEN  00000616  MOVE ONL-F309(1:2)   TO   TEN-F011
...
*商品変換ＴＢＬ索引
     ...
     IF       ONL-F013       =         921084
*     カインズ：商品コード（ＧＴＩＮ）
              MOVE     ONL-F411(2:13)  TO    TBL-F02
     ELSE
*     カインズ以外：商品コード（発注用）
              MOVE     ONL-F412(1:13)  TO    TBL-F02
     END-IF.
     PERFORM  HSHOTBL-READ-SEC.
*原単価
     IF     ( ONL-F446 NOT NUMERIC ) OR
            ( ONL-F446 =   ZERO    )
...
*↓2023/01/20
        WHEN  00751225  MOVE ONL-F302(1:9)   TO   RUI-F04
        WHEN  00781225  MOVE ONL-F302(1:9)   TO   RUI-F04
        WHEN  00761995  MOVE ONL-F302(1:9)   TO   RUI-F04
*↑2023/01/20
...
*↑2019/04/15
        WHEN  00000616  MOVE ONL-F302(1:6)   TO   RUI-F04
...
*    MOVE     ONL-F309       TO        RUI-F07.
     EVALUATE ONL-F013
*#2020/01/23 NAV ST 店舗CD桁数を変更　４→５桁
        WHEN  00008737  MOVE ONL-F309(1:5)   TO   RUI-F07
        WHEN  00033189  MOVE ONL-F309(1:5)   TO   RUI-F07
        WHEN  00087371  MOVE ONL-F309(1:5)   TO   RUI-F07
        WHEN  00087372  MOVE ONL-F309(1:5)   TO   RUI-F07
        WHEN  00087373  MOVE ONL-F309(1:5)   TO   RUI-F07
        WHEN  00087374  MOVE ONL-F309(1:5)   TO   RUI-F07
        WHEN  00087375  MOVE ONL-F309(1:5)   TO   RUI-F07
        WHEN  00087376  MOVE ONL-F309(1:5)   TO   RUI-F07
*#2020/01/23 NAV ED 店舗CD桁数を変更　４→５桁
        WHEN  00013020  MOVE ONL-F309(1:5)   TO   RUI-F07
        WHEN  00013052  MOVE ONL-F309(1:5)   TO   RUI-F07
*↓2023/01/20
        WHEN  00751225  MOVE ONL-F309(1:5)   TO   RUI-F07
        WHEN  00781225  MOVE ONL-F309(1:5)   TO   RUI-F07
        WHEN  00761995  MOVE ONL-F309(1:5)   TO   RUI-F07
*↑2023/01/20
...
*↑2019/04/15
        WHEN  00000616  MOVE ONL-F309(1:2)   TO   RUI-F07
        WHEN  OTHER     MOVE ONL-F309        TO   RUI-F07
     END-EVALUATE.
*計上日
*分類コード
     MOVE     ONL-F328       TO        RUI-F09.
*訂正区分（Ｈ）
*    F10 : INIT
*直接納品先コード
*    F1  : INIT
...
*↓2023/01/20
        WHEN  00751225  MOVE ONL-F402(1:2)   TO   RUI-F31
        WHEN  00781225  MOVE ONL-F402(1:2)   TO   RUI-F31
        WHEN  00761995  MOVE ONL-F402(1:2)   TO   RUI-F31
*↑2023/01/20
...
*↑2019/04/15
        WHEN  00000616  MOVE ONL-F402(1:1)   TO   RUI-F31
...
*相手商品コード
     IF       ONL-F013       =         921084
*     カインズ：商品コード（ＧＴＩＮ）
              MOVE     ONL-F411(2:13)  TO    RUI-F33
     ELSE
*     カインズ以外：商品コード（発注用）
              MOVE     ONL-F412(1:13)  TO    RUI-F33
     END-IF.
*数量
     MOVE     ONL-F450       TO        RUI-F34.
*原単価
     IF       WK-ERR-GENTANKA  NOT =  "1"
              MOVE  ONL-F446 TO        RUI-F35
     END-IF.
*原価金額
     MOVE     ONL-F445       TO        RUI-F36.
*商品名カナ１
     MOVE     ONL-F416       TO        RUI-F37.
*商品名カナ２
     MOVE     ONL-F419       TO        RUI-F38.
*返品理由
     MOVE     ONL-F409       TO        RUI-F39.
*訂正区分（Ｍ）
*    F40 : INIT
*売単価
     MOVE     ONL-F448       TO        RUI-F41.
*自社伝票区分
