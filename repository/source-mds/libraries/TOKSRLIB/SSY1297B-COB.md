...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY1297B.COB`
...
*
 ...
 FILE-CONTROL.
*---<<  箱数ファイル  >>---*
     SELECT   KNHAKOL4  ASSIGN    TO             KNHAKOL4
                        ORGANIZATION        IS   INDEXED
                        ACCESS    MODE      IS   SEQUENTIAL
                        RECORD    KEY       IS   HAK-FA05
...
**** メッセージ情報  ***
 01  MSG-AREA1-1.
     03  MSG-ABEND1.
       ...
       05  ERR-PG-ID         PIC  X(08)  VALUE  "SSY1297B".
...
*-------------------------------------------------------------*
 END-SEC                SECTION.
     CLOSE              KNHAKOL4  HJYOKEN.
     DISPLAY  "DELDATE        = "  WK-DEL-DATE   UPON   CONS.
     DISPLAY  "KNHAKOL4  (IN) = "  READ-CNT      UPON   CONS.
     DISPLAY  "KNHAKOL4 (DEL) = "  DEL-CNT       UPON   CONS.
 END-END.
     EXIT.
******************<<  PROGRAM  END  >>**************************
