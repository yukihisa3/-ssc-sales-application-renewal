...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY1223I.COB`
...
*----<< 表示ファイル >>--*
     SELECT   DSPFILE   ASSIGN         01-GS-DSPF
                        ...
                        STATUS         DSP-ST.
*----<< 箱数ファイル >>--*
     SELECT   KNHAKOF   ASSIGN         DA-01-VI-KNHAKOL3
                        ...
                        STATUS         KNHAKOF-ST.
*----<< 一括ＰＤラベルファイル >>--*
     SELECT   KNBULKF   ASSIGN         DA-01-VI-KNBULKL1
                        ORGANIZATION   INDEXED
                        ACCESS    MODE SEQUENTIAL
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SSY1223I DSPFILE ERROR " DSP-CNTL " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
     MOVE     4000           TO   PROGRAM-STATUS.
*    CLOSE    KNHAKOF   HTOKMS    ZSOKMS1    DSPFILE.
     STOP     RUN.
*----<< 箱数ファイル >>--*
 KNHAKOF-ERR            SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY1223I KNHAKOL3 ERROR " KNHAKOF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
     MOVE     4000           TO   PROGRAM-STATUS.
*    CLOSE    KNHAKOF   ZSOKMS1    DSPFILE.
     STOP     RUN.
*----<< 一括ＰＤラベルファイル >>--*
 KNBULKF-ERR            SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY1223I KNBULKL1 ERROR " KNHAKOF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY1223I HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY1223I ZSOKMS1 ERROR " ZSOKMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*
     MOVE    "SSY1223I"      TO   PGID.
     MOVE    "FSY12231"      TO   FORM.
...
*
 220-SONZAI-CHECK-03.
     IF ( JDATE     =    HAK-F001 ) AND
        ( JTIME     =    HAK-F002 ) AND
*#9/21  ( TORICD    =    HAK-F003 ) AND
        ( TORICD    =    HAK-F003 )
*       ( SOKO      =    HAK-F004 ) AND
*#9/21  ( TORICD    =    HAK-FA02 )
