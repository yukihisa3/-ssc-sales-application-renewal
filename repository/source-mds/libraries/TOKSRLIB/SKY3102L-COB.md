...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SKY3102L.COB`
...
*
 01  PG-ID              PIC  X(08)     VALUE  "SKY3102L".
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
...
*--------------------------------------------------------------*
 ...
 ACOS1                  SECTION.
     ...
     DISPLAY  "### SKY3102L ACOS ERROR " ACS-ST " "
 ...
 ACOS2                  SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKY3102L ACOSOK  ERROR " ACSOK-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
 ACOS3                  SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKY3102L ACOSERR ERROR " ACSERR-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
...
*--------------------------------------------------------------*
 ACOS-READ-SEC          SECTION.
     ...
     END-READ.
*
     IF  ACS-CNT(5:3)  =  "000" OR "500"
         DISPLAY "READ-CNT = " ACS-CNT UPON CONS
     END-IF.
*
 ACOS-READ-EXIT.
     EXIT.
