...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SER0050I.COB`
...
*画面表示用ワーク
 01  DSP-WORK.
     03  WORK-PGID                PIC  X(08)  VALUE  "SER0050I".
     03  WORK-FORMID              PIC  X(08)  VALUE  "FER00501".
*フラグ領域
 01  FLG-AREA.
