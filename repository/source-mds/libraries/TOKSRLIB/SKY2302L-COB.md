...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SKY2302L.COB`
...
****************************************************************
 FILE-CONTROL.
*----<<売上計上Ｆ（本社）>>----*
     SELECT   HOU       ASSIGN         DA-01-S-TOKUWK
                        ORGANIZATION   SEQUENTIAL
                        STATUS         HOU-ST.
*----<<仕入計上Ｆ（本社）>>----*
     SELECT   HOS       ASSIGN         DA-01-S-TOKUZ
                        ORGANIZATION   SEQUENTIAL
                        STATUS         HOS-ST.
*----<<プリント>>----*
...
*----<< ﾌｱｲﾙ ｽﾃｰﾀｽ >>--*
 01  WK-ST.
     ...
     03  PRT-ST         PIC  X(02).
*
 01  PG-ID             PIC  X(08)      VALUE  "SKY2302L".
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
...
*
 ...
 01  GK1                         CHARACTER  TYPE  IS  CHR-2.
     ...
     03  GKLLER                  PIC  X(14)  VALUE  SPACE.
...
*--------------------------------------------------------------*
 ...
 HOUERR                 SECTION.
     ...
     DISPLAY  "### SKY2302L HOU ERROR " HOU-ST " "
 ...
 HOSERR                 SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKY2302L HOS ERROR " HOS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
 PRTERR                 SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKY2302L PRTFILE ERROR " PRT-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
...
*--------------------------------------------------------------*
 300-END-RTN            SECTION.
     CLOSE    HOU HOS PRTFILE.
*
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "*** SKY2302L END   *** "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS
                                       UPON CONS.
 300-END-RTN-EXIT.
