...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SKY2902L.COB`
...
*    顧客名　　　　　　　：　サカタのタネ（株）殿　　　　　　　*
*    業務名　　　　　　　：　日次計上処理　　　　　　　　　　　*
*    モジュール名　　　　：　情報ＳＹＳ部計上データ件数リスト　*
*    作成日／更新日　　　：　2018/01/30                        *
*    作成者／更新者　　　：　ＮＡＶ　　　　　　　　　　　　　　*
*    処理概要　　　　　　：　ＡＣＯＳ計上の売上／仕入計上ＤＴ　*
*                        ：　件数をカウントし、リスト出力する。*
*                        ：　                                  *
****************************************************************
****************************************************************
...
****************************************************************
 FILE-CONTROL.
*----<<ＡＣＯＳ計上データＦ（全社）>>----*
     SELECT   ACOS      ASSIGN         DA-01-S-ACOSFILE
...
*----<< ﾌｱｲﾙ ｽﾃｰﾀｽ >>--*
     ...
     03  PRT-ST         PIC  X(02).
*
 01  PG-ID              PIC  X(08)     VALUE  "SKY2902L".
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
...
*--------------------------------------------------------------*
 ...
 ACSERR                 SECTION.
     ...
     DISPLAY  "### SKY2902L ACOS ERROR " ACS-ST " "
 ...
 PRTERR                 SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SKY2902L PRTFILE ERROR " PRT-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
