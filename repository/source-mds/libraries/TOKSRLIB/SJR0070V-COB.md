...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SJR0070V.COB`
...
*
 ...
 FILE-CONTROL.
*返品データファイル
     SELECT   BMSHEPL4  ASSIGN    TO        DA-01-VI-BMSHEPL4
...
*    返品データ
******************************************************************
 FD  BMSHEPL4           LABEL RECORD   IS   STANDARD.
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJR0070V".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJR0070V".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*データ初期READ
 INIT-00.
     ...
     MOVE     SPACE          TO    ONL-F302.
     MOVE     SPACE          TO    ONL-F402.
     START    BMSHEPL4  KEY IS >= ONL-F011 ONL-F012 ONL-F013
                                  ONL-F302 ONL-F402
...
*↑2019/04/15
*↓2021/10/08
        WHEN  00038709  MOVE ONL-F309(1:4)   TO   TEN-F011
*↑2021/10/08
...
*↑2019/04/15
*↓2021/10/08
        WHEN  00038709  MOVE ONL-F302(1:6)   TO   RUI-F04
*↑2021/10/08
...
*↑2019/04/15
*↓2021/10/08
        WHEN  00038709  MOVE ONL-F309(1:4)   TO   RUI-F07
*↑2021/10/08
...
*↑2019/04/15
*↓2021/10/08
        WHEN  00038709  MOVE ONL-F402(1:2)   TO   RUI-F31
*↑2021/10/08
