...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NCV3750S.COB`
...
*    作成日／作成者　　　：　2019/12/06 INOUE                  *
*    更新者／更新日　　　：　　　　　　　　　　　　　　　　　　*
*    処理概要　　　　　　：　　　　　　　　　　　　　　　　　　*
*    流用　　　　　　　　：　NCV3750B.TOKSLIBS                 *
****************************************************************
 IDENTIFICATION        DIVISION.
 PROGRAM-ID.           NCV3750S.
 AUTHOR.               NAV.
 DATE-WRITTEN.         2019/12/06.
****************************************************************
...
*取引先ＣＤ
 01  WK-TORIHIKICD.
     03  WK-TORICD                PIC  9(08)  VALUE  284202.
*ファイルエラーメッセージ
 01  FILE-ERR.
