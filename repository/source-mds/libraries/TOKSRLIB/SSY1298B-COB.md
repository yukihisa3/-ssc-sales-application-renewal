...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY1298B.COB`
...
*
 ...
 FILE-CONTROL.
*---<<  ケースＰＤラベルファイル  >>---*
     SELECT   KNCASEL5  ASSIGN    TO             KNCASEL5
                        ORGANIZATION        IS   INDEXED
                        ACCESS    MODE      IS   SEQUENTIAL
                        RECORD    KEY       IS   CAS-FA05
...
**** メッセージ情報  ***
 01  MSG-AREA1-1.
     03  MSG-ABEND1.
       ...
       05  ERR-PG-ID         PIC  X(08)  VALUE  "SSY1298B".
...
**
 ...
 FILEERR-SEC1                SECTION.
     USE AFTER       EXCEPTION
                     PROCEDURE    KNCASEL5.
     MOVE     "KNCASEL5"     TO   ERR-FL-ID.
     MOVE     CAS-STATUS     TO   ERR-STCD.
...
*-------------------------------------------------------------*
 END-SEC                SECTION.
     CLOSE              KNCASEL5  HJYOKEN.
     DISPLAY  "DELDATE        = "  WK-DEL-DATE   UPON   CONS.
     DISPLAY  "KNCASEL5  (IN) = "  READ-CNT      UPON   CONS.
     DISPLAY  "KNCASEL5 (DEL) = "  DEL-CNT       UPON   CONS.
 END-END.
     EXIT.
******************<<  PROGRAM  END  >>**************************
