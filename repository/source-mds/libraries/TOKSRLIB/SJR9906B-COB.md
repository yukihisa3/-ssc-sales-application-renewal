...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SJR9906B.COB`
...
****************************************************************
*    顧客名　　　　　　　：　（株）サカタのタネ殿　　　　　　　*
*    サブシステム　　　　：　受領返品取込機能（島忠返品削除）　*
*    業務名　　　　　　　：　島忠返品削除処理　　　　　　　    *
*    モジュール名　　　　：　島忠返品削除処理　　　　　　　    *
*    作成日／更新日　　　：　2022/07/20                        *
*    作成者／更新者　　　：　ＮＡＶ高橋                        *
*    処理概要　　　　　　：　パラメタを受取り、受領累積Ｆにス　*
*                            タートを掛け、合致するＤＴを削除  *
*    更新日／更新者　　　：　　　　　　　　　　　　　　　　　　*
*    修正概要　　　　　　：　　　　　　　　　　　　　　　　　　*
****************************************************************
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJR9906B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJR9906B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*
 LINKAGE                          SECTION.
 01  PARA-JYUSIN-DATE             PIC  9(08).
 01  PARA-JYUSIN-TIME             PIC  9(04).
 01  PARA-JYUSIN-TOKCD            PIC  9(08).
******************************************************************
*             M A I N             M O D U L E                    *
******************************************************************
 PROCEDURE              DIVISION  USING  PARA-JYUSIN-DATE
                                         PARA-JYUSIN-TIME
                                         PARA-JYUSIN-TOKCD.
 DECLARATIVES.
...
*受領累積データスタート
     ...
     INITIALIZE                        JYR-REC.
     MOVE      PARA-JYUSIN-DATE TO     JYR-F01.
     MOVE      PARA-JYUSIN-TIME TO     JYR-F02.
     MOVE      PARA-JYUSIN-TOKCD TO    JYR-F03.
...
*処理件数カウント／画面表示
 ...
 READ002.
*バッチ番号チェック
     IF  PARA-JYUSIN-DATE  NOT =  JYR-F01
     OR  PARA-JYUSIN-TIME  NOT =  JYR-F02
     OR  PARA-JYUSIN-TOKCD NOT =  JYR-F03
         MOVE  9                TO   END-FG
         GO                     TO   COMRUIF-READ-EXIT
     END-IF.
*
