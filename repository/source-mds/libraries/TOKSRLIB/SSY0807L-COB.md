...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY0807L.COB`
...
*
 ...
 FILE-CONTROL.
*欠品ファイル
     SELECT  KPPFILF   ASSIGN    TO        KPPFILL1
...
****************************************************************
 PROCESS-SEC             SECTION.
     ...
     DISPLAY  "***   SSY0807L   START    ***"  UPON CONS.
*
*ワーク初期化
     MOVE      ZERO     TO    P-CNT.
     MOVE      ZERO     TO    L-CNT.
...
*ファイル ＣＬＯＳＥ
     ...
     DISPLAY  "***   SSY0807L   END      ***"  UPON CONS.
**
 END-EXIT.
     EXIT.
