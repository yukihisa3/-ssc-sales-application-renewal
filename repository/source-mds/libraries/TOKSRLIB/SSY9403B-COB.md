...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY9403B.COB`
...
*
 ...
 FILE-CONTROL.
*出荷通知抽出データ
     SELECT   YODSNDL1  ASSIGN    TO        DA-01-VI-YODSNDL1
...
*出荷通知抽出データ
******************************************************************
 FD  YODSNDL1            LABEL RECORD   IS   STANDARD.
     COPY     YODSNDL1   OF        XFDLIB
...
*メッセージ出力領域
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG           PIC  X(08)  VALUE "SSY9403B".
         05  FILLER          PIC  X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER          PIC  X(05)  VALUE " *** ".
         05  END-PG          PIC  X(08)  VALUE "SSY9403B".
         05  FILLER          PIC  X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER          PIC  X(05)  VALUE " *** ".
...
*　　出荷抽出データ読込　　　　　　　　　　　　　　　　　　　　*
****************************************************************
 YODSNDL1-READ-SEC    SECTION.
*
     MOVE    "YODSNDL1-READ-SEC"    TO   S-NAME.
*
 YODSNDL1-READ-01.
     READ     YODSNDL1
              AT  END
                  MOVE     "END"    TO  END-FLG
                  GO                TO  YODSNDL1-READ-EXIT
     END-READ.
*
     ADD      1     TO     RD-CNT.
*
...
*
     CLOSE    YODSNDL1   TENMS1  YODSNDSF.
*
