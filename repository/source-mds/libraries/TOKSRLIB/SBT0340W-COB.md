...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SBT0340W.COB`
...
*店舗変換
 01  WK-TENPO-CD           PIC  9(05).
 01  WK-TENPO-CD-R         REDEFINES  WK-TENPO-CD.
     03  WK-TENPO-CD-H     PIC  X(05).
*納品日変換
 01  WK-NOUDT-CD           PIC  9(08).
 01  WK-NOUDT-CD-R         REDEFINES  WK-NOUDT-CD.
     03  WK-NOUDT-CD-H     PIC  X(08).
***** システム日付ワーク
 01  SYSTEM-HIZUKE.
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SBT0340W".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SBT0340W".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-IN.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*
     ...
     MOVE     HAC-F304(1:5)       TO   WK-TENPO-CD-H.
     MOVE     WK-TENPO-CD         TO   TEN-F011.
**** MOVE     HAC-F304(1:5)       TO   TEN-F011.
     PERFORM  TENMS1-READ-SEC.
***  DISPLAY "TEN-F52  =  "  TEN-F52   UPON  CONS
***  DISPLAY "TEN-F011 =  "  TEN-F011  UPON  CONS
***  DISPLAY "TEN-F75  =  "  TEN-F75   UPON  CONS
***  DISPLAY "INV-FLG  =  "  TENMS1-INV-FLG  UPON  CONS
...
***   DISPLAY "JYO-INV-FLG = " JYOKEN1-INV-FLG UPON CONS
...
*                  直接納品先名称カナ
                   ...
                   MOVE     "1"                 TO   SYU-F93
              ELSE
***               DISPLAY "JYO-F03 = " JYO-F03  UPON CONS
***               DISPLAY "JYO-F04 = " JYO-F04  UPON CONS
***               DISPLAY "JYO-F14 = " JYO-F14  UPON CONS
                   MOVE     JYO-F04             TO   WK-TENPO-CD
                   MOVE     WK-TENPO-CD-H     TO   SYU-F304(1:5)
****************** MOVE     JYO-F04             TO   SYU-F304
                   ...
                   MOVE     "0"                 TO   SYU-F93
***       DISPLAY "SYU-F304   = "  SYU-F304    UPON CONS
***       DISPLAY "SYU-F305   = "  SYU-F305    UPON CONS
***       DISPLAY "SYU-F306   = "  SYU-F306    UPON CONS
***       DISPLAY "SYU-F307   = "  SYU-F307    UPON CONS
              END-IF
     END-IF.
*  直接納品先コード
*****MOVE     HAC-F304            TO   SYU-F304.
...
*****直接納品先納品日－1
       ...
       END-IF
     END-IF.
***  DISPLAY NC"直接納品先納品日" " = " SYU-F345  UPON CONS.
*  最終納品先納品日
     MOVE     HAC-F346            TO   SYU-F346.
     IF       HAC-F346            NOT  NUMERIC
              MOVE     ZERO       TO   SYU-F346
     END-IF.
***  DISPLAY NC"最終納品先納品日" " = " SYU-F346  UPON CONS.
*  計上日
...
*ファイルクローズ
     CLOSE     SHTDENLA  CNZSYKF  MEIMS1  SHOTBL1
               BMSHACL1  MSTKMEL1 TENMS1  JYOKEN1.
*
     STOP      RUN.
*
 END-EXIT.
