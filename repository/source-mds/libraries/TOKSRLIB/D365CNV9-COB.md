...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/D365CNV9.COB`
...
*----<< ﾌｱｲﾙ ｽﾃｰﾀｽ >>--*
 ...
 01  SHOTBL1-ST.
     03  SHOTBL1-ST1    PIC  X(02).
     03  SHOTBL1-ST2    PIC  X(04).
*
*----<< ﾋﾂﾞｹ ﾜｰｸ >>--*
...
*----<< 売上伝票ファイル >>--*
 SHTDENF-ERR            SECTION.
     ...
     DISPLAY  "### D365CNV9 SHTDENF ERROR " SHTDENF-ST " "
...
*----<< 商品変換ＴＢＬ >>--*
 TBL-ERR                 SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### D365CNV9 SHOTBL1 ERROR " SHOTBL1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     MOVE     "4010"    TO        PROGRAM-STATUS.
...
*----<< 売上伝票ファイル変換結果 >>--*
 SHTOUTF-ERR            SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### D365CNV9 SHTOUTF ERROR " SHTDENF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     MOVE     "4010"    TO        PROGRAM-STATUS.
...
*--------------------------------------------------------------*
 300-END-RTN            SECTION.
     ...
     CLOSE    SHTOUTF.
*
     DISPLAY  "+++ D365CNV9 ﾖﾐｺﾐ  ｹﾝｽｳ = " IN-CNT " +++"
                                       UPON CONS.
     DISPLAY  "+++ D365CNV9 ｺｳｼﾝ  ｹﾝｽｳ = " OUT-CNT " +++"
                                       UPON CONS.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "*** D365CNV9 END *** "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS
                                       UPON CONS.
 300-END-RTN-EXIT.
