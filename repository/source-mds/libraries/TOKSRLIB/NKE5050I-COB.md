...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NKE5050I.COB`
...
*
 ...
 01  PARA-JOHO-CNT          PIC   9(06).
 01  PARA-LABH-CNT          PIC   9(06).
 01  PARA-LABM-CNT          PIC   9(06).
 01  PARA-RERR-CNT          PIC   9(06).
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### NKE5050I DSPFILE ERROR " DSP-ST " "
...
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### NKE5050I ZSOKMS1 ERROR " SOK-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FKE50501.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "NKE5050I"      TO   PGID.
     MOVE    "FKE50501"      TO   FORM.
*倉庫名称取得
     ...
     END-READ.
     MOVE     NC"出荷情報件数"      TO   HDJOHO.
     MOVE     PARA-JOHO-CNT         TO   JOHO.
     IF       PARA-KUBUN    NOT =   "1"
              MOVE     NC"封筒情報件数"      TO   HDLABH
              MOVE     PARA-LABH-CNT         TO   LABH
              MOVE     NC"梱包情報件数"      TO   HDLABM
              MOVE     PARA-LABM-CNT         TO   LABM
              MOVE     NC"＜カインズ＞"      TO   MODEMG
     ELSE
              MOVE     NC"＜カインズ以外＞"  TO   MODEMG
     END-IF.
     MOVE     NC"エラー情報件数"    TO   HDRERR.
     MOVE     PARA-RERR-CNT         TO   RERR.
     MOVE     SPACE          TO   DSP-CNTL.
     MOVE     "FKE50501"     TO   DSP-FMT.
