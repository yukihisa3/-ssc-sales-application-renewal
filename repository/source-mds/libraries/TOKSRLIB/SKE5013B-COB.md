...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SKE5013B.COB`
...
*売上伝票抽出Ｆ
     SELECT   ARZDENWK   ASSIGN    TO       ARZDENWK
                        ACCESS    MODE      SEQUENTIAL
...
*    送信用売上伝票データ
******************************************************************
 FD  ARZDENWK            LABEL RECORD   IS   STANDARD.
     COPY     ARZDENWK   OF        XFDLIB
              JOINING   SDE       PREFIX.
*
*****************************************************************
*
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SKE5013B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SKE5013B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
