...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY7320L.COB`
...
*----<< ダイユーエイト出荷情報ファイル >>--*
 DYSYUKF-ERR            SECTION.
     ...
     DISPLAY  "### SSY7320L DYSYUKF ERROR " DYSYUKF-ST " "
