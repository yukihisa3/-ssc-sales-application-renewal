...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SJR0320I.COB`
...
******************************************************************
 ...
 01  LINK-TOKST              PIC  9(08).
 01  LINK-TOKED              PIC  9(08).
 01  LINK-NRKST              PIC  9(08).
 01  LINK-NRKED              PIC  9(08).
*
**************************************************************
...
*取引先ＣＤ開始チェック
     IF  DSP-TOKST =     ZERO
     OR  DSP-TOKST NOT   NUMERIC
         MOVE   ZERO     TO        DSP-TOKST
     END-IF.
*取引先ＣＤ終了チェック
     IF  DSP-TOKED =     ZERO
     OR  DSP-TOKED NOT   NUMERIC
         MOVE   99999999 TO        DSP-TOKED
     END-IF.
*取引先ＣＤ大小チェック
     IF       DSP-TOKST  >  DSP-TOKED
              MOVE      1    TO   ERR-FLG
              MOVE     "R"   TO   EDIT-OPTION  OF  DSP-TOKST
              MOVE     "R"   TO   EDIT-OPTION  OF  DSP-TOKED
              MOVE     "C"   TO   EDIT-CURSOR  OF  DSP-TOKST
...
*実行
         WHEN   "E000"
                MOVE    DSP-NFROM     TO   LINK-NRKST
                MOVE    DSP-NTO       TO   LINK-NRKED
                MOVE    DSP-TANF      TO   LINK-TANST
                MOVE    DSP-TANT      TO   LINK-TANED
                MOVE    DSP-TOKST     TO   LINK-TOKST
                MOVE    DSP-TOKED     TO   LINK-TOKED
                MOVE    "END"         TO   END-FLG
*終了
         WHEN   "F005"
                MOVE    "END"    TO   END-FLG
...
*画面の表示
     ...
     MOVE    "SJR0320I"          TO   DSP-PGID.
     MOVE    "FJR03201"          TO   DSP-FORMID.
     MOVE    "FJR03201"          TO   DSP-FMT.
     WRITE    DSP-FJR03201.
*
 DSP-WRITE-EXIT.
     EXIT.
...
*
     IF  LINK-JIKKBN = SPACE
         MOVE NC"【　通常計上処理　】"  TO  DSP-KEIMSG
     ELSE
         MOVE NC"【　伝票纏め処理　】"  TO  DSP-KEIMSG
     END-IF.
*項目属性クリア　
     PERFORM      DSP-SYOKI-SEC.
*
...
***  取引先開始
     MOVE    "M"      TO  EDIT-OPTION  OF  DSP-TOKST.
     MOVE    SPACE    TO  EDIT-CURSOR  OF  DSP-TOKST.
***  取引先終了
     MOVE    "M"      TO  EDIT-OPTION  OF  DSP-TOKED.
     MOVE    SPACE    TO  EDIT-CURSOR  OF  DSP-TOKED.
***  入力日開始
