...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SBM0213L.COB`
...
******************************************************************
***  支払ワーク（ジュンテンドー）
     SELECT  BMSSH5W1   ASSIGN    TO        DA-01-VI-BMSSH5W1
...
*
 01  WK-SIH-F402             PIC  X(09).
 01  WK-SIH-F402-R     REDEFINES      WK-SIH-F402.
     03  WK-SIH-F402-H       PIC  9(09).
*
*日付変換サブルーチン用ワーク
...
****  見出し行１　　　　　　 ****
 01  MIDASI-1.
     ...
     03  FILLER              PIC  X(08)  VALUE  "SBM0213L".
...
****  総合計　　　 ****
 ...
 01  GOKEI-S1.
     ...
     03  FILLER              PIC  N(09)  VALUE
         NC"＜ジュンテンドー＞"   CHARACTER  TYPE  IS  NIHONGO.
     03  FILLER              PIC  X(01)  VALUE  SPACE.
...
******************************************************************
 ...
 PRT-ERR-EXC            SECTION.
     ...
     STOP     RUN.
 SIH-ERR-EXC            SECTION.
     USE      AFTER     EXCEPTION PROCEDURE BMSSH5W1.
...
*
     OPEN     INPUT     BMSSH5W1   HTOKMS   HTENMS
              OUTPUT    PRTF.
*
 INIT-EXIT.
     EXIT.
...
*
     ...
     CLOSE    PRTF      BMSSH5W1   HTOKMS    HTENMS.
*
 END-EXIT.
     EXIT.
***************************************************************
...
*ヘッダ
     IF       TEN-FLG        =    0
*      店舗情報
              IF   SIH-F405(1:6)  =    "999999"
                   MOVE   NC"相殺又は支払合計"   TO   TENNM
              ELSE
                   MOVE   SIH-F405(2:5)          TO   WK-TENCDR
...
*    伝区（処理種別）
     ...
     EVALUATE SIH-F424
         WHEN "00"
              MOVE  NC"　　"      TO   DENKNM
         WHEN "01"
              MOVE  NC"仕入"      TO   DENKNM
         WHEN "02"
              MOVE  NC"返品"      TO   DENKNM
         WHEN "04"
              MOVE  NC"値引"      TO   DENKNM
         WHEN OTHER
              MOVE  NC"＊＊"      TO   DENKNM
     END-EVALUATE.
*    伝票番号
     MOVE     SIH-F402(1:9)       TO   WK-SIH-F402.
