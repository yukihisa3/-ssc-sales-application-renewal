...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SJR0370V.COB`
...
*
*****<<返品CSVデータ >>*************************************
     SELECT   JYRHPCSV           ASSIGN    TO   JYRHPCSV
                                 STATUS         CSV-STATUS.
*                                                              *
****************************************************************
 DATA                   DIVISION.
...
*    FILE = 返品データＣＳＶ　　　　　　　　                   *
*--------------------------------------------------------------*
 FD  JYRHPCSV           BLOCK CONTAINS 1    RECORDS.
 01  CSV-REC.
     03  FILLER         PIC       X(500).
*
*----------------------------------------------------------------*
...
***** メッセージエリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJR0370V".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJR0370V".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND1.
...
*             プロセス                      0.0                *
****************************************************************
 SJR0370V-START         SECTION.
*
     MOVE   "SJR0370V-START"      TO   S-NAME.
     PERFORM            INIT-SEC.
     IF   END-FLG  NOT =  "END"
...
*
     CLOSE    COMWHEL1 TOKMS2 TENMS1 JYOKEN1 TANMS1 JYRHPCSV.
