...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NKE0245B.COB`
...
****************************************************************
 FILE-CONTROL.
*倉庫入荷確定ファイル
     SELECT      RCVNYKF     ASSIGN    TO       DA-01-S-RCVNYKF
...
****************************************************************
 ZAIKO-SEC                  SECTION.
*在庫マスタを索引する
     MOVE    RUI-F01        TO   ZAI-F01.
     MOVE    RUI-F06        TO   ZAI-F021.
     MOVE    RUI-F07        TO   ZAI-F022.
     MOVE    RUI-F09        TO   ZAI-F03.
     READ    ZAMZAIL1
             INVALID
