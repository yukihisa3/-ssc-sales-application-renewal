...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SNA1620B.COB`
...
*----<< 伝票データ >>--*
 SHTDENF-ERR            SECTION.
     ...
     DISPLAY  "### SNA1620B SHTDENF ERROR " DEN-ST " "
...
*----<< 商品変換テーブル >>--*
 HSHOTBL-ERR            SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SNA1620B HSHOTBL ERROR " TBL-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     CLOSE    SHTDENF  HSHOTBL  HMEIMS  SUBTBLF.
...
*----<< 商品変換テーブル >>--*
 HMEIMS-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SNA1620B HMEIMS ERROR " MEI-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     CLOSE    SHTDENF  HSHOTBL  HMEIMS  SUBTBLF.
