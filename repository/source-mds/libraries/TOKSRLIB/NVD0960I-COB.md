...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NVD0960I.COB`
...
*    顧客名　　　　　　　：　（株）サカタのタネ殿　　　　　　　*
*    サブシステム　　　　：　Ｄ３６５連携                      *
*    モジュール名　　　　：　入荷実績送信ＦＬＧ解除指示　　    *
*    作成日／作成者　　　：　2023/05/24 INOUE                  *
*    処理概要　　　　　　：　　　　　　　　　　　　　　　　    *
*                            　　　　　　　　　　　　　　　    *
*    更新日／更新者　　　：　                                  *
*　                                                            *
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### NVD0960I DSPFILE ERROR " DSP-CNTL " "
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FVD09601.
*
     PERFORM  CLR-GRP001-RTN.
     PERFORM  CLR-GRP002-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "NVD0960I"      TO   PGID.
     MOVE    "FVD09601"      TO   FORM.
*
     MOVE     1              TO   GR-NO.
*
     MOVE     SPACE          TO   DSP-CNTL.
     MOVE     "FVD09601"     TO   DSP-FMT.
