...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY9420B.COB`
...
*    サブシステム　　　　：　ヨドバシ　　　　　　　　　　　　　*
*    モジュール名　　　　：　ヨドバシ納期一括変更更新　　　　　*
*    作成日／作成者　　　：　2022/02/15 NAV INOUE              *
*    処理概要　　　　　　：　売上伝票ファイル・基本情報ファイル*
*                          　の納品日（納入期日）を一括変更　　*
*<履歴>*********************************************************
* XXXX/XX/XX XXXXXXXXX ＮＮＮＮＮＮＮＮＮＮＮＮＮＮＮＮＮＮＮＮ
* 2022/02/15 INOUE 　　新規作成  流用：SSY5220B.TOKSRLIB
*
****************************************************************
...
*----<< 伝票データ >>--*
 SHTDENLJ-ERR           SECTION.
     ...
     DISPLAY  "### SSY9420B SHTDENLJ ERROR " DEN-ST " "
...
*----<< 基本情報ファイル　　　 >>--*
 YODJOHL2-ERR              SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY9420B YODJOHL2 ERROR " JOH-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 納期変更・出荷確定Ｆ　 >>--*
 YODNKKL1-ERR              SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY9420B YODNKKL1 ERROR " NKK-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*
     ...
     DISPLAY  NC"納期変更・出荷確定Ｆ＝" NKK-CNT NC"件"
                                                     UPON CONS.
     MOVE     SYS-DATEW     TO    LINK-OUT-JDATE.
     MOVE     SYS-TIMEW     TO    LINK-OUT-JTIME.
*
 300-END-RTN-EXIT.
     EXIT.
*--------------------------------------------------------------*
