...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SJR0340B.COB`
...
*
 ...
 FILE-CONTROL.
*---<<  返品累積データ  >>---*
     SELECT   COMRUIF   ASSIGN    TO             COMRUIL3
                        ORGANIZATION        IS   INDEXED
                        ACCESS    MODE      IS   SEQUENTIAL
                        RECORD    KEY       IS   RUI-F08
...
**** メッセージ情報  ***
 01  MSG-AREA1-1.
     03  MSG-ABEND1.
       ...
       05  ERR-PG-ID         PIC  X(08)  VALUE  "SJR0340B".
...
*削除基準日算出
     ...
     DISPLAY "#"NC"削除基準" " = " WK-DEL-DATE " #" UPON CONS.
*返品累積Ｆ読込み
...
*-------------------------------------------------------------*
 END-SEC                SECTION.
     CLOSE              COMRUIF  HJYOKEN.
     DISPLAY  "DELDATE         = "  WK-DEL-DATE   UPON   CONS.
     DISPLAY  "COMRUIF    (IN) = "  READ-CNT      UPON   CONS.
     DISPLAY  "COMRUIF   (DEL) = "  DEL-CNT       UPON   CONS.
 END-END.
     EXIT.
******************<<  PROGRAM  END  >>**************************
