...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NSY0500I.COB`
...
*                                                              *
**履歴**********************************************************
*    2018/02/19  高橋　　新規作成（ＳＳＹ９２０５Ｉコピー）　　*
*    0000/00/00　　　　　　　　　　　　　　　　　　　　　　　　*
****************************************************************
...
******************************************************************
 ...
 01  LINK-STENPO        PIC  9(05).
 01  LINK-ETENPO        PIC  9(05).
*
**************************************************************
...
*納品日大小チェック
     ...
     END-IF.
*店舗開始チェック
     IF       DSP-STENPO  NOT NUMERIC
     OR       DSP-STENPO  =  ZERO
              MOVE   ZERO    TO   DSP-STENPO
     END-IF.
*納品日終了チェック
     IF       DSP-ETENPO  NOT NUMERIC
     OR       DSP-ETENPO  =  ZERO
     OR       DSP-ETENPO  =  99999
              MOVE  99999    TO   DSP-ETENPO
     END-IF.
*納品日大小チェック
     IF       DSP-STENPO  >  DSP-ETENPO
              MOVE   8     TO   ERR-FLG
              MOVE  "R"    TO   EDIT-OPTION  OF  DSP-STENPO
              MOVE  "R"    TO   EDIT-OPTION  OF  DSP-ETENPO
              MOVE  "C"    TO   EDIT-CURSOR  OF  DSP-STENPO
              GO           TO   PARA-CHK-EXIT
     ELSE
              MOVE  "M"    TO   EDIT-OPTION  OF  DSP-STENPO
              MOVE  "M"    TO   EDIT-OPTION  OF  DSP-ETENPO
              MOVE  SPACE  TO   EDIT-CURSOR  OF  DSP-STENPO
     END-IF.
*
     MOVE    "2"       TO    PSW.
*
...
*実行
         WHEN   "E000"
                ...
                MOVE    DSP-STENPO   TO   LINK-STENPO
                MOVE    DSP-ETENPO   TO   LINK-ETENPO
                MOVE    "END"         TO   END-FLG
*終了
         WHEN   "F005"
                MOVE    "END"    TO   END-FLG
...
*ＰＧＩＤ／ＦＭＩＤセット
     MOVE     "NSY0500I"          TO   DSP-PGID.
     MOVE     "FSY05001"          TO   DSP-FMID.
*エラーメッセージセット
     IF    ERR-FLG   =    ZERO
...
***  店舗ＣＤ
     ...
     MOVE    SPACE    TO  EDIT-CURSOR  OF  DSP-STENPO.
     MOVE    "M"      TO  EDIT-OPTION  OF  DSP-ETENPO.
     MOVE    SPACE    TO  EDIT-CURSOR  OF  DSP-ETENPO.
*
 DSP-SYOKI-EXIT.
     EXIT.
****************************************************************
