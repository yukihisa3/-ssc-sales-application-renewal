...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SNA0570I.COB`
...
*    業務名　　　　　：
*    モジュール名　　：先行受注発注データ抽出指示
*    作成日／更新日　：2011/10/27
*    作成者／更新者　：飯田/NAV
*    処理概要　　　　：
*      苗業務システムへ送信する先行受注（オンライン）
...
*      先行受注商品のみを対象とする
*      ２０１２／０７／１２対応分の戻し作業
*    変更日／更新日　：2020/04/30 NAV T.TAKAHASHI
*    変更内容　　　　：Ｄ３６５連携対応　　　
*    変更日／更新日　：2020/12/14 NAV T.TAKAHASHI
*    変更内容　　　　：Ｄ３６５連携対応（ＯＲＤ区分変更）
*    変更日／更新日　：2025/03/17 NAV T.TAKAHASHI
*    変更内容　　　　：実納品日範囲変更　納品日の１４日以前
*    　　　　　　　　　までを範囲へ変更　現状７日前
***********************************************************
...
*  画面の初期化
     MOVE  SPACE            TO  DSP-FNA05701.
*  ＰＧＩＤ
     MOVE  "SNA0570I"       TO  DSP-PGID.
*  システム日付転送
     MOVE  SYS-DATE         TO  DSP-SDATE.
*  システム時間転送
     MOVE  WK-TIME(1:6)     TO  DSP-STIME.
...
* ↓2016/10/20 ST コメントアウト位置を変更
         IF  URI-F32 NOT = RENKBN  OR  URI-F33 NOT = "         "
...
*  期間開始日
     ...
     PERFORM  HZK-CVT-SEC.
*#2025/03/17 NAV ST 開始日付を７→１４へ変更
*****COMPUTE  WK-CMPYMD-D = WK-CMPYMD-D - 7.
     COMPUTE  WK-CMPYMD-D = WK-CMPYMD-D - 14.
*#2025/03/17 NAV ED
     IF  WK-CMPYMD-D < 1
