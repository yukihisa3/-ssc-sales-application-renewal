...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSM0030S.COB`
...
*
 ...
 FILE-CONTROL.
*出荷明細ワーク（ケース数算出）
     SELECT   SYKMEIL1 ASSIGN     TO       DA-01-VI-SYKMEIL1
...
*メッセージ情報
 01  MSG-AREA.
     03  SEC-NAME.
         ...
         05  S-NAME          PIC  X(30).
     03  MSG-ABEND1.
         05  FILLER          PIC  X(12)  VALUE  "### SSM0030S".
     ...
     03  MSG-INPUT.
         05  FILLER          PIC  X(13)  VALUE  "*** SYKMEIL1 ".
...
*ﾁｮｳﾋｮｳﾃｲｷﾞｴﾘｱ
 01  HEAD01.
     ...
     03  FILLER     PIC  X(08)     VALUE  "SSM0030S".
...
*出荷明細ワーク
 OUT-ERR-SEC        SECTION.
     USE      AFTER  EXCEPTION   PROCEDURE       SYKMEIL1.
     MOVE    "SYKMEIL1"    TO    ERR-FL-ID.
...
*=============================================================
 CONTROL-SEC         SECTION.
     DISPLAY  "**  SSM0030S   START  **"   UPON  CONS.
*
     ...
     PERFORM  END-SEC.
*
     DISPLAY  "**  SSM0030S   END    **"   UPON  CONS.
     STOP  RUN.
 CONTROL-EXIT.
     EXIT.
*=============================================================
