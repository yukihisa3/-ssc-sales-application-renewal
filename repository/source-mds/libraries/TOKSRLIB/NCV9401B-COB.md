...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NCV9401B.COB`
...
*取引先ＣＤ
 01  WK-TORIHIKICD.
*****03  WK-TORICD                PIC  9(08)  VALUE  13596131.
     03  WK-TORICD                PIC  9(08)  VALUE  01318267.
*ファイルエラーメッセージ
 01  FILE-ERR.
...
*****MOVE      WK-TIME-1    TO     LINK-JIKAN.
     ...
     MOVE      "TOKDTLIB"   TO     LINK-LIBNM.
     MOVE      "YODJYUSF"   TO     LINK-FILNM.
