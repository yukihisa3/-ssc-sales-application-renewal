...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SBM0167B.COB`
...
*返品伝票ワーク（山新）
     SELECT   BMSHE4W   ASSIGN    TO        DA-01-VS-BMSHE4W
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SBM0167B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SBM0167B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*返品伝票ワ－ク出力
     DISPLAY "BMSHE4W  WRITE CNT = " WRITE-CNT UPON CONS.
     IF  PARA-HSYU  =  "1"
         CLOSE  BMSHEPF1
     END-IF.
     IF  PARA-HSYU  =  "2"
