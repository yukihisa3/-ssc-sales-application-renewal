...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NJH9203B.COB`
...
*    サブシステム　　　　：　出荷管理　　　　　　　　　　　　　*
*    業務名　　　　　　　：　ベンダーオンライン　　　　　　　　*
*    モジュール名　　　　：　ＥＤＩＣエンチョー発注データ変換　*
*    作成日　　　　　　　：　2020/06/09                        *
*    作成者　　　　　　　：　NAV INOUE                         *
*    処理概要　　　　　　：　発注データより、基本情報データ　　*
*                            を作成する（エンチョー用）　　　　*
****************************************************************
 IDENTIFICATION         DIVISION.
*
 PROGRAM-ID.            NJH9203B.
*                 流用：NJH9103B.TOKSLIBS(マキバ)
 AUTHOR.                NAV.
...
*    ｶｳﾝﾄ
 ...
 01  WK-GYONO                PIC  9(04)     VALUE  ZERO.
*
     COPY     EDJOHOF   OF        XFDLIB
              JOINING   WJOH      PREFIX.
*
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH9203B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH9203B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    バッチ取引先
*****MOVE     WJOH-F107(1:11) TO     WK-13-CD(3:11).
*****MOVE     WJOH-F107(12:2) TO     WK-13-CD(1:2).
     MOVE     WJOH-F224     TO        WK-13-CD.
...
*行番号
     ...
     ADD      1            TO        WK-GYONO.
     MOVE     WK-GYONO     TO        HEN-F03.
     MOVE     WK-GYONO     TO        JOH-F06.
*取区
     MOVE        40        TO        HEN-F051.
...
*    得意先マスタ検索
     ...
     END-IF.
*相手商品コード
     MOVE    WJOH-F407(2:13) TO      HEN-F25.
*伝票発行区分
     MOVE        9         TO        HEN-F272.
*オンライン区分
     MOVE        1         TO        HEN-F274.
