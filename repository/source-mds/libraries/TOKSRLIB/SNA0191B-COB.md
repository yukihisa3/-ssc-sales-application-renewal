...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SNA0191B.COB`
...
*    業務名　　　　　：
*    モジュール名　　：小売連携データ送信完了処理　
*    作成日／更新日　：2018/11/08
*    作成者／更新者　：高橋_／ＮＡＶ
*    処理概要　　　　：
*      苗業務システムへの取込依頼を行った記録リスト。
*      連携発生データ抽出・送信ジョブ内で処理される。
*      （非ＨＵＬＦＴ対応化）
***********************************************************
...
*　日付論理チェック
 ...
 01  HEAD01.
     03  FILLER  PIC  X(08)  VALUE "SNA0191B".
 ...
 01  MEISAI01  CHARACTER TYPE IS PIT-2-2W2H.
     ...
     03  FILLER  PIC  N(06)  VALUE NC"小売連携デー".
     03  FILLER  PIC  N(09)  VALUE NC"タ）を抽出しました".
 ...
 01  MEISAI03.
     03  FILLER  PIC  X(40)  VALUE SPACE.
     03  FILLER  PIC  N(06)  VALUE NC"抽出件数　："
                      CHARACTER TYPE IS PIT-1V5-2W.
     03  FILLER  PIC  X(01)  VALUE SPACE.
 ...
 01  MEISAI04.
     03  FILLER          PIC  X(40)  VALUE SPACE.
     03  FILLER          PIC  N(06)  VALUE NC"抽出担当者："
                              CHARACTER TYPE IS PIT-1V5-2W.
     03  FILLER          PIC  X(01)  VALUE SPACE.
...
****************************************************************
 INIT-SEC              SECTION.
     ...
     DISPLAY   "**  START SNA0191B  **"  UPON CONS.
...
*ファイル ＣＬＯＳＥ
     ...
     CLOSE  HTANMS.
     CLOSE  PRTFILE.
     DISPLAY   "**  END   SNA0191B  **"  UPON CONS.

 END-EXIT.
     EXIT.
*****************<<  SNA0191B   END PROGRAM  >>******************
