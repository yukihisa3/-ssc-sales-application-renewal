...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY1211B.COB`
...
*
 ...
 FILE-CONTROL.
*----<< 基本情報ファイル >>--*
     SELECT   KNJOHOF   ASSIGN    TO        DA-01-VI-KNJOHOL2
...
*----<< ピッキングリスト発行ワーク >>----*
     SELECT   KNPKLBWK  ASSIGN    TO        DA-01-VS-KNPKLBWK
...
*    ピッキングリスト発行ワーク
******************************************************************
 FD  KNPKLBWK           LABEL     RECORD   IS   STANDARD.
     COPY     KNPKLBWK  OF        XFDLIB
...
*    ｶｳﾝﾄ
 ...
 01  WK-INV-FLG.
     03  KNPKLBWK-INV-FLG    PIC  X(03)     VALUE  SPACE.
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY1211B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY1211B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
****************************************************************
 INIT-SEC               SECTION.
     ...
     OPEN     INPUT     KNJOHOF  SHTDENLA.
     OPEN     OUTPUT    KNPKLBWK.
*
...
*T
     ...
     MOVE      PARA-IN-SCENTER TO   JOH-FA02.
     MOVE      PARA-IN-TORICD  TO   JOH-FA07.
     IF        PARA-IN-TORICD  =  23631
               MOVE  2363      TO   JOH-FA07
     END-IF.
     MOVE      PARA-IN-SROUTE  TO   JOH-FA08.
     MOVE      PARA-IN-SBUMON  TO   JOH-FA03.
     MOVE      PARA-IN-HDATE   TO   WK-HDATE.
     MOVE      WK-HDATE2       TO   JOH-FA04.
     MOVE      PARA-IN-NDATE   TO   WK-NDATE.
     MOVE      WK-NDATE2       TO   JOH-FA05.
     MOVE      PARA-IN-STANA   TO   JOH-FC01.
...
*********IF     JOH-FA07     =  PARA-IN-TORICD
         IF     JOH-FA07     =  WK-PARA-IN-TORICD
                CONTINUE
         ELSE
                GO          TO   MAIN999
        END-IF
...
*
     CLOSE     KNJOHOF  KNPKLBWK  SHTDENLA.
*
