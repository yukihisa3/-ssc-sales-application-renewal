...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SER0040L.COB`
...
*
 ...
 FILE-CONTROL.
****<<Ｄ３６５累積ファイル>>********************************
     SELECT  ERRRUIL5  ASSIGN    TO        ERRRUIL5
...
***** メッセージエリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SER0040L".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SER0040L".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND1.
...
***** 見出し行１
 01  HD01.
     ...
     03  FILLER                PIC  X(08)  VALUE  "SER0040L".
     03  FILLER                PIC  X(13)  VALUE  SPACE.
     03  FILLER                PIC  N(15)
             VALUE NC"＜　エラーデータ状況リスト　＞"
...
***** 見出し行３
 01  HD03.
     ...
     03  FILLER                PIC  N(04)  VALUE  NC"担当者："
                               CHARACTER   TYPE IS   PITCH-15.
     03  HD03-JTANCD           PIC  X(02).
     03  FILLER                PIC  X(01)  VALUE  SPACE.
     03  HD03-JTANNM           PIC  N(10)
                               CHARACTER   TYPE IS   PITCH-15.
***** 見出し行４
 01  HD04.
...
*             プロセス                      0.0                *
****************************************************************
 SER0040L-START         SECTION.
*
     MOVE   "SER0040L-START"      TO   S-NAME.
     PERFORM            INIT-SEC.
*
     IF    END-FLG    NOT =  "END"
