...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY3993B.COB`
...
* 基本情報ファイルの初期読み込み
     ...
     INITIALIZE                 JR3-REC.
     MOVE  PA-JYUSNDT       TO  JR3-F01.  *> 受信日
