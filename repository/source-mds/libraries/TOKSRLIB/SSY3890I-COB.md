...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY3890I.COB`
...
*画面表示用ワーク
 01  DSP-WORK.
     03  WORK-PGID                PIC  X(08)  VALUE  "SSY3890I".
     03  WORK-FORMID              PIC  X(08)  VALUE  "FSY38901".
*システム日付／時刻
 01  TIME-AREA.
...
*
**************************************************************
 PROCEDURE             DIVISION   USING  LINK-SYORIKBN
                                         LINK-KANRINO
                                         LINK-SAKUBA
                                         LINK-KBN.
**************************************************************
