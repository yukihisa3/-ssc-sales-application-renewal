...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SJR0350B.COB`
...
*
 ...
 FILE-CONTROL.
*---<<  返品累積データ  >>---*
     SELECT   COMRHEF   ASSIGN    TO             COMRHEL7
                        ORGANIZATION        IS   INDEXED
                        ACCESS    MODE      IS   SEQUENTIAL
                        RECORD    KEY       IS   RHE-F07
...
**** メッセージ情報  ***
 01  MSG-AREA1-1.
     03  MSG-ABEND1.
       ...
       05  ERR-PG-ID         PIC  X(08)  VALUE  "SJR0350B".
...
**
 ...
 FILEERR-SEC1                SECTION.
     USE AFTER       EXCEPTION
                     PROCEDURE    COMRHEF.
     MOVE     "COMRHEF"      TO   ERR-FL-ID.
     MOVE     RHE-STATUS     TO   ERR-STCD.
...
*-------------------------------------------------------------*
 END-SEC                SECTION.
     CLOSE              COMRHEF  HJYOKEN.
     DISPLAY  "DELDATE         = "  WK-DEL-DATE   UPON   CONS.
     DISPLAY  "COMRHEF    (IN) = "  READ-CNT      UPON   CONS.
     DISPLAY  "COMRHEF   (DEL) = "  DEL-CNT       UPON   CONS.
 END-END.
     EXIT.
******************<<  PROGRAM  END  >>**************************
