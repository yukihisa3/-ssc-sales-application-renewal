...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY1336B.COB`
...
*
 ...
 FILE-CONTROL.
*----<< 基本情報ファイル >>--*
     SELECT   KNJOHOF   ASSIGN    TO        DA-01-VI-KNJOHOL5
...
*----<< 売上伝票ファイル >>----*
     SELECT   SHTDENLB  ASSIGN    TO        DA-01-VI-SHTDENLB
                        ORGANIZATION        INDEXED
                        ACCESS    MODE      RANDOM
...
*    ｶｳﾝﾄ
 ...
 01  WK-INV-FLG.
     03  KNSNDCGW-INV-FLG    PIC  X(03)     VALUE  SPACE.
     03  SHTDENLB-INV-FLG    PIC  X(03)     VALUE  SPACE.
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY1336B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY1336B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
****************************************************************
 INIT-SEC               SECTION.
     ...
     OPEN     I-O       KNJOHOF.
     OPEN     INPUT     SHTDENLB.
     OPEN     OUTPUT    KNSNDCGW.
*
     DISPLAY  MSG-START UPON CONS.
*
     MOVE     ZERO      TO        END-FLG   WK-CNT.
     MOVE     SPACE     TO        WK-INV-FLG SHTDENLB-INV-FLG.
*
******************
*システム日付編集*
******************
...
*    MOVE     JOH-FA05               TO  LINK-IN-YMD6.
     ...
     READ     SHTDENLB
       INVALID
             ...
             DISPLAY NC"相手商品ＣＤ＝" JOH-FB05       UPON CONS
...
*
     ...
     END-IF.
*
     CLOSE     KNJOHOF  KNSNDCGW  SHTDENLB.
*
