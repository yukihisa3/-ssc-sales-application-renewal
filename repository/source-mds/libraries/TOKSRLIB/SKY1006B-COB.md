...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SKY1006B.COB`
...
*    更新概要　　　　　　：　基幹サーバ統合　　　　　　　　　　*
*    更新日／更新者　　　：　13/05/22 /TAKAHASHI.T             *
*    更新概要　　　　　　：　ドイトの場合、法人ＣＤは出力を　　*
*                            止める。                          *
****************************************************************
...
*    帳票初期化
     MOVE     SPACE              TO   FKY10062.
*    ワーク初期化
     MOVE     ZERO               TO   DENNO1.
     MOVE     ZERO               TO   CNT-DENPYO.
     MOVE     SPACE              TO   END-FLG.
     MOVE     SPACE              TO   FKY10061.
*
 INIT-EXIT.
     EXIT.
****************************************************************
