...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SFU0120N.COB`
...
****  フラグ  ***
 01  PSW-AREA.
     ...
     02  MEIMS1-INV-FLG      PIC  X(03)  VALUE SPACE.
     02  TAISYOU-FLG         PIC  X(01)  VALUE SPACE.
 01  CNT-AREA.
...
**** メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SFU0120N".
...
*          GO TO                  READ-FURIKAF-SEC
*****END-IF.
*2016/12/23 NAV ST 更新条件変更
*管理区分＝３で伝区＝７０で振替連携対象商品の場合、在庫更新は
*行わない。（在庫更新を行わない場合は更新区分に２セット）
*上記以外のデータは今まで通り更新する。
     MOVE  FUR-F10           TO   MEI-F011.
     MOVE  FUR-F11(1:5)      TO   MEI-F0121.
     MOVE  FUR-F11(6:2)      TO   MEI-F0122.
     MOVE  FUR-F11(8:1)      TO   MEI-F0123.
...
*
     READ     MEIMS1
              INVALID     MOVE  "INV"    TO  MEIMS1-INV-FLG
                          MOVE  SPACE    TO  TAISYOU-FLG
              NOT INVALID MOVE  SPACE    TO  MEIMS1-INV-FLG
                          MOVE  MEI-FIL1 TO  TAISYOU-FLG
     END-READ.
*
 HMEIMS-READ-EXIT.
     EXIT.
*2016/12/23 NAV ED 商品名称マスタ読込追加
******************<<  PROGRAM  END  >>**************************
