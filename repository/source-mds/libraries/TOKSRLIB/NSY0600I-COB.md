...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NSY0600I.COB`
...
*                                                              *
**履歴**********************************************************
*    2021/02/18  高橋　　新規作成（ＳＳＹ９２０９Ｉコピー）　　*
*    0000/00/00　　　　　　　　　　　　　　　　　　　　　　　　*
****************************************************************
...
*店舗コード範囲
     IF     DSP-STTEN  NOT NUMERIC
            MOVE     ZERO     TO    DSP-STTEN
     END-IF.
*
     IF     DSP-EDTEN  NOT NUMERIC
            MOVE     99999    TO    DSP-EDTEN
     END-IF.
*
*店舗大小チェック
     IF       DSP-STTEN  >  DSP-EDTEN
              MOVE   11    TO   ERR-FLG
              MOVE  "R"    TO   EDIT-OPTION  OF  DSP-STTEN
              MOVE  "R"    TO   EDIT-OPTION  OF  DSP-EDTEN
              MOVE  "C"    TO   EDIT-CURSOR  OF  DSP-STTEN
              GO           TO   PARA-CHK-EXIT
     ELSE
              MOVE  "M"    TO   EDIT-OPTION  OF  DSP-STTEN
              MOVE  "M"    TO   EDIT-OPTION  OF  DSP-EDTEN
              MOVE  SPACE  TO   EDIT-CURSOR  OF  DSP-EDTEN
     END-IF.
*    部門コードチェック
*
     MOVE    "2"       TO    PSW.
...
*
     MOVE     "NSY0600I"          TO   DSP-PGID.
     MOVE     "FSY06001"          TO   DSP-FMID.
*エラーメッセージセット
     IF    ERR-FLG   =    ZERO
