...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NVD045R1.COB`
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "NVD045R1".
...
****************************************************************
 PROCEDURE                   DIVISION
                                USING PARA-STDENNO  PARA-EDDENNO.
****************************************************************
 DECLARATIVES.
...
*計上ＦＬＧ、連携日、連携時刻初期化
     ...
     MOVE     20210901        TO   DNS-F18.
*    MOVE     "1"             TO   DNS-F22
*    MOVE     20210805        TO   DNS-F23
*    MOVE     164957          TO   DNS-F24
     REWRITE  DNS-REC.
     ADD      1               TO   OUT-CNT.
