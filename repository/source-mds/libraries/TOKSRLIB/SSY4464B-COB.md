...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY4464B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY4464B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY4464B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*#2019/08/21 NAV ST
     MOVE     HAC-FIL4(98:3) TO      WK-RUT-F03.
     DISPLAY "WK-RUT-F03= " WK-RUT-F03 UPON CONS.
     MOVE     WK-RUT-F03(2:2)  TO    RUT-F03.
*#2019/08/21 NAV ED
*2013/02/01↑
     READ     JHMRUTL1
         INVALID
