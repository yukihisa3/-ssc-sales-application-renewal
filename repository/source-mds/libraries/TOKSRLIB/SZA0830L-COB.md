...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SZA0830L.COB`
...
****  見出し行１             ****
 01  MIDASI-1.
     ...
     02  FILLER              PIC  X(08)  VALUE  "SZA0830L".
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SZA0830L".
...
*      0.0       全体処理                                  *
************************************************************
 SZA0830L-START         SECTION.
     PERFORM       INIT-SEC.
     PERFORM       MAIN-SEC        UNTIL  END-FLG = "END".
     PERFORM       END-SEC.
     IF   PG-END   NOT =  "END"
          MOVE     SPACE   TO   END-FLG
          GO  TO   SZA0830L-START
     END-IF.
     STOP     RUN.
 SZA0830L-END.
     EXIT.
