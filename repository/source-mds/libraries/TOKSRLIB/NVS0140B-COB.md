...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NVS0140B.COB`
...
*ファイル読込み
     ...
     END-READ.
*
     DISPLAY "KAI-F07 = " KAI-F07  UPON CONS.
     IF  KAI-F07  =  "1"
         MOVE    "1"         TO   LINK-KEKA
         DISPLAY NC"＃＃回線使用中！！＃＃" UPON CONS
     ELSE
         DISPLAY NC"＃＃回線未使用！！＃＃" UPON CONS
         MOVE    "0"         TO   LINK-KEKA
         MOVE    "1"         TO   KAI-F07
         REWRITE  KAI-REC
     END-IF.
