...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY9599B.COB`
...
*
 ...
 FILE-CONTROL.
*----<< 旧.ファイル >>--*
     SELECT   OLDCHGPF  ASSIGN         DA-01-VS-OLDCHGPF
                        ORGANIZATION   SEQUENTIAL
                        ACCESS    MODE SEQUENTIAL
                        STATUS         OLDCHGPF-ST.
*----<< 新.ファイル >>--*
     SELECT   YODCHGPF  ASSIGN         DA-01-VS-YODCHGPF
                        ORGANIZATION   SEQUENTIAL
                        ACCESS    MODE SEQUENTIAL
                        STATUS         YODCHGPF-ST.
*----<< 参照ファイル >>--*
...
****************************************************************
 FILE                   SECTION.
*----<< 旧.ファイル >>--*
 FD  OLDCHGPF            LABEL     RECORD   IS   STANDARD.
     COPY     OLDCHGPF   OF        XFDLIB
              JOINING    OLD       PREFIX.
*----<< 新.ファイル >>--*
 FD  YODCHGPF            LABEL     RECORD   IS   STANDARD.
...
*
*----<< ﾌｱｲﾙ ｽﾃｰﾀｽ >>--*
 01  OLDCHGPF-ST       PIC  X(02).
 01  YODCHGPF-ST       PIC  X(02).
...
*--------------------------------------------------------------*
 DECLARATIVES.
*----<< 旧.ファイル >>--*
 OLDCHGPF-ERR            SECTION.
     USE AFTER     EXCEPTION PROCEDURE      OLDCHGPF.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY9599B OLDCHGPF ERROR " OLDCHGPF-ST " "
     ...
     STOP     RUN.
*----<< 新.ファイル >>--*
 YODCHGPF-ERR            SECTION.
     USE AFTER     EXCEPTION PROCEDURE      YODCHGPF.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY9599B YODCHGPF ERROR " YODCHGPF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 参照ファイル >>--*
 YODMEIL1-ERR            SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SSY9599B YODMEIL1 ERROR " YODMEIL1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "*** SSY9599B START *** "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS
                                       UPON CONS.
     OPEN     INPUT     OLDCHGPF.
     OPEN     INPUT     YODMEIL1.
     OPEN     OUTPUT    YODCHGPF.
*
 100-INIT-RTN-EXIT.
     EXIT.
*--------------------------------------------------------------*
