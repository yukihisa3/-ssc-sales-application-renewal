...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NVS0290D.COB`
...
*計上データバックアップ
     SELECT   BBSHTDEN  ASSIGN    TO        DA-01-S-BBSHTDEN
                        FILE      STATUS    IS   BBS-STATUS.
*********
 DATA                   DIVISION.
 FILE                   SECTION.
******************************************************************
...
*    ｶｳﾝﾄ
 ...
 01  BBS-CNT                 PIC  9(08)     VALUE  ZERO.
...
*
 01  WK-ST.
     ...
     03  BBS-STATUS        PIC  X(02).
*
 01  MSG-AREA.
     03  MSG-START.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  ST-PG          PIC   X(08)  VALUE "NVS0290D".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NVS0290D".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*
 FILEERR-SEC3           SECTION.
     USE       AFTER    EXCEPTION
                        PROCEDURE   BBSHTDEN.
     MOVE      "BBSHTDEN"   TO   AB-FILE.
     MOVE      BBS-STATUS   TO   AB-STS.
     DISPLAY   MSG-ABEND         UPON CONS.
     DISPLAY   SEC-NAME          UPON CONS.
     DISPLAY   ABEND-FILE        UPON CONS.
     MOVE      4000         TO   PROGRAM-STATUS.
...
*
     ...
     END-IF.
*
     MOVE    SPACE               TO   BBS-REC.
     INITIALIZE                       BBS-REC.
     MOVE    DEN-REC             TO   BBS-REC.
     WRITE   BBS-REC.
     ADD     1                   TO   BBS-CNT.
     DELETE  SHTDENL1.
     ADD       1                 TO   DEN-CNT.
...
*
     DISPLAY "RD-CNT   = " RD-CNT   UPON CONS.
     DISPLAY "DLT-CNT  = " DEN-CNT  UPON CONS.
     DISPLAY "BAK-CNT  = " BBS-CNT  UPON CONS.
     DISPLAY "SKP1-CNT = " SKP1-CNT UPON CONS.
*
     CLOSE     CANSENK1  SHTDENL1  BBSHTDEN.
*
     STOP      RUN.
*
 END-EXIT.
