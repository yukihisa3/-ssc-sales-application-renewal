...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NCV3105B.COB`
...
*    処理概要　　　　　　：　　　　　　　　　　　　　　　　　　*
*                            （ケーヨー資材／植物、東／西）    *
*    PARA:1  TOKCD:1731   FILEID:KEYOHAZ1.ONLBLIB              *
*    PARA:2  TOKCD:1732   FILEID:KEYOHAZ2.ONLBLIB              *
*    PARA:3  TOKCD:7601   FILEID:KEYOHAS1.ONLBLIB              *
*    PARA:4  TOKCD:7602   FILEID:KEYOHAS2.ONLBLIB              *
****************************************************************
 IDENTIFICATION        DIVISION.
 PROGRAM-ID.           NCV3105B.
 AUTHOR.               NAV.
 DATE-WRITTEN.         18/02/14.
****************************************************************
...
*区分により取引先ＣＤ判定
     EVALUATE  LINK-KBN
         WHEN  "1"   MOVE  1731    TO    WK-TORICD
                     DISPLAY NC"＃ケーヨー資材　東＃" UPON CONS
         WHEN  "2"   MOVE  1732    TO    WK-TORICD
                     DISPLAY NC"＃ケーヨー資材　西＃" UPON CONS
         WHEN  "3"   MOVE  7601    TO    WK-TORICD
                     DISPLAY NC"＃ケーヨー植物　東＃" UPON CONS
         WHEN  "4"   MOVE  7602    TO    WK-TORICD
                     DISPLAY NC"＃ケーヨー植物　西＃" UPON CONS
         WHEN  OTHER MOVE "4000"   TO    PROGRAM-STATUS
                     STOP  RUN
     END-EVALUATE.
*システム日付取得／時刻取得
...
*ファイル名セット
     EVALUATE  LINK-KBN
         WHEN  "1"
         MOVE  "KEYOHAZ1"   TO     LINK-FILNM
         WHEN  "2"
         MOVE  "KEYOHAZ2"   TO     LINK-FILNM
         WHEN  "3"
         MOVE  "KEYOHAS1"   TO     LINK-FILNM
         WHEN  "4"
         MOVE  "KEYOHAS2"   TO     LINK-FILNM
     END-EVALUATE.
