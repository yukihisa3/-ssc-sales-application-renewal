...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NKE0022B.COB`
...
*#2019/06/13 NAV ED
     COPY   SNDSKDF   OF  XFDLIB  JOINING  BK-SDE  AS   PREFIX.
*
*    ｶｳﾝﾄ
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NKE0022B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NKE0022B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    入数換算ワーク
 01  CAL-AREA.
     03  CAL-SYO            PIC   9(09).
     03  CAL-AMARI          PIC   9(09).
     03  CAL-SURYO          PIC   9(09).
     03  OUT2-FLG           PIC   X(01).
     03  CAL-DENNO          PIC   9(09).
     03  CAL-DENNO-MIN      PIC   9(09).
     03  CAL-DENNO-MAX      PIC   9(09).
 01  LINK-AREA.
...
****************************************************************
 INIT-SEC               SECTION.
     ...
     OPEN     INPUT     SHTDENLA  SHOTBL1   SUBTBLL1.
 ...
 INIT-000.
     ...
     READ     JYOKEN1
        INVALID
              ...
              DISPLAY   "F01=36 F02=" PARA-TORICD UPON CONS
              MOVE    4000   TO   PROGRAM-STATUS
              MOVE    9      TO   END-FG
              GO             TO   INIT-EXIT
     END-READ.
     MOVE     JYO-F04        TO   CAL-DENNO.
     MOVE     JYO-F05        TO   CAL-DENNO-MIN.
     MOVE     JYO-F06        TO   CAL-DENNO-MAX.
 INIT-001.
...
*    DISPLAY "SUB-F15  =" SUB-F15   UPON CONS.
*    DISPLAY "CAL-SYO  =" CAL-SYO   UPON CONS.
*    DISPLAY "CAL-AMARI=" CAL-AMARI UPON CONS.
*    DISPLAY "********"             UPON CONS.
*T↑
     IF       CAL-SYO  >=    1
              MOVE    "1"    TO   OUT2-FLG
              COMPUTE  CAL-SURYO  =  CAL-SYO  *  SUB-F15
*T↓
*    DISPLAY "********"             UPON CONS
*    DISPLAY "CAL-SURYO=" CAL-SURYO UPON CONS
*    DISPLAY "********"             UPON CONS
*T↑
              GO             TO   MAIN-B
     END-IF.
...
*ここから
     IF     ( OUT2-FLG      =  "1"  ) AND
            ( CAL-AMARI NOT =  ZERO )
              MOVE  BK-SDE-REC  TO   SDE-REC
*             数量置き換え
              MOVE  CAL-AMARI   TO   WK-HEN
              MOVE  WK-HEN-1    TO   WK-HEN1-2
              MOVE  "."         TO   WK-HEN1-3
              MOVE  WK-HEN-2    TO   WK-HEN1-4
              MOVE  WK-HEN1     TO   SDE-F11
*             伝票_カウントアップ
              ADD   1           TO   CAL-DENNO
*             MAX越えたら開始値に戻す
              IF    CAL-DENNO   >    CAL-DENNO-MAX
                    MOVE  CAL-DENNO-MIN  TO  CAL-DENNO
              END-IF
              MOVE  CAL-DENNO   TO   SDE-F02
*             ＷＲＩＴＥ
              WRITE    SDE-REC
              ADD      1        TO   WT-CNT
     END-IF.
