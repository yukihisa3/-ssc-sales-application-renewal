...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NVS0252B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NVS0252B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NVS0252B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*****DISPLAY "KEJ-F01 = " DEN-F01  UPON CONS.
*    DISPLAY "KEJ-F02 = " DEN-F02  UPON CONS.
*    DISPLAY "KEJ-F03 = " DEN-F04  UPON CONS.
*    DISPLAY "KEJ-F04 = " DEN-F051 UPON CONS.
*    DISPLAY "KEJ-F05 = " DEN-F07  UPON CONS.
*    DISPLAY "KEJ-F06 = " DEN-F112 UPON CONS.
*****DISPLAY "KEJ-F07 = " DEN-F03  UPON CONS.
     READ     SHTDENL1
              INVALID
