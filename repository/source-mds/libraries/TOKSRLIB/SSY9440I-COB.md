...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY9440I.COB`
...
*画面表示用ワーク
 01  DSP-WORK.
     03  WORK-PGID                PIC  X(08)  VALUE  "SSY9440I".
     03  WORK-FORMID              PIC  X(08)  VALUE  "FSY94401".
*フラグ領域
 01  FLG-AREA.
...
*    規定値チェック
     IF     ( DSP-DENKBN NOT = " " )
        AND ( DSP-DENKBN NOT = "1" )
              MOVE   9       TO   ERR-FLG
              MOVE  "R"      TO   EDIT-OPTION  OF  DSP-DENKBN
              MOVE  "C"      TO   EDIT-CURSOR  OF  DSP-DENKBN
              GO             TO   PARA-CHK-EXIT
     ELSE
              MOVE  "M"      TO   EDIT-OPTION  OF  DSP-DENKBN
              MOVE  SPACE    TO   EDIT-CURSOR  OF  DSP-DENKBN
     END-IF.
*
     IF       ERR-FLG  =  0
         IF   DSP-DENKBN  =  "1"
...
*               MOVE    DSP-TDATE     TO   LINK-TDATE
                ...
                MOVE    DSP-DENKBN    TO   LINK-DENKBN
