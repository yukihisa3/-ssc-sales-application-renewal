...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY1220I.COB`
...
*----<< 表示ファイル >>--*
     SELECT   DSPFILE   ASSIGN         01-GS-DSPF
                        ...
                        STATUS         DSP-ST.
*----<< 基本情報ファイル >>--*
     SELECT   KNJOHOF   ASSIGN         DA-01-VI-KNJOHOL5
                        ...
                        STATUS         KNJOHOF-ST.
*----<< 箱数ファイル >>--*
     SELECT   KNHAKOF   ASSIGN         DA-01-VI-KNHAKOL1
                        ORGANIZATION   INDEXED
                        ACCESS    MODE SEQUENTIAL
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SSY1220I DSPFILE ERROR " DSP-CNTL " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
     MOVE     4000           TO     PROGRAM-STATUS.
*    CLOSE    KNJOHOF   KNHAKOF   HTOKMS    ZSOKMS1    DSPFILE.
     STOP     RUN.
*----<< 基本情報ファイル >>--*
 KNJOHOF-ERR            SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY1220I KNJOHOL5 ERROR " KNJOHOF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 箱数ファイル >>--*
 KNHAKOF-ERR            SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY1220I KNHAKOL1 ERROR " KNJOHOF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY1220I HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY1220I ZSOKMS1 ERROR " ZSOKMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*
     MOVE    "SSY1220I"      TO   PGID.
     MOVE    "FSY12201"      TO   FORM.
...
*
 220-SONZAI-CHECK2-021.
     IF ( HAK-F001  NOT =    JDATE    ) OR
        ( HAK-F002  NOT =    JTIME    ) OR
        ( HAK-F003  NOT =    TORICD   )
          MOVE   0  TO   HIT-FLG
          GO        TO   220-SONZAI-CHECK2-EXIT
     END-IF.
...
*
 220-SONZAI-CHECK2-04.
     IF ( SOKO      NOT =    SPACE    ) AND
        ( WK-NOUHIN NOT =    ZERO     )
        IF    ( HAK-F004     =   SOKO       ) AND
              ( HAK-FA05     =   WK-NOUYMD2 )
                MOVE  6   TO   ERR-FLG
                MOVE  1   TO   HIT-FLG
                MOVE "C"  TO   EDIT-CURSOR OF JDATE
...
*
     MOVE     " "            TO   EDIT-CURSOR OF NOUYY
                                  EDIT-CURSOR OF NOUMM
                                  EDIT-CURSOR OF NOUDD.
     MOVE     "M"            TO   EDIT-OPTION OF NOUYY
