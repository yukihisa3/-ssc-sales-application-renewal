...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NJH1209B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH1209B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH1209B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*ケースＰＤラベルレコード
     IF   DEN-01A  =     "PP"
          ...
          MOVE     WK-PPDT09       TO     JOH-FA07
          MOVE     WK-PPDT10       TO     JOH-FA08
          MOVE     WK-PPDT06       TO     JOH-FA03
          MOVE     WK-PPDT07       TO     JOH-FA04
          MOVE     WK-PPDT08       TO     JOH-FA05
          MOVE     WK-PPDT02       TO     JOH-FA06
          MOVE     WK-PPDT04       TO     JOH-FB11
