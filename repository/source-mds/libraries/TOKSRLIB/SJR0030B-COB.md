...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SJR0030B.COB`
...
*
 ...
 FILE-CONTROL.
*返品データファイル
     SELECT   EDHENPL1  ASSIGN    TO        DA-01-VI-EDHENPL1
...
*    返品データ
******************************************************************
 FD  EDHENPL1           LABEL RECORD   IS   STANDARD.
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJR0030B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJR0030B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*商品変換ＴＢＬ索引
     ...
     MOVE     ONL-F306(2:13) TO        TBL-F02.
     PERFORM  HSHOTBL-READ-SEC.
*原単価
     IF     ( ONL-F314 NOT NUMERIC ) OR
            ( ONL-F314 =   ZERO    )
...
*相手商品コード
*# 2020/08/04 NAV ST
*****MOVE     ONL-F306       TO        RUI-F33.
     MOVE     ONL-F306(2:13) TO        RUI-F33.
*# 2020/08/04 NAV ED
*数量
*    MOVE     ONL-F318       TO        RUI-F34.
     COMPUTE  RUI-F34   =    ONL-F318  /   10.
*原単価
     IF       WK-ERR-GENTANKA  NOT =  "1"
*             MOVE  ONL-F314 TO        RUI-F35
              COMPUTE   RUI-F35    =   ONL-F314  /  100
     END-IF.
*原価金額
*    MOVE     ONL-F315       TO        RUI-F36.
     COMPUTE  RUI-F36   =    ONL-F315  /   100.
*商品名カナ１
     MOVE     ONL-F310       TO        RUI-F37.
*商品名カナ２
     MOVE     ONL-F311       TO        RUI-F38.
*返品理由
     MOVE     ONL-F305       TO        RUI-F39.
*訂正区分（Ｍ）
*    F40 : INIT
*売単価
*    MOVE     ONL-F316       TO        RUI-F41.
