...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SFU3010I.COB`
...
*    顧客名　　　　　　　：　（株）サカタのタネ殿　　　　　　　*
*    業務名　　　　　　　：　社内振替　　　　　                *
*    モジュール名　　　　：　社内振替発注ＥＸＣＥＬ件数確認    *
*    作成日／作成者　　　：　2016/12/19 INOUE                  *
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SFU3010I DSPFILE ERROR " DSP-ST " "
...
*----<< 担当者マスタ >>--*
 TANMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SFU3010I TANMS1 ERROR " TAN-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE               TO   DSP-FFU30101.
*
*    PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "SFU3010I"      TO   DSP-PGID.
     MOVE    "FFU30101"      TO   DSP-FORMID.
*モード表示
     IF       PARA-IN-JKUBUN        =   "1"
              MOVE NC"チェックのみ　"        TO   DSP-MODE
     END-IF.
     IF       PARA-IN-JKUBUN        =   "2"
              MOVE NC"チェック・取込"        TO   DSP-MODE
     END-IF.
*担当者名称取得
