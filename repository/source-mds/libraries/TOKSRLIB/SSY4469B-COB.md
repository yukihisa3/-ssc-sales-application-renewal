...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY4469B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY4469B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY4469B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*2013/02/01↓
*01  WK-DEN-NO.
*****03  WK-DEN-S          PIC        X(07).
*****03  WK-DEN-S-R        REDEFINES WK-DEN-S.
*****    05  WK-DEN-H       PIC       9(07).
 01  WK-DEN-NO.
...
*2024/10/28↓１行目が変換ＴＢＬ未登録の場合は代表をセット
         IF    SYUKA-BASYO  =  SPACE
...
*2023.04.20
*納品経路
     MOVE  HAC-F330(1:2)   TO        HEN-XI0001.
*システム日付
...
*納品先がセンターの場合、センターＣＤをセット
*　　　　　　　　　センター以外は０にセット
     IF    HAC-F330  =  "01"
           MOVE  ZERO      TO        HEN-F40
     ELSE
           MOVE  HAC-F304(1:5)  TO   WK-CEN-S
           MOVE  WK-CEN-H       TO   HEN-F40
     END-IF.
*ルート
*2022.04.20
*----MOVE     HAC-F328     TO        HEN-F42.
     MOVE     HEN-F48      TO        HEN-F42(1:2).
     IF       HAC-F330(1:2) = "01"
              MOVE   "T"   TO        HEN-F42(3:1)
     ELSE
         IF   HAC-F330(1:2) = "02"
              MOVE   "C"             TO  HEN-F42(3:1)
              MOVE   HAC-F304(1:5)   TO  HEN-F42(4:5)
         ELSE
              MOVE   "M"   TO        HEN-F42(3:1)
         END-IF
     END-IF.
*注文番号（新）←納品先ＣＤ
*2022.04.20
     MOVE     HAC-F304(1:5)  TO      HEN-F44(1:5).
     MOVE     HAC-F308(1:5)  TO      HEN-F44(6:5).
*
*出力
     WRITE  HEN-REC.
*
