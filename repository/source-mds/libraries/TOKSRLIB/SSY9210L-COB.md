...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY9210L.COB`
...
*                        ：　（オフライン対応）                *
**履歴**********************************************************
*    2018/02/23  高橋　　新規作成（ＳＳＹ９１１０Ｌコピー）　　*
*    0000/00/00　　　　　　　　　　　　　　　　　　　　　　　　*
****************************************************************
****************************************************************
...
*
 ...
 01  PG-ID             PIC  X(08)      VALUE  "SSY9210L".
 01  WK-MSG1           PIC  N(14)
...
*--------------------------------------------------------------*
 ...
 LBLERR                 SECTION.
     ...
     DISPLAY  "### SSY9210L LBL ERROR " LBL-ST " "
 ...
 PRTERR                 SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY9210L PRTFILE ERROR " PRT-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     MOVE     4000           TO        PROGRAM-STATUS.
