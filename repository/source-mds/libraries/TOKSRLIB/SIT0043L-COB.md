...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SIT0043L.COB`
...
****  見出し行１             ****
 01  MIDASI-1.
     ...
     02  FILLER              PIC  X(08)  VALUE  "SIT0043L".
...
*
 ...
 01  PARA-UPDTTIME-F       PIC 9(06).
 01  PARA-UPDTDATE-T       PIC 9(08).
 01  PARA-UPDTTIME-T       PIC 9(06).
******************************************************************
*             PROCEDURE           DIVISION                       *
******************************************************************
...
*マスタ更新履歴ファイル初期ＲＥＡＤ
     ...
     MOVE     PARA-UPDTTIME-F     TO   MSL-F06.
...
*
     ...
     END-IF.
*
     IF   ( MSL-F06  <  PARA-UPDTTIME-F ) OR
          ( MSL-F06  >  PARA-UPDTTIME-T )
            GO                TO        READMSL-01
     END-IF.
*
...
*
     ...
     DISPLAY "SIT0043L READ =" READ-CNT NC"件" UPON CONS.
...
*#2019/06/19 NAV ST
      ...
      WHEN  1    MOVE   NC"モジュラス７ＤＳＲ"   TO MEISAI-17-L
      WHEN  2    MOVE   NC"モジュラス１０Ｗ１２" TO MEISAI-17-L
      WHEN  3    MOVE   NC"モジュラス１１"       TO MEISAI-17-L
      WHEN  4    MOVE   NC"モジュラス１１Ｐ２"   TO MEISAI-17-L
      WHEN  5    MOVE   NC"モジュラス１１Ｐ１３" TO MEISAI-17-L
      WHEN  6    MOVE   NC"モジュラス７ＤＲ"     TO MEISAI-17-L
      WHEN  7    MOVE   NC"モジュラス１０Ｗ１３" TO MEISAI-17-L
      WHEN  8    MOVE   NC"モジュラス１０Ｗ３"   TO MEISAI-17-L
...
*#2019/06/19 NAV ST
      WHEN  0    MOVE   NC"なし"                 TO MEISAI-18-L
      WHEN  1    MOVE   NC"モジュラス７ＤＳＲ"   TO MEISAI-18-L
      WHEN  2    MOVE   NC"モジュラス１０Ｗ１２" TO MEISAI-18-L
      WHEN  3    MOVE   NC"モジュラス１１"       TO MEISAI-18-L
      WHEN  4    MOVE   NC"モジュラス１１Ｐ２"   TO MEISAI-18-L
      WHEN  5    MOVE   NC"モジュラス１１Ｐ１３" TO MEISAI-18-L
      WHEN  6    MOVE   NC"モジュラス７ＤＲ"     TO MEISAI-18-L
      WHEN  7    MOVE   NC"モジュラス１０Ｗ１３" TO MEISAI-18-L
      WHEN  8    MOVE   NC"モジュラス１０Ｗ３"   TO MEISAI-18-L
      WHEN OTHER MOVE   NC"？？？？？？？"       TO MEISAI-18-L
*#2019/06/19 NAV ED
     END-EVALUATE.
*  ☆税計算区分
...
*#2019/06/19 NAV ST
      WHEN  0    MOVE   NC"なし"                 TO MEISAI-17-R
      WHEN  1    MOVE   NC"モジュラス７ＤＳＲ"   TO MEISAI-17-R
      WHEN  2    MOVE   NC"モジュラス１０Ｗ１２" TO MEISAI-17-R
      WHEN  3    MOVE   NC"モジュラス１１"       TO MEISAI-17-R
      WHEN  4    MOVE   NC"モジュラス１１Ｐ２"   TO MEISAI-17-R
      WHEN  5    MOVE   NC"モジュラス１１Ｐ１３" TO MEISAI-17-R
      WHEN  6    MOVE   NC"モジュラス７ＤＲ"     TO MEISAI-17-R
      WHEN  7    MOVE   NC"モジュラス１０Ｗ１３" TO MEISAI-17-R
      WHEN  8    MOVE   NC"モジュラス１０Ｗ３"   TO MEISAI-17-R
      WHEN OTHER MOVE   NC"？？？？？？？"       TO MEISAI-17-R
*#2019/06/19 NAV ED
     END-EVALUATE.
...
*#2019/06/19 NAV ST
      WHEN  0    MOVE   NC"なし"                 TO MEISAI-18-R
      WHEN  1    MOVE   NC"モジュラス７ＤＳＲ"   TO MEISAI-18-R
      WHEN  2    MOVE   NC"モジュラス１０Ｗ１２" TO MEISAI-18-R
      WHEN  3    MOVE   NC"モジュラス１１"       TO MEISAI-18-R
      WHEN  4    MOVE   NC"モジュラス１１Ｐ２"   TO MEISAI-18-R
      WHEN  5    MOVE   NC"モジュラス１１Ｐ１３" TO MEISAI-18-R
      WHEN  6    MOVE   NC"モジュラス７ＤＲ"     TO MEISAI-18-R
      WHEN  7    MOVE   NC"モジュラス１０Ｗ１３" TO MEISAI-18-R
      WHEN  8    MOVE   NC"モジュラス１０Ｗ３"   TO MEISAI-18-R
      WHEN OTHER MOVE   NC"？？？？？？？"       TO MEISAI-18-R
*#2019/06/19 NAV ED
     END-EVALUATE.
