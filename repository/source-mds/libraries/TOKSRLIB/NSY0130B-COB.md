...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NSY0130B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NSY0130B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NSY0130B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*    ＤＣＭＪＡＰＡＮ出荷情報スタート
     ...
     START    DNSYUKF   KEY  >=   DJS-K01   DJS-K02
                                  DJS-K03   DJS-K04
                                  DJS-K08
         INVALID   KEY
              MOVE    "END"  TO   END-FLG
...
*情報データにも書込み
     ...
     READ     DNJOHOF  INVALID
              MOVE     "INV"      TO   DNJOHOF-INV-FLG
              NOT  INVALID
              MOVE     SPACE      TO   DNJOHOF-INV-FLG
     END-READ.
*
...
*
     DISPLAY "DCM SYUKA      READ CNT = " READ-CNT  UPON CONS.
     DISPLAY "DCM SND      ｿｳｼﾝ   CNT = " SND-CNT    UPON CONS.
*
     CLOSE    DNSYUKF  DNJOHOF  SNDDCMJP.
*
     STOP      RUN.
*
 END-EXIT.
