...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SBM0051M.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SBM0051M".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SBM0051M".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*
 01  WK-PARA-TENCD1         PIC   X(13)  VALUE  SPACE.
 01  WK-PARA-TENCD2         PIC   X(13)  VALUE  SPACE.
*パラメタファイルよりセット
 LINKAGE                    SECTION.
...
*
     MOVE     SPACE               TO   WK-PARA-TENCD1.
     MOVE     SPACE               TO   WK-PARA-TENCD2.
     MOVE     PARA-TENCD1(2:4)    TO   WK-PARA-TENCD1(1:4).
     MOVE     PARA-TENCD2(2:4)    TO   WK-PARA-TENCD2(1:4).
*
*ファイル読込処理判定
     EVALUATE PARA-KBN
...
*
     ...
     END-IF.
*店舗ＣＤ順チェック
     IF        DT1-F308   >=   WK-PARA-TENCD1
     AND       DT1-F308   <=   WK-PARA-TENCD2
               CONTINUE
     ELSE
               ADD        1       TO   SKIP-CNT
               GO                 TO   BMSDT1-READ-SEC
...
*
     ...
     END-READ.
*店舗ＣＤ順チェック
     IF        DT2-F308   >=   WK-PARA-TENCD1
     AND       DT2-F308   <=   WK-PARA-TENCD2
               CONTINUE
     ELSE
               ADD        1       TO   SKIP-CNT
