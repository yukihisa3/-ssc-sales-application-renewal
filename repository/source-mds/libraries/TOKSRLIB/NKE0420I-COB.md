...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NKE0420I.COB`
...
*----<< 表示ファイル >>--*
     SELECT   DSPFILE   ASSIGN         01-GS-DSPF
                        ...
                        STATUS         DSP-ST.
*----<< 棚卸確定データ >>--*
     SELECT   RCVTANXX  ASSIGN         DA-01-S-RCVTANXX
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### NKE0420I DSPFILE ERROR " DSP-ST " "
     ...
     STOP     RUN.
*----<< 棚卸確定データ >>--*
 RCVTANXX-ERR             SECTION.
     USE AFTER     EXCEPTION PROCEDURE      RCVTANXX.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### NKE0420I RCVTANXX ERROR " RCV-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### NKE0420I ZSOKMS1 ERROR " SOK-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 担当者マスタ >>--*
 TANMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### NKE0420I TANMS1 ERROR " TAN-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FKE04201.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "NKE0420I"      TO   PGID.
     MOVE    "FKE04201"      TO   FORM.
*
...
*    DISPLAY "TANTOU = " PARA-IN-TANTOU UPON CONS.
     ...
     END-READ.
*
     PERFORM  RCVTANXX-CNT-SEC.
     MOVE     KENSU          TO   TANASU.
     IF       KENSU     =    ZERO
              MOVE      3    TO   ERR-FLG
     END-IF.
*
     MOVE     SPACE          TO   DSP-CNTL.
     MOVE     "FKE04201"     TO   DSP-FMT.
...
*
 ...
 210-DSP-INIT-EXIT.
     EXIT.
*--------------------------------------------------------------*
*    LEVEL  3      棚卸確定データ件数カウント                  *
*--------------------------------------------------------------*
 RCVTANXX-CNT-SEC       SECTION.
     MOVE     "RCVTANXX-CNT-SEC"  TO   S-NAME.
*
 RCVTANXX-CNT-00.
     OPEN     INPUT     RCVTANXX.
     MOVE     ZERO                TO   KENSU.
 RCVTANXX-CNT-01.
     READ      RCVTANXX
        AT END
               GO                 TO   RCVTANXX-CNT-02
        NOT AT END
               ADD      1         TO   KENSU
*              DISPLAY "KENSU="   KENSU UPON CONS
               GO                 TO   RCVTANXX-CNT-01
     END-READ.
 RCVTANXX-CNT-02.
     CLOSE     RCVTANXX.
 RCVTANXX-CNT-EXIT.
