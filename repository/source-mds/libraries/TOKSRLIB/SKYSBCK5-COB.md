...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SKYSBCK5.COB`
...
*    業務名　　　　　：　出荷　　　　　　　　　　　　　　　　　*
*    サブシステム　　：　コーナン　ＥＤＩ　　　　　　　　　　　*
*    モジュール名　　：　ＰＤコードＣ／Ｄ計算サブルーチン　　
*    　　　　　　　　　　IN:１９桁　モジュラス１０　ウェイト３
*    作成日／更新日　：　2020/01/21                            *
*    作成者／更新者　：　NAV                                   *
*                        LO-ERR    :  9:区分，桁数指定エラー   *
*                                     3:非数値エラー　　       *
...
*
     MOVE     LI-CODE             TO    LO-CODE(1:19).
     MOVE     CALC-CD             TO    LO-CODE(20:1).
*
 300-CHECK-CD-EXIT.
     EXIT.
*--------------------------------------------------------------*
