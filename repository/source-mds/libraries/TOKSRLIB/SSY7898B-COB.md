...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY7898B.COB`
...
*
 ...
 FILE-CONTROL.
*---<<  出荷情報データ  >>---*
     SELECT   RHSYUKF   ASSIGN         DA-01-VI-RHSYUKL1
...
*----<< 出荷情報データ >>--*
 KMS-ERR              SECTION.
     ...
     DISPLAY  "### SSY7898B RHSYUKF    ERROR " DHJ-ST " "
...
*----<< 条件ファイル >>--*
 JYO-ERR              SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     "4000"         TO   PROGRAM-STATUS.
     DISPLAY  "### SSY7898B HJYOKEN    ERROR " JYO-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
