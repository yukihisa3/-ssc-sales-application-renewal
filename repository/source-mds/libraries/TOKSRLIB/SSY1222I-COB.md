...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY1222I.COB`
...
*
*---<<  箱数ファイル  >>---*
     SELECT   KNHAKOF   ASSIGN    TO        DA-01-VI-KNHAKOL2
...
****  メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SSY1222I".
...
*      2.1.1     明細セット処理                            *
*==========================================================*
 KNHAKOF-DSP-SUB       SECTION.
*
     PERFORM  EDIT-SET-BODY.
     MOVE     ZERO      TO   ERR-MSG-CD.
*
     MOVE     ZERO      TO   HAK-FLG.
     PERFORM  KNHAKOF-START-SUB.
     IF       HAK-FLG   =    ZERO
              PERFORM   KNHAKOF-READ-SUB
              IF  HAK-FLG = 1
                  IF   ERR-MSG-CD     =    ZERO
...
*
     ...
     START   KNHAKOF     KEY  >=  HAK-F001 HAK-F002 HAK-F003
...
*      2.1.1.2   箱数ファイル　　　ＲＥＡＤ                *
*----------------------------------------------------------*
 KNHAKOF-READ-SUB        SECTION.
*
     READ    KNHAKOF    NEXT
         AT END
             MOVE      1     TO   HAK-FLG
             GO              TO   KNHAKOF-READ-END
         NOT AT END
             MOVE      ZERO  TO   HAK-FLG
     END-READ.
*T
...
************************************************************
 END-SEC                SECTION.
*
     CLOSE    DSPF KNHAKOF  ZSOKMS HTOKMS HTENMS JYOKEN1.
*
 END-END.
     EXIT.
************************************************************
