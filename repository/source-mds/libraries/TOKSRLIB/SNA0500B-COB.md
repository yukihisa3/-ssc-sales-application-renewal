...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SNA0500B.COB`
...
*2022/06/07 NAV ST
*****DISPLAY "EXX-F05 = " EXX-F05 UPON CONS.
     IF        EXX-F05  =  "00001731" OR "00001732" OR "00007601"
                        OR "00007602"
               MOVE EXX-F12  TO   DEN-F02
***********DISPLAY "EXX-F12 = " EXX-F12 UPON CONS
***********
***********DISPLAY "EXX-F13 = " EXX-F13 UPON CONS
     END-IF.
*2022/06/07 NAV ED
     MOVE      0             TO   DEN-F04.
     MOVE      40            TO   DEN-F051.
...
*#2021/06/24 NAV ED
*#2022/02/28 NAV ST 日付セット使用変更　納品日⇒実納品日
...
*#2022/02/28 NAV ED 日付セット使用変更　納品日⇒実納品日
*    顧客発注番号
