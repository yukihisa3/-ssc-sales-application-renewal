...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/CSV0150B.COB`
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "CSV0150B".
...
****  出力ファイル情報２
 01  DATA2-REC.
     ...
     03  FILLER            PIC  X(01)  VALUE ",".
     03  FILLER            PIC  X(01)  VALUE X"28".
     03  FILLER            PIC  N(05)  VALUE NC"品単コード".
     03  FILLER            PIC  X(01)  VALUE X"29".
     03  FILLER            PIC  X(01)  VALUE ",".
     03  FILLER            PIC  X(01)  VALUE X"28".
...
**** 出力ファイル情報３
 01  DATA3-REC.
     ...
     03  DATA3-F071        PIC  X(08).
     03  DATA3-A071        PIC  X(01).
...
*    カンマセット
     ...
     MOVE   ","              TO   DATA3-A13 DATA3-A14 DATA3-A071.
*    バッチ日付
...
*    サカタ品単ＣＤ
     MOVE   TBL-F08          TO   DATA3-F071.
*    規格
     MOVE   TBL-F09          TO   DATA3-F08.
*    サイズ
     MOVE   TBL-F10          TO   DATA3-F09.
*    入数
     MOVE   TBL-F11          TO   DATA3-F10.
*    品名１
     MOVE   TBL-F121         TO   DATA3-F11.
*    品名２
     MOVE   TBL-F122         TO   DATA3-F12.
*    原価単価
...
*    売価単価
     MOVE   TBL-F14(1:7)     TO   TANKA-SURYO.
     MOVE   "."              TO   TANKA-FIL01.
     MOVE   TBL-F14(8:2)     TO   TANKA-SYOSU.
...
*#2014/05/14 NAV ED
             ...
             MOVE  TBL-F15(IY) TO DATA3-SURYO(IY)
     END-PERFORM.
...
************************************************************
 300-END-SEC           SECTION.
     CLOSE             CSSTBLF  HACTECSV  SEQTENF.
*
     DISPLAY "* CSSTBLF  (INPUT) = " RD-CNT   " *"  UPON CONS.
