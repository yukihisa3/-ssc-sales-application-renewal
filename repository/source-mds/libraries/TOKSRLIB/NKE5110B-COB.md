...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NKE5110B.COB`
...
*    2017/07/18 検品Ｇが数字以外の場合、０をセットに変更       *
****************************************************************
...
*    ｶｳﾝﾄ
 ...
 01  WK-SKIP-CNT             PIC  9(06)     VALUE  ZERO.
*
 01  WK-AREA.
*システム日付の編集
     03  SYS-DATE.
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NKE5110B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NKE5110B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
****************************************************************
 INIT-SEC               SECTION.
     ...
     OPEN     INPUT     SOKKENF HSHOTBL HMEIMS.
...
*検品Ｇ数字以外件数
     ...
     MOVE       WK-SKIP-CNT       TO     OUT-SKIP.
     DISPLAY MSG-SKIP                             UPON CONS.
*
     CLOSE     SOKKENF  HSHOTBL  HMEIMS.
     CLOSE     KNPTAN01.
     CLOSE     KNPTAK01.
*
     STOP      RUN.
...
*JANCDの９桁目が空白の場合はデータ作成しない
     IF       WK-F05(13:1)  =  SPACE
