...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SJR0450I.COB`
...
*実行
         WHEN   "E000"
                MOVE    "3"           TO   LINK-KEIKBN
                MOVE    DSP-TOKCD     TO   LINK-TOKCD
                MOVE    "98"          TO   LINK-TANST
                MOVE    "98"          TO   LINK-TANED
                MOVE    "2"           TO   LINK-DKBN
...
*画面の表示
     ...
     MOVE    "SJR0450I"          TO   DSP-PGID.
     MOVE    "FJR04501"          TO   DSP-FORMID.
     MOVE    "FJR04501"          TO   DSP-FMT.
     WRITE    DSP-FJR04501.
*
 DSP-WRITE-EXIT.
     EXIT.
