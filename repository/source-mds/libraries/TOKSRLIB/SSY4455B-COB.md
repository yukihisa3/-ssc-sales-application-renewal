...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY4455B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG                PIC  X(08)     VALUE "SSY4455B".
...
*             最終納品先納品日を計上日に強制セット
*             　マッピングシートでは計上日は非セットだが、
*             　テスト受信データではセットされていたため、
*             　現時点では計上日をそのまま転送としておく。
*             　本番データが相違する場合は変更必要。
*-------------MOVE      WJYR-F349 TO   WJYR-F352
             WHEN  "D"
