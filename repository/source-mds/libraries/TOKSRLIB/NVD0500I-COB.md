...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NVD0500I.COB`
...
*    顧客名　　　　　　　：　（株）サカタのタネ殿　　　　　　　*
*    業務名　　　　　　　：　Ｄ３６５連携　　　　　　　　　　　*
*    モジュール名　　　　：　倉庫間出庫入力ﾁｪｯｸﾘｽﾄ出力指示
*    作成日／作成者　　　：　2020/04/15   ASS.II               *
*    処理内容　　　　　　：　倉庫間出庫入力ﾁｪｯｸﾘｽﾄ発行条件
*    　　　　　　　　　　　　を画面より指定する。　　　　　　　*
****************************************************************
...
*画面表示用ワーク
 01  DSP-WORK.
     03  WORK-PGID                PIC  X(08)  VALUE  "NVD0500I".
     03  WORK-FORMID              PIC  X(08)  VALUE  "FVD0500I".
*フラグ領域
 01  FLG-AREA.
...
******************************************************************
 ...
 01  LINK-OUT-SYUKOST      PIC 9(08).
 01  LINK-OUT-SYUKOEN      PIC 9(08).
*
**************************************************************
...
******************* TEST
**** MOVE    "01"                 TO   LINK-IN-SOKO.
**** MOVE    "02"                 TO   LINK-IN-DSOKO.
     DISPLAY "IN 倉庫ＣＤ    ="  LINK-IN-SOKO     UPON CONS.
     DISPLAY "IN 代表倉庫ＣＤ="  LINK-IN-DSOKO    UPON CONS.
******************* TEST
***
     PERFORM   INIT-SEC.
...
******************* TEST
     ...
     DISPLAY "出庫日開始    ="  LINK-OUT-SYUKOST   UPON CONS.
     DISPLAY "出庫日終了    ="  LINK-OUT-SYUKOEN   UPON CONS.
...
*初期画面の処理
     ...
     MOVE "FVD05001"    TO  DSP-FMT.
     MOVE  SPACE        TO  DSP-FVD05001.
     PERFORM  OPT-CLR-SEC.
*ＢＯＤＹ部入力へ
     MOVE  2            TO  MAIN-FLG.
 DSP-INIT-EXIT.
...
*
     IF  ERR-FLG  =  ZERO
         ...
         MOVE  DSP-FDATE  TO   LINK-OUT-SYUKOST
         IF    DSP-TDATE  =    ZERO
               MOVE "99999999" TO   LINK-OUT-SYUKOEN
         ELSE
               MOVE DSP-TDATE  TO   LINK-OUT-SYUKOEN
         END-IF
         MOVE  99         TO   MAIN-FLG
     END-IF.
 CHK-KAKU-EXIT.
