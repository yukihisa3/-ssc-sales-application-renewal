...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NVD0510L.COB`
...
*    顧客名　　　　　　　：　（株）サカタのタネ殿　　　　　　　*
*    業務名　　　　　　　：　Ｄ３６５連携　　　　　　　　　　　*
*    モジュール名　　　　：　倉庫間出庫入力チェックリスト　　　*
*    作成日／作成者　　　：　2020/04/15   ASS.II               *
*    処理内容　　　　　　：　新入出庫ファイルより倉庫間出庫　　*
*    　　　　　　　　　　　　入力チェックリストを出力する。　　*
****************************************************************
 IDENTIFICATION      DIVISION.
 PROGRAM-ID.         NVD0510L.
 AUTHOR.             ASS.II.
 DATE-WRITTEN.       02.04.15.
*
...
*
 ...
 FILE-CONTROL.
*新入出庫Ｆ
     SELECT   DNSFILF   ASSIGN        TO  DA-01-VI-DNSFILL7
                        ORGANIZATION  IS  INDEXED
                        ACCESS MODE   IS  DYNAMIC
                        RECORD KEY    IS  DNS-F05  DNS-F14
                                          DNS-F01  DNS-F02
...
****  見出し行０             ****
 01  MIDASI0.
     ...
     02  FILLER              PIC  X(08)  VALUE  "NVD0510L".
...
****  見出し行１             ****
 01  MIDASI1        CHARACTER     TYPE   IS   NIHONGO.
     ...
     02  FILLER              PIC  X(02)  VALUE  SPACE.
     02  FILLER              PIC  N(04)  VALUE  NC"出庫日：".
     02  H1-FYY              PIC  9(04).
...
*メッセージ情報
 01  MSG-AREA.
     03  MSG-ABEND1.
         05  FILLER          PIC  X(12)  VALUE  "### NVD0510L".
...
*=============================================================
 CONTROL-SEC         SECTION.
     DISPLAY  "**  NVD0510L   START  **"   UPON  CONS.
***************** TEST
*****MOVE  "2920"     TO  LINK-BUMON.
*****MOVE  "99"       TO  LINK-SOKCD.
...
*
     ...
     PERFORM  END-SEC.
*
     DISPLAY  "**  NVD0510L    END   **"   UPON  CONS.
     STOP  RUN.
 CONTROL-EXIT.
     EXIT.
*=============================================================
...
*=============================================================
 DNS-START-SEC      SECTION.
     ...
     END-IF.
*
     START DNSFILF   KEY >=      DNS-F05  DNS-F14
                                 DNS-F01  DNS-F02
         INVALID
            MOVE   "END"     TO  END-FLG
     END-START.
