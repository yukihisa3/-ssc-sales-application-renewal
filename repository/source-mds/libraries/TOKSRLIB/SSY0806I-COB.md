...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY0806I.COB`
...
*画面定義ファイル
     SELECT  DSPFILE   ASSIGN    TO        GS-DSPF
                       ...
                       FILE      STATUS    DSP-ST.
*伝票データワーク(伝票単位順）
     SELECT  KPPFILL1  ASSIGN    TO        KPPFILL1
                       ORGANIZATION        INDEXED
                       ACCESS    MODE      RANDOM
                       RECORD    KEY       KP1-F46
                                           KP1-F47
                       ...
                       FILE      STATUS    KP1-ST.
*伝票データワーク(商品単位順）
     SELECT  KPPFILL2  ASSIGN    TO        KPPFILL2
                       ORGANIZATION        INDEXED
                       ACCESS    MODE      RANDOM
                       RECORD    KEY       KP2-F46
                                           KP2-F47
...
**************************************************************
 ...
 DSP-ERR                   SECTION.
     ...
     STOP        RUN.
 KP1-ERR                   SECTION.
     USE         AFTER     EXCEPTION PROCEDURE KPPFILL1.
     ...
     STOP        RUN.
 KP2-ERR                   SECTION.
     USE         AFTER     EXCEPTION PROCEDURE KPPFILL2.
...
*ファイルのＯＰＥＮ
     OPEN     I-O       DSPFILE   KPPFILL1 KPPFILL2.
     OPEN     INPUT     SHTDENF   HTOKMS   ZSOKMS.
*ワークの初期化
     INITIALIZE         FLG-AREA.
*カウンタの初期化
     INITIALIZE         COUNTER.
