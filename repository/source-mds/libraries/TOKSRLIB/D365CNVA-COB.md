...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/D365CNVA.COB`
...
*
 ...
 FILE-CONTROL.
*----<< 移行商品データ　 >>----*
     SELECT   HMEIWK1  ASSIGN              DA-01-VI-HMEIWK1
...
*    移行商品データ　
******************************************************************
 FD  HMEIWK1  LABEL RECORD   IS   STANDARD.
     COPY      HMEIWK1       OF   XFDLIB
     JOINING   IN                  PREFIX.
******************************************************************
*    商品名称マスタ　
******************************************************************
...
*    ｶｳﾝﾄ
 ...
 01  WK-INV-FLG.
     ...
     03  HMEIWK1-INV-FLG    PIC  X(03)     VALUE  SPACE.
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "D365CNVA".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "D365CNVA".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*　　　　　　　メイン処理　　　　　　　　　　　　　　　　　　　*
****************************************************************
 HMEIWK1-READ-SEC    SECTION.
*
     MOVE    "HMEIWK1-READ-SEC"    TO  S-NAME.
*
     READ     HMEIWK1
              AT  END
                  MOVE     "END"    TO  END-FLG
                  GO                TO  HMEIWK1-READ-EXIT
              NOT AT END
                  ADD       1       TO  READ-CNT
     END-READ.
*
