...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SKJ0040V.COB`
...
*明細エリア
 ...
 01  PARA-DATAKBN      PIC X(01).
**************************************************************
 PROCEDURE             DIVISION
     USING  PARA-TOKCDS PARA-TOKCDE PARA-DATAKBN.
**************************************************************
 DECLARATIVES.
 KYK-ERR                   SECTION.
...
*ファイルのＯＰＥＮ
     OPEN     INPUT  KYKJYKF  HTOKMS  TENMS1.
...
*
     MOVE      SPACE         TO   CSV-REC  WK-MEISAI1  WK-MEISAI2.
*    ＣＳＶ（カンマ）セット
     MOVE      ","           TO   K01 K02 K03 K04 K05.
     MOVE      ","           TO   MK1 MK2 MK3 MK4 MK5.
*    制御バイトセット
     MOVE X"28"              TO   M02S M04S MM5S MM6S.
     MOVE X"29"              TO   M02E M04E MM5E MM6E.
*    ＮＡＶＳ取引先ＣＤ
     MOVE  KYK-F01           TO   M01  MM1.
*    ＮＡＶＳ取引先名
     PERFORM  HTOKMS-READ-SEC.
     IF  HTOKMS-INV-FLG  =  "INV"
         MOVE ALL NC"＊"     TO   M02  MM5
     ELSE
         MOVE TOK-F02        TO   M02  MM5
     END-IF.
*    ＮＡＶＳ店舗ＣＤ　
     MOVE  KYK-F02           TO   M03  MM2
*    ＮＡＶＳ店舗名
     PERFORM  TENMS1-READ-SEC.
     IF  TENMS1-INV-FLG  =  "INV"
         MOVE ALL NC"＊"     TO   M04  MM6
     ELSE
         MOVE TEN-F02        TO   M04  MM6
     END-IF.
*    Ｄ３６５顧客ＩＤ
     MOVE  KYK-F03           TO   M05.
*****MOVE  SPACE             TO   MM3.
...
****************************************************************
 END-SEC               SECTION.
*ファイル ＣＬＯＳＥ
     CLOSE             KYKJYKF  HTOKMS  TENMS1  KYKJYKCV.
**
