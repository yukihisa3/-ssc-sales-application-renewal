...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/TSY0803I.COB`
...
*----<< 需要家ＩＤ管理マスタ >>--*
     SELECT   KYKJYKL2  ASSIGN         DA-01-VI-KYKJYKL2
                        ...
                        STATUS         KYKJYKL2-ST.
*----<< 売上伝票ファイル >>--*
     SELECT   SHTDENLC  ASSIGN         DA-01-VI-SHTDENLC
                        ORGANIZATION   INDEXED
...
*----<< 需要家ＩＤ管理マスタ >>--*
 FD  KYKJYKL2           LABEL RECORD   IS   STANDARD.
     COPY     KYKJYKL2  OF        XFDLIB
              JOINING   KY2       PREFIX.
*----<< 売上伝票ファイル >>--*
 FD  SHTDENLC           LABEL RECORD   IS   STANDARD.
     COPY     SHTDENLC  OF        XFDLIB
              JOINING   DEN       PREFIX.
*--------------------------------------------------------------*
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### TSY0803I DSPFILE ERROR " DSP-CNTL " "
...
*----<< 取引先マスタ >>--*
 TOKMS2-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### TSY0803I TOKMS2 ERROR " TOKMS2-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### TSY0803I ZSOKMS1 ERROR " ZSOKMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 店舗マスタ >>--*
 TENMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### TSY0803I TENMS1 ERROR " TENMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 需要家ＩＤ管理マスタ >>--*
 KYKJYKL1-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### TSY0803I KYKJYKL1 ERROR " KYKJYKL1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 需要家ＩＤ管理マスタ >>--*
 KYKJYKL2-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### TSY0803I KYKJYKL2 ERROR " KYKJYKL2-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
     ...
     STOP     RUN.
*----<< 売上伝票ファイル >>--*
 SHTDENLC-ERR             SECTION.
     USE AFTER     EXCEPTION PROCEDURE      SHTDENLC.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### TSY0803I SHTDENLC ERROR " SHTDENLC-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FSY08031.
*
     PERFORM  CLR-GRP001-RTN.
     PERFORM  CLR-GRP002-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "TSY0803I"      TO   PGID.
     MOVE    "FSY08031"      TO   FORM.
*
*    IF      PARA-IN-DSOKO  =  "01"
*            MOVE      1         TO   GR-NO
*    ELSE
...
*売上伝票ファイルＳＴＡＳＲＴ
     ...
     START    SHTDENLC  KEY  IS   >=   DEN-F277 DEN-F274 DEN-F09
                                       DEN-F01  DEN-F02  DEN-F04
