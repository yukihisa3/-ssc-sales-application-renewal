...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SHA0031L.COB`
...
*****02  FILLER              PIC  X(62)  VALUE  SPACE.
     ...
     02  FILLER              PIC  X(08)  VALUE  "(D365NO:".
     02  PRT-D365            PIC  X(20).
     02  FILLER              PIC  X(01)  VALUE  ")".
****  見出し行４             ****
 01  MEISAI3.
     02  FILLER              PIC  X(01)  VALUE  SPACE.
     02  FILLER              PIC  X(135) VALUE  ALL "-".
*
*メッセージ情報
 01  MSG-AREA.
     03  MSG-ABEND1.
