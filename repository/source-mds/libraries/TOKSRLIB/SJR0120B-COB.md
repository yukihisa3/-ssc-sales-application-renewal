...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SJR0120B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJR0120B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJR0120B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*データ初期READ
 INIT-00.
     ...
     MOVE     ZERO           TO    ONL-F02
                                   ...
                                   ONL-F07
                                   ONL-F08.
     START    GDJYURL1  KEY IS >= ONL-F01 ONL-F02 ONL-F03 ONL-F04
                                  ONL-F05 ONL-F06 ONL-F07 ONL-F08
...
*商品変換ＴＢＬ索引
     ...
     MOVE     ONL-B04        TO        TBL-F02.
     PERFORM  HSHOTBL-READ-SEC.
*原単価
     IF     ( ONL-B07  NOT NUMERIC ) OR
            ( ONL-B07  =   ZERO    )
...
*元伝票番号
     MOVE     ONL-A14        TO        RUI-F05.
*相手伝票区分
     MOVE     ONL-F06        TO        RUI-F06.
*店舗コード
...
*    F09 : INIT
*訂正区分（Ｈ）
     MOVE     ONL-A05        TO        RUI-F10.
*直接納品先コード
*    F11 : INIT
*コメント
*    F12 : INIT
*行番号
     MOVE     ONL-B02        TO        RUI-F31.
*赤黒区分
*    MOVE     "0"            TO        RUI-F32.
*
*相手商品コード
     MOVE     ONL-B04        TO        RUI-F33.
*数量
     MOVE     ONL-B06        TO        RUI-F34.
*    COMPUTE  RUI-F34   =    ONL-F318  /   10.
*原単価
     IF       WK-ERR-GENTANKA  NOT =  "1"
              MOVE  ONL-B07  TO        RUI-F35
*             COMPUTE   RUI-F35    =   ONL-F314  /  100
     END-IF.
*原価金額
     MOVE     ONL-B10        TO        RUI-F36.
*    COMPUTE  RUI-F36   =    ONL-F12   *   ONL-F13
*返品理由
     MOVE     ONL-B15        TO        RUI-F39.
*訂正区分（Ｍ）
*    F40 : INIT
*売単価
     MOVE     ONL-B08        TO        RUI-F41.
...
*
     CLOSE     GDJYURL1  HTENMS   HSHOTBL  HMEIMS
