...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY4465B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY4465B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY4465B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*伝票番号
 01  WK-DEN-NO.
     03  WK-DEN-S          PIC        X(08).
     03  WK-DEN-S-R        REDEFINES WK-DEN-S.
         05  WK-DEN-H       PIC       9(08).
*行番号
 01  WK-GYO-NO.
...
*2013/03/01 NAV ED
*商品名　カナ転送用
 01  WK-HAC-F416N                 PIC  N(25).
 01  WK-HAC-F416X REDEFINES       WK-HAC-F416N  PIC  X(50).
*
*
 01  LINK-AREA.
...
*****MOVE  HAC-F413(1:13)  TO        TBL-F02  HEN-F25.
     MOVE  HAC-F413(4:7)   TO        TBL-F02  HEN-F25.
*#2019/03/25 NAV ED
     READ    SHOTBL1
       INVALID
         MOVE    SPACE     TO        TBL-REC
...
*    商品名称マスタ検索
     ...
     READ    MEIMS1
       INVALID
*        商品名カナ（上段）
         MOVE  HAC-F416           TO  WK-HAC-F416N
         MOVE  WK-HAC-F416X(1:15) TO  HEN-F1421
***      MOVE  HAC-F417(1:15)     TO  HEN-F1421
***      MOVE  HAC-F417(16:10)    TO  HEN-F1422(1:10)
*        商品名カナ（下段）
*        MOVE  HAC-F417(16:5)     TO  HEN-F1422(11:5)
         MOVE  WK-HAC-F416X(16:5) TO  HEN-F1422
         MOVE  HAC-F417(1:10)     TO  HEN-F1422(6:10)
       NOT INVALID
*        商品名カナ（上段）
         MOVE  HAC-F416           TO  WK-HAC-F416N
         MOVE  WK-HAC-F416X(1:15) TO  HEN-F1421
...
*2013/03/01 NAV ST 納品先がセンターの場合、センターＣＤをセット
*　　　　　　　　　センター以外は０にセット
     IF    HAC-F333  =  "00"
