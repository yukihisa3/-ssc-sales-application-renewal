...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NVM0141B.COB`
...
*
 ...
 01  WK-SBM-D01              PIC  X(20)  VALUE  SPACE.
 01  WK-SBM-D02              PIC  X(20)  VALUE  SPACE.
**
*日付取得
...
*メッセージ出力領域
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG           PIC  X(08)  VALUE "NVM0141B".
         05  FILLER          PIC  X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER          PIC  X(05)  VALUE " *** ".
         05  END-PG          PIC  X(08)  VALUE "NVM0141B".
         05  FILLER          PIC  X(11)  VALUE
                                         " END   *** ".
     03  MSG-OUT1.
...
*最新のＤ３６５情報を取得する
     MOVE  SUB-F031          TO   SBM-F011.
     MOVE  SUB-F0321         TO   SBM-F0121.
     MOVE  SUB-F0322         TO   SBM-F0122.
     MOVE  SUB-F0323         TO   SBM-F0123.
     PERFORM  SBM-READ-SEC.
*   Ｄ３６５ＪＡＮＣＤ
*****MOVE  STB-F55           TO   SUB-F17.
     MOVE  WK-SBM-D01        TO   SUB-F17.
*
*   Ｄ３６５商品ＣＤ
*****MOVE  STB-F56           TO   SUB-F18.
     MOVE  WK-SBM-D02        TO   SUB-F18.
*
*   直送/セット組区分
...
*
     READ     SUBMEIL1
       INVALID
              ...
              MOVE SPACE     TO   WK-SBM-D01
              MOVE SPACE     TO   WK-SBM-D02
       NOT  INVALID
              MOVE SPACE     TO   SBM-INV-FLG
              MOVE SBM-D01   TO   WK-SBM-D01
              MOVE SBM-D02   TO   WK-SBM-D02
     END-READ.
 SBM-READ-EXIT.
     EXIT.
****************************************************************
