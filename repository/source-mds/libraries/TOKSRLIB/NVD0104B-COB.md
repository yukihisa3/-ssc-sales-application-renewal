...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NVD0104B.COB`
...
*メッセージ出力領域
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG           PIC  X(08)  VALUE "NVD0104B".
         05  FILLER          PIC  X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER          PIC  X(05)  VALUE " *** ".
         05  END-PG          PIC  X(08)  VALUE "NVD0104B".
         05  FILLER          PIC  X(11)  VALUE
                                         " END   *** ".
     03  MSG-OUT1.
...
*    入荷予定データ　順読込
****************************************************************
 YTICHKF-READ-SEC            SECTION.
     MOVE     "YTICHKF-READ-SEC"  TO   S-NAME.
*
     READ     YTICHKF
         AT END
              MOVE   "END"        TO   END-FLG
              GO      TO          YTICHKF-READ-EXIT
     END-READ.
*
     ADD      1   TO    YTI-CNT.
*ＮＡＶＳ伝票番号が空白以外は読み飛ばし
