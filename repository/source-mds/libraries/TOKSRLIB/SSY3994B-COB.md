...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY3994B.COB`
...
*------------------------------------------------------------*
* 入力パラメータ
 01  PA-KANRINS   PIC  9(08). *> 管理番号
 01  PA-KANRINE   PIC  9(08). *> 管理番号
*
**************************************************************
 PROCEDURE             DIVISION
                               USING   PA-KANRINS  PA-KANRINE.
**************************************************************
 DECLARATIVES.
 ST1-ERR                   SECTION.
...
* 基本情報ファイルの初期読み込み
     ...
     MOVE  SPACE            TO  KH1-REC.
     INITIALIZE                 KH1-REC.
     MOVE  PA-KANRINS       TO  KH1-F01.  *> 管理番号
     START NFJOHOF KEY IS >= KH1-F01  KH1-F05  KH1-F06
                             KH1-F07  KH1-F08  KH1-F09
           INVALID
...
*
     ...
     END-IF.
*
     IF  PA-KANRINS  <=  KH1-F01
     AND PA-KANRINE  >=  KH1-F01
           CONTINUE
     ELSE
           MOVE     "END"      TO  END-FLG
           GO                  TO  NFJOHOF-READ-EXIT
...
*
     MOVE   KH1-F01           TO ST1-F01.
     MOVE   KH1-F05           TO ST1-F05.
     MOVE   KH1-F06           TO ST1-F06.
     MOVE   KH1-HE20          TO ST1-F07.
     MOVE   KH1-F09           TO ST1-F08.
     MOVE   KH1-F07           TO ST1-F09.
*
     READ  NFSUTEF
...
*
     MOVE   KH1-F04           TO CKD-F00.
     MOVE   KH1-F06           TO CKD-F01.
     MOVE   KH1-HE10          TO CKD-F05.
     IF     KH1-F01  >= 90000000
            MOVE  2           TO CKD-F05
     END-IF.
     MOVE   ZERO              TO CKD-F06.
     MOVE   KH1-F07           TO CKD-F03.
     MOVE   KH1-F08           TO CKD-F04.
     MOVE   KH1-F13           TO CKD-F07.
*
     READ  NFCKDTF
...
*ナフコ商品マスタから項目設定 *******************************
     ...
     MOVE     KH1-F09        TO   CKD-F202.
     MOVE     KH1-F42        TO   CKD-F204.
     MOVE     KH1-F19        TO   CKD-F205.
     MOVE     KH1-F20        TO   CKD-F206.
     MOVE     KH1-ME10       TO   CKD-F207.
     MOVE     KH1-ME12       TO   CKD-F208.
     MOVE     KH1-HE10       TO   CKD-F20A.
     IF       KH1-F01  >=  90000000
              MOVE  2        TO   CKD-F20A
     END-IF.
     MOVE     KH1-ME04       TO   CKD-F20B.
     MOVE     KH1-F01        TO   CKD-F40.
     MOVE     KH1-F02        TO   CKD-F41.
     MOVE     KH1-F03        TO   CKD-F42.
     MOVE     KH1-F04        TO   CKD-F43.
*
     IF   NFCKDTF-INV-FLG  =  "INV"
