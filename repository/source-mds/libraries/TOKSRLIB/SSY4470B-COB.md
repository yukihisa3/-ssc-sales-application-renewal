...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY4470B.COB`
...
*
 01  WK-HAC-F340-X.
     03  WK-HAC-F340       PIC  N(60).
 01  WK-HAC-F364-X.
     03  WK-HAC-F364       PIC  N(60).
*01  WK-HAC-F435-X.
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY4470B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY4470B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*店舗ＣＤ
 01  WK-TEN-NO.
     03  WK-TEN-S          PIC        X(03).
     03  WK-TEN-S-R        REDEFINES WK-TEN-S.
         05  WK-TEN-H      PIC        9(03).
*
*01  WK-CEN-NO.
...
*    商品変換テーブル検索
     ...
     MOVE  HAC-F412(2:13)  TO        TBL-F02  HEN-F25.
     READ    SHOTBL1
       INVALID
         MOVE    SPACE     TO        TBL-REC
         INITIALIZE                  TBL-REC
...
*        PENDING:商品名　　不明確
         ...
         MOVE  HAC-F417(16:5)     TO   HEN-F1422(1:5)
         MOVE  HAC-F419(1:10)     TO   HEN-F1422(6:10)
