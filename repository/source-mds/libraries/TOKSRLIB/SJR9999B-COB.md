...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SJR9999B.COB`
...
*メッセージ定義エリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJR9999B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJR9999B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*
     ...
     END-READ.
*
     IF    PARA-HIDUKE  NOT =  RHE-F78
     OR    PARA-JIKAN   NOT =  RHE-F79
     OR    PARA-TOKCD   NOT =  RHE-F01
           MOVE  "END"          TO        END-FLG
           GO                   TO        COMRHEF-READ-EXIT
     END-IF.
*件数カウント
