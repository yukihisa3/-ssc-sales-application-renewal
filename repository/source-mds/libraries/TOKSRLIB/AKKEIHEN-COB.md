...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/AKKEIHEN.COB`
...
*--------------------------------------------------------------*
 01  PGM-ID                  PIC  X(08)     VALUE  "FAKKEIHE".
*----<< ﾃﾞｨｽﾌﾟﾚｲ ｺﾝﾄﾛｰﾙ ｴﾘｱ >>-*
 01  DSP-CNTL.
     03  DSP-FMT             PIC  X(08).
     03  DSP-GRP             PIC  X(08).
...
*画面退避用
     COPY   FAKKEIHE  OF XMDLIB  JOINING   SAV  AS   PREFIX.
*
 01  SAVE-AREA.
...
*画面＆ＴＢＬクリア
     ...
     MOVE      SPACE     TO   FAKKEIHE   TABLE-AREA.
     INITIALIZE               TBL-XX.
     MOVE      ZERO      TO   WK-TAIHI.
