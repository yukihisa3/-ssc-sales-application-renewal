...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NJH3753C.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG                PIC  X(08)     VALUE "NJH3753C".
...
******************************************************************
 ...
 DECLARATIVES.
 RCV-ERR                    SECTION.
     USE      AFTER         EXCEPTION PROCEDURE  NFHACSF.
     ...
     STOP          RUN.
 RWK-ERR                    SECTION.
     USE      AFTER         EXCEPTION PROCEDURE  NFHACWK.
...
*受信編集ファイルの初期化
     ...
     MOVE      ZERO               TO   IY.
*
     PERFORM VARYING IX FROM 1 BY 1 UNTIL IX > 722
...
*            ナフコ新Ｅ受信ファイル読込
******************************************************************
 NFHACSF-READ-SEC           SECTION.
*
     MOVE    "NFHACSF-READ-SEC"           TO   S-NAME.
*
     READ     NFHACSF
              AT  END       MOVE  "END"   TO   END-FLG
                            GO     TO     NFHACSF-READ-EXIT
