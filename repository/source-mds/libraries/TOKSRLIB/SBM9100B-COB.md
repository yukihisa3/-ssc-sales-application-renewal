...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SBM9100B.COB`
...
*    業務名　　　　　　　：　                                  *
*    モジュール名　　　　：　出荷ＭＳＧレコード削除
*    作成日／作成者　　　：　2019/11/29 T.TAKAHASHI            *
*    更新日／更新者　　　：　                                  *
...
****************************************************************
 INIT-SEC              SECTION.
*
     DISPLAY  "***  START SBM9100B  ***"   UPON  CONS.
...
*ファイルのCLOSE処理
     CLOSE     BMSSYKF.
     DISPLAY  "***  END   SBM9100B  ***"   UPON  CONS.
*
 END-EXIT.
     EXIT.
*
