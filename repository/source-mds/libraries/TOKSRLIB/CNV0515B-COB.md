...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/CNV0515B.COB`
...
*    顧客名　　　　　　　：　（株）サカタのタネ殿　　　　　　　*
*    業務名　　　　　　　：　マスタデータコンバート　　　　　　*
*    モジュール名　　　　：　商品変換Ｗ⇒商品変換ＴＢＬにセット*
*    作成日／更新日　　　：　03/07/03                          *
*    作成者／更新者　　　：　ＮＡＶ　　　　　　　　　　　　　　*
*    処理概要　　　　　　：　商品変換Ｗ⇒商品変換ＴＢＬにセット*
*                          する。                              *
****************************************************************
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "CNV0515B".
...
*            商品変換テーブルの読込処理
************************************************************
 TBLWK-READ-SEC                   SECTION.
     READ   TBLWK
       AT   END
             MOVE      "END"     TO   END-FLG
             GO        TO        TBLWK-READ-EXIT
     END-READ.
     ADD     1         TO        IN-CNT.
*
 TBLWK-READ-EXIT.
...
************************************************************
 300-END-SEC           SECTION.
     CLOSE             HSHOTBL  TBLWK.
*
     DISPLAY "* TBLWK   (INPUT)  = " IN-CNT   " *"  UPON CONS.
     DISPLAY "* HSHOTBL (OUTPUT) = " OUT-CNT1 " *"  UPON CONS.
     DISPLAY "* HSHOTBL (REWRITE)= " OUT-CNT3 " *"  UPON CONS.
*
 300-END-SEC-EXT.
     EXIT.
*****************<<  PROGRAM  END  >>***********************
