...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NVS0233B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NVS0233B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NVS0233B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
********  GO                    TO    HENKOU-010
     ...
     END-IF.
*
     MOVE      20240211       TO   DEN-F111  DEN-F112  DEN-F113.
     MOVE      0              TO   DEN-F277.
     MOVE      0              TO   DEN-F261.
     MOVE     "00000000"      TO   DEN-F45.
     MOVE      9              TO   DEN-F27C.
     MOVE      SPACE          TO   DEN-D95.
*    ＳＵＢ商品変換ＴＢＬ読込
