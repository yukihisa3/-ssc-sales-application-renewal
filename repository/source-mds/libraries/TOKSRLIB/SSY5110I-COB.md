...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY5110I.COB`
...
*画面表示用ワーク
 01  DSP-WORK.
     03  WORK-PGID                PIC  X(08)  VALUE  "SSY5110I".
     03  WORK-FORMID              PIC  X(08)  VALUE  "FSY51101".
*フラグ領域
 01  FLG-AREA.
