...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY3910V.COB`
...
*******
       WHEN  KY-HK3 > KY-ST3
                       *> "＞"：箱数無し、数量訂正Ｆ有り
        DISPLAY "SSY3910V NFHAKOF RECORD NOT FOUND KEY="
          KY-ST3 "*"  UPON CONS
          MOVE  "4000"      TO  PROGRAM-STATUS
          STOP RUN
...
*基本情報マスタ・索引
     ...
     IF  FG-NFJOHOF-INV = 1
         DISPLAY "SSY3910V NFJOHOF RECORD NOT FOUND KEY="
                 ST3-F01
             "," ST3-F05
             "," ST3-F06
             "," ST3-F09
...
*  データ・索引
         ...
         IF  FG-NFHACPF-INV = 1
             DISPLAY "SSY3910V NFHACPF RECORD NOT FOUND KEY="
                     HC2-A06
                 "," HC2-A83
                 "," HC2-A88
                 "," HC2-A26
