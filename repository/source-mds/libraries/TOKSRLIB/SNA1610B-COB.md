...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SNA1610B.COB`
...
*--------------------------------------------------------------*
 01  FLAGS.
     ...
     03  SUBTBLF-INV-FLG PIC  X(03) VALUE  ZERO.
 01  COUNTERS.
...
*----<< 伝票データ >>--*
 SHTDENF-ERR            SECTION.
     ...
     DISPLAY  "### SNA1610B SHTDENF ERROR " DEN-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     CLOSE    SHTDENF  HSHOTBL  HMEIMS  SUBTBLF.
     STOP     RUN.
*----<< 商品変換テーブル >>--*
 HSHOTBL-ERR            SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SNA1610B HSHOTBL ERROR " TBL-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     CLOSE    SHTDENF  HSHOTBL  HMEIMS  SUBTBLF.
...
*----<< 商品変換テーブル >>--*
 HMEIMS-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SNA1610B HMEIMS ERROR " MEI-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     CLOSE    SHTDENF  HSHOTBL  HMEIMS  SUBTBLF.
...
*----<< ＳＵＢ商品変換テーブル >>--*
 SUBTBLF-ERR            SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### SNA1610B SUBTBLL1 ERROR " STB-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     CLOSE    SHTDENF  HSHOTBL  HMEIMS  SUBTBLF.
...
*2012/10/23 NAV 出荷場所、伝発場所をセットする。
...
*指定パラメタ以上の場合は処理終了
     ...
     END-IF.
*指定パラメタ：倉庫以外の場合は処理終了
     IF   DEN-F48  NOT =  PARA-SOKO
          MOVE     1        TO     END-FLG
          GO                TO     900-DEN-READ-EXIT
     END-IF.
*指定されたＪＡＮＣＤ以外は処理対象外
     IF   DEN-F25  NOT =  PARA-JANCD
          GO                TO     900-DEN-READ
     END-IF.
*
     ADD  1                 TO     TAI-CNT.
*
 900-DEN-READ-EXIT.
     EXIT.
*--------------------------------------------------------------*
*    LEVEL ALL    ＳＵＢ商品変換ＴＢＬ読込　　                 *
*--------------------------------------------------------------*
 900-SUB-READ           SECTION.
*
