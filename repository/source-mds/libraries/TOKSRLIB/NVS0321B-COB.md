...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NVS0321B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NVS0321B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NVS0321B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*
     ...
     INITIALIZE                      TBL-REC.
     MOVE      PARA-IN-TOKCD    TO   TBL-F01.
     START  SUBTBLL1  KEY  IS  >=    TBL-F01  TBL-F02
            INVALID
            MOVE      "END"     TO   END-FLG
            DISPLAY NC"＃対象ＤＴ無し１" UPON CONS
            GO                  TO   INIT-EXIT
     END-START.
*    商品変換ＴＢＬ読込み
     PERFORM SUBTBLL1-READ-SEC.
     IF   END-FLG  =  "END"
          DISPLAY NC"＃対象ＤＴ無し２" UPON CONS
     END-IF.
     DISPLAY "-------------------------------------" UPON CONS.
*
 INIT-EXIT.
