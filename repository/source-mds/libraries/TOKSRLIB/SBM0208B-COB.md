...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SBM0208B.COB`
...
*支払ワーク
     SELECT   BMSSH5W   ASSIGN    TO        DA-01-VS-BMSSH5W
...
*    支払ワーク
******************************************************************
 FD  BMSSH5W            LABEL RECORD   IS   STANDARD.
     COPY     BMSSH5W   OF        XFDLIB
              JOINING   SHW       PREFIX.
******************************************************************
...
*---<< ｻﾌﾞﾙｰﾁﾝ LINK AREA >>-*
 ...
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SBM0208B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SBM0208B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
