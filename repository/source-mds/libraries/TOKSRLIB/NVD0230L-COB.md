...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NVD0230L.COB`
...
*特販部名称編集
 ...
 01  WORK-AREA.
     ...
     03  WK-SYBCD            PIC  9(02)  VALUE  ZERO.
...
****  見出し行０             ****
 01  MIDASI0        CHARACTER     TYPE   IS   NIHONGO.
     ...
     02  FILLER              PIC  X(08)  VALUE  "NVD0230L".
...
*メッセージ情報
 01  MSG-AREA.
     03  MSG-ABEND1.
         05  FILLER          PIC  X(12)  VALUE  "### NVD0230L".
...
*=============================================================
 CONTROL-SEC         SECTION.
     DISPLAY  "**  NVD0230L   START  **"   UPON  CONS.
*
     PERFORM  INIT-SEC.
     PERFORM  MAIN-SEC    UNTIL  MAIN-FLG  =  99.
     PERFORM  END-SEC.
*
     DISPLAY  "**  NVD0230L    END   **"   UPON  CONS.
     STOP  RUN.
 CONTROL-EXIT.
     EXIT.
*=============================================================
...
*ファイル ＣＬＯＳＥ
     ...
     CLOSE      JYOKEN1.
*ＭＳＧ出力
     DISPLAY "* NYKJISF (IN)=" READ-CNT " *" UPON CONS.
