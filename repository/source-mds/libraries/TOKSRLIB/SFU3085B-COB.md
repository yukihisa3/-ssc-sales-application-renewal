...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SFU3085B.COB`
...
*    顧客名　　　　　　　：　（株）サカタのタネ殿　　　　　　　*
*    業務名　　　　　　　：　社内振替　　　                    *
*    モジュール名　　　　：　社内振替情報リスト出力ワーク作成１
*    　　　　　　　　　　　　（データ抽出）                    *
*    作成日／作成者　　　：　2016/01/12 INOUE                  *
...
*
 ...
 FILE-CONTROL.
*振替明細ファイル
     SELECT   SFRMEIL2  ASSIGN    TO        DA-01-VI-SFRMEIL2
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SFU3085B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SFU3085B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*
     ...
     MOVE     PARA-IN-NYUF    TO   MEI-F12.
     START    SFRMEIL2  KEY   >=   MEI-F04   MEI-F12
         INVALID   KEY
              MOVE      9    TO   END-FG
              GO   TO   INIT-EXIT
     END-START.
...
*    倉庫・入力日チェック
     IF     ( PARA-IN-OUTSOKO  =    MEI-F04 ) AND
            ( PARA-IN-NYUF    <=    MEI-F12 ) AND
            ( PARA-IN-NYUT    >=    MEI-F12 )
              CONTINUE
     ELSE
              MOVE      9         TO   END-FG
              GO        TO        MAIN-EXIT
...
*
     CLOSE     SFRMEIL2  SFRHEDL1  SFRLSTWK.
     STOP      RUN.
*
 END-EXIT.
     EXIT.
