...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SBM0206B.COB`
...
*---<< ｻﾌﾞﾙｰﾁﾝ LINK AREA >>-*
 ...
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SBM0206B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SBM0206B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*店舗ＣＤ変換処理
 01  WK-TENPOR4.
     03  WK-TENPO4           PIC  9(04).
 01  WK-TENPOR5.
     03  WK-TENPO5           PIC  9(05).
 01  WK-TENPOR1.
     03  WK-TENPO1           PIC  9(01).
...
*支払ワ－ク出力
  MAIN-010.
     ...
     IF  SHW-F405(2:1)  =  SPACE
         IF  SHW-F405(1:1)  =  "0"
             MOVE   "99999"     TO   SHW-F405
         ELSE
             MOVE   SHW-F405(1:1) TO WK-TENPOR1
             MOVE   WK-TENPO1     TO WK-TENPO5
             MOVE   WK-TENPO5     TO SHW-F405(1:5)
         END-IF
     ELSE
         IF  SHW-F405(1:5)  =  "00000"
             MOVE   "99999"     TO   SHW-F405
         ELSE
             MOVE   SHW-F405(1:5) TO WK-TENPOR5
             MOVE   WK-TENPO5     TO SHW-F405(1:5)
         END-IF
     END-IF.
*****６バイト目に文字がある場合
     IF  SHW-F405(6:1)  NOT =  SPACE
             MOVE   SPACE       TO   SHW-F405
             MOVE   "99999"     TO   SHW-F405(1:5)
     END-IF.
*
     WRITE   SHW-REC.
     ADD     1      TO      WRITE-CNT.
