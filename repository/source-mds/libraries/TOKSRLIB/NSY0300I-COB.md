...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NSY0300I.COB`
...
*                            画面より行う。　　                *
**履歴**********************************************************
*    2021/02/10  高橋　　新規作成（ＳＳＹ９２０１Ｌコピー）　　*
*    0000/00/00　　　　　　　　　　　　　　　　　　　　　　　　*
****************************************************************
...
***           取引先ＲＥＡＤ
              ...
              END-READ
**************IF  DSP-BTTORI = 1731  OR  1732  OR 7601
*             OR  7602
*                 CONTINUE
*             ELSE
*                 MOVE   9     TO   ERR-FLG
...
*画面の初期化
     MOVE    SPACE                TO   DSP-FSY03001.
*システム日付転送
     MOVE    SYS-DATE             TO   DSP-SDATE.
*システム時間転送
     MOVE    WK-TIME(1:6)         TO   DSP-STIME.
*プログラムＩＤ　
     MOVE    "NSY0300I"           TO   DSP-PGID.
*ＦＯＲＭＩＤ　
     MOVE    "FSY03001"           TO   DSP-FMID.
*項目属性クリア　
