...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SBM0174L.COB`
...
***********************************************************
 ...
 FILE-CONTROL.
*流通ＢＭＳ返品伝票ワーク（ジュンテンドー）
     SELECT     BMSHE5W    ASSIGN    TO  DA-01-VI-BMSHE5W1
...
****  見出し行１　　　　　　 ****
 01  MIDASI-1.
     ...
     02  FILLER              PIC  X(08)  VALUE  "SBM0174L".
...
* 2023/11/19 ARK UPD END
     ...
     02  FILLER              PIC  X(01)  VALUE  SPACE.
     02  HINKANA             PIC  X(20).
* 2023/11/19 ARK DEL START
*    02  FILLER              PIC  X(01)  VALUE  SPACE.
* 2023/11/19 ARK DEL END
     02  HENBKSU             PIC  -,---,--9.
* 2023/11/19 ARK DEL START
*    02  FILLER              PIC  X(01)  VALUE  SPACE.
* 2023/11/19 ARK DEL END
...
*PROCEDURE                 DIVISION.
 ...
 PRT-ERR-SEC               SECTION.
     ...
     STOP        RUN.
 HEP-ERR-SEC               SECTION.
     USE         AFTER     EXCEPTION PROCEDURE BMSHE5W.
...
*
     CLOSE       PRTF    BMSHE5W.
*    DISPLAY  "SBM0174L READ =" READ-CNT UPON STA.
*    DISPLAY  "SBM0174L IN   =" IN-CNT   UPON STA.
 END-EXIT.
     EXIT.
**********************************************************
*                    数量・金額集計　　　　　　　　　　　*
...
*伝票ヘッダ
     IF  DEN-FLG = 0
*        店舗情報
          MOVE  HEP-F04(2:5)      TO        TENCD
          MOVE  HEP-F06           TO        TENNM
*        処理種別
          MOVE  HEP-F08           TO        SYRKBN
          EVALUATE HEP-F08
             WHEN  "02"  MOVE NC"返品"        TO  SYRKBNNM
...
*
     READ     BMSHE5W  NEXT  AT  END
              MOVE     1         TO   END-SW
              MOVE     99999999  TO   NEW-TENCD
              MOVE    999999999  TO   NEW-DENNO
              GO                 TO   DEN-READ-EXIT
     END-READ.
*
