...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SJR0280C.COB`
...
*    更新日／更新者　　　：　2024/08/08 NAV TAKAHASHI          *
*    修正概要　　　　　　：　２０分類のチェックを外す　　　　　*
****************************************************************
...
*    ｶｳﾝﾄ
 ...
 01  BUMON-CHK-CNT           PIC  9(08)     VALUE  ZERO.
*
 ...
 01  HMEIMS-INV-FLG1         PIC  X(03)     VALUE  SPACE.
*
 01  WK-AREA.
*システム日付の編集
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJR0280C".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJR0280C".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
     ...
     03  MSG-BUMON-CHK.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  FILLER         PIC   X(09)  VALUE " BM-CNT= ".
         05  BMN-NG         PIC   9(06).
         05  FILLER         PIC   X(05)  VALUE " *** ".
*時刻
 01  TIME-AREA.
...
****************************************************************
 INIT-SEC               SECTION.
     ...
     OPEN     INPUT     HSHOTBL   DENHENF  HMEIMS.
     OPEN     I-O       COMRUIF.
     OPEN     I-O       COMRHEF.
...
**** DISPLAY "JYR-F03 = " JYR-F03 UPON CONS.
...
*商品名称マスタ索引
     ...
     IF       HMEIMS-INV-FLG1  =  "INV"
              ADD      1    TO        BUMON-CHK-CNT
              GO            TO        EDIT-EXIT
     END-IF.
*
...
*
     ...
     MOVE  BUMON-CHK-CNT TO      BMN-NG.
     DISPLAY   MSG-IN    UPON CONS.
     DISPLAY   MSG-OUT   UPON CONS.
     DISPLAY   MSG-NG    UPON CONS.
     DISPLAY   MSG-BUMON-CHK    UPON CONS.
     DISPLAY   MSG-END   UPON CONS.
*
     CLOSE     COMRUIF  HSHOTBL  DENHENF  COMRHEF  HMEIMS.
*
     STOP      RUN.
*
 END-EXIT.
...
*****DISPLAY "F01 = " HEN-F01 " -- F02 = " HEN-F02 UPON  CONS.
...
*
     ...
     MOVE  SPACE                    TO  HMEIMS-INV-FLG1.
     MOVE  JYR-F52                  TO  MEI-F011.
     MOVE  JYR-F53                  TO  MEI-F0121.
     MOVE  JYR-F54                  TO  MEI-F0122.
     MOVE  JYR-F55                  TO  MEI-F0123.
     READ  HMEIMS
...
*##      WHEN  "01"    MOVE  SPACE  TO  HMEIMS-INV-FLG1
*##      WHEN  "02"    MOVE  SPACE  TO  HMEIMS-INV-FLG1
*##      WHEN  "03"    MOVE  SPACE  TO  HMEIMS-INV-FLG1
*********WHEN  "04"    MOVE  SPACE  TO  HMEIMS-INV-FLG1
*##      WHEN  "05"    MOVE  SPACE  TO  HMEIMS-INV-FLG1
*********WHEN  "06"    MOVE  SPACE  TO  HMEIMS-INV-FLG1
*#2022/03/17 NAV ED ２０分類変更伴う変更　　
*##      WHEN  OTHER   MOVE  "INV"  TO  HMEIMS-INV-FLG1
*##  END-EVALUATE.
*##2024/08/08 NAV ED##
*
 HMEIMS-READ-EXIT.
