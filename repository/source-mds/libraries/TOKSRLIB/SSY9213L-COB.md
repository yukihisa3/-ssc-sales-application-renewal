...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY9213L.COB`
...
*----<< カーマ出荷確定データ >>--*
 DJSYUKF-ERR            SECTION.
     ...
     DISPLAY  "### SSY9213L DJSYUKF ERROR " DJSYUKF-ST " "
...
*****DISPLAY "KMK-F304 = " KMK-F304 UPON CONS.
     MOVE     KMK-F304       TO   WK-KMK-F304.
*****DISPLAY "WK-KMK-F304 = " WK-KMK-F304-H UPON CONS.
