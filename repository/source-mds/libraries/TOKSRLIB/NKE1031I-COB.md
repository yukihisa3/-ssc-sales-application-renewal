...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NKE1031I.COB`
...
*
 ...
 01  PARA-IN-KENSU          PIC   9(06).
****************************************************************
 PROCEDURE              DIVISION USING PARA-IN-SOKCD
                                       PARA-IN-KENSU.
****************************************************************
*--------------------------------------------------------------*
*    LEVEL 0        エラー処理　　　　　　　　　　　　　　　　 *
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### NKE1031I DSPFILE ERROR " DSP-ST " "
...
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### NKE1031I ZSOKMS1 ERROR " SOK-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FKE10311.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "NKE1031I"      TO   PGID.
     MOVE    "FKE10311"      TO   FORM.
*倉庫名称取得
     MOVE      PARA-IN-SOKCD    TO   SOK-F01 SOKCD.
     READ      ZSOKMS1
               INVALID  KEY
               MOVE      SPACE     TO   SOKNM
               NOT INVALID  KEY
...
*件数
     MOVE     PARA-IN-KENSU            TO   JOHO.
*
     MOVE     SPACE                 TO   DSP-CNTL.
     MOVE     "FKE10311"            TO   DSP-FMT.
