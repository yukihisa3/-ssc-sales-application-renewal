...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY9204I.COB`
...
*                                                              *
**履歴**********************************************************
*    2018/02/19  高橋　　新規作成（ＳＳＹ９１０４Ｉコピー）　　*
...
****  メッセージ情報  ***
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "SSY9204I".
...
*
     ...
     START   DSCENTF     KEY  >=  DKC-F01 DKC-F02 DKC-F03
...
************************************************************
 END-SEC                SECTION.
*
     CLOSE    DSPF DSCENTF  ZSOKMS HTOKMS HTENMS  DCMHSBL2.
*
 END-END.
     EXIT.
************************************************************
