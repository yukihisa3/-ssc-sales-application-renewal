...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NJH3754C.COB`
...
*
 ...
 FILE-CONTROL.
*ナフコ発注累積データ
     SELECT   NSHACL1  ASSIGN    TO        DA-01-VI-NSHACL1
...
*    ナフコ発注累積データ
******************************************************************
 FD  NSHACL1            LABEL RECORD   IS   STANDARD.
*                       BLOCK CONTAINS      15   RECORDS
*                       LABEL RECORD   IS   STANDARD.
*
     COPY     NSHACL1   OF        XFDLIB
              JOINING   DEN       PREFIX.
******************************************************************
*    取引先マスタ
******************************************************************
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH3754C".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH3754C".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
