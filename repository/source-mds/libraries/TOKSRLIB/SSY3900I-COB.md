...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY3900I.COB`
...
*    サブシステム　　　　：　ナフコ出荷支援システム　　　　　　*
*    業務名　　　　　　　：　出荷　　　　　　　　　　　　　　　*
*    モジュール名　　　　：　ナフコ送り状／納品明細書データ    *
*    　　　　　　　　　　　　作成指示　　　　　　　　　　　　  *
*    作成日／更新日　　　：　2019/12/03                        *
*    作成者／更新者　　　：　NAV                               *
*    処理概要　　　　　　：　ナフコへ納品する資料発行データ　　*
*                        ：　の条件指示　　　　　　　　　　    *
*    変更日　　　　　　　：　    /  /                          *
*    変更者　　　　　　　：　                                  *
*    変更概要　　　　　　：　　　　　　　　　　　　　　　　　　*
...
*画面表示用ワーク
 01  DSP-WORK.
     03  WORK-PGID                PIC  X(08)  VALUE  "SSY3900I".
     03  WORK-FORMID              PIC  X(08)  VALUE  "FSY39001".
*システム日付／時刻
 01  TIME-AREA.
