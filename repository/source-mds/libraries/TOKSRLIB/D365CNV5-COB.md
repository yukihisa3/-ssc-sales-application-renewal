...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/D365CNV5.COB`
...
*    業務名　　　　：　基幹　　　　　　　　　　　　　　        *
*    サブシステム　：　Ｄ３６５連携　　　　　　　　　　        *
*    モジュール名　：　ＳＵＢ商品名称マスタ作成・更新　　　　  *
*    作成日／作成者：　2021/06/04 INOUE                        *
*    処理概要　　　：　作成データからＳＵＢ名称マスタ　　      *
*                      を作成・更新する　　　　　　　　　      *
*    更新履歴                                                  *
*    更新日／更新者：　                                        *
*                                                              *
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "D365CNV5".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "D365CNV5".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*
     ...
     DISPLAY NC"サブ名称Ｍ作成" " OUT = " WRT-CNT    UPON CONS.
     DISPLAY NC"サブ名称Ｍ上書" " UPDT= " RWT-CNT    UPON CONS.
     DISPLAY "-------------------------------------" UPON CONS.
*
