...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY4467B.COB`
...
*    ｶｳﾝﾄ
 ...
 01  WK-RUT-F03              PIC  X(03)     VALUE  SPACE.
*ブレイク退避領域
 01  WK-KEY.
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY4467B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY4467B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*#2023/11/16 NAV ST 伝票番号＝０の時はデータ作成はしない
     IF    HEN-F02  =  ZERO
           ADD         1   TO        SKIP-CNT
           GO              TO        TENSO-EXIT
     END-IF.
...
*********2019/10/11 NAV ST変換ＴＢＬ　ＩＮＶの場合の対応
         IF    TBL-F04  =  SPACE
