...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/D365CNVD.COB`
...
*----<< 売上伝票ファイル >>--*
 SHTDENF-ERR            SECTION.
     ...
     DISPLAY  "### D365CNVD SHTDENF ERROR " SHTDENF-ST " "
...
*----<< 商品変換ＴＢＬ >>--*
 TBL-ERR                 SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### D365CNVD SUBTBLL1 ERROR " SUBTBLL1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     MOVE     "4010"    TO        PROGRAM-STATUS.
...
*----<< 売上伝票ファイル変換結果 >>--*
 SHTOUTF-ERR            SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### D365CNVD SHTOUTF ERROR " SHTDENF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     MOVE     "4010"    TO        PROGRAM-STATUS.
...
*--------------------------------------------------------------*
 300-END-RTN            SECTION.
     ...
     CLOSE    SHTOUTF.
*
     DISPLAY  "+++ D365CNVD ﾖﾐｺﾐ  ｹﾝｽｳ = " IN-CNT " +++"
                                       UPON CONS.
     DISPLAY  "+++ D365CNVD ｺｳｼﾝ  ｹﾝｽｳ = " OUT-CNT " +++"
                                       UPON CONS.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "*** D365CNVD END *** "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS
                                       UPON CONS.
 300-END-RTN-EXIT.
