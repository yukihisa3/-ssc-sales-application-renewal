...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NJH1110B.COB`
...
*                            変換伝票データファイルを作成する　*
*    取引先名　　　　　　：　ケーヨー　　統合版　　　　        *
*　　取引先ＣＤ　　　　　：　１７３、１７３１、７６０、７６０１*
**履歴**********************************************************
*    2018/02/14  高橋　　新規作成　　　　　　　　　　　　　　　*
*    2019/03/18  高橋　　発注種別変換マスタ対応　　　　　　　　*
*    0000/00/00　　　　　　　　　　　　　　　　　　　　　　　　*
****************************************************************
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "NJH1110B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "NJH1110B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*パラメタ区分により取引先ＣＤセット
     EVALUATE PARA-KBN
         WHEN "1"    MOVE  1731   TO   WK-TORICD
         DISPLAY NC"＃ケーヨー資材　東日本　変換＃" UPON CONS
         WHEN "2"    MOVE  1732   TO   WK-TORICD
         DISPLAY NC"＃ケーヨー資材　西日本　変換＃" UPON CONS
         WHEN "3"    MOVE  7601   TO   WK-TORICD
         DISPLAY NC"＃ケーヨー植物　東日本　変換＃" UPON CONS
         WHEN "4"    MOVE  7602   TO   WK-TORICD
         DISPLAY NC"＃ケーヨー植物　西日本　変換＃" UPON CONS
         WHEN OTHER
              MOVE        "4000"  TO   PROGRAM-STATUS
              DISPLAY NC"＃取引先ＣＤ取得エラー"      UPON CONS
              DISPLAY NC"＃取得区分" ":" PARA-KBN " " UPON CONS
              STOP  RUN
     END-EVALUATE.
*
...
*    ルート（直送ＣＤ）
     ...
     MOVE     WK-RUTO-H     TO        HEN-A12  WK-RUTO-CD.
*    ルートが空白の場合、９９をセット
     IF       WK-DH16  =  SPACE
              MOVE    "99"  TO        HEN-A12  WK-RUTO-CD
     END-IF.
*    ＪＡＮコード
...
*    伝票番号
     MOVE     WK-DH28       TO        HEN-A42.
*    特売ＣＤ
     MOVE     WK-DH29       TO        HEN-A43.
*    拠点ＣＤ
     MOVE     WK-DH30       TO        HEN-A44.
*    館番号
     MOVE     WK-DH31       TO        HEN-A45.
*    共通取引先ＣＤ
     MOVE     WK-DH32       TO        HEN-A46.
*    直送先ＣＤ
     MOVE     WK-DH33       TO        HEN-A47.
*    申込番号
     MOVE     WK-DH34       TO        HEN-A48.
*転送処理へ
     PERFORM  TENSO-SEC.
*
     WRITE    HEN-REC.
...
*****MOVE        HEN-A01   TO        HEN-F01.
     MOVE        WK-TORICD TO        HEN-F01.
*伝票ナンバー
     MOVE        HEN-A42   TO        HEN-F02  HEN-F23.
*行番号
...
*#2018/03/01 NAV ST 部門ＣＤ判断セット
*****MOVE     SPACE        TO        RUT-F02.
     MOVE     HEN-A40      TO        RUT-F02.
*#2018/03/01 NAV ED
     MOVE     SPACE        TO        RUT-F03.
     MOVE     WK-RUTO-CD   TO        RUT-F03(1:2).
     READ     JHMRUTL1
         INVALID
