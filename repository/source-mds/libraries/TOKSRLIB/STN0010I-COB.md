...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/STN0010I.COB`
...
*画面表示用ワーク
 01  DSP-WORK.
     03  WORK-PGID                PIC  X(08)  VALUE  "STN0010I".
...
*フラグ領域
 01  FLG-AREA.
     ...
     03  JYO-INV-FLG              PIC  X(03)  VALUE  ZERO.
*ワーク領域
 01  WRK-AREA.
***  モード退避
...
*    原票_
     ...
     PERFORM   JYOKEN1-READ-SEC.
     IF        JYO-INV-FLG   =    "   "
               MOVE    JYO-F04    TO   BK-GENNO-0
               MOVE    JYO-F05    TO   BK-GENNO-1
     ELSE
               DISPLAY NC"条件ファイルなし！" UPON CONS
...
*画面表示
     ...
     PERFORM   DSP-WT-SEC.
*画面入力
*    MOVE      "PARAGRP"   TO  DSP-GRP.
     MOVE      "TANADT"    TO  DSP-GRP.
     PERFORM   DSP-RD-SEC.
*ＰＦ判定
     EVALUATE  DSP-FNC
          WHEN "E000"
...
*_卸日
     IF  DSP-TANADT   =    SPACE
         MOVE   1          TO   ERR-FLG
         MOVE  "R"         TO   EDIT-OPTION  OF  DSP-TANADT
         MOVE  "C"         TO   EDIT-CURSOR  OF  DSP-TANADT
         GO                TO   CHK-BODY-EXIT
     END-IF.
     MOVE  "2"         TO   LINK-IN-KBN.
     MOVE   DSP-TANADT TO   LINK-IN-YMD8.
     CALL  "SKYDTCKB"  USING   LINK-IN-KBN
                               LINK-IN-YMD6
                               LINK-IN-YMD8
                               LINK-OUT-RET
...
****************************************************************
 OPT-CLR-SEC        SECTION.
     MOVE  SPACE         TO  EDIT-CURSOR  OF  DSP-TANADT.
     MOVE "M"            TO  EDIT-OPTION  OF  DSP-TANADT.
 OPT-CLR-EXIT.
     EXIT.
