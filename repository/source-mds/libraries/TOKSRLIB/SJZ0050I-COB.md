...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SJZ0050I.COB`
...
******************************************************************
 ...
 01  LINK-OUT-SOKCD      PIC  X(02).
 01  LINK-OUT-SYOCD1     PIC  X(08).
 01  LINK-OUT-SYOCD2     PIC  X(08).
...
***  商品ＣＤ開始
     IF       DSP-SYOCD1  =  SPACE
              MOVE   SPACE    TO  DSP-SYOCD1
     END-IF.
***  商品ＣＤ終了
     IF       DSP-SYOCD2  =  SPACE
              MOVE "99999999" TO  DSP-SYOCD2
     END-IF.
***  商品ＣＤ大小チェック
     IF       DSP-SYOCD1  >  DSP-SYOCD2
              MOVE  4         TO   ERR-FLG
...
*実行
         WHEN   "E000"
                MOVE    DSP-SOKCD     TO   LINK-OUT-SOKCD
                MOVE    DSP-SYOCD1    TO   LINK-OUT-SYOCD1
                MOVE    DSP-SYOCD2    TO   LINK-OUT-SYOCD2
                IF      DSP-TOKCD   NOT NUMERIC
                OR      DSP-TOKCD   =  ZERO
                        MOVE ZERO      TO  LINK-OUT-TOKCD
                ELSE
