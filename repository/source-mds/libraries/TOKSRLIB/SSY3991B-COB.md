...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY3991B.COB`
...
* 基本情報ファイルの初期読み込み
     ...
     INITIALIZE                 KH1-REC.
     MOVE  PA-KANRINO       TO  KH1-F01.  *> 管理番号
