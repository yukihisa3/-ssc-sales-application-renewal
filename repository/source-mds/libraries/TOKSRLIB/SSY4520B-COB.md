...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY4520B.COB`
...
*ワーク項目
 ...
 01  WK-HAC-F302                  PIC  X(06)     VALUE  SPACE.
 01  WK-JYR-F302                  PIC  X(06)     VALUE  SPACE.
*
     COPY     BMSHACF   OF        XFDLIB
              JOINING   WHAC      PREFIX.
     COPY     BMSJYRF   OF        XFDLIB
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG                PIC  X(08)     VALUE "SSY4520B".
         ...
         WHEN "ORDER"
           EVALUATE  RCV-F101
             ...
             WHEN  "C"
              ...
              MOVE      WHAC-F302(1:6) TO   WK-HAC-F302
**************伝票番号特別処理 ST
              IF  WK-HAC-F302(6:1)  =  SPACE
                  MOVE  SPACE     TO   WHAC-F302
                  MOVE  "0"       TO   WHAC-F302(1:1)
                  MOVE  WK-HAC-F302(1:5)  TO  WHAC-F302(2:5)
              END-IF
**************MOVE      WHAC-F302(1:6) TO   WK-HAC-F302
              IF  WK-HAC-F302(5:2)  =  SPACE
                  MOVE  SPACE     TO   WHAC-F302
                  MOVE  "00"      TO   WHAC-F302(1:2)
                  MOVE  WK-HAC-F302(1:4)  TO  WHAC-F302(3:4)
              END-IF
**************MOVE      WHAC-F302(1:6) TO   WK-HAC-F302
              IF  WK-HAC-F302(4:3)  =  SPACE
                  MOVE  SPACE     TO   WHAC-F302
                  MOVE  "000"     TO   WHAC-F302(1:3)
                  MOVE  WK-HAC-F302(1:3)  TO  WHAC-F302(4:3)
              END-IF
**************MOVE      WHAC-F302(1:6) TO   WK-HAC-F302
              IF  WK-HAC-F302(3:4)  =  SPACE
                  MOVE  SPACE     TO   WHAC-F302
                  MOVE  "0000"    TO   WHAC-F302(1:4)
                  MOVE  WK-HAC-F302(1:2)  TO  WHAC-F302(5:2)
              END-IF
**************MOVE      WHAC-F302(1:6) TO   WK-HAC-F302
              IF  WK-HAC-F302(2:5)  =  SPACE
                  MOVE  SPACE     TO   WHAC-F302
                  MOVE  "00000"   TO   WHAC-F302(1:5)
                  MOVE  WK-HAC-F302(1:1)  TO  WHAC-F302(6:1)
              END-IF
**************伝票番号特別処理 ED
             WHEN  "D"
         ...
         WHEN "RECEI"
           EVALUATE  RCV-F101
             ...
             WHEN  "C"
              ...
              MOVE      WJYR-F302(1:6) TO   WK-JYR-F302
**************伝票番号特別処理 ST
              IF  WK-JYR-F302(6:1)  =  SPACE
                  MOVE  SPACE     TO   WJYR-F302
                  MOVE  "0"       TO   WJYR-F302(1:1)
                  MOVE  WK-JYR-F302(1:5)  TO  WJYR-F302(2:5)
              END-IF
**************MOVE      WJYR-F302(1:6) TO   WK-JYR-F302
              IF  WK-JYR-F302(5:2)  =  SPACE
                  MOVE  SPACE     TO   WJYR-F302
                  MOVE  "00"      TO   WJYR-F302(1:2)
                  MOVE  WK-JYR-F302(1:4)  TO  WJYR-F302(3:4)
              END-IF
**************MOVE      WJYR-F302(1:6) TO   WK-JYR-F302
              IF  WK-JYR-F302(4:3)  =  SPACE
                  MOVE  SPACE     TO   WJYR-F302
                  MOVE  "000"     TO   WJYR-F302(1:3)
                  MOVE  WK-JYR-F302(1:3)  TO  WJYR-F302(4:3)
              END-IF
**************MOVE      WJYR-F302(1:6) TO   WK-JYR-F302
              IF  WK-JYR-F302(3:4)  =  SPACE
                  MOVE  SPACE     TO   WJYR-F302
                  MOVE  "0000"    TO   WJYR-F302(1:4)
                  MOVE  WK-JYR-F302(1:2)  TO  WJYR-F302(5:2)
              END-IF
**************MOVE      WJYR-F302(1:6) TO   WK-JYR-F302
              IF  WK-JYR-F302(2:5)  =  SPACE
                  MOVE  SPACE     TO   WJYR-F302
                  MOVE  "00000"   TO   WJYR-F302(1:5)
                  MOVE  WK-JYR-F302(1:1)  TO  WJYR-F302(6:1)
              END-IF
**************伝票番号特別処理 ED
             WHEN  "D"
