...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY9202B.COB`
...
*                            をセンター納品データへ出力する。　*
**履歴**********************************************************
*    2018/02/19  高橋　　新規作成（ＳＳＹ９１０２Ｂコピー）　　*
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY9202B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY9202B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*
     IF       DEN-F01  =  1731   OR 1732
                       OR 7601   OR 7602
              MOVE      KEI-A40  TO    DKC-F07
              MOVE      KEI-A38  TO    WK-HATYU-SYUBETSU
     END-IF.
*
     EVALUATE WK-HATYU-SYUBETSU
         ...
         WHEN OTHER
              MOVE     "1"        TO   DKC-F16
     END-EVALUATE.
*#2019/03/19 NAV ST　発注種別変換区分をそのままセット
