...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SJR9905B.COB`
...
*    業務名　　　　　　　：　受領返品　　　　　　　            *
*    サブシステム　　　　：　受領返品データ抽出　　　　　      *
*    作成日／作成者　　　：　2021/11/10  NAV TAKAHASHI         *
*    処理概要　　　　　　：　受領返品データの抜出を行なう。　　*
*    更新日／更新者　　　：　                                  *
*    更新概要　　　　　　：　　　　　　　　　　　　　　　　　　*
*    　　　　　　　　　　　　　　　　　　　　　　　　　　　　　*
...
*返品累積ワーク　　
     SELECT   COMRHEWK  ASSIGN    TO        DA-01-S-COMRHEWK
                        FILE  STATUS   IS   RWK-STATUS.
*
 DATA                   DIVISION.
 FILE                   SECTION.
******************************************************************
...
*メッセージ定義エリア
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SJR9905B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SJR9905B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*
 FILEERR-SEC2           SECTION.
     USE       AFTER    EXCEPTION
                        PROCEDURE   COMRHEWK.
     MOVE      "COMRHEWK"   TO   AB-FILE.
     MOVE      RWK-STATUS   TO   AB-STS.
     DISPLAY   MSG-ABEND         UPON CONS.
     DISPLAY   SEC-NAME          UPON CONS.
     DISPLAY   ABEND-FILE        UPON CONS.
     MOVE      4000         TO   PROGRAM-STATUS.
