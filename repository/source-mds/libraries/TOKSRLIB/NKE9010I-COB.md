...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NKE9010I.COB`
...
*    サブシステム　　　　：　出荷業務　　　　　　　　　　      *
*    業務名　　　　　　　：　カインズ検品システム　　　　　    *
*    モジュール名　　　　：　カインズ検品振分倉庫一括変更      *
*    作成日／更新日　　　：　2023/10/27                        *
*    作成者／更新者　　　：　NAV                               *
*    処理概要　　　　　　：　画面より、カインズ検品システムの  *
*                            振分倉庫ＣＤを一括変更する条件を  *
*                            指定する。（出荷数＝０対応）      *
****************************************************************
****************************************************************
...
*
 ...
 01  PARA-HSOKO             PIC   X(02).
 01  PARA-STENCD            PIC   9(05).
 01  PARA-ETENCD            PIC   9(05).
 01  PARA-SCENTR            PIC   9(05).
 01  PARA-ECENTR            PIC   9(05).
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### NKE9010I DSPFILE ERROR " DSP-CNTL " "
...
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### NKE9010I HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     4000           TO   PROGRAM-STATUS.
     DISPLAY  "### NKE9010I ZSOKMS1 ERROR " ZSOKMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FKE90101.
*
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "NKE9010I"      TO   PGID.
     MOVE    "FKE90101"      TO   FORM.
*
     MOVE     SPACE          TO   DSP-CNTL.
     MOVE     "FKE90101"     TO   DSP-FMT.
              ...
              READ      ZSOKMS1
                  INVALID  KEY
                        ...
                        IF   ERR-FLG   =    ZERO
                             MOVE      5    TO   ERR-FLG
                        END-IF
                        MOVE     "C"   TO   EDIT-CURSOR OF HSOKO
                        MOVE     "R"   TO   EDIT-OPTION OF HSOKO
              NOT INVALID  KEY
                        MOVE      SOK-F02   TO   HSOKON
                        MOVE      SOKO      TO   WK-SOKCD
              END-READ
     ELSE
              IF   ERR-FLG   =    ZERO
...
*
     ...
     END-IF.
*開始センターコードチェック
     IF       SCENTR  NOT NUMERIC
              MOVE      ZERO      TO   SCENTR
     END-IF.
     IF       ECENTR  NOT NUMERIC
              MOVE      99999     TO   ECENTR
     END-IF.
*
     IF       SCENTR  >  ECENTR
              IF   ERR-FLG   =    ZERO
                   MOVE      7    TO   ERR-FLG
              END-IF
              MOVE     "C"   TO   EDIT-CURSOR OF SCENTR
              MOVE     "R"   TO   EDIT-OPTION OF SCENTR
              MOVE     "R"   TO   EDIT-OPTION OF ECENTR
     END-IF.
*部門コードチェック
...
*
     ...
     MOVE     HSOKO               TO   PARA-HSOKO.
     MOVE     STENCD              TO   PARA-STENCD.
     MOVE     ETENCD              TO   PARA-ETENCD.
     MOVE     SCENTR              TO   PARA-SCENTR.
     MOVE     ECENTR              TO   PARA-ECENTR.
...
*--------------------------------------------------------------*
 CLR-HEAD-RTN           SECTION.
     MOVE     " "            TO   EDIT-CURSOR OF JDATE
                                  ...
                                  EDIT-CURSOR OF SOKO
                                  EDIT-CURSOR OF HSOKO
                                  EDIT-CURSOR OF STENCD
                                  EDIT-CURSOR OF ETENCD
                                  EDIT-CURSOR OF SCENTR
                                  EDIT-CURSOR OF ECENTR
     ...
     MOVE     "M"            TO   EDIT-OPTION OF JDATE
                                  ...
                                  EDIT-OPTION OF SOKO
                                  EDIT-OPTION OF HSOKO
                                  EDIT-OPTION OF STENCD
                                  EDIT-OPTION OF ETENCD
                                  EDIT-OPTION OF SCENTR
                                  EDIT-OPTION OF ECENTR
