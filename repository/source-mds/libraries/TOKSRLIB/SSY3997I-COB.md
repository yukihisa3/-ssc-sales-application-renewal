...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY3997I.COB`
...
*    サブシステム　　　　：　ナフコ出荷支援システム　　　　　　*
*    業務名　　　　　　　：　実績管理　　　　　　　　　　　　　*
*    モジュール名　　　　：　ナフコ受領累積ＤＴ抽出指示　　　　*
*    作成日／更新日　　　：　2020/06/12                        *
*    作成者／更新者　　　：　NAV                               *
*    処理概要　　　　　　：　ナフコ受領累積ＤＴから累積抽出する*
*                        ：　条件：受信日付範囲を入力する。    *
*    変更日　　　　　　　：　    /  /                          *
*    変更者　　　　　　　：　                                  *
*    変更概要　　　　　　：　　　　　　　　　　　　　　　　　　*
...
*画面表示用ワーク
 01  DSP-WORK.
     03  WORK-PGID                PIC  X(08)  VALUE  "SSY3997I".
     03  WORK-FORMID              PIC  X(08)  VALUE  "FSY39971".
*システム日付／時刻
 01  TIME-AREA.
...
*
**************************************************************
 PROCEDURE             DIVISION   USING  LINK-STDATE
                                         LINK-EDDATE.
**************************************************************
 DECLARATIVES.
 DSP-ERR                   SECTION.
...
*開始管理番号
      IF      DSP-STDATE  =  ZERO
      OR      DSP-STDATE  NOT NUMERIC
              MOVE    ZERO       TO   DSP-STDATE
      END-IF.
 PARA-CHK-03.
*終了管理番号
      IF      DSP-EDDATE  =  ZERO
      OR      DSP-EDDATE  NOT NUMERIC
...
*
 ...
 PARA-CHK-05.
     MOVE    "2"       TO    PSW.
*大範囲指定ＭＳＧ
     COMPUTE HIDUKE-CHK = DSP-EDDATE  -  DSP-STDATE.
     IF       HIDUKE-CHK  >  100
