...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NSY9002B.COB`
...
*
 ...
 FILE-CONTROL.
*---<<  出荷情報データ  >>---*
     SELECT   DNSYUKF   ASSIGN         DA-01-VI-DNSYUKL1
...
*----<< 出荷情報データ >>--*
 KMS-ERR              SECTION.
     ...
     DISPLAY  "### NSY9002B DNSYUKF    ERROR " KMS-ST " "
...
*----<< 条件ファイル >>--*
 JYO-ERR              SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     "4000"         TO   PROGRAM-STATUS.
     DISPLAY  "### NSY9002B HJYOKEN    ERROR " JYO-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
