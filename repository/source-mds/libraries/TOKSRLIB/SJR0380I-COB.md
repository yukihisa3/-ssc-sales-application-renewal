...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SJR0380I.COB`
...
*取引先マスタ
     SELECT  HTOKMS    ASSIGN    TO        TOKMS2
                       ...
                       FILE      STATUS    TOK-ST.
*伝票纏め返品累積データ
     SELECT  COMRMHF   ASSIGN    TO        COMRMHL7
                       ORGANIZATION        INDEXED
...
*伝票纏め返品累積データ存在チェック
     ...
     START    COMRMHF   KEY  IS   >=   RMH-F78  RMH-F79  RMH-F01
     ...
     INVALID
              ...
              MOVE     "R"   TO   EDIT-OPTION  OF  DSP-BTDATE
*↓20171121NG修正
                                  EDIT-OPTION  OF  DSP-BTTIME
                                  EDIT-OPTION  OF  DSP-BTTORI
*↑20171121NG修正
              GO             TO   PARA-CHK-EXIT
     NOT INVALID
***           ファイル存在チェック
...
*画面の初期化
     MOVE    SPACE                TO   DSP-FJR03801.
*システム日付転送
     MOVE    HEN-DATE             TO   DSP-SDATE.
*システム時間転送
     MOVE    HEN-TIME             TO   DSP-STIME.
*ＰＧＩＤ
     MOVE    "SJR0380I"           TO   DSP-PGID.
*ＦＯＲＭＩＤ
     MOVE    "FJR03801"           TO   DSP-FORMID.
*項目属性クリア　
...
*
     READ  COMRMHF
           AT  END     MOVE  "CHK"   TO   SONZAI-CHK
     END-READ.
*
 COMRMHF-READ-EXIT.
     EXIT.
*****************<<  SJR0380I   END PROGRAM  >>******************
