...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY1230I.COB`
...
*----<< 表示ファイル >>--*
     SELECT   DSPFILE   ASSIGN         01-GS-DSPF
                        ...
                        STATUS         DSP-ST.
*----<< 一括ＰＤラベルファイル >>--*
     SELECT   KNBULKF   ASSIGN         DA-01-VI-KNBULKL2
                        ...
                        STATUS         KNBULKF-ST.
*----<< ケースＰＤラベルファイル >>--*
     SELECT   KNCASEF   ASSIGN         DA-01-VI-KNCASEL3
                        ORGANIZATION   INDEXED
                        ACCESS    MODE SEQUENTIAL
...
*
*----<< ﾌｱｲﾙ ｽﾃｰﾀｽ >>--*
 01  KNBULKF-ST        PIC  X(02).
 01  KNCASEF-ST        PIC  X(02).
...
*----<< 表示ファイル >>--*
 DSPFILE-ERR            SECTION.
     ...
     DISPLAY  "### SSY1230I DSPFILE ERROR " DSP-CNTL " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
     MOVE     4000           TO   PROGRAM-STATUS.
*    CLOSE    KNBULKF   HTOKMS    ZSOKMS1    DSPFILE.
     STOP     RUN.
*----<< 一括ラベルファイル >>--*
 KNBULKF-ERR            SECTION.
     USE AFTER     EXCEPTION PROCEDURE      KNBULKF.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY1230I KNBULKL2 ERROR " KNBULKF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
     MOVE     4000           TO   PROGRAM-STATUS.
*    CLOSE    KNBULKF   ZSOKMS1    DSPFILE.
     STOP     RUN.
*----<< 取引先マスタ >>--*
 HTOKMS-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY1230I HTOKMS ERROR " HTOKMS-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< ケースＰＤラベルファイル >>--*
 KNCASEF-ERR            SECTION.
     USE AFTER     EXCEPTION PROCEDURE      KNCASEF.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY1228I KNCASEL3 ERROR " KNCASEF-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
     MOVE     4000           TO   PROGRAM-STATUS.
*    CLOSE    KNCASEF   ZSOKMS1    DSPFILE.
     STOP     RUN.
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SSY1230I ZSOKMS1 ERROR " ZSOKMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "*** SSY1230I START *** "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS
                                       UPON CONS.
     OPEN     I-O       DSPFILE.
     OPEN     INPUT     KNBULKF  KNCASEF.
     OPEN     INPUT     HTOKMS.
     OPEN     INPUT     ZSOKMS1.
*----<< ﾜｰｸ ｼｮｷｾｯﾄ >>-*
     MOVE     0              TO   GR-NO.
...
*----<< 納品形態入力 >>-*
     PERFORM  220-INP-GRP00  UNTIL     GR-NO    NOT  =    1.
*----<< ﾊﾞｯﾁNO. ﾆｭｳﾘｮｸ >>-*
     PERFORM  220-INP-GRP01  UNTIL     GR-NO    NOT  =    2.
*----<< ﾊﾝｲ ｼﾃｲ ﾆｭｳﾘｮｸ1 >>-*
     PERFORM  220-INP-GRP02  UNTIL     GR-NO    NOT  =    3.
*----<< ﾊﾝｲ ｼﾃｲ ﾆｭｳﾘｮｸ2 >>-*
     IF       KEITAI  =  "1"
              PERFORM  220-INP-GRP03
                             UNTIL     GR-NO    NOT  =    4
     END-IF.
     IF       KEITAI  =  "2"
              PERFORM  220-INP-GRP04
                             UNTIL     GR-NO    NOT  =    4
     END-IF.
     IF       KEITAI  =  "3"
              PERFORM  220-INP-GRP04
...
*--------------------------------------------------------------*
 300-END-RTN            SECTION.
     ...
     CLOSE    DSPFILE.
     CLOSE    KNBULKF  KNCASEF.
     CLOSE    HTOKMS.
     CLOSE    ZSOKMS1.
*
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "*** SSY1230I END *** "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS
                                       UPON CONS.
 300-END-RTN-EXIT.
...
*--------------------------------------------------------------*
 210-DSP-INIT           SECTION.
     ...
     MOVE     SPACE          TO   FSY12301.
*
     PERFORM  CLR-HEAD0-RTN.
     PERFORM  CLR-HEAD-RTN.
     PERFORM  CLR-BODY1-RTN.
     PERFORM  CLR-BODY2-RTN.
     PERFORM  CLR-BODY3-RTN.
     PERFORM  CLR-TAIL-RTN.
*
     MOVE    "SSY1230I"      TO   PGID.
     MOVE    "FSY12301"      TO   FORM.
...
*
     IF     ( KEITAI  NOT = "1"   ) AND
            ...
            ( KEITAI  NOT = "3"   )
              MOVE      6         TO   ERR-FLG
              MOVE     "C"        TO   EDIT-CURSOR OF KEITAI
              MOVE     "R"        TO   EDIT-OPTION OF KEITAI
...
*
     IF  KEITAI    =    "1"
         GO                       TO   220-GRP01-CHECK-04
     END-IF.
     IF  KEITAI    =    "2"
         GO                       TO   220-GRP01-CHECK-05
     END-IF.
     IF  KEITAI    =    "3"
         GO                       TO   220-GRP01-CHECK-06
     END-IF.
*
 220-GRP01-CHECK-04.
*    一括ラベルファイル存在チェック
     IF  ERR-FLG        =    ZERO
         ...
         MOVE      SPACE          TO   BUL-F004
         MOVE      ZERO           TO   BUL-FA01
         MOVE      ZERO           TO   BUL-FA02
         MOVE      ZERO           TO   BUL-FA03
         MOVE      ZERO           TO   BUL-FA06
         MOVE      ZERO           TO   BUL-FA04
         MOVE      ZERO           TO   BUL-FA05
...
*    ケースＰＤラベルファイル存在チェック
     IF  ERR-FLG        =    ZERO
         ...
         INITIALIZE                    CAS-REC
         MOVE      JDATE          TO   CAS-F001
         MOVE      JTIME          TO   CAS-F002
         MOVE      TORICD         TO   CAS-F003
         MOVE      SPACE          TO   CAS-F004
         MOVE      ZERO           TO   CAS-FA02
         MOVE      ZERO           TO   CAS-FA07
         MOVE      ZERO           TO   CAS-FA08
         MOVE      ZERO           TO   CAS-FA03
         MOVE      ZERO           TO   CAS-FA04
         MOVE      ZERO           TO   CAS-FA05
         MOVE      SPACE          TO   CAS-FC01
...
*
*    ルート
     IF       ROUTEF   NOT NUMERIC
              MOVE     00    TO   ROUTEF
     END-IF.
     IF       ROUTET   NOT NUMERIC
              MOVE     99    TO   ROUTET
     END-IF.
     IF     ( ROUTEF    IS NUMERIC     AND
              ROUTET    IS NUMERIC     AND
              ROUTEF    >    ROUTET   )
              IF   ERR-FLG   =    ZERO
                   MOVE      7    TO   ERR-FLG
              END-IF
              MOVE     "C"   TO   EDIT-CURSOR OF ROUTEF
              MOVE     "R"   TO   EDIT-OPTION OF ROUTEF
              MOVE     "R"   TO   EDIT-OPTION OF ROUTET
     END-IF.
*    部門
...
*    LEVEL  3      ファイル存在チェック　　                    *
*--------------------------------------------------------------*
 220-SONZAI-CHECK1       SECTION.
     MOVE    "220-SONZAI-CHECK1"  TO   S-NAME.
*
 220-SONZAI-CHECK1-01.
     MOVE     SPACE          TO   BUL-REC.
     INITIALIZE                   BUL-REC.
*T↓
...
*    DISPLAY "TORICD    ="   TORICD UPON CONS.
*    DISPLAY "ROUTEF    ="   ROUTEF UPON CONS.
...
*             MOVE     "R"        TO   EDIT-OPTION OF STANA
*             MOVE     "R"        TO   EDIT-OPTION OF ETANA
              GO   TO   220-SONZAI-CHECK1-EXIT
     END-START.
*
 220-SONZAI-CHECK1-02.
     READ     KNBULKF
                AT END
                   MOVE      11   TO   ERR-FLG
                   MOVE     "C"   TO   EDIT-CURSOR OF SOKO
...
*               MOVE  "R"   TO   EDIT-OPTION OF ETANA
     ...
     END-IF.
*
 220-SONZAI-CHECK1-07.
     IF  ROUTEF IS     NUMERIC
         IF     BUL-FA03    >=  ROUTEF
                CONTINUE
         ELSE
                GO          TO   220-SONZAI-CHECK1-02
         END-IF
     END-IF.
*
 220-SONZAI-CHECK1-08.
     IF  ROUTET IS     NUMERIC
         IF     BUL-FA03    <=  ROUTET
                CONTINUE
         ELSE
                GO          TO   220-SONZAI-CHECK1-02
...
*
 220-SONZAI-CHECK1-10.
     ...
     END-IF.
*
 220-SONZAI-CHECK1-11.
     IF  ( WK-HACYU  IS  NUMERIC ) AND
         ( WK-HACYU  NOT = ZERO  )
         IF     BUL-FA04     =  WK-HACYMD2
                CONTINUE
         ELSE
*               MOVE   11   TO   ERR-FLG
*               MOVE  "C"   TO   EDIT-CURSOR OF SOKO
...
*               MOVE  "R"   TO   EDIT-OPTION OF ETANA
     ...
     END-IF.
*
*220-SONZAI-CHECK1-13.
*    IF  STANA  NOT =  SPACE
*T
*        DISPLAY "BUL-FC01=" BUL-FC01 UPON CONS
*        DISPLAY "BUL-FC01=" BUL-FC01
*        DISPLAY "STANA   =" STANA    UPON CONS
*        DISPLAY "STANA   =" STANA
*T
*        IF     BUL-FC01    >=  STANA
...
*    END-IF.
*
 220-SONZAI-CHECK1-EXIT.
     EXIT.
*--------------------------------------------------------------*
*    LEVEL  3      ﾊﾝｲ      ﾆｭｳﾘｮｸ2                            *
*--------------------------------------------------------------*
 220-INP-GRP04          SECTION.
     MOVE     "220-INP-GRP04"     TO   S-NAME.
*
     MOVE     "BODY03"            TO   WK-GRP.
     PERFORM  900-DSP-READ.
*
     EVALUATE DSP-FNC
         WHEN PF05
...
*    LEVEL  3                                                  *
*--------------------------------------------------------------*
 220-GRP04-CHECK-SEC    SECTION.
     MOVE     "220-CRP04-CHECK-SEC"    TO   S-NAME.
     MOVE     ZERO      TO        ERR-FLG.
*
*    ルート
     IF       ROUTEF   NOT NUMERIC
...
*    _番
     ...
     END-IF.
*
 220-GRP04-CHECK-EXIT.
     EXIT.
*--------------------------------------------------------------*
*    LEVEL  3      ケースＰＤラベルファイル存在チェック        *
*--------------------------------------------------------------*
...
*T↑
     ...
     MOVE     JTIME          TO   CAS-F002.
     MOVE     TORICD         TO   CAS-F003.
     MOVE     SOKO           TO   CAS-F004.
     MOVE     STEN           TO   CAS-FA02.
     MOVE     TORICD         TO   CAS-FA07.
     MOVE     ROUTEF         TO   CAS-FA08.
     MOVE     SBUMON         TO   CAS-FA03.
     MOVE     WK-HACYMD2     TO   CAS-FA04.
     MOVE     WK-NOUYMD2     TO   CAS-FA05.
     MOVE     STANA          TO   CAS-FC01.
     START    KNCASEF   KEY  >=   CAS-F001  CAS-F002
                                  CAS-F003  CAS-F004
                                  CAS-FA02  CAS-FA07
                                  CAS-FA08  CAS-FA03
...
*
 220-SONZAI-CHECK2-10.
     ...
     END-IF.
*
 220-SONZAI-CHECK2-11.
     IF  ( WK-HACYU  IS  NUMERIC ) AND
         ( WK-HACYU  NOT = ZERO  )
         IF     CAS-FA04     =  WK-HACYMD2
                CONTINUE
         ELSE
*               MOVE   11   TO   ERR-FLG
*               MOVE  "C"   TO   EDIT-CURSOR OF SOKO
...
*               MOVE  "R"   TO   EDIT-OPTION OF ETANA
     ...
     END-IF.
*
 220-SONZAI-CHECK2-12.
     IF ( WK-NOUHIN IS  NUMERIC ) AND
        ( WK-NOUHIN NOT = ZERO  )
*T
*         DISPLAY "WK-NOUYMD2=" WK-NOUYMD2 UPON CONS
*         DISPLAY "CAS-FA05  =" CAS-FA05   UPON CONS
*T
         IF     CAS-FA05     =  WK-NOUYMD2
                CONTINUE
         ELSE
*               MOVE   11   TO   ERR-FLG
*               MOVE  "C"   TO   EDIT-CURSOR OF SOKO
...
*               MOVE  "R"   TO   EDIT-OPTION OF ETANA
     ...
     END-IF.
*
 220-SONZAI-CHECK2-13.
     IF  STANA  NOT =  SPACE
*T
*        DISPLAY "CAS-FC01=" CAS-FC01 UPON CONS
...
*
     MOVE     KEITAI              TO   PARA-OUT-KEITAI.
...
*
     ...
     ELSE
              MOVE      ROUTEF    TO   PARA-OUT-SROUTE
     END-IF.
*
     IF       ROUTET    NOT  NUMERIC
     OR       ROUTET    =    ZERO
     ...
     ELSE
              MOVE      ROUTET    TO   PARA-OUT-EROUTE
     END-IF.
*
     IF       SBUMON NOT  NUMERIC
     OR       SBUMON    =    ZERO
...
*
*T
     DISPLAY "PARA-OUT-KEITAI =" PARA-OUT-KEITAI  UPON CONS.
     DISPLAY "PARA-OUT-JDATE  =" PARA-OUT-JDATE   UPON CONS.
     DISPLAY "PARA-OUT-JTIME  =" PARA-OUT-JTIME   UPON CONS.
     DISPLAY "PARA-OUT-TORICD =" PARA-OUT-TORICD  UPON CONS.
     DISPLAY "PARA-OUT-SOKO   =" PARA-OUT-SOKO    UPON CONS.
     DISPLAY "PARA-OUT-SCENTER=" PARA-OUT-SCENTER UPON CONS.
     DISPLAY "PARA-OUT-ECENTER=" PARA-OUT-ECENTER UPON CONS.
     DISPLAY "PARA-OUT-SROUTE =" PARA-OUT-SROUTE  UPON CONS.
     DISPLAY "PARA-OUT-EROUTE =" PARA-OUT-EROUTE  UPON CONS.
     DISPLAY "PARA-OUT-SBUMON =" PARA-OUT-SBUMON  UPON CONS.
     DISPLAY "PARA-OUT-EBUMON =" PARA-OUT-EBUMON  UPON CONS.
     DISPLAY "PARA-OUT-HDATE  =" PARA-OUT-HDATE   UPON CONS.
     DISPLAY "PARA-OUT-NDATE  =" PARA-OUT-NDATE   UPON CONS.
     DISPLAY "PARA-OUT-STANA  =" PARA-OUT-STANA   UPON CONS.
     DISPLAY "PARA-OUT-ETANA  =" PARA-OUT-ETANA   UPON CONS.
*T
*
...
*    LEVEL  3      ＨＥＡＤ　属性クリア　　　　　　　　　　　　*
*--------------------------------------------------------------*
 CLR-HEAD0-RTN           SECTION.
     MOVE     " "            TO   EDIT-CURSOR OF KEITAI.
     MOVE     "M"            TO   EDIT-OPTION OF KEITAI.
 CLR-HEAD0-EXIT.
     EXIT.
*--------------------------------------------------------------*
*    LEVEL  3      ＨＥＡＤ　属性クリア　　　　　　　　　　　　*
...
*
     ...
     MOVE     " "            TO   EDIT-CURSOR OF ETEN.
     MOVE     "M"            TO   EDIT-OPTION OF ETEN.
*
 CLR-BODY1-EXIT.
     EXIT.
*--------------------------------------------------------------*
...
*
     MOVE     " "            TO   EDIT-CURSOR OF ROUTEF
                                  EDIT-CURSOR OF ROUTET
...
*                                 EDIT-CURSOR OF ETANA.
     MOVE     "M"            TO   EDIT-OPTION OF ROUTEF
                                  EDIT-OPTION OF ROUTET
