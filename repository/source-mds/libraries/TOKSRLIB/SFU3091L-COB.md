...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SFU3091L.COB`
...
*    作成日／更新日　　　：　2018/05/14 T.TAKAHASHI            *
*    作成者／更新者　　　：　ＮＡＶ　　　　　　　　　　　　　　*
*    処理概要　　　　　　：　社内振替データより、　　　　　　　*
*                        ：　チェックリストを出力する。　　　　*
*　　　　　　　　　　　　　　（入力順出力）　　　　　　　　　　*
...
*
 ...
 FILE-CONTROL.
*----<< 振替ワーク >>--*
     SELECT   SFRLSTWK  ASSIGN         DA-01-VS-SFRLSTWK
...
****************************************************************
 FILE                   SECTION.
*----<< 振替ワーク >>--*
 FD  SFRLSTWK           LABEL     RECORD   IS   STANDARD.
...
*
 01  HEAD01.
     03  FILLER         CHARACTER TYPE BAIKAKU-1-5.
         ...
         05  FILLER     PIC  X(08)     VALUE  "SFU3091L".
...
*--------------------------------------------------------------*
 DECLARATIVES.
*----<< 振替ワーク >>--*
 SFRLSTWK-ERR            SECTION.
     USE AFTER     EXCEPTION PROCEDURE      SFRLSTWK.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SFU3091L SFRLSTWK ERROR " SFRLSTWK-ST " "
...
*----<< 倉庫マスタ >>--*
 ZSOKMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SFU3091L ZSOKMS1 ERROR " ZSOKMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*----<< 担当者マスタ >>--*
 TANMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "### SFU3091L TANMS1 ERROR " TANMS1-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     DISPLAY  SEC-NAME                 UPON CONS.
...
*
     MOVE     LST-F92        TO   ME-022.
     MOVE     "-"            TO   ME-023.
     MOVE     LST-F93        TO   ME-024.
     MOVE     LST-F94        TO   ME-025.
     MOVE     LST-F95        TO   ME-026.
     MOVE     LST-F96        TO   ME-027.
     MOVE     "-"            TO   ME-028.
     MOVE     LST-F97        TO   ME-029.
     MOVE     LST-F98        TO   ME-02A.
     MOVE     LST-F99        TO   ME-02B.
*
...
*
     MOVE     LST-MF96       TO   ME-039.
     MOVE     "-"            TO   ME-03A.
     MOVE     LST-MF97       TO   ME-03B.
     MOVE     LST-MF98       TO   ME-03C.
     MOVE     LST-MF99       TO   ME-03D.
*
...
*--------------------------------------------------------------*
 SFRLSTWK-READ-SEC       SECTION.
*
     MOVE     "SFRLSTWK-READ-SEC"  TO   S-NAME.
*
     READ     SFRLSTWK   AT   END
              MOVE      "END"     TO   END-FLG
              GO   TO    SFRLSTWK-READ-EXIT
     END-READ.
*
     ADD      1                   TO   READ-CNT.
*
