...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY5220I.COB`
...
*画面表示用ワーク
 01  DSP-WORK.
     03  WORK-PGID                PIC  X(08)  VALUE  "SSY5220I".
     03  WORK-FORMID              PIC  X(08)  VALUE  "FSY52201".
*システム日付／時刻
 01  TIME-AREA.
...
*数量確定ファイル存在／未抽出チェック
*スタート
     MOVE     SPACE          TO   WK-KAKUTEI-FLG.
     MOVE     SPACE          TO   ST1-REC.
     INITIALIZE                   ST1-REC.
     MOVE     DSP-KANRNO     TO   ST1-F01.
     MOVE     SPACE          TO   ST1-F05.
...
****************************************************************
 END-SEC               SECTION.
*ファイル ＣＬＯＳＥ
     CLOSE             NFSUTEF  DSPFILE.
**
 END-EXIT.
     EXIT.
*****************<<  SSY5220I   END PROGRAM  >>******************
