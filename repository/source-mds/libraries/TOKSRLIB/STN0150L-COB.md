...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/STN0150L.COB`
...
*
 ...
 FILE-CONTROL.
****<< _卸確定リストデータ  >>
     SELECT   KKTANAW   ASSIGN  TO   DA-01-VI-KKTANAW1
...
****  見出し行0             ****
 01  MIDASI-0.
     ...
     02  FILLER              PIC  X(08)  VALUE  "STN0150L".
...
**** メッセージ情報           ****
 01  MSG-AREA1-1.
     02  MSG-ABEND1.
       ...
       03  ERR-PG-ID         PIC  X(08)  VALUE  "STN0150L".
...
*      1.2       リストファイルＲＥＡＤ処理                *
************************************************************
 KKTANAW-READ-SEC       SECTION.
     READ    KKTANAW
       AT  END
           MOVE    "END"       TO   END-FLG
           GO       TO   KKTANAW-READ-SEC-EXIT
     END-READ.
     ADD      1          TO   READ-CNT.
*
...
************************************************************
 END-SEC                SECTION.
     CLOSE    KKTANAW  ZSOKMS  SUBMEIF  PRINTF.
