...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY5310B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY5310B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY5310B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*2021/10/05 NV ST
 01  WK-TORICD.
     03  WK-TORICD-S       PIC        X(06).
     03  WK-TORICD-S-R     REDEFINES WK-TORICD-S.
         05  WK-TORI-1     PIC        9(04).
         05  WK-TORI-2     PIC        9(02).
*2021/10/05 NV ED
*
 01  LINK-AREA.
...
*取引先コード
     ...
     MOVE  HAC-F323(1:6)   TO        WK-TORICD.
*伝票ナンバー
