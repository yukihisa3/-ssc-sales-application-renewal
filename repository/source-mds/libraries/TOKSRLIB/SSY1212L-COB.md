...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY1212L.COB`
...
*
 ...
 FILE-CONTROL.
*リスト発行ワーク
     SELECT   KNPKLBW1       ASSIGN        TO  01-VI-KNPKLBW1
...
*メッセージ情報
 01  MSG-AREA.
     03  SEC-NAME.
         ...
         05  S-NAME          PIC  X(30).
     03  MSG-ABEND1.
         05  FILLER          PIC  X(12)  VALUE  "### SSY1212L".
     ...
     03  MSG-INPUT.
         05  FILLER          PIC  X(13)  VALUE  "*** KNPKLBW1 ".
...
*リスト発行ワーク
 OUT-ERR-SEC        SECTION.
     USE      AFTER  EXCEPTION   PROCEDURE       KNPKLBW1.
     MOVE    "KNPKLBW1"    TO    ERR-FL-ID.
...
*=============================================================
 CONTROL-SEC         SECTION.
     DISPLAY  "**  SSY1212L   START  **"   UPON  CONS.
*
     ...
     PERFORM  END-SEC.
*
     DISPLAY  "**  SSY1212L   END    **"   UPON  CONS.
     STOP  RUN.
 CONTROL-EXIT.
     EXIT.
*=============================================================
