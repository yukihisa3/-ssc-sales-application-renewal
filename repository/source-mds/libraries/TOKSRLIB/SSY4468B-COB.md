...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY4468B.COB`
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY4468B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY4468B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*行番号
 01  WK-GYO-NO.
     03  WK-GYO-S          PIC        X(04).
     03  WK-GYO-S-R        REDEFINES WK-GYO-S.
         05  WK-GYO-H      PIC        9(04).
*店舗ＣＤ
 01  WK-TEN-NO.
     03  WK-TEN-S          PIC        X(04).
     03  WK-TEN-S-R        REDEFINES WK-TEN-S.
         05  WK-TEN-H      PIC        9(04).
*
 01  WK-CEN-NO.
...
*行番号
     MOVE  HAC-F402        TO        WK-GYO-S.
     MOVE  WK-GYO-S(1:2)   TO        HEN-F03.
*取区
     MOVE  40              TO        HEN-F051.
