...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NKE0090B.COB`
...
*　　顧客名　　　　　　　：　（株）サカタのタネ殿　　　　　　　*
*　　業務名　　　　　　　：　出荷検品　　　　                  *
*　　モジュール名　　　　：　ヨドバシ出荷検品確定データ更新　　*
*　　作成日／作成者　　　：　2023/01/31  NAV                   *
...
*----<< 出荷確定累積Ｆ >>--*
     SELECT   RUISYKL1  ASSIGN         DA-01-VI-RUISYKL1
                        ...
                        STATUS         RUI-ST.
*----<< 基本情報Ｆ >>--*
     SELECT   YODJOHL5  ASSIGN         DA-01-VI-YODJOHL5
                        ORGANIZATION   INDEXED
                        ACCESS    MODE RANDOM
                        RECORD    KEY  JOH-F17 JOH-F18 JOH-F06
                                       JOH-F14 JOH-F19
                        STATUS         JOH-ST.
*---<<  商品変換テーブル  >>---*
...
*----<< 出荷確定累積Ｆ >>--*
 FD  RUISYKL1    LABEL RECORD   IS   STANDARD.
     COPY        RUISYKL1    OF      XFDLIB
                 JOINING     RUI     PREFIX.
*----<< 基本情報Ｆ >>--*
 FD  YODJOHL5    LABEL RECORD   IS   STANDARD.
     COPY        YODJOHL5    OF      XFDLIB
                 JOINING     JOH     PREFIX.
*---<<  在庫マスタ  >>---*
 FD  ZAMZAIL1.
...
*--------------------------------------------------------------*
 01  FLAGS.
     ...
     03  JOH-INV-FLG    PIC  X(03)  VALUE  SPACE.
 ...
 01  COUNTERS.
     ...
     03  JOH-RWT-CNT    PIC  9(07).
 01  WK-JOH-F06
     03  WK-JOH-F06-1    PIC  X(01).
     03  WK-JOH-F06-2    PIC  X(04).
 01  WK-JOH-F14
     03  WK-JOH-F14-YYYY PIC  9(04).
     03  WK-JOH-F14-MM   PIC  9(02).
     03  WK-JOH-F14-DD   PIC  9(02).
 01  WK-JOH-F14-R  REDEFINES  WK-JOH-F14
                         PIC  9(08).
*
*----<< ｴﾗｰﾒｯｾｰｼﾞ >>--*
 01  ERR-TBL.
...
*----<< 出荷確定Ｆ >>--*
 RCV-ERR              SECTION.
     ...
     DISPLAY  "### NKE0090B RCVSYKXX    ERROR " RCV-ST " "
...
*----<< 出荷確定累積ファイル >>--*
 RUI-ERR                SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     "4000"         TO   PROGRAM-STATUS.
     DISPLAY  "### NKE0090B RUISYKL1    ERROR " RUI-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
*----<< 基本情報ファイル >>--*
 JOH-ERR                SECTION.
     USE AFTER     EXCEPTION PROCEDURE      YODJOHL5.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     "4000"         TO   PROGRAM-STATUS.
     DISPLAY  "### NKE0090B YODJOHL5     ERROR " JOH-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
*----<< 売上伝票ファイル >>--*
 SHTDENL1-ERR           SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     "4000"         TO   PROGRAM-STATUS.
     DISPLAY  "### NKE0090B SHTDENL1   ERROR " DEN-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
*----<< 商品変換テーブル >>--*
 SHOTBL1-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     "4000"         TO   PROGRAM-STATUS.
     DISPLAY  "### NKE0090B SHOTBL1    ERROR " SHO-ST    " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
*----<< 在庫マスタ >>--*
 ZAMZAIL1-ERR            SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     "4000"         TO   PROGRAM-STATUS.
     DISPLAY  "### NKE0090B ZAMZAIL1    ERROR " ZAI-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
*----<< 商品名称マスタ >>--*
 MEIMS1-ERR             SECTION.
     ...
     ACCEPT   SYS-TIME       FROM TIME.
     MOVE     "4000"         TO   PROGRAM-STATUS.
     DISPLAY  "### NKE0090B MEIMS1  ERROR " MEI-ST " "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS " ###"
                                       UPON CONS.
     STOP     RUN.
...
*    ACCEPT   SYS-TIME       FROM TIME.
*    MOVE     "4000"         TO   PROGRAM-STATUS.
*    DISPLAY  "### NKE0090B RCVERRF ERROR " ERR-ST " "
*             SYS-YY "." SYS-MM "." SYS-DD " "
*             SYS-HH ":" SYS-MN ":" SYS-SS " ###"
*                                      UPON CONS.
*    STOP     RUN.
...
*    MOVE     HEN-DATE(7:2)  TO   HD1-03.
     ...
     OPEN     I-O       RUISYKL1 ZAMZAIL1 SHTDENL1 YODJOHL5.
...
*
*基本情報ファイル参照
     MOVE     RCV-F01        TO   JOH-F17.
     MOVE     RCV-F06        TO   JOH-F18.
     MOVE     RCV-F02        TO   WK-JOH-F06.
     MOVE     WK-JOH-F06-2   TO   JOH-F06.
     MOVE     RCV-F05(1:4)   TO   WK-JOH-F14-YYYY.
     MOVE     RCV-F05(6:2)   TO   WK-JOH-F14-MM.
     MOVE     RCV-F05(9:2)   TO   WK-JOH-F14-DD.
     MOVE     WK-JOH-F14-R   TO   JOH-F14.
     MOVE     RCV-F07        TO   JOH-F19.
     PERFORM  JOH-FIND-SEC.
*
*更新続行判定
...
*
     ...
     DISPLAY  "+++ JOH_UPDATE =" JOH-RWT-CNT " +++" UPON CONS.
*    MOVE     IN-CNT         TO   PARA-INCNT.
     MOVE     RUI-OUT-CNT    TO   PARA-OUT-KENSU.
     ACCEPT   SYS-DATE       FROM DATE.
     ACCEPT   SYS-TIME       FROM TIME.
     DISPLAY  "*** NKE0090B END   *** "
              SYS-YY "." SYS-MM "." SYS-DD " "
              SYS-HH ":" SYS-MN ":" SYS-SS
                                       UPON CONS.
*
...
*                基本情報ファイル読　                          *
****************************************************************
 JOH-FIND-SEC           SECTION.
*T↓
*    DISPLAY "JOH-FIND-SEC"  UPON CONS.
*T↑
*
     READ      YODJOHL5
        INVALID
               MOVE      "INV"    TO    JOH-INV-FLG
               MOVE      "ERR"    TO    ERR-FLG-7
*T
               DISPLAY  "JOH-F17  ="   JOH-F17  UPON CONS
               DISPLAY  "JOH-F18  ="   JOH-F18  UPON CONS
               DISPLAY  "JOH-F06  ="   JOH-F06  UPON CONS
               DISPLAY  "JOH-F14  ="   JOH-F14  UPON CONS
               DISPLAY  "JOH-F19  ="   JOH-F19  UPON CONS
*T
        NOT  INVALID
               MOVE      "HIT"    TO    JOH-INV-FLG
               MOVE      "   "    TO    ERR-FLG-7
     END-READ.
*
 JOH-FIND-EXIT.
