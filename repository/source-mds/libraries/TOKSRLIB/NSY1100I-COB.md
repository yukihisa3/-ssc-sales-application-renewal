...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/NSY1100I.COB`
...
*    処理概要　　　　　　：　ＣＳＶ出力条件入力→パラメタ引渡　*
*                            　　　　　　　　　                *
**履歴**********************************************************
*    2021/02/22  INOUE   新規作成　　　　　　　　　　　　　　　*
*    0000/00/00　　　　　　　　　　　　　　　　　　　　　　　　*
****************************************************************
...
*画面の初期化
     MOVE    SPACE                TO   DSP-FSY11001.
*システム日付転送
     MOVE    SYS-DATE             TO   DSP-SDATE.
*システム時間転送
     MOVE    WK-TIME(1:6)         TO   DSP-STIME.
*プログラムＩＤ　
     MOVE    "NSY1100I"           TO   DSP-PGID.
*ＦＯＲＭＩＤ　
     MOVE    "FSY11001"           TO   DSP-FMID.
*項目属性クリア　
