...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SIT0082L.COB`
...
*マスタレコードエリア（店舗マスタ）
     ...
     JOINING TENL          AS   PREFIX.
     COPY    TENMS1        OF   XFDLIB
     JOINING TENR          AS   PREFIX.
*改ページ条件
 01  NEW-KEY.
...
*A
*01  WK-TENL-F19            PIC  9(11) VALUE ZERO.
*01  WK-TENL-F20            PIC  9(11) VALUE ZERO.
*01  WK-TENL-F21            PIC  9(11) VALUE ZERO.
*01  WK-TENL-F76            PIC  9(08) VALUE ZERO.
*01  WK-TENR-F19            PIC  9(11) VALUE ZERO.
*01  WK-TENR-F20            PIC  9(11) VALUE ZERO.
*01  WK-TENR-F21            PIC  9(11) VALUE ZERO.
*01  WK-TENR-F76            PIC  9(08) VALUE ZERO.
*
*ファイルＳＴＡＴＵＳ
 01  FILE-STATUS.
     03  MSL-ST            PIC X(02).
...
****  見出し行１             ****
 01  MIDASI-1.
     ...
     02  FILLER              PIC  X(08)  VALUE  "SIT0082L".
...
****  明細行6               ****
 01  MEISAI-06                   CHARACTER   TYPE  IS  NIHONGO.
     ...
     02  MEISAI-06-1.
         ...
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-06-L         PIC  X(05).
         03  FILLER              PIC  X(27)  VALUE  SPACE.
         03  MEISAI-06-L-STAR    PIC  N(01).
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-06-R         PIC  X(05).
****  明細行7               ****
 01  MEISAI-07                   CHARACTER   TYPE  IS  NIHONGO.
     ...
     02  MEISAI-07-1.
         ...
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-07-L         PIC  X(08).
         03  FILLER              PIC  X(24)  VALUE  SPACE.
         03  MEISAI-07-R-STAR    PIC  N(01).
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-07-R         PIC  X(08).
****  明細行8               ****
...
****  明細行9               ****
 01  MEISAI-09                   CHARACTER   TYPE  IS  NIHONGO.
     ...
     02  MEISAI-09-1.
         ...
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-09-L         PIC  N(15).
         03  FILLER              PIC  X(02)  VALUE  SPACE.
         03  MEISAI-09-R-STAR    PIC  N(01).
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-09-R         PIC  N(15).
****  明細行10              ****
...
****  明細行11              ****
 01  MEISAI-11                   CHARACTER   TYPE  IS  NIHONGO.
     ...
     02  MEISAI-11-1.
         ...
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-11-L         PIC  X(12).
         03  FILLER              PIC  X(20)  VALUE  SPACE.
         03  MEISAI-11-R-STAR    PIC  N(01).
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-11-R         PIC  X(12).
****  明細行12              ****
...
****  明細行14              ****
 01  MEISAI-14                   CHARACTER   TYPE  IS  NIHONGO.
     ...
     02  MEISAI-14-1.
         ...
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-14-L         PIC  9(02).
         03  FILLER              PIC  X(30)  VALUE  SPACE.
         03  MEISAI-14-R-STAR    PIC  N(01).
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-14-R         PIC  9(02).
****  明細行15              ****
 01  MEISAI-15                   CHARACTER   TYPE  IS  NIHONGO.
     ...
     02  MEISAI-15-1.
         ...
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-15-L         PIC  9(02).
         03  FILLER              PIC  X(30)  VALUE  SPACE.
         03  MEISAI-15-R-STAR    PIC  N(01).
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-15-R         PIC  9(02).
****  明細行16              ****
...
****  明細行17              ****
 01  MEISAI-17                   CHARACTER   TYPE  IS  NIHONGO.
     ...
     02  MEISAI-17-1.
         ...
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-17-L         PIC  X(02).
         03  FILLER              PIC  X(30)  VALUE  SPACE.
         03  MEISAI-17-R-STAR    PIC  N(01).
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-17-R         PIC  X(02).
****  明細行18              ****
 01  MEISAI-18                   CHARACTER   TYPE  IS  NIHONGO.
     ...
     02  MEISAI-18-1.
         ...
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-18-L         PIC  9(02).
         03  FILLER              PIC  X(30)  VALUE  SPACE.
         03  MEISAI-18-R-STAR    PIC  N(01).
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-18-R         PIC  9(02).
****  明細行19              ****
 01  MEISAI-19                   CHARACTER   TYPE  IS  NIHONGO.
     ...
     02  MEISAI-19-1.
         ...
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-19-L         PIC  N(06).
         03  FILLER              PIC  X(20)  VALUE  SPACE.
         03  MEISAI-19-R-STAR    PIC  N(01).
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-19-R         PIC  N(06).
****  明細行20              ****
 01  MEISAI-20                   CHARACTER   TYPE  IS  NIHONGO.
     ...
     02  MEISAI-20-1.
         ...
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-20-L         PIC  9(01).
         03  FILLER              PIC  X(31)  VALUE  SPACE.
         03  MEISAI-20-R-STAR    PIC  N(01).
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-20-R         PIC  9(01).
****  明細行21              ****
 01  MEISAI-21                   CHARACTER   TYPE  IS  NIHONGO.
     ...
     02  MEISAI-21-1.
         ...
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-21-L         PIC  X(01).
         03  FILLER              PIC  X(31)  VALUE  SPACE.
         03  MEISAI-21-R-STAR    PIC  N(01).
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-21-R         PIC  X(01).
****  明細行22              ****
 01  MEISAI-22                   CHARACTER   TYPE  IS  NIHONGO.
     ...
     02  MEISAI-22-1.
         ...
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-22-L         PIC  X(01).
         03  FILLER              PIC  X(31)  VALUE  SPACE.
         03  MEISAI-22-R-STAR    PIC  N(01).
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-22-R         PIC  X(01).
****  明細行23              ****
 01  MEISAI-23                   CHARACTER   TYPE  IS  NIHONGO.
     ...
     02  MEISAI-23-1.
         ...
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-23-L         PIC  X(01).
         03  FILLER              PIC  X(31)  VALUE  SPACE.
         03  MEISAI-23-R-STAR    PIC  N(01).
         03  FILLER              PIC  X(01)  VALUE  SPACE.
         03  MEISAI-23-R         PIC  X(01).
*
 LINKAGE                   SECTION.
...
*
     ...
     DISPLAY "SIT0082L READ =" READ-CNT NC"件" UPON CONS.
...
*修正前・修正後レコード準備
     IF      MSL-F04    =          "2"
             MOVE       MSL-F08     TO      TENL-REC
             MOVE       MSL-F09     TO      TENR-REC
* 項目セット
             PERFORM    MEIEDT2-SEC
             GO                     TO      MEIEDT-EXIT
     END-IF.
...
*   取引先コード
     ...
     MOVE        TENL-F52   TO        MEISAI-01-L.
*   店舗コード
     MOVE        SPACE      TO        MEISAI-02-1.
     MOVE        TENL-F011  TO        MEISAI-02-L.
*   店舗名（正式）
     MOVE        SPACE      TO        MEISAI-03-1.
     MOVE        TENL-F02   TO        MEISAI-03-L.
*   店舗名（略名）
     MOVE        SPACE      TO        MEISAI-04-1.
     MOVE        TENL-F03   TO        MEISAI-04-L.
*   店舗名（カナ）
     MOVE        SPACE      TO        MEISAI-05-1.
     MOVE        TENL-F04   TO        MEISAI-05-L.
*   店舗名（カナ略名）
     MOVE        SPACE      TO        MEISAI-06-1.
     MOVE        TENL-F55   TO        MEISAI-06-L.
*   郵便番号
     MOVE        SPACE      TO        MEISAI-07-1.
     MOVE        TENL-F781  TO        MEISAI-07-L(1:3).
     MOVE        "-"        TO        MEISAI-07-L(4:1).
     MOVE        TENL-F782  TO        MEISAI-07-L(5:4).
*   住所（上段）
     MOVE        SPACE      TO        MEISAI-08-1.
     MOVE        TENL-F06   TO        MEISAI-08-L.
*   住所（下段）
     MOVE        SPACE      TO        MEISAI-09-1.
     MOVE        TENL-F07   TO        MEISAI-09-L.
*   電話番号
     MOVE        SPACE      TO        MEISAI-10-1.
     MOVE        TENL-F08   TO        MEISAI-10-L.
*   ファックス
     MOVE        SPACE      TO        MEISAI-11-1.
     MOVE        TENL-F09   TO        MEISAI-11-L.
*   店舗区分
     MOVE        SPACE      TO        MEISAI-12-1.
     MOVE        TENL-F97   TO        MEISAI-12-L.
*  ☆出荷場所
     MOVE        SPACE      TO        MEISAI-13-1.
     MOVE        NC"☆"     TO        MEISAI-13-L-STAR.
     MOVE        TENL-F80   TO        MEISAI-13-L.
*  ☆ルート
     MOVE        SPACE      TO        MEISAI-14-1.
     MOVE        NC"☆"     TO        MEISAI-14-L-STAR.
     MOVE        TENL-F81   TO        MEISAI-14-L.
*  ☆ルート順番
     MOVE        SPACE      TO        MEISAI-15-1.
     MOVE        NC"☆"     TO        MEISAI-15-L-STAR.
     MOVE        TENL-F82   TO        MEISAI-15-L.
*   売場コード
     MOVE        SPACE      TO        MEISAI-16-1.
     MOVE        TENL-F79   TO        MEISAI-16-L.
*  ☆振分倉庫コード
     MOVE        SPACE      TO        MEISAI-17-1.
     MOVE        NC"☆"     TO        MEISAI-17-L-STAR.
     MOVE        TENL-F73   TO        MEISAI-17-L.
*  ☆デリバリー区分
     MOVE        SPACE      TO        MEISAI-18-1.
     MOVE        NC"☆"     TO        MEISAI-18-L-STAR.
     MOVE        TENL-F14   TO        MEISAI-18-L.
*  ☆納品形態
     MOVE        SPACE      TO        MEISAI-19-1.
     MOVE        NC"☆"     TO        MEISAI-19-L-STAR.
     EVALUATE    TENL-F12(1)
      WHEN  00   MOVE   NC"店直"          TO    MEISAI-19-L
      WHEN  09   MOVE   NC"センター納品"  TO    MEISAI-19-L
      WHEN OTHER MOVE   NC"？？？？？？"  TO    MEISAI-19-L
     END-EVALUATE.
*   営業所／支店区分
     MOVE        SPACE      TO        MEISAI-20-1.
     MOVE        TENL-F77   TO        MEISAI-20-L.
*   対象外区分
     MOVE        SPACE      TO        MEISAI-21-1.
     MOVE        TENL-F76   TO        MEISAI-21-L.
*  ☆センター区分
     MOVE        SPACE      TO        MEISAI-22-1.
     MOVE        NC"☆"     TO        MEISAI-22-L-STAR.
     MOVE        TENL-F75   TO        MEISAI-22-L.
*  ☆新センターコード
     MOVE        SPACE      TO        MEISAI-23-1.
     MOVE        NC"☆"     TO        MEISAI-23-L-STAR.
     MOVE        TENL-F90   TO        MEISAI-23-L.
*
 MEIEDT-EXIT.
     EXIT.
**********************************************************
...
*   取引先コード
     MOVE        SPACE      TO        MEISAI-01-1.
     MOVE        TENR-F52   TO        MEISAI-01-R.
     IF          TENR-F52   NOT =     TENL-F52
                 MOVE       TENL-F52  TO        MEISAI-01-L
     END-IF.
*
*   店舗コード
     MOVE        SPACE      TO        MEISAI-02-1.
     MOVE        TENR-F011  TO        MEISAI-02-R.
     IF          TENR-F011  NOT =     TENL-F011
                 MOVE       TENL-F011 TO        MEISAI-02-L
     END-IF.
*   店舗名（正式）
     MOVE        SPACE      TO        MEISAI-03-1.
     MOVE        TENR-F02   TO        MEISAI-03-R.
     IF          TENR-F02   NOT =     TENL-F02
                 MOVE       TENL-F02  TO        MEISAI-03-L
     END-IF.
*   店舗名（略名）
     MOVE        SPACE      TO        MEISAI-04-1.
     MOVE        TENR-F03   TO        MEISAI-04-R.
     IF          TENR-F03   NOT =     TENL-F03
                 MOVE       TENL-F03  TO        MEISAI-04-L
     END-IF.
*   店舗名（カナ）
     MOVE        SPACE      TO        MEISAI-05-1.
     MOVE        TENR-F04   TO        MEISAI-05-R.
     IF          TENR-F04   NOT =     TENL-F04
                 MOVE       TENL-F04  TO        MEISAI-05-L
     END-IF.
*   店舗名（カナ略名）
     MOVE        SPACE      TO        MEISAI-06-1.
     MOVE        TENR-F55   TO        MEISAI-06-R.
     IF          TENR-F55   NOT =     TENL-F55
                 MOVE       TENL-F55  TO        MEISAI-06-L
     END-IF.
*   郵便番号
     MOVE        SPACE      TO        MEISAI-07-1.
     MOVE        TENR-F781  TO        MEISAI-07-R(1:3).
     MOVE        "-"        TO        MEISAI-07-R(4:1).
     MOVE        TENR-F782  TO        MEISAI-07-R(5:4).
     IF        ( TENR-F781  NOT =     TENL-F781 ) OR
               ( TENR-F782  NOT =     TENL-F782 )
                 MOVE       TENL-F781 TO        MEISAI-07-L(1:3)
                 MOVE       "-"       TO        MEISAI-07-L(4:1)
                 MOVE       TENL-F782 TO        MEISAI-07-L(5:4)
     END-IF.
*   住所（上段）
     MOVE        SPACE      TO        MEISAI-08-1.
     MOVE        TENR-F06   TO        MEISAI-08-R.
     IF          TENR-F06   NOT =     TENL-F06
                 MOVE       TENL-F06  TO        MEISAI-08-L
     END-IF.
*   住所（下段）
     MOVE        SPACE      TO        MEISAI-09-1.
     MOVE        TENR-F07   TO        MEISAI-09-R.
     IF          TENR-F07   NOT =     TENL-F07
                 MOVE       TENL-F07  TO        MEISAI-09-L
     END-IF.
*   電話番号
     MOVE        SPACE      TO        MEISAI-10-1.
     MOVE        TENR-F08   TO        MEISAI-10-R.
     IF          TENR-F08   NOT =     TENL-F08
                 MOVE       TENL-F08  TO        MEISAI-10-L
     END-IF.
*   ファックス
     MOVE        SPACE      TO        MEISAI-11-1.
     MOVE        TENR-F09   TO        MEISAI-11-R.
     IF          TENR-F09   NOT =     TENL-F09
                 MOVE       TENL-F09  TO        MEISAI-11-L
     END-IF.
*   店舗区分
     MOVE        SPACE      TO        MEISAI-12-1.
     MOVE        TENR-F97   TO        MEISAI-12-R.
     IF          TENR-F97   NOT =     TENL-F97
                 MOVE       TENL-F97  TO        MEISAI-12-L
     END-IF.
*  ☆出荷場所
     MOVE        SPACE      TO        MEISAI-13-1.
     MOVE        NC"☆"     TO        MEISAI-13-R-STAR.
     MOVE        TENR-F80   TO        MEISAI-13-R.
     IF          TENR-F80   NOT =     TENL-F80
                 MOVE       NC"☆"    TO        MEISAI-13-L-STAR
                 MOVE       TENL-F80  TO        MEISAI-13-L
     END-IF.
*  ☆ルート
     MOVE        SPACE      TO        MEISAI-14-1.
     MOVE        NC"☆"     TO        MEISAI-14-R-STAR.
     MOVE        TENR-F81   TO        MEISAI-14-R.
     IF          TENR-F81   NOT =     TENL-F81
                 MOVE       NC"☆"    TO        MEISAI-14-L-STAR
                 MOVE       TENL-F81  TO        MEISAI-14-L
     END-IF.
*  ☆ルート順番
     ...
     MOVE        TENR-F82   TO        MEISAI-15-R.
     IF          TENR-F82   NOT =     TENL-F82
                 MOVE       NC"☆"    TO        MEISAI-15-L-STAR
                 MOVE       TENL-F82  TO        MEISAI-15-L
     END-IF.
*   売場コード
     MOVE        SPACE      TO        MEISAI-16-1.
     MOVE        TENR-F79   TO        MEISAI-16-R.
     IF          TENR-F79   NOT =     TENL-F79
                 MOVE       TENL-F79  TO        MEISAI-16-L
     END-IF.
*  ☆振分倉庫コード
     MOVE        SPACE      TO        MEISAI-17-1.
     MOVE        NC"☆"     TO        MEISAI-17-R-STAR.
     MOVE        TENR-F73   TO        MEISAI-17-R.
     IF          TENR-F73   NOT =     TENL-F73
                 MOVE       NC"☆"    TO        MEISAI-17-L-STAR
                 MOVE       TENL-F73  TO        MEISAI-17-L
     END-IF.
*  ☆デリバリー区分
     ...
     MOVE        TENR-F14   TO        MEISAI-18-R.
     IF          TENR-F14   NOT =     TENL-F14
                 MOVE       NC"☆"    TO        MEISAI-18-L-STAR
                 MOVE       TENL-F14  TO        MEISAI-18-L
     END-IF.
*  ☆納品形態
     ...
     EVALUATE    TENR-F12(1)
      WHEN  00   MOVE   NC"店直"          TO    MEISAI-19-R
      WHEN  09   MOVE   NC"センター納品"  TO    MEISAI-19-R
      WHEN OTHER MOVE   NC"？？？？？？"  TO    MEISAI-19-R
     END-EVALUATE.
     IF  TENR-F12(1) NOT =  TENL-F12(1)
         MOVE        NC"☆"               TO    MEISAI-19-L-STAR
         EVALUATE    TENL-F12(1)
          WHEN  00   MOVE  NC"店直"         TO  MEISAI-19-L
          WHEN  09   MOVE  NC"センター納品" TO  MEISAI-19-L
...
*   営業所／支店区分
     MOVE        SPACE      TO        MEISAI-20-1.
     MOVE        TENR-F77   TO        MEISAI-20-R.
     IF          TENR-F77   NOT =     TENL-F77
                 MOVE       NC"☆"    TO        MEISAI-20-L-STAR
                 MOVE       TENL-F77  TO        MEISAI-20-L
     END-IF.
*   対象外区分
     MOVE        SPACE      TO        MEISAI-21-1.
     MOVE        TENR-F76   TO        MEISAI-21-R.
     IF          TENR-F76   NOT =     TENL-F76
...
*  ☆センター区分
     ...
     MOVE        TENR-F75   TO        MEISAI-22-R.
     IF          TENR-F75   NOT =     TENL-F75
                 MOVE       NC"☆"    TO        MEISAI-22-L-STAR
                 MOVE       TENL-F75  TO        MEISAI-22-L
     END-IF.
*  ☆新センターコード
     ...
     MOVE        TENR-F90   TO        MEISAI-23-R.
     IF          TENR-F90   NOT =     TENL-F90
                 MOVE       NC"☆"    TO        MEISAI-23-L-STAR
                 MOVE       TENL-F90  TO        MEISAI-23-L
     END-IF.
*
