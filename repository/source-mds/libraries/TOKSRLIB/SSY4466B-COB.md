...
**種別**: COBOL プログラム  
**ライブラリ**: TOKSRLIB  
**ソースファイル**: `source/navs/cobol/programs/TOKSRLIB/SSY4466B.COB`
...
*    更新日　　　　　　　：　2019/05/17                        *
*    更新概要　　　　　　：　サブ商品変換ＴＢＬ追加　　　　　　*
*    更新日　　　　　　　：　2019/06/27 NAV TAKAHASHI          *
*    更新概要　　　　　　：　センター納品の場合、バッチ_を変更*
*    　　　　　　　　　　　　（バッチ時刻＋１）　　　　　　　　*
****************************************************************
...
*
 01  MSG-AREA.
     03  MSG-START.
         ...
         05  ST-PG          PIC   X(08)  VALUE "SSY4466B".
         05  FILLER         PIC   X(11)  VALUE
                                         " START *** ".
     03  MSG-END.
         05  FILLER         PIC   X(05)  VALUE " *** ".
         05  END-PG         PIC   X(08)  VALUE "SSY4466B".
         05  FILLER         PIC   X(11)  VALUE
                                         " END   *** ".
     03  MSG-ABEND.
         05  FILLER         PIC   X(05)  VALUE " *** ".
...
*店舗ＣＤ
 01  WK-TEN-NO.
     03  WK-TEN-S          PIC        X(06).
     03  WK-TEN-S-R        REDEFINES WK-TEN-S.
         05  WK-TEN-0      PIC        9(01).
...
*             M A I N             M O D U L E                    *
******************************************************************
 PROCEDURE              DIVISION USING PARA-AREA  PARA-JIKAN2
 DECLARATIVES.
...
****************************************************************
 INIT-SEC               SECTION.
     ...
     OPEN     I-O       BMSHACF.
     OPEN     INPUT     SHOTBL1   MEIMS1  SUBTBLL1
...
*担当者コード
     MOVE  99              TO        HEN-F06.
*店コード
     MOVE  HAC-F308(1:6)   TO        WK-TEN-S.
     MOVE  WK-TEN-H        TO        HEN-F07.
*#LINKS連携用に直接納品先ＣＤ、最終納品先ＣＤをセットする。
     MOVE  HAC-F304(1:6)   TO        HEN-XI0004(1:6).
     MOVE  HAC-F308(1:6)   TO        HEN-XI0004(7:6).
     MOVE  HAC-F331        TO        HEN-XI0004(13:2).
     MOVE  HAC-F330        TO        HEN-XI0004(15:2).
     MOVE  HAC-F304(4:3)   TO        HEN-XI0004(17:3).
*#2019/06/27 NAV ST
...
*
     ...
     DISPLAY "MAISU = " CNT-MAISU " : " CNT-MAISU2 UPON CONS.
     IF        CNT-MAISU     >    ZERO
     OR        CNT-MAISU2    >    ZERO
*              出荷場所件数マスタ出力
               PERFORM  JSMKENL1-WRT-SEC
