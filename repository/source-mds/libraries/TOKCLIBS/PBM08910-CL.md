...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PBM08910.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PBM08910'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SBM8910L:
    ...
    OVRF FILE-IONFURL2,TOFILE-IONFURL2.BMSFLIB  /.納品ｾﾝﾀｰﾏｽﾀ./
    OVRF FILE-JYOKEN1,TOFILE-JYOKEN1.TOKFLIB    /.条件ﾏｽﾀ./
    OVRF FILE-TOKMS2,TOFILE-TOKMS2.TOKFLIB      /.取引先ﾏｽﾀ./
    OVRF FILE-TENMS1,TOFILE-TENMS1.TOKFLIB      /.店舗ﾏｽﾀ./
    CALL PGM-SBM8910L.TOKELIBO
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  'イオン取引先振分リスト'
              GOTO ABEND
    END
