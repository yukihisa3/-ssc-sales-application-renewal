...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PHC00100.CL`
...
/. ***********************************************************  ./
    ...
    VAR ?MSG      ,STRING*99(6)
    VAR ?MSGX     ,STRING*99
    VAR ?PGMID    ,STRING*8,VALUE-'PHC00100'
    VAR ?STEP     ,STRING*8
...
SSY0006B:
    ...
    CALL      PGM-SHC0010B.TOKELIBO,PARA-(?P1,?P2,?P3,?P4,?P5,?P6)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
                                  /.##相手商品ｺｰﾄﾞ順##./
    IF        ?P6        =  '2'   THEN
...
/.  OVRPRTF   FILE-PRTF,TOFILE-XU04LP.XUCL,MEDLIB-TOKELIB  ./
    CALL      PGM-SHC0020L.TOKELIBO,PARA-(?P5,?P6)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
...
/.  OVRPRTF   FILE-PRTF,TOFILE-XU04LP.XUCL,MEDLIB-TOKELIB  ./
    CALL      PGM-SHC0030L.TOKELIBO,PARA-(?P5)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
