...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSJH5713.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PSJH5713'  /.PROGRAM-ID./
...
PFEXPORT:
    ...
    FEXPORT FILE-HACGODY.ONLBLIB,MODE-@REP,PUBAUT-@ALL,PARA-GODY1,
    UNIT-1
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND
    END
...
SCVGODYB:
    ...
    CALL      PGM-SCVGODYB.TOKELIBO,PARA-(?HIDUKE,?JIKAN,?TOKCD,?LINE,
...
SJH5704B:
    ...
    CALL      PGM-SJH5704B.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := '92'
