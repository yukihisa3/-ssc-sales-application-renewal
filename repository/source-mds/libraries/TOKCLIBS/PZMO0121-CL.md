...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PZMO0121.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PZMO0121'
    VAR       ?STEP     ,STRING*8
    VAR       ?WKSTN    ,STRING*8
    VAR       ?NWKSTN   ,NAME
    ?NWKSTN   :=         @ORGWS
...
ZMO0120B:
    ...
    OVRF      FILE-OUTFILE,TOFILE-DENJNLWK.TOKWLIB
...
/.##ソート##./
 SORT01:
    ...
    SORT   INFILE-DENJNLWK.TOKWLIB,INRL-1020,INBF-1,
           OUTFILE-DENJNLWK.TOKWLIB,OUTBF-1,RCD-4,
...
ZMO0130B:
    ...
    OVRF      FILE-DENJNLWK,TOFILE-DENJNLWK.TOKWLIB
