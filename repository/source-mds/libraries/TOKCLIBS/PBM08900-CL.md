...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PBM08900.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PBM08900'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SBM8900I:
    ...
    OVRF FILE-IONFURL2,TOFILE-IONFURL2.BMSFLIB  /.取引先振分ﾏｽﾀ./
    OVRF FILE-JYOKEN1,TOFILE-JYOKEN1.TOKFLIB    /.条件ﾌｧｲﾙ./
    ...
    CALL PGM-SBM8900I.TOKELIBO,PARA-(?TANCD)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '取引先振分マスタ保守'
              GOTO ABEND
    END
