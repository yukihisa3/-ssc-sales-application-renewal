...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY91160.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY91070'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
/.##実行PG名称ｾｯﾄ##./
    ?PGNM := 'センター納品ラベル発行'
/.##ﾗｲﾌﾞﾗﾘﾘｽﾄ登録##./
    DEFLIBL TOKELIB/TOKFLIB/TOKELIBO/TOKKLIB/ZAIEXCEL/TOKDTLIB
/.##ﾌﾟﾛｸﾞﾗﾑ開始ﾒｯｾｰｼﾞ##./
    ?MSGX :=  '***   '  && ?PGMID  &&   ' START  ***'
    SNDMSG    ?MSGX,TO-XCTL
...
SSY9107I:
    ...
    CALL      PGM-SSY9107I.TOKELIBO,PARA-(?P11,?P5,?P1,?P2,?P3
                                         ,?P4,?P6,?P7,?P8,?P9,?P10)
    IF        @PGMEC    ^=   0    THEN
         IF   @PGMEC     =   4010 THEN
...
./  OVRF      FILE-DSLBLL1,TOFILE-?LBLXXXL1
    ...
    CALL      PGM-SSY9116L.TOKELIBO,PARA-(?P1,?P2,?P3,?P4,?P6
                                        ,?P7,?P8,?P9,?P10,?P12)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '納品ラベル'
              GOTO ABEND END
