...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/CKEIHENJ.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'CKEIHENJ'
    VAR       ?STEP     ,STRING*8
...
JKEIHEN:
    ...
    CALL      PGM-JKEIHEN.TOKELIBO,PARA-(?TANCD,?BUMON,
                                          ?LSTTIME,?LSTDATE)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
