...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PJH00070.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PJH00070'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
PJH00070:
    ...
    OVRF      FILE-JSMMSGL1,TOFILE-JSMMSGL1.TOKJLIB
    OVRDSPF   FILE-DSPF,TOFILE-DSPF.XUCL,MEDLIB-TOKELIB
    CALL      PGM-SJH0007L.TOKELIBO
    /.ﾌﾟﾛｸﾞﾗﾑｴﾗｰ判定./
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
/.###ﾌﾟﾛｸﾞﾗﾑ終了###./
