...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSE87030.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PSE87030'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,STRING*8
...
STEP030:
    ...
    SORTF     INFILE-SETGKFA.TOKFLIB,
              ...
              SELECT6-'F01!EQ!#00013938',
/.            SELECT8-'F01!EQ!#00100403',  ./
              RCDL-@DSP
    IF      @PGMEC    ^=   0    THEN
...
STEP040:
    ...
    CALL  SSE8703B.TOKELIBO,PARA-(?SYORIKN1)
    IF      @PGMEC    ^=   0    THEN
            ?KEKA4 := '【請求送信データ作成（資材）】'
                    GOTO ABEND
    END
...
STEP070:
    ...
    SORTF     INFILE-SETGKFA.TOKFLIB,
              ...
              KEY-'F01!A',
              SELECT3-'F01!EQ!#00001427',
              SELECT4-'F01!EQ!#00014272',
              SELECT5-'F01!EQ!#00014273',
              SELECT7-'F01!EQ!#00017137',
              RCDL-@DSP
    IF      @PGMEC    ^=   0    THEN
...
STEP080:
    ...
    OVRF FILE-HACKENDT,TOFILE-DCMKENDT.TOKKLIB
    OVRF FILE-SHTDENL1,TOFILE-SHTDENL1.TOKFLIB
    CALL  SSE8703B.TOKELIBO,PARA-(?SYORIKN2)
    IF      @PGMEC    ^=   0    THEN
            ?KEKA4 := '【請求送信データ作成（植物）】'
                    GOTO ABEND
    END
