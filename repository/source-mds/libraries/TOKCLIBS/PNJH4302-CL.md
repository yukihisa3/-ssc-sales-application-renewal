...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH4302.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH4302'  /.PROGRAM-ID./
...
SSY4465B:
    ...
    CALL      PGM-SSY4465B.TOKSOLIB,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
...
SJR0360A:
    ...
    IF  ?JKBN = ' '  THEN
        ...
        OVRF FILE-COMRHEL5,TOFILE-COMRHEL5.TOKDLIB
    ...
    ELSE
        ...
        OVRF FILE-COMRHEL5,TOFILE-COMRMHL5.TOKDLIB
