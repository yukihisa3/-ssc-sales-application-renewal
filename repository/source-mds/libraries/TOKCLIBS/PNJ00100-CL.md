...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJ00100.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PNJ00100'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SNJ0030I:
    ...
    OVRF FILE-JSMKAIL1,TOFILE-JSMKAIL1.TOKJLIB  /.EDI回線管理ﾏｽﾀ./
    OVRDSPF FILE-DSPF,TOFILE-DSPF.XUCL,MEDLIB-TOKELIBO
    CALL PGM-SNJ0010I.TOKELIBO,PARA-(?TANCD)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  'ＥＤＩ回線管理マスタ保守'
              GOTO ABEND
    END
