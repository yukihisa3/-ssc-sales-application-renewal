...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH9121.CL`
...
/.##ﾜｰｸﾃｲｷﾞ ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH9121'  /.PROGRAM-ID./
...
NJH9121B:
    ...
    OVRF      FILE-EDHENPL1,TOFILE-EDHENPL1.TOKDLIB
    CALL      PGM-NJH9121B.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
              CALL PGM-SNJ0730B.TOKELIBO,
