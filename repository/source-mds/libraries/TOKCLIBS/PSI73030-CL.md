...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSI73030.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PSI73030'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,STRING*8
...
STEP030:
    ...
    SNDMSG '######################################',TO-XCTL
    SNDMSG '## ダイユーエイト支払明細書発行開始 ##',TO-XCTL
    SNDMSG '######################################',TO-XCTL
    CALL SSI7303L.TOKELIBO
    IF   ?PGCHK1  = '1'    THEN
         SNDMSG '########################################',TO-XCTL
         SNDMSG '## ダイユーエイト支払明細書発行エラー ##',TO-XCTL
         SNDMSG '########################################',TO-XCTL
    END
