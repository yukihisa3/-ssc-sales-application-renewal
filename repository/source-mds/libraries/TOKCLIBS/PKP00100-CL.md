...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PKP00100.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PKP00100'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
/.##ﾗｲﾌﾞﾗﾘﾘｽﾄ登録##./
    DEFLIBL   TOKELIB/TOKFLIB/TOKELIBO/TOKKLIB/TOKJLIB/TOKWLIB
...
SKP0010I:
    ...
    OVRF      FILE-KEPALLL1,TOFILE-KEPALLL1.TOKWLIB
    OVRDSPF   FILE-DSPF,TOFILE-DSPF.XUCL,MEDLIB-TOKELIBO
    CALL      PGM-SKP0010I.TOKELIBO
    IF        @PGMEC    ^=   0    THEN
              ?PGMEC := @PGMEC
              IF    ?PGMEC  =  4010  THEN
                    ?MSGX := '##取消終了##'
...
SKP0020L:
    ...
    OVRF      FILE-KEPALLL1,TOFILE-KEPALLL1.TOKWLIB
    OVRF      FILE-TOKMS2,TOFILE-TOKMS2.TOKFLIB
    CALL      PGM-SKP0020L.TOKELIBO
    IF  @PGMEC    ^=   0    THEN
        IF  @PGMEC = 4010   THEN
            OVRDSPF   FILE-DSPF,TOFILE-DSPF.XUCL,MEDLIB-TOKELIB
            ?KEKA1 :=  '欠品集計リストの出力対象データが'
            ?KEKA2 :=  'ありません。'
            ?KEKA3 :=  '確認して下さい。'
            ?KEKA4 :=  ''
