...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/CKEIHEN.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?LSTTIME  ,STRING*6,VALUE-'000000'   /.時刻./
    VAR       ?LSTDATE  ,STRING*8,VALUE-'00000000' /.日付./
...
TKEIHEN:
    ...
    CALL      PGM-TKEIHEN.TOKELIBO,PARA-(?TANCD,?BUMON,
                                          ?LSTTIME,?LSTDATE)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
