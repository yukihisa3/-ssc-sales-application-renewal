...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY3758C.CL`
...
/.### ﾜｰｸｴﾘｱ定義 ###./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY3758C'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SSY3759B:
    ...
    /. I、?SYYMD   出荷日             ./
    /. I、?TENYMD  店着日             ./
    OVRF  FILE-NFJOHOLC,TOFILE-NFJOHOLC.TOKKLIB
    OVRF  FILE-NFJOHOLD,TOFILE-NFJOHOLD.TOKKLIB
    CALL PGM-SSY3759C.TOKELIBO
