...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY3766B.CL`
...
/.### ﾜｰｸｴﾘｱ定義 ###./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'SSY3766B'    /.ﾌﾟﾛｸﾞﾗﾑID./
