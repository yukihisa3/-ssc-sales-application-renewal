...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY8875A.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PSY88750'
    VAR       ?STEP     ,STRING*8
...
SSY0002B:
    ...
    CALL      PGM-SSY8875B.TOKELIBO,PARA-(?P1,?P2,?P3,
...
/.ＳＯＲＴ順：ﾊﾞｯﾁ、倉庫、納品日、分類、発注種別他、店、_./
    ...
    SORT      INFILE-SHWSYUKF.TOKFLIB,INRL-200,INBF-5,
            ...
            /.KEY4-150!4!CA,KEY5-23!5!CA,KEY6-32!6!CA,./
            /.KEY4-23!5!CA,KEY5-150!4!CA,KEY6-32!6!CA,./
...
SSY0025L:
    ...
    OVRF      FILE-ZSOKMS1,TOFILE-ZSOKMS1.TOKFLIB
    OVRF      FILE-MEIMS1,TOFILE-MEIMS1.TOKFLIB
    CALL      PGM-SSY8876L.TOKELIBO,PARA-(?P1)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
