...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/CHAISIN.CL`
...
/.##ワーク定義##./
    ...
    VAR  ?PGMID    ,STRING*8,VALUE-'CHAISIN '   /.PROGRAM-ID./
...
/.##ﾗｲﾌﾞﾗﾘﾘｽﾄ登録##./
    DEFLIBL TOKELIB/TOKFLIB/TOKJLIB/TOKELIBO/TOKDTLIB
...
/.     4.結果コード                ./
    ...
    CALL SCVMSG.TOKCLIBO,PARA-('ｾｲｼﾞｮｳ ｼｭｳﾘｮｳ CHAISIN')
...
/.##ｸﾞｯﾃﾞｲ出荷初期化##./
    IF  ?TORICD = '00000028'  THEN
        CNVFILE FILE-PCCHK5.TOKWLIB,TOFILE-PCCHK5.ONLBLIB,
                ADD-@NO,BF-1
    END
...
/.     4.結果コード                ./
    ...
    CALL SCVMSG.TOKCLIBO,PARA-('ｲｼﾞｮｳ ｼｭｳﾘｮｳ  CHAISIN')
