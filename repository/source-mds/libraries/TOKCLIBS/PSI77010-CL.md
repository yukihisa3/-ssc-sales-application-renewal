...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSI77010.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PSI77010'
    VAR       ?STEP     ,STRING*8
...
SSI7701B:
    ...
    OVRF      FILE-SITGKFJ,TOFILE-SITGKFJ.TOKKLIB
    OVRF      FILE-TENMS1,TOFILE-TENMS1.TOKFLIB
    CALL      PGM-SSI7701B.TOKELIBO,PARA-(?SYORIKN1,?SYORIKN2)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
...
RTN:
    ...
    ?SYORINM3 := '件数を確認して下さい。１：サンデー　２：ジョイ　　'
