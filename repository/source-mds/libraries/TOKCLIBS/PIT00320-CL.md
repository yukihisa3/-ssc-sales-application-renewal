...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PIT00320.CL`
...
SIT0030I:
    ...
    CALL      PGM-SIT0032I.TOKELIBO,PARA-(?BUMON,?TANTO,?UPDT,?UPTM)
    IF        @PGMEC    ^=   0  THEN
              IF  @PGMEC = 4010  THEN
...
/.##本社ﾚｰｻﾞｰへ出力##./
    ...
    CALL      PGM-SIT0041L.TOKELIBO,PARA-(?BUMON,?TANTO,?UPDT,?UPTM,
                                          ?UPDTE,?UPTME)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
