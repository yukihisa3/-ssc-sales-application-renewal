...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PHGLOGNN.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PHGLOGNN'
    VAR       ?STEP     ,STRING*8
...
CRTLOGON:
    ...
    DLTFILE LOGINUSR.TOKWLIB
    CRTFILE FILE-LOGINUSR.TOKWLIB,SIZE-10,ESIZE-10,ORG-@SF,
            USED-@YES,RL-20
    IF        @PGMEC    ^=   0
          THEN
              GOTO ABEND
...
HGLOGON:
    ...
    OVRF     FILE-LOGINUSR,TOFILE-LOGINUSR.TOKWLIB
