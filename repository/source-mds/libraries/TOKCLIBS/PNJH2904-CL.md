...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH2904.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH2904' /.PROGRAM-ID./
...
/.##ﾃﾞｰﾀ存在ﾁｪｯｸ##./
    VAR       ?CHK    ,STRING*2,VALUE-'  '        /.ﾃﾞｰﾀ存在ﾁｪｯｸ./
...
/.##ﾃﾞｰﾀ変換PGﾍのﾊﾟﾗﾒﾀ作成##./
    ...
    DEFLIBL   TOKELIB/TOKFLIB/TOKELIBO/TOKJLIB/TOKKLIB/TOKWLIB
...
SJH2900B:
    ...
    OVRF      FILE-DATAF1,TOFILE-JUSDATA1.TOKWLIB
    OVRF      FILE-DATAF2,TOFILE-JUSCOWK.TOKWLIB
    OVRF      FILE-DATAF3,TOFILE-JUSDATA3.TOKWLIB
    OVRF      FILE-DATAF4,TOFILE-JUSDATA4.TOKWLIB
    OVRF      FILE-DATAF5,TOFILE-JUSDATA5.TOKWLIB
...
CVCS256J:
    ...
    OVRF      FILE-CVCS256,TOFILE-JUSCOWK.TOKWLIB
    OVRF      FILE-CVCS128,TOFILE-JUSCON.TOKWLIB
    CALL      PGM-CVCS256J.TOKELIBO,PARA-(?CHK)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
...
/.  DEFLIBL   TOKELIB/TOKFLIB/TOKELIBO/TOKJLIB/TOKKLIB/TOKWLIB ./
    ...
    OVRF      FILE-CVCSG001,TOFILE-JUSCOWK.TOKWLIB
    ...
    CALL      PGM-NJH2904B.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
