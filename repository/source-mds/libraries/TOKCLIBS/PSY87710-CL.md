...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY87710.CL`
...
/.##本社ﾚｰｻﾞｰへ出力##./
    IF ?CHK = '1' THEN
       SNDMSG MSG-'##本レ出力##',TO-XCTL.@ORGPROF,JLOG-@YES
       OVRPRTF FILE-XU04LP,TOFILE-KAHMAPRT.XUCL
    END
/.##ｶﾄｰﾚｯｸﾚｰｻﾞｰへ出力##./
    IF ?CHK = '2' THEN
       SNDMSG MSG-'##岡山出力##',TO-XCTL.@ORGPROF,JLOG-@YES
...
/.##ｽﾄｯｸﾌｫｰﾑへ出力##./
    IF ?CHK = '4' THEN
       SNDMSG MSG-'##本ス出力##',TO-XCTL.@ORGPROF,JLOG-@YES
...
SSY8772L:
    ...
    CALL      PGM-SSY8772L.TOKELIBO,PARA-(?P1,?P2,?P3,?P4,?P6,?P7
                                         ,?P8,?P9,?P10,?P11)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '出荷リスト出力'
              GOTO ABEND END
