...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY87631.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY87631'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
/.##甘木配送ｾﾝﾀｰﾚｰｻﾞｰへ出力##./
    IF ?CHK = '5' THEN
       ...
       OVRPRTF FILE-XU04LP,TOFILE-KAHMAPRA.XUCL
    END
...
SSY8763L:
    ...
    OVRF      FILE-DJSYUKL8,TOFILE-DJSYUKL8.TOKKLIB
    CALL      PGM-SSY8763L.TOKELIBO,PARA-(?P1,?P2,?P3,?P4,?P6,?P7
                                         ,?P8,?P9)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '出荷リスト出力'
              GOTO ABEND END
