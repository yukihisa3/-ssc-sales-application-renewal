...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY50440.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY50440'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
/.##帳票ﾌｧｲﾙ##./
  ...
  /.##さくらﾚｰｻﾞｰに出力##./
    IF  ?CHK = '6'  THEN
         OVRF      FILE-LSTNMEL1,TOFILE-LSTNMSL1.TOKWLIB
         CLRFILE   LSTNMSF.TOKWLIB
    END
  /.##新札幌ﾚｰｻﾞｰに出力##./
    IF  ?CHK = '7'  THEN
         OVRF      FILE-LSTNMEL1,TOFILE-LSTNMAL1.TOKWLIB
         CLRFILE   LSTNMAF.TOKWLIB
    END
...
/.##ﾌﾟﾘﾝﾀ切り替え##./
 ...
 ./      OVRPRTF FILE-XU04LP,TOFILE-TOSTMPRS.XUCL
 /.      ?MSGX    :=  '## 出力ﾌﾟﾘﾝﾀ ==> 片岡 ##'
 ./      ?MSGX    :=  '## 出力ﾌﾟﾘﾝﾀ ==> さくら（片岡） ##'
         SNDMSG MSG-?MSGX,TO-XCTL.@ORGPROF,JLOG-@YES
    END
  ...
  /.##新札幌ﾚｰｻﾞｰに出力##./
    IF  ?CHK = '7'  THEN
         OVRPRTF FILE-XU04LP,TOFILE-TOSTMPRA.XUCL
         ?MSGX    :=  '## 出力ﾌﾟﾘﾝﾀ ==> 新札幌 ##'
         SNDMSG MSG-?MSGX,TO-XCTL.@ORGPROF,JLOG-@YES
    END
