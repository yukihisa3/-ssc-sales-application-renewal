...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY3941K.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PSY3941K'
    VAR       ?STEP     ,STRING*8
    /.端末別ファイルＩＤ編集用./
              /.端末番号./
...
SSY3941B:
    ...
    OVRF      FILE-HCTPXXX1,TOFILE-?HACTXXX1
    CALL      PGM-SSY3941B.TOKELIBO,PARA-(?KANRINO,?SAKUCD)
...
SSY3942B:
    ...
    OVRF      FILE-HCTPXXX1,TOFILE-?HACTXXX1
    OVRF      FILE-HCSMXXX1,TOFILE-?HACSXXX1
    CALL      PGM-SSY3942B.TOKELIBO,PARA-(?KANRINO,?SAKUCD)
