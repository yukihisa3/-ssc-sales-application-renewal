...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY3767C.CL`
...
/.### ﾜｰｸｴﾘｱ定義 ###./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY3767C'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SSY3767C:
    ...
    /. O、?STYMD   開始仕入計上日     ./
    /. O、?EDYMD   終了仕入計上日　   ./
    OVRF    FILE-NFJYUDT,TOFILE-NFJYUDT.ONLBLIB
    CALL PGM-SSY3767C.TOKELIBO,PARA-(?JDATE,?STYMD,?EDYMD)
    IF  @PGMEC ^= 0  THEN
        IF @PGMEC = 4010  THEN
