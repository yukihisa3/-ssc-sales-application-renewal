...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJ00300.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PNJ00300'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SNJ0030I:
    ...
    CALL PGM-SNJ0030I.TOKELIBO,PARA-(?TANCD)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  'ＥＤＩ管理マスタ保守'
              GOTO ABEND
    END
