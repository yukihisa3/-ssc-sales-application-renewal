...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSK00500.CL`
...
/.### ﾜｰｸｴﾘｱ定義 ###./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSK00500'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SSK0050I:
    ...
    CALL PGM-SSK0050I.TOKELIBO,PARA-(?BUMON,?TANCD,
                                     ?SKBN,?DKBN,?DFROM,?DTO,
...
SSK0051B:
    ...
    ?MSGX :=  '***   '  && ?STEP   &&   '        ***'
    SNDMSG ?MSGX,TO-XCTL.@ORGPROF,SLOG-@YES,JLOG-@YES
    CALL PGM-SSK0051B.TOKELIBO,PARA-(
                                     ?SKBN,?DKBN,?DFROM,?DTO,
                                     ?KKBN,?TANF,?TANT,?DENK1,
                                     ?DENK2,?DENK3,?DENK4,?DENK5,
                                     ?TENF,?TENT,?DENNF,?DENNT,
...
SSK0052L:
    ...
    CALL PGM-SSK0052L.TOKELIBO,PARA-(
                                     ?SKBN,?DKBN,?DFROM,?DTO,
                                     ?KKBN,?TANF,?TANT,?DENK1,
                                     ?DENK2,?DENK3,?DENK4,?DENK5,
                                     ?TENF,?TENT,?DENNF,?DENNT,
...
SSK0053V:
    ...
    CALL PGM-SSK0053V.TOKELIBO,PARA-(
                                     ?SKBN,?DKBN,?DFROM,?DTO,
                                     ?KKBN,?TANF,?TANT,?DENK1,
                                     ?DENK2,?DENK3,?DENK4,?DENK5,
                                     ?TENF,?TENT,?DENNF,?DENNT,
...
FIMPORT:
    ...
    FIMPORT FILE-KEICSVHP.TOKKLIB,PARA-PARAKEI,UNIT-3
    ?PGMEC    :=    @PGMEC
    ?PGMEM    :=    @PGMEM
    IF  ?PGMEC ^= 0  THEN
           ?KEKA4 := '返品計上データＣＳＶ出力'
