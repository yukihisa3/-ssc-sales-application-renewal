...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSV01250.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PSV01250'
    VAR       ?STEP     ,STRING*8
...
CSV0120B:
    ...
    OVRF      FILE-DENPYOF,TOFILE-?JHTDENF
    OVRF      FILE-SHOTBL1,TOFILE-SHOTBL1.TOKFLIB
    OVRF      FILE-HACYUDT,TOFILE-HACYUDT.TOKWLIB
    CALL      PGM-CSV0125B.TOKELIBO
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
...
CSV0110B:
    ...
    OVRF      FILE-CSVDT1,TOFILE-CSVDT1.TOKWLIB
    OVRF      FILE-HACYUDT,TOFILE-HACYUDT.TOKWLIB
    OVRF      FILE-TENMS1,TOFILE-TENMS1.TOKFLIB
    CALL      PGM-CSV0115B.TOKELIBO
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
...
PFIMPORT:
    ...
    FIMPORT FILE-CSVDT1.TOKWLIB,PARA-TXTDATA,UNIT-2
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
