...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PBM10210.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PBM10210'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,NAME!MOD
...
ASSIGN:
    ...
    ASSIGN    FILE-SETGKFS.TOKKLIB!@XCL
    ?PGMEC    :=    @PGMEC
    ?PGMEM    :=    @PGMEM
    IF        ?PGMEC    ^=   0    THEN
              SNDMSG '他で連携処理が行われています',TOWS-@ORGWS
              ?KEKA4 :=  'サンデー・ジョイ請求合計ファイルロック'
              GOTO ABEND
    END
    ...
    ASSIGN    FILE-SEKSJYF.ONLBLIB!@XCL
    ?PGMEC    :=    @PGMEC
    ?PGMEM    :=    @PGMEM
    IF        ?PGMEC    ^=   0    THEN
              SNDMSG '他で連携処理が行われています',TOWS-@ORGWS
...
PSORT1:
    ...
    IF        ?TORICD  =  '00030402'  THEN
       SORTF  INFILE-SETGKFA.TOKFLIB,
              ...
              SELECT1-'F01!EQ!#00304021',
              RCDL-@DSP
       IF     @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '【サンデー・ジョイ分　請求データ抽出】'
              GOTO ABEND
       END
    END
...
STEP050:
    ...
    OVRF FILE-SETGKFP,TOFILE-SETGKFS.TOKKLIB
...
STEP060:
    ...
    OVRF FILE-BMSSEKL1,TOFILE-BMSSEKL1.BMSFLIB
    OVRF FILE-SEKSNDF,TOFILE-SEKSJYF.ONLBLIB
...
STEP070:
    ...
    OVRF FILE-SEKIONF,TOFILE-SEKSJYF.ONLBLIB
