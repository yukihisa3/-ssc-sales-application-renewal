...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSI7301T.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PSI7301T'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,STRING*8
...
STEP060:
    ...
    SNDMSG '######################################',TO-XCTL
    SNDMSG '## ダイユーエイト支払データ変換開始 ##',TO-XCTL
    SNDMSG '######################################',TO-XCTL
    OVRF      FILE-DYSIHASF,TOFILE-DYSIHASF.ONLBLIB
    OVRF      FILE-DYSIHL3,TOFILE-DYSIHL3.TOKKLIB
    CALL SSI7301B.TOKELIBO
    IF   ?PGCHK1  = '1'    THEN
         SNDMSG '########################################',TO-XCTL
         SNDMSG '## ダイユーエイト支払データ変換エラー ##',TO-XCTL
         SNDMSG '########################################',TO-XCTL
    END
