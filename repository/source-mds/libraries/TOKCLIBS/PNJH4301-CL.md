...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH4301.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH4301'  /.PROGRAM-ID./
...
/.  OVRF      FILE-CVCSG001,TOFILE-OK.ONLBLIB   ./
    ...
    OVRF      FILE-JSMDAYL1,TOFILE-JSMDAYL1.TOKJLIB /.当日ｽｹｼﾞｭｰﾙM./
    ...
    CALL      PGM-NJH4301B.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
