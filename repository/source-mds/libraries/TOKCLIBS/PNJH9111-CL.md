...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH9111.CL`
...
/.##ﾜｰｸﾃｲｷﾞ ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH9111'  /.PROGRAM-ID./
...
NJH9111B:
    ...
    CALL      PGM-NJH9111B.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
              CALL PGM-SNJ0730B.TOKELIBO,
