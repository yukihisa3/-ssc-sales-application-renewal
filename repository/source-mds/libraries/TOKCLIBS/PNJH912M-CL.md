...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH912M.CL`
...
/.##ﾜｰｸﾃｲｷﾞ ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH912M'  /.PROGRAM-ID./
...
NJH9120B:
    ...
    CALL      PGM-NJH9120M.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
