...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PBM0300L.CL`
...
/. *   SYSTEM-NAME :    流通ＢＭＳオンライン      　　　     *  ./
/. *   JOB-ID      :    PBM0300L                             *  ./
/. *   JOB-NAME    :    納品センターマスタリスト発行　　　  *  ./
/. *               :                                         *  ./
/. ***********************************************************  ./
/.###ﾜｰｸｴﾘｱ定義####./
    PGM
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PBM0300L'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
/.##ﾗｲﾌﾞﾗﾘﾘｽﾄ登録##./
    DEFLIBL TOKELIB/TOKFLIB/TOKELIBO/TOKKLIB/BMSFLIB
...
SBM0300L:
    ...
    OVRF FILE-SOKCETL1,TOFILE-SOKCETL1.BMSFLIB  /.納品ｾﾝﾀｰﾏｽﾀ./
    OVRF FILE-SOKMS1,TOFILE-SOKMS1.TOKFLIB      /.倉庫ﾏｽﾀ./
    OVRF FILE-TOKMS2,TOFILE-TOKMS2.TOKFLIB      /.取引先ﾏｽﾀ./
    OVRF FILE-TENMS1,TOFILE-TENMS1.TOKFLIB      /.店舗ﾏｽﾀ./
    CALL PGM-SBM0300L.TOKELIBO
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '納品センターマスタリスト'
              GOTO ABEND
    END
