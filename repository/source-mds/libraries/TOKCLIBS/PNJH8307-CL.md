...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH8307.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH8307'  /.PROGRAM-ID./
...
NJH8307B:
    ...
    CALL      PGM-NJH8307B.TOKELIBO,PARA-(?HIDUKE,?JIKAN,?TOKCD,?LINE,
...
NJH8327B:
    ...
    CALL      PGM-NJH8327B.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
...
KENLST05:
    ...
    SBMJOB JOB-KENLST05,JOBD-CVCS.XUCL,JOBK-@B,PGM-KENLST.TOKCLIBO,
...
RTN:
   ...
   /.##ｴﾗｰﾘｽﾄ発行##./
    SBMJOB JOB-KEKALS05,JOBD-CVCS.XUCL,JOBK-@B,
