...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH4402.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH4402'  /.PROGRAM-ID./
...
/.  OVRF      FILE-CVCSG001,TOFILE-OK.ONLBLIB   ./
...
/.##CALL      PGM-NJH4402B.TOKELIBO,PARA-(?PARA)
##./CALL      PGM-NJH4403B.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
