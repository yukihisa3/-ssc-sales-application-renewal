...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY85010.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY85010'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SSY3103I:
    ...
    OVRF      FILE-KGJOHOL2,TOFILE-KGJOHOL2.TOKKLIB
    OVRF      FILE-TOKMS2,TOFILE-TOKMS2.TOKFLIB
    OVRF      FILE-ZSOKMS1,TOFILE-ZSOKMS1.TOKFLIB
    CALL      PGM-SSY8501I.TOKELIBO,PARA-(?P1,?P2,?P3,?P4,?P6,?P5)
    IF        @PGMEC    ^=   0    THEN
         IF   @PGMEC     =   4010 THEN
...
SSY8502B:
    ...
    CALL      PGM-SSY8502B.TOKELIBO,PARA-(?P1,?P2,?P3,?P4,?P6)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  'データ削除'
              GOTO ABEND END
...
SSY3104B:
    ...
    OVRF      FILE-KGJOHOL3,TOFILE-KGJOHOL3.TOKKLIB
    OVRF      FILE-KGSYUKL2,TOFILE-KGSYUKL1.TOKKLIB
    CALL      PGM-SSY8503B.TOKELIBO,PARA-(?P1,?P2,?P3,?P4,?P6)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  'データ抽出'
              GOTO ABEND END
