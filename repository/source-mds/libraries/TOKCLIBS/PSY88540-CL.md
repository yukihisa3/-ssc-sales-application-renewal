...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY88540.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY88540'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SSY8854I:
    ...
    CALL      PGM-SSY8854I.TOKELIBO,PARA-(?P7,?P5,?P1,?P2,?P3,?P4)
    IF        @PGMEC    ^=   0    THEN
         IF   @PGMEC     =   4010 THEN
...
/.  IF  ?WS ^= 'WKSTNHT5'  THEN
    ...
    ELSE
          ...
          OUTQ-XOUTQ1,MEDLIB-TOKELIBO
    END
    CALL      PGM-SSY8855L.TOKELIBO,PARA-(?P1,?P2,?P3,?P4)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '荷個数明細書'
              GOTO ABEND END
