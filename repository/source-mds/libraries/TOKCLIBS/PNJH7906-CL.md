...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH7906.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH7906'  /.PROGRAM-ID./
...
NCV0073B:
    ...
    CALL      PGM-NCV7900B.TOKELIBO,PARA-(?HIDUKE,?JIKAN,?TOKCD,?LINE,
...
KENLST:
    ...
    IF ?TOKCK1 = '1'  THEN
       ...
       ?MSGX :=  '***   '  && ?STEP   &&   '        ***'
       SNDMSG    ?MSGX,TO-XCTL
       SBMJOB JOB-KENLSTA9,JOBD-CVCS.XUCL,JOBK-@B,PGM-KENLST.TOKCLIBO,
    ...
    IF ?TOKCK2 = '1'  THEN
       ...
       ?MSGX :=  '***   '  && ?STEP   &&   '        ***'
       SNDMSG    ?MSGX,TO-XCTL
       SBMJOB JOB-KENLSTB9,JOBD-CVCS.XUCL,JOBK-@B,PGM-KENLST.TOKCLIBO,
       VSIZE-5,RSIZE-16,LOG-@YES!1024,PARA-(?HIDUKE,?JIKAN,
       ?TOKCD2,?LINE,?YUSEN)
    END
