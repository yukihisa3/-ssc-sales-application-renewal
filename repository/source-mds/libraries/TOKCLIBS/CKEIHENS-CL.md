...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/CKEIHENS.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'CKEIHENS'
    VAR       ?STEP     ,STRING*8
...
SKEIHEN:
    ...
    CALL      PGM-SKEIHEN.TOKELIBO,PARA-(?TANCD,?BUMON,
                                          ?LSTTIME,?LSTDATE)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
