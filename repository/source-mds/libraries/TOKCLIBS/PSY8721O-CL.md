...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY8721O.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY8721K'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SSY8740I:
    ...
    OVRPRTF   FILE-XU04LP,TOFILE-KAHMAPRO.XUCL
/.  OVRPRTF   FILE-PRTF,TOFILE-KAHMAPRK.XUCL               ./
/.  OVRPRTF   FILE-PRTF,TOFILE-XU04LP.XUCL,MEDLIB-TOKELIB  ./
    OVRF      FILE-DJSYUKL1,TOFILE-DJSYUKL1.TOKKLIB
    OVRF      FILE-TOKMS2,TOFILE-TOKMS2.TOKFLIB
    OVRF      FILE-ZSOKMS1,TOFILE-ZSOKMS1.TOKFLIB
    CALL      PGM-SSY8740I.TOKELIBO,PARA-(?P1,?P2,?P3,?P4,?P5,?P6,?P7
                                         ,?P8,?P9)
    IF        @PGMEC    ^=   0    THEN
         IF   @PGMEC     =   4010 THEN
...
SSY8743L:
    ...
    OVRF      FILE-DJSYUKL4,TOFILE-DJSYUKL4.TOKKLIB
    CALL      PGM-SSY874KL.TOKELIBO,PARA-(?P1,?P2,?P3,?P4,?P6,?P7
                                         ,?P8,?P9)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '出荷リスト出力'
              GOTO ABEND END
