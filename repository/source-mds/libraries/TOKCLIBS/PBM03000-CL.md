...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PBM03000.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PBM03000'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SBM0300I:
    ...
    OVRF FILE-SOKCETL1,TOFILE-SOKCETL1.BMSFLIB  /.納品ｾﾝﾀﾏｽﾀ./
    ...
    CALL PGM-SBM0300I.TOKELIBO,PARA-(?TANCD)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '納品センターマスタ保守'
              GOTO ABEND
    END
