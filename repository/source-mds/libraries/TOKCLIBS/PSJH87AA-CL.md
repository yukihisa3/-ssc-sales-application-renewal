...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSJH87AA.CL`
...
STEP050:
    ...
    OVRF FILE-JCADAIKI,TOFILE-DAIKIHAC.ONLBLIB
...
STEP060:
    ...
    OVRF FILE-DAIKI,TOFILE-DAIKIHAC.ONLBLIB
...
./
    IF   ?CHK4  =  '1'  THEN
         ...
         SNDMSG '######################################',TO-XCTL
         CALL PSJH3102.TOKCLIBO,PARA-(?HIDUKE,?JIKAN,?PGCHK4)
         IF   ?PGCHK3  = '1'    THEN
              SNDMSG '######################################',TO-XCTL
...
./
    IF   ?CHK8  =  '1'  THEN
         ...
         SNDMSG '######################################',TO-XCTL
         CALL PSJH8402.TOKCLIBO,PARA-(?HIDUKE,?JIKAN,?PGCHK8)
         IF   ?PGCHK3  = '1'    THEN
              SNDMSG '######################################',TO-XCTL
...
/.  IF   ?CHK9  =  '1'  THEN
         ...
         SNDMSG '######################################',TO-XCTL
         CALL PSJH7903.TOKCLIBO,PARA-(?HIDUKE,?JIKAN,?PGCHK9)
         IF   ?PGCHK3  = '1'    THEN
              SNDMSG '######################################',TO-XCTL
