...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PJUS2101.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PJUS2201'  /.PROGRAM-ID./
...
SSI0170B:
 ...
 /. OVRF      FILE-CVCS256,TOFILE-CVCSTEL1.CVCSLBT  ./
    OVRF      FILE-CVCS256,TOFILE-SHIKATAK.ONLBLIB
    OVRF      FILE-CVCS128,TOFILE-CVCS128K.TOKFLIB
    CALL      PGM-SSI0170B.TOKELIB
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K554'
