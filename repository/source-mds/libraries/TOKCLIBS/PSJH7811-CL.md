...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSJH7811.CL`
...
/.##ﾊﾟﾗﾒﾀ定義##./
    VAR       ?HIDUKE   ,STRING*8,VALUE-'20081001' /.受信日付./
    VAR       ?JIKAN    ,STRING*4,VALUE-'1415'     /.受信時間./
    VAR       ?TOKCD    ,STRING*8,VALUE-'00051649' /.受信取引先./
    VAR       ?LINE     ,STRING*1,VALUE-'P'        /.回線./
    VAR       ?YUSEN    ,STRING*1,VALUE-'1'        /.回線優先./
    VAR       ?LIBNM    ,STRING*8,VALUE-'ONLBLIB ' /.集信LIB./
    VAR       ?FILNM    ,STRING*8,VALUE-'ROYALPC ' /.集信FILE./
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PSJH7810'  /.PROGRAM-ID./
...
/.  OVRF      FILE-VLD500,TOFILE-LD500.TOKFLIB   ./
    ...
    CALL      PGM-SJH7810B.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := '92'
