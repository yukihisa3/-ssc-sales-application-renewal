...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSI8705D.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PSI8705D'
    VAR       ?STEP     ,STRING*8
...
SSI87051:
    ...
    OVRF      FILE-SETGK874,TOFILE-SETGK874.TOKKLIB
    OVRF      FILE-TENMS1,TOFILE-TENMS1.TOKFLIB
    CALL      PGM-SSI8705D.TOKELIBO,PARA-(?SYORIKN1,?SYORIKN2)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
...
SSI87052:
    ...
    OVRF      FILE-SIHARASF,TOFILE-SIHARASF.TOKKLIB
    OVRF      FILE-SETGK874,TOFILE-SETGK884.TOKKLIB
    OVRF      FILE-TENMS1,TOFILE-TENMS1.TOKFLIB
    CALL      PGM-SSI8705D.TOKELIBO,PARA-(?SYORIKN3,?SYORIKN4)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
RTN:
