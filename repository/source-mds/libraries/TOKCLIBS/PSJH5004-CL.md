...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSJH5004.CL`
...
/.##ﾊﾟﾗﾒﾀ定義##./
    ...
    PARA      ?JKEKA    ,STRING*2,IN,VALUE-'  '      /.結果./
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PSJH5004'  /.PROGRAM-ID./
...
SJH4701B:
    ...
    CALL      PGM-SJH5004B.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := '92'
