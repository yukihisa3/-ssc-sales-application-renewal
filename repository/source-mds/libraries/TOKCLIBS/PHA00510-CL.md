...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PHA00510.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PHA00510'
    VAR       ?STEP     ,STRING*8
...
/.  OVRPRTF FILE-XU04LP,TOFILE-XU04LP.XUCL,DEV-SYSPRINT,
            OUTQ-XXLWQ,MEDLIB-TOKELIBO
