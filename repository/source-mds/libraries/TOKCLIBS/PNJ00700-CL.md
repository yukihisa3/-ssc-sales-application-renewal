...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJ00700.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PNJ00700'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SNJ0070I:
    ...
    OVRF FILE-JSMKIHL1,TOFILE-JSMKIHL1.TOKJLIB  /.基本ｽｹｼﾞｭｰﾙﾏｽﾀ./
    ...
    CALL PGM-SNJ0070I.TOKELIBO,PARA-(?TANCD)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '基本スケジュールマスタ保守'
              GOTO ABEND
    END
