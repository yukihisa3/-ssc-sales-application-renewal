...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH8306.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH8306'  /.PROGRAM-ID./
...
NJH8306B:
    ...
    CALL      PGM-NJH8306B.TOKELIBO,PARA-(?HIDUKE,?JIKAN,?TOKCD,?LINE,
...
NJH8326B:
    ...
    CALL      PGM-NJH8326B.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
...
KENLST04:
    ...
    SBMJOB JOB-KENLST04,JOBD-CVCS.XUCL,JOBK-@B,PGM-KENLST.TOKCLIBO,
...
RTN:
   ...
   /.##ｴﾗｰﾘｽﾄ発行##./
    SBMJOB JOB-KEKALS04,JOBD-CVCS.XUCL,JOBK-@B,
