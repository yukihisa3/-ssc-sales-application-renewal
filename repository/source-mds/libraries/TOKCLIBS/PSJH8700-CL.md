...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSJH8700.CL`
...
STEP070:
    ...
    IF   ?CHK9  =  '1'  THEN
         ...
         SNDMSG '######################################',TO-XCTL
         CALL PSJH7906.TOKCLIBO,PARA-(?HIDUKE,?JIKAN,?PGCHK9)
         IF   ?PGCHK3  = '1'    THEN
              SNDMSG '######################################',TO-XCTL
    ...
    IF   ?CHK10 =  '1'  THEN
         ...
         SNDMSG '######################################',TO-XCTL
         CALL PSJH7905.TOKCLIBO,PARA-(?HIDUKE,?JIKAN,?PGCHK10)
         IF   ?PGCHK3  = '1'    THEN
              SNDMSG '######################################',TO-XCTL
    ...
    IF   ?CHK11 =  '1'  THEN
         ...
         SNDMSG '## ダイキ　　　　　　資材　変換開始 ##',TO-XCTL
         SNDMSG '######################################',TO-XCTL
         CALL PSJH7907.TOKCLIBO,PARA-(?HIDUKE,?JIKAN,?PGCHK11)
         IF   ?PGCHK3  = '1'    THEN
              SNDMSG '######################################',TO-XCTL
              SNDMSG '## ダイキ　　　　　資材　変換エラー ##',TO-XCTL
              SNDMSG '######################################',TO-XCTL
    ...
    IF   ?CHK12 =  '1'  THEN
         ...
         SNDMSG '## ダイキ　　　　　　植物　変換開始 ##',TO-XCTL
         SNDMSG '######################################',TO-XCTL
         CALL PSJH7908.TOKCLIBO,PARA-(?HIDUKE,?JIKAN,?PGCHK12)
         IF   ?PGCHK3  = '1'    THEN
              SNDMSG '######################################',TO-XCTL
              SNDMSG '## ダイキ　　　　　植物　変換エラー ##',TO-XCTL
              SNDMSG '######################################',TO-XCTL
