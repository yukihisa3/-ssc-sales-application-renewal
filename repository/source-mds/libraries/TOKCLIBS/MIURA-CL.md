...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/MIURA.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'CSY01030'
    VAR       ?STEP     ,STRING*8
...
/.##ﾗｲﾌﾞﾗﾘﾘｽﾄ登録##./
    DEFLIBL   TOKELIBO/TOKFLIB/TOKKLIB/TOKELIB
...
TSY0103I:
    ...
    CALL      PGM-TSY0103I.TOKELIBO,PARA-(?TANCD,?BUMON,
                                          ?LSTTIME,?LSTDATE)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
