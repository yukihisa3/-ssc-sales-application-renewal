...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNA01300.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?CLID    ,STRING*08,VALUE-'PNA01300'        /.CLID         ./
   ...
   /.##パラメタ（個別）##./
    ...
    VAR ?OUTSEQ  ,STRING*01,VALUE-'1'               /.リスト出力順 ./
    /. 相手商品順:1､自社商品順:2 ↑ ./
    ...
    VAR ?MSG1A,STRING*38,VALUE-'小売発注連携リスト（相手商品コード順'
