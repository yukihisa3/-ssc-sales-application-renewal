...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PBM00600.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PBM00600'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,NAME!MOD
...
STEP060:
    ...
    OVRF FILE-BMSYKF,TOFILE-BMSYKF.BMSFLIB
    CALL SBM0070B.TOKELIBO,PARA-(?JDATE,?JTIME,?TORICD,?SOKO,
...
STEP070:
    ...
    CALL  SBM0080B.TOKELIBO,PARA-(?SYORIKN2)
    IF      @PGMEC    ^=   0    THEN
