...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH8801.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PSJH8801'  /.PROGRAM-ID./
...
NJH8801B:
    ...
    OVRF      FILE-JSMKEN11,TOFILE-JSMKENL1.TOKJLIB
...
/.  OVRF      FILE-VLD500,TOFILE-LD500.TOKFLIB   ./
    ...
    CALL      PGM-NJH8801B.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
