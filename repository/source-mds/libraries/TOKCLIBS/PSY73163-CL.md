...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY73163.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PSY73163'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,STRING*8
...
STEP030:
    ...
    /.##リック資材受領書発行##./
    CALL SSY7317L.TOKELIBO,PARA-('00001994')
    IF      @PGMEC    ^=   0    THEN
            ?KEKA4 := '【リック資材受領書発行】'
            GOTO ABEND
    END
