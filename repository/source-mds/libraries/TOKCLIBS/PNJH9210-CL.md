...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH9210.CL`
...
/.##ﾜｰｸﾃｲｷﾞ ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH9210'  /.PROGRAM-ID./
...
NJH9210B:
    ...
    CALL      PGM-NJH9210B.TOKSOLIB,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
