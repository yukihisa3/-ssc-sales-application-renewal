...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PIT01500.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PIT01500'
    VAR       ?STEP     ,STRING*8
...
SIT0050I:
    ...
    CALL      PGM-SIT0150I.TOKELIBO,PARA-(?BUMON,?TANTO,?UPDT,?UPTM)
    IF        @PGMEC    ^=   0  THEN
              IF  @PGMEC = 4010  THEN
...
./  OVRF      FILE-ZSOKMS1,TOFILE-ZSOKMS1.TOKFLIB
    ...
    CALL      PGM-SIT0160L.TOKELIBO,PARA-(?BUMON,?TANTO,?UPDT,?UPTM,
                                          ?UPDTE,?UPTME)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
