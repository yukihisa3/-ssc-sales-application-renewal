...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJ00800.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PNJ00800'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SNJ0080L:
    ...
    OVRF FILE-JSMKIHL2,TOFILE-JSMKIHL2.TOKJLIB  /.基本ｽｹｼﾞｭｰﾙﾏｽﾀﾘｽﾄ./
    OVRF FILE-TOKMS2,TOFILE-TOKMS2.TOKFLIB      /.取引先ﾏｽﾀ./
    CALL PGM-SNJ0080L.TOKELIBO
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '基本スケジュールマスタリスト'
              GOTO ABEND
    END
