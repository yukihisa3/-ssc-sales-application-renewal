...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH4592.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH4592'  /.PROGRAM-ID./
...
/.##ﾌﾟﾛｸﾞﾗﾑｶｲｼﾒｯｾｰｼﾞ##./
    ...
    DEFLIBL TOKELIB/TOKFLIB/OSKELIB/TOKELIBO/TOKKLIB/TOKJLIB
...
SCV1003B:
    ...
    CALL      PGM-NCV1003B.TOKELIBO,PARA-(?HIDUKE,?JIKAN,?TOKCD,?LINE,
...
/.  OVRF      FILE-CVCSG001,TOFILE-IONHACSS.ONLBLIB
./  OVRF      FILE-JSMKENL1,TOFILE-JSMKENL1.TOKJLIB
    ...
    CALL      PGM-NJH4592B.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
...
KENLST:
    ...
    SBMJOB JOB-KENLST03,JOBD-CVCS.XUCL,JOBK-@B,PGM-KENLST.TOKCLIBO,
...
RTN:
    ...
    CALL SCVMSG.TOKCLIBO,PARA-('ｾｲｼﾞｮｳ ｼｭｳﾘｮｳ PNJH4592')

   /.##ｴﾗｰﾘｽﾄ発行##./
    SBMJOB JOB-KEKALS03,JOBD-CVCS.XUCL,JOBK-@B,
...
ABEND:
    ...
    CALL SCVMSG.TOKCLIBO,PARA-('ｲｼﾞｮｳ ｼｭｳﾘｮｳ  PNJH4592')
