...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY88530.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY88530'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SSY8853I:
    ...
    OVRF      FILE-DSCENTL2,TOFILE-DSCENTL2.TOKKLIB
    CALL      PGM-SSY8853I.TOKELIBO,PARA-(?P4,?P5)
    IF        @PGMEC    ^=   0    THEN
         IF   @PGMEC     =   4010 THEN
