...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSJH8330.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PSJH8330'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,STRING*8
...
STEP030:
    ...
    FEXPORT FILE-JEDICOSJ.ONLBLIB,MODE-@REP,PARA-HORMAC,
            UNIT-5
    IF      @PGMEC    ^=   0    THEN
            ?KEKA4 := '【受信データ取込処理】'
                    GOTO ABEND
...
STEP050:
    ...
    OVRF FILE-JCAFILED,TOFILE-JCAFILED.ONLBLIB
...
STEP060:
    ...
    OVRF FILE-HOH,TOFILE-JCAFILEA.ONLBLIB
    OVRF FILE-HOS,TOFILE-JCAFILEB.ONLBLIB
    OVRF FILE-HOK,TOFILE-JCAFILEC.ONLBLIB
    OVRF FILE-HOT,TOFILE-JCAFILED.ONLBLIB
    CALL SJH8332L.TOKELIBO,PARA-('1',?CHK1,?CHK2,?CHK3)
    IF      @PGMEC    ^=   0    THEN
            ?KEKA4 := '【受信結果リスト】'
                    GOTO ABEND
    END
