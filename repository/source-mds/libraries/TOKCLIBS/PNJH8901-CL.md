...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH8901.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH8901'  /.PROGRAM-ID./
...
NCV8901B:
    ...
    CALL      PGM-NCV8901B.TOKELIBO,PARA-(?HIDUKE,?JIKAN,?TOKCD,?LINE,
