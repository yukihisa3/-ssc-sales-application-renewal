...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJ06100.CL`
...
/. ***********************************************************  ./
    PGM (P1-?JYUKBN)
/.###ﾊﾟﾗﾒｰﾀ定義####./
    PARA ?JYUKBN   ,STRING*1,IN,VALUE-' '       /.配信区分./
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PNJ06100'    /.ﾌﾟﾛｸﾞﾗﾑID./
