...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH735N.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH735N'  /.PROGRAM-ID./
...
NCV7351N:
    ...
    CALL      PGM-NCV7351N.TOKELIBO,PARA-(?HIDUKE,?JIKAN,?TOKCD,?LINE,
...
SJH7351N:
    ...
    OVRF      FILE-JHMKENL1,TOFILE-JHMKENL1.TOKJLIB
    OVRF      FILE-JSHDAYL1,TOFILE-JSHDAYL1.TOKJLIB
    ...
    CALL      PGM-NJH7351N.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
