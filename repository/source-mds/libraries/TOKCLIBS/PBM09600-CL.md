...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PBM09600.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PBM09600'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SBM0960I:
    ...
    OVRF FILE-SYOMEIL1,TOFILE-SYOMEIL1.TOKKLIB  /.取引先振分ﾏｽﾀ./
    OVRF FILE-SHOTBL1,TOFILE-SHOTBL1.TOKFLIB    /.条件ﾌｧｲﾙ./
    OVRF FILE-TOKMS2,TOFILE-TOKMS2.TOKFLIB      /.取引先ﾏｽﾀ./
    OVRF FILE-MEIMS1,TOFILE-MEIMS1.TOKFLIB      /.店舗ﾏｽﾀ./
    OVRDSPF FILE-DSPF,TOFILE-DSPF.XUCL,MEDLIB-TOKELIBO
    CALL PGM-SBM0960I.TOKELIBO,PARA-(?BUMON,?TANCD)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '商品名称管理マスタ保守'
              GOTO ABEND
    END
