...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH3102.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH3102'  /.PROGRAM-ID./
...
NCV0073B:
    ...
    CALL      PGM-NCV3100B.TOKELIBO,PARA-(?HIDUKE,?JIKAN,?TOKCD,?LINE,
...
NJH3102B:
    ...
    OVRF      FILE-KMJOHOL1,TOFILE-KMJOHOL1.OSKFLIB
    OVRVLDF   FILE-VLD500,TOFILE-LD500.XUCL
    CALL      PGM-NJH3102B.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
...
KENLST07:
    ...
    SBMJOB JOB-KENLST07,JOBD-CVCS.XUCL,JOBK-@B,PGM-KENLST.TOKCLIBO,
...
RTN:
   ...
   /.##ｴﾗｰﾘｽﾄ発行##./
    SBMJOB JOB-KEKALS07,JOBD-CVCS.XUCL,JOBK-@B,
