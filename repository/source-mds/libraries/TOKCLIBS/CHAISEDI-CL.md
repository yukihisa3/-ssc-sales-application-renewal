...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/CHAISEDI.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    PGM (P1-?JYUKBN)
/.###ﾜｰｸｴﾘｱ定義####./
    PARA ?JYUKBN  ,STRING*1,IN,VALUE-'1'        /.ｼﾞｭｼﾝﾓｰﾄﾞ./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'CMANUEDI'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SNJ0610I:
    ...
    CALL      PGM-SNJ0610I.TOKELIBO,PARA-(?JYUKBN)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
/.###ﾌﾟﾛｸﾞﾗﾑ終了###./
RTN:
