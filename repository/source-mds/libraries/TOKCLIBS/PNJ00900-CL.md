...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJ00900.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PNJ00900'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SNJ0090I:
    ...
    CALL PGM-SNJ0090I.TOKELIBO,PARA-(?TANCD)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  'メッセージマスタ保守'
              GOTO ABEND
    END
