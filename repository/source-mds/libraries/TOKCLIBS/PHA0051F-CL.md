...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PHA0051F.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PHA0051F'
    VAR       ?STEP     ,STRING*8
...
/.  OVRPRTF FILE-XU04LP,TOFILE-XU04LP.XUCL,DEV-PRINT512,
            OUTQ-XXPXL512,MEDLIB-TOKELIB  ./
    OVRPRTF FILE-XU04LP,TOFILE-XU04LP.XUCL,DEV-FAXLINK1,
            OUTQ-XXFAXQ,MEDLIB-TOKELIB
