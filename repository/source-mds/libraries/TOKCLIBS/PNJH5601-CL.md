...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH5601.CL`
...
/. ##ﾜｰｸﾃｲｷﾞ## ./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH5601'  /.PROGRAM-ID./
...
NJH5601B:
    ...
    CALL      PGM-NJH5601B.TOKELIBO,PARA-(?PARA)
