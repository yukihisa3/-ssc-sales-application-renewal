...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY89010.CL`
...
SSY8901I:
    ...
    CALL      PGM-SSY8901I.TOKELIBO,PARA-(?P1,?P2,?P3,?P4,?P5,?P6,?P7
                                         ,?P8,?P9)
    IF        @PGMEC    ^=   0    THEN
         IF   @PGMEC     =   4010 THEN
...
/.##ｽﾄｯｸﾌｫｰﾑへ出力##./
    ...
    END
    OVRF      FILE-RCSYUKL4,TOFILE-RCSYUKL4.TOKKLIB
    CALL      PGM-SSY8902L.TOKELIBO,PARA-(?P1,?P2,?P3,?P4,?P6,?P7
                                         ,?P8,?P9)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '出荷リスト出力'
              GOTO ABEND END
