...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PIT0070T.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PIT00700'
    VAR       ?STEP     ,STRING*8
    VAR       ?BUMON    ,STRING*4,VALUE-'2920'     /.部門CD./
    VAR       ?TANTO    ,STRING*8,VALUE-'02      ' /.担当者CD./
    VAR       ?UPDT     ,STRING*8,VALUE-'20090318' /.更新日./
    VAR       ?UPTM     ,STRING*6,VALUE-'104626'   /.更新時間./
    VAR       ?UPDTE    ,STRING*8,VALUE-'20090318' /.更新日./
    VAR       ?UPTME    ,STRING*6,VALUE-'104705'   /.更新時間./
...
SIT0080L:
    ...
    CALL      PGM-SIT0080L.TOKELIBO,PARA-(?BUMON,?TANTO,?UPDT,?UPTM,
                                          ?UPDTE,?UPTME)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
