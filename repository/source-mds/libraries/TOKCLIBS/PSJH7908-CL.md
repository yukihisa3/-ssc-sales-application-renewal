...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSJH7908.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PSJH7908'  /.PROGRAM-ID./
...
SCV0073B:
    ...
    CALL      PGM-SCV7930B.TOKELIBO,PARA-(?HIDUKE,?JIKAN,?TOKCD,?LINE,
...
KENLST:
    ...
    SBMJOB JOB-KENLST5,JOBD-CVCS.XUCL,JOBK-@B,PGM-KENLST.TOKELIB,
...
RTN:
   ...
   /.##ｴﾗｰﾘｽﾄ発行##./
    SBMJOB JOB-KEKALST4,JOBD-CVCS.XUCL,JOBK-@B,
