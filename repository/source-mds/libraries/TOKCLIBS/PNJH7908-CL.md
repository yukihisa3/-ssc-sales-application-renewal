...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH7908.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH7908'  /.PROGRAM-ID./
...
NCV7930B:
    ...
    CALL      PGM-NCV7930B.TOKELIBO,PARA-(?HIDUKE,?JIKAN,?TOKCD,?LINE,
...
NJH7908B:
    ...
    CALL      PGM-NJH7908B.TOKELIBO,
    PARA-(?HIDUKE,?JIKAN,?LINE,?YUSEN,?TOKCD)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
...
KENLST12:
    ...
    SBMJOB JOB-KENLST12,JOBD-CVCS.XUCL,JOBK-@B,PGM-KENLST.TOKCLIBO,
...
RTN:
   ...
   /.##ｴﾗｰﾘｽﾄ発行##./
    SBMJOB JOB-KEKALS12,JOBD-CVCS.XUCL,JOBK-@B,
...
ABEND:
   ...
   /.##ｴﾗｰﾘｽﾄ発行##./
    SBMJOB JOB-KEKALT12,JOBD-CVCS.XUCL,JOBK-@B,
           PGM-SNJ0590L.TOKELIBO,LOG-@YES!1024,PTY-5,PGMEL-@I/@L/
           @S/@T,LIBL-TOKFLIB/TOKELIB/TOKJLIB/TOKELIBO,
           PARA-(?HIDUKE,?JIKAN,?TOKCD,?KEKA)
    ?PGMEC    :=    @PGMEC
