...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY0015U.CL`
...
SGD0012V:
    ...
    OVRF      FILE-JHTDENF,TOFILE-?JHTDENF
    OVRF      FILE-UTACSV,TOFILE-UTACSV.TOKWLIB
    CALL      PGM-SGD0012V.TOKELIBO
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
...
PFIMPORT:
    ...
    FIMPORT FILE-UTACSV.TOKWLIB,PARA-UTANE,UNIT-1
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
