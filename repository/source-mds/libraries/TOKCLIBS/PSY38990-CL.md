...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY38990.CL`
...
/.### ﾜｰｸｴﾘｱ定義 ###./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY37990'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
/.## ﾗｲﾌﾞﾗﾘﾘｽﾄ登録 ##./
    DEFLIBL TOKELIB/TOKFLIB/TOKELIBO/TOKDLIB/TOKKLIB
...
ABEND:  /. ﾌﾟﾛｸﾞﾗﾑ異常終了時処理 ./
    ...
    ?KEKA1 :=  '売上伝票ファイルの削除処理が異常終了'
    ?KEKA2 :=  'しました。ログリストを採取してＮＡＶ'
    ?KEKA3 :=  'へ連絡して下さい。'
