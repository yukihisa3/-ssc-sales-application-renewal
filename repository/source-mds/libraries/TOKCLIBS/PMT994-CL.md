...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PMT994.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PMT994  '
    VAR       ?STEP     ,STRING*8
...
ZMT991B:
    ...
    OVRF      FILE-TBLADDL1,TOFILE-TBLADDL1.TOKWLIB
    OVRF      FILE-SHOTBL1,TOFILE-SHOTBL1.TOKFLIB
    OVRF      FILE-ERRF,TOFILE-ZMT994ER.TOKWLIB
    CALL      PGM-ZMT994B.TOKELIBO,
