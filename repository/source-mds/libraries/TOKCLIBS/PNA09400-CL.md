...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNA09400.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?CLID    ,STRING*08,VALUE-'PNA09400'        /.CLID         ./
   ...
   /.##パラメタ（個別）##./
    ...
    VAR ?MSG1A,STRING*38,VALUE-'・小売連携発注データ（手書き）の再累'
    VAR ?MSG1B,STRING*38,VALUE-'積を行います。　　　　　　　　　　　'
