...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY88640.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY88640'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
/.##ｽﾄｯｸﾌｫｰﾑへ出力##./
    ...
    CALL      PGM-SSY8864I.TOKELIBO,PARA-(?P1,?P2,?P3,?P4,?P5,?P6,?P7
                                         ,?P8,?P9,?P10,?P11)
    IF        @PGMEC    ^=   0    THEN
         IF   @PGMEC     =   4010 THEN
...
SSY8865L:
    ...
    OVRF      FILE-DJSYUKLA,TOFILE-DJSYUKLA.TOKKLIB
    CALL      PGM-SSY8865L.TOKELIBO,PARA-(?P1,?P2,?P3,?P4,?P6,?P7
                                         ,?P8,?P9,?P10,?P11)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '出荷リスト出力'
              GOTO ABEND END
