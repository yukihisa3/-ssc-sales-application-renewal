...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH73RZ.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH73RZ'  /.PROGRAM-ID./
...
NCV7352B:
    ...
    CALL      PGM-NCV7352B.TOKSOLIB,PARA-(?HIDUKE,?JIKAN,?TOKCD,?LINE,
...
NJH7352B:
    ...
    CALL      PGM-NJH7352B.TOKSOLIB,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
...
KENLST:
    ...
    SBMJOB JOB-KENLRZ,JOBD-CVCS.XUCL,JOBK-@B,PGM-KENLST.TOKCLIBO,
...
RTN:
   ...
   /.##ｴﾗｰﾘｽﾄ発行##./
    SBMJOB JOB-KEKALTRZ,JOBD-CVCS.XUCL,JOBK-@B,
