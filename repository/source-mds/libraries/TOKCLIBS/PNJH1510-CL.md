...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH1510.CL`
...
/.##ﾊﾟﾗﾒﾀ定義##./
    ...
    PARA      ?JKEKA    ,STRING*4,OUT,VALUE-'    '     /.OUT結果./
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH1510'  /.PROGRAM-ID./
...
NJH1501B:
    ...
    CALL      PGM-NJH1510B.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
