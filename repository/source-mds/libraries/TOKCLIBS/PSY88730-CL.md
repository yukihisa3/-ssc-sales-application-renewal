...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY88730.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?PGMID    ,STRING*8,VALUE-'PSY88730'    /.ﾌﾟﾛｸﾞﾗﾑID./
...
SSY8873I:
    ...
    CALL      PGM-SSY8873I.TOKELIBO,PARA-(?P7,?P5,?P1,?P2,?P3,?P4
                                         ,?P6,?P8)
    IF        @PGMEC    ^=   0    THEN
         IF   @PGMEC     =   4010 THEN
...
SSY8874L:
    ...
    OVRF      FILE-DKCENTL1,TOFILE-DKCENTL1.TOKKLIB
...
/.  IF  ?WS ^= 'WKSTNHT5'  THEN
    ...
    ELSE
          ...
          OUTQ-XOUTQ1,MEDLIB-TOKELIBO
    END
    CALL      PGM-SSY8874L.TOKELIBO,PARA-(?P1,?P2,?P3,?P4,?P6,?P8)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '荷個数明細書'
              GOTO ABEND END
