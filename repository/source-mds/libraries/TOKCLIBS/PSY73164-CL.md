...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY73164.CL`
...
STEP030:
    ...
    /.##リック植物受領書発行##./
    CALL SSY7317L.TOKELIBO,PARA-('00001995')
    IF      @PGMEC    ^=   0    THEN
            ?KEKA4 := '【リック植物受領書発行】'
            GOTO ABEND
    END
