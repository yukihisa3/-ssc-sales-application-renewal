...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/CNI10300.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'CNI10300'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,STRING*8
...
STEP080:
 ...
 /.20120301  DAT -> LTO  ./
 /. SAVLIB LIB-TOKFLIB/TOKWLIB/OSKFLIB/TOKKLIB,TODEV-DAT,
           REWIND-@AFTER,MODE-@USED  ./
    SAVLIB LIB-TOKFLIB/TOKWLIB/OSKFLIB/TOKKLIB,TODEV-LTO,
