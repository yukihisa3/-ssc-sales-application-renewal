...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH4601.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH4601'  /.PROGRAM-ID./
...
NJH4601B:
    ...
    DEFLIBL   TOKELIB/TOKFLIB/TOKJLIB/TOKELIBO/TOKKLIB
    ...
    CALL      PGM-NJH4601B.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
