...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH2901.CL`
...
SJH2900B:
    ...
    OVRF      FILE-DATAF2,TOFILE-JUSCO.TOKWLIB
...
NJH2901B:
    ...
    OVRF      FILE-CVCSG001,TOFILE-JUSCO.TOKWLIB
    ...
    CALL      PGM-NJH2901B.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
