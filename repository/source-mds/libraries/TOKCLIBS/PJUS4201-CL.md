...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PJUS4201.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PJUS4201'  /.PROGRAM-ID./
...
SJT0110B:
    ...
    DEFLIBL TOKELIB/TOKFLIB/OSKFLIB/TOKELIBO/TOKJLIB/TOKKLIB

    ?STEP :=   'SJT0110B'
    ?MSGX :=  '***   '  && ?STEP   &&   '        ***'
    SNDMSG    ?MSGX,TO-XCTL.@ORGPROF,JLOG-@YES

    OVRF      FILE-JUNTENJR,TOFILE-JUNTENJR.ONLBLIB
    OVRF      FILE-SHOTBL1,TOFILE-SHOTBL1.TOKFLIB
    OVRF      FILE-MEIMS1,TOFILE-MEIMS1.TOKFLIB
    OVRF      FILE-JHMRUTL1,TOFILE-JHMRUTL1.TOKFLIB
    OVRF      FILE-TOKMS2,TOFILE-TOKMS2.TOKFLIB
    OVRF      FILE-JTCJHEL1,TOFILE-JTCJHEL1.OSKFLIB
    OVRF      FILE-JTCJMEL1,TOFILE-JTCJMEL1.OSKFLIB
    OVRF      FILE-JTCJMOL1,TOFILE-JTCJMOL1.OSKFLIB
    CALL      PGM-SJT0110B.OSKELIB
    IF        @PGMEC    ^=   0    THEN
              /.##正常終了ｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K523'
