...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH2401.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH2401'  /.PROGRAM-ID./
...
NJH2401B:
    ...
    DEFLIBL   TOKELIB/ONLBLIB/TOKFLIB/TOKELIBO/TOKJLIB/TOKKLIB
    ...
    CALL      PGM-NJH2401B.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
              CALL PGM-NSJ0730B.TOKELIBO,
