...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSJH8331.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PSJH8331'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,STRING*8
...
STEP030:
    ...
    FEXPORT FILE-JEDICOJS.ONLBLIB,MODE-@REP,PARA-HORMAC,
            UNIT-6
    IF      @PGMEC    ^=   0    THEN
            ?KEKA4 := '【受信データ取込処理】'
                    GOTO ABEND
...
STEP050:
    ...
    OVRF FILE-JEDICOS,TOFILE-JEDICOJS.ONLBLIB
    OVRF FILE-JCAFILEA,TOFILE-JCAFILEE.ONLBLIB
    OVRF FILE-JCAFILEB,TOFILE-JCAFILEF.ONLBLIB
    OVRF FILE-JCAFILEC,TOFILE-JCAFILEG.ONLBLIB
    OVRF FILE-JCAFILED,TOFILE-JCAFILEH.ONLBLIB
    CALL SJH8330B.TOKELIBO
    IF      @PGMEC    ^=   0    THEN
            ?KEKA4 := '【ＪＥＤＩＣＯＳデータ変換】'
                    GOTO ABEND
    END
...
STEP060:
    ...
    OVRF FILE-HOH,TOFILE-JCAFILEE.ONLBLIB
    OVRF FILE-HOS,TOFILE-JCAFILEF.ONLBLIB
    OVRF FILE-HOK,TOFILE-JCAFILEG.ONLBLIB
    OVRF FILE-HOT,TOFILE-JCAFILEH.ONLBLIB
    CALL SJH8332L.TOKELIBO,PARA-('2',?CHK1,?CHK2,?CHK3)
    IF      @PGMEC    ^=   0    THEN
            ?KEKA4 := '【受信結果リスト】'
                    GOTO ABEND
    END
