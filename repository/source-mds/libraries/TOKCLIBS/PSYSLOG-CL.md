...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSYSLOG.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PSYSLOG'
    VAR       ?STEP   ,STRING*8
...
MAIN000:
    ...
    DSPSLOG TYPE-@NEWIPL,OUTPUT-@LIST,EDT-@JEF
    IF      @PGMEC  ^=  0
        THEN
              ?MSGX :=  '## ｼｽﾃﾑﾛｸﾞ出力異常 ##'
