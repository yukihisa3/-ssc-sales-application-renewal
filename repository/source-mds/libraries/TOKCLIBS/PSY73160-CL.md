...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY73160.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PSY73160'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,STRING*8
...
STEP030:
    ...
    SNDMSG '######################################',TO-XCTL
    SNDMSG '## ダイユーエイト　受領書発行　開始 ##',TO-XCTL
    SNDMSG '######################################',TO-XCTL
/.##ダイユーエイト受領データセット##./
    SETPF FILE-DYJRYOF1.TOKKLIB,TOFILE-DYJRYOF.TOKKLIB,
    ADD-@NO,ACTCHK-@NO

    CALL SSY7317L.TOKELIBO,PARA-('00001225')
    IF   ?PGCHK1  = '1'    THEN
         SNDMSG '######################################',TO-XCTL
         SNDMSG '## ダイユーエイト　受領書発行エラー ##',TO-XCTL
         SNDMSG '######################################',TO-XCTL
    END
