...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH5750.CL`
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH5750'  /.PROGRAM-ID./
...
SSY5705B:
    ...
    OVRF      FILE-HACGODYW,TOFILE-HACGODYW.ONLBLIB
...
NJH5750B:
    ...
    OVRF      FILE-CVCSG001,TOFILE-HACGODYW.ONLBLIB
    ...
    CALL      PGM-NJH5750B.TOKELIBO,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
              CALL PGM-SNJ0730B.TOKELIB,
