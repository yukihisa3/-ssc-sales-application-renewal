...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSI8705A.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PSI8705A'
    VAR       ?STEP     ,STRING*8
...
SSI87051:
    ...
    CALL      PGM-SSI8705A.TOKELIBO,PARA-(?SYORIKN1,?SYORIKN2)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
...
SSI87052:
    ...
    OVRF      FILE-TENMS1,TOFILE-TENMS1.TOKFLIB
    CALL      PGM-SSI8705A.TOKELIBO,PARA-(?SYORIKN3,?SYORIKN4)
    IF        @PGMEC    ^=   0    THEN
              GOTO ABEND END
RTN:
