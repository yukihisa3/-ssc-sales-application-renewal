...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY38101.CL`
...
/.##ﾊﾟﾗﾒﾀ情報##./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PSY38101'
    VAR       ?STEP     ,STRING*8
...
CNVDF000:
    ...
    ?MSGX :=  '***   出力先 = HGNAS  ***'
    SNDMSG    ?MSGX,TO-XCTL.@ORGPROF,JLOG-@YES,SLOG-@YES
    ?MSGX :=  '***   ﾌｧｲﾙID = NFTENMS.CSV ***'
    SNDMSG    ?MSGX,TO-XCTL.@ORGPROF,JLOG-@YES,SLOG-@YES

  /.社内テスト用
    CNVDF FILE-NFTENMS.TOKDLIB,
          PATH-'//NAVPC/NFTENMS.CSV',MODE-@EXP,ADD-@NO,
          ACTCHK-@NO,HEADLINE-@YES,EXTCNV-@YES
./  CNVDF FILE-NFTENMS.TOKDLIB,
          PATH-'//HGNAS/NFTENMS.CSV',MODE-@EXP,ADD-@NO,
          ACTCHK-@NO,HEADLINE-@YES,EXTCNV-@YES

    ?PGMEC := @PGMEC
    ?PGMES := @PGMES
    IF        ?PGMEC    ^=   0    THEN
              ?KEKA4 := 'ナフコ店舗マスタリストＣＳＶ出力'
              GOTO ABEND END
