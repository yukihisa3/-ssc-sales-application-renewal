...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNJH4409.CL`
...
/. *   JOB-ID      :    PNJH4409                             *  ./
/. *   JOB-NAME    :    アレンザＨＤ　ＢＭＳ用　　　　　　　 *  ./
/. *               :    2023.04.20 S22481700                 *  ./
/. *               :    流用：PNJH4403                       *  ./
/. *   UPDATE      :                                         *  ./
/. ***********************************************************  ./
...
/.##ﾜｰｸﾃｲｷﾞ##./
    ...
    VAR       ?PGMID    ,STRING*8,VALUE-'PNJH4409'  /.PROGRAM-ID./
...
SSY4469B:
    ...
    CALL      PGM-SSY4469B.TOKSOLIB,PARA-(?PARA)
    IF        @PGMEC    ^=   0    THEN
              /.##ABENDｺｰﾄﾞｾｯﾄ##./
              ?KEKA := 'K525'
