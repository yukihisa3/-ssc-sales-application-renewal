...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PPD01200.CL`
...
/. ***********************************************************  ./
    ...
    VAR       ?MSG      ,STRING*99(6)
    VAR       ?MSGX     ,STRING*99
    VAR       ?PGMID    ,STRING*8,VALUE-'PPD01200'
    VAR       ?STEP     ,STRING*8
/.##ﾌｧｲﾙ名称編集用##./
    VAR       ?WKSTN    ,NAME
...
SPD0120I:
    ...
    OVRF      FILE-TANMS1,TOFILE-TANMS1.TOKKLIB
    CALL      PGM-SPD0120I.TOKELIBO,PARA-(?TANCD)
    IF        @PGMEC    ^=   0    THEN
              ?KEKA4 :=  '【量販店入力】'
              GOTO ABEND END
...
ABEND:
    ...
    ?KEKA1 :=  '（手書連携）量販店入力が異常終了しまし'
    ?KEKA2 :=  'た。ログリストを採取してＮＡＶへ連絡し'
    ?KEKA3 :=  'て下さい。'
