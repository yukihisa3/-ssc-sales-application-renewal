...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PNA01100.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR ?CLID    ,STRING*08,VALUE-'PNA01100'        /.CLID         ./
...
SETPF1:
    ...
    SETPF FILE-NARKANF.TOKKLIB,TOFILE-NARKANF.TOKBLIB,ADD-@NO
    ?PGMEC    :=    @PGMEC
    ?PGMEM    :=    @PGMEM
    IF        ?PGMEC    ^=   0   THEN
              ?KEKA4 :=  '連携ＮＯ管理Ｆバックアップ'
...
SETPF2:
    ...
    SETPF FILE-NARRUIF.TOKKLIB,TOFILE-NARRUIF.TOKBLIB,ADD-@NO
    ?PGMEC    :=    @PGMEC
    ?PGMEM    :=    @PGMEM
    IF        ?PGMEC    ^=   0   THEN
              ?KEKA4 :=  '小売連携累積Ｆバックアップ'
...
SNA0110B:
    ...
    OVRF      FILE-NARKANL4,TOFILE-NARKANL4.TOKKLIB
    OVRF      FILE-NARRUIL1,TOFILE-NARRUIL1.TOKKLIB
    CALL      PGM-SNA0110B.TOKELIBO
    ?PGMEC    :=    @PGMEC
    ?PGMEM    :=    @PGMEM
    IF        ?PGMEC    ^=   0   THEN
              ?KEKA4 :=  '小売連携累積Ｆ削除'
