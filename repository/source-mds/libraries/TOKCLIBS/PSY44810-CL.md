...
**種別**: JCL  
**ライブラリ**: TOKCLIBS  
**ソースファイル**: `source/navs/cobol/programs/TOKCLIBS/PSY44810.CL`
...
/.###ﾜｰｸｴﾘｱ定義####./
    ...
    VAR       ?MSG    ,STRING*99(6)
    VAR       ?MSGX   ,STRING*99
    VAR       ?PGMID  ,STRING*8,VALUE-'PSY44810'
    VAR       ?STEP   ,STRING*8
    VAR       ?WKSTN  ,NAME!MOD
...
STEP060:
 ...
 /. OVRF FILE-JHTTEGF,TOFILE-BMSTEGF.BMSFLIB  ./
    ...
    CALL SSY4481B.TOKELIBO,PARA-(?SYORIKN1)
    IF      @PGMEC    ^=   0    THEN
       IF      @PGMEC    =  4010    THEN
               GOTO RTN
       ELSE
...
STEP070:
    ...
    CALL  SBM0081B.TOKELIBO,PARA-(?SYORIKN2)
    IF      @PGMEC    ^=   0    THEN
